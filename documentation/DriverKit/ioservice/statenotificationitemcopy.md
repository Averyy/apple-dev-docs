...
```swift
kern_return_t StateNotificationItemCopy(OSString * itemName, OSDictionary * * value);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/ioservice/statenotificationitemcopy)*