...
```swift
kern_return_t RequireMaxBusStall(uint64_t maxBusStall);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/ioservice/requiremaxbusstall)*