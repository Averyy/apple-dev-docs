...
```swift
#define kIOPropertySCSIParallelSignalingTypeLVDKey
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/kiopropertyscsiparallelsignalingtypelvdkey)*