...
```swift
#define kIOPropertyPhysicalInterconnectTypeAppleFabric
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/kiopropertyphysicalinterconnecttypeapplefabric)*