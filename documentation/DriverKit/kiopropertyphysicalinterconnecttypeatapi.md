...
```swift
#define kIOPropertyPhysicalInterconnectTypeATAPI
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/kiopropertyphysicalinterconnecttypeatapi)*