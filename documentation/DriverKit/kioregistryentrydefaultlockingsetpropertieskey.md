...
```swift
#define kIORegistryEntryDefaultLockingSetPropertiesKey
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/kioregistryentrydefaultlockingsetpropertieskey)*