...
```swift
#define kIOPropertyPortSpeedAutomatic2GigabitKey
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/kiopropertyportspeedautomatic2gigabitkey)*