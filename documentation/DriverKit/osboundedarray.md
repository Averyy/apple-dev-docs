...
```swift
typedef libkern::libkern::bounded_array<T, N, os_detail::panic_trapping_policy> OSBoundedArray;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/osboundedarray)*