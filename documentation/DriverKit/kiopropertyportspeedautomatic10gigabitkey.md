...
```swift
#define kIOPropertyPortSpeedAutomatic10GigabitKey
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/kiopropertyportspeedautomatic10gigabitkey)*