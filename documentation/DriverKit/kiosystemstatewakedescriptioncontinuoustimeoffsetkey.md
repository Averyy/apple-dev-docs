...
```swift
#define kIOSystemStateWakeDescriptionContinuousTimeOffsetKey
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/kiosystemstatewakedescriptioncontinuoustimeoffsetkey)*