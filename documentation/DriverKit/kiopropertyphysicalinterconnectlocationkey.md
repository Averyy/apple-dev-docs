...
```swift
#define kIOPropertyPhysicalInterconnectLocationKey
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/kiopropertyphysicalinterconnectlocationkey)*