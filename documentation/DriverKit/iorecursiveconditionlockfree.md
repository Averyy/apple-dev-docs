...
```swift
void IORecursiveConditionLockFree(struct IORecursiveConditionLock * lock);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/iorecursiveconditionlockfree)*