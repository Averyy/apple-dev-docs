...
```swift
OSSerializationPtrOSCreateSerializationFromObject(OSObjectPtr obj);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/oscreateserializationfromobject)*