...
```swift
#define kIOUserClientDefaultLockingSingleThreadExternalMethodKey
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/kiouserclientdefaultlockingsinglethreadexternalmethodkey)*