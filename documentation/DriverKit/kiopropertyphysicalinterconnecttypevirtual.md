...
```swift
#define kIOPropertyPhysicalInterconnectTypeVirtual
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/kiopropertyphysicalinterconnecttypevirtual)*