...
```swift
uint64_t getStateLastChannelUpdateTime(uint64_t channel_id);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/iostatereporter/getstatelastchannelupdatetime)*