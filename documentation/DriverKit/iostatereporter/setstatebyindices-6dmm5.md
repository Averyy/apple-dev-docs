...
```swift
IOReturn setStateByIndices(int channel_index, int new_state_index);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/iostatereporter/setstatebyindices-6dmm5)*