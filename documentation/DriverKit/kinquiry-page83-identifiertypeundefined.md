...
```swift
#define kINQUIRY_Page83_IdentifierTypeUndefined
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/kinquiry_page83_identifiertypeundefined)*