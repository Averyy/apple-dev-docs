...
```swift
#define kIOPropertyPhysicalInterconnectTypeSecureDigital
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/kiopropertyphysicalinterconnecttypesecuredigital)*