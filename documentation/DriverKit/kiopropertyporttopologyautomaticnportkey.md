...
```swift
#define kIOPropertyPortTopologyAutomaticNPortKey
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/kiopropertyporttopologyautomaticnportkey)*