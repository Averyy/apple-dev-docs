...
This parameter is set only for large structures, and if set [`structureInput`](iouserclientmethodarguments/structureinput.md) is `NULL`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/iouserclientmethodarguments/structureinputdescriptor)*