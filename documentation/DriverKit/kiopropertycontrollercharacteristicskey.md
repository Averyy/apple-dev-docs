...
```swift
#define kIOPropertyControllerCharacteristicsKey
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/kiopropertycontrollercharacteristicskey)*