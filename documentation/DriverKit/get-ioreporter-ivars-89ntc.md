...
```swift
static IOReporter_IVars * get_IOReporter_IVars(IOReporter * p);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/get_ioreporter_ivars-89ntc)*