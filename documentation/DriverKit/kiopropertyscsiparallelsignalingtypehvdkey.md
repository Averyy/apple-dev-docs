...
```swift
#define kIOPropertySCSIParallelSignalingTypeHVDKey
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/kiopropertyscsiparallelsignalingtypehvdkey)*