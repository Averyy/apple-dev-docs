...
- [kOSBooleanFalse](kosbooleanfalse.md)
  The OSBoolean constant for `false` .
- [kOSBooleanTrue](kosbooleantrue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/osboolean)*