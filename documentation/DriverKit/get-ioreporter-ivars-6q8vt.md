...
```swift
static IOReporter_IVars * get_IOReporter_IVars(IOReporter_IVars * p);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/get_ioreporter_ivars-6q8vt)*