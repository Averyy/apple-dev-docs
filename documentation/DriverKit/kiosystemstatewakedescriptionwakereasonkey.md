...
```swift
#define kIOSystemStateWakeDescriptionWakeReasonKey
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/kiosystemstatewakedescriptionwakereasonkey)*