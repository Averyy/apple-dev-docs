...
```swift
bool IORecursiveConditionLockTryLock(struct IORecursiveConditionLock * lock);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/iorecursiveconditionlocktrylock)*