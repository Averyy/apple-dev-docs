...
```swift
static IOHistogramReporter_IVars * get_IOHistogramReporter_IVars(IOHistogramReporter_IVars * p);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/get_iohistogramreporter_ivars-4lwpg)*