...
```swift
void IORecursiveConditionLockLock(struct IORecursiveConditionLock * lock);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/iorecursiveconditionlocklock)*