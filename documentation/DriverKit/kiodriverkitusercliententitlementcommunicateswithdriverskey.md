...
```swift
#define kIODriverKitUserClientEntitlementCommunicatesWithDriversKey
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/driverkit/kiodriverkitusercliententitlementcommunicateswithdriverskey)*