...
- [func receive<S>(subscriber: S)](publishers/ignoreoutput/receive(subscriber:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/combine/publishers-ignoreoutput-publisher-operators)*