...
```swift
static func microseconds(_ us: Int) -> ImmediateScheduler.SchedulerTimeType.Stride
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/combine/immediatescheduler/schedulertimetype/stride/microseconds(_:))*