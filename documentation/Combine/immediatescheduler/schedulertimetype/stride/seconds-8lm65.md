...
```swift
static func seconds(_ s: Double) -> ImmediateScheduler.SchedulerTimeType.Stride
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/combine/immediatescheduler/schedulertimetype/stride/seconds(_:)-8lm65)*