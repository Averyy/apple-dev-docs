...
If your closure can throw an error, use Combine’s [`tryMap(_:)`](published/publisher/trymap(_:).md) operator instead.
...
*[View on Apple Developer](https://developer.apple.com/documentation/combine/published/publisher/map(_:)-28nu5)*