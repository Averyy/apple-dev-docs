...
Use [`print(_:to:)`](published/publisher/print(_:to:).md) to log messages the console.
...
*[View on Apple Developer](https://developer.apple.com/documentation/combine/published/publisher/print(_:to:))*