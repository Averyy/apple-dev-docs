...
- [func receive<S>(subscriber: S)](publishers/scan/receive(subscriber:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/combine/publishers-scan-publisher-operators)*