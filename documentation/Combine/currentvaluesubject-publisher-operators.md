...
- [func receive<S>(subscriber: S)](currentvaluesubject/receive(subscriber:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/combine/currentvaluesubject-publisher-operators)*