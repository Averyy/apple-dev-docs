...
- [func receive<S>(subscriber: S)](future/receive(subscriber:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/combine/future-publisher-operators)*