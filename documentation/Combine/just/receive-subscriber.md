...
```swift
func receive<S>(subscriber: S) where Output == S.Input, S : Subscriber, S.Failure == Never
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/combine/just/receive(subscriber:))*