...
- [func receive<S>(subscriber: S)](deferred/receive(subscriber:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/combine/deferred-publisher-operators)*