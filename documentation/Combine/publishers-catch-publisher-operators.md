...
- [func receive<S>(subscriber: S)](publishers/catch/receive(subscriber:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/combine/publishers-catch-publisher-operators)*