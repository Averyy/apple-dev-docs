...
- [func receive<S>(subscriber: S)](publishers/sequence/receive(subscriber:).md)
  Attaches the specified subscriber to this publisher.
...
*[View on Apple Developer](https://developer.apple.com/documentation/combine/publishers/sequence/subscribe(_:)-4qu2b)*