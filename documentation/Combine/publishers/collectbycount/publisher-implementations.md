...
### Instance Properties
- [var values: AsyncThrowingPublisher<Self>](publishers/collectbycount/values-1u58y.md)
  The elements produced by the publisher, as a throwing asynchronous sequence.
- [var values: AsyncPublisher<Self>](publishers/collectbycount/values-4jgo4.md)
...
- [func contains(Self.Output) -> Publishers.Contains<Self>](publishers/collectbycount/contains(_:).md)
...
- [func encode<Coder>(encoder: Coder) -> Publishers.Encode<Self, Coder>](publishers/collectbycount/encode(encoder:).md)
...
- [func removeDuplicates() -> Publishers.RemoveDuplicates<Self>](publishers/collectbycount/removeduplicates.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/combine/publishers/collectbycount/publisher-implementations)*