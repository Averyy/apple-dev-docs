...
- [func receive<S>(subscriber: S)](publishers/zip4/receive(subscriber:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/combine/publishers-zip4-publisher-operators)*