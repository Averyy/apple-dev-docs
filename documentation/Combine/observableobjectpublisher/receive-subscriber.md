...
```swift
final func receive<S>(subscriber: S) where S : Subscriber, S.Failure == Never, S.Input == ()
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/combine/observableobjectpublisher/receive(subscriber:))*