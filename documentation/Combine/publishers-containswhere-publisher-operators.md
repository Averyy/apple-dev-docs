...
- [func receive<S>(subscriber: S)](publishers/containswhere/receive(subscriber:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/combine/publishers-containswhere-publisher-operators)*