...
- [func receive<S>(subscriber: S)](publishers/trycontainswhere/receive(subscriber:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/combine/publishers-trycontainswhere-publisher-operators)*