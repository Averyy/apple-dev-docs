...
- [func receive<S>(subscriber: S)](publishers/maperror/receive(subscriber:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/combine/publishers-maperror-publisher-operators)*