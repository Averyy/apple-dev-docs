# HMCharacteristicTypeRouterStatus
...
The corresponding value is one of the constants in the [`HMCharacteristicValueRouterStatus`](hmcharacteristicvaluerouterstatus.md) enumeration.

## Topics

### Values
- [enum HMCharacteristicValueRouterStatus](hmcharacteristicvaluerouterstatus.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/homekit/hmcharacteristictyperouterstatus)*