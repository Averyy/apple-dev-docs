...
- `home`: The home.
- `room`: The room that was removed from the zone.
- `zone`: The zone the room was removed from.
...
*[View on Apple Developer](https://developer.apple.com/documentation/homekit/hmhomedelegate/home(_:didremove:from:)-8oz67)*