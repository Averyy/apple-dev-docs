...
- `group`: The group to which the service was added.
...
*[View on Apple Developer](https://developer.apple.com/documentation/homekit/hmhomedelegate/home(_:didadd:to:)-6xdgy)*