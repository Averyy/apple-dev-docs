...
- `home`: The home for which supported features changed.
...
*[View on Apple Developer](https://developer.apple.com/documentation/homekit/hmhomedelegate/homedidupdatesupportedfeatures(_:))*