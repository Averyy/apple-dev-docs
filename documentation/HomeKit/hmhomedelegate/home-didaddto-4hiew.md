...
- `home`: The home.
- `room`: The room that was assigned to the zone.
- `zone`: The zone the room was assigned to.
...
*[View on Apple Developer](https://developer.apple.com/documentation/homekit/hmhomedelegate/home(_:didadd:to:)-4hiew)*