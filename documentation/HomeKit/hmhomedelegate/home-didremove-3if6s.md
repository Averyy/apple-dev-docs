...
Accessories in a room that gets removed from a home are moved to [`roomForEntireHome()`](hmhome/roomforentirehome().md).

## Parameters

- `home`: The home the room was removed from.
...
*[View on Apple Developer](https://developer.apple.com/documentation/homekit/hmhomedelegate/home(_:didremove:)-3if6s)*