...
The corresponding value is one of the constants in the [`HMCharacteristicValueConfigurationState`](hmcharacteristicvalueconfigurationstate.md) enumeration.

## Topics

### Values
- [enum HMCharacteristicValueConfigurationState](hmcharacteristicvalueconfigurationstate.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/homekit/hmcharacteristictypeisconfigured)*