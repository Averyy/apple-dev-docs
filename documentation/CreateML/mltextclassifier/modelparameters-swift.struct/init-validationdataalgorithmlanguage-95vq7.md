...
- validationData: A data source of the labeled directories the text classifier uses for validation data during training. - algorithm: An algorithm type for the text classifier.
...
*[View on Apple Developer](https://developer.apple.com/documentation/createml/mltextclassifier/modelparameters-swift.struct/init(validationdata:algorithm:language:)-95vq7)*