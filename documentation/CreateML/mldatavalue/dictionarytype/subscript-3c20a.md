...
```swift
subscript(index: MLDataValue.DictionaryType.Index) -> MLDataValue.DictionaryType.Element { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/createml/mldatavalue/dictionarytype/subscript(_:)-3c20a)*