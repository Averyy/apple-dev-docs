...
*[View on Apple Developer](https://developer.apple.com/documentation/createml/mldatavalue/dictionarytype/split(maxsplits:omittingemptysubsequences:whereseparator:))*