...
```swift
var endIndex: MLDataValue.SequenceType.Index { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/createml/mldatavalue/sequencetype/endindex)*