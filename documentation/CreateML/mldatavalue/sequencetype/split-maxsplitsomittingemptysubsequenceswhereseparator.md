...
*[View on Apple Developer](https://developer.apple.com/documentation/createml/mldatavalue/sequencetype/split(maxsplits:omittingemptysubsequences:whereseparator:))*