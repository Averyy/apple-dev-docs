...
Then use [`init(column:)`](mldatacolumn/init(column:)-8uzuq.md) to convert the column to a column of arrays of strings.
...
*[View on Apple Developer](https://developer.apple.com/documentation/createml/mldatacolumn/init(column:)-8uzuq)*