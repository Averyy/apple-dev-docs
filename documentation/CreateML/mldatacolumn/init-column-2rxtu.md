...
Then use [`init(column:)`](mldatacolumn/init(column:)-2rxtu.md) to convert the column to a column of arrays of integers.
...
- `column`: An   of elements convertible to an    of   .
...
*[View on Apple Developer](https://developer.apple.com/documentation/createml/mldatacolumn/init(column:)-2rxtu)*