...
Then use [`init(column:)`](mldatacolumn/init(column:)-23pmx.md) to convert the column to a column of arrays of doubles.
...
*[View on Apple Developer](https://developer.apple.com/documentation/createml/mldatacolumn/init(column:)-23pmx)*