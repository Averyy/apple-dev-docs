...
- `stepSize`: The shrinkage used to decrease the prediction weight of each learner. The smaller the step size the more conservative the *boosting* process will be. The default value is 0.3.
