...
- `parameters`: Model training parameters. See [`MLLinearRegressor.ModelParameters`](mllinearregressor/modelparameters-swift.struct.md) for the defaults.
...
*[View on Apple Developer](https://developer.apple.com/documentation/createml/mllinearregressor/train(trainingdata:targetcolumn:featurecolumns:parameters:sessionparameters:))*