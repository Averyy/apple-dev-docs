...
- `maxLength`: The largest number of elements to use from the beginning of   the column. The default value is  .
...
*[View on Apple Developer](https://developer.apple.com/documentation/createml/mluntypedcolumn/prefix(_:))*