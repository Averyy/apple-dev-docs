...
By explicitly adding the type annotation `MLDataColumn<Double>`, the compiler uses this version of `subscript(_:)` instead of the equivalent [`subscript(_:)`](mldatatable/subscript(_:)-3wjk.md) from [`MLUntypedColumn`](mluntypedcolumn.md).
