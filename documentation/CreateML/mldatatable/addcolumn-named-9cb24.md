...
Then use [`addColumn(_:named:)`](mldatatable/addcolumn(_:named:)-9cb24.md) to add a column to the table.
...
*[View on Apple Developer](https://developer.apple.com/documentation/createml/mldatatable/addcolumn(_:named:)-9cb24)*