...
The dictionary keys are the values in the column that you specified with the aggregator’s [`columnName`](mldatatable/aggregator/columnname.md) property.
...
*[View on Apple Developer](https://developer.apple.com/documentation/createml/mldatatable/aggregator/operations-swift.enum/dictionarymerge(valuecolumn:))*