...
```swift
mutating func next() -> AnnotatedBatch<Scalar>?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/createmlcomponents/timeseriesforecasterbatches/iterator/next())*