...
*[View on Apple Developer](https://developer.apple.com/documentation/createmlcomponents/timeseriesforecasterbatches/split(separator:maxsplits:omittingemptysubsequences:))*