...
*[View on Apple Developer](https://developer.apple.com/documentation/createmlcomponents/timeseriesforecasterannotatedwindows/split(maxsplits:omittingemptysubsequences:whereseparator:))*