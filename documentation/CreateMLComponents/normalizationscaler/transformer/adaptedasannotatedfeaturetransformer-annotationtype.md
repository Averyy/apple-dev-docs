...
*[View on Apple Developer](https://developer.apple.com/documentation/createmlcomponents/normalizationscaler/transformer/adaptedasannotatedfeaturetransformer(annotationtype:))*