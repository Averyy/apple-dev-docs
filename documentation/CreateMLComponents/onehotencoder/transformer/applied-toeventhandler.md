...
- Parameters - input: A category to encode.
...
*[View on Apple Developer](https://developer.apple.com/documentation/createmlcomponents/onehotencoder/transformer/applied(to:eventhandler:))*