...
*[View on Apple Developer](https://developer.apple.com/documentation/createmlcomponents/pipelinedataerror/incompatibleconfiguration(operation:debugdescription:))*