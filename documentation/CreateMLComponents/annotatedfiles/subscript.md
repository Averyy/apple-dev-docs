...
```swift
subscript(index: AnnotatedFiles.Index) -> IndexingIterator<AnnotatedFiles>.Element { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/createmlcomponents/annotatedfiles/subscript(_:))*