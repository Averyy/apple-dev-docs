...
```swift
var annotationColumnID: ColumnID<Estimator.Annotation> { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/createmlcomponents/preprocessingupdatablesupervisedtabularestimator/annotationcolumnid)*