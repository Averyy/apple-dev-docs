...
*[View on Apple Developer](https://developer.apple.com/documentation/createmlcomponents/classificationdistribution/split(separator:maxsplits:omittingemptysubsequences:))*