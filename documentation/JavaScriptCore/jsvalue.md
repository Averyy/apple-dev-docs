...
### Initializers
- [init!(UInt32: UInt32, inContext: JSContext!)](jsvalue/init(uint32:incontext:).md)
- [init!(bool: Bool, inContext: JSContext!)](jsvalue/init(bool:incontext:).md)
- [init!(double: Double, inContext: JSContext!)](jsvalue/init(double:incontext:).md)
- [init!(int32: Int32, inContext: JSContext!)](jsvalue/init(int32:incontext:).md)
- [init!(jsValueRef: JSValueRef!, in: JSContext!)](jsvalue/init(jsvalueref:in:).md)
- [init!(newArrayInContext: JSContext!)](jsvalue/init(newarrayincontext:).md)
...
- [init?(newBigIntFromDouble: Double, inContext: JSContext)](jsvalue/init(newbigintfromdouble:incontext:).md)
- [init?(newBigIntFromInt64: Int64, inContext: JSContext)](jsvalue/init(newbigintfromint64:incontext:).md)
- [init?(newBigIntFromString: String, inContext: JSContext)](jsvalue/init(newbigintfromstring:incontext:).md)
- [init?(newBigIntFromUInt64: UInt64, inContext: JSContext)](jsvalue/init(newbigintfromuint64:incontext:).md)
- [init!(newErrorFromMessage: String!, inContext: JSContext!)](jsvalue/init(newerrorfrommessage:incontext:).md)
- [init!(newObjectInContext: JSContext!)](jsvalue/init(newobjectincontext:).md)
- [init!(newPromiseInContext: JSContext!, fromExecutor: ((JSValue?, JSValue?) -> Void)!)](jsvalue/init(newpromiseincontext:fromexecutor:).md)
- [init!(newPromiseRejectedWithReason: Any!, inContext: JSContext!)](jsvalue/init(newpromiserejectedwithreason:incontext:).md)
- [init!(newPromiseResolvedWithResult: Any!, inContext: JSContext!)](jsvalue/init(newpromiseresolvedwithresult:incontext:).md)
- [init!(newRegularExpressionFromPattern: String!, flags: String!, inContext: JSContext!)](jsvalue/init(newregularexpressionfrompattern:flags:incontext:).md)
- [init!(newSymbolFromDescription: String!, inContext: JSContext!)](jsvalue/init(newsymbolfromdescription:incontext:).md)
- [init!(nullInContext: JSContext!)](jsvalue/init(nullincontext:).md)
- [init!(object: Any!, inContext: JSContext!)](jsvalue/init(object:incontext:).md)
...
- [init!(undefinedInContext: JSContext!)](jsvalue/init(undefinedincontext:).md)
### Instance Properties
