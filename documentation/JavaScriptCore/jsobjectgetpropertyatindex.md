...
Calling [`JSObjectGetPropertyAtIndex(_:_:_:_:)`](jsobjectgetpropertyatindex(_:_:_:_:).md) is equivalent to calling [`JSObjectGetProperty(_:_:_:_:)`](jsobjectgetproperty(_:_:_:_:).md) with a string that contains `propertyIndex`, but [`JSObjectGetPropertyAtIndex(_:_:_:_:)`](jsobjectgetpropertyatindex(_:_:_:_:).md) provides optimized access to numeric properties.
...
*[View on Apple Developer](https://developer.apple.com/documentation/javascriptcore/jsobjectgetpropertyatindex(_:_:_:_:))*