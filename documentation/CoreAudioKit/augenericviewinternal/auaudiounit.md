...
```swift
@MainActor
@objc @preconcurrency var auAudioUnit: AUAudioUnit? { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreaudiokit/augenericviewinternal/auaudiounit)*