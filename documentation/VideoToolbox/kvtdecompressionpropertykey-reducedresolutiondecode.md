...
### Resolutions
- [let kVTDecompressionResolutionKey_Width: CFString](kvtdecompressionresolutionkey_width.md)
  A key to specify the resolution width.
- [let kVTDecompressionResolutionKey_Height: CFString](kvtdecompressionresolutionkey_height.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/videotoolbox/kvtdecompressionpropertykey_reducedresolutiondecode)*