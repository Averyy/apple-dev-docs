...
```swift
class var defaultRevision: VTOpticalFlowConfiguration.Revision { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/videotoolbox/vtopticalflowconfiguration/defaultrevision)*