...
```swift
var revision: VTOpticalFlowConfiguration.Revision { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/videotoolbox/vtopticalflowconfiguration/revision-swift.property)*