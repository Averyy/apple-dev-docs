...
```swift
static var fatalError: VTFrameProcessorError.Code { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/videotoolbox/vtframeprocessorerror-swift.struct/fatalerror)*