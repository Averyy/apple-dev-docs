...
```swift
var kVTVideoDecoderReferenceMissingErr: OSStatus { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/videotoolbox/kvtvideodecoderreferencemissingerr)*