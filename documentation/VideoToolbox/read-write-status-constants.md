...
### Status Constants
- [let kVTPropertyReadWriteStatus_ReadOnly: CFString](kvtpropertyreadwritestatus_readonly.md)
- [let kVTPropertyReadWriteStatus_ReadWrite: CFString](kvtpropertyreadwritestatus_readwrite.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/videotoolbox/read-write-status-constants)*