...
### Property Types
- [let kVTPropertyType_Boolean: CFString](kvtpropertytype_boolean.md)
- [let kVTPropertyType_Enumeration: CFString](kvtpropertytype_enumeration.md)
- [let kVTPropertyType_Number: CFString](kvtpropertytype_number.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/videotoolbox/property-type-constants)*