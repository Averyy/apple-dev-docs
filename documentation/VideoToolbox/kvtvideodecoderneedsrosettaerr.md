...
```swift
var kVTVideoDecoderNeedsRosettaErr: OSStatus { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/videotoolbox/kvtvideodecoderneedsrosettaerr)*