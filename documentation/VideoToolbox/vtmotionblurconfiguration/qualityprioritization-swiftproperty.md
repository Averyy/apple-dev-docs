...
```swift
var qualityPrioritization: VTMotionBlurConfiguration.QualityPrioritization { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/videotoolbox/vtmotionblurconfiguration/qualityprioritization-swift.property)*