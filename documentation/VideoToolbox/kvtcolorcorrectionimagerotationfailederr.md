...
```swift
var kVTColorCorrectionImageRotationFailedErr: OSStatus { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/videotoolbox/kvtcolorcorrectionimagerotationfailederr)*