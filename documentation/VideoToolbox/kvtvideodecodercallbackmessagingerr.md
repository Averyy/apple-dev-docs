...
```swift
var kVTVideoDecoderCallbackMessagingErr: OSStatus { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/videotoolbox/kvtvideodecodercallbackmessagingerr)*