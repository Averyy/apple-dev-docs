...
### Downsampling Modes
- [let kVTDownsamplingMode_Average: CFString](kvtdownsamplingmode_average.md)
  Average missing samples (default center).
- [let kVTDownsamplingMode_Decimate: CFString](kvtdownsamplingmode_decimate.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/videotoolbox/downsampling-mode-constants)*