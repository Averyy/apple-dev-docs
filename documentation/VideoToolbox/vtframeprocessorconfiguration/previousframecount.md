...
```swift
optional var previousFrameCount: Int { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/videotoolbox/vtframeprocessorconfiguration/previousframecount)*