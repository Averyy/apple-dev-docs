...
- Set [`requiresSecureCoding`](https://developer.apple.com/documentation/foundation/nscoder/1409845-requiressecurecoding) to `true` and the [`decodingFailurePolicy`](https://developer.apple.com/documentation/foundation/nscoder/1642984-decodingfailurepolicy) to [`NSDecodingFailurePolicySetErrorAndReturn`](https://developer.apple.com/documentation/foundation/nsdecodingfailurepolicy/nsdecodingfailurepolicyseterrorandreturn) for any coder the following implementations or overrides use [`decodingFailurePolicy`](https://developer.apple.com/documentation/foundation/nscoder/1642984-decodingfailurepolicy) set to [`NSDecodingFailurePolicySetErrorAndReturn`](https://developer.apple.com/documentation/foundation/nsdecodingfailurepolicy/nsdecodingfailurepolicyseterrorandreturn): - [`restoreWindow(withIdentifier:state:completionHandler:)`](https://developer.apple.com/documentation/AppKit/NSWindowRestoration/restoreWindow(withIdentifier:state:completionHandler:))
