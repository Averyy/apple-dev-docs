# macOS Tahoe 26.5 Beta 3 Release Notes
...
The macOS 26.5 SDK provides support to develop apps for Mac computers running Tahoe 26.5 beta 3. The SDK comes bundled with Xcode 26.5, available from the Mac App Store. For information on the compatibility requirements for Xcode 26.5, see [`Xcode 26.5 Release Notes`](https://developer.apple.com/documentation/Xcode-Release-Notes/xcode-26_5-release-notes).
