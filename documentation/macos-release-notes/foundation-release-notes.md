...
- [`unarchivedObject(ofClass:from:)`](https://developer.apple.com/documentation/Foundation/NSKeyedUnarchiver/unarchivedObject(ofClass:from:)) and [`unarchivedObject(ofClasses:from:)`](https://developer.apple.com/documentation/Foundation/NSKeyedUnarchiver/unarchivedObject(ofClasses:from:)-b9t5) replace [`unarchiveObject(with:)`](https://developer.apple.com/documentation/Foundation/NSKeyedUnarchiver/unarchiveObject(with:)), [`unarchiveTopLevelObjectWithData(_:)`](https://developer.apple.com/documentation/Foundation/NSKeyedUnarchiver/unarchiveTopLevelObjectWithData(_:)), and [`unarchiveObject(withFile:)`](https://developer.apple.com/documentation/Foundation/NSKeyedUnarchiver/unarchiveObject(withFile:)).
