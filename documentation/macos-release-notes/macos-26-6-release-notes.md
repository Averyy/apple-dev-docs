# macOS Tahoe 26.6 Beta 2 Release Notes
...
The macOS 26.6 SDK provides support to develop apps for Mac computers running Tahoe 26.6 beta 2. The SDK comes bundled with Xcode 26.6, available from the Mac App Store. For information on the compatibility requirements for Xcode 26.6, see [`Xcode 26.6 Release Notes`](https://developer.apple.com/documentation/Xcode-Release-Notes/xcode-26_6-release-notes).
