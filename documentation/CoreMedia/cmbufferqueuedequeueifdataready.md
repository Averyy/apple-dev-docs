...
- `queue`: The   from which to dequeue a buffer (if the buffer is ready).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremedia/cmbufferqueuedequeueifdataready(_:))*