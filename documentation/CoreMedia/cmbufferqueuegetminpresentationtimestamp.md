# CMBufferQueueGetMinPresentationTimeStamp(_:)
...
The search for earliest presentation timstamp is performed in                this API. If you know your queue is sorted by presentation time,                [`CMBufferQueueGetBufferCount(_:)`](cmbufferqueuegetbuffercount(_:).md) is a faster alternative. If the                `getPresentationTimeStamp` callback is `NULL`, kCMTimeInvalid will                be returned.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremedia/cmbufferqueuegetminpresentationtimestamp(_:))*