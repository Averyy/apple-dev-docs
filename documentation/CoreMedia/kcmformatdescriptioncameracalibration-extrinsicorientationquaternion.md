...
```swift
let kCMFormatDescriptionCameraCalibration_ExtrinsicOrientationQuaternion: CFString
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremedia/kcmformatdescriptioncameracalibration_extrinsicorientationquaternion)*