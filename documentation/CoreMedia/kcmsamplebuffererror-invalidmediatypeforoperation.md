...
This error occurs, for example, if you call the [`withUnsafeAudioStreamPacketDescriptions(_:)`](cmsamplebuffer/withunsafeaudiostreampacketdescriptions(_:).md) with nonaudio data.
...
- [var kCMSampleBufferError_InvalidMediaFormat: OSStatus](kcmsamplebuffererror_invalidmediaformat.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremedia/kcmsamplebuffererror_invalidmediatypeforoperation)*