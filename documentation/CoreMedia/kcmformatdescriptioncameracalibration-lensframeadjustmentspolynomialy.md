...
```swift
let kCMFormatDescriptionCameraCalibration_LensFrameAdjustmentsPolynomialY: CFString
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremedia/kcmformatdescriptioncameracalibration_lensframeadjustmentspolynomialy)*