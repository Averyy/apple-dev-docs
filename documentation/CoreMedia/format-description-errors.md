...
### Constants
- [var kCMFormatDescriptionError_InvalidParameter: OSStatus](kcmformatdescriptionerror_invalidparameter.md)
  An error that indicates that the function recieves an empty value for a parameter it requires.
- [var kCMFormatDescriptionError_AllocationFailed: OSStatus](kcmformatdescriptionerror_allocationfailed.md)
  An error that indicates when an allocation fails.
- [var kCMFormatDescriptionError_ValueNotAvailable: OSStatus](kcmformatdescriptionerror_valuenotavailable.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremedia/format-description-errors)*