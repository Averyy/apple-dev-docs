...
- [var kCMSampleBufferError_SampleTimingInfoInvalid: OSStatus](kcmsamplebuffererror_sampletiminginfoinvalid.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremedia/sample-buffer-errors)*