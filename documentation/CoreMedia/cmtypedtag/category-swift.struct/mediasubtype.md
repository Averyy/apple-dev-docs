...
```swift
static var mediaSubType: CMTypedTag<CMFormatDescription.MediaSubType>.Category { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremedia/cmtypedtag/category-swift.struct/mediasubtype)*