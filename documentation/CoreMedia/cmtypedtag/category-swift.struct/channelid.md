...
```swift
static var channelID: CMTypedTag<Int64>.Category { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremedia/cmtypedtag/category-swift.struct/channelid)*