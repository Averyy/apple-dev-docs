...
- `videoFormatDescription`: The   to be copied.
- `stringEncoding`: Pass   or  .
- `flavor`:   constant or   for QuickTimeMovie flavor.
- `blockBufferOut`: Receives a new   containing ImageDescription data structure in big-endian byte ordering.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremedia/cmvideoformatdescriptioncopyasbigendianimagedescriptionblockbuffer(allocator:videoformatdescription:stringencoding:flavor:blockbufferout:))*