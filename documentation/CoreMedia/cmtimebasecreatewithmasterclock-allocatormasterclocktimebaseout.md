...
The timebase will initially have rate zero and time zero. Pass [`CMClockGetHostTimeClock()`](cmclockgethosttimeclock().md)() for masterClock to have the host time clock drive this timebase.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremedia/cmtimebasecreatewithmasterclock(allocator:masterclock:timebaseout:))*