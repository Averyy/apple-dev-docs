...
- `value`: The stereo view interpretation for this tag.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremedia/cmtag-swift.class/stereoviewinterpretation(_:))*