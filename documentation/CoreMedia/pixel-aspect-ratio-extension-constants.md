...
### Constants
- [let kCMFormatDescriptionKey_PixelAspectRatioHorizontalSpacing: CFString](kcmformatdescriptionkey_pixelaspectratiohorizontalspacing-swift.var.md)
  A key that identifies the horizontal spacing of the pixel aspect ratio.
- [let kCMFormatDescriptionKey_PixelAspectRatioVerticalSpacing: CFString](kcmformatdescriptionkey_pixelaspectratioverticalspacing-swift.var.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremedia/pixel-aspect-ratio-extension-constants)*