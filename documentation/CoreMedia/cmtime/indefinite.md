...
Don’t test a time against this constant using (`time ==` [`indefinite`](cmtime/indefinite.md)) because there are many that are also indefinite. Use [`CMTIME_IS_INDEFINITE(_:)`](cmtime_is_indefinite(_:).md) instead.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremedia/cmtime/indefinite)*