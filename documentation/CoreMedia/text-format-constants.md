...
### Constants
- [var kCMTextFormatType_3GText: CMTextFormatType](kcmtextformattype_3gtext.md)
  A type that describes 3GPP text media.
- [var kCMTextFormatType_QTText: CMTextFormatType](kcmtextformattype_qttext.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremedia/text-format-constants)*