...
```swift
var sampleAttachments: CMSampleBuffer.SampleAttachmentsArray { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremedia/cmsamplebuffer/sampleattachments-swift.property)*