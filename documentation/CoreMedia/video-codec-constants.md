...
- [var kCMVideoCodecType_HEVC: CMVideoCodecType](kcmvideocodectype_hevc.md)
  A type that identifies the ITU-T HEVC format.
- [var kCMVideoCodecType_HEVCWithAlpha: CMVideoCodecType](kcmvideocodectype_hevcwithalpha.md)
...
- [var kCMVideoCodecType_JPEG_XL: CMVideoCodecType](kcmvideocodectype_jpeg_xl.md)
...
- [var kCMVideoCodecType_DisparityHEVC: CMVideoCodecType](kcmvideocodectype_disparityhevc.md)
  A type that identifies the disparity HEVC format.
- [var kCMVideoCodecType_DolbyVisionHEVC: CMVideoCodecType](kcmvideocodectype_dolbyvisionhevc.md)
  A type that identifies the Dolby Vision HEVC format.
- [var kCMVideoCodecType_VP9: CMVideoCodecType](kcmvideocodectype_vp9.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremedia/video-codec-constants)*