...
![An illustration showing an example of the Pass Designer tool layout with an event pass.](/images/com.apple.walletpasses/pass-designer-overview@2x.png)
...
![An illustration of two airline boarding passes, one as viewed in iOS 26 and later, and the other as viewed in earlier iOS versions.](/images/com.apple.walletpasses/pass-designer-pass-types-boarding-pass-airline@2x.png)

**Coupon pass**:

Use the coupon pass style for coupons, special offers, and other discounts.

![An illustration of a coupon pass for a food truck.](/images/com.apple.walletpasses/pass-designer-pass-types-coupon@2x.png)
...
![An illustration of a generic pass with a depiction of a gym membership.](/images/com.apple.walletpasses/pass-designer-pass-types-generic@2x.png)
...
![An illustration of a Store Card pass for a coffee shop.](/images/com.apple.walletpasses/pass-designer-pass-types-store-card@2x.png)
...
![An illustration of an event pass for a concert.](/images/com.apple.walletpasses/pass-designer-pass-types-event-ticket@2x.png)
...
![An illustration of a poster generic pass of a museum ticket.](/images/com.apple.walletpasses/pass-designer-pass-types-poster-generic@2x.png)
...
![An image of the Template Picker with the Boarding Pass option selected.](/images/com.apple.walletpasses/pass-designer-template-picker@2x.png)
...
![A screenshot of the Pass Designer workspace layout with callouts for each section of the tool.](/images/com.apple.walletpasses/pass-designer-workspace-layout@2x.png)
...
![A screenshot of the background color selection section of the Pass Designer tool.](/images/com.apple.walletpasses/pass-designer-canvas-color-picker@2x.png)
...
![A screenshot of the component section of the Pass Designer tool, highlighting the Identity & Signing section.](/images/com.apple.walletpasses/pass-designer-components-overview@2x.png)
...
![A screenshot of the Identity & Signing component.](/images/com.apple.walletpasses/pass-designer-identity-and-signing-overview@2x.png)
...
![A screenshot of the Style component.](/images/com.apple.walletpasses/pass-designer-style-overview@2x.png)
...
![A screenshot of the Colors section of the Style component.](/images/com.apple.walletpasses/pass-designer-style-overview-color@2x.png)

The graphic below shows which section of the pass each color field refers to:

![An illustration of a pass with the color fields called out. component.](/images/com.apple.walletpasses/pass-designer-color-layout@2x.png)
...
![An screenshot of the Pass Designer images types.](/images/com.apple.walletpasses/pass-designer-images-overview@2x.png)
...
![An image of the Icon section of the Pass Designer tool.](/images/com.apple.walletpasses/pass-designer-images-icon@2x.png)
...
![An image of the Logo section of the Pass Designer tool.](/images/com.apple.walletpasses/pass-designer-images-logo@2x.png)
...
![An image of a coupon pass with a callout for the logo section of the pass.](/images/com.apple.walletpasses/pass-designer-images-logo-anatomy@2x.png)
...
![A screenshot of the Primary Logo section of the Pass Designer tool.](/images/com.apple.walletpasses/pass-designer-images-primary-logo@2x.png)
...
![An image of the secondary logo.](/images/com.apple.walletpasses/pass-designer-images-secondary-logo@2x.png)
...
![An example of an event pass secondary logo.](/images/com.apple.walletpasses/pass-designer-images-secondary-logo-anatomy@2x.png)
...
![An example of a strip image](/images/com.apple.walletpasses/pass-designer-images-strip@2x.png)
...
![An example of a strip image for a food truck.](/images/com.apple.walletpasses/pass-designer-images-strip-image-anatomy@2x.png)
...
![An example of the thumbnail component in Pass Designer.](/images/com.apple.walletpasses/pass-designer-images-thumbnail@2x.png)
...
![An example of a thumbnail for a gym membership.](/images/com.apple.walletpasses/pass-designer-images-thumbnail-anatomy@2x.png)
...
![An image of the Barcode & NFC section of the Pass Designer tool.](/images/com.apple.walletpasses/pass-designer-barcode-and-nfc-overview@2x.png)
...
![An image of an airline boarding pass with an Aztec barcode.](/images/com.apple.walletpasses/pass-designer-barcode-types-aztec@2x.png)

**Code128**:

![An image of an airline boarding pass with a Code128 barcode.](/images/com.apple.walletpasses/pass-designer-barcode-types-code128@2x.png)

**QR**:

![An image of an airline boarding pass with a QR code.](/images/com.apple.walletpasses/pass-designer-barcode-types-qr@2x.png)

**PDF417**:

![An image of an airline boarding pass with a PDF417 barcode.](/images/com.apple.walletpasses/pass-designer-barcode-types-pdf417@2x.png)

**Code 39**:

![An image of an airline boarding pass with a Code 39 barcode.](/images/com.apple.walletpasses/pass-designer-barcode-types-code-39@2x.png)

**Codabar**:

![An image of an airline boarding pass with a Codabar barcode.](/images/com.apple.walletpasses/pass-designer-barcode-types-codabar@2x.png)

**EAN-13**:

![An image of an airline boarding pass with a EAN-13 barcode.](/images/com.apple.walletpasses/pass-designer-barcode-types-ean-13@2x.png)

**Interleaved 2 of 5 (ITF)**:

![An image of an airline boarding pass with a Interleaved 2 of 5 barcode.](/images/com.apple.walletpasses/pass-designer-barcode-types-interleaved@2x.png)
...
![A screenshot of semantic tags component in Pass Designer.](/images/com.apple.walletpasses/pass-designer-semantic-tags-overview@2x.png)
...
![A screenshot of the text field component in Pass Designer.](/images/com.apple.walletpasses/pass-designer-text-fields-overview@2x.png)
