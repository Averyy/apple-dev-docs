# UpcomingPassInformationEntry.BackFields
...
```swift
object UpcomingPassInformationEntry.BackFields
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/walletpasses/upcomingpassinformationentry/backfields-data.dictionary)*