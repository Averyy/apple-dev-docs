...
If you subclass [`IOUserAudioStereoPanControl`](iouseraudiostereopancontrol.md) to override this class’ behavior, don’t use [`Create`](iouseraudiostereopancontrol/create.md) to allocate and initialize the custom subclass.
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiodriverkit/iouseraudiostereopancontrol/create)*