...
For the corresponding format with the SBR extension, see [`MPEG4AAC_ELD_SBR`](audiodriverkit/iouseraudioformatid/mpeg4aac_eld_sbr.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiodriverkit/audiodriverkit/iouseraudioformatid/mpeg4aac_eld)*