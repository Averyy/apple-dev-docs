...
```swift
static var command: XCUIElement.KeyModifierFlags { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/xcuiautomation/xcuielement/keymodifierflags/command)*