...
```swift
@MainActor
@nonobjc @preconcurrency func swipeRight(withVelocity velocity: XCUIGestureVelocity)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/xcuiautomation/xcuielement/swiperight(withvelocity:))*