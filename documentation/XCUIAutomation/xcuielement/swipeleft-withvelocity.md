...
```swift
@MainActor
@nonobjc @preconcurrency func swipeLeft(withVelocity velocity: XCUIGestureVelocity)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/xcuiautomation/xcuielement/swipeleft(withvelocity:))*