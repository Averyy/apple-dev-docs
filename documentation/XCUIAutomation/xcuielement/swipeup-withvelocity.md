...
```swift
@MainActor
@nonobjc @preconcurrency func swipeUp(withVelocity velocity: XCUIGestureVelocity)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/xcuiautomation/xcuielement/swipeup(withvelocity:))*