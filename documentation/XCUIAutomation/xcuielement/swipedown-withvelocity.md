...
```swift
@MainActor
@nonobjc @preconcurrency func swipeDown(withVelocity velocity: XCUIGestureVelocity)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/xcuiautomation/xcuielement/swipedown(withvelocity:))*