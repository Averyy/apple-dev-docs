...
```swift
@NSCopying
@MainActor var toolbarButtons: XCUIElementQuery { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/xcuiautomation/xcuielementtypequeryprovider/toolbarbuttons)*