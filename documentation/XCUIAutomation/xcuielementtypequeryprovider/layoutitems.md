...
```swift
@NSCopying
@MainActor var layoutItems: XCUIElementQuery { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/xcuiautomation/xcuielementtypequeryprovider/layoutitems)*