...
```swift
@NSCopying
@MainActor var searchFields: XCUIElementQuery { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/xcuiautomation/xcuielementtypequeryprovider/searchfields)*