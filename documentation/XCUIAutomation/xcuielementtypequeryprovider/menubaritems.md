...
```swift
@NSCopying
@MainActor var menuBarItems: XCUIElementQuery { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/xcuiautomation/xcuielementtypequeryprovider/menubaritems)*