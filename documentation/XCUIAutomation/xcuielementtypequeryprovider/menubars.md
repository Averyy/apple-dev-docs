...
```swift
@NSCopying
@MainActor var menuBars: XCUIElementQuery { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/xcuiautomation/xcuielementtypequeryprovider/menubars)*