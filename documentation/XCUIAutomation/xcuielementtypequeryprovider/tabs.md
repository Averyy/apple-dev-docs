...
```swift
@NSCopying
@MainActor var tabs: XCUIElementQuery { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/xcuiautomation/xcuielementtypequeryprovider/tabs)*