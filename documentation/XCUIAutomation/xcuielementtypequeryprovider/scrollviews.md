...
```swift
@NSCopying
@MainActor var scrollViews: XCUIElementQuery { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/xcuiautomation/xcuielementtypequeryprovider/scrollviews)*