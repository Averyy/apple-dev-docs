...
- [XCUIRemoteButton.fourColors](xcuiremotebutton/fourcolors.md)
...
### Initializers
- [init?(rawValue: UInt)](xcuiremotebutton/init(rawvalue:).md)
### Default Implementations
- [Equatable Implementations](xcuiremote/button/equatable-implementations.md)
- [RawRepresentable Implementations](xcuiremote/button/rawrepresentable-implementations.md)
