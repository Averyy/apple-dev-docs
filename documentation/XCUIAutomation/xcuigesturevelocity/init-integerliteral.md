...
- `value`: The integer value to use as the gesture velocity.
...
*[View on Apple Developer](https://developer.apple.com/documentation/xcuiautomation/xcuigesturevelocity/init(integerliteral:))*