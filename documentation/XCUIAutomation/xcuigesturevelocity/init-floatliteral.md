...
```swift
init(floatLiteral value: XCUIGestureVelocity.FloatLiteralType)
```

## Parameters

- `value`: The float value to use as the gesture velocity.
...
*[View on Apple Developer](https://developer.apple.com/documentation/xcuiautomation/xcuigesturevelocity/init(floatliteral:))*