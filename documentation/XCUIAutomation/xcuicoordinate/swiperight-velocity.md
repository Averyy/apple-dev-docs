...
- `velocity`: The speed at which to perform the swipe-right gesture, in pixels per second.
...
*[View on Apple Developer](https://developer.apple.com/documentation/xcuiautomation/xcuicoordinate/swiperight(velocity:))*