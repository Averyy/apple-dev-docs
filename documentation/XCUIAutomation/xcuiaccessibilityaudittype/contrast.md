...
```swift
static var contrast: XCUIAccessibilityAuditType { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/xcuiautomation/xcuiaccessibilityaudittype/contrast)*