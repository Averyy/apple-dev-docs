...
```swift
static var trait: XCUIAccessibilityAuditType { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/xcuiautomation/xcuiaccessibilityaudittype/trait)*