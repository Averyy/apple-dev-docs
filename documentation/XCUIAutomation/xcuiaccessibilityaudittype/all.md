...
```swift
static var all: XCUIAccessibilityAuditType { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/xcuiautomation/xcuiaccessibilityaudittype/all)*