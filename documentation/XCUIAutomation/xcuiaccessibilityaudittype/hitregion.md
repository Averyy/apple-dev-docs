...
```swift
static var hitRegion: XCUIAccessibilityAuditType { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/xcuiautomation/xcuiaccessibilityaudittype/hitregion)*