...
```swift
static var sufficientElementDescription: XCUIAccessibilityAuditType { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/xcuiautomation/xcuiaccessibilityaudittype/sufficientelementdescription)*