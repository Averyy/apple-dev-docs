...
```swift
convenience init(stereoGlobalTapButExcludeProcesses processesIDsToExcludeFromTap: [AudioObjectID])
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreaudio/catapdescription/init(stereoglobaltapbutexcludeprocesses:))*