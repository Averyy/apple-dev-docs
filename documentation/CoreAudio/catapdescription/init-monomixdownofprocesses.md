...
```swift
convenience init(monoMixdownOfProcesses processesIDsToIncludeInTap: [AudioObjectID])
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreaudio/catapdescription/init(monomixdownofprocesses:))*