...
- `inNanos`: A UInt64 containing the nanosecond time to convert.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreaudio/audioconvertnanostohosttime(_:))*