...
```swift
var kSMErrorLaunchDeniedByUser: Int { get }
```
...
- [var kSMErrorAuthorizationFailure: Int](ksmerrorauthorizationfailure.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/servicemanagement/ksmerrorlaunchdeniedbyuser)*