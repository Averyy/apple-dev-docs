...
If `nil`, the system uses [`albumArtist`](itlibalbum/albumartist.md) when sorting by album artist.
...
*[View on Apple Developer](https://developer.apple.com/documentation/ituneslibrary/itlibalbum/sortalbumartist)*