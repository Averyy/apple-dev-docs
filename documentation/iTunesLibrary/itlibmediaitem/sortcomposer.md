...
If `nil`, iTunes uses [`composer`](itlibmediaitem/composer.md) when sorting media items by composer.
...
*[View on Apple Developer](https://developer.apple.com/documentation/ituneslibrary/itlibmediaitem/sortcomposer)*