...
If `nil`, iTunes uses [`title`](itlibmediaitem/title.md) when sorting media items.
...
*[View on Apple Developer](https://developer.apple.com/documentation/ituneslibrary/itlibmediaitem/sorttitle)*