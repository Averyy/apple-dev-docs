...
### Accessor methods
- [func interiorColor() -> NSColor!](pdfannotationsquare/interiorcolor.md)
  Gets the fill color used for drawing the annotation.
- [func setInteriorColor(NSColor!)](pdfannotationsquare/setinteriorcolor(_:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/pdfkit/pdfannotationsquare)*