...
### Accessor methods
- [func interiorColor() -> NSColor!](pdfannotationcircle/interiorcolor.md)
  Returns the fill color used for drawing the annotation.
- [func setInteriorColor(NSColor!)](pdfannotationcircle/setinteriorcolor(_:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/pdfkit/pdfannotationcircle)*