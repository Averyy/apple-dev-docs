...
```swift
- (instancetype)initWithPortaitEffectsMatte:(AVPortraitEffectsMatte *)matte;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/ciimage/2998423-initwithportaiteffectsmatte)*