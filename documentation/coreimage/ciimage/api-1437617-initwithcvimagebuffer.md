...
- `imageBuffer`: A    object in a supported pixel format constant. For more information, see   and  .
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/ciimage/1437617-initwithcvimagebuffer)*