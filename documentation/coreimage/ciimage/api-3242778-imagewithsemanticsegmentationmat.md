...
```swift
+ (instancetype)imageWithSemanticSegmentationMatte:(AVSemanticSegmentationMatte *)matte options:(NSDictionary<CIImageOption, id> *)options;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/ciimage/3242778-imagewithsemanticsegmentationmat)*