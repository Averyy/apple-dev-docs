...
```swift
- (instancetype)initWithSemanticSegmentationMatte:(AVSemanticSegmentationMatte *)matte options:(NSDictionary<CIImageOption, id> *)options;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/ciimage/3242780-initwithsemanticsegmentationmatt)*