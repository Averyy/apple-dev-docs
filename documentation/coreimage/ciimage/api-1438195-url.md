...
#### Discussion
 ...
 A URL is available only if the image object was created with a URL (such as with the [`init(contentsOf:)`](ciimage/1437908-init.md) method or related methods). Otherwise, this property’s value is `nil`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/ciimage/1438195-url)*