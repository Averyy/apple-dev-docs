...
```swift
+ (instancetype)imageWithPortaitEffectsMatte:(AVPortraitEffectsMatte *)matte;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/ciimage/2998419-imagewithportaiteffectsmatte)*