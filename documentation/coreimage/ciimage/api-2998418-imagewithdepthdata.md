...
```swift
+ (instancetype)imageWithDepthData:(AVDepthData *)data options:(NSDictionary<NSString *,id> *)options;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/ciimage/2998418-imagewithdepthdata)*