...
```swift
- (instancetype)initWithPortaitEffectsMatte:(AVPortraitEffectsMatte *)matte options:(NSDictionary<CIImageOption, id> *)options;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/ciimage/2998424-initwithportaiteffectsmatte)*