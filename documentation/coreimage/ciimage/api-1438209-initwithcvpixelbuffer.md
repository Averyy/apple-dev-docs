...
```swift
- (instancetype)initWithCVPixelBuffer:(CVPixelBufferRef)pixelBuffer options:(NSDictionary<CIImageOption, id> *)options;
```
...
- `buffer`: A    object. 
- `dict`: A dictionary that contains options for creating an image object. (See  .) The pixel format is supplied by the   object.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/ciimage/1438209-initwithcvpixelbuffer)*