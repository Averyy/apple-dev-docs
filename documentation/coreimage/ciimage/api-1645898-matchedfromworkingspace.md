...
- `colorSpace`: The color space to be converted to. This color space must conform to the   color space model. 
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/ciimage/1645898-matchedfromworkingspace)*