...
To also render using Metal, use this image with a Metal-based [`CIContext`](cicontext.md) object created with the [`contextWithMTLDevice:`](cicontext/1437609-contextwithmtldevice.md) method, and call the [`render:toMTLTexture:commandBuffer:bounds:colorSpace:`](cicontext/1438026-render.md) method to create an output image in another Metal texture object.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/ciimage/1546999-imagewithmtltexture)*