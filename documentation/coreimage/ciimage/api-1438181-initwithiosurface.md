...
```swift
- (instancetype)initWithIOSurface:(IOSurfaceRef)surface options:(NSDictionary<CIImageOption, id> *)options;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/ciimage/1438181-initwithiosurface)*