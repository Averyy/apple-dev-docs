...
```swift
@property(class, strong, readonly) CIImage *magentaImage;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/ciimage/3074427-magentaimage)*