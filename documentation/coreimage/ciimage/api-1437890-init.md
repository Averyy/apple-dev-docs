...
To render the image using Metal, use this image with a Metal-based [`CIContext`](cicontext.md) object created with the [`init(mtlDevice:)`](cicontext/1437609-init.md) method, and call the [`render(_:to:commandBuffer:bounds:colorSpace:)`](cicontext/1438026-render.md) method to create an output image in another Metal texture object.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/ciimage/1437890-init)*