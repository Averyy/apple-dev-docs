...
```swift
- (instancetype)initWithImage:(UIImage *)image options:(NSDictionary<CIImageOption, id> *)options;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/ciimage/1624098-initwithimage)*