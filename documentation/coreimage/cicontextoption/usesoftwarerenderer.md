...
If the associated [`NSNumber`](https://developer.apple.com/documentation/Foundation/NSNumber) object  is [`true`](https://developer.apple.com/documentation/swift/true), the software renderer is required.
