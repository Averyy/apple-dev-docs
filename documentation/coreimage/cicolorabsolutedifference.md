...
### Instance Properties
- [var inputImage: CIImage?](cicolorabsolutedifference/inputimage.md)
  The first image to use for differencing.
- [var inputImage2: CIImage?](cicolorabsolutedifference/inputimage2.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/cicolorabsolutedifference)*