...
A Core Image color object that represents an RGB color, in the color space specified by the Quartz 2D constant [`kCGColorSpaceGenericRGB`](https://developer.apple.com/documentation/coregraphics/kcgcolorspacegenericrgb), with an alpha value.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/cicolor/1502111-colorwithred)*