...
- [let kCICategoryGenerator: String](kcicategorygenerator.md)
...
- [let kCICategoryInterlaced: String](kcicategoryinterlaced.md)
  A filter that works on interlaced images.
- [let kCICategoryNonSquarePixels: String](kcicategorynonsquarepixels.md)
  A filter that works on non-square pixels.
- [let kCICategoryHighDynamicRange: String](kcicategoryhighdynamicrange.md)
  A filter that works on high dynamic range pixels.
- [let kCICategoryBuiltIn: String](kcicategorybuiltin.md)
  A filter provided by Core Image. This distinguishes built-in filters from plug-in filters.
- [let kCICategoryFilterGenerator: String](kcicategoryfiltergenerator.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/cifilter/filter_category_keys)*