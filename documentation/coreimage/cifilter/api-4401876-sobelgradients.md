...
The following code applies the [`sobelGradientsFilter`](cifilter/4190864-sobelgradientsfilter.md) filter to an image.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/cifilter/4401876-sobelgradients)*