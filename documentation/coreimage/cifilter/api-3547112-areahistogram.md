...
To display the histogram, you can use the [`histogramDisplay()`](cifilter/3547122-histogramdisplay.md) filter:
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/cifilter/3547112-areahistogram)*