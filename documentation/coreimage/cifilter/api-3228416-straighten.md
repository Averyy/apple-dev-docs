...
![Two photographs of a large building on the corner of an intersection. The building has small windows and is made of a brick structure. The photo on the left has no modifications to size or color. In the photo on the right, a straighten filter is applied, resulting in the the image becoming rotated and appearing upside down.](https://docs-assets.developer.apple.com/published/3f16c62d32/rendered2x-1587583588.png)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/cifilter/3228416-straighten)*