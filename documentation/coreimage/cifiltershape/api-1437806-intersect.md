...
- `rect`: A rectangle. Core Image uses the rectangle specified by integer parts of the width and height.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/cifiltershape/1437806-intersect)*