...
If this value is [`true`](https://developer.apple.com/documentation/swift/true), you can adjust the amount of contrast to apply to the image by setting [`contrastAmount`](cirawfilter/3801620-contrastamount.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/cirawfilter/3801621-iscontrastsupported)*