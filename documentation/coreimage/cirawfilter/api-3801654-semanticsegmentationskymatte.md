...
```swift
var semanticSegmentationSkyMatte: CIImage? { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/cirawfilter/3801654-semanticsegmentationskymatte)*