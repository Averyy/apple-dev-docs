...
If this value is [`true`](https://developer.apple.com/documentation/swift/true), you can enable lens correction on the image by setting [`isLensCorrectionEnabled`](cirawfilter/3801632-islenscorrectionenabled.md) to [`true`](https://developer.apple.com/documentation/swift/true).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/cirawfilter/3801633-islenscorrectionsupported)*