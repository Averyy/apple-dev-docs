...
If this value is [`true`](https://developer.apple.com/documentation/swift/true), you can adjust the amount of luminance noise reduction to apply to the image by setting [`luminanceNoiseReductionAmount`](cirawfilter/3801637-luminancenoisereductionamount.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/cirawfilter/3801638-isluminancenoisereductionsupport)*