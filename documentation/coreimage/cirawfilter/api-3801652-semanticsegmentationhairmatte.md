...
```swift
var semanticSegmentationHairMatte: CIImage? { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/cirawfilter/3801652-semanticsegmentationhairmatte)*