...
If this value is [`true`](https://developer.apple.com/documentation/swift/true), you can adjust the amount of moire artifact reduction to apply to the image by setting [`moireReductionAmount`](cirawfilter/3801639-moirereductionamount.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/cirawfilter/3801640-ismoirereductionsupported)*