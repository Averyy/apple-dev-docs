...
If this value is [`true`](https://developer.apple.com/documentation/swift/true), you can adjust the amount of sharpness to apply to the image by setting [`sharpnessAmount`](cirawfilter/3801657-sharpnessamount.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/cirawfilter/3801658-issharpnesssupported)*