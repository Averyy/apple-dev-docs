...
This array is sorted in reverse chronological order. All entries represent a valid version identifier set to [`decoderVersion`](cirawfilter/decoderversion.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/cirawfilter/supporteddecoderversions)*