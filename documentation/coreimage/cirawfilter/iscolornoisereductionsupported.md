...
If this value is [`true`](https://developer.apple.com/documentation/Swift/true), you can adjust the amount of color noise reduction to apply to the image by setting [`colorNoiseReductionAmount`](cirawfilter/colornoisereductionamount.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/cirawfilter/iscolornoisereductionsupported)*