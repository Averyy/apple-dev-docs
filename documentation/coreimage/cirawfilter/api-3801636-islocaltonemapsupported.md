...
If this value is [`true`](https://developer.apple.com/documentation/swift/true), you can adjust the amount of local tone curve to apply to the image by setting [`localToneMapAmount`](cirawfilter/3801635-localtonemapamount.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/cirawfilter/3801636-islocaltonemapsupported)*