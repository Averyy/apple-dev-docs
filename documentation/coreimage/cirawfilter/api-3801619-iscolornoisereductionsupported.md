...
If this value is [`true`](https://developer.apple.com/documentation/swift/true), you can adjust the amount of color noise reduction to apply to the image by setting [`colorNoiseReductionAmount`](cirawfilter/3801618-colornoisereductionamount.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/cirawfilter/3801619-iscolornoisereductionsupported)*