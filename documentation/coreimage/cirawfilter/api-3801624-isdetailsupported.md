...
If this value is [`true`](https://developer.apple.com/documentation/swift/true), you can adjust the amount of detail enhancement to apply to the image by setting [`detailAmount`](cirawfilter/3801623-detailamount.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/cirawfilter/3801624-isdetailsupported)*