...
> **Note**:  Setting this value has no effect if the [`boostAmount`](cirawfilter/boostamount.md) is `0`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/cirawfilter/boostshadowamount)*