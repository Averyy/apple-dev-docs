...
### Type Properties
- [static let none: ArchiveCompression](archivecompression/none.md)
...
- [static let mammoth: ArchiveCompression](archivecompression/mammoth.md)
### Initializers
...
*[View on Apple Developer](https://developer.apple.com/documentation/applearchive/archivecompression)*