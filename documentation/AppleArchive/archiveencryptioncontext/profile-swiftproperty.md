...
```swift
var profile: ArchiveEncryptionContext.Profile { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/applearchive/archiveencryptioncontext/profile-swift.property)*