...
This function opens a stream created by [`randomAccessDecompressionStream(readingFrom:allocationLimit:flags:threadCount:)`](archivebytestream/randomaccessdecompressionstream(readingfrom:allocationlimit:flags:threadcount:).md), calls the specified closure, and closes the stream.
...
*[View on Apple Developer](https://developer.apple.com/documentation/applearchive/archivebytestream/withrandomaccessdecompressionstream(readingfrom:allocationlimit:flags:threadcount:_:))*