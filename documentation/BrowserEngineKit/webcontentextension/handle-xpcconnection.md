...
When your browser app calls [`makeLibXPCConnection()`](webcontentprocess/makelibxpcconnection().md), `BrowserEngineKit` calls this method on your extension, passing the newly created connection as the parameter. To accept the connection, call [`xpc_connection_set_event_handler(_:_:)`](https://developer.apple.com/documentation/XPC/xpc_connection_set_event_handler(_:_:)) to install an event handler and listen for incoming messages.
...
*[View on Apple Developer](https://developer.apple.com/documentation/browserenginekit/webcontentextension/handle(xpcconnection:))*