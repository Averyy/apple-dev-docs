...
If you return `false` from [`textInteractionGesture(_:shouldBeginAt:)`](betextinput/textinteractiongesture(_:shouldbeginat:).md) for the gesture that moves the caret, then the text systen doesn’t call this method.
