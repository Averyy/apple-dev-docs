...
- [func handle(xpcConnection: xpc_connection_t)](webcontentextension/handle(xpcconnection:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/browserenginekit/webcontentextension)*