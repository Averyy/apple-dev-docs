...
```swift
func requestPermission(for url: URL, referrerURL: URL?) async throws -> BEWebContentFilterPermissionDecision
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/browserenginekit/bewebcontentfilter/requestpermission(for:referrerurl:completionhandler:))*