...
```swift
static var descriptionList: BEAccessibilityContainerType { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/browserenginekit/beaccessibilitycontainertype/descriptionlist)*