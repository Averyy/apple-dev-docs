...
```swift
static var scrollArea: BEAccessibilityContainerType { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/browserenginekit/beaccessibilitycontainertype/scrollarea)*