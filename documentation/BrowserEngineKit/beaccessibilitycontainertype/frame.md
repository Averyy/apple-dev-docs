...
```swift
static var frame: BEAccessibilityContainerType { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/browserenginekit/beaccessibilitycontainertype/frame)*