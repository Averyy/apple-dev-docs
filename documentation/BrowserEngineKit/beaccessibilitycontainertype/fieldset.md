...
```swift
static var fieldset: BEAccessibilityContainerType { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/browserenginekit/beaccessibilitycontainertype/fieldset)*