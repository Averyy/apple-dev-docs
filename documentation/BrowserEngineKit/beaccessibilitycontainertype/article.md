...
```swift
static var article: BEAccessibilityContainerType { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/browserenginekit/beaccessibilitycontainertype/article)*