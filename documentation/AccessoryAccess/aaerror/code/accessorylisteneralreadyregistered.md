# AAError.Code.accessoryListenerAlreadyRegistered
...
```swift
case accessoryListenerAlreadyRegistered
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accessoryaccess/aaerror/code/accessorylisteneralreadyregistered)*