...
```swift
nonisolated
init(fetching url: URL, timeout: Duration = .seconds(30), includeSubresources: Bool = true) async throws
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/linkpresentation/linkmetadata/init(fetching:timeout:includesubresources:)-69bj2)*