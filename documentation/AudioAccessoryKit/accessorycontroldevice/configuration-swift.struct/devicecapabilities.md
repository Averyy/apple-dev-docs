...
```swift
var deviceCapabilities: AccessoryControlDevice.Capabilities
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/audioaccessorykit/accessorycontroldevice/configuration-swift.struct/devicecapabilities)*