...
```swift
static let audioSwitching: AccessoryControlDevice.Capabilities
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/audioaccessorykit/accessorycontroldevice/capabilities/audioswitching)*