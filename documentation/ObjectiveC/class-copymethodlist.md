...
To get the implementations of methods that may be implemented by superclasses, use [`class_getInstanceMethod(_:_:)`](class_getinstancemethod(_:_:).md) or [`class_getClassMethod(_:_:)`](class_getclassmethod(_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/objectivec/class_copymethodlist(_:_:))*