...
You should usually use `NSObject`’s [`superclass()`](nsobject-swift.class/superclass().md) method instead of this function.
...
*[View on Apple Developer](https://developer.apple.com/documentation/objectivec/class_getsuperclass(_:))*