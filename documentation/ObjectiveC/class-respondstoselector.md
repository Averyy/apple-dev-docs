...
You should usually use `NSObject`’s [`responds(to:)`](nsobjectprotocol/responds(to:).md) or [`instancesRespond(to:)`](nsobject-swift.class/instancesrespond(to:).md) methods instead of this function.
...
*[View on Apple Developer](https://developer.apple.com/documentation/objectivec/class_respondstoselector(_:_:))*