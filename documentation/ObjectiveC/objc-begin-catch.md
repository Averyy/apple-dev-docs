...
```swift
func objc_begin_catch(_ exc_buf: UnsafeMutableRawPointer) -> Any
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/objectivec/objc_begin_catch(_:))*