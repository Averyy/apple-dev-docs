...
You should usually use `NSObject`’s [`conforms(to:)`](nsobjectprotocol/conforms(to:).md) method instead of this function.
...
*[View on Apple Developer](https://developer.apple.com/documentation/objectivec/class_conformstoprotocol(_:_:))*