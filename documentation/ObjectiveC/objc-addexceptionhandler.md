...
```swift
func objc_addExceptionHandler(_ fn: objc_exception_handler, _ context: UnsafeMutableRawPointer?) -> UInt
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/objectivec/objc_addexceptionhandler(_:_:))*