...
[`class_getMethodImplementation(_:_:)`](class_getmethodimplementation(_:_:).md) may be faster than `method_getImplementation(class_getInstanceMethod(cls, name))`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/objectivec/class_getmethodimplementation(_:_:))*