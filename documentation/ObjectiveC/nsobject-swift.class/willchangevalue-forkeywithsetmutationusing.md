...
- `objects`: The objects that are involved in the change (see [`NSKeyValueSetMutationKind`](https://developer.apple.com/documentation/foundation/nskeyvaluesetmutationkind)).
