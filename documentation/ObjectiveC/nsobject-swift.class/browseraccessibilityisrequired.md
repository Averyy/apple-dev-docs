...
```swift
var browserAccessibilityIsRequired: Bool { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/objectivec/nsobject-swift.class/browseraccessibilityisrequired)*