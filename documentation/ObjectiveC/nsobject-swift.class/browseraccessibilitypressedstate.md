...
```swift
var browserAccessibilityPressedState: BEAccessibilityPressedState { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/objectivec/nsobject-swift.class/browseraccessibilitypressedstate)*