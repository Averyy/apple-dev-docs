...
```swift
func objc_finalizeOnMainThread(_ cls: AnyClass!)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/objectivec/objc_finalizeonmainthread(_:))*