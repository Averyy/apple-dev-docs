...
ReplayKit calls this method when the the broadcasting app calls its [`pauseBroadcast()`](rpbroadcastcontroller/pausebroadcast().md) method.
...
*[View on Apple Developer](https://developer.apple.com/documentation/replaykit/rpbroadcastsamplehandler/broadcastpaused())*