...
ReplayKit calls this method when the the broadcasting app calls its [`startBroadcast(handler:)`](rpbroadcastcontroller/startbroadcast(handler:).md) method.
...
*[View on Apple Developer](https://developer.apple.com/documentation/replaykit/rpbroadcastsamplehandler/broadcaststarted(withsetupinfo:))*