...
ReplayKit calls this method when the the broadcasting app calls its [`resumeBroadcast()`](rpbroadcastcontroller/resumebroadcast().md) method.
...
*[View on Apple Developer](https://developer.apple.com/documentation/replaykit/rpbroadcastsamplehandler/broadcastresumed())*