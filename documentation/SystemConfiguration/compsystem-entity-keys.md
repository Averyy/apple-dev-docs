...
### Constants
- [let kSCPropSystemComputerName: CFString](kscpropsystemcomputername-swift.var.md)
  The CompSystem key `ComputerName`, whose value is of type `CFString`.
- [let kSCPropSystemComputerNameEncoding: CFString](kscpropsystemcomputernameencoding-swift.var.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/systemconfiguration/compsystem-entity-keys)*