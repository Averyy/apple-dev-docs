...
### Constants
- [let kSCPropNet6to4Relay: CFString](kscpropnet6to4relay-swift.var.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/systemconfiguration/6to4-entity-keys)*