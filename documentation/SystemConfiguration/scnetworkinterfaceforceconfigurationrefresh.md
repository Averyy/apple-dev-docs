...
- [`SCPreferencesCreateWithAuthorization(_:_:_:_:)`](scpreferencescreatewithauthorization(_:_:_:_:).md)
- The appropriate `SCNetworkSetCopy...` function, such as [`SCNetworkSetCopyServices(_:)`](scnetworksetcopyservices(_:).md)
- [`SCNetworkServiceGetInterface(_:)`](scnetworkservicegetinterface(_:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/systemconfiguration/scnetworkinterfaceforceconfigurationrefresh(_:))*