...
### Constants
- [let kSCPropNetLocalHostName: CFString](kscpropnetlocalhostname-swift.var.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/systemconfiguration/hostnames-dictionary-keys)*