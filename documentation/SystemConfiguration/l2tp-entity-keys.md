...
### Constants
- [let kSCPropNetL2TPIPSecSharedSecret: CFString](kscpropnetl2tpipsecsharedsecret-swift.var.md)
  The L2TP key `IPSecSharedSecret`, whose value is of type `CFString`.
- [let kSCPropNetL2TPIPSecSharedSecretEncryption: CFString](kscpropnetl2tpipsecsharedsecretencryption-swift.var.md)
  The L2TP key `IPSecSharedSecretEncryption`, whose value is of type `CFString`.
- [let kSCPropNetL2TPTransport: CFString](kscpropnetl2tptransport-swift.var.md)
  The L2TP key `Transport`, whose value is of type `CFString`.
### L2TP Shared Secret Encryption Values
- [let kSCValNetL2TPIPSecSharedSecretEncryptionKeychain: CFString](kscvalnetl2tpipsecsharedsecretencryptionkeychain-swift.var.md)
  The constant value Keychain.
### Transport Values
- [let kSCValNetL2TPTransportIP: CFString](kscvalnetl2tptransportip-swift.var.md)
  The constant value IP.
- [let kSCValNetL2TPTransportIPSec: CFString](kscvalnetl2tptransportipsec-swift.var.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/systemconfiguration/l2tp-entity-keys)*