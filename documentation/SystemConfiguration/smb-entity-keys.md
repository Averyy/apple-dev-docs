...
- [let kSCPropNetSMBNetBIOSNodeType: CFString](kscpropnetsmbnetbiosnodetype-swift.var.md)
...
- [let kSCValNetSMBNetBIOSNodeTypeBroadcast: CFString](kscvalnetsmbnetbiosnodetypebroadcast-swift.var.md)
  The constant value Broadcast.
- [let kSCValNetSMBNetBIOSNodeTypePeer: CFString](kscvalnetsmbnetbiosnodetypepeer-swift.var.md)
  The constant value Peer.
- [let kSCValNetSMBNetBIOSNodeTypeMixed: CFString](kscvalnetsmbnetbiosnodetypemixed-swift.var.md)
  The constant value Mixed.
- [let kSCValNetSMBNetBIOSNodeTypeHybrid: CFString](kscvalnetsmbnetbiosnodetypehybrid-swift.var.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/systemconfiguration/smb-entity-keys)*