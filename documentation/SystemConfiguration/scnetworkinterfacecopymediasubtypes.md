# SCNetworkInterfaceCopyMediaSubTypes(_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/systemconfiguration/scnetworkinterfacecopymediasubtypes(_:))*