...
### Constants
- [let kSCPropNetLinkActive: CFString](kscpropnetlinkactive-swift.var.md)
  The Link key `Active`, whose value is of type `CFBoolean`.
- [let kSCPropNetLinkDetaching: CFString](kscpropnetlinkdetaching-swift.var.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/systemconfiguration/link-entity-keys)*