...
```swift
case greaterThanOrEqualTo = 9
```


---

*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpsraymaskoperator/greaterthanorequalto)*