...
### Initializers
- [init(device: any MTLDevice, a: Float, b: Float, c: Float)](mpscnnneuronlogarithm/init(device:a:b:c:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpscnnneuronlogarithm)*