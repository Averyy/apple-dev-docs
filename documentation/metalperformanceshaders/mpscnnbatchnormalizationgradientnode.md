...
### Initializers
- [init(sourceGradient: MPSNNImageNode, sourceImage: MPSNNImageNode, gradientState: MPSNNGradientStateNode)](mpscnnbatchnormalizationgradientnode/init(sourcegradient:sourceimage:gradientstate:).md)
