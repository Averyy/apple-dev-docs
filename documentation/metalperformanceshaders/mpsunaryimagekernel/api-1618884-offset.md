...
The offset is defined to be the position of the `origin` value of [`clipRect`](mpsunaryimagekernel/1618859-cliprect.md), in source coordinates.
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpsunaryimagekernel/1618884-offset)*