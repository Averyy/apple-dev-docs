...
### Initializers
- [init(device: any MTLDevice)](mpscnnmultiply/2942507-init.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpscnnmultiply)*