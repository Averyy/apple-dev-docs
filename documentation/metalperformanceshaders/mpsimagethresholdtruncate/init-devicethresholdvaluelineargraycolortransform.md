...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpsimagethresholdtruncate/init(device:thresholdvalue:lineargraycolortransform:))*