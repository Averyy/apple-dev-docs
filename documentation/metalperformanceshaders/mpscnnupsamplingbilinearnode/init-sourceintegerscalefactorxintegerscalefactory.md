# init(source:integerScaleFactorX:integerScaleFactorY:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpscnnupsamplingbilinearnode/init(source:integerscalefactorx:integerscalefactory:))*