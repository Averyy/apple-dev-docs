...
```swift
var channelFormat: MPSImageFeatureChannelFormat { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpsimagedescriptor/1648818-channelformat)*