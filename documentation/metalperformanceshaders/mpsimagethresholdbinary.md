...
[`Listing 1`](mpsimagethresholdbinary#2851308.md) shows the threshold binary function.
...
### Initializers
- [init?(coder: NSCoder, device: any MTLDevice)](mpsimagethresholdbinary/2865668-init.md)
### Methods
- [init(device: any MTLDevice, thresholdValue: Float, maximumValue: Float, linearGrayColorTransform: UnsafePointer<Float>?)](mpsimagethresholdbinary/1618855-init.md)
  Initializes the kernel.
### Properties
- [var thresholdValue: Float](mpsimagethresholdbinary/1618851-thresholdvalue.md)
  The threshold value used to initialize the threshold filter.
- [var maximumValue: Float](mpsimagethresholdbinary/1618852-maximumvalue.md)
  The maximum value used to initialize the threshold filter.
- [var transform: UnsafePointer<Float>](mpsimagethresholdbinary/1618744-transform.md)
