# batchEncodingStorageSize(primaryImage:secondaryImage:sourceStates:destinationImage:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpscnnbinarykernel/batchencodingstoragesize(primaryimage:secondaryimage:sourcestates:destinationimage:))*