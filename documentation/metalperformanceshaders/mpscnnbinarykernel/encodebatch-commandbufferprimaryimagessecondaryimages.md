# encodeBatch(commandBuffer:primaryImages:secondaryImages:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpscnnbinarykernel/encodebatch(commandbuffer:primaryimages:secondaryimages:))*