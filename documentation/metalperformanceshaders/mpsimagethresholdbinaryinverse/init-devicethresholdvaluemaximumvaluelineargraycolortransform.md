...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpsimagethresholdbinaryinverse/init(device:thresholdvalue:maximumvalue:lineargraycolortransform:))*