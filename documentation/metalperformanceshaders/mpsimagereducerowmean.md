...
### Initializers
- [init(device: any MTLDevice)](mpsimagereducerowmean/2942322-init.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpsimagereducerowmean)*