...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpscnndropout/resultstatebatch(sourceimage:sourcestates:destinationimage:))*