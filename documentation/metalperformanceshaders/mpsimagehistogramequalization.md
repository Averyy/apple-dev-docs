...
### Initializers
- [init?(coder: NSCoder, device: any MTLDevice)](mpsimagehistogramequalization/init(coder:device:).md)
### Methods
...
### Properties
- [var histogramInfo: MPSImageHistogramInfo](mpsimagehistogramequalization/histograminfo.md)
