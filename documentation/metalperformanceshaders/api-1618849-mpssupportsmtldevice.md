...
- [`true`](https://developer.apple.com/documentation/swift/true) if the device is supported.
- [`false`](https://developer.apple.com/documentation/swift/false) if the device is not supported.
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/1618849-mpssupportsmtldevice)*