...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpscnnconvolutiontranspose/temporaryresultstate(commandbuffer:sourceimage:sourcestates:destinationimage:))*