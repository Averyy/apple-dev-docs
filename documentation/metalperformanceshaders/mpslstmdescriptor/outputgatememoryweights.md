...
```swift
var outputGateMemoryWeights: (any MPSCNNConvolutionDataSource)? { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpslstmdescriptor/outputgatememoryweights)*