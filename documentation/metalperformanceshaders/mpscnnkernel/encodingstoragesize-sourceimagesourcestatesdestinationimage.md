...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpscnnkernel/encodingstoragesize(sourceimage:sourcestates:destinationimage:))*