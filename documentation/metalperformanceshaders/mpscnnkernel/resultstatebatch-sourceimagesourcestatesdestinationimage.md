...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpscnnkernel/resultstatebatch(sourceimage:sourcestates:destinationimage:))*