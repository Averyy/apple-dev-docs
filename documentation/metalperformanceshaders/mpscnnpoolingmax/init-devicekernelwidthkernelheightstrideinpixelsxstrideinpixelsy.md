...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpscnnpoolingmax/init(device:kernelwidth:kernelheight:strideinpixelsx:strideinpixelsy:))*