...
consuming func slice(at ranges: [any NDArray.RangeExpression]) -> NDArray.MutableRawView
```
...
> **Note**: If you need to avoid `consuming` the view which this is called on, you can use [`mutatingSlice(at:)`](ndarray/mutablerawview/mutatingslice(at:)-5ts4w.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreai/ndarray/mutablerawview/slice(at:)-82sdj)*