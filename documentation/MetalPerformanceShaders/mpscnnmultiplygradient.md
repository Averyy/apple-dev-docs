...
### Initializers
- [init(device: any MTLDevice, isSecondarySourceFilter: Bool)](mpscnnmultiplygradient/init(device:issecondarysourcefilter:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpscnnmultiplygradient)*