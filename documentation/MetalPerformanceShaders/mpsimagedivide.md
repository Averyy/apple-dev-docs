...
### Initializers
- [init(device: any MTLDevice)](mpsimagedivide/init(device:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpsimagedivide)*