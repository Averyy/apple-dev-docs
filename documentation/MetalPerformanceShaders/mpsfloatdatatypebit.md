...
### Initializers
- [init?(rawValue: UInt32)](mpsfloatdatatypebit/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpsfloatdatatypebit)*