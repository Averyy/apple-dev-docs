...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpscnnkernel/encodebatch(commandbuffer:sourceimages:destinationstates:destinationimages:))*