...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpscnnkernel/batchencodingstoragesize(sourceimage:sourcestates:destinationimage:))*