# encode(to:sourceArrays:resultState:destinationArray:)
...
```swift
func encode(to cmdBuf: any MTL4CommandBuffer, sourceArrays: [MPSNDArray], resultState outGradientState: MPSState?, destinationArray destination: MPSNDArray)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpsndarraymultiarykernel/encode(to:sourcearrays:resultstate:destinationarray:)-9acjx)*