...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpsnngraph/encode(to:sourceimages:sourcestates:intermediateimages:destinationstates:))*