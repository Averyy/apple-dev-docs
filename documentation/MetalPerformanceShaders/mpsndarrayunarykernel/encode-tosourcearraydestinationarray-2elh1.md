...
```swift
func encode(to cmdBuf: any MTLCommandBuffer, sourceArray: MPSNDArray, destinationArray destination: MPSNDArray)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpsndarrayunarykernel/encode(to:sourcearray:destinationarray:)-2elh1)*