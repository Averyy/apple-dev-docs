...
### Initializers
- [init(source: MPSNNImageNode, aData: Data)](mpscnnneuronprelunode/init(source:adata:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpscnnneuronprelunode)*