...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpscnnbatchnormalization/encode(to:sourceimage:batchnormalizationstate:destinationimage:))*