...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpscnnbinaryfullyconnected/init(device:convolutiondata:scalevalue:type:flags:))*