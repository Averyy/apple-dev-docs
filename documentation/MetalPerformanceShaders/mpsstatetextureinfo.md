...
### Initializers
- [init()](mpsstatetextureinfo/init.md)
### Instance Properties
- [var arrayLength: Int](mpsstatetextureinfo/arraylength.md)
- [var depth: Int](mpsstatetextureinfo/depth.md)
- [var height: Int](mpsstatetextureinfo/height.md)
- [var pixelFormat: MTLPixelFormat](mpsstatetextureinfo/pixelformat.md)
- [var textureType: MTLTextureType](mpsstatetextureinfo/texturetype.md)
- [var usage: MTLTextureUsage](mpsstatetextureinfo/usage.md)
- [var width: Int](mpsstatetextureinfo/width.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpsstatetextureinfo)*