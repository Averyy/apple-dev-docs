...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshaders/mpscnnbinarykernel/encode(commandbuffer:primaryimage:secondaryimage:))*