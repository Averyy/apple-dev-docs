...
Calling [`init(api:)`](eaglcontext/init(api:)-q09o.md) creates a new [`EAGLSharegroup`](eaglsharegroup.md) object and attaches it to this context.
...
*[View on Apple Developer](https://developer.apple.com/documentation/opengles/eaglcontext/init(api:)-q09o)*