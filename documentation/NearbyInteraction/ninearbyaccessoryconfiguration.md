...
- [init(bluetoothChannelSoundingIdentifier: UUID, previousBluetoothIdentifier: UUID?)](ninearbyaccessoryconfiguration/init(bluetoothchannelsoundingidentifier:previousbluetoothidentifier:).md)
