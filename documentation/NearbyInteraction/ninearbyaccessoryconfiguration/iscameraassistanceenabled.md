...
When `true`, this property leverages [`ARKit`](https://developer.apple.com/documentation/ARKit) to provide a nearby object’s [`distance`](ninearbyobject/distance-676dm.md) and [`direction`](ninearbyobject/direction-4qh5w.md) in a wider range of environmental conditions.
...
*[View on Apple Developer](https://developer.apple.com/documentation/nearbyinteraction/ninearbyaccessoryconfiguration/iscameraassistanceenabled)*