...
The framework invalidates a session with this error code if the app provides an invalid discovery token to the [`init(peerToken:)`](ninearbypeerconfiguration/init(peertoken:).md) initializer.
...
*[View on Apple Developer](https://developer.apple.com/documentation/nearbyinteraction/nierror/code/invalidconfiguration)*