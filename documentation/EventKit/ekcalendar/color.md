...
This property is the equivalent of the [`cgColor`](ekcalendar/cgcolor.md) property on iOS.
...
*[View on Apple Developer](https://developer.apple.com/documentation/eventkit/ekcalendar/color)*