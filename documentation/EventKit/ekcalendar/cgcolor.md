...
This property is the equivalent of the [`color`](ekcalendar/color.md) property in macOS.
...
*[View on Apple Developer](https://developer.apple.com/documentation/eventkit/ekcalendar/cgcolor)*