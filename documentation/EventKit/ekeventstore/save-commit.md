...
- `commit`: A Boolean value that indicates whether to save the reminder immediately or to batch the changes. Passing   won’t commit changes to the event store until the   method is invoked.
...
*[View on Apple Developer](https://developer.apple.com/documentation/eventkit/ekeventstore/save(_:commit:))*