...
- `commit`: [`true`](https://developer.apple.com/documentation/Swift/true) to remove the calendar immediately; otherwise, the change is batched until the [`commit()`](ekeventstore/commit().md) method is invoked.
