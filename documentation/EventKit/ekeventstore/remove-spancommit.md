...
- `commit`:   to remove the event immediately; otherwise, the change is batched until the   method is invoked.
...
*[View on Apple Developer](https://developer.apple.com/documentation/eventkit/ekeventstore/remove(_:span:commit:))*