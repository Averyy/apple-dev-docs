...
```swift
class var buttonLeftTrigger: TCControlLabel { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/touchcontroller/tccontrollabel/buttonlefttrigger)*