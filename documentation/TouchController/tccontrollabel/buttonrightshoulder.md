...
```swift
class var buttonRightShoulder: TCControlLabel { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/touchcontroller/tccontrollabel/buttonrightshoulder)*