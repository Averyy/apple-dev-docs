...
```swift
class var leftThumbstickButton: TCControlLabel { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/touchcontroller/tccontrollabel/leftthumbstickbutton)*