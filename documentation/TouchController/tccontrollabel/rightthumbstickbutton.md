...
```swift
class func rightThumbstickButton() -> Self
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/touchcontroller/tccontrollabel/rightthumbstickbutton())*