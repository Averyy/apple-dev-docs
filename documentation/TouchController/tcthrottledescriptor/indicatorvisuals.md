...
```swift
var indicatorVisuals: TCControlVisuals? { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/touchcontroller/tcthrottledescriptor/indicatorvisuals)*