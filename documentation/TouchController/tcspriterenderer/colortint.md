...
```swift
unowned(unsafe) var colorTint: CGColor { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/touchcontroller/tcspriterenderer/colortint)*