...
```swift
func removeTouchpad(_ touchpad: TCTouchpad)
```

## Parameters

- `touchpad`: The   to remove.
...
*[View on Apple Developer](https://developer.apple.com/documentation/touchcontroller/tctouchcontroller/removetouchpad(_:))*