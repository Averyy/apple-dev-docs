...
```swift
func removeThrottle(_ throttle: TCThrottle)
```

## Parameters

- `throttle`: The   to remove.
...
*[View on Apple Developer](https://developer.apple.com/documentation/touchcontroller/tctouchcontroller/removethrottle(_:))*