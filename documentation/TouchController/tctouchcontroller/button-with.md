...
```swift
func button(with descriptor: TCButtonDescriptor) -> TCButton
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/touchcontroller/tctouchcontroller/button(with:))*