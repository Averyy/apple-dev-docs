...
```swift
func removeThumbstick(_ button: TCThumbstick)
```

## Parameters

- `button`: The   to remove.
...
*[View on Apple Developer](https://developer.apple.com/documentation/touchcontroller/tctouchcontroller/removethumbstick(_:))*