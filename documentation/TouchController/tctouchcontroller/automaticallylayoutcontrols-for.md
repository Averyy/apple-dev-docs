# automaticallyLayoutControls(for:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/touchcontroller/tctouchcontroller/automaticallylayoutcontrols(for:))*