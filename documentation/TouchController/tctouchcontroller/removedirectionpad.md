...
```swift
func removeDirectionPad(_ directionPad: TCDirectionPad)
```

## Parameters

- `directionPad`: The   to remove.
...
*[View on Apple Developer](https://developer.apple.com/documentation/touchcontroller/tctouchcontroller/removedirectionpad(_:))*