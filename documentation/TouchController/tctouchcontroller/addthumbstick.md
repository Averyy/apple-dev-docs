...
```swift
func addThumbstick(_ button: TCThumbstick)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/touchcontroller/tctouchcontroller/addthumbstick(_:))*