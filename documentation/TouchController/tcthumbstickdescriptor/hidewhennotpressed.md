...
```swift
var hideWhenNotPressed: Bool { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/touchcontroller/tcthumbstickdescriptor/hidewhennotpressed)*