...
```swift
var downVisuals: TCControlVisuals? { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/touchcontroller/tcdirectionpaddescriptor/downvisuals)*