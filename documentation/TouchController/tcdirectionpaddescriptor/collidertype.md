...
```swift
var colliderType: TCColliderType { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/touchcontroller/tcdirectionpaddescriptor/collidertype)*