...
```swift
var downContents: TCControlContents? { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/touchcontroller/tcdirectionpaddescriptor/downcontents)*