...
```swift
var leftVisuals: TCControlVisuals? { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/touchcontroller/tcdirectionpaddescriptor/leftvisuals)*