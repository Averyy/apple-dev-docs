# nw_establishment_report_get_used_proxy(_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_establishment_report_get_used_proxy(_:))*