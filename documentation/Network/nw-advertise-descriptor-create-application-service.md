# nw_advertise_descriptor_create_application_service(_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_advertise_descriptor_create_application_service(_:))*