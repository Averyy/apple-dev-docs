# nw_advertise_descriptor_copy_txt_record_object(_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_advertise_descriptor_copy_txt_record_object(_:))*