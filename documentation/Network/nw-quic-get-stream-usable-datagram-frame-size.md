# nw_quic_get_stream_usable_datagram_frame_size(_:)
...
```swift
func nw_quic_get_stream_usable_datagram_frame_size(_ metadata: nw_protocol_metadata_t) -> UInt16
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_quic_get_stream_usable_datagram_frame_size(_:))*