# nw_quic_set_stream_application_error(_:_:)
...
```swift
func nw_quic_set_stream_application_error(_ metadata: nw_protocol_metadata_t, _ application_error: UInt64)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_quic_set_stream_application_error(_:_:))*