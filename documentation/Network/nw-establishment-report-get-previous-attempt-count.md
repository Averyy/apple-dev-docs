# nw_establishment_report_get_previous_attempt_count(_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_establishment_report_get_previous_attempt_count(_:))*