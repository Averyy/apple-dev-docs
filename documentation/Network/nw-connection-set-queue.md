...
```swift
func nw_connection_set_queue(_ connection: nw_connection_t, _ queue: dispatch_queue_t)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_connection_set_queue(_:_:))*