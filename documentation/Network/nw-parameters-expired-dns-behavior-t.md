...
- [init(UInt32)](nw_parameters_expired_dns_behavior_t/init(_:).md)
  Creates an instance of the expired DNS behavior structure.
- [init(rawValue: UInt32)](nw_parameters_expired_dns_behavior_t/init(rawvalue:).md)
  Creates an instance of the expired DNS behavior structure.
### Expired DNS behaviors
- [var nw_parameters_expired_dns_behavior_default: nw_parameters_expired_dns_behavior_t](nw_parameters_expired_dns_behavior_default.md)
  Let the system determine whether or not to allow expired DNS answers.
- [var nw_parameters_expired_dns_behavior_allow: nw_parameters_expired_dns_behavior_t](nw_parameters_expired_dns_behavior_allow.md)
  Explicitly allow the use of expired DNS answers.
- [var nw_parameters_expired_dns_behavior_prohibit: nw_parameters_expired_dns_behavior_t](nw_parameters_expired_dns_behavior_prohibit.md)
  Explicitly prohibit the use of expired DNS answers.
### Accessing the raw value
- [var rawValue: UInt32](nw_parameters_expired_dns_behavior_t/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_parameters_expired_dns_behavior_t)*