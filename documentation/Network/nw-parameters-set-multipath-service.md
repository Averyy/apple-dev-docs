# nw_parameters_set_multipath_service(_:_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_parameters_set_multipath_service(_:_:))*