# nw_quic_set_initial_max_streams_bidirectional(_:_:)
...
```swift
func nw_quic_set_initial_max_streams_bidirectional(_ options: nw_protocol_options_t, _ initial_max_streams_bidirectional: UInt64)
```

## Parameters

- `options`: A QUIC protocol options instance.
- `initial_max_streams_bidirectional`: The value of the `initial_max_streams_bidi` transport parameter.
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_quic_set_initial_max_streams_bidirectional(_:_:))*