...
- [var nw_ethernet_channel_state_ready: nw_ethernet_channel_state_t](nw_ethernet_channel_state_ready.md)
...
### Initializers
- [init(UInt32)](nw_ethernet_channel_state_t/init(_:).md)
- [init(rawValue: UInt32)](nw_ethernet_channel_state_t/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](nw_ethernet_channel_state_t/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_ethernet_channel_state_t)*