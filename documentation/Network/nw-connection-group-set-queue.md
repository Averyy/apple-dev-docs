...
```swift
func nw_connection_group_set_queue(_ group: nw_connection_group_t, _ queue: dispatch_queue_t)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_connection_group_set_queue(_:_:))*