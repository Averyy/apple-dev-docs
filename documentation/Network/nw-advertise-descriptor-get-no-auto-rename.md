# nw_advertise_descriptor_get_no_auto_rename(_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_advertise_descriptor_get_no_auto_rename(_:))*