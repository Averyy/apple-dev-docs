# nw_content_context_get_expiration_milliseconds(_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_content_context_get_expiration_milliseconds(_:))*