# nw_quic_set_max_datagram_frame_size(_:_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_quic_set_max_datagram_frame_size(_:_:))*