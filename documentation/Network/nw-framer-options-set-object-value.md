# nw_framer_options_set_object_value(_:_:_:)
...
```swift
func nw_framer_options_set_object_value(_ options: nw_protocol_options_t, _ key: UnsafePointer<CChar>, _ value: Any?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_framer_options_set_object_value(_:_:_:))*