# nw_parameters_set_include_peer_to_peer(_:_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_parameters_set_include_peer_to_peer(_:_:))*