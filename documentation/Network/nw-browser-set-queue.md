...
```swift
func nw_browser_set_queue(_ browser: nw_browser_t, _ queue: dispatch_queue_t)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_browser_set_queue(_:_:))*