# nw_advertise_descriptor_set_txt_record_object(_:_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_advertise_descriptor_set_txt_record_object(_:_:))*