...
```swift
typealias nw_group_descriptor_t = any OS_nw_group_descriptor
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_group_descriptor_t)*