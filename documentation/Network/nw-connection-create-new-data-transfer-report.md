# nw_connection_create_new_data_transfer_report(_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_connection_create_new_data_transfer_report(_:))*