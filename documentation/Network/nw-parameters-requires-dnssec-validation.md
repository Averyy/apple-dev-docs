# nw_parameters_requires_dnssec_validation(_:)
...
```swift
func nw_parameters_requires_dnssec_validation(_ parameters: nw_parameters_t) -> Bool
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_parameters_requires_dnssec_validation(_:))*