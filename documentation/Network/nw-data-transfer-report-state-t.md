...
### Report States
- [var nw_data_transfer_report_state_collecting: nw_data_transfer_report_state_t](nw_data_transfer_report_state_collecting.md)
  The data transfer report has been started but is still collecting data.
- [var nw_data_transfer_report_state_collected: nw_data_transfer_report_state_t](nw_data_transfer_report_state_collected.md)
  The data transfer report has completed, and data can be examined.
### Initializers
- [init(UInt32)](nw_data_transfer_report_state_t/init(_:).md)
- [init(rawValue: UInt32)](nw_data_transfer_report_state_t/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](nw_data_transfer_report_state_t/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_data_transfer_report_state_t)*