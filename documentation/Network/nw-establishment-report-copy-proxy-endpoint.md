# nw_establishment_report_copy_proxy_endpoint(_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_establishment_report_copy_proxy_endpoint(_:))*