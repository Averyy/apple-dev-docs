# nw_proxy_config_enumerate_excluded_domains(_:_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_proxy_config_enumerate_excluded_domains(_:_:))*