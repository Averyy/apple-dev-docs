# nw_data_transfer_report_get_duration_milliseconds(_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_data_transfer_report_get_duration_milliseconds(_:))*