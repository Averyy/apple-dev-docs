# nw_quic_get_initial_max_stream_data_bidirectional_remote(_:)
...
```swift
func nw_quic_get_initial_max_stream_data_bidirectional_remote(_ options: nw_protocol_options_t) -> UInt64
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_quic_get_initial_max_stream_data_bidirectional_remote(_:))*