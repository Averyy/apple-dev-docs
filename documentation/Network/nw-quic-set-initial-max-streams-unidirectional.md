# nw_quic_set_initial_max_streams_unidirectional(_:_:)
...
```swift
func nw_quic_set_initial_max_streams_unidirectional(_ options: nw_protocol_options_t, _ initial_max_streams_unidirectional: UInt64)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_quic_set_initial_max_streams_unidirectional(_:_:))*