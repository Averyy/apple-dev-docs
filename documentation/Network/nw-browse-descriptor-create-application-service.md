# nw_browse_descriptor_create_application_service(_:)
...
```swift
func nw_browse_descriptor_create_application_service(_ application_service_name: UnsafePointer<CChar>) -> nw_browse_descriptor_t
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_browse_descriptor_create_application_service(_:))*