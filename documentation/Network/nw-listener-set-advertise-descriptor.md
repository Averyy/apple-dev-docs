# nw_listener_set_advertise_descriptor(_:_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_listener_set_advertise_descriptor(_:_:))*