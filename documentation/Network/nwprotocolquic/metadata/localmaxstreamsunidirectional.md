...
```swift
var localMaxStreamsUnidirectional: Int { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nwprotocolquic/metadata/localmaxstreamsunidirectional)*