# nw_parameters_set_expired_dns_behavior(_:_:)
...
- [func nw_parameters_get_fast_open_enabled(nw_parameters_t) -> Bool](nw_parameters_get_fast_open_enabled(_:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_parameters_set_expired_dns_behavior(_:_:))*