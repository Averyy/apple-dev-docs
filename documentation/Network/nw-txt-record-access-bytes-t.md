...
The return value is passed back to the caller of [`nw_txt_record_access_bytes(_:_:)`](nw_txt_record_access_bytes(_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_txt_record_access_bytes_t)*