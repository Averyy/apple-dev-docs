# nw_proxy_config_enumerate_match_domains(_:_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_proxy_config_enumerate_match_domains(_:_:))*