...
```swift
func nw_advertise_descriptor_get_application_service_name(_ advertise_descriptor: nw_advertise_descriptor_t) -> UnsafePointer<CChar>?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_advertise_descriptor_get_application_service_name(_:))*