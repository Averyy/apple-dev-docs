# nw_proxy_config_clear_excluded_domains(_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_proxy_config_clear_excluded_domains(_:))*