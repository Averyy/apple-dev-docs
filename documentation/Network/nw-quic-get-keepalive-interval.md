# nw_quic_get_keepalive_interval(_:)
...
```swift
func nw_quic_get_keepalive_interval(_ metadata: nw_protocol_metadata_t) -> UInt16
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_quic_get_keepalive_interval(_:))*