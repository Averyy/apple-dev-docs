# nw_parameters_set_requires_dnssec_validation(_:_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_parameters_set_requires_dnssec_validation(_:_:))*