...
- `max_udp_payload_size`: The maximum length of a QUIC packet, in bytes.
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_quic_set_max_udp_payload_size(_:_:))*