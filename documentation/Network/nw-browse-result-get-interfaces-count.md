# nw_browse_result_get_interfaces_count(_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_browse_result_get_interfaces_count(_:))*