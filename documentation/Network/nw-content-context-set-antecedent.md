# nw_content_context_set_antecedent(_:_:)
...
```swift
func nw_content_context_set_antecedent(_ context: nw_content_context_t, _ antecedent_context: nw_content_context_t?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_content_context_set_antecedent(_:_:))*