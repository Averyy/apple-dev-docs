...
- [var nw_error_domain_invalid: nw_error_domain_t](nw_error_domain_invalid.md)
  The error is invalid.
- [var nw_error_domain_posix: nw_error_domain_t](nw_error_domain_posix.md)
  A POSIX error, which is used for most network protocol and routing errors.
- [var nw_error_domain_dns: nw_error_domain_t](nw_error_domain_dns.md)
  A DNS error encountered in resolving, browsing, or advertising.
- [var nw_error_domain_tls: nw_error_domain_t](nw_error_domain_tls.md)
  A TLS error reported by a TLS connection or listener.
### CFError Domain Constants
- [let kNWErrorDomainPOSIX: CFString](knwerrordomainposix.md)
  A POSIX error, which is used for most network protocol and routing errors.
- [let kNWErrorDomainDNS: CFString](knwerrordomaindns.md)
  A DNS error encountered in resolving, browsing, or advertising.
- [let kNWErrorDomainTLS: CFString](knwerrordomaintls.md)
  A TLS error reported by a TLS connection or listener.
### Initializers
- [init(UInt32)](nw_error_domain_t/init(_:).md)
- [init(rawValue: UInt32)](nw_error_domain_t/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](nw_error_domain_t/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_error_domain_t)*