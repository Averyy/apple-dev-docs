# nw_browse_descriptor_get_include_txt_record(_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_browse_descriptor_get_include_txt_record(_:))*