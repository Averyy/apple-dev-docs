# nw_connection_group_copy_protocol_metadata_for_message(_:_:_:)
...
```swift
func nw_connection_group_copy_protocol_metadata_for_message(_ group: nw_connection_group_t, _ context: nw_content_context_t, _ definition: nw_protocol_definition_t) -> nw_protocol_metadata_t?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_connection_group_copy_protocol_metadata_for_message(_:_:_:))*