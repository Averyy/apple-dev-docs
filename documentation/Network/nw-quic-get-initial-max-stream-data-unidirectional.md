# nw_quic_get_initial_max_stream_data_unidirectional(_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_quic_get_initial_max_stream_data_unidirectional(_:))*