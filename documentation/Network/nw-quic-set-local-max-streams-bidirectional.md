...
- `max_streams_bidirectional`: The maximum number of bidirectional streams that the peer can create.
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_quic_set_local_max_streams_bidirectional(_:_:))*