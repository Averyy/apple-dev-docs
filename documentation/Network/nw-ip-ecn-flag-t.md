...
### ECN Flags
- [var nw_ip_ecn_flag_non_ect: nw_ip_ecn_flag_t](nw_ip_ecn_flag_non_ect.md)
  Non-ECN Capable Transport.
- [var nw_ip_ecn_flag_ect_0: nw_ip_ecn_flag_t](nw_ip_ecn_flag_ect_0.md)
  ECN Capable Transport (flag 0).
- [var nw_ip_ecn_flag_ect_1: nw_ip_ecn_flag_t](nw_ip_ecn_flag_ect_1.md)
  ECN Capable Transport (flag 1).
- [var nw_ip_ecn_flag_ce: nw_ip_ecn_flag_t](nw_ip_ecn_flag_ce.md)
  Congestion Experienced.
### Initializers
- [init(UInt32)](nw_ip_ecn_flag_t/init(_:).md)
- [init(rawValue: UInt32)](nw_ip_ecn_flag_t/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](nw_ip_ecn_flag_t/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_ip_ecn_flag_t)*