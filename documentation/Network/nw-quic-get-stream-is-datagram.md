# nw_quic_get_stream_is_datagram(_:)
...
```swift
func nw_quic_get_stream_is_datagram(_ options: nw_protocol_options_t) -> Bool
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_quic_get_stream_is_datagram(_:))*