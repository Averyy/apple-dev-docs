# nw_ip_options_set_calculate_receive_time(_:_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_ip_options_set_calculate_receive_time(_:_:))*