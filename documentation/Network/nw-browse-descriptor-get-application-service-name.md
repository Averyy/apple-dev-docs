# nw_browse_descriptor_get_application_service_name(_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_browse_descriptor_get_application_service_name(_:))*