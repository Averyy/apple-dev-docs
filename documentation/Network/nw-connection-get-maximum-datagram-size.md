# nw_connection_get_maximum_datagram_size(_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_connection_get_maximum_datagram_size(_:))*