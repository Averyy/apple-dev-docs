# nw_browser_set_browse_results_changed_handler(_:_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_browser_set_browse_results_changed_handler(_:_:))*