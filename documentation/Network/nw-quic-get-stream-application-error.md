# nw_quic_get_stream_application_error(_:)
...
```swift
func nw_quic_get_stream_application_error(_ metadata: nw_protocol_metadata_t) -> UInt64
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_quic_get_stream_application_error(_:))*