# nw_quic_get_max_datagram_frame_size(_:)
...
```swift
func nw_quic_get_max_datagram_frame_size(_ options: nw_protocol_options_t) -> UInt16
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_quic_get_max_datagram_frame_size(_:))*