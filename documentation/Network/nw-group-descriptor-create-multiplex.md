# nw_group_descriptor_create_multiplex(_:)
...
```swift
func nw_group_descriptor_create_multiplex(_ remote_endpoint: nw_endpoint_t) -> nw_group_descriptor_t
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_group_descriptor_create_multiplex(_:))*