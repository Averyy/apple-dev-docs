...
```swift
@preconcurrency
final var stateUpdateHandler: (@Sendable (NWConnectionGroup.State) -> Void)? { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nwconnectiongroup/stateupdatehandler)*