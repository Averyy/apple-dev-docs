# nw_browse_descriptor_set_include_txt_record(_:_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_browse_descriptor_set_include_txt_record(_:_:))*