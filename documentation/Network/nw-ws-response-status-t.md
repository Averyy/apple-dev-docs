...
- [var nw_ws_response_status_invalid: nw_ws_response_status_t](nw_ws_response_status_invalid.md)
  An invalid response status.
- [var nw_ws_response_status_accept: nw_ws_response_status_t](nw_ws_response_status_accept.md)
  The client request is being accepted.
- [var nw_ws_response_status_reject: nw_ws_response_status_t](nw_ws_response_status_reject.md)
  The client request is being rejected.
### Initializers
- [init(UInt32)](nw_ws_response_status_t/init(_:).md)
- [init(rawValue: UInt32)](nw_ws_response_status_t/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](nw_ws_response_status_t/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_ws_response_status_t)*