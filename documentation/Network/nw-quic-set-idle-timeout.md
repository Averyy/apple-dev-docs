...
- `idle_timeout`: An idle timeout value, in milliseconds.
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_quic_set_idle_timeout(_:_:))*