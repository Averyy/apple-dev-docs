# nw_quic_get_remote_max_streams_unidirectional(_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_quic_get_remote_max_streams_unidirectional(_:))*