# nw_listener_set_new_connection_group_handler(_:_:)
...
```swift
func nw_listener_set_new_connection_group_handler(_ listener: nw_listener_t, _ handler: nw_listener_new_connection_group_handler_t?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_listener_set_new_connection_group_handler(_:_:))*