# nw_path_copy_effective_remote_endpoint(_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_path_copy_effective_remote_endpoint(_:))*