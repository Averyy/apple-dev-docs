...
### Versions
- [var nw_ws_version_invalid: nw_ws_version_t](nw_ws_version_invalid.md)
  An invalid version.
- [var nw_ws_version_13: nw_ws_version_t](nw_ws_version_13.md)
  Version 13 of the WebSocket protocol.
### Initializers
- [init(UInt32)](nw_ws_version_t/init(_:).md)
- [init(rawValue: UInt32)](nw_ws_version_t/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](nw_ws_version_t/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_ws_version_t)*