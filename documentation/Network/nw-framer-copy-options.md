...
```swift
func nw_framer_copy_options(_ framer: nw_framer_t) -> nw_protocol_options_t
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_framer_copy_options(_:))*