# nw_listener_set_new_connection_limit(_:_:)
...
By default, the limit is [`NW_LISTENER_INFINITE_CONNECTION_LIMIT`](nw_listener_infinite_connection_limit.md). When the limit is infinite, it does not decrement but allows all inbound connections.
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_listener_set_new_connection_limit(_:_:))*