# nw_quic_copy_sec_protocol_options(_:)
...
```swift
func nw_quic_copy_sec_protocol_options(_ options: nw_protocol_options_t) -> sec_protocol_options_t
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_quic_copy_sec_protocol_options(_:))*