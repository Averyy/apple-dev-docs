# nw_establishment_report_get_proxy_configured(_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_establishment_report_get_proxy_configured(_:))*