...
- `ether_type`: The custom Ethernet frame type to register for this channel, in host-byte order.
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_ethernet_channel_create(_:_:))*