...
```swift
func nw_endpoint_copy_txt_record(_ endpoint: nw_endpoint_t) -> nw_txt_record_t?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/network/nw_endpoint_copy_txt_record(_:))*