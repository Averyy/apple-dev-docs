...
For a list of possible size values, see [`MSStickerSize`](msstickersize.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/messages/msstickerbrowserview/stickersize)*