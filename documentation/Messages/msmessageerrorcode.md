...
- [MSMessageErrorCode.unknown](msmessageerrorcode/unknown.md)
  An unexpected or unknown error has occurred.
### Initializers
- [init?(rawValue: Int)](msmessageerrorcode/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/messages/msmessageerrorcode)*