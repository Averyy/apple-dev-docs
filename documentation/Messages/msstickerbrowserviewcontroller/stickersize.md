...
For a list of possible values, see [`MSStickerSize`](msstickersize.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/messages/msstickerbrowserviewcontroller/stickersize)*