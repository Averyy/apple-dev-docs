...
![Screenshot showing an Xcode dialog with a list of apps to run. The selected app is Xcode.](/images/com.apple.xcodekit/media-2902155@2x.png)
...
![The app icon for Xcode with a black background instead of the usual blue background.](/images/com.apple.xcodekit/media-2902156@2x.png)
