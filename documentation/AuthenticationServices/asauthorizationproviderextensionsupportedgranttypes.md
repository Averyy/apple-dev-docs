...
### Initializers
- [init(rawValue: Int)](asauthorizationproviderextensionsupportedgranttypes/init(rawvalue:).md)
### Type Properties
- [static var jwtBearer: ASAuthorizationProviderExtensionSupportedGrantTypes](asauthorizationproviderextensionsupportedgranttypes/jwtbearer.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/authenticationservices/asauthorizationproviderextensionsupportedgranttypes)*