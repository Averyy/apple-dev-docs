...
### Initializers
- [init?(rawValue: Int)](asuseragerange/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/authenticationservices/asuseragerange)*