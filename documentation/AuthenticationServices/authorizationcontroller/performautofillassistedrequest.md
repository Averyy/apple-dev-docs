...
Then use [`task(name:priority:file:line:_:)`](https://developer.apple.com/documentation/SwiftUI/View/task(name:priority:file:line:_:)) or [`task(id:name:priority:file:line:_:)`](https://developer.apple.com/documentation/SwiftUI/View/task(id:name:priority:file:line:_:)) to perform the request when the view appears:
