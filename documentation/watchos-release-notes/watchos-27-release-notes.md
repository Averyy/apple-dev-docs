...
- Siri AI conversations might not sync to paired Apple Watch, failing with a “No iCloud is configured” error. (183040889) **Workaround:** On the Watch, open Settings > Apple Account to trigger an account refresh and restores syncing.
