...
The watchOS 26.4 SDK provides support to develop watchOS apps for Apple Watch devices running watchOS 26.4 RC. The SDK comes bundled with Xcode 26.4, available from the Mac App Store. For information on the compatibility requirements for Xcode 26.4, see [`Xcode 26.4 Release Notes`](https://developer.apple.com/documentation/Xcode-Release-Notes/xcode-26_4-release-notes).
