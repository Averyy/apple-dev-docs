# VNClassifyImageRequestRevision2
...
```swift
var VNClassifyImageRequestRevision2: Int { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/vision/vnclassifyimagerequestrevision2)*