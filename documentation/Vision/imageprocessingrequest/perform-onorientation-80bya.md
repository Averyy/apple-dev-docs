...
- `url`: The input   on which to perform the request.
...
*[View on Apple Developer](https://developer.apple.com/documentation/vision/imageprocessingrequest/perform(on:orientation:)-80bya)*