...
- [var localPosition: simd_float4x4](vnhumanbodyrecognizedpoint3d/localposition.md)
  The three-dimensional position.
### Getting the Parent Joint
- [var parentJoint: VNHumanBodyPose3DObservation.JointName](vnhumanbodyrecognizedpoint3d/parentjoint.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/vision/vnhumanbodyrecognizedpoint3d)*