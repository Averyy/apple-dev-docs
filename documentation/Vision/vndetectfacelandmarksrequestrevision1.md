...
```swift
var VNDetectFaceLandmarksRequestRevision1: Int { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/vision/vndetectfacelandmarksrequestrevision1)*