...
```swift
var rightPupil: FaceObservation.Landmarks2D.Region { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/vision/faceobservation/landmarks2d/rightpupil)*