# RequestDescriptor.detectFaceRectanglesRequest(_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/vision/requestdescriptor/detectfacerectanglesrequest(_:))*