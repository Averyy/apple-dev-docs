...
```swift
final let revision: DetectHumanBodyPose3DRequest.Revision
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/vision/detecthumanbodypose3drequest/revision-swift.property)*