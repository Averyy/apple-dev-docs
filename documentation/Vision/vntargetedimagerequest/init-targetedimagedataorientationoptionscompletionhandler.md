# init(targetedImageData:orientation:options:completionHandler:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/vision/vntargetedimagerequest/init(targetedimagedata:orientation:options:completionhandler:))*