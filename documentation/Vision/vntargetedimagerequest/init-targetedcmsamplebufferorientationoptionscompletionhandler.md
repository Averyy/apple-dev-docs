...
- `orientation`: The EXIF orientation of the image. See   for supported orientations.
...
*[View on Apple Developer](https://developer.apple.com/documentation/vision/vntargetedimagerequest/init(targetedcmsamplebuffer:orientation:options:completionhandler:))*