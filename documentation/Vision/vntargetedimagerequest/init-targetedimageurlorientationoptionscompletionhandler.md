# init(targetedImageURL:orientation:options:completionHandler:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/vision/vntargetedimagerequest/init(targetedimageurl:orientation:options:completionhandler:))*