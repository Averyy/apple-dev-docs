...
```swift
convenience init(_ image: CGImage, orientation: CGImagePropertyOrientation? = nil)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/vision/imagerequesthandler/init(_:orientation:)-8nodt)*