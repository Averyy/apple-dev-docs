...
```swift
convenience init(_ imageURL: URL, orientation: CGImagePropertyOrientation? = nil)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/vision/imagerequesthandler/init(_:orientation:)-6imw8)*