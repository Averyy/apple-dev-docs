...
```swift
@nonobjc
var supportedJointNames: [VNHumanBodyPose3DObservation.JointName] { get throws }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/vision/vndetecthumanbodypose3drequest/supportedjointnames)*