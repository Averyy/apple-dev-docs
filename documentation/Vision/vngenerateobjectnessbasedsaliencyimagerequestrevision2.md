...
```swift
var VNGenerateObjectnessBasedSaliencyImageRequestRevision2: Int { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/vision/vngenerateobjectnessbasedsaliencyimagerequestrevision2)*