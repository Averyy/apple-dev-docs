...
```swift
var lists: [DocumentObservation.Container.List] { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/vision/documentobservation/container/lists)*