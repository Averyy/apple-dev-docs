...
```swift
var paragraphs: [DocumentObservation.Container.Text] { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/vision/documentobservation/container/paragraphs)*