...
```swift
var text: DocumentObservation.Container.Text { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/vision/documentobservation/container/text-swift.property)*