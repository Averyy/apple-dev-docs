...
- [var ACErrorDeniedByPlugin: ACErrorCode](acerrordeniedbyplugin.md)
  Error code that indicates a plugin prevented the expected action from occurring.
- [var ACErrorCoreDataSaveFailed: ACErrorCode](acerrorcoredatasavefailed.md)
  Error code that indicates an error occurred while trying to save to a Core Data store.
- [var ACErrorFailedSerializingAccountInfo: ACErrorCode](acerrorfailedserializingaccountinfo.md)
  Error code that indicates an account’s information couldn’t be serialized.
- [var ACErrorInvalidCommand: ACErrorCode](acerrorinvalidcommand.md)
  Error code that indicates an invalid command was attempted.
- [var ACErrorMissingTransportMessageID: ACErrorCode](acerrormissingtransportmessageid.md)
  Error code that indicates an expected message identifier wasn’t found while performing a command.
- [var ACErrorCredentialItemNotFound: ACErrorCode](acerrorcredentialitemnotfound.md)
  Error code that indicates a credential item wasn’t saved because it couldn’t be found.
- [var ACErrorCredentialItemNotExpired: ACErrorCode](acerrorcredentialitemnotexpired.md)
  Error code that indicates a credential item wasn’t removed because it hasn’t yet expired.
### Initializers
- [init(UInt32)](acerrorcode/init(_:).md)
  Initializes a new error code structure.
- [init(rawValue: UInt32)](acerrorcode/init(rawvalue:).md)
  Initializes a new error code structure.
### Instance Properties
- [var rawValue: UInt32](acerrorcode/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/accounts/acerrorcode)*