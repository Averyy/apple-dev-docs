...
```swift
@MainActor
@preconcurrency init<S>(_ title: S, monogram: Text, coordinate: CLLocationCoordinate2D) where Label == Label<Text, Text>, S : StringProtocol
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/mapkit/marker/init(_:monogram:coordinate:)-21hql)*