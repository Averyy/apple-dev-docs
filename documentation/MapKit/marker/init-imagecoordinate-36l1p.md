...
```swift
@MainActor
@preconcurrency init<S>(_ title: S, image: String, coordinate: CLLocationCoordinate2D) where Label == Label<Text, Image>, S : StringProtocol
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/mapkit/marker/init(_:image:coordinate:)-36l1p)*