...
```swift
@MainActor
@preconcurrency init<S>(_ title: S, coordinate: CLLocationCoordinate2D) where Label == Text, S : StringProtocol
```

## Parameters

- `title`: The label for the marker.
...
*[View on Apple Developer](https://developer.apple.com/documentation/mapkit/marker/init(_:coordinate:)-82942)*