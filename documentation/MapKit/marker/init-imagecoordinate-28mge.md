...
```swift
@MainActor
@preconcurrency init(_ titleKey: LocalizedStringKey, image: String, coordinate: CLLocationCoordinate2D) where Label == Label<Text, Image>
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/mapkit/marker/init(_:image:coordinate:)-28mge)*