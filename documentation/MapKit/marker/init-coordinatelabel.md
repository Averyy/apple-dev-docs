...
```swift
@MainActor
@preconcurrency init(coordinate: CLLocationCoordinate2D, @ViewBuilder label: () -> Label)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/mapkit/marker/init(coordinate:label:))*