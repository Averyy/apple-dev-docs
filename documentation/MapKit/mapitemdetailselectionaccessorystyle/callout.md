...
```swift
static var callout: MapItemDetailSelectionAccessoryStyle { get }
```

#### Discussion

This uses the [`automatic`](mapitemdetailselectionaccessorystyle/calloutstyle/automatic.md) callout style.
...
*[View on Apple Developer](https://developer.apple.com/documentation/mapkit/mapitemdetailselectionaccessorystyle/callout)*