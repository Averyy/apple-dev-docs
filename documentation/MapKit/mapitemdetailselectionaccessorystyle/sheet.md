...
```swift
static var sheet: MapItemDetailSelectionAccessoryStyle { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/mapkit/mapitemdetailselectionaccessorystyle/sheet)*