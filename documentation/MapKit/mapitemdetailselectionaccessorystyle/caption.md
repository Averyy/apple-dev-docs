...
```swift
static var caption: MapItemDetailSelectionAccessoryStyle { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/mapkit/mapitemdetailselectionaccessorystyle/caption)*