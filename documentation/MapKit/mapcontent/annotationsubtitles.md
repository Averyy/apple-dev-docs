...
```swift
@MainActor
@preconcurrency func annotationSubtitles(_ visibility: Visibility) -> some MapContent
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/mapkit/mapcontent/annotationsubtitles(_:))*