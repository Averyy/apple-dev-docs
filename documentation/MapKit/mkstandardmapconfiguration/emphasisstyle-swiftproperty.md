...
```swift
var emphasisStyle: MKStandardMapConfiguration.EmphasisStyle { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/mapkit/mkstandardmapconfiguration/emphasisstyle-swift.property)*