...
### Initializers
- [init?(rawValue: UInt)](mkannotationview/dragstate-swift.enum/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/mapkit/mkannotationview/dragstate-swift.enum)*