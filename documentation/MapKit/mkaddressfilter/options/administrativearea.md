...
```swift
static var administrativeArea: MKAddressFilter.Options { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/mapkit/mkaddressfilter/options/administrativearea)*