...
- `rawValue`: The unsigned integer value of the direction transport type.
...
*[View on Apple Developer](https://developer.apple.com/documentation/mapkit/mklocalsearchcompleter/resulttype/init(rawvalue:))*