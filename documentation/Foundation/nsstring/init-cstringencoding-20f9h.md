...
- `nullTerminatedCString`: A C array of characters. The array must end with a   character; intermediate   characters are not allowed.
- `encoding`: The encoding of  . For possible values, see  .
