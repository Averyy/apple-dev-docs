...
Invokes [`getCharacters(_:range:)`](nsstring/getcharacters(_:range:).md) with `buffer` and the entire extent of the receiver as the range.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsstring/getcharacters(_:))*