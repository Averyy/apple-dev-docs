...
To create an immutable string from an immutable C string buffer, do not attempt to use this method. Instead, use [`init(CStringNoCopy:length:freeWhenDone:)`](nsstring/init(cstringnocopy:length:freewhendone:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsstring/init(cstring:))*