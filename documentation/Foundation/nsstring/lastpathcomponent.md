...
The following table illustrates the effect of [`lastPathComponent`](nsstring/lastpathcomponent.md) on a variety of different paths:
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsstring/lastpathcomponent)*