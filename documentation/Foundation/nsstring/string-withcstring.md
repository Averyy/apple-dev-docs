...
`cString` should contain data in the default C string encoding. If the argument passed to [`string(withCString:)`](nsstring/string(withcstring:).md) is not a zero-terminated C-string, the results are undefined.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsstring/string(withcstring:))*