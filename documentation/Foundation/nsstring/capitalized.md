...
> ❗ **Important**:  When working with text that’s presented to the user, use [`localizedCapitalized`](nsstring/localizedcapitalized.md) or [`capitalized(with:)`](nsstring/capitalized(with:).md) instead.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsstring/capitalized)*