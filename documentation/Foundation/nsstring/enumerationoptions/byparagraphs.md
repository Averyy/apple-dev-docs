...
Enumerates by paragraphs. Equivalent to [`paragraphRange(for:)`](nsstring/paragraphrange(for:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsstring/enumerationoptions/byparagraphs)*