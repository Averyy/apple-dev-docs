...
Enumerates by lines. Equivalent to [`lineRange(for:)`](nsstring/linerange(for:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsstring/enumerationoptions/bylines)*