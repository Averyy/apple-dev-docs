...
Note that this method only works with file paths (not, for example, string representations of URLs). See [`appendingPathComponent(_:)`](nsstring/appendingpathcomponent(_:).md) for an individual example.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsstring/strings(byappendingpaths:))*