...
### Initializers
- [init(rawValue: Int)](nsstring/drawingoptions/init(rawvalue:).md)
### Type Properties
...
- [static var usesLineFragmentOrigin: NSString.DrawingOptions](nsstring/drawingoptions/useslinefragmentorigin.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsstring/drawingoptions)*