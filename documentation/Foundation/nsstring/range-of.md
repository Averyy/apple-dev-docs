...
Invokes [`range(of:options:)`](nsstring/range(of:options:).md) with no options.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsstring/range(of:))*