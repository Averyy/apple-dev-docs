...
- `file`: The standard output for the receiver, which can be either an   or an   object.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/process/standardoutput)*