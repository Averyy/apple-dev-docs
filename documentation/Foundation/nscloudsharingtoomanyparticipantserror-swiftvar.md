...
```swift
var NSCloudSharingTooManyParticipantsError: Int { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nscloudsharingtoomanyparticipantserror-swift.var)*