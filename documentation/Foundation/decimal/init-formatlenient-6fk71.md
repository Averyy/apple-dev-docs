...
- `format`: A format style that describes formatting conventions used by the string. The initializer uses this format’s [`Decimal.ParseStrategy`](decimal/parsestrategy.md) to parse the string.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/decimal/init(_:format:lenient:)-6fk71)*