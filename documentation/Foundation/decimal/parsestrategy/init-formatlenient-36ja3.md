...
- `format`: A configured [`Decimal.FormatStyle`](decimal/formatstyle.md) that describes the percent string format to parse.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/decimal/parsestrategy/init(format:lenient:)-36ja3)*