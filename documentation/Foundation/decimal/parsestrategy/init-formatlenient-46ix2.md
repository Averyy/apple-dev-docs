...
- `format`: A configured [`Decimal.FormatStyle`](decimal/formatstyle.md) that describes the string format to parse.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/decimal/parsestrategy/init(format:lenient:)-46ix2)*