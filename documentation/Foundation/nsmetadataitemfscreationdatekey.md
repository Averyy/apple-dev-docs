...
The value is an [`NSDate`](nsdate.md) object that contains the date and time that the file was created.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsmetadataitemfscreationdatekey)*