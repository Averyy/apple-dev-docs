...
A string that corresponds to `size`. See [`cgSize(for:)`](nscoder/cgsize(for:).md) for a discussion of the string format.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nscoder/string(for:)-2f1xb)*