...
A string that corresponds to `transform`. See [`cgAffineTransform(for:)`](nscoder/cgaffinetransform(for:).md) for a discussion of the string format.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nscoder/string(for:)-6yx6n)*