...
When decoding the data from the archive, you pass the value in the `key` parameter to the corresponding [`decodeUIOffset(forKey:)`](nscoder/decodeuioffset(forkey:).md) method to retrieve the data.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nscoder/encode(_:forkey:)-9d1qy)*