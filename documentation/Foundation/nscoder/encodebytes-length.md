...
This method must be matched by a corresponding [`decodeBytes(withReturnedLength:)`](nscoder/decodebytes(withreturnedlength:).md) message.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nscoder/encodebytes(_:length:))*