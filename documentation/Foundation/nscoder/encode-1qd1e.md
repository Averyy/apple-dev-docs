...
This method must be matched by a subsequent [`decodeData()`](nscoder/decodedata().md) message.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nscoder/encode(_:)-1qd1e)*