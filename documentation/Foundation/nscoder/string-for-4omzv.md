...
A string that corresponds to `vector`. See [`cgVector(for:)`](nscoder/cgvector(for:).md) for a discussion of the string format.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nscoder/string(for:)-4omzv)*