...
A string that corresponds to `insets`. See [`uiEdgeInsets(for:)`](nscoder/uiedgeinsets(for:).md) for a discussion of the string format.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nscoder/string(for:)-26b4z)*