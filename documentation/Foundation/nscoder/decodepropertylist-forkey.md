...
This method calls [`decodeObjectOfClasses:forKey:`](nscoder/decodeobjectofclasses:forkey:.md) with a set allowing only property list types.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nscoder/decodepropertylist(forkey:))*