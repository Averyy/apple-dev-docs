...
A string that corresponds to `rect`. See [`cgRect(for:)`](nscoder/cgrect(for:).md) for a discussion of the string format.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nscoder/string(for:)-4qz0a)*