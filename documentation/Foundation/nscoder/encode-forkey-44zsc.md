...
When decoding the data from the archive, you pass the value in the `key` parameter to the corresponding [`decodeUIEdgeInsets(forKey:)`](nscoder/decodeuiedgeinsets(forkey:).md) method to retrieve the data.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nscoder/encode(_:forkey:)-44zsc)*