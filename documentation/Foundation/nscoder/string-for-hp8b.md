...
A string that corresponds to insets. See [`nsDirectionalEdgeInsets(for:)`](nscoder/nsdirectionaledgeinsets(for:).md) for a discussion of the string format.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nscoder/string(for:)-hp8b)*