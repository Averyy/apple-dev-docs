# init(absoluteURLWithDataRepresentation:relativeTo:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsurl/init(absoluteurlwithdatarepresentation:relativeto:))*