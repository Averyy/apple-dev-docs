...
The file system representation format is described in [`File System Programming Guide`](https://developer.apple.comhttps://developer.apple.com/library/archive/documentation/FileManagement/Conceptual/FileSystemProgrammingGuide/Introduction/Introduction.html#//apple_ref/doc/uid/TP40010672).
...
- `isDir`:   if the last path part is a directory, otherwise  .
- `baseURL`: The base URL for the new URL object. This must be a file URL. If   is absolute, this URL is ignored.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsurl/fileurl(withfilesystemrepresentation:isdirectory:relativeto:))*