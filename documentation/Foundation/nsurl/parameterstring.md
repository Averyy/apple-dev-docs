...
This property should not be confused with the [`query`](nsurl/query.md) property, which also often contains a string of parameters.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsurl/parameterstring)*