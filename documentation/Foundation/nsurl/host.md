...
This property contains the host, unescaped using the [`replacingPercentEscapes(using:)`](nsstring/replacingpercentescapes(using:).md) method. If the receiver does not conform to RFC 1808, this property contains `nil`. For example, in the URL `http://www.example.com/index.html`, the host is `www.example.com`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsurl/host)*