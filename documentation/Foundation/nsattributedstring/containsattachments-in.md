...
[`true`](https://developer.apple.com/documentation/Swift/true) if the attributed string contains a property configured as [`attachment`](nsattributedstring/key/attachment.md) with [`character`](https://developer.apple.com/documentation/UIKit/NSTextAttachment/character) in `range`; otherwise, [`false`](https://developer.apple.com/documentation/Swift/false).
