...
[`true`](https://developer.apple.com/documentation/Swift/true) if the attributed string contains a property configured as [`attachment`](nsattributedstring/key/attachment.md) with doc://com.apple.documentation/documentation/appkit/nstextattachment/character in `range`; otherwise, [`false`](https://developer.apple.com/documentation/Swift/false).
