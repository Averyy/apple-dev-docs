...
The value of this attribute is an [`NSString`](nsstring.md) object indicating a document type to be forced when loading the document, specified as a UTI string; mutually exclusive with [`documentType`](nsattributedstring/documentreadingoptionkey/documenttype.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsattributedstring/documentreadingoptionkey/filetype)*