...
The value of this attribute is an [`NSString`](nsstring.md) object containing the document’s category.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsattributedstring/documentattributekey/category)*