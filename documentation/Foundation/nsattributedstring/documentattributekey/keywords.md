...
The value of this attribute is an [`NSArray`](nsarray.md) object containing [`NSString`](nsstring.md) objects, containing keywords.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsattributedstring/documentattributekey/keywords)*