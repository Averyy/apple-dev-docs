...
Use these constants as the values for the [`spellingState`](nsattributedstring/key/spellingstate.md) key.

## Topics

### Getting the spelling states
- [NSAttributedString.SpellingState.grammar](nsattributedstring/spellingstate/grammar.md)
  Flag for grammar issues.
- [NSAttributedString.SpellingState.spelling](nsattributedstring/spellingstate/spelling.md)
  Flag for spelling issues.
### Initializers
- [init?(rawValue: Int)](nsattributedstring/spellingstate/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsattributedstring/spellingstate)*