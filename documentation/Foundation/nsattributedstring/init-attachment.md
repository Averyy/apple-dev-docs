...
This is a convenience method for creating an attributed string containing an attachment using [`character`](https://developer.apple.com/documentation/UIKit/NSTextAttachment/character) as the base character.
