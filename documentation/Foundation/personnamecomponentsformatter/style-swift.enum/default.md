...
The form with minimally necessary features for differentiation in a casual setting. See “[`Default`](personnamecomponentsformatter#Default.md)” for details about its specific behavior. Equivalent to [`PersonNameComponentsFormatter.Style.medium`](personnamecomponentsformatter/style-swift.enum/medium.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/personnamecomponentsformatter/style-swift.enum/default)*