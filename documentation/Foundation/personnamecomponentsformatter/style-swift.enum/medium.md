...
Equivalent to [`PersonNameComponentsFormatter.Style.default`](personnamecomponentsformatter/style-swift.enum/default.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/personnamecomponentsformatter/style-swift.enum/medium)*