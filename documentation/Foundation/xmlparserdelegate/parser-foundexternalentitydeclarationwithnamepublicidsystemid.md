...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/xmlparserdelegate/parser(_:foundexternalentitydeclarationwithname:publicid:systemid:))*