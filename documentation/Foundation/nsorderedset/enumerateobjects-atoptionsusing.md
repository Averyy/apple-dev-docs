...
> ❗ **Important**:  If the block parameter or the `s` is `nil`, this method raises an exception.
...
- `block`: The block to apply to elements in the ordered set. The block takes three arguments: - **obj**: The element in the ordered set.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsorderedset/enumerateobjects(at:options:using:))*