...
- `block`: The block to apply to elements in the ordered set. The block takes three arguments: - **obj**: The element in the set.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsorderedset/enumerateobjects(options:using:))*