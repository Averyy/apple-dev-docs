...
The system sets the file pointer to the beginning of the file. You can’t write data to the returned file handle object. Use the [`readDataToEndOfFile()`](filehandle/readdatatoendoffile().md) or [`readData(ofLength:)`](filehandle/readdata(oflength:).md) methods to read data from it.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/filehandle/init(forreadingatpath:))*