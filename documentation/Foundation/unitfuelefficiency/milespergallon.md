...
```swift
@NSCopying
class var milesPerGallon: UnitFuelEfficiency { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/unitfuelefficiency/milespergallon)*