...
```swift
@NSCopying
class var millivolts: UnitElectricPotentialDifference { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/unitelectricpotentialdifference/millivolts)*