...
```swift
@NSCopying
class var kilovolts: UnitElectricPotentialDifference { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/unitelectricpotentialdifference/kilovolts)*