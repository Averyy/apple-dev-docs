...
```swift
@NSCopying
class var microvolts: UnitElectricPotentialDifference { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/unitelectricpotentialdifference/microvolts)*