...
```swift
@NSCopying
class var megavolts: UnitElectricPotentialDifference { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/unitelectricpotentialdifference/megavolts)*