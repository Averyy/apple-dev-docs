...
For performance reasons, you should use this method, rather than invoking `count` on [`results`](nsmetadataquery/results.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsmetadataquery/resultcount)*