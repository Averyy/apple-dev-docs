...
Unless you use [`enumerateResults(_:)`](nsmetadataquery/enumerateresults(_:).md) or [`enumerateResults(options:using:)`](nsmetadataquery/enumerateresults(options:using:).md), you should invoke this method before iterating over query results that could change due to live updates.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsmetadataquery/disableupdates())*