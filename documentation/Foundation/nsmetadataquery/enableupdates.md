...
Unless you use [`enumerateResults(_:)`](nsmetadataquery/enumerateresults(_:).md) or [`enumerateResults(options:using:)`](nsmetadataquery/enumerateresults(options:using:).md), you should invoke this method after you’re done iterating over the query results.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsmetadataquery/enableupdates())*