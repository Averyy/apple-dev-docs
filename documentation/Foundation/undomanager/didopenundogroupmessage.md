...
The undo manager posts this message after you call [`beginUndoGrouping()`](undomanager/beginundogrouping().md). Because this is a “did”-style message, the undo manager sends the message after it opens the undo group.
...
This message interoperates with the notification [`NSUndoManagerDidOpenUndoGroup`](nsnotification/name-swift.struct/nsundomanagerdidopenundogroup.md). The system notifies observers of the message when the [`NotificationCenter`](notificationcenter.md) posts the notification and vice versa.

## Topics

### Initializers
- [init()](undomanager/didopenundogroupmessage/init.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/undomanager/didopenundogroupmessage)*