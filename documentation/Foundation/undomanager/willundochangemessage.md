...
The undo manager posts this message after you call [`undo()`](undomanager/undo().md) or [`undoNestedGroup()`](undomanager/undonestedgroup().md). Because this is a “will”-style message, the undo manager sends the message before it performs the undo.
...
### Initializers
- [init()](undomanager/willundochangemessage/init.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/undomanager/willundochangemessage)*