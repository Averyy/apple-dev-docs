...
See `NSConnection`’s [`enableMultipleThreads`](nsconnection/enablemultiplethreads.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsexceptionname/objectinaccessibleexception)*