...
The date representation includes the year, month, and day. Equivalent to specifying [`withYear`](iso8601dateformatter/options/withyear.md), [`withMonth`](iso8601dateformatter/options/withmonth.md), and [`withDay`](iso8601dateformatter/options/withday.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/iso8601dateformatter/options/withfulldate)*