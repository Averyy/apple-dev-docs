...
- If [`withWeekOfYear`](iso8601dateformatter/options/withweekofyear.md) is specified, `YYYY` is used.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/iso8601dateformatter/options/withyear)*