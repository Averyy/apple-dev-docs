...
```swift
@frozen
enum ListItemDelimiterAttribute
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/attributescopes/foundationattributes/listitemdelimiterattribute)*