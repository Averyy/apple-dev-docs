...
- [static let zip: NSTextCheckingKey](nstextcheckingkey/zip.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nstextcheckingkey/name)*