...
- [func netService(NetService, didAcceptConnectionWith: InputStream, outputStream: OutputStream)](netservicedelegate/netservice(_:didacceptconnectionwith:outputstream:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/netservicedelegate)*