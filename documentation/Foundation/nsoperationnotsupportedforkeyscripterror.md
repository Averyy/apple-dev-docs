...
- [var NSNoScriptError: Int](nsnoscripterror.md)
  No error.
- [var NSReceiverEvaluationScriptError: Int](nsreceiverevaluationscripterror.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsoperationnotsupportedforkeyscripterror)*