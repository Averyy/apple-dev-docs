...
### Decoding Values
- [static func decode(from: any Decoder) throws -> Self.Value](decodableattributedstringkey/decode(from:).md)
...
- [protocol EncodableAttributedStringKey](encodableattributedstringkey.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/decodableattributedstringkey)*