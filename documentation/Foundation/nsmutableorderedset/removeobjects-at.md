...
This method is similar to [`removeObject(at:)`](nsmutableorderedset/removeobject(at:).md), but allows you to efficiently remove multiple objects with a single operation.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsmutableorderedset/removeobjects(at:))*