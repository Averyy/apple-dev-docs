...
[`IntegerFormatStyle.Percent`](integerformatstyle/percent.md) uses [`NumberFormatStyleConfiguration`](numberformatstyleconfiguration.md) for its configuration type.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/integerformatstyle/percent/configuration)*