...
The value associated with the [`immutable`](fileattributekey/immutable.md) file attributes key, or [`false`](https://developer.apple.com/documentation/Swift/false) if the file attributes dictionary has no entry for the key.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsdictionary/fileisimmutable())*