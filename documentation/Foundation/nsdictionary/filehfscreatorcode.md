...
The value associated with the [`hfsCreatorCode`](fileattributekey/hfscreatorcode.md) file attributes key, or `0` if the file attributes dictionary has no entry for the key.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsdictionary/filehfscreatorcode())*