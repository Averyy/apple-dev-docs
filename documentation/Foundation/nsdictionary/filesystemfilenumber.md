...
The value associated with the [`systemFileNumber`](fileattributekey/systemfilenumber.md) file attributes key as an `Int` (`unsigned long` in Objective-C), or `0` if the file attributes dictionary has no entry for the key.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsdictionary/filesystemfilenumber())*