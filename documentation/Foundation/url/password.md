...
New code should use [`password(percentEncoded:)`](url/password(percentencoded:).md) instead of this property.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/url/password)*