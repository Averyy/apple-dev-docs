...
If the URL doesn’t contain a host component according to [`RFC 3986`](https://developer.apple.comhttps://www.ietf.org/rfc/rfc3986.txt), this function returns `nil`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/url/host(percentencoded:))*