...
New code should use [`host(percentEncoded:)`](url/host(percentencoded:).md) instead of this property.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/url/host)*