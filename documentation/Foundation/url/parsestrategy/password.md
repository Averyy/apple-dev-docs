...
- `strategy`: A strategy for parsing the password component.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/url/parsestrategy/password(_:))*