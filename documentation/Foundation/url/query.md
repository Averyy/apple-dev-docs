...
New code should use [`query(percentEncoded:)`](url/query(percentencoded:).md) instead of this property.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/url/query)*