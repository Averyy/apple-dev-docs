...
The [`FileManager.SearchPathDirectory.downloadsDirectory`](filemanager/searchpathdirectory/downloadsdirectory.md) flag only produces a path when you provide a [`userDomainMask`](filemanager/searchpathdomainmask/userdomainmask.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/filemanager/searchpathdirectory/downloadsdirectory)*