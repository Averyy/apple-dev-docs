...
- [func CFBridgingRetain(Any?) -> CFTypeRef?](cfbridgingretain(_:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/memory-management-functions)*