...
The objects are removed using [`removeObject(at:)`](nsmutablearray/removeobject(at:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsmutablearray/removeobjects(in:)-1udmn)*