...
### Initializers
- [init(any NSFastEnumeration)](nsfastenumerationiterator/init(_:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsfastenumerationiterator)*