...
```swift
var NSCloudSharingQuotaExceededError: Int { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nscloudsharingquotaexceedederror-swift.var)*