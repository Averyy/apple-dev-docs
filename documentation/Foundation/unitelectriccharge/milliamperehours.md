...
```swift
@NSCopying
class var milliampereHours: UnitElectricCharge { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/unitelectriccharge/milliamperehours)*