...
```swift
@NSCopying
class var megaampereHours: UnitElectricCharge { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/unitelectriccharge/megaamperehours)*