...
```swift
@NSCopying
class var kiloampereHours: UnitElectricCharge { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/unitelectriccharge/kiloamperehours)*