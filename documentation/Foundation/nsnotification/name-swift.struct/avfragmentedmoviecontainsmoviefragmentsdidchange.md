...
The system posts this notification only for changes that occur after a movie’s [`containsMovieFragments`](https://developer.apple.com/documentation/AVFoundation/AVMovie/containsMovieFragments) property reaches a [`AVKeyValueStatus.loaded`](https://developer.apple.com/documentation/AVFoundation/AVKeyValueStatus/loaded) status.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsnotification/name-swift.struct/avfragmentedmoviecontainsmoviefragmentsdidchange)*