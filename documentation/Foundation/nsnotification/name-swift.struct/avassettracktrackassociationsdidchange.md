...
The system posts this notification only for changes that occur after an asset’s track’s [`availableTrackAssociationTypes`](https://developer.apple.com/documentation/AVFoundation/AVAssetTrack/availableTrackAssociationTypes) property reaches a [`AVKeyValueStatus.loaded`](https://developer.apple.com/documentation/AVFoundation/AVKeyValueStatus/loaded) status.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsnotification/name-swift.struct/avassettracktrackassociationsdidchange)*