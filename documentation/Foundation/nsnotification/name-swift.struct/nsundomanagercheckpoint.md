...
The system posts this notification on the actor, thread, or dispatch queue that calls [`beginUndoGrouping()`](undomanager/beginundogrouping().md), [`endUndoGrouping()`](undomanager/endundogrouping().md), or [`canRedo`](undomanager/canredo.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsnotification/name-swift.struct/nsundomanagercheckpoint)*