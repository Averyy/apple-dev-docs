...
The system posts this notification only after the value of an asset’s [`availableMediaCharacteristicsWithMediaSelectionOptions`](https://developer.apple.com/documentation/AVFoundation/AVPartialAsyncProperty/availableMediaCharacteristicsWithMediaSelectionOptions) property reaches a status of [`AVKeyValueStatus.loaded`](https://developer.apple.com/documentation/AVFoundation/AVKeyValueStatus/loaded).
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsnotification/name-swift.struct/avassetmediaselectiongroupsdidchange)*