...
In some locales, when quotations are nested, the quotation characters alternate. Thus, [`quotationEndDelimiterKey`](nslocale/key/quotationenddelimiterkey.md), then [`alternateQuotationEndDelimiterKey`](nslocale/key/alternatequotationenddelimiterkey.md), etc.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nslocale/key/alternatequotationenddelimiterkey)*