...
This property contains the same value returned by the [`object(forKey:)`](nslocale/object(forkey:).md) method when passing the [`alternateQuotationBeginDelimiterKey`](nslocale/key/alternatequotationbegindelimiterkey.md) key.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nslocale/alternatequotationbegindelimiter)*