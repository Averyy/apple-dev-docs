...
The XML string representation of this object is `<``name``></``name``>`. This method invokes [`init(name:uri:)`](xmlelement/init(name:uri:)-1r286.md) with the URI parameter set to `nil`.
