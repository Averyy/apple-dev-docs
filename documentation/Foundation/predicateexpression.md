...
- [associatedtype Output](predicateexpression/output.md)
- [func evaluate(PredicateBindings) throws -> Self.Output](predicateexpression/evaluate(_:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/predicateexpression)*