...
`NSSetCommand` uses available scripting class descriptions to determine whether it should set a value for an attribute (or property), or set a value for all elements (to-many objects). For the latter, it invokes doc://com.apple.documentation/documentation/objectivec/nsobject/1411225-replacevalue; for the former, it invokes doc://com.apple.documentation/documentation/objectivec/nsobject/1415969-setvalue (or, if the receiver overrides doc://com.apple.documentation/documentation/objectivec/nsobject/1430042-takevalue, it invokes that method, to support backward binary compatibility.)
