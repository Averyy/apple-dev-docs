...
```swift
@NSCopying
class var kiloohms: UnitElectricResistance { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/unitelectricresistance/kiloohms)*