...
```swift
@NSCopying
class var microohms: UnitElectricResistance { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/unitelectricresistance/microohms)*