...
- [enum DescriptiveNumberFormatConfiguration](descriptivenumberformatconfiguration.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/format-style-configurations)*