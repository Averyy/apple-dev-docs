...
This method selects the correct unit based on the formatter’s locale, the magnitude of the value, and the [`isForFoodEnergyUse`](energyformatter/isforfoodenergyuse.md) property.
