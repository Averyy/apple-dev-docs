...
- `options`: A mask that specifies options for Base64 decoding the data. Possible values are given in  .
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsdata/init(base64encodeddata:options:))*