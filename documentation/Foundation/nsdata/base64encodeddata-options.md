...
- `options`: A mask that specifies options for Base64 encoding the data. Possible values are given in [`NSData.Base64EncodingOptions`](nsdata/base64encodingoptions.md).
