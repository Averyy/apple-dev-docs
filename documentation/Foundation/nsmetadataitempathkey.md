...
The value is an [`NSString`](nsstring.md) object that contains the full path to the file
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsmetadataitempathkey)*