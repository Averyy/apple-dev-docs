...
```swift
@NSCopying
class var millimetersOfMercury: UnitPressure { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/unitpressure/millimetersofmercury)*