...
```swift
@NSCopying
class var newtonsPerMetersSquared: UnitPressure { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/unitpressure/newtonspermeterssquared)*