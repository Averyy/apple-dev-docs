...
```swift
@NSCopying
class var poundsForcePerSquareInch: UnitPressure { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/unitpressure/poundsforcepersquareinch)*