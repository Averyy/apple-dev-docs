...
If a current progress object exists, the initializer uses it to set the value of the [`totalUnitCount`](progress/totalunitcount.md) property.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/progress/init(totalunitcount:))*