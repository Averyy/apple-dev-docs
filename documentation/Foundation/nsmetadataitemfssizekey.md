...
The value is an [`NSNumber`](nsnumber.md) object that indicates the size (in bytes) of the file on disk.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsmetadataitemfssizekey)*