...
The recovery attempter must be an object that can correctly interpret an index into the array returned by [`recoveryAttempter`](nserror/recoveryattempter.md).
...
- [let NSLocalizedRecoverySuggestionErrorKey: String](nslocalizedrecoverysuggestionerrorkey.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsrecoveryattemptererrorkey)*