...
An `NSXMLNode` object of kind [`XMLNode.Kind.text`](xmlnode/kind-swift.enum/text.md) initialized with the textual `value` or `nil` if the object couldn’t be created.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/xmlnode/text(withstringvalue:))*