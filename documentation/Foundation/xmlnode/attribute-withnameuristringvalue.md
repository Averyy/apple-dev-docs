...
An `NSXMLNode` object of kind [`XMLNode.Kind.attribute`](xmlnode/kind-swift.enum/attribute.md) or `nil` if the object couldn’t be created.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/xmlnode/attribute(withname:uri:stringvalue:))*