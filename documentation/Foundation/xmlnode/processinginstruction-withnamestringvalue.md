...
An `NSXMLNode` object  of kind [`XMLNode.Kind.processingInstruction`](xmlnode/kind-swift.enum/processinginstruction.md) or `nil` if the object couldn’t be created.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/xmlnode/processinginstruction(withname:stringvalue:))*