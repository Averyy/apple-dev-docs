...
An `NSXMLNode` object of kind [`XMLNode.Kind.namespace`](xmlnode/kind-swift.enum/namespace.md) or `nil` if the object couldn’t be created. If something other than a predefined-namespace prefix is specified, the method returns `nil`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/xmlnode/predefinednamespace(forprefix:))*