...
- `element`: An [`XMLElement`](xmlelement.md) object representing an element.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/xmlnode/document(withrootelement:))*