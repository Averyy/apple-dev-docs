...
Specifies that significant whitespace should be represented by text nodes. If [`nodePreserveWhitespace`](xmlnode/options/nodepreservewhitespace.md) is also specified, this option has no effect.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/xmlnode/options/nodepromotesignificantwhitespace)*