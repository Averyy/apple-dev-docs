...
An `NSXMLNode` object of kind [`XMLNode.Kind.namespace`](xmlnode/kind-swift.enum/namespace.md) or `nil` if the object couldn’t be created.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/xmlnode/namespace(withname:stringvalue:))*