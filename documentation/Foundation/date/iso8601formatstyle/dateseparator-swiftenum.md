...
- [Date.ISO8601FormatStyle.DateSeparator.dash](date/iso8601formatstyle/dateseparator-swift.enum/dash.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/date/iso8601formatstyle/dateseparator-swift.enum)*