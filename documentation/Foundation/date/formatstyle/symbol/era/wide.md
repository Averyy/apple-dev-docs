...
A custom format style conveying a full representation of an era. For example, `Before Christ` and `Anno Domini`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/date/formatstyle/symbol/era/wide)*