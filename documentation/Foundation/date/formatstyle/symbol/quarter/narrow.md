...
This custom format style conveys the shortest representation of a quarter. For example, `2`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/date/formatstyle/symbol/quarter/narrow)*