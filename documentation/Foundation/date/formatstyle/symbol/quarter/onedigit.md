...
This custom format style conveys a one-digit representation of a quarter. For example, `2`, for the second quarter.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/date/formatstyle/symbol/quarter/onedigit)*