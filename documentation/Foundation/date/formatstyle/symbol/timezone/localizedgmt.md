...
For example, `GMT-7` ([`Date.FormatStyle.Symbol.TimeZone.Width.short`](date/formatstyle/symbol/timezone/width/short.md)) or `GMT-07:00` ([`Date.FormatStyle.Symbol.TimeZone.Width.long`](date/formatstyle/symbol/timezone/width/long.md)).
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/date/formatstyle/symbol/timezone/localizedgmt(_:))*