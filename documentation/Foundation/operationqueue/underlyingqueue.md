...
The value of this property should only be set if there are no operations in the queue; setting the value of this property when [`operationCount`](operationqueue/operationcount.md) is not equal to `0` raises an [`invalidArgumentException`](nsexceptionname/invalidargumentexception.md). The value of this property must not be the value returned by [`dispatch_get_main_queue`](https://developer.apple.com/documentation/Dispatch/dispatch_get_main_queue). The quality-of-service level set for the underlying dispatch queue overrides any value set for the operation queue’s [`qualityOfService`](operationqueue/qualityofservice.md) property.
