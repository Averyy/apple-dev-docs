...
Access the bad encoding from the `userInfo` dictionary using the [`NSStringEncodingErrorKey`](nsstringencodingerrorkey.md) key.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/nsfilewriteinapplicablestringencodingerror-swift.var)*