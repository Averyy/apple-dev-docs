...
```swift
@NSCopying
class var kiloamperes: UnitElectricCurrent { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundation/unitelectriccurrent/kiloamperes)*