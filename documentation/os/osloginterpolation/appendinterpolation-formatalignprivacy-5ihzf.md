...
- `number`: The 8-bit integer value to add to the message.
...
*[View on Apple Developer](https://developer.apple.com/documentation/os/osloginterpolation/appendinterpolation(_:format:align:privacy:)-5ihzf)*