# showSignificantUpdateAcknowledgement(in:updateDescription:)
...
```swift
@MainActor
func showSignificantUpdateAcknowledgement(in windowScene: UIWindowScene, updateDescription: String) async throws
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/declaredagerange/agerangeservice/showsignificantupdateacknowledgement(in:updatedescription:))*