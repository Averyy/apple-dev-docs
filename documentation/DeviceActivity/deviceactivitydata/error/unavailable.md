# DeviceActivityData.Error.unavailable
...
To access data, the person must be in a region that supports data access.
...
*[View on Apple Developer](https://developer.apple.com/documentation/deviceactivity/deviceactivitydata/error/unavailable)*