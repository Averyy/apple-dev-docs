...
*[View on Apple Developer](https://developer.apple.com/documentation/deviceactivity/deviceactivityreport/onlongpressgesture(minimumduration:perform:onpressingchanged:))*