...
*[View on Apple Developer](https://developer.apple.com/documentation/deviceactivity/deviceactivityreport/fileimporter(ispresented:allowedcontenttypes:oncompletion:))*