...
*[View on Apple Developer](https://developer.apple.com/documentation/deviceactivity/deviceactivityreport/confirmationdialog(_:ispresented:titlevisibility:actions:)-6orwv)*