...
*[View on Apple Developer](https://developer.apple.com/documentation/deviceactivity/deviceactivityreport/scrolltransition(topleading:bottomtrailing:axis:transition:))*