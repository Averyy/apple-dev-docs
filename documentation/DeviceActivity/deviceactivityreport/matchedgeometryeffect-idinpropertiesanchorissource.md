...
*[View on Apple Developer](https://developer.apple.com/documentation/deviceactivity/deviceactivityreport/matchedgeometryeffect(id:in:properties:anchor:issource:))*