...
*[View on Apple Developer](https://developer.apple.com/documentation/deviceactivity/deviceactivityreport/onlongpressgesture(minimumduration:maximumdistance:pressing:perform:))*