...
*[View on Apple Developer](https://developer.apple.com/documentation/deviceactivity/deviceactivityreport/searchable(text:editabletokens:ispresented:placement:prompt:token:)-7lt6)*