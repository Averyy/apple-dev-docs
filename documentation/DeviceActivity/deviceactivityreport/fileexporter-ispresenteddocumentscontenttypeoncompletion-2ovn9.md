...
*[View on Apple Developer](https://developer.apple.com/documentation/deviceactivity/deviceactivityreport/fileexporter(ispresented:documents:contenttype:oncompletion:)-2ovn9)*