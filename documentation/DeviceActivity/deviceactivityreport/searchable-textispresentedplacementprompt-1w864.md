...
*[View on Apple Developer](https://developer.apple.com/documentation/deviceactivity/deviceactivityreport/searchable(text:ispresented:placement:prompt:)-1w864)*