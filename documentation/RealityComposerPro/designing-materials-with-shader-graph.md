...
> **Note**: Setting an input as constant is the same as authoring a constant node. See doc://com.apple.documentation/documentation/shadergraph/procedural for more detailed information.
