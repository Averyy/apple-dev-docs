...
- Download and install the [`Sensitive Content Analysis profile`](https://developer.apple.comhttps://developer.apple.com/services-account/download?path=/iOS/iOS_Logs/SensitiveContentAnalysis.mobileconfig).
