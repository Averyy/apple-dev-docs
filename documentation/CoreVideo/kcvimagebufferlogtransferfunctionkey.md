...
```swift
let kCVImageBufferLogTransferFunctionKey: CFString
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/corevideo/kcvimagebufferlogtransferfunctionkey)*