...
The value for the [`kCVImageBufferGammaLevelKey`](kcvimagebuffergammalevelkey.md) key defines this transfer function.
...
*[View on Apple Developer](https://developer.apple.com/documentation/corevideo/kcvimagebuffertransferfunction_usegamma)*