...
The chroma location value is of type [`CFString`](https://developer.apple.com/documentation/CoreFoundation/CFString). This key only applies to progressive-scan image data. See [`Image Buffer Chroma Location Constants`](image-buffer-chroma-location-constants.md) for more information.
...
*[View on Apple Developer](https://developer.apple.com/documentation/corevideo/kcvimagebufferchromalocationtopfieldkey)*