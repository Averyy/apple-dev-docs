...
```swift
var kCVPixelFormatType_Lossless_30RGBLE_8A_BiPlanar: OSType { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/corevideo/kcvpixelformattype_lossless_30rgble_8a_biplanar)*