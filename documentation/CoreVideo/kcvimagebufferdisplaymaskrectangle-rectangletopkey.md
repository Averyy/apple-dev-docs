...
```swift
let kCVImageBufferDisplayMaskRectangle_RectangleTopKey: CFString
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/corevideo/kcvimagebufferdisplaymaskrectangle_rectangletopkey)*