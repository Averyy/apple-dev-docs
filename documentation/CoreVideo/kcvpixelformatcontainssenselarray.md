...
```swift
let kCVPixelFormatContainsSenselArray: CFString
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/corevideo/kcvpixelformatcontainssenselarray)*