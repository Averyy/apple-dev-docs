...
If this Boolean value is `true`, the Player is advancing [`currentTime`](livephotoskit.player/currenttime.md) automatically, as close to every one-sixtieth of a second as it can achieve.
...
*[View on Apple Developer](https://developer.apple.com/documentation/livephotoskitjs/livephotoskit.player/isplaying)*