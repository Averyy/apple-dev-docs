...
Width of the photo component (as obtained from [`photoSrc`](livephotoskit.player/photosrc.md) or [`photo`](livephotoskit.player/photo.md)) in pixels.
...
*[View on Apple Developer](https://developer.apple.com/documentation/livephotoskitjs/livephotoskit.player/photowidth)*