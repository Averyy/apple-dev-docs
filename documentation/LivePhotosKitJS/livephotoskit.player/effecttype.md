...
```swift
attribute LivePhotosKit.EffectTypeLiteral effectType;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/livephotoskitjs/livephotoskit.player/effecttype)*