...
`GET https://api.music.apple.com/v1/me/ratings/songs`

## Parameters

- `ids` ([string]) *(required)*: The unique identifiers for the songs.
...
*[View on Apple Developer](https://developer.apple.com/documentation/applemusicapi/get-multiple-personal-content-ratings-6wab5)*