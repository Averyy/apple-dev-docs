...
`GET https://api.music.apple.com/v1/me/ratings/stations`

## Parameters

- `ids` ([string]) *(required)*: The unique identifiers for the stations.
...
*[View on Apple Developer](https://developer.apple.com/documentation/applemusicapi/get-multiple-personal-content-ratings-7ycdc)*