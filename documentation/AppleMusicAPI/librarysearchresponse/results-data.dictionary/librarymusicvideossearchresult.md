...
- `data` ([LibraryMusicVideos]) *(required)*: The library music video resources matching the search term, ordered by best match.
...
*[View on Apple Developer](https://developer.apple.com/documentation/applemusicapi/librarysearchresponse/results-data.dictionary/librarymusicvideossearchresult)*