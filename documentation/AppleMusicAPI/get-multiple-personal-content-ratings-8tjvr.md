...
- `ids` ([string]) *(required)*: The unique identifiers for the albums.
...
*[View on Apple Developer](https://developer.apple.com/documentation/applemusicapi/get-multiple-personal-content-ratings-8tjvr)*