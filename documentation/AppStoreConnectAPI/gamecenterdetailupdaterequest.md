...
### Objects
- [object GameCenterDetailUpdateRequest.Data](gamecenterdetailupdaterequest/data-data.dictionary.md)
  The request body you use to update a detail.

## Properties

- `data` (GameCenterDetailUpdateRequest.Data) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenterdetailupdaterequest)*