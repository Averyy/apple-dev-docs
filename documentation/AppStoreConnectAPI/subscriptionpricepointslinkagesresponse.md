...
```swift
object SubscriptionPricePointsLinkagesResponse
```

## Topics

### Dictionaries
- [object SubscriptionPricePointsLinkagesResponse.Data](subscriptionpricepointslinkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([SubscriptionPricePointsLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/subscriptionpricepointslinkagesresponse)*