...
```swift
object InAppPurchaseV2InAppPurchaseLocalizationsLinkagesResponse
```

## Topics

### Dictionaries
- [object InAppPurchaseV2InAppPurchaseLocalizationsLinkagesResponse.Data](inapppurchasev2inapppurchaselocalizationslinkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([InAppPurchaseV2InAppPurchaseLocalizationsLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/inapppurchasev2inapppurchaselocalizationslinkagesresponse)*