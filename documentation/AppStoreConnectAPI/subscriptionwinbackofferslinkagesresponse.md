...
```swift
object SubscriptionWinBackOffersLinkagesResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/subscriptionwinbackofferslinkagesresponse)*