...
- `id` (string) *(required)*: An opaque resource ID that uniquely identifies the resource. Obtain the App Store version experiment resource ID from the [`List all experiments for an app store version`](get-v1-appstoreversions-_id_-appstoreversionexperimentsv2.md) response.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/delete-v2-appstoreversionexperiments-_id_)*