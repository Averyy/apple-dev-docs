...
```swift
object GameCenterMatchmakingRuleSet.Relationships.Teams
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecentermatchmakingruleset/relationships-data.dictionary/teams-data.dictionary)*