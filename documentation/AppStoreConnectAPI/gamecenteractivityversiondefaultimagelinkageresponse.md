...
```swift
object GameCenterActivityVersionDefaultImageLinkageResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenteractivityversiondefaultimagelinkageresponse)*