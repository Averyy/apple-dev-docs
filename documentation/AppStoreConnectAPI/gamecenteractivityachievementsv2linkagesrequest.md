...
```swift
object GameCenterActivityAchievementsV2LinkagesRequest
```
...
### Dictionaries
- [object GameCenterActivityAchievementsV2LinkagesRequest.Data](gamecenteractivityachievementsv2linkagesrequest/data-data.dictionary.md)

## Properties

- `data` ([GameCenterActivityAchievementsV2LinkagesRequest.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenteractivityachievementsv2linkagesrequest)*