...
```swift
object BuildBetaDetailBuildLinkageResponse
```

## Topics

### Dictionaries
- [object BuildBetaDetailBuildLinkageResponse.Data](buildbetadetailbuildlinkageresponse/data-data.dictionary.md)

## Properties

- `data` (BuildBetaDetailBuildLinkageResponse.Data) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/buildbetadetailbuildlinkageresponse)*