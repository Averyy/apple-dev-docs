...
- The [`App Infos`](app-infos.md) resource adds an [`Age Rating Declarations`](age-rating-declarations.md) relationship.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/app-store-connect-api-1-3-release-notes)*