...
```swift
object GameCenterAchievementImageCreateRequest
```

## Topics

### Objects
- [object GameCenterAchievementImageCreateRequest.Data](gamecenterachievementimagecreaterequest/data-data.dictionary.md)
  The request body you use to create a Game Center achievement image.

## Properties

- `data` (GameCenterAchievementImageCreateRequest.Data) *(required)*
...
- [object GameCenterAchievementImageV2Response](gamecenterachievementimagev2response.md)
  A response that contains a single Game Center achievement image v2 resource.
- [object GameCenterAchievementImageV2UpdateRequest](gamecenterachievementimagev2updaterequest.md)
  The request body you use to update a Game Center achievement image v2.
- [object GameCenterAchievementImage](gamecenterachievementimage.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenterachievementimagecreaterequest)*