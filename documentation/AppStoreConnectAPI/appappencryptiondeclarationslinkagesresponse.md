...
```swift
object AppAppEncryptionDeclarationsLinkagesResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appappencryptiondeclarationslinkagesresponse)*