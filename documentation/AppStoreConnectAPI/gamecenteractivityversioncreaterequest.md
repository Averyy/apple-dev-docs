...
```swift
object GameCenterActivityVersionCreateRequest
```
...
- `data` (GameCenterActivityVersionCreateRequest.Data) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenteractivityversioncreaterequest)*