...
```swift
object AppStoreVersionAppStoreVersionExperimentsV2LinkagesResponse
```

## Topics

### Dictionaries
- [object AppStoreVersionAppStoreVersionExperimentsV2LinkagesResponse.Data](appstoreversionappstoreversionexperimentsv2linkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([AppStoreVersionAppStoreVersionExperimentsV2LinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appstoreversionappstoreversionexperimentsv2linkagesresponse)*