...
`GET https://api.appstoreconnect.apple.com/v1/ciProducts/{id}/relationships/app`
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/get-v1-ciproducts-_id_-relationships-app)*