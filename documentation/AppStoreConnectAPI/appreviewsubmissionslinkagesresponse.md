...
```swift
object AppReviewSubmissionsLinkagesResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appreviewsubmissionslinkagesresponse)*