...
```swift
object BuildBetaAppReviewSubmissionLinkageResponse
```

## Topics

### Dictionaries
- [object BuildBetaAppReviewSubmissionLinkageResponse.Data](buildbetaappreviewsubmissionlinkageresponse/data-data.dictionary.md)

## Properties

- `data` (BuildBetaAppReviewSubmissionLinkageResponse.Data) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/buildbetaappreviewsubmissionlinkageresponse)*