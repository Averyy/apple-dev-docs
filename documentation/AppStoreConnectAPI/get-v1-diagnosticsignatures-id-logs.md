...
- `limit` (integer): The maximum number of diagnostic logs to return.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/get-v1-diagnosticsignatures-_id_-logs)*