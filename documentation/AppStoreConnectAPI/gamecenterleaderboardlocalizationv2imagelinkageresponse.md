...
```swift
object GameCenterLeaderboardLocalizationV2ImageLinkageResponse
```
...
- `data` (GameCenterLeaderboardLocalizationV2ImageLinkageResponse.Data) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenterleaderboardlocalizationv2imagelinkageresponse)*