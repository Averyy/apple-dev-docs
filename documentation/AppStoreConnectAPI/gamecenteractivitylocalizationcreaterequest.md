...
```swift
object GameCenterActivityLocalizationCreateRequest
```

## Topics

### Dictionaries
- [object GameCenterActivityLocalizationCreateRequest.Data](gamecenteractivitylocalizationcreaterequest/data-data.dictionary.md)

## Properties

- `data` (GameCenterActivityLocalizationCreateRequest.Data) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenteractivitylocalizationcreaterequest)*