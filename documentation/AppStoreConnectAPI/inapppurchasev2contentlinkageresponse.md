...
```swift
object InAppPurchaseV2ContentLinkageResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/inapppurchasev2contentlinkageresponse)*