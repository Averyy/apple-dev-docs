...
```swift
object GameCenterActivityVersionLocalizationsLinkagesResponse
```

## Topics

### Dictionaries
- [object GameCenterActivityVersionLocalizationsLinkagesResponse.Data](gamecenteractivityversionlocalizationslinkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([GameCenterActivityVersionLocalizationsLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenteractivityversionlocalizationslinkagesresponse)*