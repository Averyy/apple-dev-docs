...
```swift
object SubscriptionPromotionalOffersLinkagesResponse
```

## Topics

### Dictionaries
- [object SubscriptionPromotionalOffersLinkagesResponse.Data](subscriptionpromotionalofferslinkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([SubscriptionPromotionalOffersLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/subscriptionpromotionalofferslinkagesresponse)*