...
### Dictionaries
- [object InAppPurchaseV2VersionsLinkagesResponse.Data](inapppurchasev2versionslinkagesresponse/data-data.dictionary.md)
  The data element of the response body.

## Properties

- `data` ([InAppPurchaseV2VersionsLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/inapppurchasev2versionslinkagesresponse)*