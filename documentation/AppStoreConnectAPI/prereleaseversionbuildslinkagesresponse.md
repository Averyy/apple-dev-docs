...
```swift
object PrereleaseVersionBuildsLinkagesResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/prereleaseversionbuildslinkagesresponse)*