...
`GET https://api.appstoreconnect.apple.com/v2/gameCenterLeaderboardLocalizations/{id}`
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/get-v2-gamecenterleaderboardlocalizations-_id_)*