...
```swift
object AppStoreVersionAgeRatingDeclarationLinkageResponse
```

## Topics

### Dictionaries
- [object AppStoreVersionAgeRatingDeclarationLinkageResponse.Data](appstoreversionageratingdeclarationlinkageresponse/data-data.dictionary.md)

## Properties

- `data` (AppStoreVersionAgeRatingDeclarationLinkageResponse.Data) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appstoreversionageratingdeclarationlinkageresponse)*