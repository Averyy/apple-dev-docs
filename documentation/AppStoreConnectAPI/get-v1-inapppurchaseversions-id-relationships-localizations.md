...
`GET https://api.appstoreconnect.apple.com/v1/inAppPurchaseVersions/{id}/relationships/localizations`
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/get-v1-inapppurchaseversions-_id_-relationships-localizations)*