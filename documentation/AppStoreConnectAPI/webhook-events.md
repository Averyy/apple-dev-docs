...
To learn more about setting up, testing, and parsing webhook configurations, see [`Configuring and parsing App Store Connect webhook notifications`](configuring-webhook-notifications.md).

#### Learn Webhook Event Types

Here are two types of webhook event types; each includes different information, based on whether the systems notifies you about app status changes or beta-tester feedback crashes or screenshots.
