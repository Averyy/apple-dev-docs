...
### Objects
- [object GameCenterGroupGameCenterAchievementsLinkagesResponse.Data](gamecentergroupgamecenterachievementslinkagesresponse/data-data.dictionary.md)
  The resource linkage data identifying the achievements associated with a Game Center group.

## Properties

- `data` ([GameCenterGroupGameCenterAchievementsLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecentergroupgamecenterachievementslinkagesresponse)*