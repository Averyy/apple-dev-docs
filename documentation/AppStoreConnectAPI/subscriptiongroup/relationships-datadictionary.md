# SubscriptionGroup.Relationships
...
```swift
object SubscriptionGroup.Relationships
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/subscriptiongroup/relationships-data.dictionary)*