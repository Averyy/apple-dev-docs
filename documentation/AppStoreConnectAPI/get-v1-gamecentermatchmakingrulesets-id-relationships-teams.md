# List team IDs for a Game Center matchmaking rule set
...
`GET https://api.appstoreconnect.apple.com/v1/gameCenterMatchmakingRuleSets/{id}/relationships/teams`
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/get-v1-gamecentermatchmakingrulesets-_id_-relationships-teams)*