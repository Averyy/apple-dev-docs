...
```swift
object BackgroundAssetVersionInternalBetaReleaseResponse
```

## Properties

- `data` (BackgroundAssetVersionInternalBetaRelease) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/backgroundassetversioninternalbetareleaseresponse)*