...
```swift
object AppStoreReviewAttachmentCreateRequest
```

## Topics

### Objects
- [object AppStoreReviewAttachmentCreateRequest.Data](appstorereviewattachmentcreaterequest/data-data.dictionary.md)
  The data element of the request body.

## Properties

- `data` (AppStoreReviewAttachmentCreateRequest.Data) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appstorereviewattachmentcreaterequest)*