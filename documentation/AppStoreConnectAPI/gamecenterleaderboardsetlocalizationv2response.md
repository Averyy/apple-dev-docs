...
```swift
object GameCenterLeaderboardSetLocalizationV2Response
```
...
- `data` (GameCenterLeaderboardSetLocalizationV2) *(required)*
- `included` ([*])
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenterleaderboardsetlocalizationv2response)*