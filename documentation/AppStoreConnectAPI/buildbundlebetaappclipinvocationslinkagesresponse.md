...
```swift
object BuildBundleBetaAppClipInvocationsLinkagesResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/buildbundlebetaappclipinvocationslinkagesresponse)*