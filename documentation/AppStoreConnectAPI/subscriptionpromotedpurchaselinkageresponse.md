...
```swift
object SubscriptionPromotedPurchaseLinkageResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/subscriptionpromotedpurchaselinkageresponse)*