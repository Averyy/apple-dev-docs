...
```swift
object GameCenterDetailAchievementReleasesLinkagesResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenterdetailachievementreleaseslinkagesresponse)*