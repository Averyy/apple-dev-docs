...
```swift
object AppStoreVersionExperimentCreateRequest
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appstoreversionexperimentcreaterequest)*