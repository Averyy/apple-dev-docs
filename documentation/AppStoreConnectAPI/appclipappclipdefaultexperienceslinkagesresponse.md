...
```swift
object AppClipAppClipDefaultExperiencesLinkagesResponse
```

## Topics

### Dictionaries
- [object AppClipAppClipDefaultExperiencesLinkagesResponse.Data](appclipappclipdefaultexperienceslinkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([AppClipAppClipDefaultExperiencesLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appclipappclipdefaultexperienceslinkagesresponse)*