...
```swift
object InAppPurchaseOfferCodeOneTimeUseCodesResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/inapppurchaseoffercodeonetimeusecodesresponse)*