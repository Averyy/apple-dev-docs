...
### Objects
- [object GameCenterDetailGameCenterLeaderboardSetsLinkagesResponse.Data](gamecenterdetailgamecenterleaderboardsetslinkagesresponse/data-data.dictionary.md)
  The resource linkage data identifying the leaderboard sets associated with a Game Center detail.

## Properties

- `data` ([GameCenterDetailGameCenterLeaderboardSetsLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenterdetailgamecenterleaderboardsetslinkagesresponse)*