...
```swift
object BetaAppReviewDetailAppLinkageResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/betaappreviewdetailapplinkageresponse)*