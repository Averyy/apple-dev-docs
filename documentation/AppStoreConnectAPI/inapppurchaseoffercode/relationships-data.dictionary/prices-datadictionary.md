# InAppPurchaseOfferCode.Relationships.Prices
...
```swift
object InAppPurchaseOfferCode.Relationships.Prices
```

## Topics

### Dictionaries
- [object InAppPurchaseOfferCode.Relationships.Prices.Data](inapppurchaseoffercode/relationships-data.dictionary/prices-data.dictionary/data-data.dictionary.md)
  The type and ID of a related resource.

## Properties

- `data` ([InAppPurchaseOfferCode.Relationships.Prices.Data])
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/inapppurchaseoffercode/relationships-data.dictionary/prices-data.dictionary)*