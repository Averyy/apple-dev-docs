...
```swift
object AppCategorySubcategoriesLinkagesResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appcategorysubcategorieslinkagesresponse)*