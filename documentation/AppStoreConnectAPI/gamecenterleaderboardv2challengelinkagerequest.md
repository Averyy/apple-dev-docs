...
```swift
object GameCenterLeaderboardV2ChallengeLinkageRequest
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenterleaderboardv2challengelinkagerequest)*