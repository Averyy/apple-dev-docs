...
```swift
object AppAlternativeDistributionKeyLinkageResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appalternativedistributionkeylinkageresponse)*