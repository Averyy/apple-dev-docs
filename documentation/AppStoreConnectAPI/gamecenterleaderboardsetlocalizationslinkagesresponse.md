...
```swift
object GameCenterLeaderboardSetLocalizationsLinkagesResponse
```

## Topics

### Dictionaries
- [object GameCenterLeaderboardSetLocalizationsLinkagesResponse.Data](gamecenterleaderboardsetlocalizationslinkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([GameCenterLeaderboardSetLocalizationsLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenterleaderboardsetlocalizationslinkagesresponse)*