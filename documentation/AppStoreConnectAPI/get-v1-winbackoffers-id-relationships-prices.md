...
`GET https://api.appstoreconnect.apple.com/v1/winBackOffers/{id}/relationships/prices`
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/get-v1-winbackoffers-_id_-relationships-prices)*