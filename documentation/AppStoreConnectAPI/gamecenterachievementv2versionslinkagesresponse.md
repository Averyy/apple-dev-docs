...
```swift
object GameCenterAchievementV2VersionsLinkagesResponse
```
...
### Dictionaries
- [object GameCenterAchievementV2VersionsLinkagesResponse.Data](gamecenterachievementv2versionslinkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([GameCenterAchievementV2VersionsLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenterachievementv2versionslinkagesresponse)*