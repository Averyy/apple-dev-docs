...
```swift
object AppClipAdvancedExperience.Attributes.Place.DisplayPoint
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appclipadvancedexperience/attributes-data.dictionary/place-data.dictionary/displaypoint-data.dictionary)*