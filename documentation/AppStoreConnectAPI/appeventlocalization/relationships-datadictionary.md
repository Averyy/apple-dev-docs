# AppEventLocalization.Relationships
...
```swift
object AppEventLocalization.Relationships
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appeventlocalization/relationships-data.dictionary)*