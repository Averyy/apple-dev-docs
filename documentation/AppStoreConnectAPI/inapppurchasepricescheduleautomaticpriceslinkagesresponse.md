...
```swift
object InAppPurchasePriceScheduleAutomaticPricesLinkagesResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/inapppurchasepricescheduleautomaticpriceslinkagesresponse)*