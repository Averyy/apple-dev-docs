...
```swift
object GameCenterActivityLocalizationUpdateRequest
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenteractivitylocalizationupdaterequest)*