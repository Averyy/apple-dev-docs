...
```swift
object AppBetaFeedbackScreenshotSubmissionsLinkagesResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appbetafeedbackscreenshotsubmissionslinkagesresponse)*