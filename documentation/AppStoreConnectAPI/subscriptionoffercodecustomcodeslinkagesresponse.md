...
```swift
object SubscriptionOfferCodeCustomCodesLinkagesResponse
```

## Topics

### Dictionaries
- [object SubscriptionOfferCodeCustomCodesLinkagesResponse.Data](subscriptionoffercodecustomcodeslinkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([SubscriptionOfferCodeCustomCodesLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/subscriptionoffercodecustomcodeslinkagesresponse)*