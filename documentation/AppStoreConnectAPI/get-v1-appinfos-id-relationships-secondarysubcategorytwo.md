# Get the second secondary subcategory ID for an app info
...
`GET https://api.appstoreconnect.apple.com/v1/appInfos/{id}/relationships/secondarySubcategoryTwo`
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/get-v1-appinfos-_id_-relationships-secondarysubcategorytwo)*