...
- `data` (GameCenterLeaderboardImageV2) *(required)*
- `included` ([GameCenterLeaderboardLocalizationV2])
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenterleaderboardimagev2response)*