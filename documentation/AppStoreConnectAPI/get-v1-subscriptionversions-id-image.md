# Read the image for a subscription version
...
`GET https://api.appstoreconnect.apple.com/v1/subscriptionVersions/{id}/image`
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/get-v1-subscriptionversions-_id_-image)*