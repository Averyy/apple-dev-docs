...
```swift
object AppClipDefaultExperience.Relationships.AppClipAppStoreReviewDetail
```
...
- [object AppClipDefaultExperience.Relationships.AppClipDefaultExperienceLocalizations](appclipdefaultexperience/relationships-data.dictionary/appclipdefaultexperiencelocalizations-data.dictionary.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appclipdefaultexperience/relationships-data.dictionary/appclipappstorereviewdetail-data.dictionary)*