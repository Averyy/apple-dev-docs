...
```swift
object AppClipDefaultExperience.Relationships.AppClip
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appclipdefaultexperience/relationships-data.dictionary/appclip-data.dictionary)*