...
```swift
object SubscriptionPromotionalOffersResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/subscriptionpromotionaloffersresponse)*