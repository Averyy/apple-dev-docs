...
```swift
object GameCenterDetailActivityReleasesLinkagesResponse
```

## Topics

### Dictionaries
- [object GameCenterDetailActivityReleasesLinkagesResponse.Data](gamecenterdetailactivityreleaseslinkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([GameCenterDetailActivityReleasesLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenterdetailactivityreleaseslinkagesresponse)*