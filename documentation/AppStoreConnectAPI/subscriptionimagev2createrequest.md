...
```swift
object SubscriptionImageV2CreateRequest
```

## Topics

### Objects and types
- [object SubscriptionImageV2CreateRequest.Data](subscriptionimagev2createrequest/data-data.dictionary.md)
  The request body you use to create a SubscriptionImageV2.

## Properties

- `data` (SubscriptionImageV2CreateRequest.Data) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/subscriptionimagev2createrequest)*