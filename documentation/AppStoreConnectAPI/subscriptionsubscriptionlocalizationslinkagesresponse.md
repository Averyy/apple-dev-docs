...
```swift
object SubscriptionSubscriptionLocalizationsLinkagesResponse
```

## Topics

### Dictionaries
- [object SubscriptionSubscriptionLocalizationsLinkagesResponse.Data](subscriptionsubscriptionlocalizationslinkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([SubscriptionSubscriptionLocalizationsLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/subscriptionsubscriptionlocalizationslinkagesresponse)*