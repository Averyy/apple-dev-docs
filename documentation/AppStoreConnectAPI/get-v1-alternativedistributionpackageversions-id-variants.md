...
- `limit` (integer): The maximum number of alternative distribution package variants resources to return.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/get-v1-alternativedistributionpackageversions-_id_-variants)*