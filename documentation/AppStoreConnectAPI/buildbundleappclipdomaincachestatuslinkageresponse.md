...
```swift
object BuildBundleAppClipDomainCacheStatusLinkageResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/buildbundleappclipdomaincachestatuslinkageresponse)*