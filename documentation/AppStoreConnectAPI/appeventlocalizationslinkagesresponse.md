...
```swift
object AppEventLocalizationsLinkagesResponse
```

## Topics

### Dictionaries
- [object AppEventLocalizationsLinkagesResponse.Data](appeventlocalizationslinkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([AppEventLocalizationsLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appeventlocalizationslinkagesresponse)*