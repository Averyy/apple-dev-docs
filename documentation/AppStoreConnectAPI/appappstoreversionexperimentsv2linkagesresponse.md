...
```swift
object AppAppStoreVersionExperimentsV2LinkagesResponse
```

## Topics

### Dictionaries
- [object AppAppStoreVersionExperimentsV2LinkagesResponse.Data](appappstoreversionexperimentsv2linkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([AppAppStoreVersionExperimentsV2LinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appappstoreversionexperimentsv2linkagesresponse)*