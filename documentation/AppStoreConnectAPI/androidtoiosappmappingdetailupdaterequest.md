...
```swift
object AndroidToIosAppMappingDetailUpdateRequest
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/androidtoiosappmappingdetailupdaterequest)*