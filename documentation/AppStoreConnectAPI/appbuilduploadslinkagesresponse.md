...
```swift
object AppBuildUploadsLinkagesResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appbuilduploadslinkagesresponse)*