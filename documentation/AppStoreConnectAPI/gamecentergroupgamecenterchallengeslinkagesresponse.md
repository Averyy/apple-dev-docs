...
```swift
object GameCenterGroupGameCenterChallengesLinkagesResponse
```

## Topics

### Dictionaries
- [object GameCenterGroupGameCenterChallengesLinkagesResponse.Data](gamecentergroupgamecenterchallengeslinkagesresponse/data-data.dictionary.md)
  The resource linkage data identifying a Game Center challenge associated with a group.

## Properties

- `data` ([GameCenterGroupGameCenterChallengesLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecentergroupgamecenterchallengeslinkagesresponse)*