...
### Objects
- [object GameCenterLeaderboardSetGroupLeaderboardSetLinkageResponse.Data](gamecenterleaderboardsetgroupleaderboardsetlinkageresponse/data-data.dictionary.md)
  The resource linkage data identifying the group leaderboard set associated with a leaderboard set.

## Properties

- `data` (GameCenterLeaderboardSetGroupLeaderboardSetLinkageResponse.Data) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenterleaderboardsetgroupleaderboardsetlinkageresponse)*