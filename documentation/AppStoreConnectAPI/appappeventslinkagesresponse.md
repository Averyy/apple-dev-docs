...
```swift
object AppAppEventsLinkagesResponse
```

## Topics

### Dictionaries
- [object AppAppEventsLinkagesResponse.Data](appappeventslinkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([AppAppEventsLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appappeventslinkagesresponse)*