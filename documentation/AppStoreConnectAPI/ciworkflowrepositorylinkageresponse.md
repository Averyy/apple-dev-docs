...
```swift
object CiWorkflowRepositoryLinkageResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/ciworkflowrepositorylinkageresponse)*