...
```swift
object GameCenterChallengeImageCreateRequest
```
...
- `data` (GameCenterChallengeImageCreateRequest.Data) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenterchallengeimagecreaterequest)*