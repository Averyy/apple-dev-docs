...
```swift
object AppStoreVersionLocalizationAppPreviewSetsLinkagesResponse
```

## Topics

### Dictionaries
- [object AppStoreVersionLocalizationAppPreviewSetsLinkagesResponse.Data](appstoreversionlocalizationapppreviewsetslinkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([AppStoreVersionLocalizationAppPreviewSetsLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appstoreversionlocalizationapppreviewsetslinkagesresponse)*