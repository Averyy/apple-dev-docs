...
### Objects
- [object PerformanceOverview.Attributes](performanceoverview/attributes-data.dictionary.md)
...
- `id` (string) *(required)*
- `attributes` (PerformanceOverview.Attributes)
- `links` (ResourceLinks)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/performanceoverview)*