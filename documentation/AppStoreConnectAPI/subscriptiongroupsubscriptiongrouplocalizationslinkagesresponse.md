...
```swift
object SubscriptionGroupSubscriptionGroupLocalizationsLinkagesResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/subscriptiongroupsubscriptiongrouplocalizationslinkagesresponse)*