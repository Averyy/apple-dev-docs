...
```swift
object AppInAppPurchasesLinkagesResponse
```

## Topics

### Dictionaries
- [object AppInAppPurchasesLinkagesResponse.Data](appinapppurchaseslinkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([AppInAppPurchasesLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appinapppurchaseslinkagesresponse)*