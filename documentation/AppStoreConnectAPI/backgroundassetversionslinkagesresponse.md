...
```swift
object BackgroundAssetVersionsLinkagesResponse
```
...
- [object BackgroundAssetVersionsLinkagesResponse.Data](backgroundassetversionslinkagesresponse/data-data.dictionary.md)
  The resource linkage data identifying a background asset version in a linkage response.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/backgroundassetversionslinkagesresponse)*