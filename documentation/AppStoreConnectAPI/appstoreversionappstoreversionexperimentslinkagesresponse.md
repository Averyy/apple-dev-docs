...
```swift
object AppStoreVersionAppStoreVersionExperimentsLinkagesResponse
```

## Topics

### Dictionaries
- [object AppStoreVersionAppStoreVersionExperimentsLinkagesResponse.Data](appstoreversionappstoreversionexperimentslinkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([AppStoreVersionAppStoreVersionExperimentsLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appstoreversionappstoreversionexperimentslinkagesresponse)*