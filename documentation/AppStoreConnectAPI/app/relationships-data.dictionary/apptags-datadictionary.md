...
```swift
object App.Relationships.AppTags
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/app/relationships-data.dictionary/apptags-data.dictionary)*