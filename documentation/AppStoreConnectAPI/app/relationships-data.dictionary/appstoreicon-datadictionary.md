# App.Relationships.AppStoreIcon
...
```swift
object App.Relationships.AppStoreIcon
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/app/relationships-data.dictionary/appstoreicon-data.dictionary)*