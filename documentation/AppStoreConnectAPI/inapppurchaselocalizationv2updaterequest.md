...
### Objects and types
- [object InAppPurchaseLocalizationV2UpdateRequest.Data](inapppurchaselocalizationv2updaterequest/data-data.dictionary.md)
  The request body you use to modify an in-app purchase localization with the v2 API.

## Properties

- `data` (InAppPurchaseLocalizationV2UpdateRequest.Data) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/inapppurchaselocalizationv2updaterequest)*