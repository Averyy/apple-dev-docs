...
`GET https://api.appstoreconnect.apple.com/v1/betaGroups/{id}/relationships/app`
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/get-v1-betagroups-_id_-relationships-app)*