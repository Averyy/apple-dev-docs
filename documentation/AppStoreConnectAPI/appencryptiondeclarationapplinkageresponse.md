...
```swift
object AppEncryptionDeclarationAppLinkageResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appencryptiondeclarationapplinkageresponse)*