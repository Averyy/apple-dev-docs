# SubscriptionGroupLocalization.Attributes
...
```swift
object SubscriptionGroupLocalization.Attributes
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/subscriptiongrouplocalization/attributes-data.dictionary)*