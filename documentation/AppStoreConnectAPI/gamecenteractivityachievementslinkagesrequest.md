...
```swift
object GameCenterActivityAchievementsLinkagesRequest
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenteractivityachievementslinkagesrequest)*