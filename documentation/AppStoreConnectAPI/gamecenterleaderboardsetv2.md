...
```swift
object GameCenterLeaderboardSetV2
```
...
- `attributes` (GameCenterLeaderboardSetV2.Attributes)
- `id` (string) *(required)*
- `links` (ResourceLinks)
- `relationships` (GameCenterLeaderboardSetV2.Relationships)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenterleaderboardsetv2)*