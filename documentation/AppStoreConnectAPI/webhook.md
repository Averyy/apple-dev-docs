...
### Dictionaries
- [object Webhook.Attributes](webhook/attributes-data.dictionary.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/webhook)*