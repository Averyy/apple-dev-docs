...
```swift
object AppPricePointV3EqualizationsLinkagesResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/apppricepointv3equalizationslinkagesresponse)*