# Get the app price schedule ID for an app
...
`GET https://api.appstoreconnect.apple.com/v1/apps/{id}/relationships/appPriceSchedule`
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/get-v1-apps-_id_-relationships-apppriceschedule)*