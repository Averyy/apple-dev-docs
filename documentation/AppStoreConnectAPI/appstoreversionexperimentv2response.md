...
```swift
object AppStoreVersionExperimentV2Response
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appstoreversionexperimentv2response)*