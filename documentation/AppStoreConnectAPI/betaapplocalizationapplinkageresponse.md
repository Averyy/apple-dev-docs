...
```swift
object BetaAppLocalizationAppLinkageResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/betaapplocalizationapplinkageresponse)*