...
```swift
object InAppPurchaseOfferPrice.Relationships
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/inapppurchaseofferprice/relationships-data.dictionary)*