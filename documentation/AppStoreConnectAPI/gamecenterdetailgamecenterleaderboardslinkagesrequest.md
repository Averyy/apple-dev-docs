...
### Objects
- [object GameCenterDetailGameCenterLeaderboardsLinkagesRequest.Data](gamecenterdetailgamecenterleaderboardslinkagesrequest/data-data.dictionary.md)
  The resource linkage data for updating the leaderboards associated with a Game Center detail.

## Properties

- `data` ([GameCenterDetailGameCenterLeaderboardsLinkagesRequest.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenterdetailgamecenterleaderboardslinkagesrequest)*