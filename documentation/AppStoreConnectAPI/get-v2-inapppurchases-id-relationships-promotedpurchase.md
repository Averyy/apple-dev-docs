...
`GET https://api.appstoreconnect.apple.com/v2/inAppPurchases/{id}/relationships/promotedPurchase`
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/get-v2-inapppurchases-_id_-relationships-promotedpurchase)*