...
```swift
object CiProductAppLinkageResponse
```

## Topics

### Dictionaries
- [object CiProductAppLinkageResponse.Data](ciproductapplinkageresponse/data-data.dictionary.md)

## Properties

- `data` (CiProductAppLinkageResponse.Data) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/ciproductapplinkageresponse)*