...
```swift
object GameCenterAchievementV2UpdateRequest
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenterachievementv2updaterequest)*