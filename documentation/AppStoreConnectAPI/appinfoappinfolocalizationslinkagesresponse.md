...
```swift
object AppInfoAppInfoLocalizationsLinkagesResponse
```

## Topics

### Dictionaries
- [object AppInfoAppInfoLocalizationsLinkagesResponse.Data](appinfoappinfolocalizationslinkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([AppInfoAppInfoLocalizationsLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appinfoappinfolocalizationslinkagesresponse)*