...
```swift
object AppStoreVersionRoutingAppCoverageLinkageResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appstoreversionroutingappcoveragelinkageresponse)*