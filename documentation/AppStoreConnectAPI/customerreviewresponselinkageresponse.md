...
```swift
object CustomerReviewResponseLinkageResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/customerreviewresponselinkageresponse)*