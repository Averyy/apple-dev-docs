# List beta App Clip invocation IDs for a build bundle
...
`GET https://api.appstoreconnect.apple.com/v1/buildBundles/{id}/relationships/betaAppClipInvocations`
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/get-v1-buildbundles-_id_-relationships-betaappclipinvocations)*