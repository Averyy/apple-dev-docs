...
```swift
object GameCenterChallengeLeaderboardV2LinkageRequest
```
...
- `data` (GameCenterChallengeLeaderboardV2LinkageRequest.Data) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenterchallengeleaderboardv2linkagerequest)*