...
```swift
object BackgroundAssetUploadFileCreateRequest
```
...
- [object BackgroundAssetUploadFileCreateRequest.Data](backgroundassetuploadfilecreaterequest/data-data.dictionary.md)
  The data wrapper for a background asset upload file create request.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/backgroundassetuploadfilecreaterequest)*