...
- `data` (GameCenterAchievementImageV2) *(required)*
- `included` ([GameCenterAchievementLocalizationV2])
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenterachievementimagev2response)*