...
```swift
object GameCenterChallengeLocalizationUpdateRequest
```

## Topics

### Dictionaries
- [object GameCenterChallengeLocalizationUpdateRequest.Data](gamecenterchallengelocalizationupdaterequest/data-data.dictionary.md)

## Properties

- `data` (GameCenterChallengeLocalizationUpdateRequest.Data) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenterchallengelocalizationupdaterequest)*