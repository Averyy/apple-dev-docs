...
```swift
object GameCenterAchievementImageV2UpdateRequest
```
...
### Dictionaries
- [object GameCenterAchievementImageV2UpdateRequest.Data](gamecenterachievementimagev2updaterequest/data-data.dictionary.md)
  The data element of the request body.

## Properties

- `data` (GameCenterAchievementImageV2UpdateRequest.Data) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenterachievementimagev2updaterequest)*