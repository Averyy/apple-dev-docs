...
`GET https://api.appstoreconnect.apple.com/v1/subscriptionVersions/{id}/relationships/images`
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/get-v1-subscriptionversions-_id_-relationships-images)*