...
- `filter[gameCenterDetail]` (string): The fields of the Game Center details to include in the response.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/get-v1-gamecentermatchmakingqueues-_id_-metrics-matchmakingrequests)*