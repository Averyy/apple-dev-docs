...
```swift
object GameCenterGroupGameCenterLeaderboardSetsV2LinkagesRequest
```
...
- `data` ([GameCenterGroupGameCenterLeaderboardSetsV2LinkagesRequest.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecentergroupgamecenterleaderboardsetsv2linkagesrequest)*