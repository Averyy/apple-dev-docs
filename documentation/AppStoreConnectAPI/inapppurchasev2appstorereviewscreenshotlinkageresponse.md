...
```swift
object InAppPurchaseV2AppStoreReviewScreenshotLinkageResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/inapppurchasev2appstorereviewscreenshotlinkageresponse)*