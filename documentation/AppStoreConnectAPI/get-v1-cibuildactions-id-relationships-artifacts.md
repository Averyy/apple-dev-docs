# List artifact IDs for a CI build action
...
`GET https://api.appstoreconnect.apple.com/v1/ciBuildActions/{id}/relationships/artifacts`
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/get-v1-cibuildactions-_id_-relationships-artifacts)*