...
`GET https://api.appstoreconnect.apple.com/v1/scmRepositories/{id}/relationships/gitReferences`
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/get-v1-scmrepositories-_id_-relationships-gitreferences)*