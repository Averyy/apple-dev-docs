...
```swift
object BackgroundAssetUpdateRequest
```
...
- `data` (BackgroundAssetUpdateRequest.Data) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/backgroundassetupdaterequest)*