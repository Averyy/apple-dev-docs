...
```swift
object GameCenterDetailGameCenterAchievementsV2LinkagesRequest
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenterdetailgamecenterachievementsv2linkagesrequest)*