...
```swift
object AppPriceScheduleManualPricesLinkagesResponse
```

## Topics

### Dictionaries
- [object AppPriceScheduleManualPricesLinkagesResponse.Data](apppriceschedulemanualpriceslinkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([AppPriceScheduleManualPricesLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/apppriceschedulemanualpriceslinkagesresponse)*