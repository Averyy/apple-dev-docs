...
```swift
object AppGameCenterEnabledVersionsLinkagesResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appgamecenterenabledversionslinkagesresponse)*