...
```swift
object GameCenterAchievementLocalizationsLinkagesResponse
```

## Topics

### Dictionaries
- [object GameCenterAchievementLocalizationsLinkagesResponse.Data](gamecenterachievementlocalizationslinkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([GameCenterAchievementLocalizationsLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenterachievementlocalizationslinkagesresponse)*