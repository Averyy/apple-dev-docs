...
`GET https://api.appstoreconnect.apple.com/v1/appInfos/{id}/secondarySubcategoryOne`
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/get-v1-appinfos-_id_-secondarysubcategoryone)*