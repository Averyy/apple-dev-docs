...
```swift
object GameCenterAppVersionAppStoreVersionLinkageResponse
```

## Topics

### Dictionaries
- [object GameCenterAppVersionAppStoreVersionLinkageResponse.Data](gamecenterappversionappstoreversionlinkageresponse/data-data.dictionary.md)

## Properties

- `data` (GameCenterAppVersionAppStoreVersionLinkageResponse.Data) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenterappversionappstoreversionlinkageresponse)*