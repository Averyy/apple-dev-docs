...
```swift
object GameCenterDetailGameCenterActivitiesLinkagesResponse
```

## Topics

### Dictionaries
- [object GameCenterDetailGameCenterActivitiesLinkagesResponse.Data](gamecenterdetailgamecenteractivitieslinkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([GameCenterDetailGameCenterActivitiesLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenterdetailgamecenteractivitieslinkagesresponse)*