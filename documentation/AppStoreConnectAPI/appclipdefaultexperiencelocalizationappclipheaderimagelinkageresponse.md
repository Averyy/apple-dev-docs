...
```swift
object AppClipDefaultExperienceLocalizationAppClipHeaderImageLinkageResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appclipdefaultexperiencelocalizationappclipheaderimagelinkageresponse)*