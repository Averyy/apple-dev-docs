...
```swift
object BuildAppStoreVersionLinkageResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/buildappstoreversionlinkageresponse)*