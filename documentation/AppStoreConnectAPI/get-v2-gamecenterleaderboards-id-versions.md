...
`GET https://api.appstoreconnect.apple.com/v2/gameCenterLeaderboards/{id}/versions`
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/get-v2-gamecenterleaderboards-_id_-versions)*