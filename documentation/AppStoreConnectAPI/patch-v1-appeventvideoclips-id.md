...
- [POST /v1/appEventVideoClips](post-v1-appeventvideoclips.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/patch-v1-appeventvideoclips-_id_)*