...
```swift
object AppBetaAppLocalizationsLinkagesResponse
```

## Topics

### Dictionaries
- [object AppBetaAppLocalizationsLinkagesResponse.Data](appbetaapplocalizationslinkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([AppBetaAppLocalizationsLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appbetaapplocalizationslinkagesresponse)*