...
```swift
object GameCenterLeaderboardSetV2VersionsLinkagesResponse
```
...
### Dictionaries
- [object GameCenterLeaderboardSetV2VersionsLinkagesResponse.Data](gamecenterleaderboardsetv2versionslinkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([GameCenterLeaderboardSetV2VersionsLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenterleaderboardsetv2versionslinkagesresponse)*