...
```swift
object AppAppInfosLinkagesResponse
```

## Topics

### Dictionaries
- [object AppAppInfosLinkagesResponse.Data](appappinfoslinkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([AppAppInfosLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appappinfoslinkagesresponse)*