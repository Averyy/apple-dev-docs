...
```swift
object SubscriptionSubscriptionAvailabilityLinkageResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/subscriptionsubscriptionavailabilitylinkageresponse)*