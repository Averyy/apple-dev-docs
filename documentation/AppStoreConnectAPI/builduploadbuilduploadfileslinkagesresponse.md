...
```swift
object BuildUploadBuildUploadFilesLinkagesResponse
```

## Topics

### Dictionaries
- [object BuildUploadBuildUploadFilesLinkagesResponse.Data](builduploadbuilduploadfileslinkagesresponse/data-data.dictionary.md)
  The data element of the response body.

## Properties

- `data` ([BuildUploadBuildUploadFilesLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/builduploadbuilduploadfileslinkagesresponse)*