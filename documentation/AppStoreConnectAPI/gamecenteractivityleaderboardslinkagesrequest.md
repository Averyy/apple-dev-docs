...
```swift
object GameCenterActivityLeaderboardsLinkagesRequest
```

## Topics

### Dictionaries
- [object GameCenterActivityLeaderboardsLinkagesRequest.Data](gamecenteractivityleaderboardslinkagesrequest/data-data.dictionary.md)
  The request body you use to update a activity.

## Properties

- `data` ([GameCenterActivityLeaderboardsLinkagesRequest.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenteractivityleaderboardslinkagesrequest)*