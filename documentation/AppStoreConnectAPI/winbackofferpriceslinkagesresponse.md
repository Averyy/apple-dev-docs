...
```swift
object WinBackOfferPricesLinkagesResponse
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/winbackofferpriceslinkagesresponse)*