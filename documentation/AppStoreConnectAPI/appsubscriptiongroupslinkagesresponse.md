...
```swift
object AppSubscriptionGroupsLinkagesResponse
```

## Topics

### Dictionaries
- [object AppSubscriptionGroupsLinkagesResponse.Data](appsubscriptiongroupslinkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([AppSubscriptionGroupsLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appsubscriptiongroupslinkagesresponse)*