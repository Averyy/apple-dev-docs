...
`GET https://api.appstoreconnect.apple.com/v1/builds/{id}/relationships/betaBuildLocalizations`
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/get-v1-builds-_id_-relationships-betabuildlocalizations)*