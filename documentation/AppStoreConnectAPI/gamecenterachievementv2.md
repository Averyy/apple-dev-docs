...
```swift
object GameCenterAchievementV2
```
...
- `attributes` (GameCenterAchievementV2.Attributes)
- `id` (string) *(required)*
- `links` (ResourceLinks)
- `relationships` (GameCenterAchievementV2.Relationships)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecenterachievementv2)*