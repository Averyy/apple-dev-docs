...
### Objects and types
- [object InAppPurchaseLocalizationV2CreateRequest.Data](inapppurchaselocalizationv2createrequest/data-data.dictionary.md)
  The request body you use to create an In-App Purchase localization with the v2 API.

## Properties

- `data` (InAppPurchaseLocalizationV2CreateRequest.Data) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/inapppurchaselocalizationv2createrequest)*