# AppPerformanceOverviewsLinkagesResponse
...
```swift
object AppPerformanceOverviewsLinkagesResponse
```

## Topics

### Dictionaries
- [object AppPerformanceOverviewsLinkagesResponse.Data](appperformanceoverviewslinkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([AppPerformanceOverviewsLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appperformanceoverviewslinkagesresponse)*