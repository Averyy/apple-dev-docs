...
```swift
object AppScreenshotSetCreateRequest.Data.Relationships
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appscreenshotsetcreaterequest/data-data.dictionary/relationships-data.dictionary)*