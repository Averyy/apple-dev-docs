...
```swift
object GameCenterGroupGameCenterActivitiesLinkagesResponse
```

## Topics

### Dictionaries
- [object GameCenterGroupGameCenterActivitiesLinkagesResponse.Data](gamecentergroupgamecenteractivitieslinkagesresponse/data-data.dictionary.md)
  The resource linkage data identifying a Game Center activity associated with a group.

## Properties

- `data` ([GameCenterGroupGameCenterActivitiesLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/gamecentergroupgamecenteractivitieslinkagesresponse)*