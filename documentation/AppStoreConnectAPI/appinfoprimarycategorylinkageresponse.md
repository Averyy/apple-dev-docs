...
```swift
object AppInfoPrimaryCategoryLinkageResponse
```

## Topics

### Dictionaries
- [object AppInfoPrimaryCategoryLinkageResponse.Data](appinfoprimarycategorylinkageresponse/data-data.dictionary.md)

## Properties

- `data` (AppInfoPrimaryCategoryLinkageResponse.Data) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/appinfoprimarycategorylinkageresponse)*