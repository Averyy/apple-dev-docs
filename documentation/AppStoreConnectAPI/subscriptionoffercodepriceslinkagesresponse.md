...
```swift
object SubscriptionOfferCodePricesLinkagesResponse
```

## Topics

### Dictionaries
- [object SubscriptionOfferCodePricesLinkagesResponse.Data](subscriptionoffercodepriceslinkagesresponse/data-data.dictionary.md)

## Properties

- `data` ([SubscriptionOfferCodePricesLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/subscriptionoffercodepriceslinkagesresponse)*