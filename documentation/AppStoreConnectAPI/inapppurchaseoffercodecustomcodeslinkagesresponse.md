...
- `data` ([InAppPurchaseOfferCodeCustomCodesLinkagesResponse.Data]) *(required)*
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/inapppurchaseoffercodecustomcodeslinkagesresponse)*