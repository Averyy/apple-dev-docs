...
```swift
object SubscriptionLocalizationV2Response
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/subscriptionlocalizationv2response)*