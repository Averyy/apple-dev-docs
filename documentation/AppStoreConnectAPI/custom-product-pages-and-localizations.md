...
- [App Custom Product Pages](app-custom-product-pages.md)
...
- [App Custom Product Page Versions](app-custom-product-page-versions.md)
  Create and update a version of your custom product page.
### Managing Custom Product Page Localizations
- [App Custom Product Page Localizations](app-custom-product-page-localizations.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreconnectapi/custom-product-pages-and-localizations)*