...
![An illustration that shows a person in a bedroom with a window, light fixture, bed, nightstand with an alarm clock, and a wheelchair. The person is waking up in the morning, sitting up on the bed, and using an iPhone.](/images/com.apple.Accessibility/accessibility-scene-mobility@2x.png)
...
*[View on Apple Developer](https://developer.apple.com/documentation/accessibility/mobility)*