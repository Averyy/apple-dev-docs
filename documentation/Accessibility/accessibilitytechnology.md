...
### Initializers
- [init(rawValue: String)](accessibilitytechnology/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/accessibility/accessibilitytechnology)*