...
### Initializers
- [init(expressions: [AXMathExpression])](axmathexpressiontable/init(expressions:).md)
### Instance Properties
- [var expressions: [AXMathExpression]](axmathexpressiontable/expressions.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/accessibility/axmathexpressiontable)*