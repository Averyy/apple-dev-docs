...
### Initializers
- [init(content: String)](axmathexpressionoperator/init(content:).md)
### Instance Properties
- [var content: String](axmathexpressionoperator/content.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/accessibility/axmathexpressionoperator)*