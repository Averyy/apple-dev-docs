...
### Type Properties
- [class var current: AccessibilityRequest?](accessibilityrequest/current.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/accessibility/accessibilityrequest)*