...
### Initializers
- [init(content: String)](axmathexpressionidentifier/init(content:).md)
### Instance Properties
- [var content: String](axmathexpressionidentifier/content.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/accessibility/axmathexpressionidentifier)*