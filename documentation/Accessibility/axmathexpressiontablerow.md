...
### Initializers
- [init(expressions: [AXMathExpression])](axmathexpressiontablerow/init(expressions:).md)
### Instance Properties
- [var expressions: [AXMathExpression]](axmathexpressiontablerow/expressions.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/accessibility/axmathexpressiontablerow)*