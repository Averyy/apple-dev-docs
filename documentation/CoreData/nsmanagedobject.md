...
> **Note**: The default value for doc://com.apple.documentation/documentation/objectivec/nsobject/1409370-automaticallynotifiesobserversfo is `false` for managed properties of a `NSManagedObject`, and `true` for unmanaged properties.
