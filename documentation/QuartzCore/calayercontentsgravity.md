...
### Initializers
- [init(rawValue: String)](calayercontentsgravity/init(rawvalue:).md)
### Type Properties
...
*[View on Apple Developer](https://developer.apple.com/documentation/quartzcore/calayercontentsgravity)*