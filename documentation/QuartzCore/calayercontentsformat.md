...
### Initializers
- [init(rawValue: String)](calayercontentsformat/init(rawvalue:).md)
### Type Properties
...
*[View on Apple Developer](https://developer.apple.com/documentation/quartzcore/calayercontentsformat)*