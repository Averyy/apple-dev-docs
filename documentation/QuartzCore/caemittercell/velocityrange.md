...
The range specifies the mean amount the initial [`velocity`](caemittercell/velocity.md) value change.
...
*[View on Apple Developer](https://developer.apple.com/documentation/quartzcore/caemittercell/velocityrange)*