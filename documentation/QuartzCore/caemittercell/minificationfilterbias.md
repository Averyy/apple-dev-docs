...
This value is used by the [`minificationFilter`](caemittercell/minificationfilter.md) property when it is set to `kCAFilterTrilinear`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/quartzcore/caemittercell/minificationfilterbias)*