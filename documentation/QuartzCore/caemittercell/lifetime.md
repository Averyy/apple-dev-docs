...
The lifetime of the cell will vary by a random amount with the range specified by [`lifetimeRange`](caemittercell/lifetimerange.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/quartzcore/caemittercell/lifetime)*