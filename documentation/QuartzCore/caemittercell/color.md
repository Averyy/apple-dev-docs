...
The specified color of the cell will vary by a random amount within the [`redRange`](caemittercell/redrange.md), [`greenRange`](caemittercell/greenrange.md), [`blueRange`](caemittercell/bluerange.md) and [`alphaRange`](caemittercell/alpharange.md)values over the lifetime of the cell. The [`redSpeed`](caemittercell/redspeed.md), [`greenSpeed`](caemittercell/greenspeed.md), [`blueSpeed`](caemittercell/bluespeed.md), and [`alphaSpeed`](caemittercell/alphaspeed.md) determine the rate of change.
...
*[View on Apple Developer](https://developer.apple.com/documentation/quartzcore/caemittercell/color)*