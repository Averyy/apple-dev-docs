...
The range specifies the mean amount that the [`scale`](caemittercell/scale.md) value can vary for the cell over its lifetime.
...
*[View on Apple Developer](https://developer.apple.com/documentation/quartzcore/caemittercell/scalerange)*