...
```swift
var alphaRange: Float { get set }
```

#### Discussion

The range specifies the mean amount by which the alpha component of the [`color`](caemittercell/color.md) property can vary for the cell.
...
*[View on Apple Developer](https://developer.apple.com/documentation/quartzcore/caemittercell/alpharange)*