...
The range specifies the mean amount by which the blue component of the [`color`](caemittercell/color.md) property can vary for the cell.
...
*[View on Apple Developer](https://developer.apple.com/documentation/quartzcore/caemittercell/bluerange)*