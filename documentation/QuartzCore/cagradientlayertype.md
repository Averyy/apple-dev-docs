...
### Initializers
- [init(rawValue: String)](cagradientlayertype/init(rawvalue:).md)
### Type Properties
- [static let axial: CAGradientLayerType](cagradientlayertype/axial.md)
...
- [static let conic: CAGradientLayerType](cagradientlayertype/conic.md)
- [static let radial: CAGradientLayerType](cagradientlayertype/radial.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/quartzcore/cagradientlayertype)*