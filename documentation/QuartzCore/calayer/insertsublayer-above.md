...
- `sibling`: An existing sublayer in the current layer. The layer in `aLayer` is inserted after this layer in the [`sublayers`](calayer/sublayers.md) array, and thus appears in front of it visually.
...
*[View on Apple Developer](https://developer.apple.com/documentation/quartzcore/calayer/insertsublayer(_:above:))*