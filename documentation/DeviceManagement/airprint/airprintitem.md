...
- `ForceTLS` (boolean): If `true`, AirPrint connections are secured by Transport Layer Security (TLS). Available only in iOS 11 and later. Available: iOS 11+ | iPadOS 11+ | visionOS 2+
