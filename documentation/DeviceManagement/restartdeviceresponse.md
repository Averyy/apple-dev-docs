...
### Objects
- [object RestartDeviceResponse.ErrorChainItem](restartdeviceresponse/errorchainitem.md)
...
- `ErrorChain` ([RestartDeviceResponse.ErrorChainItem]): An array of dictionaries that describes any errors that occur.
...
- `UserLongName` (string) *(required)*: The full name of the user. Available: macOS 10.13+
...
*[View on Apple Developer](https://developer.apple.com/documentation/devicemanagement/restartdeviceresponse)*