...
- `ManifestURL` (string): The URL of the app manifest, which needs to begin with `https:`. The manifest is returned as a property list that uses the [`ManifestURL`](manifesturl.md) format. Available: iOS 7+ | iPadOS 7+ | macOS 10.9+ | tvOS 10.2+ | visionOS 1.1+ | watchOS 10+
