...
- [object ActiveNSExtensionsResponse.ExtensionsItem](activensextensionsresponse/extensionsitem.md)
...
- `ErrorChain` ([ActiveNSExtensionsResponse.ErrorChainItem]): An array of dictionaries that describes any errors that occur.
- `Extensions` ([ActiveNSExtensionsResponse.ExtensionsItem]) *(required)*: An array of dictionaries that contains information about active extensions on the device.
...
*[View on Apple Developer](https://developer.apple.com/documentation/devicemanagement/activensextensionsresponse)*