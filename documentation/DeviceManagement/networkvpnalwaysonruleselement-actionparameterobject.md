...
```swift
object NetworkVPNAlwaysOnRulesElement_ActionParameterObject
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/devicemanagement/networkvpnalwaysonruleselement_actionparameterobject)*