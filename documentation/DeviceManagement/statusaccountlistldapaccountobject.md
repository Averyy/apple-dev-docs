...
- `is-enabled` (boolean): A Boolean value that indicates whether the account is enabled for use with the Contacts app.
...
*[View on Apple Developer](https://developer.apple.com/documentation/devicemanagement/statusaccountlistldapaccountobject)*