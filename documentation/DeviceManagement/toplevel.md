...
- `EncryptedPayloadContent` (data): Enabled if `IsEncrypted` is `true`.
- `PayloadContent` ([TopLevel.PayloadContentItem]) *(required)*: The array of payload dictionaries. If `IsEncrypted` is `true`, this array isn’t needed.
