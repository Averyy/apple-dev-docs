...
![The device management service regularly monitors the Apple Software Lookup Service for new releases](https://docs-assets.developer.apple.com/published/24facd46598191547b16752d0cee95f4/su-phase1%402x.png)
...
![The device management service creates the enforcement configuration and syncs it to the device](https://docs-assets.developer.apple.com/published/1978201dfc0054786e8bd05e479d2811/su-phase2%402x.png)
...
![The device retrieves the download URL and begins the download and preparation of the software update](https://docs-assets.developer.apple.com/published/ed5d8865d97d224e01e2bc0a5922cbc2/su-phase3%402x.png)
...
![The device enters the notification period to regularly inform the user](https://docs-assets.developer.apple.com/published/6fc4d7539aa305b097e632e2abcc21cd/su-phase4%402x.png)
...
![The device enforces installtion of the software update and sends status reports to the device management service](https://docs-assets.developer.apple.com/published/989b5f502f333a2519062edd53c299e2/su-phase5%402x.png)
...
![The device sends updated information to the device management service](https://docs-assets.developer.apple.com/published/3f8b9aec960ed2f41d9dc4d69b98d87f/su-phase6%402x.png)
...
![Unassign the configuration and send a push notification to initiate synchronization](https://docs-assets.developer.apple.com/published/c5491a961d03cb3d7fa7074374c043df/su-phase7%402x.png)
...
*[View on Apple Developer](https://developer.apple.com/documentation/devicemanagement/phases-of-software-update-enforcement)*