...
This command doesn’t return certificates that Declarative Device Management installs. Instead, use the Declarative Device Management [`StatusSecurityCertificateList`](statussecuritycertificatelist.md) status item to monitor the Declarative Device Management certificates.
...
<dict>
    ...
    <array>
        <dict>
            <key>CommonName</key>
            <string>Example Root Cert</string>
            <key>Data</key>
            <data>
    ...
    <key>CommandUUID</key>
    <string>0001-CertificateList</string>
    <key>Status</key>
