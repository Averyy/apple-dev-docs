...
- `RetryDelay` (integer): The number of seconds to wait between subsequent retries. The first retry is attempted without this delay. Available: iOS 4+ | iPadOS 4+ | macOS 10.10+ | tvOS 9+ | visionOS 1+ | watchOS 3+
