...
- `Identifier` (string) *(required)*: A string uniquely identifying this declaration. The size of this string should not exceed 64 octets. A UUID string value is a good choice.
- `Payload` (DeclarationBase.Payload) *(required)*: The payload describing this declaration.
- `ServerToken` (string) *(required)*: A unique token generated by the server specifying a particular revision of the declaration. The size of this string should not exceed 64 octets.
