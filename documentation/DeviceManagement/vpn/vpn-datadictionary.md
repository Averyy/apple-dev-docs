...
- `OnDemandUserOverrideDisabled` (integer): If `1`, the device disables the Connect On Demand toggle in Settings for this configuration. Not available in watchOS. Available: iOS 14+ | iPadOS 14+ | tvOS 17+ | visionOS 1+
...
- `ProviderDesignatedRequirement` (string): If the VPN provider uses a system extension, this field is required. Not available in watchOS. Available: macOS 10.15+ | tvOS 17+
