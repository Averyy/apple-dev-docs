...
**Availability**:
- iOS 5.0+ - Deprecated
- iPadOS 5.0+ - Deprecated
- macOS 10.9+ - Deprecated
- tvOS 9.0+ - Deprecated
- visionOS 1.1+ - Deprecated
- watchOS 10.0+ - Deprecated
...
Apple deprecated this setting in iOS 13.4. Use [`SettingsCommand.Command.Settings.SharedDeviceConfiguration`](settingscommand/command-data.dictionary/settings-data.dictionary/shareddeviceconfiguration-data.dictionary.md) instead. This setting doesn’t support User Enrollment, and is only available for Shared iPad.
