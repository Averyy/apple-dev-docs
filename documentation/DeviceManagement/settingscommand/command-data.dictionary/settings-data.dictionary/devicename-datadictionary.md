...
This setting doesn’t support User Enrollment, and is only available on supervised devices.
...
*[View on Apple Developer](https://developer.apple.com/documentation/devicemanagement/settingscommand/command-data.dictionary/settings-data.dictionary/devicename-data.dictionary)*