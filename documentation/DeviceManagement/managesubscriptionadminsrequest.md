...
```swift
object ManageSubscriptionAdminsRequest
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/devicemanagement/managesubscriptionadminsrequest)*