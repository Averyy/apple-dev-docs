...
To learn how to obtain information about event taps, see the function [`CGGetEventTapList(_:_:_:)`](cggeteventtaplist(_:_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgeventtapinformation)*