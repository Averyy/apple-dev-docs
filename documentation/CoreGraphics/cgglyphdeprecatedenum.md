...
### Constants
- [CGGlyphDeprecatedEnum.max](cgglyphdeprecatedenum/max.md)
  Maximum font index value.
- [CGGlyphDeprecatedEnum.min](cgglyphdeprecatedenum/min.md)
  Minimum font index value.
### Initializers
- [init?(rawValue: Int32)](cgglyphdeprecatedenum/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgglyphdeprecatedenum)*