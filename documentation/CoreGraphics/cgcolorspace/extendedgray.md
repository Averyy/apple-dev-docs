...
This color space has the same colorimetry as [`genericGrayGamma2_2`](cgcolorspace/genericgraygamma2_2.md); in addition, you may encode component values below `0.0` and above `1.0`. Negative values are encoded as the signed reflection of the original encoding function, as shown below
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgcolorspace/extendedgray)*