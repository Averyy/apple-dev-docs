...
This color space has the same colorimetry as [`linearGray`](cgcolorspace/lineargray.md); in addition, you may encode component values below `0.0` and above `1.0`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgcolorspace/extendedlineargray)*