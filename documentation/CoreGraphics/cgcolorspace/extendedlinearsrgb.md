...
This color space has the same colorimetry as [`linearSRGB`](cgcolorspace/linearsrgb.md); in addition, you may encode component values below `0.0` and above `1.0`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgcolorspace/extendedlinearsrgb)*