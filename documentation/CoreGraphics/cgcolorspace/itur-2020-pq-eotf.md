...
This color space has the same colorimetry as [`itur_2020`](cgcolorspace/itur_2020.md), but uses the Perceptual Quantizer (PQ) transfer function. A pixel value of `1.0` is assumed to be `100` nits. See the current active version of the BT.2100 recommendation on the ITU website ([`https://www.itu.int/`](https://developer.apple.comhttps://www.itu.int/)).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgcolorspace/itur_2020_pq_eotf)*