...
This color space has the same colorimetry as [`itur_2020`](cgcolorspace/itur_2020.md), but uses a linear transfer function. You may encode component values below `0.0` and above `1.0`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgcolorspace/extendedlinearitur_2020)*