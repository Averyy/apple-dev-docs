...
For example, see the function [`CGWaitForScreenRefreshRects(_:_:)`](cgwaitforscreenrefreshrects(_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgrectcount)*