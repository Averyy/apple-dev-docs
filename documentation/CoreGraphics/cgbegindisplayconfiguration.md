...
This function creates a display configuration object that provides a context for a set of display configuration changes. After you specify the desired changes, you use [`CGCompleteDisplayConfiguration(_:_:)`](cgcompletedisplayconfiguration(_:_:).md) to apply them in a single transaction.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgbegindisplayconfiguration(_:))*