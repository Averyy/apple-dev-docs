...
For information about the characteristics of a main display, see [`CGMainDisplayID()`](cgmaindisplayid().md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgdisplayismain(_:))*