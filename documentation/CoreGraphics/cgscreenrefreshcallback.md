...
To register a screen-refresh callback function, you call the function [`CGRegisterScreenRefreshCallback(_:_:)`](cgregisterscreenrefreshcallback(_:_:).md). Quartz invokes your callback function when operations such as drawing, window movement, scrolling, or display reconfiguration occur on local displays. When you finish using a callback registration, you should call the function [`CGUnregisterScreenRefreshCallback(_:_:)`](cgunregisterscreenrefreshcallback(_:_:).md) to remove it.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgscreenrefreshcallback)*