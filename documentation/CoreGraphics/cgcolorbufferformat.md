...
### Initializers
- [init()](cgcolorbufferformat/init.md)
- [init(version: UInt32, bitmapInfo: CGBitmapInfo, bitsPerComponent: Int, bitsPerPixel: Int, bytesPerRow: Int)](cgcolorbufferformat/init(version:bitmapinfo:bitspercomponent:bitsperpixel:bytesperrow:).md)
### Instance Properties
- [var bitmapInfo: CGBitmapInfo](cgcolorbufferformat/bitmapinfo.md)
- [var bitsPerComponent: Int](cgcolorbufferformat/bitspercomponent.md)
- [var bitsPerPixel: Int](cgcolorbufferformat/bitsperpixel.md)
- [var bytesPerRow: Int](cgcolorbufferformat/bytesperrow.md)
- [var version: UInt32](cgcolorbufferformat/version.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgcolorbufferformat)*