...
To hide or show the cursor, you can use the functions [`CGDisplayHideCursor(_:)`](cgdisplayhidecursor(_:).md) and [`CGDisplayShowCursor(_:)`](cgdisplayshowcursor(_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgcursorisvisible())*