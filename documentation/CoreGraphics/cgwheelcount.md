...
See the function [`CGPostScrollWheelEvent`](cgpostscrollwheelevent.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgwheelcount)*