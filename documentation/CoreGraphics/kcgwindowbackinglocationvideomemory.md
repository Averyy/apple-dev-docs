...
The key that identifies whether the window’s backing store is located in video memory. The value for this key is a [`CFBoolean`](https://developer.apple.com/documentation/CoreFoundation/CFBoolean) type.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/kcgwindowbackinglocationvideomemory)*