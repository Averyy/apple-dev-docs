# CGImageCreateCopyWithContentHeadroom(_:_:)
...
```swift
func CGImageCreateCopyWithContentHeadroom(_ headroom: Float, _ image: CGImage) -> CGImage?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgimagecreatecopywithcontentheadroom(_:_:))*