# CGImageGetContentAverageLightLevel(_:)
...
```swift
func CGImageGetContentAverageLightLevel(_ image: CGImage) -> Float
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgimagegetcontentaveragelightlevel(_:))*