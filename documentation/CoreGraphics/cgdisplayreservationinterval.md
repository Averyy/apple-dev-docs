...
For more information about fade reservations, see the function [`CGAcquireDisplayFadeReservation(_:_:)`](cgacquiredisplayfadereservation(_:_:).md). Fade reservation tokens are discussed in [`CGDisplayFadeReservationToken`](cgdisplayfadereservationtoken.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgdisplayreservationinterval)*