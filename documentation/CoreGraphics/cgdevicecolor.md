...
### Initializers
- [init()](cgdevicecolor/init.md)
- [init(red: Float, green: Float, blue: Float)](cgdevicecolor/init(red:green:blue:).md)
### Instance Properties
- [var blue: Float](cgdevicecolor/blue.md)
- [var green: Float](cgdevicecolor/green.md)
- [var red: Float](cgdevicecolor/red.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgdevicecolor)*