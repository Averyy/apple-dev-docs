...
### Constants
- [CGGesturePhase.began](cggesturephase/began.md)
...
### Initializers
- [init?(rawValue: UInt32)](cggesturephase/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cggesturephase)*