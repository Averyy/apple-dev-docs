...
When requesting a new display mode, you can specify a desired refresh rate as a hint to Quartz. For example, see the function [`CGDisplayBestModeForParametersAndRefreshRate(_:_:_:_:_:_:)`](cgdisplaybestmodeforparametersandrefreshrate(_:_:_:_:_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgrefreshrate)*