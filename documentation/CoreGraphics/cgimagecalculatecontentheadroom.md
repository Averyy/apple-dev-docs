# CGImageCalculateContentHeadroom(_:)
...
```swift
func CGImageCalculateContentHeadroom(_ image: CGImage) -> Float
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgimagecalculatecontentheadroom(_:))*