...
```swift
func CGPDFContextSetParentTree(_ context: CGContext, _ parentTreeDictionary: CGPDFDictionaryRef)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgpdfcontextsetparenttree(_:_:))*