...
Quartz uses this data type to specify the duration of both fade-out and fade-in operations. Values may range from 0 to `kCGMaxDisplayReservationInterval` seconds. A 0 value means fade immediately—see [`CGDisplayFade(_:_:_:_:_:_:_:_:)`](cgdisplayfade(_:_:_:_:_:_:_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgdisplayfadeinterval)*