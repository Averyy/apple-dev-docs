...
An image containing the contents of the specified display. If the display ID is invalid, the return value is `NULL`. In Objective-C, you’re responsible for releasing the image created by calling [`CGImageRelease`](cgimagerelease.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgdisplaycreateimage(_:))*