...
For general information about blend fractions, see the data type [`CGDisplayBlendFraction`](cgdisplayblendfraction.md). For information about how these constants are used, see the function [`CGDisplayFade(_:_:_:_:_:_:_:_:)`](cgdisplayfade(_:_:_:_:_:_:_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/display-fade-blend-fractions)*