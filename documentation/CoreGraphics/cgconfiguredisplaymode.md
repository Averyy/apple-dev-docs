...
- A dictionary returned by one of the `CGDisplayBestMode` functions, such as [`CGDisplayBestModeForParameters(_:_:_:_:_:)`](cgdisplaybestmodeforparameters(_:_:_:_:_:).md).
- A dictionary in the array returned by [`CGDisplayAvailableModes(_:)`](cgdisplayavailablemodes(_:).md).
...
This deprecated function takes as a parameter a display mode dictionary. Starting in OS X v10.6, display mode dictionaries have been replaced by the `CGDisplayMode` opaque type. For information on the `CGDisplayMode` opaque type, see [`Getting Information About a Display Mode`](quartz-display-services#Getting-Information-About-a-Display-Mode.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgconfiguredisplaymode(_:_:_:))*