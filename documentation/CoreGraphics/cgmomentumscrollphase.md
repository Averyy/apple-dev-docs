...
### Initializers
- [init?(rawValue: UInt32)](cgmomentumscrollphase/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgmomentumscrollphase)*