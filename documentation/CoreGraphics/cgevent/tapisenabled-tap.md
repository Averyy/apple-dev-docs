...
For more information, see the function [`tapEnable(tap:enable:)`](cgevent/tapenable(tap:enable:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgevent/tapisenabled(tap:))*