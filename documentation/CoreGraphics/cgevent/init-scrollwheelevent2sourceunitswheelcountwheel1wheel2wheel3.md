# init(scrollWheelEvent2Source:units:wheelCount:wheel1:wheel2:wheel3:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgevent/init(scrollwheelevent2source:units:wheelcount:wheel1:wheel2:wheel3:))*