...
To learn how to find the mask bit that corresponds to a given display, see the function [`CGDisplayIDToOpenGLDisplayMask(_:)`](cgdisplayidtoopengldisplaymask(_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgopengldisplaymask)*