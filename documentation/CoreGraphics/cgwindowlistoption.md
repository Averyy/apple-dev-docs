...
### Initializers
- [init(rawValue: UInt32)](cgwindowlistoption/init(rawvalue:).md)
### Type Properties
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgwindowlistoption)*