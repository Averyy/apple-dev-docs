...
As an alternative, Quartz also supports asynchronous notification—see [`CGRegisterScreenRefreshCallback(_:_:)`](cgregisterscreenrefreshcallback(_:_:).md) and [`CGScreenRegisterMoveCallback(_:_:)`](cgscreenregistermovecallback(_:_:).md). If refresh or move callback functions are registered, this function should not be used.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgwaitforscreenupdaterects(_:_:_:_:_:))*