...
You must call the function [`endPDFPage()`](cgcontext/endpdfpage().md) to signal the end of the page.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgcontext/beginpdfpage(_:))*