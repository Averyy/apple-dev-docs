...
- `releaseCallback`: The custom release function to call when it is time to release the bitmap data. For the syntax of this function, see the description of the   data type. You may specify   for this parameter.
- `releaseInfo`: A pointer to any data you want passed to the your custom release callback.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgcontext/init(data:width:height:bitspercomponent:bytesperrow:space:bitmapinfo:releasecallback:releaseinfo:))*