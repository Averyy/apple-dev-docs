...
Sub-pixel positioning is used by the graphics context if it is allowed, enabled, and if the font itself is antialiased when drawn. For information on how to enable subpixel positioning, see the [`setShouldSubpixelPositionFonts(_:)`](cgcontext/setshouldsubpixelpositionfonts(_:).md) function.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgcontext/setallowsfontsubpixelpositioning(_:))*