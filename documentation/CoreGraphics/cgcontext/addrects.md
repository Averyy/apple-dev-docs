...
Calling this convenience method is equivalent to repeatedly calling the [`addRect(_:)`](cgcontext/addrect(_:).md) method for each rectangle in the array.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgcontext/addrects(_:))*