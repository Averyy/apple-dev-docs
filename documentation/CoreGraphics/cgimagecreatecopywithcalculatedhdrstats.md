# CGImageCreateCopyWithCalculatedHDRStats(_:)
...
```swift
func CGImageCreateCopyWithCalculatedHDRStats(_ image: CGImage) -> CGImage?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgimagecreatecopywithcalculatedhdrstats(_:))*