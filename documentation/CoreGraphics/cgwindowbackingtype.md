...
### Initializers
- [init?(rawValue: UInt32)](cgwindowbackingtype/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coregraphics/cgwindowbackingtype)*