...
```swift
var focusDetectionID: CNDecision.FocusDetectionID { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/cinematic/cndecision-swift.struct/focusdetectionid-swift.property)*