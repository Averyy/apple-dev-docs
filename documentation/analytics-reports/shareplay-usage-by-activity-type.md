# SharePlay Usage by Activity Type
...
The data in this report shows information about SharePlay usage including the type of activity.
...
| Activity Type | Type of SharePlay activity in use, which matches the type in GroupActivityMetadata.ActivityType | `string` |

#### Glossary

| Dimension | Value | Definition |
| --- | --- | --- |
| Activity Type | listenTogether | A shared listening activity, such as listening to music together |
| Activity Type | watchTogether | A shared watching activity, such as watching an episode of a television show together |
| Activity Type | workoutTogether | A shared workout activity, such as participating in a fitness class together |
| Activity Type | playTogether | A shared gaming activity initiated through Game Center |
| Activity Type | shopTogether | A shared shopping activity, such as browsing for products online together |
| Activity Type | readTogether | A shared reading activity, such as reading a book together |
| Activity Type | exploreTogether | A shared exploration activity, such as planning a trip together or browsing a web feed together |
| Activity Type | learnTogether | A shared learning activity, such as studying a topic together |
| Activity Type | createTogether | A shared creation activity, such as drawing on an art canvas together. |
| Activity Type | generic | A generic activity. |
| Activity Type | Unknown | Error case: activity type could not be found. |
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/shareplay-usage-by-activity-type)*