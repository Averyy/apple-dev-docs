...
The data in this report details playback errors during media streaming of HTTP Live Streaming (HLS) assets via AVFoundation APIs.
...
| Error Code | Error code with which the playback ended | `string` |

#### Glossary

| Dimension | Value | Definition |
| --- | --- | --- |
| Error Code | -12,000 | Internal CoreMedia error code |
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/http-live-streaming-playback-errors)*