...
The data in this report contains information about language preference settings.
...
| Language | Language identifier for the application | `string` |
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/application-preferred-language-settings)*