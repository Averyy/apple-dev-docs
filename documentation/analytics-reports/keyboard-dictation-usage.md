...
The data in this report details keyboard dictation usage.
...
| Event | Describes which Siri event type is associated with this data | `string` |
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/keyboard-dictation-usage)*