# Audio Session Audio Unit Usage
...
The data in this report contains counts of your application’s use of Audio Units.
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/audio-session-audio-unit-usage)*