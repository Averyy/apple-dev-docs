# Wi-Fi Known Network Modifications
...
The data in this report contains information about people adding and removing known networks by using your app’s Wi-Fi manager.
...
| Operation | Operations performed on KnownNetwork | `string` |

#### Glossary

| Dimension | Value | Definition |
| --- | --- | --- |
| Operation | WiFiKnownNetworkAdded | Addition of a network to the system known networks list |
| Operation | WiFiKnownNetworkRemoved | Removal of a network to the system known networks list |
| Operation | WiFiKnownNetworkUpdated | Update of a network to the system known networks list |
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/wi-fi-known-network-modifications)*