...
| Document Type | Strings that describe the type of document the app requests | `string` |
| Is Developer Test ID | If true, the response from the API is based on a test ID instead of a real ID | `boolean` |
| Outcome | Strings that describe the outcome of the API call | `string` |
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/verify-with-wallet-document-request-availability)*