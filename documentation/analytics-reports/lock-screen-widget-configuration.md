...
The data in this report details widgets configured on the Lock Screen.
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/lock-screen-widget-configuration)*