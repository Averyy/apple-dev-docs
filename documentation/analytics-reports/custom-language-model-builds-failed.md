...
The data in this report details the number of times that the app-triggered rebuild of a Speech framework custom language model failed.
...
| Artifact Identifier | A developer-defined string that uniquely identifies the language model | `string` |

#### Glossary

| Dimension | Value | Definition |
| --- | --- | --- |
| Artifact Identifier | string | A developer-defined string that uniquely identifies the language model |
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/custom-language-model-builds-failed)*