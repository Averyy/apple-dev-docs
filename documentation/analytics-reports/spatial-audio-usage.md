...
The data in this report contains information about spatial audio modes or usage per application.
...
| Head Tracking | Whether head tracking is turned on | `boolean` |
| Spatial Audio | Whether spatial audio is turned on | `boolean` |
| Up Mixing | Whether stereo up-mixing is turned on | `boolean` |
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/spatial-audio-usage)*