# Bluetooth LE Connection Results
...
The data in this report shows Low Energy (LE) connection results.
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/bluetooth-le-connection-results)*