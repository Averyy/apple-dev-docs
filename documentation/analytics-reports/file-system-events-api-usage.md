...
The data in this report contains information about each client of file-system events. It includes the number of processes that subscribe to file-system events, the number of paths watched, and the string allocation count.
...
| Allocated Bytes | Count of string allocation for App Apple ID | `integer` |
| Paths Count | Number of watched paths for App Apple ID | `integer` |
| PIDs Count | Number of file-system events clients (PIDs) with the same App Apple ID | `integer` |
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/file-system-events-api-usage)*