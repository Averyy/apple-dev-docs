...
Use this report to help you understand eSIM-provisioning operations. The information includes success rate, failure reason, eSIM install type, client type, flow phase, and app names.
...
| Carrier Name | Carrier name from SMDP | `string` |
| Result | Provisioning results are: 0 for unknown, 1 for success, 2 for failure, and 3 for incomplete. | `string` |
| MCC | Country code | `string` |
| MNC | Network code | `string` |

#### Glossary

| Dimension | Value | Definition |
| --- | --- | --- |
| Carrier Name | [‘iPad’ | ipad |
| Carrier Name | ‘Verizon’ | Verizon |
| Carrier Name | ‘AT&T’ | AT&T |
| Carrier Name | ‘T-Mobile’ | T-Mobile |
| Carrier Name | ‘Carrier Lab’] | Carrier Lab |
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/cellular-plan-provisioning)*