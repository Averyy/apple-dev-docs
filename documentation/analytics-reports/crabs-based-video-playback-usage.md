# CRABS-Based Video Playback Usage
...
The data in this report contains information about CRABS video playback or video playback that is streamed using the CRABS protocol (legacy compared to HLS) by application.
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/crabs-based-video-playback-usage)*