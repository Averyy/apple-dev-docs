...
The data in this report counts changes in Dynamic Island layout state.
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/dynamic-island-layout-changes)*