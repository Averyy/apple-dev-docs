# Game Controller Haptics Engine Creation
...
The data in this report details the haptic localities that an app uses. It includes information about haptic use frequency and controller use frequency.
...
| Product Category | The controller type for which the app creates the haptic engine | `string` |
| Haptic Locality | The haptic locality of the haptic engine | `string` |

#### Glossary

| Dimension | Value | Definition |
| --- | --- | --- |
| Product Category | Xbox Wireless Controller, DualSense | The name of the game controller device which is involved in the haptic feedback |
| Haptic Locality | right, left | Which of the haptic engines has been triggered, given by a location or “locality” name defined in public Apple SDKs |
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/game-controller-haptics-engine-creation)*