...
The data in this report details the number of photo or video sharing events from Photos.
...
| Excludes Live Photo Vitality | Whether the shared media excludes Live Photo sound and motion vitality | `boolean` |
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/photos-sharing)*