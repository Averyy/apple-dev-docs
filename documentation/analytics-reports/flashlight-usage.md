...
The data in this report contains information about flashlight state per application or client.
...
| State | On or off state of flashlight | `boolean` |
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/flashlight-usage)*