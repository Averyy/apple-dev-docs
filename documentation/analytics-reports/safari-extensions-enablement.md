...
This report contains the count of unique devices where an extension is turned on. This data is aggregated and reported on a weekly basis per device. People turn on extensions in Safari settings or through the Page Format menu.
...
| Enabled | Whether or not the extension is currently enabled | `boolean` |
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/safari-extensions-enablement)*