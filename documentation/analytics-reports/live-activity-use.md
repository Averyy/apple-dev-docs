...
This report contains information on your application’s use of Live Activity from start to end.
...
| Duration | The duration of the live activity | `integer` |
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/live-activity-use)*