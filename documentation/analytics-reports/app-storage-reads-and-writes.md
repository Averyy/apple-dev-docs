...
The data in this report details the number of reads and writes your app performs on users’ disks.
...
| Bytes Read | The number of bytes read by the application | `integer` |
| Bytes Written | The number of bytes written by the application | `integer` |
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/app-storage-reads-and-writes)*