...
The data in this report contains aggregate information about loading Core ML models. The information includes ML model metrics such as the model name, model type, model origin, the app’s bundle identifier and possible error codes.
...
| Model Type | The Type of the model. | `integer` |
| Model Origin | The origin of the model. | `integer` |
| Model Load Error | The code of possible error | `integer` |
...
| --- | --- | --- |
| Model Name | model1 | name of the model |
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/load-coreml-models-metrics)*