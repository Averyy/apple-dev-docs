...
The data in this report contains information about the maximum number of Metal command queues that are in flight concurrently.
...
| Bundle Version | The version number of the bundle | `string` |
| Software Development Kit | Operation System (OS) version | `string` |
| Command Queues In Flight | The command queues in flight | `integer` |

#### Glossary

| Dimension | Value | Definition |
| --- | --- | --- |
| Bundle Version | Bundle version | The version number of the bundle |
| Software Development Kit | SDK version | The version of the SDK that the application is linked against |
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/metal-command-queues)*