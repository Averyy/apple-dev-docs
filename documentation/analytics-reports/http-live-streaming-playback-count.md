# HTTP Live Streaming Playback Count
...
The data in this report contains information about the count of playback sessions during media streaming of HTTP Live Streaming (HLS) assets via AVFoundation APIs.
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/http-live-streaming-playback-count)*