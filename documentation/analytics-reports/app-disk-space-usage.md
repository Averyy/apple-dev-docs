...
The data in this report details how much storage your app uses. The information matches the content on the storage pane in the app’s Settings menu.
...
| Data Size | Total data size of the app | `long` |
| Binary Size | Binary size of the app | `long` |
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/app-disk-space-usage)*