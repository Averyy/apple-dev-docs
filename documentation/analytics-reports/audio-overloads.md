...
The data in this report contains details on the number of audio glitches people encounter in your application.
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/audio-overloads)*