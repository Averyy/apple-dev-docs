...
The data in this report contains aggregate information about [`AirPlay`](https://developer.apple.comhttps://developer.apple.com/airplay) errors. It presents errors and information about multiple dimensions of device configuration, and shows the count and percentage of each error occurrence.
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/airplay-errors)*