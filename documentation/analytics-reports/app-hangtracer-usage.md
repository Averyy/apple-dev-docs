...
Use this report to understand an aggregation of the time that your app leverages the HangTracer Framework to monitor foreground UI responsiveness. This information includes total runloop time, foreground time, and bundleID of the foregrounded app.
...
| Foreground Time | How long an app is foreground, tracked by the HangTracer framework | `integer` |
| Runloop time | Duration of CFRunloop turns for foregrounded app | `integer` |
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/app-hangtracer-usage)*