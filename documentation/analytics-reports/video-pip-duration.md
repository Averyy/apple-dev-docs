...
The data in this report details the duration of time spent in Picture in Picture (PiP) for the app.
...
| Active Duration | The total duration, in seconds, that the source was actively in PiP, excluding sessions of 8 seconds or less. | `float` |
...
*[View on Apple Developer](https://developer.apple.com/documentation/analytics-reports/video-pip-duration)*