...
```swift
var schemaVersion: InsightType.SchemaVersion
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/trustinsights/insightevaluator/insightrequest/schemaversion)*