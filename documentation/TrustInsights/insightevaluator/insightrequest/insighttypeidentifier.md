...
```swift
var insightTypeIdentifier: String { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/trustinsights/insightevaluator/insightrequest/insighttypeidentifier)*