...
```swift
let requestedInsight: (repeat each InsightRequest)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/trustinsights/insightevaluator/insightcontext/requestedinsight)*