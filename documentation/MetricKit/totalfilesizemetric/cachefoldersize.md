...
```swift
let cacheFolderSize: Measurement<UnitInformationStorage>
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/metrickit/totalfilesizemetric/cachefoldersize)*