...
```swift
let binaryFileSize: Measurement<UnitInformationStorage>
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/metrickit/totalfilesizemetric/binaryfilesize)*