...
```swift
let highCPUTerminationCount: Int
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/metrickit/backgroundterminationmetric/highcputerminationcount)*