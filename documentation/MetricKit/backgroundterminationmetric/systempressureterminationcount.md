...
```swift
let systemPressureTerminationCount: Int
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/metrickit/backgroundterminationmetric/systempressureterminationcount)*