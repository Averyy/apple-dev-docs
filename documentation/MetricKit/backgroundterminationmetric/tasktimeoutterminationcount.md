...
```swift
let taskTimeoutTerminationCount: Int
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/metrickit/backgroundterminationmetric/tasktimeoutterminationcount)*