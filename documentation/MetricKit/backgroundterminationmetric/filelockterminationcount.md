...
```swift
let fileLockTerminationCount: Int
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/metrickit/backgroundterminationmetric/filelockterminationcount)*