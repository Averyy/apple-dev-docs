...
This metric corresponds to the [`MetricResult.totalCellularDownload(_:)`](metricresult/totalcellulardownload(_:).md) case. It appears only in [`intervalEntries`](metricreport/intervalentries.md) and is not included in state entries.
...
### Measurements
- [let value: Measurement<UnitInformationStorage>](totalcellulardownloadmetric/value.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metrickit/totalcellulardownloadmetric)*