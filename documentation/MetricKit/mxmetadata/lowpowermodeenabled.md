...
Retrieve the current setting of the system for the low power mode setting. On systems where the low power mode is unknown or unsupported, the value returned from the [`lowPowerModeEnabled`](mxmetadata/lowpowermodeenabled.md) property is always NO.
...
*[View on Apple Developer](https://developer.apple.com/documentation/metrickit/mxmetadata/lowpowermodeenabled)*