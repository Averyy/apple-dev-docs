...
```swift
let bestAccuracyForNavigation: Measurement<UnitDuration>
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/metrickit/locationactivitytimemetric/bestaccuracyfornavigation)*