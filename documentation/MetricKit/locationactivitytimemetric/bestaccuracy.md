...
```swift
let bestAccuracy: Measurement<UnitDuration>
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/metrickit/locationactivitytimemetric/bestaccuracy)*