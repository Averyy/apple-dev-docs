...
```swift
var lockCellularPlan: Bool? { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/managedsettings/cellularsettings/lockcellularplan-swift.property)*