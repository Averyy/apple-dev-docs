...
```swift
@MainActor
@preconcurrency func preferredWindowClippingMargins(_ edges: Edge3D.Set, _ margins: EdgeInsets3D) -> some View
```
...
- `margins`: The amount by which the scene’s logical bounds are   inset from the rendering bounds.


---

*[View on Apple Developer](https://developer.apple.com/documentation/permissionkit/communicationlimitsbutton/preferredwindowclippingmargins(_:_:)-93raa)*