...
```swift
nonisolated
func dismissalConfirmationDialog<A, M>(_ titleResource: LocalizedStringResource, shouldPresent: Bool, @ViewBuilder actions: () -> A, @ViewBuilder message: () -> M) -> some View where A : View, M : View
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/permissionkit/communicationlimitsbutton/dismissalconfirmationdialog(_:shouldpresent:actions:message:)-13xme)*