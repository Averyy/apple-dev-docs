...
- [static var paymentTagReaderSessionErrorLocationAuthorizationDenied: NFCReaderError.Code](nfcreadererror-swift.struct/paymenttagreadersessionerrorlocationauthorizationdenied.md)
- [static var paymentTagReaderSessionErrorLocationServiceRestricted: NFCReaderError.Code](nfcreadererror-swift.struct/paymenttagreadersessionerrorlocationservicerestricted.md)
- [static var paymentTagReaderSessionErrorOnDeviceLocationUnavailable: NFCReaderError.Code](nfcreadererror-swift.struct/paymenttagreadersessionerrorondevicelocationunavailable.md)
