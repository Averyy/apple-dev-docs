# init(location:timeOffset:size:opacity:force:azimuth:altitude:secondaryScale:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/pencilkit/pkstrokepointreference/init(location:timeoffset:size:opacity:force:azimuth:altitude:secondaryscale:))*