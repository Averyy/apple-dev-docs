...
The [`PKStrokePointReference`](pkstrokepointreference.md) at control point index i.
...
*[View on Apple Developer](https://developer.apple.com/documentation/pencilkit/pkstrokepathreference/point(at:))*