...
```swift
@frozen
struct DropWhileSequence<Base> where Base : Sequence
```
...
### Instance Methods
- [func drop(while: (DropWhileSequence<Base>.Element) throws -> Bool) rethrows -> DropWhileSequence<Base>](dropwhilesequence/drop(while:).md)
### Type Aliases
- [DropWhileSequence.Element](dropwhilesequence/element.md)
  A type representing the sequence’s elements.
### Default Implementations
- [Sequence Implementations](dropwhilesequence/sequence-implementations.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/dropwhilesequence)*