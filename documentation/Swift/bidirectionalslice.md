...
```swift
typealias BidirectionalSlice<T> = Slice<T> where T : BidirectionalCollection
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/bidirectionalslice)*