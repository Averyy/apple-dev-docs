...
```swift
typealias ReversedIndex<T> = ReversedCollection<T>.Index where T : BidirectionalCollection
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/reversedindex)*