...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/unsafemutablebufferpointer/split(separator:maxsplits:omittingemptysubsequences:)-3dgmc)*