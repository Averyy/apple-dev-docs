...
```swift
typealias RegexOutput = Character.Output
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/character/regexoutput)*