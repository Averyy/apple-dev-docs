...
- `other`: The typed pointer to convert. If   is  , the   result is  .


---

*[View on Apple Developer](https://developer.apple.com/documentation/swift/unsafemutablerawpointer/init(_:)-5r9za)*