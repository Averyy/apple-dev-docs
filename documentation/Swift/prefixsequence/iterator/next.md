...
```swift
mutating func next() -> PrefixSequence<Base>.Iterator.Element?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/prefixsequence/iterator/next())*