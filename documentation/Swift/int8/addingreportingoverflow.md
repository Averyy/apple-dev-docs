...
```swift
func addingReportingOverflow(_ other: Int8) -> (partialValue: Int8, overflow: Bool)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/int8/addingreportingoverflow(_:))*