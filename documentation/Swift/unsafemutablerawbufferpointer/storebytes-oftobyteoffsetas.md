...
- `offset`: The offset in bytes into the buffer pointer’s memory to begin   writing bytes from the value. The default is zero.
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/unsafemutablerawbufferpointer/storebytes(of:tobyteoffset:as:))*