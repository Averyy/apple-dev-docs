...
```swift
static func decodeAtomicRepresentation(_ representation: consuming UnsafeBufferPointer<Element>.AtomicRepresentation) -> UnsafeBufferPointer<Element>
```
...
- `representation`: The storage representation for   that’s used   within atomic operations.


---

*[View on Apple Developer](https://developer.apple.com/documentation/swift/unsafebufferpointer/decodeatomicrepresentation(_:))*