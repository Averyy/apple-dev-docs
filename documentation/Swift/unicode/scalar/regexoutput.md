...
```swift
typealias RegexOutput = Unicode.Scalar.Output
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/unicode/scalar/regexoutput)*