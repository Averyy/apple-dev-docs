...
- [var indices: Range<Self.Index>](unicode/scalar/utf16view/indices-swift.property.md)
  The indices that are valid for subscripting the collection, in ascending order.
- [var startIndex: Int](unicode/scalar/utf16view/startindex.md)
  The position of the first code unit.
### Instance Methods
- [func distance(from: Self.Index, to: Self.Index) -> Self.Index.Stride](unicode/scalar/utf16view/distance(from:to:).md)
  Returns the distance between two indices.
- [func index(Self.Index, offsetBy: Self.Index.Stride) -> Self.Index](unicode/scalar/utf16view/index(_:offsetby:).md)
...
- [func index(after: Self.Index) -> Self.Index](unicode/scalar/utf16view/index(after:).md)
  Returns the position immediately after the given index.
- [func index(before: Self.Index) -> Self.Index](unicode/scalar/utf16view/index(before:).md)
  Returns the position immediately after the given index.
### Subscripts
