...
- [func filter<E>((Self.Element) throws(E) -> Bool) throws(E) -> [Self.Element]](array/filter(_:)-2juem.md)
  Returns an array containing, in order, the elements of the sequence that satisfy the given predicate.
- [func filter<E>((Self.Element) throws(E) -> Bool) throws(E) -> [Self.Element]](array/filter(_:)-7pg6k.md)
  Returns an array containing, in order, the elements of the sequence that satisfy the given predicate.
