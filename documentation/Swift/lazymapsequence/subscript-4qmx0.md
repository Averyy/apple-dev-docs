...
```swift
subscript(bounds: Range<Base.Index>) -> LazyMapSequence<Base, Element>.SubSequence { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/lazymapsequence/subscript(_:)-4qmx0)*