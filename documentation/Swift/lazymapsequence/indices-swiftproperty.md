...
```swift
var indices: LazyMapSequence<Base, Element>.Indices { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/lazymapsequence/indices-swift.property)*