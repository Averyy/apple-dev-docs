...
```swift
func enqueue<C>(_ job: consuming ExecutorJob, at instant: C.Instant, tolerance: C.Duration? = nil, clock: C) where C : Clock
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/dispatchglobaltaskexecutor/enqueue(_:at:tolerance:clock:)-8m6th)*