...
```swift
@discardableResult
func async<T>(priority: TaskPriority? = nil, operation: @escaping () async -> T) -> Task<T, Never> where T : Sendable
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/async(priority:operation:)-6nw1p)*