...
The method preserves fractional parts in currency strings. To match currency strings without fractional parts, you may use [`localizedIntegerCurrency(code:locale:)`](regexcomponent/localizedintegercurrency(code:locale:).md) to capture integer values.
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/regexcomponent/localizedcurrency(code:locale:))*