...
```swift
@discardableResult
func asyncDetached<T>(priority: TaskPriority? = nil, operation: @escaping () async throws -> T) -> Task<T, any Error> where T : Sendable
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/asyncdetached(priority:operation:)-493is)*