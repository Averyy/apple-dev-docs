...
```swift
nonisolated
(nonsending) mutating func nextResult() async -> Result<ChildTaskResult, Failure>?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/throwingtaskgroup/nextresult())*