...
```swift
func startTaskSynchronously(name: String? = nil, priority: TaskPriority? = nil, operation: sending @escaping () async throws -> ChildTaskResult)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/throwingtaskgroup/starttasksynchronously(name:priority:operation:))*