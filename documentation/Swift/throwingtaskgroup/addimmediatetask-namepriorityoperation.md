# addImmediateTask(name:priority:operation:)
...
```swift
func addImmediateTask(name: String? = nil, priority: TaskPriority? = nil, operation: sending @escaping @isolated(any) () async throws -> ChildTaskResult)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/throwingtaskgroup/addimmediatetask(name:priority:operation:))*