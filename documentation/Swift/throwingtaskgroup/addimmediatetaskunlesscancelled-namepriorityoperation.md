# addImmediateTaskUnlessCancelled(name:priority:operation:)
...
```swift
func addImmediateTaskUnlessCancelled(name: String? = nil, priority: TaskPriority? = nil, operation: sending @escaping @isolated(any) () async throws -> ChildTaskResult)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/throwingtaskgroup/addimmediatetaskunlesscancelled(name:priority:operation:))*