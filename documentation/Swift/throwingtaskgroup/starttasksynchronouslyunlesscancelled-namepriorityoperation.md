# startTaskSynchronouslyUnlessCancelled(name:priority:operation:)
...
```swift
func startTaskSynchronouslyUnlessCancelled(name: String? = nil, priority: TaskPriority? = nil, operation: sending @escaping () async throws -> ChildTaskResult)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/throwingtaskgroup/starttasksynchronouslyunlesscancelled(name:priority:operation:))*