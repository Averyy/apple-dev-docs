...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/lazyprefixwhilesequence/iterator/split(maxsplits:omittingemptysubsequences:whereseparator:))*