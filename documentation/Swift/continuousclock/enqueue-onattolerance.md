...
```swift
func enqueue(_ job: consuming ExecutorJob, on executor: some Executor, at instant: ContinuousClock.Instant, tolerance: Duration?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/continuousclock/enqueue(_:on:at:tolerance:))*