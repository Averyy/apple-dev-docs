...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/unsaferawbufferpointer/iterator/split(maxsplits:omittingemptysubsequences:whereseparator:))*