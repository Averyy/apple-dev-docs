...
- `possibleStrictSubset`: A sequence of elements.    must be finite.
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/set/isstrictsuperset(of:)-58ejg)*