...
```swift
@discardableResult
func detach<T>(priority: TaskPriority? = nil, operation: @escaping () async -> T) -> Task<T, Never> where T : Sendable
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/detach(priority:operation:)-1z4ju)*