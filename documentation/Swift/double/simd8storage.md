...
### Initializers
- [init()](double/simd8storage/init.md)
  Creates a vector with zero in all lanes.
### Instance Properties
- [var scalarCount: Int](double/simd8storage/scalarcount.md)
  The number of scalars, or elements, in the vector.
### Subscripts
- [subscript(Int) -> Double](double/simd8storage/subscript(_:).md)
  Accesses the element at the specified index.
### Type Aliases
- [Double.SIMD8Storage.Scalar](double/simd8storage/scalar.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/double/simd8storage)*