...
### Initializers
- [init()](double/simd32storage/init.md)
  Creates a vector with zero in all lanes.
### Instance Properties
- [var scalarCount: Int](double/simd32storage/scalarcount.md)
  The number of scalars, or elements, in the vector.
### Subscripts
- [subscript(Int) -> Double](double/simd32storage/subscript(_:).md)
  Accesses the element at the specified index.
### Type Aliases
- [Double.SIMD32Storage.Scalar](double/simd32storage/scalar.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/double/simd32storage)*