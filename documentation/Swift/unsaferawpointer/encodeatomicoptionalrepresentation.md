...
```swift
static func encodeAtomicOptionalRepresentation(_ value: consuming UnsafeRawPointer?) -> UnsafeRawPointer.AtomicOptionalRepresentation
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/unsaferawpointer/encodeatomicoptionalrepresentation(_:))*