...
```swift
@discardableResult
func bindMemory<T>(to type: T.Type, capacity count: Int) -> UnsafePointer<T> where T : ~Copyable
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/unsaferawpointer/bindmemory(to:capacity:))*