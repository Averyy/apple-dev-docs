...
- `other`: The mutable raw pointer to convert. If   is   , the result is  .


---

*[View on Apple Developer](https://developer.apple.com/documentation/swift/unsaferawpointer/init(_:)-4dxzd)*