...
```swift
@discardableResult
func async<T>(priority: TaskPriority? = nil, operation: @escaping () async throws -> T) -> Task<T, any Error> where T : Sendable
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/async(priority:operation:)-6ud0e)*