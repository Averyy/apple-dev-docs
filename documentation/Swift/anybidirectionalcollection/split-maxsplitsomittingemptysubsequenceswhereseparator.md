...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/anybidirectionalcollection/split(maxsplits:omittingemptysubsequences:whereseparator:))*