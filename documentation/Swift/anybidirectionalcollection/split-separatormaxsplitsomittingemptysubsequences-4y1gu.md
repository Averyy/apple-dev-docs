...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/anybidirectionalcollection/split(separator:maxsplits:omittingemptysubsequences:)-4y1gu)*