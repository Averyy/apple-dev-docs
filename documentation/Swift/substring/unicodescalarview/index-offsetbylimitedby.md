...
```swift
func index(_ i: Substring.UnicodeScalarView.Index, offsetBy n: Int, limitedBy limit: Substring.UnicodeScalarView.Index) -> Substring.UnicodeScalarView.Index?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/substring/unicodescalarview/index(_:offsetby:limitedby:))*