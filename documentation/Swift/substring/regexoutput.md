...
```swift
typealias RegexOutput = Substring.Output
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/substring/regexoutput)*