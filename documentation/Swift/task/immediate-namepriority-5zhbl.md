...
```swift
@discardableResult
static func immediate(name: String? = nil, priority: TaskPriority? = nil, _ operation: @escaping @isolated(any) () async throws -> Success) -> Task<Success, Never>
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/task/immediate(name:priority:_:)-5zhbl)*