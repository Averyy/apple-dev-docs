...
```swift
@discardableResult
static func startSynchronously(name: String? = nil, priority: TaskPriority? = nil, _ operation: sending @escaping () async throws -> Success) -> Task<Success, any Error>
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/task/startsynchronously(name:priority:_:)-6szf8)*