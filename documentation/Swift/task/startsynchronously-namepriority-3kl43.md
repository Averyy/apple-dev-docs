...
```swift
@discardableResult
static func startSynchronously(name: String? = nil, priority: TaskPriority? = nil, _ operation: sending @escaping () async throws -> Success) -> Task<Success, Never>
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/task/startsynchronously(name:priority:_:)-3kl43)*