...
```swift
func deallocate<T>(_ pointer: UnsafeMutablePointer<T>)
```


---

*[View on Apple Developer](https://developer.apple.com/documentation/swift/executorjob/localallocator/deallocate(_:)-91xo3)*