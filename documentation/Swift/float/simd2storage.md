...
### Initializers
- [init()](float/simd2storage/init.md)
  Creates a vector with zero in all lanes.
### Instance Properties
- [var scalarCount: Int](float/simd2storage/scalarcount.md)
  The number of scalars, or elements, in the vector.
### Subscripts
- [subscript(Int) -> Float](float/simd2storage/subscript(_:).md)
  Accesses the element at the specified index.
### Type Aliases
- [Float.SIMD2Storage.Scalar](float/simd2storage/scalar.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/float/simd2storage)*