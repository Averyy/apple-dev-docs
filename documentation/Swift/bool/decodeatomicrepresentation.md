...
```swift
static func decodeAtomicRepresentation(_ representation: consuming Bool.AtomicRepresentation) -> Bool
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/bool/decodeatomicrepresentation(_:))*