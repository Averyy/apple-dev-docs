...
```swift
typealias Zip2Iterator<T, U> = Zip2Sequence<T, U>.Iterator where T : Sequence, U : Sequence
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/zip2iterator)*