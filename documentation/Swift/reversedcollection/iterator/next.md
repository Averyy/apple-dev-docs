...
```swift
mutating func next() -> ReversedCollection<Base>.Iterator.Element?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/reversedcollection/iterator/next())*