...
- [func isIsolatingCurrentContext() -> Bool](dummymainexecutor/isisolatingcurrentcontext-4gc9m.md)
  Checks if the current execution context is isolated by this executor.
- [func isIsolatingCurrentContext() -> Bool?](dummymainexecutor/isisolatingcurrentcontext-50b17.md)
  Checks if the current execution context is isolated by this executor.
