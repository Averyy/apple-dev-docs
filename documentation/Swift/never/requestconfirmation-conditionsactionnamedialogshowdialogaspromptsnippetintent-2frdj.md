...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/never/requestconfirmation(conditions:actionname:dialog:showdialogasprompt:snippetintent:)-2frdj)*