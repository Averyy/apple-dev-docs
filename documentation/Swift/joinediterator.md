...
```swift
typealias JoinedIterator<T> = JoinedSequence<T>.Iterator where T : Sequence, T.Element : Sequence
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/joinediterator)*