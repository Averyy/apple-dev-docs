...
```swift
func startTaskSynchronouslyUnlessCancelled(name: String? = nil, priority: TaskPriority? = nil, operation: sending @escaping () async -> Void)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/discardingtaskgroup/starttasksynchronouslyunlesscancelled(name:priority:operation:))*