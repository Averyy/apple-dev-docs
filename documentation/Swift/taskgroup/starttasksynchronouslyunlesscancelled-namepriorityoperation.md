...
```swift
func startTaskSynchronouslyUnlessCancelled(name: String? = nil, priority: TaskPriority? = nil, operation: sending @escaping () async -> ChildTaskResult)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/taskgroup/starttasksynchronouslyunlesscancelled(name:priority:operation:))*