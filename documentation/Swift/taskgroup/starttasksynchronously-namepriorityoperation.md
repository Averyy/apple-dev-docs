...
```swift
func startTaskSynchronously(name: String? = nil, priority: TaskPriority? = nil, operation: sending @escaping () async -> ChildTaskResult)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/taskgroup/starttasksynchronously(name:priority:operation:))*