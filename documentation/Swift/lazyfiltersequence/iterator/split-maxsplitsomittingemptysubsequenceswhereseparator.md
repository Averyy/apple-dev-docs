...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/lazyfiltersequence/iterator/split(maxsplits:omittingemptysubsequences:whereseparator:))*