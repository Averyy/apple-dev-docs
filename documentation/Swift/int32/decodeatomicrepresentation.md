...
```swift
static func decodeAtomicRepresentation(_ representation: consuming Int32.AtomicRepresentation) -> Int32
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/int32/decodeatomicrepresentation(_:))*