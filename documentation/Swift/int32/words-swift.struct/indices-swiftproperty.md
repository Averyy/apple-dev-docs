...
```swift
var indices: Int32.Words.Indices { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/int32/words-swift.struct/indices-swift.property)*