...
```swift
@frozen
struct PrefixSequence<Base> where Base : Sequence
```
...
### Initializers
- [init(Base, maxLength: Int)](prefixsequence/init(_:maxlength:).md)
### Instance Methods
- [func prefix(Int) -> PrefixSequence<Base>](prefixsequence/prefix(_:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/prefixsequence)*