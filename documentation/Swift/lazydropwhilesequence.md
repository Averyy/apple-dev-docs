...
```swift
@frozen
struct LazyDropWhileSequence<Base> where Base : Sequence
```

## Topics

### Type Aliases
- [LazyDropWhileSequence.Element](lazydropwhilesequence/element.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/lazydropwhilesequence)*