...
```swift
var indices: UInt32.Words.Indices { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/uint32/words-swift.struct/indices-swift.property)*