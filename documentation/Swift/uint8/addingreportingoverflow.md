...
```swift
func addingReportingOverflow(_ other: UInt8) -> (partialValue: UInt8, overflow: Bool)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/uint8/addingreportingoverflow(_:))*