...
### Instance Methods
- [func asUnownedSerialExecutor() -> UnownedSerialExecutor](dispatchmainexecutor/asunownedserialexecutor.md)
  Convert this executor value to the optimized form of borrowed executor references.
- [func assertIsolated(@autoclosure () -> String, file: StaticString, line: UInt)](dispatchmainexecutor/assertisolated(_:file:line:).md)
  Stops program execution if the current task is not executing on this serial executor.
- [func checkIsolated()](dispatchmainexecutor/checkisolated.md)
...
- [func checkIsolated()](dispatchmainexecutor/checkisolated-79qov.md)
  Last resort “fallback” isolation check, called when the concurrency runtime is comparing executors e.g. during `assumeIsolated()` and is unable to prove serial equivalence between the expected (this object), and the current executor.
- [func isIsolatingCurrentContext() -> Bool](dispatchmainexecutor/isisolatingcurrentcontext-2sevl.md)
  Checks if the current execution context is isolated by this executor.
- [func isIsolatingCurrentContext() -> Bool?](dispatchmainexecutor/isisolatingcurrentcontext-54su5.md)
  Checks if the current execution context is isolated by this executor.
- [func isSameExclusiveExecutionContext(other: Self) -> Bool](dispatchmainexecutor/issameexclusiveexecutioncontext(other:).md)
...
- [func preconditionIsolated(@autoclosure () -> String, file: StaticString, line: UInt)](dispatchmainexecutor/preconditionisolated(_:file:line:).md)
  Stops program execution if the current task is not executing on this serial executor.


---

*[View on Apple Developer](https://developer.apple.com/documentation/swift/dispatchmainexecutor/serialexecutor-implementations)*