...
```swift
var indices: UInt.Words.Indices { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/uint/words-swift.struct/indices-swift.property)*