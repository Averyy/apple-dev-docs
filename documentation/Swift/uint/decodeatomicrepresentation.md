...
```swift
static func decodeAtomicRepresentation(_ representation: consuming UInt.AtomicRepresentation) -> UInt
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/uint/decodeatomicrepresentation(_:))*