...
```swift
func multipliedFullWidth(by other: UInt) -> (high: UInt, low: UInt.Magnitude)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/uint/multipliedfullwidth(by:))*