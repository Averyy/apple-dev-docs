...
```swift
typealias RangeReplaceableSlice<T> = Slice<T> where T : RangeReplaceableCollection
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/rangereplaceableslice)*