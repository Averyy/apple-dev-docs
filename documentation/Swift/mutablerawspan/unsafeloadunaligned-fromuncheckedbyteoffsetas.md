...
```swift
func unsafeLoadUnaligned<T>(fromUncheckedByteOffset offset: Int, as: T.Type) -> T where T : BitwiseCopyable
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/mutablerawspan/unsafeloadunaligned(fromuncheckedbyteoffset:as:))*