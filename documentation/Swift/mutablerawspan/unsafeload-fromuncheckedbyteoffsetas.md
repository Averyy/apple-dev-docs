...
```swift
func unsafeLoad<T>(fromUncheckedByteOffset offset: Int, as: T.Type) -> T
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/mutablerawspan/unsafeload(fromuncheckedbyteoffset:as:))*