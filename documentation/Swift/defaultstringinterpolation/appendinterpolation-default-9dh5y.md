...
```swift
mutating func appendInterpolation<T>(_ value: T?, default: @autoclosure () -> some StringProtocol) where T : CustomStringConvertible
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/defaultstringinterpolation/appendinterpolation(_:default:)-9dh5y)*