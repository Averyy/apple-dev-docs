...
```swift
@frozen
struct UnfoldSequence<Element, State>
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/unfoldsequence)*