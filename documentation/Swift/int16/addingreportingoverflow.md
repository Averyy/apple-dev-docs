...
```swift
func addingReportingOverflow(_ other: Int16) -> (partialValue: Int16, overflow: Bool)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/int16/addingreportingoverflow(_:))*