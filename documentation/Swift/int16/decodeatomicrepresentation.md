...
```swift
static func decodeAtomicRepresentation(_ representation: consuming Int16.AtomicRepresentation) -> Int16
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/int16/decodeatomicrepresentation(_:))*