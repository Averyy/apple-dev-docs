...
```swift
func multipliedReportingOverflow(by other: Int64) -> (partialValue: Int64, overflow: Bool)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/int64/multipliedreportingoverflow(by:))*