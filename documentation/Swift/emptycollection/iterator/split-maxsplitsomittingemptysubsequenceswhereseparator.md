...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/emptycollection/iterator/split(maxsplits:omittingemptysubsequences:whereseparator:))*