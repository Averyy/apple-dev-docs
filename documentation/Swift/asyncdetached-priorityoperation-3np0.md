...
```swift
@discardableResult
func asyncDetached<T>(priority: TaskPriority? = nil, operation: @escaping () async -> T) -> Task<T, Never> where T : Sendable
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/asyncdetached(priority:operation:)-3np0)*