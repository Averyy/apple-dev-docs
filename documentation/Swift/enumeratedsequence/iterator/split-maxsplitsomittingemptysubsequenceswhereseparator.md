...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/enumeratedsequence/iterator/split(maxsplits:omittingemptysubsequences:whereseparator:))*