...
```swift
func startTaskSynchronouslyUnlessCancelled(name: String? = nil, priority: TaskPriority? = nil, operation: sending @escaping () async throws -> Void)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/throwingdiscardingtaskgroup/starttasksynchronouslyunlesscancelled(name:priority:operation:))*