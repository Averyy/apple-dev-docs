...
```swift
func startTaskSynchronously(name: String? = nil, priority: TaskPriority? = nil, operation: sending @escaping () async throws -> Void)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/throwingdiscardingtaskgroup/starttasksynchronously(name:priority:operation:))*