...
### Type Aliases
- [AsyncPrefixWhileSequence.Failure](asyncprefixwhilesequence/failure.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/asyncprefixwhilesequence)*