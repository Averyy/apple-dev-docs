...
```swift
func enqueue(_ job: consuming ExecutorJob, on executor: some Executor, at instant: SuspendingClock.Instant, tolerance: Duration?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/suspendingclock/enqueue(_:on:at:tolerance:))*