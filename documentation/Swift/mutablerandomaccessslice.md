...
```swift
typealias MutableRandomAccessSlice<T> = Slice<T> where T : MutableCollection, T : RandomAccessCollection
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/mutablerandomaccessslice)*