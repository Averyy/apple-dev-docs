...
```swift
static func decodeAtomicRepresentation(_ representation: consuming UInt128.AtomicRepresentation) -> UInt128
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/uint128/decodeatomicrepresentation(_:))*