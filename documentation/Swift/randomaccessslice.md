...
```swift
typealias RandomAccessSlice<T> = Slice<T> where T : RandomAccessCollection
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/randomaccessslice)*