...
```swift
mutating func nextSpan(maximumCount: Int) -> Span<Iterator.Element>
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/borrowingiteratoradapter/nextspan(maximumcount:))*