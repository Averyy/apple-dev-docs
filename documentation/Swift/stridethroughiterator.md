...
```swift
@frozen
struct StrideThroughIterator<Element> where Element : Strideable
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/stridethroughiterator)*