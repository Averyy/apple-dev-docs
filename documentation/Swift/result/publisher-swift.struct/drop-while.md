...
Use [`drop(while:)`](result/publisher-swift.struct/drop(while:).md) to omit elements from an upstream publisher until the element received meets a condition you specify.
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/result/publisher-swift.struct/drop(while:))*