...
Use [`timeout(_:scheduler:options:customError:)`](result/publisher-swift.struct/timeout(_:scheduler:options:customerror:).md) to terminate a publisher if an element isn’t delivered within a timeout interval you specify.
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/result/publisher-swift.struct/timeout(_:scheduler:options:customerror:))*