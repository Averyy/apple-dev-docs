...
- `subrange`: The range in the collection in which to search for the   regex, using   to create the regex.
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/rangereplaceablecollection/replacing(subrange:maxreplacements:content:with:))*