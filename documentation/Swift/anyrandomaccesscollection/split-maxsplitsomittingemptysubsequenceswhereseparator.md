...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/anyrandomaccesscollection/split(maxsplits:omittingemptysubsequences:whereseparator:))*