...
- [ConvertibleFromGeneratedContent Implementations](float/convertiblefromgeneratedcontent-implementations.md)
- [ConvertibleToGeneratedContent Implementations](float/convertibletogeneratedcontent-implementations.md)
...
- [Generable Implementations](float/generable-implementations.md)
- [Hashable Implementations](float/hashable-implementations.md)
- [InstructionsRepresentable Implementations](float/instructionsrepresentable-implementations.md)
...
- [PromptRepresentable Implementations](float/promptrepresentable-implementations.md)
