...
### Initializers
- [init()](int/simd4storage/init.md)
  Creates a vector with zero in all lanes.
### Instance Properties
- [var scalarCount: Int](int/simd4storage/scalarcount.md)
  The number of scalars, or elements, in the vector.
### Subscripts
- [subscript(Int) -> Int](int/simd4storage/subscript(_:).md)
  Accesses the element at the specified index.
### Type Aliases
- [Int.SIMD4Storage.Scalar](int/simd4storage/scalar.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swift/int/simd4storage)*