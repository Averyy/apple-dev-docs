...
```swift
object SportingEvent.LeagueName
```

## Properties

- `leagueName` (string): The localized name of the league.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appletvfeed/sportingevent/leaguename-data.dictionary)*