...
```swift
object SportingEvent.Description
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appletvfeed/sportingevent/description-data.dictionary)*