...
Query [`supportedCombinations`](capturedroom/object/category-swift.enum/supportedcombinations.md) to check the attributes that a category supports.
...
*[View on Apple Developer](https://developer.apple.com/documentation/roomplan/capturedroom/modelprovider/setmodelfileurl(_:for:)-8xio)*