...
```swift
@MainActor
@preconcurrency override dynamic var subviews: [UIView] { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/roomplan/roomcaptureview/subviews)*