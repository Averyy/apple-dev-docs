...
```swift
@MainActor
@preconcurrency override dynamic func layoutSubviews()
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/roomplan/roomcaptureview/layoutsubviews())*