...
If you read [`isSupported`](dcappattestservice/issupported.md) from an app running on a Mac device, the value is [`false`](https://developer.apple.com/documentation/swift/false). This includes Mac Catalyst apps, and iOS or iPadOS apps running on Apple silicon.
