...
```swift
static var invalidDirectoryCookie: FSError.Code { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/fskit/fserror/invaliddirectorycookie)*