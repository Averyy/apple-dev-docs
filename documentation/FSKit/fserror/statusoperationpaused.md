...
```swift
static var statusOperationPaused: FSError.Code { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/fskit/fserror/statusoperationpaused)*