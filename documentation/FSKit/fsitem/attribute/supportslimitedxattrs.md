...
```swift
static var supportsLimitedXAttrs: FSItem.Attribute { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/fskit/fsitem/attribute/supportslimitedxattrs)*