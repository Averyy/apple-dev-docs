...
Use this type in your implementation of [`getAttributes(_:of:context:replyHandler:)`](fsvolume/handler/getattributes(_:of:context:replyhandler:).md).

## Topics

### Creating a get-attributes result
- [init?(attributes: FSItem.Attributes)](fsgetattributesresult/init(attributes:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/fskit/fsgetattributesresult)*