...
Use this type in your implementation of[`removeItem(_:named:from:context:replyHandler:)`](fsvolume/handler/removeitem(_:named:from:context:replyhandler:).md).

## Topics

### Creating a remove-item result
- [init?(itemAttributes: FSItem.Attributes, directoryAttributes: FSItem.Attributes, freeSpace: FSFreeSpace?)](fsremoveitemresult/init(itemattributes:directoryattributes:freespace:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/fskit/fsremoveitemresult)*