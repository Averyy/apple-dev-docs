...
> ❗ **Important**: This protocol replaces the [`FSVolume.OpenCloseOperations`](fsvolume/opencloseoperations.md) protocol. It exposes the same functionality, while adding the [`FSContext`](fscontext.md) parameters.
...
- [var isOpenCloseInhibited: Bool](fsvolume/openclosehandler/isopencloseinhibited.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/fskit/fsvolume/openclosehandler)*