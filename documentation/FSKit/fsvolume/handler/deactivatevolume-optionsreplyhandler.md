# deactivateVolume(options:replyHandler:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/fskit/fsvolume/handler/deactivatevolume(options:replyhandler:))*