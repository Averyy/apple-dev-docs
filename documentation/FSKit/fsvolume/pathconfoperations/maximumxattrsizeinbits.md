...
Implement at least one of [`maximumXattrSize`](fsvolume/pathconfoperations/maximumxattrsize.md) or `maximumXattrSizeInBits`. FSKit automatically converts from one to another if needed. If you implement both, FSKit uses only the `maximumXattrSizeInBits` implementation.
...
*[View on Apple Developer](https://developer.apple.com/documentation/fskit/fsvolume/pathconfoperations/maximumxattrsizeinbits)*