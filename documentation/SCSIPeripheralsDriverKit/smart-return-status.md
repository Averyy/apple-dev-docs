...
Use this method in your dext to prefill a 16-byte CDB for the standard SMART SCSI Command to return status.
...
*[View on Apple Developer](https://developer.apple.com/documentation/scsiperipheralsdriverkit/smart_return_status)*