...
Call this method when the dext finishes using its window of exclusivity from a previous [`UserSuspendServices`](iouserscsiperipheraldevicetype00/usersuspendservices.md) call so file systems can continue communicating with the drive.
...
*[View on Apple Developer](https://developer.apple.com/documentation/scsiperipheralsdriverkit/iouserscsiperipheraldevicetype00/userresumeservices)*