...
> ❗ **Important**:  Matchmaking rules are only available for peer-to-peer ([`GKMatchType.peerToPeer`](gkmatchtype/peertopeer.md)) and hosted ([`GKMatchType.hosted`](gkmatchtype/hosted.md)) match requests.
