...
The possible values range from the minimum number of players to the value returned by the [`maxPlayersAllowedForMatch(of:)`](gkmatchrequest/maxplayersallowedformatch(of:).md) method. To set the minimum number of players, use the [`minPlayers`](gkmatchrequest/minplayers.md) property.
...
*[View on Apple Developer](https://developer.apple.com/documentation/gamekit/gkmatchrequest/maxplayers)*