...
When you initialize a new score object, the [`player`](gkscore/player.md) property is the local player. If the score object was returned to your game by loading scores from Game Center, the [`player`](gkscore/player.md) property is the player who earned that score.
...
*[View on Apple Developer](https://developer.apple.com/documentation/gamekit/gkscore/player)*