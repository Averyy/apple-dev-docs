...
When you initialize a new score object, the [`playerID`](gkscore/playerid.md) property is set to the identifier for the local player. If the score object was returned to your game by loading scores from Game Center, the [`playerID`](gkscore/playerid.md) property identifies the player who recorded that score.
...
*[View on Apple Developer](https://developer.apple.com/documentation/gamekit/gkscore/playerid)*