...
- `completionHandler`: A block that is called after all the game sessions have been loaded. - **sessions**: An array of `GKGameSession` objects that contains all of the game sessions associated with the specified container.
