...
- `completionHandler`: The block that GameKit calls when it completes the request. This block receives the following parameters: - **`players`**: The players that join the match. If unsuccessful, this parameter is `nil`.
