...
- `completionHandler`: The block that GameKit calls when it completes the request. This block receives the following parameters: - **`match`**: The match that the players join. If unsuccessful, this parameter is `nil`.
