...
### Constants
- [GKPeerPickerConnectionType.nearby](gkpeerpickerconnectiontype/nearby.md)
  A Bluetooth connection to a device.
- [GKPeerPickerConnectionType.online](gkpeerpickerconnectiontype/online.md)
  An Internet-based connection.
- [GKPeerPickerConnectionType.nearby](gkpeerpickerconnectiontype/nearby.md)
  A Bluetooth connection to a device.
### Initializers
- [init?(rawValue: UInt)](gkpeerpickerconnectiontype/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/gamekit/gkpeerpickerconnectiontype)*