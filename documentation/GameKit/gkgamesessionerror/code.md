...
### Initializers
- [init?(rawValue: Int)](gkgamesessionerror/code/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/gamekit/gkgamesessionerror/code)*