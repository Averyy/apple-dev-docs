...
This property is similar to the [`GKMatchRequest`](gkmatchrequest.md).[`recipientProperties`](gkmatchrequest/recipientproperties.md) property but with some additions that Game Center may add. For example, if you add team rules to your rule set, use the `gc` and `team` keys to get the name of the player’s team, similar to [`properties`](gkmatchedplayers/properties.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/gamekit/gkmatchedplayers/playerproperties)*