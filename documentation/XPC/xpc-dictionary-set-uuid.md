...
- `uuid`: The `uuid_t` value to insert. After calling this method, the XPC object corresponding to the primitive value inserted may be safely retrieved with [`xpc_dictionary_get_value(_:_:)`](xpc_dictionary_get_value(_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/xpc/xpc_dictionary_set_uuid(_:_:_:))*