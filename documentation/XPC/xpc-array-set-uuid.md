...
- `uuid`: The UUID primitive to insert. After calling this method, the XPC object corresponding to the primitive value inserted may be safely retrieved with [`xpc_array_get_value(_:_:)`](xpc_array_get_value(_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/xpc/xpc_array_set_uuid(_:_:_:))*