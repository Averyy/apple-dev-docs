...
If the dictionary was received by a connection event handler or a dictionary created through [`xpc_dictionary_create_reply(_:)`](xpc_dictionary_create_reply(_:).md), a connection object over which a reply message can be sent is returned. For any other dictionary, NULL is returned.
...
*[View on Apple Developer](https://developer.apple.com/documentation/xpc/xpc_dictionary_get_remote_connection(_:))*