...
The number of values stored in the dictionary. Calling [`xpc_dictionary_set_value(_:_:_:)`](xpc_dictionary_set_value(_:_:_:).md) with a non-`NULL` value will increment the count. Calling [`xpc_dictionary_set_value(_:_:_:)`](xpc_dictionary_set_value(_:_:_:).md) with a `NULL` value will decrement the count.
...
*[View on Apple Developer](https://developer.apple.com/documentation/xpc/xpc_dictionary_get_count(_:))*