...
- `connection`: The connection to insert. After calling this method, the XPC object corresponding to the primitive value inserted may be safely retrieved with  . The connection is NOT retained by the array.
