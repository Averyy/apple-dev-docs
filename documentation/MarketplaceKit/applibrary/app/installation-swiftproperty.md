...
```swift
@MainActor
final var installation: AppLibrary.App.Installation? { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/marketplacekit/applibrary/app/installation-swift.property)*