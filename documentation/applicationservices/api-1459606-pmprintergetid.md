...
You can use the function `PMPrinterGetID` to capture information about a printer for later use. To create a printer object from a printer ID returned by this function, use the function [`PMPrinterCreateFromPrinterID(_:)`](1461363-pmprintercreatefromprinterid.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/applicationservices/1459606-pmprintergetid)*