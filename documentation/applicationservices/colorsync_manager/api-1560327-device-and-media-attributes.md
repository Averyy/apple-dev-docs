...
### Constants
- [var cmReflective: Int](cmreflective.md)
  If the bit 0 of the associated mask is `0` then reflective media; if `1` then transparency media.
- [var cmGlossy: Int](cmglossy.md)
  If the bit 1 of the associated mask is `0` then glossy; if `1` then matte.


---

*[View on Apple Developer](https://developer.apple.com/documentation/applicationservices/colorsync_manager/1560327-device_and_media_attributes)*