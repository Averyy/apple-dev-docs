...
In most cases, you do not need to call this function as ColorSync Manager invokes your callback for you. See the [`CMBitmapCallBackProcPtr`](cmbitmapcallbackprocptr.md) callback for more information and for a description of the parameters.
...
*[View on Apple Developer](https://developer.apple.com/documentation/applicationservices/colorsync_manager/1805303-invokecmbitmapcallbackupp)*