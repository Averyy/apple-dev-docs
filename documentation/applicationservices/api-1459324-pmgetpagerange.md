...
The page range returned by the function `PMGetPageRange` is independent of the first and last page values returned by [`PMGetFirstPage(_:_:)`](1460271-pmgetfirstpage.md) and [`PMGetLastPage(_:_:)`](1462747-pmgetlastpage.md). See `PMSetPageRange` for more information.
...
*[View on Apple Developer](https://developer.apple.com/documentation/applicationservices/1459324-pmgetpagerange)*