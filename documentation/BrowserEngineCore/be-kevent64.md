...
> ❗ **Important**: To use 32-bit data types, call `be_kevent`.
...
- `flags`: Configuration flags that control how   waits for kernel events.
...
*[View on Apple Developer](https://developer.apple.com/documentation/browserenginecore/be_kevent64(_:_:_:_:_:_:))*