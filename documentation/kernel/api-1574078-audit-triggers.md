...
```swift
kern_return_t audit_triggers(mach_port_t audit_port, int flags);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1574078-audit_triggers)*