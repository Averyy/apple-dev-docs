...
```swift
static OSPtr<IOBufferMemoryDescriptor> inTaskWithOptions(task_t inTask, IOOptionBits options, vm_size_t capacity, vm_offset_t alignment, uint32_t kernTag, uint32_t userTag);
```
...
- `kernTag`: The kernel memory tag.
- `userTag`: The user memory tag.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/iobuffermemorydescriptor/3516446-intaskwithoptions)*