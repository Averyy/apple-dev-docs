...
- `dvp`: Directory in which lookup is occurring.
- `vpp`: Destination for vnode pointer.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1562195-cache_lookup)*