...
```swift
enum task_latency_qos : unsigned int {
    ...
};
```
...
### Constants
- [LATENCY_QOS_TIER_0](task_latency_qos/latency_qos_tier_0.md)
- [LATENCY_QOS_TIER_1](task_latency_qos/latency_qos_tier_1.md)
- [LATENCY_QOS_TIER_2](task_latency_qos/latency_qos_tier_2.md)
- [LATENCY_QOS_TIER_3](task_latency_qos/latency_qos_tier_3.md)
- [LATENCY_QOS_TIER_4](task_latency_qos/latency_qos_tier_4.md)
- [LATENCY_QOS_TIER_5](task_latency_qos/latency_qos_tier_5.md)
- [LATENCY_QOS_TIER_UNSPECIFIED](task_latency_qos/latency_qos_tier_unspecified.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/task_latency_qos)*