...
- `aperture`: The system will only access the aperture kIOFBSystemAperture.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioframebuffer/1813036-getaperturerange)*