...
- `allDisplayModes`: A caller allocated buffer with the size given by the result of getDisplayModeCount().
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioframebuffer/1813237-getdisplaymodes)*