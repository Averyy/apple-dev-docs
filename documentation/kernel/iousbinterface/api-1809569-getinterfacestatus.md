...
- `status`: Pointer to a USBStatus type which will contain the results of the operation.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/iousbinterface/1809569-getinterfacestatus)*