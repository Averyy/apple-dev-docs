...
- `forClient`: The client requesting the alternate setting. This client must have the interface open in order to perform the request.
- `alternateSetting`: Alternate setting (from the alternate interface's interface descriptor).
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/iousbinterface/1809615-setalternateinterface)*