...
- `withRetain`: Pass true to retain and the client should release it later after its use.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/iousbinterface/1809527-findnextpipe)*