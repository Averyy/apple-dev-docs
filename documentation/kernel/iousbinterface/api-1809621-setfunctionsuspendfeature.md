...
- `options`: The suspend options passed to the Device Request.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/iousbinterface/1809621-setfunctionsuspendfeature)*