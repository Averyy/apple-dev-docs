...
```swift
typedef EFI_STATUS (*EFI_SET_WAKEUP_TIME)(EFI_BOOLEAN Enable, EFI_TIME *Time);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/efi_set_wakeup_time)*