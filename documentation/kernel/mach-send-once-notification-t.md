...
```swift
typedef struct mach_send_once_notification_t {
    ...
} mach_send_once_notification_t;
```
...
### Instance Properties
- [not_header](mach_send_once_notification_t/1509350-not_header.md)
- [trailer](mach_send_once_notification_t/1509391-trailer.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/mach_send_once_notification_t)*