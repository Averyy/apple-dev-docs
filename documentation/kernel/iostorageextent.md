...
### Fields
- [byteStart](iostorageextent/1575000-bytestart.md)
  Starting byte offset for the operation.
- [byteCount](iostorageextent/1575004-bytecount.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/iostorageextent)*