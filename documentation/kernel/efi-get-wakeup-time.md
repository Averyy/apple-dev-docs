...
```swift
typedef EFI_STATUS (*EFI_GET_WAKEUP_TIME)(EFI_BOOLEAN *Enabled, EFI_BOOLEAN *Pending, EFI_TIME *Time);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/efi_get_wakeup_time)*