...
- `multicasts`: A pointer to a NULL terminated array of references to the multicast addresses.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1525020-ifnet_get_multicast_list)*