...
Retrieve the interface capabilities enabled on the interface.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1525016-ifnet_capabilities_enabled)*