...
### Instance Properties
- [asyncReference](ioexternalmethodarguments/1400648-asyncreference.md)
- [asyncReferenceCount](ioexternalmethodarguments/1400735-asyncreferencecount.md)
- [asyncWakePort](ioexternalmethodarguments/1400708-asyncwakeport.md)
- [scalarInput](ioexternalmethodarguments/1400564-scalarinput.md)
- [scalarInputCount](ioexternalmethodarguments/1400691-scalarinputcount.md)
- [scalarOutput](ioexternalmethodarguments/1400595-scalaroutput.md)
- [scalarOutputCount](ioexternalmethodarguments/1400746-scalaroutputcount.md)
- [selector](ioexternalmethodarguments/1400652-selector.md)
- [structureInput](ioexternalmethodarguments/1400597-structureinput.md)
- [structureInputDescriptor](ioexternalmethodarguments/1400661-structureinputdescriptor.md)
- [structureInputSize](ioexternalmethodarguments/1400615-structureinputsize.md)
- [structureOutput](ioexternalmethodarguments/1400671-structureoutput.md)
- [structureOutputDescriptor](ioexternalmethodarguments/1400675-structureoutputdescriptor.md)
- [structureOutputDescriptorSize](ioexternalmethodarguments/1400613-structureoutputdescriptorsize.md)
- [structureOutputSize](ioexternalmethodarguments/1400722-structureoutputsize.md)
- [structureVariableOutputData](ioexternalmethodarguments/1400720-structurevariableoutputdata.md)
- [version](ioexternalmethodarguments/1400568-version.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioexternalmethodarguments)*