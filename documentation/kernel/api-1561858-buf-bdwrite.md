...
- `bp`: The buffer to mark for delayed write.
- `return_error`: If the number of pending delayed writes systemwide is larger than an internal limit, return EAGAIN rather than doing an asynchronous write.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1561858-buf_bdwrite)*