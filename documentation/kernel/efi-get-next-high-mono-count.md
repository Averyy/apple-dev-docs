...
```swift
typedef EFI_STATUS (*EFI_GET_NEXT_HIGH_MONO_COUNT)(EFI_UINT32 *HighCount);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/efi_get_next_high_mono_count)*