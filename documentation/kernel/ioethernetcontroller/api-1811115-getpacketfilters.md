...
- `group`: The name of the filter group.
- `filters`: Pointer to the mask of supported filters returned by this method.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioethernetcontroller/1811115-getpacketfilters)*