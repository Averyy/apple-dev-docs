...
- `filters`: Pointer to the return value containing a mask of supported filters.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioethernetcontroller/1811127-getpacketfilters)*