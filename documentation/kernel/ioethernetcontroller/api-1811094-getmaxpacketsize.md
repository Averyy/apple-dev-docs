...
- `maxSize`: Pointer to the return value.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioethernetcontroller/1811094-getmaxpacketsize)*