...
- `addr`: The buffer where the controller's hardware address should be written.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioethernetcontroller/1811082-gethardwareaddress)*