...
- `active`: True to enable support for system wake on reception of a Magic Packet, false to disable it.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioethernetcontroller/1811434-setwakeonmagicpacket)*