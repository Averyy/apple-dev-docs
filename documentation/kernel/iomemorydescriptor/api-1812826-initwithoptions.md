...
Note this function can be used to re-init a previously created memory descriptor. For a more complete description see [`withOptions`](iomemorydescriptor/1441825-withoptions.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/iomemorydescriptor/1812826-initwithoptions)*