...
- `multicasts`: An array of references to the multicast addresses.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1524898-ifnet_free_multicast_list)*