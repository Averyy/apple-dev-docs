...
- `interface`: The interface to decrement the reference count of and possibly free.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1525052-ifnet_release)*