...
- `parallelRequest`: is a reference to the SCSIParallelTaskIdentifier to be executed.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioscsiparallelinterfacecontroller/1809933-executeparalleltask)*