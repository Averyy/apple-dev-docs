...
- `realizedTransferCountInBytes`: is the number of bytes to add to the realized data count for the task.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioscsiparallelinterfacecontroller/1810290-incrementrealizeddatatransfercou)*