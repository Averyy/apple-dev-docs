...
```swift
void FreeSCSIParallelTask (
 SCSIParallelTaskIdentifierreturnTask );
```
...
- `returnTask`: is a reference to the SCSIParallelTaskIdentifier to be returned.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioscsiparallelinterfacecontroller/1809961-freescsiparalleltask)*