...
```swift
void kdbg_set_timestamp_and_cpu(kd_buf *kp, uint64_t thetime, int cpu);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/3197817-kdbg_set_timestamp_and_cpu)*