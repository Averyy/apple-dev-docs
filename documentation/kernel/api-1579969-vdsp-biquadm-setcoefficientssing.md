...
- `__coeffs`: An input array of single-precision coefficients.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1579969-vdsp_biquadm_setcoefficientssing)*