...
- `anObject`: The object to scan for.
- `index`: The index at which to begin the scan.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/osarray/1808202-getnextindexofobject)*