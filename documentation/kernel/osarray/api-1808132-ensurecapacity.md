...
- `newCapacity`: The total number of objects the array should be able to store.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/osarray/1808132-ensurecapacity)*