...
### Instance Properties
- [cmd](routines_command_64/1525821-cmd.md)
...
- [reserved2](routines_command_64/1525923-reserved2.md)
...
- [reserved5](routines_command_64/1525514-reserved5.md)
  Reserved for future use. Set this field to `0`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/routines_command_64)*