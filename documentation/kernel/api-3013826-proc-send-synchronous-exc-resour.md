...
```swift
boolean_t proc_send_synchronous_EXC_RESOURCE(proc_t p);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/3013826-proc_send_synchronous_exc_resour)*