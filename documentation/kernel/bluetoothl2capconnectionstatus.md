...
```swift
typedef enum BluetoothL2CAPConnectionStatus BluetoothL2CAPConnectionStatus;
```

## Topics

### Constants
- [kBluetoothL2CAPConnectionStatusAuthenticationPending](bluetoothl2capconnectionstatus/kbluetoothl2capconnectionstatusauthenticationpending.md)
- [kBluetoothL2CAPConnectionStatusAuthorizationPending](bluetoothl2capconnectionstatus/kbluetoothl2capconnectionstatusauthorizationpending.md)
- [kBluetoothL2CAPConnectionStatusNoInfoAvailable](bluetoothl2capconnectionstatus/kbluetoothl2capconnectionstatusnoinfoavailable.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/bluetoothl2capconnectionstatus)*