...
```swift
typedef void (*IOInterruptAction)(OSObject *target, void *refCon, IOService *nub, int source);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/iointerruptaction)*