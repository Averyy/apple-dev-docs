...
```swift
void clock_get_calendar_absolute_and_microtime(clock_sec_t *secs, clock_usec_t *microsecs, uint64_t *abstime);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1416697-clock_get_calendar_absolute_and_)*