...
```swift
int kpc_get_actionid(uint32_t classes, uint32_t *actionid);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1572427-kpc_get_actionid)*