...
- `dict`: A dictionary whose contents will be stored in the new instance.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/osdictionary/1808234-withdictionary)*