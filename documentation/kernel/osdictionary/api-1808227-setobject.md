...
- `aKey`: An OSSymbol identifying the object placed within the dictionary. It is automatically retained.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/osdictionary/1808227-setobject)*