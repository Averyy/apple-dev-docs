...
- `aKey`: An OSSymbol key identifying the object to be returned to the caller.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/osdictionary/1808148-getobject)*