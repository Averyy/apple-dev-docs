...
- `aKey`: An OSString key identifying the object to be returned to caller.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/osdictionary/1808139-getobject)*