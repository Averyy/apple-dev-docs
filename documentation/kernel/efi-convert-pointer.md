...
```swift
typedef EFI_STATUS (*EFI_CONVERT_POINTER)(EFI_UINTN DebugDisposition, VOID **Address);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/efi_convert_pointer)*