...
```swift
boolean_t kpc_register_pm_handler(void (*handler)(boolean_t));
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1572430-kpc_register_pm_handler)*