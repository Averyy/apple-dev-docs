...
- [dwExtPortStatus](iousb30hubportstatusext/3166559-dwextportstatus.md)
  The extended port status bits.
- [wPortChange](iousb30hubportstatusext/3166560-wportchange.md)
  The port status change bits.
- [wPortStatus](iousb30hubportstatusext/3166561-wportstatus.md)
...
- [IOUSBHubStatus](iousbhubstatus.md)
  A structure that represents the USB hub status.


---

*[View on Apple Developer](https://developer.apple.com/documentation/kernel/iousb30hubportstatusext)*