...
```swift
kern_return_t vm_region(vm_map_read_t target_task, vm_address_t *address, vm_size_t *size, vm_region_flavor_t flavor, vm_region_info_t info, mach_msg_type_number_t *infoCnt, mach_port_t *object_name);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1585377-vm_region)*