...
```swift
wait_result_t lck_rw_sleep(lck_rw_t *lck, lck_sleep_action_t lck_sleep_action, event_t event, wait_interrupt_t interruptible);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1575504-lck_rw_sleep)*