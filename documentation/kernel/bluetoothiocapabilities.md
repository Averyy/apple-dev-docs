...
```swift
enum BluetoothIOCapabilities : unsigned int {
    ...
};
```
...
### Constants
- [kBluetoothCapabilityTypeDisplayOnly](bluetoothiocapabilities/kbluetoothcapabilitytypedisplayonly.md)
- [kBluetoothCapabilityTypeDisplayYesNo](bluetoothiocapabilities/kbluetoothcapabilitytypedisplayyesno.md)
- [kBluetoothCapabilityTypeKeyboardOnly](bluetoothiocapabilities/kbluetoothcapabilitytypekeyboardonly.md)
- [kBluetoothCapabilityTypeNoInputNoOutput](bluetoothiocapabilities/kbluetoothcapabilitytypenoinputnooutput.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/bluetoothiocapabilities)*