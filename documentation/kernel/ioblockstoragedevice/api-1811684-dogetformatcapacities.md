...
- `capacitiesMaxCount`: The number of capacity values returned in "capacities," or if no buffer is given, the total number of capacity values available.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioblockstoragedevice/1811684-dogetformatcapacities)*