...
- `devvp`: Device on which to perform I/O
- `ap`: vnop_strategy_args structure (most importantly, a buffer).
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1561893-buf_strategy)*