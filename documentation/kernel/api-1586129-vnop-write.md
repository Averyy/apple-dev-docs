...
- `vp`: The vnode to write to.
- `uio`: Description of request, including file offset, amount of data to write, source address for data, and whether that destination is in kernel or user space.
- `ctx`: Context against which to authenticate write request.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1586129-vnop_write)*