...
- `newCapacity`: The total number of distinct objects the set should be able to store.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/osset/1808068-ensurecapacity)*