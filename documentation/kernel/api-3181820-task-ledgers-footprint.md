...
```swift
void task_ledgers_footprint(ledger_t ledger, ledger_amount_t *ledger_resident, ledger_amount_t *ledger_compressed);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/3181820-task_ledgers_footprint)*