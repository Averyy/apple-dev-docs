...
```swift
typedef void (*IODTNVLocationFunc)(IORegistryEntry *entry, UInt8 *busNum, UInt8 *deviceNum, UInt8 *functionNum);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/iodtnvlocationfunc)*