...
- `bp`: Complete specificiation of requested I/O: region of data involved, whether request is for read or write, and so on.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1586257-vnop_strategy)*