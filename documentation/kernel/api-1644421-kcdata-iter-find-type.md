...
```swift
kcdata_iter_t kcdata_iter_find_type(kcdata_iter_t iter, uint32_t type);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1644421-kcdata_iter_find_type)*