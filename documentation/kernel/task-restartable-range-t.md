...
```swift
typedef struct task_restartable_range_t {
    ...
} task_restartable_range_t;
```
...
### Instance Properties
- [flags](task_restartable_range_t/3143264-flags.md)
- [length](task_restartable_range_t/3143265-length.md)
- [location](task_restartable_range_t/3143266-location.md)
- [recovery_offs](task_restartable_range_t/3143267-recovery_offs.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/task_restartable_range_t)*