...
```swift
errno_t ifnet_llbroadcast_copy_bytes(ifnet_t interface, void *addr, size_t bufferlen, size_t *out_len);
```
...
- `addr`: A buffer to copy the broadcast address in to.
- `bufferlen`: The length of the buffer at addr.
- `addr_len`: On return, the length of the broadcast address.
- `lladdr_len`: The length, in bytes, of the link layer address.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1525030-ifnet_llbroadcast_copy_bytes)*