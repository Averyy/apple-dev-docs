...
```swift
queue_entry_t circle_queue_next(circle_queue_t cq, queue_entry_t elt);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/3181807-circle_queue_next)*