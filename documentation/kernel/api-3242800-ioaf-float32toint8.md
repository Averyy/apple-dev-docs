...
```swift
void IOAF_Float32ToInt8(const Float32 *src, SInt8 *dest, unsigned int count);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/3242800-ioaf_float32toint8)*