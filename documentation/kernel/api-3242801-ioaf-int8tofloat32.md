...
```swift
void IOAF_Int8ToFloat32(const SInt8 *src, Float32 *dest, unsigned int count);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/3242801-ioaf_int8tofloat32)*