...
- [ctx](vnop_getattr_args/1807232-ctx.md)
  Context against which to authenticate action.
### Instance Properties
- [a_context](vnop_getattr_args/1586271-a_context.md)
- [a_desc](vnop_getattr_args/1586319-a_desc.md)
- [a_vap](vnop_getattr_args/1586168-a_vap.md)
- [a_vp](vnop_getattr_args/1585987-a_vp.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/vnop_getattr_args)*