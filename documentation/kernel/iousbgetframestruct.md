...
This structure holds the frame number and a timestamp for when the frame register read occurred.

## Topics

### Getting the Properties
- [frame](iousbgetframestruct/1546070-frame.md)
  The frame indicator.
- [timeStamp](iousbgetframestruct/1546083-timestamp.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/iousbgetframestruct)*