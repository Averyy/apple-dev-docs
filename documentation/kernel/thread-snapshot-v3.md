...
### Instance Properties
- [ths_base_priority](thread_snapshot_v3/1644357-ths_base_priority.md)
- [ths_continuation](thread_snapshot_v3/1644327-ths_continuation.md)
- [ths_dqserialnum](thread_snapshot_v3/1644298-ths_dqserialnum.md)
- [ths_eqos](thread_snapshot_v3/1644299-ths_eqos.md)
- [ths_io_tier](thread_snapshot_v3/1644345-ths_io_tier.md)
- [ths_last_made_runnable_time](thread_snapshot_v3/1644293-ths_last_made_runnable_time.md)
- [ths_last_run_time](thread_snapshot_v3/1644304-ths_last_run_time.md)
- [ths_rqos](thread_snapshot_v3/1644442-ths_rqos.md)
- [ths_rqos_override](thread_snapshot_v3/1644433-ths_rqos_override.md)
- [ths_sched_flags](thread_snapshot_v3/1644376-ths_sched_flags.md)
- [ths_sched_priority](thread_snapshot_v3/1644436-ths_sched_priority.md)
- [ths_ss_flags](thread_snapshot_v3/1644402-ths_ss_flags.md)
- [ths_state](thread_snapshot_v3/1644458-ths_state.md)
- [ths_sys_time](thread_snapshot_v3/1644428-ths_sys_time.md)
- [ths_thread_id](thread_snapshot_v3/1644286-ths_thread_id.md)
- [ths_thread_t](thread_snapshot_v3/1644269-ths_thread_t.md)
- [ths_total_syscalls](thread_snapshot_v3/1644381-ths_total_syscalls.md)
- [ths_user_time](thread_snapshot_v3/1644461-ths_user_time.md)
- [ths_voucher_identifier](thread_snapshot_v3/1644320-ths_voucher_identifier.md)
- [ths_wait_event](thread_snapshot_v3/1644374-ths_wait_event.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/thread_snapshot_v3)*