...
```swift
kern_return_t mach_port_get_context(ipc_space_read_t task, mach_port_name_t name, mach_vm_address_t *context);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1578930-mach_port_get_context)*