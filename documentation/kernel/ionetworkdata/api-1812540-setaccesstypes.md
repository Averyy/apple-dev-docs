...
```swift
virtual void setAccessTypes(
 UInt32types);
```

## Parameters

- `types`: A mask of access types indicating the supported access types.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ionetworkdata/1812540-setaccesstypes)*