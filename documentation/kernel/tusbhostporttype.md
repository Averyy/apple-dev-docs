...
```swift
enum tUSBHostPortType : unsigned int {
    ...
};
```
...
### Constants
- [kUSBHostPortTypeAccessory](tusbhostporttype/kusbhostporttypeaccessory.md)
  The accessory port type.
- [kUSBHostPortTypeCaptive](tusbhostporttype/kusbhostporttypecaptive.md)
  The captive port type.
- [kUSBHostPortTypeCount](tusbhostporttype/kusbhostporttypecount.md)
  The port type count.
- [kUSBHostPortTypeExpressCard](tusbhostporttype/kusbhostporttypeexpresscard.md)
  The express card port type.
- [kUSBHostPortTypeInternal](tusbhostporttype/kusbhostporttypeinternal.md)
  The internal port type.
- [kUSBHostPortTypeStandard](tusbhostporttype/kusbhostporttypestandard.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/tusbhostporttype)*