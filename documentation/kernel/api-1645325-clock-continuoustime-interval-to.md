...
```swift
void clock_continuoustime_interval_to_deadline(uint64_t abstime, uint64_t *result);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1645325-clock_continuoustime_interval_to)*