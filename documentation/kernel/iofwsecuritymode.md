...
```swift
enum IOFWSecurityMode : unsigned int {
    ...
};
```
...
### Constants
- [kIOFWSecurityModeNormal](iofwsecuritymode/kiofwsecuritymodenormal.md)
- [kIOFWSecurityModeSecure](iofwsecuritymode/kiofwsecuritymodesecure.md)
- [kIOFWSecurityModeSecurePermanent](iofwsecuritymode/kiofwsecuritymodesecurepermanent.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/iofwsecuritymode)*