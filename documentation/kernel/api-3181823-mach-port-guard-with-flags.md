...
```swift
kern_return_t mach_port_guard_with_flags(ipc_space_t task, mach_port_name_t name, uint64_t guard, uint64_t flags);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/3181823-mach_port_guard_with_flags)*