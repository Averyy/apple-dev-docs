...
```swift
typedef struct IOFWDuplicateGUIDStruct {
    ...
} IOFWDuplicateGUIDRec;
```
...
### Instance Properties
- [fGUID](iofwduplicateguidrec/1457227-fguid.md)
- [fLastGenSeen](iofwduplicateguidrec/1456893-flastgenseen.md)
- [fNextGUID](iofwduplicateguidrec/1457116-fnextguid.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/iofwduplicateguidrec)*