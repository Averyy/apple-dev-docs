...
```swift
int kcdata_iter_is_legacy_item(kcdata_iter_t iter, uint32_t legacy_size);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1644404-kcdata_iter_is_legacy_item)*