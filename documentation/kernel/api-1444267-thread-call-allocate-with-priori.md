...
- `param0`: First argument to pass to callback.
- `pri`: Priority of item.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1444267-thread_call_allocate_with_priori)*