...
```swift
typedef struct cpuid_mwait_leaf_t {
    ...
} cpuid_mwait_leaf_t;
```
...
### Instance Properties
- [extensions](cpuid_mwait_leaf_t/1580635-extensions.md)
- [linesize_max](cpuid_mwait_leaf_t/1580495-linesize_max.md)
- [linesize_min](cpuid_mwait_leaf_t/1580600-linesize_min.md)
- [sub_Cstates](cpuid_mwait_leaf_t/1580528-sub_cstates.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/cpuid_mwait_leaf_t)*