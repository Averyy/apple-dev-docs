...
```swift
typedef enum IOFWAVCAsyncCommandState IOFWAVCAsyncCommandState;
```

## Topics

### Constants
- [kAVCAsyncCommandStateBusReset](iofwavcasynccommandstate/kavcasynccommandstatebusreset.md)
- [kAVCAsyncCommandStateCanceled](iofwavcasynccommandstate/kavcasynccommandstatecanceled.md)
- [kAVCAsyncCommandStateOutOfMemory](iofwavcasynccommandstate/kavcasynccommandstateoutofmemory.md)
- [kAVCAsyncCommandStatePendingRequest](iofwavcasynccommandstate/kavcasynccommandstatependingrequest.md)
- [kAVCAsyncCommandStateReceivedFinalResponse](iofwavcasynccommandstate/kavcasynccommandstatereceivedfinalresponse.md)
- [kAVCAsyncCommandStateReceivedInterimResponse](iofwavcasynccommandstate/kavcasynccommandstatereceivedinterimresponse.md)
- [kAVCAsyncCommandStateRequestFailed](iofwavcasynccommandstate/kavcasynccommandstaterequestfailed.md)
- [kAVCAsyncCommandStateRequestSent](iofwavcasynccommandstate/kavcasynccommandstaterequestsent.md)
- [kAVCAsyncCommandStateTimeOutBeforeResponse](iofwavcasynccommandstate/kavcasynccommandstatetimeoutbeforeresponse.md)
- [kAVCAsyncCommandStateWaitingForResponse](iofwavcasynccommandstate/kavcasynccommandstatewaitingforresponse.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/iofwavcasynccommandstate)*