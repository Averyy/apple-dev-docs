...
```swift
typedef struct cpuid_xsave_leaf_t {
    ...
} cpuid_xsave_leaf_t;
```
...
### Instance Properties
- [extended_state](cpuid_xsave_leaf_t/1580631-extended_state.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/cpuid_xsave_leaf_t)*