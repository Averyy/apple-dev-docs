...
```swift
wait_result_t lck_spin_sleep_grp(lck_spin_t *lck, lck_sleep_action_t lck_sleep_action, event_t event, wait_interrupt_t interruptible, lck_grp_t *grp);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/3112642-lck_spin_sleep_grp)*