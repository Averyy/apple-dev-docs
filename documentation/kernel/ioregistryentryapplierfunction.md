...
```swift
typedef void (*IORegistryEntryApplierFunction)(IORegistryEntry *entry, void *context);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioregistryentryapplierfunction)*