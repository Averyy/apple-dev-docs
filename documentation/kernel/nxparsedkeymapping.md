...
```swift
typedef struct _NXParsedKeyMapping_ NXParsedKeyMapping;
```

## Topics

### Instance Properties
- [keyBits](nxparsedkeymapping/1579245-keybits.md)
- [keyDefs](nxparsedkeymapping/1579237-keydefs.md)
- [mapping](nxparsedkeymapping/1579253-mapping.md)
- [mappingLen](nxparsedkeymapping/1579234-mappinglen.md)
- [maxMod](nxparsedkeymapping/1579209-maxmod.md)
- [modDefs](nxparsedkeymapping/1579251-moddefs.md)
- [numDefs](nxparsedkeymapping/1579259-numdefs.md)
- [numSeqs](nxparsedkeymapping/1579210-numseqs.md)
- [numSpecialKeys](nxparsedkeymapping/1579265-numspecialkeys.md)
- [seqDefs](nxparsedkeymapping/1579252-seqdefs.md)
- [shorts](nxparsedkeymapping/1579243-shorts.md)
- [specialKeys](nxparsedkeymapping/1579215-specialkeys.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/nxparsedkeymapping)*