...
- `init`: The initial values for the interface. These values can not be changed after the interface has been allocated.
- `interface`: The interface allocated upon success.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1525028-ifnet_allocate)*