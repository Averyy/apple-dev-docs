...
- `vp`: The vnode whose device id to extract--vnode must be a special file.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1562443-vnode_specrdev)*