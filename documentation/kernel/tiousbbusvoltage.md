...
```swift
enum tIOUSBBusVoltage : unsigned int {
    ...
};
```
...
### Constants
- [kIOUSBBusVoltageDefault](tiousbbusvoltage/kiousbbusvoltagedefault.md)
  The default bus voltage.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/tiousbbusvoltage)*