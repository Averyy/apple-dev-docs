...
- `domain`: The socket domain (PF_INET, etc...).
...
- `new_so`: Upon success, a reference to the new socket.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1396122-sock_socket)*