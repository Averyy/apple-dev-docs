...
- `category`: An OSSymbol corresponding to an IOMatchCategory matching property.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioservice/1809878-copyclientwithcategory)*