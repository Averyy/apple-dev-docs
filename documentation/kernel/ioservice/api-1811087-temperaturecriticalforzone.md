...
```swift
virtual IOReturn temperatureCriticalForZone(
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioservice/1811087-temperaturecriticalforzone)*