...
- `messageType`: A type defined in `IOMessage.h` or defined by the provider family.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioservice/1810334-messageclient)*