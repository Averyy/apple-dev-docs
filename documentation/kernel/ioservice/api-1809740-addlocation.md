...
- `table`: The matching properties are added to the specified dictionary, which must be non-zero.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioservice/1809740-addlocation)*