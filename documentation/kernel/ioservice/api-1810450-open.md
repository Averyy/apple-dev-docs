...
- `options`: Options for the open. The provider family may implement options for open; IOService defines only   to request the device be withdrawn from its current owner.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioservice/1810450-open)*