...
```swift
kern_return_t task_set_port_space(ipc_space_t task, int table_entries);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1578836-task_set_port_space)*