...
### Instance Properties
- [ths_base_priority](thread_snapshot_v2/1551691-ths_base_priority.md)
- [ths_continuation](thread_snapshot_v2/1551754-ths_continuation.md)
- [ths_dqserialnum](thread_snapshot_v2/1551823-ths_dqserialnum.md)
- [ths_eqos](thread_snapshot_v2/1551868-ths_eqos.md)
- [ths_io_tier](thread_snapshot_v2/1551643-ths_io_tier.md)
- [ths_last_made_runnable_time](thread_snapshot_v2/1551753-ths_last_made_runnable_time.md)
- [ths_last_run_time](thread_snapshot_v2/1551831-ths_last_run_time.md)
- [ths_rqos](thread_snapshot_v2/1551695-ths_rqos.md)
- [ths_rqos_override](thread_snapshot_v2/1551856-ths_rqos_override.md)
- [ths_sched_flags](thread_snapshot_v2/1551880-ths_sched_flags.md)
- [ths_sched_priority](thread_snapshot_v2/1551813-ths_sched_priority.md)
- [ths_ss_flags](thread_snapshot_v2/1551698-ths_ss_flags.md)
- [ths_state](thread_snapshot_v2/1551882-ths_state.md)
- [ths_sys_time](thread_snapshot_v2/1551655-ths_sys_time.md)
- [ths_thread_id](thread_snapshot_v2/1551871-ths_thread_id.md)
- [ths_total_syscalls](thread_snapshot_v2/1551819-ths_total_syscalls.md)
- [ths_user_time](thread_snapshot_v2/1551758-ths_user_time.md)
- [ths_voucher_identifier](thread_snapshot_v2/1551795-ths_voucher_identifier.md)
- [ths_wait_event](thread_snapshot_v2/1551638-ths_wait_event.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/thread_snapshot_v2)*