...
```swift
IOReturn gen64IOVMSegments(UInt64 *offset, Segment64 *segments, UInt32 *numSegments);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/iodmacommand/1547722-gen64iovmsegments)*