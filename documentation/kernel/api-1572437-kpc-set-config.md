...
```swift
int kpc_set_config(uint32_t classes, kpc_config_t *new_config);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1572437-kpc_set_config)*