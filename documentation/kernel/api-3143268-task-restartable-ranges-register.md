...
```swift
kern_return_t task_restartable_ranges_register(task_t task, task_restartable_range_array_t ranges, mach_msg_type_number_t count);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/3143268-task_restartable_ranges_register)*