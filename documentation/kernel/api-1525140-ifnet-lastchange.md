...
- `last_change`: A timeval struct to copy the last time changed in to.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1525140-ifnet_lastchange)*