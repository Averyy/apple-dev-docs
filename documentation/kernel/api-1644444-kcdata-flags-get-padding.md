...
```swift
uint32_t kcdata_flags_get_padding(uint64_t flags);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1644444-kcdata_flags_get_padding)*