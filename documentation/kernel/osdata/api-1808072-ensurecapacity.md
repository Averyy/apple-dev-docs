...
- `newCapacity`: The total number of bytes the OSData object should be able to store.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/osdata/1808072-ensurecapacity)*