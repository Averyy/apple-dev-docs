...
- `interface`: The interface the link layer address is being changed on.
- `lladdr`: A pointer to the raw link layer address (pointer to the 6 byte ethernet address for ethernet).
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1524891-ifnet_set_lladdr)*