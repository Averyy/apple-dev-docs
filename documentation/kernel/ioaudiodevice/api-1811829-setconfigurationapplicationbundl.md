...
- `bundleID`: The bundle ID of the application to be launched by the HAL for configuration of the device and its engine(s).
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioaudiodevice/1811829-setconfigurationapplicationbundl)*