...
- `provider`: This is the service provider nub that provides access to the hardware resources.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioaudiodevice/1811891-start)*