...
- `audioEngine`: The IOAudioEngine instance to be activated. It is treated as a newly allocated instance.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioaudiodevice/1811648-activateaudioengine)*