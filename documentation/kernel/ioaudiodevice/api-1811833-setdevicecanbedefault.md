...
- `defaultsFlags`: The flags to instruct CoreAudio to allow this device to be only the indicated default devices.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioaudiodevice/1811833-setdevicecanbedefault)*