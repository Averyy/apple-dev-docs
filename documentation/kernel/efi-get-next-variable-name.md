...
```swift
typedef EFI_STATUS (*EFI_GET_NEXT_VARIABLE_NAME)(EFI_UINTN *VariableNameSize, EFI_CHAR16 *VariableName, EFI_GUID *VendorGuid);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/efi_get_next_variable_name)*