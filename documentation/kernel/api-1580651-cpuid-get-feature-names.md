...
```swift
char * cpuid_get_feature_names(uint64_t, char *, unsigned int);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1580651-cpuid_get_feature_names)*