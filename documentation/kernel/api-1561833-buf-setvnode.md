...
- `bp`: Buffer whose vnode to set.
- `vp`: The vnode to attach to the buffer.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1561833-buf_setvnode)*