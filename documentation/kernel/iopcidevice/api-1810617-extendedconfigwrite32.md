...
- `offset`: A byte offset into configuration space, of which bits 0-1 are ignored.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/iopcidevice/1810617-extendedconfigwrite32)*