...
- `result`: A pointer to an IOReturn for the resulting status.
- `userClient`: The instance of SCSITaskUserClient for which to change exclusivity state.
- `state`: A bool indicating the desired state to set.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioscsiprotocolinterface/1811011-ssetuserclientexclusivitystate)*