...
- `request`: A valid SCSITaskIdentifier representing the task to transport across the wire(s).
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioscsiprotocolinterface/1810126-executecommand)*