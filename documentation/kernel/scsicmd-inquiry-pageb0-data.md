...
### Instance Properties
- [ATOMIC_ALIGNMENT](scsicmd_inquiry_pageb0_data/1778245-atomic_alignment.md)
- [ATOMIC_TRANSFER_LENGTH_GRANULARITY](scsicmd_inquiry_pageb0_data/1778234-atomic_transfer_length_granulari.md)
- [MAXIMUM_ATOMIC_BOUNDARY_SIZE](scsicmd_inquiry_pageb0_data/1778214-maximum_atomic_boundary_size.md)
- [MAXIMUM_ATOMIC_TRANSFER_LENGTH](scsicmd_inquiry_pageb0_data/1778225-maximum_atomic_transfer_length.md)
- [MAXIMUM_ATOMIC_TRANSFER_LENGTH_WITH_ATOMIC_BOUNDARY](scsicmd_inquiry_pageb0_data/1778212-maximum_atomic_transfer_length_w.md)
- [MAXIMUM_COMPARE_AND_WRITE_LENGTH](scsicmd_inquiry_pageb0_data/1778209-maximum_compare_and_write_length.md)
- [MAXIMUM_PREFETCH_LENGTH](scsicmd_inquiry_pageb0_data/1778233-maximum_prefetch_length.md)
- [MAXIMUM_TRANSFER_LENGTH](scsicmd_inquiry_pageb0_data/1778216-maximum_transfer_length.md)
- [MAXIMUM_UNMAP_BLOCK_DESCRIPTOR_COUNT](scsicmd_inquiry_pageb0_data/1778203-maximum_unmap_block_descriptor_c.md)
- [MAXIMUM_UNMAP_LBA_COUNT](scsicmd_inquiry_pageb0_data/1778227-maximum_unmap_lba_count.md)
- [MAXIMUM_WRITE_SAME_LENGTH](scsicmd_inquiry_pageb0_data/1778211-maximum_write_same_length.md)
- [OPTIMAL_TRANSFER_LENGTH](scsicmd_inquiry_pageb0_data/1778244-optimal_transfer_length.md)
- [OPTIMAL_TRANSFER_LENGTH_GRANULARITY](scsicmd_inquiry_pageb0_data/1778205-optimal_transfer_length_granular.md)
- [OPTIMAL_UNMAP_GRANULARITY](scsicmd_inquiry_pageb0_data/1778242-optimal_unmap_granularity.md)
- [PAGE_CODE](scsicmd_inquiry_pageb0_data/1778230-page_code.md)
- [PAGE_LENGTH](scsicmd_inquiry_pageb0_data/1778224-page_length.md)
- [PERIPHERAL_DEVICE_TYPE](scsicmd_inquiry_pageb0_data/1778228-peripheral_device_type.md)
- [UNMAP_GRANULARITY_ALIGNMENT](scsicmd_inquiry_pageb0_data/1778202-unmap_granularity_alignment.md)
- [WSNZ](scsicmd_inquiry_pageb0_data/1778201-wsnz.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/scsicmd_inquiry_pageb0_data)*