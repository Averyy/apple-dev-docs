...
- `debuggerP`: A handle that will return the new IOKernelDebugger object created.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ionetworkcontroller/1813919-attachdebuggerclient)*