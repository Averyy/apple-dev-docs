...
- `active`: Set to true if entering KDP and false if leaving KDP.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ionetworkcontroller/1813990-setdebuggermode)*