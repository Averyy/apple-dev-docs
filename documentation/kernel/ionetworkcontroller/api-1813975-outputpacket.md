...
- `mbuf_t`: An mbuf chain containing the output packet to be sent on the network.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ionetworkcontroller/1813975-outputpacket)*