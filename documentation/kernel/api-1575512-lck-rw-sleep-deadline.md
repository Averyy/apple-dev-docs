...
```swift
wait_result_t lck_rw_sleep_deadline(lck_rw_t *lck, lck_sleep_action_t lck_sleep_action, event_t event, wait_interrupt_t interruptible, uint64_t deadline);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1575512-lck_rw_sleep_deadline)*