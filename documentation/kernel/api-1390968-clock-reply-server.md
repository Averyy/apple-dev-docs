...
```swift
boolean_t clock_reply_server(mach_msg_header_t *InHeadP, mach_msg_header_t *OutHeadP);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1390968-clock_reply_server)*