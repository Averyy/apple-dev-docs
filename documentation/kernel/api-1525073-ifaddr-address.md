...
- `out_addr`: The sockaddr storage for the address.
- `addr_size`: The size of the storage for the address.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1525073-ifaddr_address)*