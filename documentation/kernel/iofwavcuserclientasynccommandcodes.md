...
```swift
enum IOFWAVCUserClientAsyncCommandCodes : unsigned int {
    ...
};
```
...
### Constants
- [kIOFWAVCUserClientInstallAsyncAVCCommandCallback](iofwavcuserclientasynccommandcodes/kiofwavcuserclientinstallasyncavccommandcallback.md)
- [kIOFWAVCUserClientNumAsyncCommands](iofwavcuserclientasynccommandcodes/kiofwavcuserclientnumasynccommands.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/iofwavcuserclientasynccommandcodes)*