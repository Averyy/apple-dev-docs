...
- `family_id`: Upon return, a unique interface family identifier for use with ifnet_* functions. This identifier is valid until the system is rebooted.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1524844-ifnet_interface_family_find)*