...
```swift
boolean_t fairplay_server(mach_msg_header_t *InHeadP, mach_msg_header_t *OutHeadP);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/3281841-fairplay_server)*