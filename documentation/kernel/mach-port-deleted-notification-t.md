...
```swift
typedef struct mach_port_deleted_notification_t {
    ...
} mach_port_deleted_notification_t;
```
...
### Instance Properties
- [NDR](mach_port_deleted_notification_t/1509385-ndr.md)
- [not_header](mach_port_deleted_notification_t/1509389-not_header.md)
- [not_port](mach_port_deleted_notification_t/1509392-not_port.md)
- [trailer](mach_port_deleted_notification_t/1509357-trailer.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/mach_port_deleted_notification_t)*