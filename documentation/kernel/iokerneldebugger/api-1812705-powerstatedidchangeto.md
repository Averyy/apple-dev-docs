...
- `flags`: Description of the capability of the controller in the new power state.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/iokerneldebugger/1812705-powerstatedidchangeto)*