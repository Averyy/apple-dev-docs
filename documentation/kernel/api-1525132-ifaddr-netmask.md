...
- `out_netmask`: The sockaddr storage for the netmask.
- `netmask_size`: The size of the storage for the netmask.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1525132-ifaddr_netmask)*