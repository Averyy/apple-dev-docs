...
### Instance Properties
- [tds_base_priority](thread_delta_snapshot_v2/1644393-tds_base_priority.md)
- [tds_eqos](thread_delta_snapshot_v2/1644278-tds_eqos.md)
- [tds_io_tier](thread_delta_snapshot_v2/1644386-tds_io_tier.md)
- [tds_last_made_runnable_time](thread_delta_snapshot_v2/1644457-tds_last_made_runnable_time.md)
- [tds_rqos](thread_delta_snapshot_v2/1644326-tds_rqos.md)
- [tds_rqos_override](thread_delta_snapshot_v2/1644324-tds_rqos_override.md)
- [tds_sched_flags](thread_delta_snapshot_v2/1644297-tds_sched_flags.md)
- [tds_sched_priority](thread_delta_snapshot_v2/1644422-tds_sched_priority.md)
- [tds_ss_flags](thread_delta_snapshot_v2/1644362-tds_ss_flags.md)
- [tds_state](thread_delta_snapshot_v2/1644315-tds_state.md)
- [tds_thread_id](thread_delta_snapshot_v2/1644434-tds_thread_id.md)
- [tds_voucher_identifier](thread_delta_snapshot_v2/1644346-tds_voucher_identifier.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/thread_delta_snapshot_v2)*