...
```swift
typedef struct EFI_RUNTIME_SERVICES_64 {
    ...
} EFI_RUNTIME_SERVICES_64;
```
...
### Instance Properties
- [ConvertPointer](efi_runtime_services_64/1417504-convertpointer.md)
- [GetNextHighMonotonicCount](efi_runtime_services_64/1417453-getnexthighmonotoniccount.md)
- [GetNextVariableName](efi_runtime_services_64/1417382-getnextvariablename.md)
- [GetTime](efi_runtime_services_64/1417452-gettime.md)
- [GetVariable](efi_runtime_services_64/1417527-getvariable.md)
- [GetWakeupTime](efi_runtime_services_64/1417356-getwakeuptime.md)
- [Hdr](efi_runtime_services_64/1417362-hdr.md)
- [ResetSystem](efi_runtime_services_64/1417330-resetsystem.md)
- [SetTime](efi_runtime_services_64/1417479-settime.md)
- [SetVariable](efi_runtime_services_64/1417171-setvariable.md)
- [SetVirtualAddressMap](efi_runtime_services_64/1417261-setvirtualaddressmap.md)
- [SetWakeupTime](efi_runtime_services_64/1417177-setwakeuptime.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/efi_runtime_services_64)*