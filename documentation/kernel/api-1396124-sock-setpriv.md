...
- `so`: The socket on which to modify the SS_PRIV flag.
- `on`: Indicate whether or not the SS_PRIV flag should be set.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1396124-sock_setpriv)*