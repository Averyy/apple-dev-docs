...
### Fields
- [vp](vnop_getxattr_args/1807243-vp.md)
  The vnode for which to page out data.
- [pl](vnop_getxattr_args/1807247-pl.md)
...
- [pl_offset](vnop_getxattr_args/1807250-pl_offset.md)
...
- [f_offset](vnop_getxattr_args/1807253-f_offset.md)
...
- [size](vnop_getxattr_args/1807254-size.md)
...
- [flags](vnop_getxattr_args/1807257-flags.md)
...
- [ctx](vnop_getxattr_args/1807260-ctx.md)
  Context to authenticate for pageout request.
### Instance Properties
- [a_context](vnop_getxattr_args/1586182-a_context.md)
- [a_desc](vnop_getxattr_args/1586231-a_desc.md)
- [a_name](vnop_getxattr_args/1586177-a_name.md)
- [a_options](vnop_getxattr_args/1586045-a_options.md)
- [a_size](vnop_getxattr_args/1586036-a_size.md)
- [a_uio](vnop_getxattr_args/1585986-a_uio.md)
- [a_vp](vnop_getxattr_args/1586304-a_vp.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/vnop_getxattr_args)*