...
```swift
enum task_throughput_qos : unsigned int {
    ...
};
```
...
### Constants
- [THROUGHPUT_QOS_TIER_0](task_throughput_qos/throughput_qos_tier_0.md)
- [THROUGHPUT_QOS_TIER_1](task_throughput_qos/throughput_qos_tier_1.md)
- [THROUGHPUT_QOS_TIER_2](task_throughput_qos/throughput_qos_tier_2.md)
- [THROUGHPUT_QOS_TIER_3](task_throughput_qos/throughput_qos_tier_3.md)
- [THROUGHPUT_QOS_TIER_4](task_throughput_qos/throughput_qos_tier_4.md)
- [THROUGHPUT_QOS_TIER_5](task_throughput_qos/throughput_qos_tier_5.md)
- [THROUGHPUT_QOS_TIER_UNSPECIFIED](task_throughput_qos/throughput_qos_tier_unspecified.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/task_throughput_qos)*