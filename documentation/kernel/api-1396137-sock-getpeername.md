...
- `so`: The socket.
- `peername`: Storage for the peer name.
- `peernamelen`: Length of storage for the peer name.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1396137-sock_getpeername)*