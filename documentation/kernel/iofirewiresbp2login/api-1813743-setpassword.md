...
- `buf`: a pointer to the password buffer.
- `len`: the length in bytes of the password buffer.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/iofirewiresbp2login/1813743-setpassword)*