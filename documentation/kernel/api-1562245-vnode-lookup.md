...
- `flags`: VNODE_LOOKUP_NOFOLLOW: do not follow symbolic links. VNODE_LOOKUP_NOCROSSMOUNT: do not cross mount points.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1562245-vnode_lookup)*