...
### Fields
- [options](iostorageattributes/1574978-options.md)
  Options for the request. See IOStorageOptions.
- [bufattr](iostorageattributes/1574948-bufattr.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/iostorageattributes)*