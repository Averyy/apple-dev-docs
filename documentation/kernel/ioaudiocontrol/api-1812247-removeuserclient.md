...
- `userClient`: The IOAudioControlUserClient to be removed.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioaudiocontrol/1812247-removeuserclient)*