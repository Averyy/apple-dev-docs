...
- `owner`: The owner of the IOCommandGate (the IOAudioControl in this case).
- `arg1`: The IOAudioControlUserClient to be removed.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioaudiocontrol/1812259-removeuserclientaction)*