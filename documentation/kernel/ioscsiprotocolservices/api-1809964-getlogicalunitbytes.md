...
- `lunBytes`: A pointer to SCSILogicalUnitBytes to be filled in by this method.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioscsiprotocolservices/1809964-getlogicalunitbytes)*