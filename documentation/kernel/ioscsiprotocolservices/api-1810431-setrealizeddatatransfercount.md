...
- `newRealizedDataCount`: The realized (actual) data count transferred.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioscsiprotocolservices/1810431-setrealizeddatatransfercount)*