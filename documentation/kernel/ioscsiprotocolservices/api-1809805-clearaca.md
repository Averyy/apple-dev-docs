...
- `theLogicalUnit`: A logical unit for which to clear the ACA.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioscsiprotocolservices/1809805-clearaca)*