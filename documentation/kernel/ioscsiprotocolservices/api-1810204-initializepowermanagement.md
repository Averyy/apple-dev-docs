...
- `provider`: The provider to be joined to in the power management tree.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioscsiprotocolservices/1810204-initializepowermanagement)*