...
```swift
virtual SCSIServiceResponse HandleTargetReset (
 void );
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioscsiprotocolservices/1810176-handletargetreset)*