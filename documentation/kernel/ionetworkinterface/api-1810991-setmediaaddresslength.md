...
- `length`: The size of the media address in bytes.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ionetworkinterface/1810991-setmediaaddresslength)*