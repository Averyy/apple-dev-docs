...
- `mtu`: The interface MTU size in bytes.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ionetworkinterface/1810979-setmaxtransferunit)*