...
- `length`: The size of the media header in bytes.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ionetworkinterface/1811003-setmediaheaderlength)*