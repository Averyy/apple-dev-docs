...
- `aKey`: A C-string identifying the object to be removed.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ionetworkinterface/1810886-removenetworkdata)*