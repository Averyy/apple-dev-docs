...
### Fields
- [blockStart](ioblockstoragedeviceextent/1568446-blockstart.md)
  The starting block number of the operation.
- [blockCount](ioblockstoragedeviceextent/1568453-blockcount.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioblockstoragedeviceextent)*