...
```swift
kern_return_t mach_port_swap_guard(ipc_space_t task, mach_port_name_t name, uint64_t old_guard, uint64_t new_guard);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/3181824-mach_port_swap_guard)*