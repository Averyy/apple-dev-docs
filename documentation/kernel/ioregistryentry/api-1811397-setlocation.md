...
- `location`: A C-string location string which will be copied, or an OSSymbol which will be retained.
- `plane`: The plane object, or zero to set the global location string.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioregistryentry/1811397-setlocation)*