...
- `aValue`: The property's numeric value.
- `aNumberOfBits`: The property's size in bits, for OSNumber.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioregistryentry/1811491-setproperty)*