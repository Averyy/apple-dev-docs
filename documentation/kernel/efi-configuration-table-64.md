...
```swift
typedef struct EFI_CONFIGURATION_TABLE_64 {
    ...
} EFI_CONFIGURATION_TABLE_64;
```
...
### Instance Properties
- [VendorGuid](efi_configuration_table_64/1417193-vendorguid.md)
- [VendorTable](efi_configuration_table_64/1417349-vendortable.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/efi_configuration_table_64)*