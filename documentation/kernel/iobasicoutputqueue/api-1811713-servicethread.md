...
- `param`: A parameter that was given to scheduleServiceThread(). This parameter is not used.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/iobasicoutputqueue/1811713-servicethread)*