...
```swift
virtual void setAVCTargetSpacePointer(
 IOFireWireAVCTargetSpace *pAVCTargetSpace);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/iofirewirepcrspace/1813255-setavctargetspacepointer)*