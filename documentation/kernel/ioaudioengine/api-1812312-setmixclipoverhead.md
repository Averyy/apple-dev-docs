...
- `newMixClipOverhead`: How much time per buffer should be made available for the mix and clip routines to run. Valid values are 1 through 99, inclusive.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioaudioengine/1812312-setmixclipoverhead)*