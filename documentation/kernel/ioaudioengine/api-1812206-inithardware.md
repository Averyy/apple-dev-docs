...
- `provider`: The service provider numb for this audio engine - typically the IOAudioDevice.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioaudioengine/1812206-inithardware)*