...
- `runEraseHead`: The audio engine will run the erase head if this value is true.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioaudioengine/1812317-setrunerasehead)*