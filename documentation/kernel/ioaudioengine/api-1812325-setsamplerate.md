...
- `newSampleRate`: The sample rate of the audio engine in samples per second.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioaudioengine/1812325-setsamplerate)*