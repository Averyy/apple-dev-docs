...
- `type`: Optional user client type passed in by the client - ignored.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioaudioengine/1812227-newuserclient)*