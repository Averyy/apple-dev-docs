...
- `attribute`: Defines the attribute to be set.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/ioaudioengine/1812296-setattributeforconnection)*