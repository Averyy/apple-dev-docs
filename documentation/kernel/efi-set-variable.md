...
```swift
typedef EFI_STATUS (*EFI_SET_VARIABLE)(EFI_CHAR16 *VariableName, EFI_GUID *VendorGuid, EFI_UINT32 Attributes, EFI_UINTN DataSize, VOID *Data);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/efi_set_variable)*