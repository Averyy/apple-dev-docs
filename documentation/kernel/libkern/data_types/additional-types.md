...
- [OSMallocTag](osmalloctag.md)
  An opaque type used to track memory allocations.
- [OSMallocTag_t](osmalloctag_t.md)
...
- [OSKextRequestTag](oskextrequesttag.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/libkern/data_types/additional_types)*