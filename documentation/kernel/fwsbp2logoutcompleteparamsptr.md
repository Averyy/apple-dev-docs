...
```swift
typedef struct FWSBP2LogoutCompleteParams *FWSBP2LogoutCompleteParamsPtr;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/fwsbp2logoutcompleteparamsptr)*