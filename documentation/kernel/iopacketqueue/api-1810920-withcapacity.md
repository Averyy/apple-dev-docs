...
- `capacity`: The initial capacity of the queue object. Can be later changed by calling the setCapacity() method.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/iopacketqueue/1810920-withcapacity)*