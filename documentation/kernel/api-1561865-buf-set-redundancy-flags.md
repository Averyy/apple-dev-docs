...
- `flags`: Flags to add to buffer's redundancy flags
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1561865-buf_set_redundancy_flags)*