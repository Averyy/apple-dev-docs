...
- `startInterfaceMatching`: A boolean specifying whether IOKit should begin the process of finding
- `issueRemoteWakeup`: A boolean specifying whether we should issue the SetFeature(kUSBFeatureDeviceRemoteWakeup) immediately after setting the configuration, before loading any drivers. matching drivers for the new IOUSBInterface objects.
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/iousbdevice/1811340-setconfiguration)*