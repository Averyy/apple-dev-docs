...
- `configIndex`: The configuration index (not the configuration value)
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/iousbdevice/1810553-getfullconfigurationdescriptor)*