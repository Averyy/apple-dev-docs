...
- `ep`: A description of the endpoint
- `sscd`: The SuperSpeed Companion Descriptor, if any (NULL if none)
- `interface`: The IOUSBInterface object requesting the pipe returns the desired IOUSBPipe object
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/iousbdevice/1811080-makepipe)*