...
```swift
int mach_vm_round_page_overflow(mach_vm_offset_t in, mach_vm_offset_t *out);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/kernel/1643689-mach_vm_round_page_overflow)*