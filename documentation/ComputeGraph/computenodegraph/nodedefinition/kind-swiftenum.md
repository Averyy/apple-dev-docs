...
### Enumeration Cases
- [case binaryArithmetic(a: ComputeNodeGraph.DataType, b: ComputeNodeGraph.DataType, operation: BinaryOperation)](computenodegraph/nodedefinition/kind-swift.enum/binaryarithmetic(a:b:operation:).md)
...
- [case convert(from: ComputeNodeGraph.DataType, to: ComputeNodeGraph.DataType)](computenodegraph/nodedefinition/kind-swift.enum/convert(from:to:).md)
...
- [ComputeNodeGraph.NodeDefinition.Kind.function(name:bundle:)](computenodegraph/nodedefinition/kind-swift.enum/function(name:bundle:).md)
...
- [case reinterpret(from: ComputeNodeGraph.DataType, to: ComputeNodeGraph.DataType)](computenodegraph/nodedefinition/kind-swift.enum/reinterpret(from:to:).md)
  Reinterpret one type scalar or vector type as another of the same number of size and bytes.
- [case sampleTexture(sampler: ComputeNodeGraph.SamplerSettings)](computenodegraph/nodedefinition/kind-swift.enum/sampletexture(sampler:).md)
...
- [case standardLibrary(type: ComputeNodeGraph.DataType, function: StandardLibraryFunction)](computenodegraph/nodedefinition/kind-swift.enum/standardlibrary(type:function:).md)
...
- [case swizzle(type: ComputeNodeGraph.DataType, channels: ComputeNodeGraph.SwizzleChannels)](computenodegraph/nodedefinition/kind-swift.enum/swizzle(type:channels:).md)
...
- [case unaryArithmetic(type: ComputeNodeGraph.DataType, operation: UnaryOperation)](computenodegraph/nodedefinition/kind-swift.enum/unaryarithmetic(type:operation:).md)
