...
A new material property object whose [`type`](mdlmaterialproperty/type.md) property is [`MDLMaterialPropertyType.float3`](mdlmaterialpropertytype/float3.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/modelio/mdlmaterialproperty/init(name:semantic:float3:))*