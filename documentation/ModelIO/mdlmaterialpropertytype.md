...
### Initializers
- [init?(rawValue: UInt)](mdlmaterialpropertytype/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/modelio/mdlmaterialpropertytype)*