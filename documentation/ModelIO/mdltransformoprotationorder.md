...
### Enumeration Cases
- [MDLTransformOpRotationOrder.XYZ](mdltransformoprotationorder/xyz.md)
- [MDLTransformOpRotationOrder.XZY](mdltransformoprotationorder/xzy.md)
- [MDLTransformOpRotationOrder.YXZ](mdltransformoprotationorder/yxz.md)
- [MDLTransformOpRotationOrder.YZX](mdltransformoprotationorder/yzx.md)
- [MDLTransformOpRotationOrder.ZXY](mdltransformoprotationorder/zxy.md)
- [MDLTransformOpRotationOrder.ZYX](mdltransformoprotationorder/zyx.md)
### Initializers
- [init?(rawValue: UInt)](mdltransformoprotationorder/init(rawvalue:).md)
...
- [enum MDLMaterialFace](mdlmaterialface.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/modelio/mdltransformoprotationorder)*