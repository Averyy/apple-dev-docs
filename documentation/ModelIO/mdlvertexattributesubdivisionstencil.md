...
- [let kUTType3dObject: String](kuttype3dobject.md)
  The Object file format (common extension `.obj`).


---

*[View on Apple Developer](https://developer.apple.com/documentation/modelio/mdlvertexattributesubdivisionstencil)*