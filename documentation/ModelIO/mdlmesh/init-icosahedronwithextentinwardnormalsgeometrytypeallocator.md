...
```swift
init(icosahedronWithExtent extent: vector_float3, inwardNormals: Bool, geometryType: MDLGeometryType, allocator: (any MDLMeshBufferAllocator)?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/modelio/mdlmesh/init(icosahedronwithextent:inwardnormals:geometrytype:allocator:))*