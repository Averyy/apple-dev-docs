# init(sphereWithExtent:segments:inwardNormals:geometryType:allocator:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/modelio/mdlmesh/init(spherewithextent:segments:inwardnormals:geometrytype:allocator:))*