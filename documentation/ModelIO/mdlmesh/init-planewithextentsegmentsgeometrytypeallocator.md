# init(planeWithExtent:segments:geometryType:allocator:)
...
```swift
init(planeWithExtent extent: vector_float3, segments: vector_uint2, geometryType: MDLGeometryType, allocator: (any MDLMeshBufferAllocator)?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/modelio/mdlmesh/init(planewithextent:segments:geometrytype:allocator:))*