# addAttribute(withName:format:type:data:stride:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/modelio/mdlmesh/addattribute(withname:format:type:data:stride:))*