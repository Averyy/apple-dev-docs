...
- `inwardNormals`:   to generate normal vectors pointing toward the central axis of the cone;   to generate normal vectors pointing outward.
...
*[View on Apple Developer](https://developer.apple.com/documentation/modelio/mdlmesh/newellipticalcone(withheight:radii:radialsegments:verticalsegments:geometrytype:inwardnormals:allocator:))*