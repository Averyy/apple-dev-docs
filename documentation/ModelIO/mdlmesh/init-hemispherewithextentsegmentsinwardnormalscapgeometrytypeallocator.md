# init(hemisphereWithExtent:segments:inwardNormals:cap:geometryType:allocator:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/modelio/mdlmesh/init(hemispherewithextent:segments:inwardnormals:cap:geometrytype:allocator:))*