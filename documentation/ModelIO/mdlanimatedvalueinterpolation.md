...
### Enumeration Cases
- [MDLAnimatedValueInterpolation.constant](mdlanimatedvalueinterpolation/constant.md)
- [MDLAnimatedValueInterpolation.linear](mdlanimatedvalueinterpolation/linear.md)
### Initializers
- [init?(rawValue: UInt)](mdlanimatedvalueinterpolation/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/modelio/mdlanimatedvalueinterpolation)*