...
If an asset contains timed information, such as animated mesh data, this property provides the asset’s bounding box as of the first time sample. Use the [`boundingBox(atTime:)`](mdlasset/boundingbox(attime:).md) method to get bounding box information at a specific time sample.
...
*[View on Apple Developer](https://developer.apple.com/documentation/modelio/mdlasset/boundingbox)*