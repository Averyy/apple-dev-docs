...
Using this initializer is equivalent to using the [`init(url:vertexDescriptor:bufferAllocator:preserveTopology:error:)`](mdlasset/init(url:vertexdescriptor:bufferallocator:preservetopology:error:)-510xi.md) initializer, passing [`false`](https://developer.apple.com/documentation/swift/false) for the `preserveTopology` parameter and ignoring errors.
...
*[View on Apple Developer](https://developer.apple.com/documentation/modelio/mdlasset/init(url:vertexdescriptor:bufferallocator:)-1tchi)*