# MDLMaterialPropertyType.float4
...
Use the [`float4Value`](mdlmaterialproperty/float4value.md) property to access the material property’s value.
...
*[View on Apple Developer](https://developer.apple.com/documentation/modelio/mdlmaterialpropertytype/float4)*