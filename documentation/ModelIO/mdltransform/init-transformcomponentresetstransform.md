# init(transformComponent:resetsTransform:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/modelio/mdltransform/init(transformcomponent:resetstransform:))*