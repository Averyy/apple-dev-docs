...
```swift
#define kIOHIDPointerAccelerationSupportKey
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hiddriverkit/kiohidpointeraccelerationsupportkey)*