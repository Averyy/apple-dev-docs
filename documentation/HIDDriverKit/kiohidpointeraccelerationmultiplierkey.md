...
```swift
#define kIOHIDPointerAccelerationMultiplierKey
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hiddriverkit/kiohidpointeraccelerationmultiplierkey)*