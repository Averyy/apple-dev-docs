...
```swift
#define kIOHIDDeviceDefaultAsyncRequestTimeout
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hiddriverkit/kiohiddevicedefaultasyncrequesttimeout)*