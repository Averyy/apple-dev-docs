...
### Getting the Usages
- [kHIDUsage_GenDevControls_BackgroundControls](khidusage_gendevcontrols_backgroundcontrols.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/hiddriverkit/generic-device-controls-enum)*