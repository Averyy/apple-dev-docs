...
- [kIOHIDReportOptionNotInterrupt](kiohidreportoptionnotinterrupt.md)
  An option that indicates the report isn’t interrupt driven.
- [kIOHIDReportOptionVariableSize](kiohidreportoptionvariablesize.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/hiddriverkit/report-options-enum)*