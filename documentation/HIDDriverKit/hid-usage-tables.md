...
### Essentials
- [Usage Pages](usage-pages-enum.md)
...
- [Weighing Device](weighing-device-enum.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/hiddriverkit/hid-usage-tables)*