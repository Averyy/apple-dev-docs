...
For example, this property is `1` if the value in the [`touch`](iohiddigitizertouchdata/touch.md) field changed from `0` to `1` since the last event.
...
*[View on Apple Developer](https://developer.apple.com/documentation/hiddriverkit/iohiddigitizertouchdata/touchchanged)*