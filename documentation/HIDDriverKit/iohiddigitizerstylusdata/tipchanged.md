...
For example, this property is `1` if the value in the [`tip`](iohiddigitizerstylusdata/tip.md) field changed from `0` to `1` since the last event.
...
*[View on Apple Developer](https://developer.apple.com/documentation/hiddriverkit/iohiddigitizerstylusdata/tipchanged)*