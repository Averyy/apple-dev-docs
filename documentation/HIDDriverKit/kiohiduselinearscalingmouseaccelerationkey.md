...
```swift
#define kIOHIDUseLinearScalingMouseAccelerationKey
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hiddriverkit/kiohiduselinearscalingmouseaccelerationkey)*