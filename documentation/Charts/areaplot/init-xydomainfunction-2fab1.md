...
```swift
nonisolated
init(x: Text, y: Text, domain: ClosedRange<Double>? = nil, function: @escaping @Sendable (Double) -> Double)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/charts/areaplot/init(x:y:domain:function:)-2fab1)*