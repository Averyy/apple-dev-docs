...
```swift
nonisolated
init(x: Text, yStart: Text, yEnd: Text, domain: ClosedRange<Double>? = nil, function: @escaping @Sendable (Double) -> (yStart: Double, yEnd: Double))
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/charts/areaplot/init(x:ystart:yend:domain:function:)-etcn)*