...
```swift
nonisolated
init(x: LocalizedStringResource, y: LocalizedStringResource, t: LocalizedStringResource, domain: ClosedRange<Double>, function: @escaping (Double) -> (x: Double, y: Double))
```
