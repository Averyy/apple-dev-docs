...
```swift
nonisolated
init(x: Text, y: Text, t: Text, domain: ClosedRange<Double>, function: @escaping @Sendable (Double) -> (x: Double, y: Double))
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/charts/lineplot/init(x:y:t:domain:function:)-5c4bo)*