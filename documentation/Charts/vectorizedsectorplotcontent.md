...
```swift
@MainActor
@preconcurrency struct VectorizedSectorPlotContent<Data> where Data : RandomAccessCollection
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/charts/vectorizedsectorplotcontent)*