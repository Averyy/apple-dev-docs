...
```swift
nonisolated
init(centered: Bool? = nil, length: AxisTick.Length = .automatic, stroke: StrokeStyle? = nil)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/charts/axistick/init(centered:length:stroke:)-93rvh)*