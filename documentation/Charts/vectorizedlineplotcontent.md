...
```swift
@MainActor
@preconcurrency struct VectorizedLinePlotContent<Data> where Data : RandomAccessCollection
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/charts/vectorizedlineplotcontent)*