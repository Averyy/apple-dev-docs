...
```swift
nonisolated
func accessibilityValue<S>(_ value: S) -> some ChartContent where S : StringProtocol
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/charts/chartcontent/accessibilityvalue(_:)-4k545)*