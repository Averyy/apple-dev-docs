...
```swift
nonisolated
func accessibilityValue(_ valueKey: LocalizedStringKey) -> some ChartContent
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/charts/chartcontent/accessibilityvalue(_:)-33c0e)*