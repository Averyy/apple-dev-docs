...
```swift
nonisolated
func symbol<V>(@ViewBuilder symbol: () -> V) -> some ChartContent where V : View
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/charts/chartcontent/symbol(symbol:))*