...
```swift
nonisolated
func accessibilityLabel<S>(_ label: S) -> some ChartContent where S : StringProtocol
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/charts/chartcontent/accessibilitylabel(_:)-5gk8d)*