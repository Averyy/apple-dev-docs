...
```swift
nonisolated
func offset(x: CGFloat = 0, yStart: CGFloat = 0, yEnd: CGFloat = 0) -> some ChartContent
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/charts/chartcontent/offset(x:ystart:yend:))*