...
```swift
nonisolated
init<Data, X>(_ data: Data, xStart: PlottableProjection<RulePlot<Content>.DataElement, X>, xEnd: PlottableProjection<RulePlot<Content>.DataElement, X>, y: KeyPath<RulePlot<Content>.DataElement, CGFloat>) where Content == VectorizedRulePlotContent<Data>, Data : RandomAccessCollection, X : Plottable
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/charts/ruleplot/init(_:xstart:xend:y:)-54gxx)*