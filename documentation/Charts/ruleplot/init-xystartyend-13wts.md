...
```swift
nonisolated
init<Data>(_ data: Data, x: PlottableProjection<RulePlot<Content>.DataElement, some Plottable>, yStart: CGFloat? = nil, yEnd: CGFloat? = nil) where Content == VectorizedRulePlotContent<Data>, Data : RandomAccessCollection
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/charts/ruleplot/init(_:x:ystart:yend:)-13wts)*