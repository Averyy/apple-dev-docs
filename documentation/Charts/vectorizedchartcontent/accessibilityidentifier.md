...
```swift
nonisolated
func accessibilityIdentifier(_ identifier: KeyPath<Self.DataElement, String>) -> some VectorizedChartContent<Self.DataElement>
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/charts/vectorizedchartcontent/accessibilityidentifier(_:))*