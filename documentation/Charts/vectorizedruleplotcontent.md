...
```swift
@MainActor
@preconcurrency struct VectorizedRulePlotContent<Data> where Data : RandomAccessCollection
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/charts/vectorizedruleplotcontent)*