...
```swift
@MainActor
@preconcurrency struct VectorizedPointPlotContent<Data> where Data : RandomAccessCollection
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/charts/vectorizedpointplotcontent)*