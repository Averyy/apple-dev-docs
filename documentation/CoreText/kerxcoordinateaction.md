...
### Initializers
- [init()](kerxcoordinateaction/init.md)
- [init(markX: UInt16, markY: UInt16, currX: UInt16, currY: UInt16)](kerxcoordinateaction/init(markx:marky:currx:curry:).md)
### Instance Properties
- [var currX: UInt16](kerxcoordinateaction/currx.md)
- [var currY: UInt16](kerxcoordinateaction/curry.md)
- [var markX: UInt16](kerxcoordinateaction/markx.md)
- [var markY: UInt16](kerxcoordinateaction/marky.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/kerxcoordinateaction)*