...
Key to get the variation axis identifier value as a reference to a [`CFNumber`](https://developer.apple.com/documentation/corefoundation/cfnumber) object.
...
- [let kCTFontVariationAxisHiddenKey: CFString](kctfontvariationaxishiddenkey.md)
  The key to find out if the axis is hidden.


---

*[View on Apple Developer](https://developer.apple.com/documentation/coretext/kctfontvariationaxisidentifierkey)*