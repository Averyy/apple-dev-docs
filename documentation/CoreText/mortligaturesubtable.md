...
### Initializers
- [init()](mortligaturesubtable/init.md)
- [init(header: STHeader, ligatureActionTableOffset: UInt16, componentTableOffset: UInt16, ligatureTableOffset: UInt16)](mortligaturesubtable/init(header:ligatureactiontableoffset:componenttableoffset:ligaturetableoffset:).md)
### Instance Properties
- [var componentTableOffset: UInt16](mortligaturesubtable/componenttableoffset.md)
- [var header: STHeader](mortligaturesubtable/header.md)
- [var ligatureActionTableOffset: UInt16](mortligaturesubtable/ligatureactiontableoffset.md)
- [var ligatureTableOffset: UInt16](mortligaturesubtable/ligaturetableoffset.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/mortligaturesubtable)*