...
### Initializers
- [init()](kernorderedlistentry/init.md)
- [init(pair: KernKerningPair, value: KernKerningValue)](kernorderedlistentry/init(pair:value:).md)
### Instance Properties
- [var pair: KernKerningPair](kernorderedlistentry/pair.md)
- [var value: KernKerningValue](kernorderedlistentry/value.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/kernorderedlistentry)*