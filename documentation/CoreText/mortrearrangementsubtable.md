...
### Initializers
- [init()](mortrearrangementsubtable/init.md)
- [init(header: STHeader)](mortrearrangementsubtable/init(header:).md)
### Instance Properties
- [var header: STHeader](mortrearrangementsubtable/header.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/mortrearrangementsubtable)*