...
### Initializers
- [init()](sfntcmapheader/init.md)
- [init(version: UInt16, numTables: UInt16, encoding: sfntCMapEncoding)](sfntcmapheader/init(version:numtables:encoding:).md)
### Instance Properties
- [var encoding: sfntCMapEncoding](sfntcmapheader/encoding.md)
- [var numTables: UInt16](sfntcmapheader/numtables.md)
- [var version: UInt16](sfntcmapheader/version.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/sfntcmapheader)*