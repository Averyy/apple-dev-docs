...
### Initializers
- [init()](stxentryone/init.md)
- [init(newState: STXStateIndex, flags: UInt16, index1: UInt16)](stxentryone/init(newstate:flags:index1:).md)
### Instance Properties
- [var flags: UInt16](stxentryone/flags.md)
- [var index1: UInt16](stxentryone/index1.md)
- [var newState: STXStateIndex](stxentryone/newstate.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/stxentryone)*