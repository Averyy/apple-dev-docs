...
### Initializers
- [init()](kernorderedlistheader/init.md)
- [init(nPairs: UInt16, searchRange: UInt16, entrySelector: UInt16, rangeShift: UInt16, table: UInt16)](kernorderedlistheader/init(npairs:searchrange:entryselector:rangeshift:table:).md)
### Instance Properties
- [var entrySelector: UInt16](kernorderedlistheader/entryselector.md)
- [var nPairs: UInt16](kernorderedlistheader/npairs.md)
- [var rangeShift: UInt16](kernorderedlistheader/rangeshift.md)
- [var searchRange: UInt16](kernorderedlistheader/searchrange.md)
- [var table: UInt16](kernorderedlistheader/table.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/kernorderedlistheader)*