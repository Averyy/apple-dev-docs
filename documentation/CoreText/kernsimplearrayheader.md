...
### Initializers
- [init()](kernsimplearrayheader/init.md)
- [init(rowWidth: UInt16, leftOffsetTable: UInt16, rightOffsetTable: UInt16, theArray: KernArrayOffset, firstTable: UInt16)](kernsimplearrayheader/init(rowwidth:leftoffsettable:rightoffsettable:thearray:firsttable:).md)
### Instance Properties
- [var firstTable: UInt16](kernsimplearrayheader/firsttable.md)
- [var leftOffsetTable: UInt16](kernsimplearrayheader/leftoffsettable.md)
- [var rightOffsetTable: UInt16](kernsimplearrayheader/rightoffsettable.md)
- [var rowWidth: UInt16](kernsimplearrayheader/rowwidth.md)
- [var theArray: KernArrayOffset](kernsimplearrayheader/thearray.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/kernsimplearrayheader)*