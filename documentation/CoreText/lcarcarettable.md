...
### Initializers
- [init()](lcarcarettable/init.md)
- [init(version: Fixed, format: UInt16, lookup: SFNTLookupTable)](lcarcarettable/init(version:format:lookup:).md)
### Instance Properties
- [var format: UInt16](lcarcarettable/format.md)
- [var lookup: SFNTLookupTable](lcarcarettable/lookup.md)
- [var version: Fixed](lcarcarettable/version.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/lcarcarettable)*