...
### Initializers
- [init()](mortswashsubtable/init.md)
- [init(lookup: SFNTLookupTable)](mortswashsubtable/init(lookup:).md)
### Instance Properties
- [var lookup: SFNTLookupTable](mortswashsubtable/lookup.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/mortswashsubtable)*