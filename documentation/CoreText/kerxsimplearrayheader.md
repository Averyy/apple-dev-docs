...
### Initializers
- [init()](kerxsimplearrayheader/init.md)
- [init(rowWidth: UInt32, leftOffsetTable: UInt32, rightOffsetTable: UInt32, theArray: KerxArrayOffset, firstTable: UInt32)](kerxsimplearrayheader/init(rowwidth:leftoffsettable:rightoffsettable:thearray:firsttable:).md)
### Instance Properties
- [var firstTable: UInt32](kerxsimplearrayheader/firsttable.md)
- [var leftOffsetTable: UInt32](kerxsimplearrayheader/leftoffsettable.md)
- [var rightOffsetTable: UInt32](kerxsimplearrayheader/rightoffsettable.md)
- [var rowWidth: UInt32](kerxsimplearrayheader/rowwidth.md)
- [var theArray: KerxArrayOffset](kerxsimplearrayheader/thearray.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/kerxsimplearrayheader)*