...
### Initializers
- [init()](rotaglyphentry/init.md)
- [init(GlyphIndexOffset: Int16, HBaselineOffset: Int16, VBaselineOffset: Int16)](rotaglyphentry/init(glyphindexoffset:hbaselineoffset:vbaselineoffset:).md)
### Instance Properties
- [var GlyphIndexOffset: Int16](rotaglyphentry/glyphindexoffset.md)
- [var HBaselineOffset: Int16](rotaglyphentry/hbaselineoffset.md)
- [var VBaselineOffset: Int16](rotaglyphentry/vbaselineoffset.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/rotaglyphentry)*