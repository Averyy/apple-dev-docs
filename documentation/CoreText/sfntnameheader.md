...
### Initializers
- [init()](sfntnameheader/init.md)
- [init(format: UInt16, count: UInt16, stringOffset: UInt16, rec: sfntNameRecord)](sfntnameheader/init(format:count:stringoffset:rec:).md)
### Instance Properties
- [var count: UInt16](sfntnameheader/count.md)
- [var format: UInt16](sfntnameheader/format.md)
- [var rec: sfntNameRecord](sfntnameheader/rec.md)
- [var stringOffset: UInt16](sfntnameheader/stringoffset.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/sfntnameheader)*