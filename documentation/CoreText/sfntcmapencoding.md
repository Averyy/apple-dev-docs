...
### Initializers
- [init()](sfntcmapencoding/init.md)
- [init(platformID: UInt16, scriptID: UInt16, offset: UInt32)](sfntcmapencoding/init(platformid:scriptid:offset:).md)
### Instance Properties
- [var offset: UInt32](sfntcmapencoding/offset.md)
- [var platformID: UInt16](sfntcmapencoding/platformid.md)
- [var scriptID: UInt16](sfntcmapencoding/scriptid.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/sfntcmapencoding)*