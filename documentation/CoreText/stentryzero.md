...
### Initializers
- [init()](stentryzero/init.md)
- [init(newState: UInt16, flags: UInt16)](stentryzero/init(newstate:flags:).md)
### Instance Properties
- [var flags: UInt16](stentryzero/flags.md)
- [var newState: UInt16](stentryzero/newstate.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/stentryzero)*