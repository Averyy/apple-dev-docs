...
### Initializers
- [init()](kernoffsettable/init.md)
- [init(firstGlyph: UInt16, nGlyphs: UInt16, offsetTable: KernArrayOffset)](kernoffsettable/init(firstglyph:nglyphs:offsettable:).md)
### Instance Properties
- [var firstGlyph: UInt16](kernoffsettable/firstglyph.md)
- [var nGlyphs: UInt16](kernoffsettable/nglyphs.md)
- [var offsetTable: KernArrayOffset](kernoffsettable/offsettable.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/kernoffsettable)*