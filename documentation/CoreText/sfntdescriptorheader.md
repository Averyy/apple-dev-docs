...
### Initializers
- [init()](sfntdescriptorheader/init.md)
- [init(version: Fixed, descriptorCount: Int32, descriptor: sfntFontDescriptor)](sfntdescriptorheader/init(version:descriptorcount:descriptor:).md)
### Instance Properties
- [var descriptor: sfntFontDescriptor](sfntdescriptorheader/descriptor.md)
- [var descriptorCount: Int32](sfntdescriptorheader/descriptorcount.md)
- [var version: Fixed](sfntdescriptorheader/version.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/sfntdescriptorheader)*