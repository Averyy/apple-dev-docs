...
### Initializers
- [init()](kerxanchorpointaction/init.md)
- [init(markAnchorPoint: UInt16, currAnchorPoint: UInt16)](kerxanchorpointaction/init(markanchorpoint:curranchorpoint:).md)
### Instance Properties
- [var currAnchorPoint: UInt16](kerxanchorpointaction/curranchorpoint.md)
- [var markAnchorPoint: UInt16](kerxanchorpointaction/markanchorpoint.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/kerxanchorpointaction)*