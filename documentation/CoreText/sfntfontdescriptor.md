...
### Initializers
- [init()](sfntfontdescriptor/init.md)
- [init(name: FourCharCode, value: Fixed)](sfntfontdescriptor/init(name:value:).md)
### Instance Properties
- [var name: FourCharCode](sfntfontdescriptor/name.md)
- [var value: Fixed](sfntfontdescriptor/value.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/sfntfontdescriptor)*