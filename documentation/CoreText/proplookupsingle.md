...
### Initializers
- [init()](proplookupsingle/init.md)
- [init(glyph: UInt16, props: PropCharProperties)](proplookupsingle/init(glyph:props:).md)
### Instance Properties
- [var glyph: UInt16](proplookupsingle/glyph.md)
- [var props: PropCharProperties](proplookupsingle/props.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/proplookupsingle)*