...
### Initializers
- [init()](kerxcontrolpointentry/init.md)
- [init(newState: UInt16, flags: UInt16, actionIndex: UInt16)](kerxcontrolpointentry/init(newstate:flags:actionindex:).md)
### Instance Properties
- [var actionIndex: UInt16](kerxcontrolpointentry/actionindex.md)
- [var flags: UInt16](kerxcontrolpointentry/flags.md)
- [var newState: UInt16](kerxcontrolpointentry/newstate.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/kerxcontrolpointentry)*