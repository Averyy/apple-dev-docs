...
### Initializers
- [init()](morttable/init.md)
- [init(version: Fixed, nChains: UInt32, chains: MortChain)](morttable/init(version:nchains:chains:).md)
### Instance Properties
- [var chains: MortChain](morttable/chains.md)
- [var nChains: UInt32](morttable/nchains.md)
- [var version: Fixed](morttable/version.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/morttable)*