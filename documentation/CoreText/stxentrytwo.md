...
### Initializers
- [init()](stxentrytwo/init.md)
- [init(newState: STXStateIndex, flags: UInt16, index1: UInt16, index2: UInt16)](stxentrytwo/init(newstate:flags:index1:index2:).md)
### Instance Properties
- [var flags: UInt16](stxentrytwo/flags.md)
- [var index1: UInt16](stxentrytwo/index1.md)
- [var index2: UInt16](stxentrytwo/index2.md)
- [var newState: STXStateIndex](stxentrytwo/newstate.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/stxentrytwo)*