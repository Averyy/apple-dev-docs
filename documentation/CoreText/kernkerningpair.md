...
### Initializers
- [init()](kernkerningpair/init.md)
- [init(left: UInt16, right: UInt16)](kernkerningpair/init(left:right:).md)
### Instance Properties
- [var left: UInt16](kernkerningpair/left.md)
- [var right: UInt16](kernkerningpair/right.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/kernkerningpair)*