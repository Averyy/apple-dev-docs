...
### Initializers
- [init()](sfntcmapsubheader/init.md)
- [init(format: UInt16, length: UInt16, languageID: UInt16)](sfntcmapsubheader/init(format:length:languageid:).md)
### Instance Properties
- [var format: UInt16](sfntcmapsubheader/format.md)
- [var languageID: UInt16](sfntcmapsubheader/languageid.md)
- [var length: UInt16](sfntcmapsubheader/length.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/sfntcmapsubheader)*