...
### Initializers
- [init()](justwidthdeltagroup/init.md)
- [init(count: UInt32, entries: JustWidthDeltaEntry)](justwidthdeltagroup/init(count:entries:).md)
### Instance Properties
- [var count: UInt32](justwidthdeltagroup/count.md)
- [var entries: JustWidthDeltaEntry](justwidthdeltagroup/entries.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/justwidthdeltagroup)*