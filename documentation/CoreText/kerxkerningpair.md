...
### Initializers
- [init()](kerxkerningpair/init.md)
- [init(left: UInt16, right: UInt16)](kerxkerningpair/init(left:right:).md)
### Instance Properties
- [var left: UInt16](kerxkerningpair/left.md)
- [var right: UInt16](kerxkerningpair/right.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/kerxkerningpair)*