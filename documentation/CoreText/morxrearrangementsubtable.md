...
### Initializers
- [init()](morxrearrangementsubtable/init.md)
- [init(header: STXHeader)](morxrearrangementsubtable/init(header:).md)
### Instance Properties
- [var header: STXHeader](morxrearrangementsubtable/header.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/morxrearrangementsubtable)*