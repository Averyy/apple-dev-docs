...
The Font Manager bundle identifier to be used when getting or setting global auto-activation using [`CTFontManagerGetAutoActivationSetting(_:)`](ctfontmanagergetautoactivationsetting(_:).md) or [`CTFontManagerSetAutoActivationSetting(_:_:)`](ctfontmanagersetautoactivationsetting(_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/kctfontmanagerbundleidentifier)*