...
### Initializers
- [init()](stclasstable/init.md)
- [init(firstGlyph: UInt16, nGlyphs: UInt16, classes: STClass)](stclasstable/init(firstglyph:nglyphs:classes:).md)
### Instance Properties
- [var classes: STClass](stclasstable/classes.md)
- [var firstGlyph: UInt16](stclasstable/firstglyph.md)
- [var nGlyphs: UInt16](stclasstable/nglyphs.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/stclasstable)*