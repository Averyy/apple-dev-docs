...
### Initializers
- [init()](kernstateentry/init.md)
- [init(newState: UInt16, flags: UInt16)](kernstateentry/init(newstate:flags:).md)
### Instance Properties
- [var flags: UInt16](kernstateentry/flags.md)
- [var newState: UInt16](kernstateentry/newstate.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/kernstateentry)*