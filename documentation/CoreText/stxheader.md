...
### Initializers
- [init()](stxheader/init.md)
- [init(nClasses: UInt32, classTableOffset: UInt32, stateArrayOffset: UInt32, entryTableOffset: UInt32)](stxheader/init(nclasses:classtableoffset:statearrayoffset:entrytableoffset:).md)
### Instance Properties
- [var classTableOffset: UInt32](stxheader/classtableoffset.md)
- [var entryTableOffset: UInt32](stxheader/entrytableoffset.md)
- [var nClasses: UInt32](stxheader/nclasses.md)
- [var stateArrayOffset: UInt32](stxheader/statearrayoffset.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/stxheader)*