...
### Initializers
- [init()](kerxcontrolpointaction/init.md)
- [init(markControlPoint: UInt16, currControlPoint: UInt16)](kerxcontrolpointaction/init(markcontrolpoint:currcontrolpoint:).md)
### Instance Properties
- [var currControlPoint: UInt16](kerxcontrolpointaction/currcontrolpoint.md)
- [var markControlPoint: UInt16](kerxcontrolpointaction/markcontrolpoint.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/kerxcontrolpointaction)*