...
### Initializers
- [init()](mortchain/init.md)
- [init(defaultFlags: MortSubtableMaskFlags, length: UInt32, nFeatures: UInt16, nSubtables: UInt16, featureEntries: MortFeatureEntry)](mortchain/init(defaultflags:length:nfeatures:nsubtables:featureentries:).md)
### Instance Properties
- [var defaultFlags: MortSubtableMaskFlags](mortchain/defaultflags.md)
- [var featureEntries: MortFeatureEntry](mortchain/featureentries.md)
- [var length: UInt32](mortchain/length.md)
- [var nFeatures: UInt16](mortchain/nfeatures.md)
- [var nSubtables: UInt16](mortchain/nsubtables.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/mortchain)*