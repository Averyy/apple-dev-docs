...
### Initializers
- [init()](traktabledata/init.md)
- [init(nTracks: UInt16, nSizes: UInt16, sizeTableOffset: UInt32, trakTable: TrakTableEntry)](traktabledata/init(ntracks:nsizes:sizetableoffset:traktable:).md)
### Instance Properties
- [var nSizes: UInt16](traktabledata/nsizes.md)
- [var nTracks: UInt16](traktabledata/ntracks.md)
- [var sizeTableOffset: UInt32](traktabledata/sizetableoffset.md)
- [var trakTable: TrakTableEntry](traktabledata/traktable.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/traktabledata)*