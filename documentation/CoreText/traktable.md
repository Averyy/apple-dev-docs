...
### Initializers
- [init()](traktable/init.md)
- [init(version: Fixed, format: UInt16, horizOffset: UInt16, vertOffset: UInt16)](traktable/init(version:format:horizoffset:vertoffset:).md)
### Instance Properties
- [var format: UInt16](traktable/format.md)
- [var horizOffset: UInt16](traktable/horizoffset.md)
- [var version: Fixed](traktable/version.md)
- [var vertOffset: UInt16](traktable/vertoffset.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/traktable)*