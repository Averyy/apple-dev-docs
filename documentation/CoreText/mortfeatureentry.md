...
### Initializers
- [init()](mortfeatureentry/init.md)
- [init(featureType: UInt16, featureSelector: UInt16, enableFlags: MortSubtableMaskFlags, disableFlags: MortSubtableMaskFlags)](mortfeatureentry/init(featuretype:featureselector:enableflags:disableflags:).md)
### Instance Properties
- [var disableFlags: MortSubtableMaskFlags](mortfeatureentry/disableflags.md)
- [var enableFlags: MortSubtableMaskFlags](mortfeatureentry/enableflags.md)
- [var featureSelector: UInt16](mortfeatureentry/featureselector.md)
- [var featureType: UInt16](mortfeatureentry/featuretype.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/mortfeatureentry)*