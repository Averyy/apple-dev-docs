...
### Initializers
- [init()](kerxtableheader/init.md)
- [init(version: Fixed, nTables: UInt32, firstSubtable: UInt32)](kerxtableheader/init(version:ntables:firstsubtable:).md)
### Instance Properties
- [var firstSubtable: UInt32](kerxtableheader/firstsubtable.md)
- [var nTables: UInt32](kerxtableheader/ntables.md)
- [var version: Fixed](kerxtableheader/version.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/kerxtableheader)*