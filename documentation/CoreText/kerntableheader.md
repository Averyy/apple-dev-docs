...
### Initializers
- [init()](kerntableheader/init.md)
- [init(version: Fixed, nTables: Int32, firstSubtable: UInt16)](kerntableheader/init(version:ntables:firstsubtable:).md)
### Instance Properties
- [var firstSubtable: UInt16](kerntableheader/firstsubtable.md)
- [var nTables: Int32](kerntableheader/ntables.md)
- [var version: Fixed](kerntableheader/version.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/kerntableheader)*