...
### Initializers
- [init()](stxentryzero/init.md)
- [init(newState: STXStateIndex, flags: UInt16)](stxentryzero/init(newstate:flags:).md)
### Instance Properties
- [var flags: UInt16](stxentryzero/flags.md)
- [var newState: STXStateIndex](stxentryzero/newstate.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/stxentryzero)*