...
### Initializers
- [init()](justtable/init.md)
- [init(version: Fixed, format: UInt16, horizHeaderOffset: UInt16, vertHeaderOffset: UInt16)](justtable/init(version:format:horizheaderoffset:vertheaderoffset:).md)
### Instance Properties
- [var format: UInt16](justtable/format.md)
- [var horizHeaderOffset: UInt16](justtable/horizheaderoffset.md)
- [var version: Fixed](justtable/version.md)
- [var vertHeaderOffset: UInt16](justtable/vertheaderoffset.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/justtable)*