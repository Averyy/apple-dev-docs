...
### Initializers
- [init()](anchorpoint/init.md)
- [init(x: Int16, y: Int16)](anchorpoint/init(x:y:).md)
### Instance Properties
- [var x: Int16](anchorpoint/x.md)
- [var y: Int16](anchorpoint/y.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/anchorpoint)*