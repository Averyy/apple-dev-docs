...
### Initializers
- [init()](morxtable/init.md)
- [init(version: Fixed, nChains: UInt32, chains: MorxChain)](morxtable/init(version:nchains:chains:).md)
### Instance Properties
- [var chains: MorxChain](morxtable/chains.md)
- [var nChains: UInt32](morxtable/nchains.md)
- [var version: Fixed](morxtable/version.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/morxtable)*