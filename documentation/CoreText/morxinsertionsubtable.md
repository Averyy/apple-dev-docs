...
### Initializers
- [init()](morxinsertionsubtable/init.md)
- [init(header: STXHeader, insertionGlyphTableOffset: UInt32)](morxinsertionsubtable/init(header:insertionglyphtableoffset:).md)
### Instance Properties
- [var header: STXHeader](morxinsertionsubtable/header.md)
- [var insertionGlyphTableOffset: UInt32](morxinsertionsubtable/insertionglyphtableoffset.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/morxinsertionsubtable)*