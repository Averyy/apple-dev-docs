...
### Initializers
- [init()](sfntinstance/init.md)
- [init(nameID: Int16, flags: Int16, coord: Fixed)](sfntinstance/init(nameid:flags:coord:).md)
### Instance Properties
- [var coord: Fixed](sfntinstance/coord.md)
- [var flags: Int16](sfntinstance/flags.md)
- [var nameID: Int16](sfntinstance/nameid.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/sfntinstance)*