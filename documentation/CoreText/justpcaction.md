...
### Initializers
- [init()](justpcaction/init.md)
- [init(actionCount: UInt32, actions: JustPCActionSubrecord)](justpcaction/init(actioncount:actions:).md)
### Instance Properties
- [var actionCount: UInt32](justpcaction/actioncount.md)
- [var actions: JustPCActionSubrecord](justpcaction/actions.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/justpcaction)*