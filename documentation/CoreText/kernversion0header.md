...
### Initializers
- [init()](kernversion0header/init.md)
- [init(version: UInt16, nTables: UInt16, firstSubtable: UInt16)](kernversion0header/init(version:ntables:firstsubtable:).md)
### Instance Properties
- [var firstSubtable: UInt16](kernversion0header/firstsubtable.md)
- [var nTables: UInt16](kernversion0header/ntables.md)
- [var version: UInt16](kernversion0header/version.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/kernversion0header)*