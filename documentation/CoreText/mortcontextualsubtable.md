...
### Initializers
- [init()](mortcontextualsubtable/init.md)
- [init(header: STHeader, substitutionTableOffset: UInt16)](mortcontextualsubtable/init(header:substitutiontableoffset:).md)
### Instance Properties
- [var header: STHeader](mortcontextualsubtable/header.md)
- [var substitutionTableOffset: UInt16](mortcontextualsubtable/substitutiontableoffset.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/mortcontextualsubtable)*