...
### Initializers
- [init()](mortinsertionsubtable/init.md)
- [init(header: STHeader)](mortinsertionsubtable/init(header:).md)
### Instance Properties
- [var header: STHeader](mortinsertionsubtable/header.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/mortinsertionsubtable)*