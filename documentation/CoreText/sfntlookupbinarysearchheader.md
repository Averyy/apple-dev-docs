...
### Initializers
- [init()](sfntlookupbinarysearchheader/init.md)
- [init(unitSize: UInt16, nUnits: UInt16, searchRange: UInt16, entrySelector: UInt16, rangeShift: UInt16)](sfntlookupbinarysearchheader/init(unitsize:nunits:searchrange:entryselector:rangeshift:).md)
### Instance Properties
- [var entrySelector: UInt16](sfntlookupbinarysearchheader/entryselector.md)
- [var nUnits: UInt16](sfntlookupbinarysearchheader/nunits.md)
- [var rangeShift: UInt16](sfntlookupbinarysearchheader/rangeshift.md)
- [var searchRange: UInt16](sfntlookupbinarysearchheader/searchrange.md)
- [var unitSize: UInt16](sfntlookupbinarysearchheader/unitsize.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/sfntlookupbinarysearchheader)*