...
### Initializers
- [init()](mortsubtable/init.md)
- [init(length: UInt16, coverage: UInt16, flags: MortSubtableMaskFlags, u: MortSpecificSubtable)](mortsubtable/init(length:coverage:flags:u:).md)
### Instance Properties
- [var coverage: UInt16](mortsubtable/coverage.md)
- [var flags: MortSubtableMaskFlags](mortsubtable/flags.md)
- [var length: UInt16](mortsubtable/length.md)
- [var u: MortSpecificSubtable](mortsubtable/u.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/mortsubtable)*