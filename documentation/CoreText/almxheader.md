...
### Initializers
- [init()](almxheader/init.md)
- [init(Version: Fixed, Flags: UInt16, NMasters: UInt16, FirstGlyph: UInt16, LastGlyph: UInt16, lookup: SFNTLookupTable)](almxheader/init(version:flags:nmasters:firstglyph:lastglyph:lookup:).md)
### Instance Properties
- [var FirstGlyph: UInt16](almxheader/firstglyph.md)
- [var Flags: UInt16](almxheader/flags.md)
- [var LastGlyph: UInt16](almxheader/lastglyph.md)
- [var NMasters: UInt16](almxheader/nmasters.md)
- [var Version: Fixed](almxheader/version.md)
- [var lookup: SFNTLookupTable](almxheader/lookup.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/almxheader)*