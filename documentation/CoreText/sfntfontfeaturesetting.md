...
### Initializers
- [init()](sfntfontfeaturesetting/init.md)
- [init(setting: UInt16, nameID: Int16)](sfntfontfeaturesetting/init(setting:nameid:).md)
### Instance Properties
- [var nameID: Int16](sfntfontfeaturesetting/nameid.md)
- [var setting: UInt16](sfntfontfeaturesetting/setting.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/sfntfontfeaturesetting)*