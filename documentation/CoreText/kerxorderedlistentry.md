...
### Initializers
- [init()](kerxorderedlistentry/init.md)
- [init(pair: KerxKerningPair, value: KernKerningValue)](kerxorderedlistentry/init(pair:value:).md)
### Instance Properties
- [var pair: KerxKerningPair](kerxorderedlistentry/pair.md)
- [var value: KernKerningValue](kerxorderedlistentry/value.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/kerxorderedlistentry)*