...
Unregistered fonts are no longer discoverable through font descriptor matching. Fonts that are backed by files should be unregistered using [`CTFontManagerUnregisterFontsForURL(_:_:_:)`](ctfontmanagerunregisterfontsforurl(_:_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/ctfontmanagerunregistergraphicsfont(_:_:))*