...
### Initializers
- [init()](sfntlookuparrayheader/init.md)
- [init(lookupValues: SFNTLookupValue)](sfntlookuparrayheader/init(lookupvalues:).md)
### Instance Properties
- [var lookupValues: SFNTLookupValue](sfntlookuparrayheader/lookupvalues.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/sfntlookuparrayheader)*