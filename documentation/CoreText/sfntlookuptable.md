...
### Initializers
- [init()](sfntlookuptable/init.md)
- [init(format: SFNTLookupTableFormat, fsHeader: SFNTLookupFormatSpecificHeader)](sfntlookuptable/init(format:fsheader:).md)
### Instance Properties
- [var format: SFNTLookupTableFormat](sfntlookuptable/format.md)
- [var fsHeader: SFNTLookupFormatSpecificHeader](sfntlookuptable/fsheader.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/sfntlookuptable)*