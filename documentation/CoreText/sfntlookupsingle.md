...
### Initializers
- [init()](sfntlookupsingle/init.md)
- [init(glyph: UInt16, value: UInt16)](sfntlookupsingle/init(glyph:value:).md)
### Instance Properties
- [var glyph: UInt16](sfntlookupsingle/glyph.md)
- [var value: UInt16](sfntlookupsingle/value.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/sfntlookupsingle)*