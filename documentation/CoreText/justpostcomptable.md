...
### Initializers
- [init()](justpostcomptable/init.md)
- [init(lookupTable: SFNTLookupTable)](justpostcomptable/init(lookuptable:).md)
### Instance Properties
- [var lookupTable: SFNTLookupTable](justpostcomptable/lookuptable.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/justpostcomptable)*