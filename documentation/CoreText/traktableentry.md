...
### Initializers
- [init()](traktableentry/init.md)
- [init(track: Fixed, nameTableIndex: UInt16, sizesOffset: UInt16)](traktableentry/init(track:nametableindex:sizesoffset:).md)
### Instance Properties
- [var nameTableIndex: UInt16](traktableentry/nametableindex.md)
- [var sizesOffset: UInt16](traktableentry/sizesoffset.md)
- [var track: Fixed](traktableentry/track.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/traktableentry)*