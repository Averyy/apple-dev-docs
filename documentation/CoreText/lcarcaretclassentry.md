...
### Initializers
- [init()](lcarcaretclassentry/init.md)
- [init(count: UInt16, partials: UInt16)](lcarcaretclassentry/init(count:partials:).md)
### Instance Properties
- [var count: UInt16](lcarcaretclassentry/count.md)
- [var partials: UInt16](lcarcaretclassentry/partials.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/lcarcaretclassentry)*