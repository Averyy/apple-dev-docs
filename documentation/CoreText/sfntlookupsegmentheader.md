...
### Initializers
- [init()](sfntlookupsegmentheader/init.md)
- [init(binSearch: SFNTLookupBinarySearchHeader, segments: SFNTLookupSegment)](sfntlookupsegmentheader/init(binsearch:segments:).md)
### Instance Properties
- [var binSearch: SFNTLookupBinarySearchHeader](sfntlookupsegmentheader/binsearch.md)
- [var segments: SFNTLookupSegment](sfntlookupsegmentheader/segments.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/sfntlookupsegmentheader)*