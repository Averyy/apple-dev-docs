...
### Initializers
- [init()](sfntfeaturename/init.md)
- [init(featureType: UInt16, settingCount: UInt16, offsetToSettings: Int32, featureFlags: UInt16, nameID: Int16)](sfntfeaturename/init(featuretype:settingcount:offsettosettings:featureflags:nameid:).md)
### Instance Properties
- [var featureFlags: UInt16](sfntfeaturename/featureflags.md)
- [var featureType: UInt16](sfntfeaturename/featuretype.md)
- [var nameID: Int16](sfntfeaturename/nameid.md)
- [var offsetToSettings: Int32](sfntfeaturename/offsettosettings.md)
- [var settingCount: UInt16](sfntfeaturename/settingcount.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/sfntfeaturename)*