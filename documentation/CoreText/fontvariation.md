...
### Initializers
- [init()](fontvariation/init.md)
- [init(name: FourCharCode, value: Fixed)](fontvariation/init(name:value:).md)
### Instance Properties
- [var name: FourCharCode](fontvariation/name.md)
- [var value: Fixed](fontvariation/value.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/fontvariation)*