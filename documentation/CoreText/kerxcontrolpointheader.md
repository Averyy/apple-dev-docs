...
### Initializers
- [init()](kerxcontrolpointheader/init.md)
- [init(header: STXHeader, flags: UInt32, firstTable: UInt8)](kerxcontrolpointheader/init(header:flags:firsttable:).md)
### Instance Properties
- [var firstTable: UInt8](kerxcontrolpointheader/firsttable.md)
- [var flags: UInt32](kerxcontrolpointheader/flags.md)
- [var header: STXHeader](kerxcontrolpointheader/header.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/kerxcontrolpointheader)*