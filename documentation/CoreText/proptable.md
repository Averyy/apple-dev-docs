...
### Initializers
- [init()](proptable/init.md)
- [init(version: Fixed, format: UInt16, defaultProps: PropCharProperties, lookup: SFNTLookupTable)](proptable/init(version:format:defaultprops:lookup:).md)
### Instance Properties
- [var defaultProps: PropCharProperties](proptable/defaultprops.md)
- [var format: UInt16](proptable/format.md)
- [var lookup: SFNTLookupTable](proptable/lookup.md)
- [var version: Fixed](proptable/version.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/proptable)*