...
### Initializers
- [init()](kernstateheader/init.md)
- [init(header: STHeader, valueTable: UInt16, firstTable: UInt8)](kernstateheader/init(header:valuetable:firsttable:).md)
### Instance Properties
- [var firstTable: UInt8](kernstateheader/firsttable.md)
- [var header: STHeader](kernstateheader/header.md)
- [var valueTable: UInt16](kernstateheader/valuetable.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/kernstateheader)*