...
### Initializers
- [init()](justpcductilityaction/init.md)
- [init(ductilityAxis: UInt32, minimumLimit: Fixed, noStretchValue: Fixed, maximumLimit: Fixed)](justpcductilityaction/init(ductilityaxis:minimumlimit:nostretchvalue:maximumlimit:).md)
### Instance Properties
- [var ductilityAxis: UInt32](justpcductilityaction/ductilityaxis.md)
- [var maximumLimit: Fixed](justpcductilityaction/maximumlimit.md)
- [var minimumLimit: Fixed](justpcductilityaction/minimumlimit.md)
- [var noStretchValue: Fixed](justpcductilityaction/nostretchvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/justpcductilityaction)*