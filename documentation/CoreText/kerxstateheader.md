...
### Initializers
- [init()](kerxstateheader/init.md)
- [init(header: STXHeader, valueTable: UInt32, firstTable: UInt8)](kerxstateheader/init(header:valuetable:firsttable:).md)
### Instance Properties
- [var firstTable: UInt8](kerxstateheader/firsttable.md)
- [var header: STXHeader](kerxstateheader/header.md)
- [var valueTable: UInt32](kerxstateheader/valuetable.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/kerxstateheader)*