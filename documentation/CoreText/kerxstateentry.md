...
### Initializers
- [init()](kerxstateentry/init.md)
- [init(newState: UInt16, flags: UInt16, valueIndex: UInt16)](kerxstateentry/init(newstate:flags:valueindex:).md)
### Instance Properties
- [var flags: UInt16](kerxstateentry/flags.md)
- [var newState: UInt16](kerxstateentry/newstate.md)
- [var valueIndex: UInt16](kerxstateentry/valueindex.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/kerxstateentry)*