...
### Initializers
- [init()](kernsubtableheader/init.md)
- [init(length: Int32, stInfo: KernSubtableInfo, tupleIndex: Int16, fsHeader: KernFormatSpecificHeader)](kernsubtableheader/init(length:stinfo:tupleindex:fsheader:).md)
### Instance Properties
- [var fsHeader: KernFormatSpecificHeader](kernsubtableheader/fsheader.md)
- [var length: Int32](kernsubtableheader/length.md)
- [var stInfo: KernSubtableInfo](kernsubtableheader/stinfo.md)
- [var tupleIndex: Int16](kernsubtableheader/tupleindex.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/kernsubtableheader)*