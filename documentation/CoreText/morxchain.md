...
### Initializers
- [init()](morxchain/init.md)
- [init(defaultFlags: MortSubtableMaskFlags, length: UInt32, nFeatures: UInt32, nSubtables: UInt32, featureEntries: MortFeatureEntry)](morxchain/init(defaultflags:length:nfeatures:nsubtables:featureentries:).md)
### Instance Properties
- [var defaultFlags: MortSubtableMaskFlags](morxchain/defaultflags.md)
- [var featureEntries: MortFeatureEntry](morxchain/featureentries.md)
- [var length: UInt32](morxchain/length.md)
- [var nFeatures: UInt32](morxchain/nfeatures.md)
- [var nSubtables: UInt32](morxchain/nsubtables.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/morxchain)*