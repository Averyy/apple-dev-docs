...
### Initializers
- [init()](sfntlookupsingleheader/init.md)
- [init(binSearch: SFNTLookupBinarySearchHeader, entries: SFNTLookupSingle)](sfntlookupsingleheader/init(binsearch:entries:).md)
### Instance Properties
- [var binSearch: SFNTLookupBinarySearchHeader](sfntlookupsingleheader/binsearch.md)
- [var entries: SFNTLookupSingle](sfntlookupsingleheader/entries.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/sfntlookupsingleheader)*