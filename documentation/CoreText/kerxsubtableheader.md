...
### Initializers
- [init()](kerxsubtableheader/init.md)
- [init(length: UInt32, stInfo: KerxSubtableCoverage, tupleCount: UInt32, fsHeader: KerxFormatSpecificHeader)](kerxsubtableheader/init(length:stinfo:tuplecount:fsheader:).md)
### Instance Properties
- [var fsHeader: KerxFormatSpecificHeader](kerxsubtableheader/fsheader.md)
- [var length: UInt32](kerxsubtableheader/length.md)
- [var stInfo: KerxSubtableCoverage](kerxsubtableheader/stinfo.md)
- [var tupleCount: UInt32](kerxsubtableheader/tuplecount.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/kerxsubtableheader)*