...
### Initializers
- [init()](proplookupsegment/init.md)
- [init(lastGlyph: UInt16, firstGlyph: UInt16, value: UInt16)](proplookupsegment/init(lastglyph:firstglyph:value:).md)
### Instance Properties
- [var firstGlyph: UInt16](proplookupsegment/firstglyph.md)
- [var lastGlyph: UInt16](proplookupsegment/lastglyph.md)
- [var value: UInt16](proplookupsegment/value.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/proplookupsegment)*