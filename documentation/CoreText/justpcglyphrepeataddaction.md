...
### Initializers
- [init()](justpcglyphrepeataddaction/init.md)
- [init(flags: UInt16, glyph: UInt16)](justpcglyphrepeataddaction/init(flags:glyph:).md)
### Instance Properties
- [var flags: UInt16](justpcglyphrepeataddaction/flags.md)
- [var glyph: UInt16](justpcglyphrepeataddaction/glyph.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/justpcglyphrepeataddaction)*