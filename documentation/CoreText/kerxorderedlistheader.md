...
### Initializers
- [init()](kerxorderedlistheader/init.md)
- [init(nPairs: UInt32, searchRange: UInt32, entrySelector: UInt32, rangeShift: UInt32, table: UInt32)](kerxorderedlistheader/init(npairs:searchrange:entryselector:rangeshift:table:).md)
### Instance Properties
- [var entrySelector: UInt32](kerxorderedlistheader/entryselector.md)
- [var nPairs: UInt32](kerxorderedlistheader/npairs.md)
- [var rangeShift: UInt32](kerxorderedlistheader/rangeshift.md)
- [var searchRange: UInt32](kerxorderedlistheader/searchrange.md)
- [var table: UInt32](kerxorderedlistheader/table.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/kerxorderedlistheader)*