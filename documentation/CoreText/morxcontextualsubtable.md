...
### Initializers
- [init()](morxcontextualsubtable/init.md)
- [init(header: STXHeader, substitutionTableOffset: UInt32)](morxcontextualsubtable/init(header:substitutiontableoffset:).md)
### Instance Properties
- [var header: STXHeader](morxcontextualsubtable/header.md)
- [var substitutionTableOffset: UInt32](morxcontextualsubtable/substitutiontableoffset.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/morxcontextualsubtable)*