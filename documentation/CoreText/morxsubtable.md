...
### Initializers
- [init()](morxsubtable/init.md)
- [init(length: UInt32, coverage: UInt32, flags: MortSubtableMaskFlags, u: MorxSpecificSubtable)](morxsubtable/init(length:coverage:flags:u:).md)
### Instance Properties
- [var coverage: UInt32](morxsubtable/coverage.md)
- [var flags: MortSubtableMaskFlags](morxsubtable/flags.md)
- [var length: UInt32](morxsubtable/length.md)
- [var u: MorxSpecificSubtable](morxsubtable/u.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretext/morxsubtable)*