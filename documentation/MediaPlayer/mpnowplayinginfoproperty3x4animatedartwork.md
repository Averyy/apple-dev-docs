...
```swift
let MPNowPlayingInfoProperty3x4AnimatedArtwork: String
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/mediaplayer/mpnowplayinginfoproperty3x4animatedartwork)*