...
### Constants
- [let MPMoviePlayerFullscreenAnimationDurationUserInfoKey: String](mpmovieplayerfullscreenanimationdurationuserinfokey.md)
- [let MPMoviePlayerFullscreenAnimationCurveUserInfoKey: String](mpmovieplayerfullscreenanimationcurveuserinfokey.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/mediaplayer/fullscreen-notification-keys)*