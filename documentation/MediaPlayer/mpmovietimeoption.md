...
### Constants
- [MPMovieTimeOption.nearestKeyFrame](mpmovietimeoption/nearestkeyframe.md)
- [MPMovieTimeOption.exact](mpmovietimeoption/exact.md)
### Initializers
- [init?(rawValue: Int)](mpmovietimeoption/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/mediaplayer/mpmovietimeoption)*