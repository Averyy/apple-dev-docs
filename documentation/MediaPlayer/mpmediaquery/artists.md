...
A media item can have more than one media type; for example, an item could be of types “music” and “podcast.” An [`artists()`](mpmediaquery/artists().md) query matches all [`music`](mpmediatype/music.md) items, whether or not they’re also of other media types.
...
*[View on Apple Developer](https://developer.apple.com/documentation/mediaplayer/mpmediaquery/artists())*