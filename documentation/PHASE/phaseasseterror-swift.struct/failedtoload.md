...
```swift
static var failedToLoad: PHASEAssetError.Code { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/phase/phaseasseterror-swift.struct/failedtoload)*