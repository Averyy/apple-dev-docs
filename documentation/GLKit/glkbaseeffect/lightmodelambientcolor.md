...
```swift
var lightModelAmbientColor: GLKVector4 { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/glkit/glkbaseeffect/lightmodelambientcolor)*