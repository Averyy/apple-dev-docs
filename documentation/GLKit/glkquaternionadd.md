...
- `quaternionLeft`: The first quaternion.
- `quaternionRight`: The second quaternion.
...
*[View on Apple Developer](https://developer.apple.com/documentation/glkit/glkquaternionadd(_:_:))*