# GLKVertexAttributeParametersFromModelIO(_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/glkit/glkvertexattributeparametersfrommodelio(_:))*