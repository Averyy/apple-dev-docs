...
**Availability**:
- External Purchase Server API 1.2+
...
*[View on Apple Developer](https://developer.apple.com/documentation/externalpurchaseserverapi/duplicatetokenstatusnotallowederror)*