...
**Availability**:
- External Purchase Server API 1.1+
...
*[View on Apple Developer](https://developer.apple.com/documentation/externalpurchaseserverapi/restatementnotallowedcreationdateerror)*