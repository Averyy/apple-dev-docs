...
```swift
@IBOutlet
unowned(unsafe) var backgroundImageConstraint: NSLayoutConstraint! { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetoothui/iobluetoothpasskeydisplay/backgroundimageconstraint)*