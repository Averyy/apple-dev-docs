...
```swift
var returnHighlightImage: NSImage! { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetoothui/iobluetoothpasskeydisplay/returnhighlightimage)*