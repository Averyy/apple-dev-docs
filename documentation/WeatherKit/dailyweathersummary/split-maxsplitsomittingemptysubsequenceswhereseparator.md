...
*[View on Apple Developer](https://developer.apple.com/documentation/weatherkit/dailyweathersummary/split(maxsplits:omittingemptysubsequences:whereseparator:))*