...
*[View on Apple Developer](https://developer.apple.com/documentation/weatherkit/dailyweatherstatistics/split(maxsplits:omittingemptysubsequences:whereseparator:))*