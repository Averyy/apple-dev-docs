...
```swift
var combinedMarkLightURL: URL { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/weatherkit/weatherattribution/combinedmarklighturl)*