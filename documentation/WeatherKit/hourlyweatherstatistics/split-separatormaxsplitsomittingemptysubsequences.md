...
*[View on Apple Developer](https://developer.apple.com/documentation/weatherkit/hourlyweatherstatistics/split(separator:maxsplits:omittingemptysubsequences:))*