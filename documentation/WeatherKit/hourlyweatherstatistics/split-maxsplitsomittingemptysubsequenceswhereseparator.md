...
*[View on Apple Developer](https://developer.apple.com/documentation/weatherkit/hourlyweatherstatistics/split(maxsplits:omittingemptysubsequences:whereseparator:))*