...
![A foreground watchOS app showing the user’s name, account number, and balance.](/images/com.apple.watchOS-Apps/designing-your-app-for-the-always-on-state-1@2x.png)

But the interface obscures sensitive data, such as the account number and balance, when the app is in the Always On state.

![A watchOS app in Always On, with the account number obscured and the balance removed.](/images/com.apple.watchOS-Apps/designing-your-app-for-the-always-on-state-2@2x.png)
...
![The Numerals Duo watch face in Always On, showing strong outlines and dimmed fills for the large numbers.](/images/com.apple.watchOS-Apps/designing-your-app-for-the-always-on-state-3@2x.png)
...
![A watchOS app running in the foreground. It shows a large, white title, status text, and a button.](/images/com.apple.watchOS-Apps/designing-your-app-for-the-always-on-state-4@2x.png)
...
![A watchOS app running in Always On. The app dims the title, but the appearance of the status text and button don’t changed.](/images/com.apple.watchOS-Apps/designing-your-app-for-the-always-on-state-5@2x.png)
...
![The regular and Always On previews in Xcode’s canvas.](/images/com.apple.watchOS-Apps/designing-your-app-for-the-always-on-state-6@2x.png)
...
![A screenshot of a 44 mm watch face in the Xcode simulator. The Toggle Always On button is highlighted in the tool bar above the image of the watch face.](/images/com.apple.watchOS-Apps/designing-your-app-for-the-always-on-state-7@2x.png)
