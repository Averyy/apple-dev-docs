...
```swift
static var removingStream: SCStreamError.Code { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/screencapturekit/scstreamerror/removingstream)*