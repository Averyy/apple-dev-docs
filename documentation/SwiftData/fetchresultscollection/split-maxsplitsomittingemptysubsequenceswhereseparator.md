...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftdata/fetchresultscollection/split(maxsplits:omittingemptysubsequences:whereseparator:))*