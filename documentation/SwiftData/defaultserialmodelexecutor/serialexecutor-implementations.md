...
- [func isIsolatingCurrentContext() -> Bool?](defaultserialmodelexecutor/isisolatingcurrentcontext-1ducg.md)
  Checks if the current execution context is isolated by this executor.
- [func isIsolatingCurrentContext() -> Bool](defaultserialmodelexecutor/isisolatingcurrentcontext-4bh1o.md)
  Checks if the current execution context is isolated by this executor.
