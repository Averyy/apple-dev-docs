...
- [var configuration: SymbolEffectConfiguration](automaticsymboleffect/configuration.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/symbols/automaticsymboleffect)*