...
- `count`: The preferred number of times to play the effect, or   to request the default number of repeats. The function may clamp very large or small values.
...
*[View on Apple Developer](https://developer.apple.com/documentation/symbols/symboleffectoptions/repeat(_:)-314sv)*