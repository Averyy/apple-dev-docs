...
### Initializers
- [init?(rawValue: Int)](iclegacyreturn/code/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/imagecapturecore/iclegacyreturn/code)*