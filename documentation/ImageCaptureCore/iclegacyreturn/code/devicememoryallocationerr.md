# ICLegacyReturn.Code.deviceMemoryAllocationErr
...
```swift
case deviceMemoryAllocationErr
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/imagecapturecore/iclegacyreturn/code/devicememoryallocationerr)*