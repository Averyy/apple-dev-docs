# ICLegacyReturn.Code.deviceLocationIDNotFoundErr
...
```swift
case deviceLocationIDNotFoundErr
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/imagecapturecore/iclegacyreturn/code/devicelocationidnotfounderr)*