...
Cancels the scan in progress by calling [`requestOverviewScan()`](icscannerdevice/requestoverviewscan().md) or [`requestScan()`](icscannerdevice/requestscan().md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/imagecapturecore/icscannerdevice/cancelscan())*