...
![An Xcode screenshot showing the Build Settings for a project target, highlighting the Produce Debugging Information setting with the Debug entry set to Yes, include source code.](/images/com.apple.Xcode/gputools-metal-debugger-se-include-sources@2x.png)
