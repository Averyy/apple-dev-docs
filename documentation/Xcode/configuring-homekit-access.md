...
![A screenshot of a target’s Info.plist file open in Xcode’s Property List Editor. The file contains the Privacy - HomeKit Usage Description key and an example purpose string as its value.](/images/com.apple.Xcode/homekit-purpose-string@2x.png)
...
![A screenshot of Finder showing the contents of the Hardware folder from the downloaded disk image. The HomeKit Accessory Simulator is in a selected state.](/images/com.apple.Xcode/homekit-simulator@2x.png)
