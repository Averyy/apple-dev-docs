...
![An outline of a crash report that shows where the exception information and backtraces are located.](/images/com.apple.Xcode/identifying-the-cause-of-common-crashes-1@2x.png)
...
> ❗ **Important**: Before looking for specific patterns, verify that you have a fully symbolicated crash report generated by the operating system. See [`Determine whether a crash report is symbolicated`](adding-identifiable-symbol-names-to-a-crash-report#Determine-whether-a-crash-report-is-symbolicated.md).
