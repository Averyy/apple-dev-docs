...
Before looking for specific patterns, verify that you have a fully symbolicated crash report generated by the operating system. See [`Determine if a crash report is symbolicated`](adding-identifiable-symbol-names-to-a-crash-report#Determine-if-a-crash-report-is-symbolicated.md).
