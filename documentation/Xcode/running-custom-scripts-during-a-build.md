...
> **Note**: If your script compiles or converts one or more input files to a different format, considering creating a build rule for your files instead. For more information, see [`Creating build rules for custom file types`](creating-build-rules-for-custom-file-types.md).
...
> **Note**: To rename a script phase, double-click the Run Script title to edit it.
