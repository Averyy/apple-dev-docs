...
![A screenshot of the Camera Properties popover in the Geometry viewer with the projection matrix controls highlighted.](/images/com.apple.Xcode/gputools-metal-debugger-gv-camera-options@2x.png)
...
![A screenshot of the Geometry viewer displaying the geometry in the scene view and listing the vertices in the table. The selected vertex and its siblings are highlighted in the scene view and in the table.](/images/com.apple.Xcode/gputools-metal-debugger-gv-rotate@2x.png)
...
![A screenshot of the context menu for the scene view with the Visualize Vertex Attribute menu item highlighted and the Normal Values submenu selected.](/images/com.apple.Xcode/gputools-metal-debugger-gv-visualize-attribute@2x.png)
...
![A screenshot of the Geometry viewer displaying the geometry in the scene view and listing the vertices in the table. The selected vertex and its siblings are highlighted in the scene view and in the table.](/images/com.apple.Xcode/gputools-metal-debugger-gv-vertex-selection@2x.png)
...
![A screenshot of the Metal debugger showing the Shader editor and the Geometry viewer side by side. A vertex is highlighted in the Geometry viewer, and the Debug button in the control bar is highlighted.](/images/com.apple.Xcode/gputools-metal-debugger-gv-shader-debugger@2x.png)
