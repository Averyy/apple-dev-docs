...
> ❗ **Important**: Media Device Discovery Extension is deprecated in iOS 27.0 and visionOS 27.0. Refer to [`Routing and streaming media to remote devices`](https://developer.apple.com/documentation/avsystemrouting/routing-and-streaming-media-to-remote-devices) for device discovery.
...
![A screenshot of Xcode’s Capabilities library. The Media Device Discovery capability is in a selected state.](/images/com.apple.Xcode/media-device-discovery@2x.png)
