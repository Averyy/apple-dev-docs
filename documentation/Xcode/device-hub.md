...
![A screenshot of the Device Hub expanded window showing the sidebar on the left with available devices, the canvas in the middle running an iPhone simulator, and the inspector on the right showing an app installed.](https://docs-assets.developer.apple.com/published/9959a3c90b3ab29fce23f0158ec8ebee/device-hub-anatomy%402x.png)
...
*[View on Apple Developer](https://developer.apple.com/documentation/xcode/device-hub)*