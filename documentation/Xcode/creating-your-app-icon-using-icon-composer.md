...
![A screenshot of the sidebar on the left and canvas on the right with a group selected.](/images/com.apple.Xcode/icon-composer-layer-position-scale-group@2x.png)
