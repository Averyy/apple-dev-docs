...
![A screenshot of the Counters viewer, consisting of a counters timeline and a table for either passes or commands.](/images/com.apple.Xcode/gputools-metal-debugger-cg-overview@2x.png)
...
![A screenshot of the per-pass counters timeline. The pass with the longest shader GPU time is selected.](/images/com.apple.Xcode/gputools-metal-debugger-cg-gpu-time@2x.png)
...
![A screenshot of the Adjust Editor Options menu highlighting the Assistant menu item.](/images/com.apple.Xcode/gputools-metal-debugger-cg-menu-enable-assistant-editor@2x.png)
...
![A screenshot of the assistant editor drop-down menu highlighting the Performance menu item.](/images/com.apple.Xcode/gputools-metal-debugger-ct-assistant-menu-performance@2x.png)
...
![A screenshot of the Metal debugger showing the Counters viewer and the Performance Statistics viewer side by side.](/images/com.apple.Xcode/gputools-metal-debugger-cg-performance@2x.png)
...
![A screenshot of the assistant editor drop-down menu highlighting the Pipeline Statistics menu item.](/images/com.apple.Xcode/gputools-metal-debugger-ct-assistant-menu-pipeline-statistics@2x.png)
...
![A screenshot of the Metal debugger showing the Counters viewer and the Pipeline Statistics viewer side by side.](/images/com.apple.Xcode/gputools-metal-debugger-cg-pipeline-statistics@2x.png)
