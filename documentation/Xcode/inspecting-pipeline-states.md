...
![A screenshot of the Pipeline State viewer displaying the pipeline state’s properties hierarchically.](/images/com.apple.Xcode/gputools-metal-debugger-psov-overview@2x.png)
...
![A screenshot of the Pipeline State viewer filtering for the term pixel. The list displays the matching properties hierarchically.](/images/com.apple.Xcode/gputools-metal-debugger-psov-filter@2x.png)
