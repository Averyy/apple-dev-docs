...
![A screenshot of the Apple Pay capability after you add it to your target. The Merchant IDs list contains two existing merchant IDs, neither of which are in an enabled state.](/images/com.apple.Xcode/fetched-merchant-ids@2x.png)
...
![A screenshot of the Apple Pay capability after you add it to your target. The Merchant IDs list contains three merchant IDs, and the new merchant ID is in an enabled state.](/images/com.apple.Xcode/selected-merchant-id@2x.png)
