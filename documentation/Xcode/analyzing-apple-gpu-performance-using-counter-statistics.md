...
![A screenshot of the Performance counters displaying per-pass performance limiters counters.](/images/com.apple.Xcode/gputools-metal-debugger-ct-overview@2x.png)
...
![A screenshot of the Adjust Editor Options menu highlighting the Assistant menu item.](/images/com.apple.Xcode/gputools-metal-debugger-ct-menu-enable-assistant-editor@2x.png)
...
![A screenshot of the Metal debugger showing the Performance counters and the Performance Statistics viewer side by side.](/images/com.apple.Xcode/gputools-metal-debugger-ct-performance@2x.png)
...
![A screenshot of the Metal debugger showing the Performance counters and the Pipeline Statistics viewer side by side.](/images/com.apple.Xcode/gputools-metal-debugger-ct-pipeline-statistics@2x.png)
