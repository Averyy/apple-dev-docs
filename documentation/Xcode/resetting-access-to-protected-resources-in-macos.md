...
- **`FileProviderPresence`**: To reset access for a file provider to determine which files the person is accessing. Privacy usage description key: `NSFileProviderPresenceUsageDescription`.
...
- **`SystemPolicyAppBundles`**: To reset access to app bundles. Privacy usage description key: `NSAppBundlesUsageDescription`.
