...
- [Testing a beta OS](testing-a-beta-os.md)
  Manage unintended differences in your app by testing beta operating-system (OS) releases.
### Feedback
- [Viewing and responding to feedback from beta testers](viewing-and-responding-to-feedback.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/xcode/distribution)*