...
![A screenshot of Xcode’s Capabilities library. The Keychain Sharing capability is in a selected state.](/images/com.apple.Xcode/keychain-sharing@2x.png)
...
![A screenshot of the Keychain Sharing capability after you add it to your target. The keychain groups list contains a single group.](/images/com.apple.Xcode/keychain-groups@2x.png)
...
![A screenshot of an app’s entitlements file open in Xcode’s plist editor. The Keychain Access Groups key is in an expanded state and contains two items, each representing a different keychain group.](/images/com.apple.Xcode/keychain-groups-plist@2x.png)
