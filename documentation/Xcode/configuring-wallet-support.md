...
![A screenshot of the Wallet capability after you add it to an app’s target. The Allow subset of pass types option is in an enabled state, as are two of the three listed pass type identifiers.](/images/com.apple.Xcode/subset-of-pass-types@2x.png)
