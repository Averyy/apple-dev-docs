...
*[View on Apple Developer](https://developer.apple.com/documentation/system/filepath/componentview/split(maxsplits:omittingemptysubsequences:whereseparator:))*