...
```swift
subscript(position: FilePath.ComponentView.Index) -> FilePath.Component { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/system/filepath/componentview/subscript(_:))*