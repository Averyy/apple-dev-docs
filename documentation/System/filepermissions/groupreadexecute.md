...
```swift
static var groupReadExecute: FilePermissions { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/system/filepermissions/groupreadexecute)*