...
```swift
static var otherReadExecute: FilePermissions { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/system/filepermissions/otherreadexecute)*