...
This method returns an error if `PSTATE.ZA` is `0` (for example, when [`za_storage_enabled`](hv_vcpu_sme_state_t/za_storage_enabled.md) is `false`).
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_vcpu_get_sme_zt0_reg(_:_:))*