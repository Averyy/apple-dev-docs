...
### Initializers
- [init(UInt16)](hv_gic_distributor_reg_t/init(_:).md)
- [init(rawValue: UInt16)](hv_gic_distributor_reg_t/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt16](hv_gic_distributor_reg_t/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_gic_distributor_reg_t)*