...
```swift
func hv_vm_atpic_deassert_irq(_ irq: Int32) -> hv_return_t
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_vm_atpic_deassert_irq(_:))*