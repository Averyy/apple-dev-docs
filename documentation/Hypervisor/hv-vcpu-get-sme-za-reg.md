...
```swift
func hv_vcpu_get_sme_za_reg(_ vcpu: hv_vcpu_t, _ value: UnsafeMutablePointer<UInt8>, _ length: Int) -> hv_return_t
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_vcpu_get_sme_za_reg(_:_:_:))*