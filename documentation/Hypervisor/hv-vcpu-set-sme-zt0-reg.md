...
```swift
func hv_vcpu_set_sme_zt0_reg(_ vcpu: hv_vcpu_t, _ value: UnsafePointer<hv_sme_zt0_uchar64_t>) -> hv_return_t
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_vcpu_set_sme_zt0_reg(_:_:))*