...
```swift
var GUEST_INTRBILITY_NMI_BLOCKING: UInt64 { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/guest_intrbility_nmi_blocking)*