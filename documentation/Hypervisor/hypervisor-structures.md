...
- [struct hv_ioapic_state](hv_ioapic_state.md)
- [struct hv_ioapic_state_ext_t](hv_ioapic_state_ext_t.md)
- [struct hv_sme_p_reg_t](hv_sme_p_reg_t.md)
- [struct hv_sme_z_reg_t](hv_sme_z_reg_t.md)
- [struct hv_vcpu_sme_state_t](hv_vcpu_sme_state_t.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hypervisor-structures)*