...
```swift
var HV_FEATURE_REG_ID_AA64MMFR0_EL1: hv_feature_reg_t { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_feature_reg_id_aa64mmfr0_el1)*