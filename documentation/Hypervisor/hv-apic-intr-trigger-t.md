...
### Initializers
- [init(UInt32)](hv_apic_intr_trigger_t/init(_:).md)
- [init(rawValue: UInt32)](hv_apic_intr_trigger_t/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](hv_apic_intr_trigger_t/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_apic_intr_trigger_t)*