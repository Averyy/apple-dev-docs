...
```swift
var HV_GIC_ICV_REG_BPR1_EL1: hv_gic_icv_reg_t { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_gic_icv_reg_bpr1_el1)*