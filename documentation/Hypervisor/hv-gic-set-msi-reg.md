...
```swift
func hv_gic_set_msi_reg(_ reg: hv_gic_msi_reg_t, _ value: UInt64) -> hv_return_t
```
...
- `reg`: The enumeration value that represents the GIC distributor MSI register.
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_gic_set_msi_reg(_:_:))*