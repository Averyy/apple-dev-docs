...
```swift
func hv_vcpu_apic_get_state(_ vcpu: hv_vcpuid_t, _ state: UnsafeMutablePointer<hv_apic_state_ext_t>) -> hv_return_t
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_vcpu_apic_get_state(_:_:))*