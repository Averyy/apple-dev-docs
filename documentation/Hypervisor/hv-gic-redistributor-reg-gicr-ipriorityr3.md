# HV_GIC_REDISTRIBUTOR_REG_GICR_IPRIORITYR3
...
```swift
var HV_GIC_REDISTRIBUTOR_REG_GICR_IPRIORITYR3: hv_gic_redistributor_reg_t { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_gic_redistributor_reg_gicr_ipriorityr3)*