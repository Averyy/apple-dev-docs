...
### Initializers
- [init(UInt32)](hv_gic_redistributor_reg_t/init(_:).md)
- [init(rawValue: UInt32)](hv_gic_redistributor_reg_t/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](hv_gic_redistributor_reg_t/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_gic_redistributor_reg_t)*