...
```swift
func hv_vm_ioapic_read(_ gpa: hv_gpaddr_t, _ datap: UnsafeMutablePointer<UInt32>) -> hv_return_t
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_vm_ioapic_read(_:_:))*