...
```swift
var HV_MSR_IA32_PERF_GLOBAL_STATUS: UInt32 { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_msr_ia32_perf_global_status)*