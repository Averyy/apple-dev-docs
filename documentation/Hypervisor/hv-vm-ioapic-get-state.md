...
```swift
func hv_vm_ioapic_get_state(_ state: UnsafeMutablePointer<hv_ioapic_state_ext_t>) -> hv_return_t
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_vm_ioapic_get_state(_:))*