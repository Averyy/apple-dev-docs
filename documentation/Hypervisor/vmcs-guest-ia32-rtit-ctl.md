...
```swift
var VMCS_GUEST_IA32_RTIT_CTL: Int { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/vmcs_guest_ia32_rtit_ctl)*