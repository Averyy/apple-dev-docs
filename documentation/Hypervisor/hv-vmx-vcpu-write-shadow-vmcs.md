...
- `vcpu`: The vCPU ID.
- `field`: The ID of the shadow VMCS field to write.
- `value`: The value of the shadow VMCS field to write.
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_vmx_vcpu_write_shadow_vmcs(_:_:_:))*