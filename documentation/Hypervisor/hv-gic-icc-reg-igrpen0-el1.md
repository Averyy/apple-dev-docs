...
```swift
var HV_GIC_ICC_REG_IGRPEN0_EL1: hv_gic_icc_reg_t { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_gic_icc_reg_igrpen0_el1)*