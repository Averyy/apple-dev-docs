...
```swift
func hv_vcpu_apic_read(_ vcpu: hv_vcpuid_t, _ offset: UInt32, _ data: UnsafeMutablePointer<UInt32>) -> hv_return_t
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_vcpu_apic_read(_:_:_:))*