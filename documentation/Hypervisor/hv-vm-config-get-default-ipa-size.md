# hv_vm_config_get_default_ipa_size(_:)
...
```swift
func hv_vm_config_get_default_ipa_size(_ ipa_bit_length: UnsafeMutablePointer<UInt32>) -> hv_return_t
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_vm_config_get_default_ipa_size(_:))*