...
### Initializers
- [init()](hv_ioapic_state_ext_t/init.md)
- [init(version: UInt32, state: hv_ioapic_state)](hv_ioapic_state_ext_t/init(version:state:).md)
### Instance Properties
- [var state: hv_ioapic_state](hv_ioapic_state_ext_t/state.md)
- [var version: UInt32](hv_ioapic_state_ext_t/version.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_ioapic_state_ext_t)*