...
```swift
func hv_vm_atpic_get_state(_ state: UnsafeMutablePointer<hv_atpic_state_ext_t>, _ is_primary: Bool) -> hv_return_t
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_vm_atpic_get_state(_:_:))*