...
### Initializers
- [init()](hv_apic_state_ext_t/init.md)
- [init(version: UInt32, state: hv_apic_state)](hv_apic_state_ext_t/init(version:state:).md)
### Instance Properties
- [var state: hv_apic_state](hv_apic_state_ext_t/state.md)
- [var version: UInt32](hv_apic_state_ext_t/version.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_apic_state_ext_t)*