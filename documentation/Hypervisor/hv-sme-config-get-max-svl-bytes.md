# hv_sme_config_get_max_svl_bytes(_:)
...
```swift
func hv_sme_config_get_max_svl_bytes(_ value: UnsafeMutablePointer<Int>) -> hv_return_t
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_sme_config_get_max_svl_bytes(_:))*