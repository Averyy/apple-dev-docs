...
```swift
func hv_vm_ioapic_write(_ gpa: hv_gpaddr_t, _ data: UInt32) -> hv_return_t
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_vm_ioapic_write(_:_:))*