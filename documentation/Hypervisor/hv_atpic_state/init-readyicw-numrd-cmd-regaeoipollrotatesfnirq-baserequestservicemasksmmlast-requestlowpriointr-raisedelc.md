...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_atpic_state/init(ready:icw_num:rd_cmd_reg:aeoi:poll:rotate:sfn:irq_base:request:service:mask:smm:last_request:lowprio:intr_raised:elc:))*