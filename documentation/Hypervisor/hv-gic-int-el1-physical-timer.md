...
```swift
var HV_GIC_INT_EL1_PHYSICAL_TIMER: hv_gic_intid_t { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_gic_int_el1_physical_timer)*