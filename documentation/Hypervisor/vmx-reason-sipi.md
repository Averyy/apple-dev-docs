...
A Startup Inter-Processor Interrupt (SIPI) arrived while the logical processor was in the “wait-for-SIPI” state.
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/vmx_reason_sipi)*