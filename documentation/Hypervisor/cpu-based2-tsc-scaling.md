...
Use the [`hv_vmx_read_capability(_:_:)`](hv_vmx_read_capability(_:_:).md) API to determine the correct setting for this value at run time.
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/cpu_based2_tsc_scaling)*