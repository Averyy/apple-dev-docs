...
```swift
var HV_GIC_ICH_REG_LR6_EL2: hv_gic_ich_reg_t { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_gic_ich_reg_lr6_el2)*