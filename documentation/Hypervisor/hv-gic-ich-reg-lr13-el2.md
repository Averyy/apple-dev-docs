...
```swift
var HV_GIC_ICH_REG_LR13_EL2: hv_gic_ich_reg_t { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_gic_ich_reg_lr13_el2)*