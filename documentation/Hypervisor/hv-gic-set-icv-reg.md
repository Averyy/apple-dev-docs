...
- `reg`: The enumeration value that represents the ICV system register.
- `value`: The GIC ICV register value the framework writes to.
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_gic_set_icv_reg(_:_:_:))*