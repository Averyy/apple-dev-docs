# hv_gic_get_redistributor_base_alignment(_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_gic_get_redistributor_base_alignment(_:))*