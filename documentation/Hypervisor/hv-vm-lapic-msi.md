...
```swift
func hv_vm_lapic_msi(_ addr: UInt64, _ data: UInt64) -> hv_return_t
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_vm_lapic_msi(_:_:))*