# hv_vcpu_apic_lsc_enter_r32(_:_:_:_:_:_:_:_:)
...
```swift
func hv_vcpu_apic_lsc_enter_r32(_ vcpu: hv_vcpuid_t, _ is_load: Bool, _ rip: UInt64, _ ilen: UInt32, _ cs: UInt16, _ reg: hv_x86_reg_t, _ uva: UnsafeMutablePointer<UInt64>?, _ count: UInt32) -> hv_return_t
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_vcpu_apic_lsc_enter_r32(_:_:_:_:_:_:_:_:))*