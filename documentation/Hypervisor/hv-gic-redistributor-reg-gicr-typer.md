...
```swift
var HV_GIC_REDISTRIBUTOR_REG_GICR_TYPER: hv_gic_redistributor_reg_t { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_gic_redistributor_reg_gicr_typer)*