...
```swift
func hv_vm_lapic_set_intr(_ vcpu: hv_vcpuid_t, _ vector: UInt8, _ trig: hv_apic_intr_trigger_t) -> hv_return_t
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_vm_lapic_set_intr(_:_:_:))*