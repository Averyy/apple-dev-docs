...
```swift
func hv_vm_ioapic_deassert_irq(_ intin: Int32) -> hv_return_t
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_vm_ioapic_deassert_irq(_:))*