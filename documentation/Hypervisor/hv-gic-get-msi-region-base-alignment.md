# hv_gic_get_msi_region_base_alignment(_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_gic_get_msi_region_base_alignment(_:))*