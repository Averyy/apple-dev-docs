...
### Initializers
- [init(UInt32)](hv_apic_lvt_flavor_t/init(_:).md)
- [init(rawValue: UInt32)](hv_apic_lvt_flavor_t/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](hv_apic_lvt_flavor_t/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_apic_lvt_flavor_t)*