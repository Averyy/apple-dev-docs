...
### Initializers
- [init(UInt64)](hv_apic_ctrl_t/init(_:).md)
- [init(rawValue: UInt64)](hv_apic_ctrl_t/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt64](hv_apic_ctrl_t/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_apic_ctrl_t)*