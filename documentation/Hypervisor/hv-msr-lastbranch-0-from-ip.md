...
```swift
var HV_MSR_LASTBRANCH_0_FROM_IP: UInt32 { get }
```

#### Discussion

This value represents one of four pairs of last branch records.
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_msr_lastbranch_0_from_ip)*