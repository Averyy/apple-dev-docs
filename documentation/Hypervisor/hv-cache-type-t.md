...
### Initializers
- [init(UInt32)](hv_cache_type_t/init(_:).md)
  Creates a new 32-bit integer that describes a cache element.
- [init(rawValue: UInt32)](hv_cache_type_t/init(rawvalue:).md)
  Creates a new cache element with the unsigned 32-bit integer you provide.
### Instance Properties
- [var rawValue: UInt32](hv_cache_type_t/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_cache_type_t)*