...
```swift
func hv_vm_set_apic_bus_freq(_ freq: UInt64) -> hv_return_t
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_vm_set_apic_bus_freq(_:))*