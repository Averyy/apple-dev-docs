...
```swift
func hv_vcpu_exit_init_ap(_ vcpu: hv_vcpuid_t, _ is_actv: UnsafeMutablePointer<Bool>, _ count: UInt32) -> hv_return_t
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hypervisor/hv_vcpu_exit_init_ap(_:_:_:))*