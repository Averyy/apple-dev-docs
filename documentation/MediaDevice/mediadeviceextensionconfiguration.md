...
```swift
protocol MediaDeviceExtensionConfiguration : AppExtensionConfiguration
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/mediadevice/mediadeviceextensionconfiguration)*