...
Make sure that the value in the `Info.plist` file of your DriverKit extension matches the identifier string you passed to the [`activationRequest(forExtensionWithIdentifier:queue:)`](ossystemextensionrequest/activationrequest(forextensionwithidentifier:queue:).md) method.
...
*[View on Apple Developer](https://developer.apple.com/documentation/systemextensions/ossystemextensionerror/code/extensionmissingidentifier)*