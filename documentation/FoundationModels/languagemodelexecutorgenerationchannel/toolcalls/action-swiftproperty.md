...
```swift
var action: LanguageModelExecutorGenerationChannel.ToolCalls.Action
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundationmodels/languagemodelexecutorgenerationchannel/toolcalls/action-swift.property)*