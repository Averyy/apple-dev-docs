...
```swift
init(dictionaryOf valueSchema: DynamicGenerationSchema)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundationmodels/dynamicgenerationschema/init(dictionaryof:))*