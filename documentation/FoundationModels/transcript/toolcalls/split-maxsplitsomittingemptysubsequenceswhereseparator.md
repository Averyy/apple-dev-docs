...
*[View on Apple Developer](https://developer.apple.com/documentation/foundationmodels/transcript/toolcalls/split(maxsplits:omittingemptysubsequences:whereseparator:))*