...
.DynamicProfileBuilder func body(content: Self.Content) -> Self.Body
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundationmodels/languagemodelsession/dynamicprofilemodifier/body(content:))*