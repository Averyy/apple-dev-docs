...
- [init(any LanguageModelSession.DynamicProfile)](languagemodelsession/anydynamicprofile/init(_:).md)
  Creates an instance from the dynamic profile you specify.
- [init(erasing: some LanguageModelSession.DynamicProfile)](languagemodelsession/anydynamicprofile/init(erasing:).md)
  Creates an instance from the dynamic profile you specify.
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundationmodels/languagemodelsession/anydynamicprofile)*