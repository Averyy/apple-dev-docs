...
- [init(input: LanguageModelSession.Usage.Input, output: LanguageModelSession.Usage.Output, metadata: [String : any ConvertibleToGeneratedContent])](languagemodelsession/usage-swift.struct/init(input:output:metadata:).md)
