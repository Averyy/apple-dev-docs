...
```swift
nonisolated
static var allCases: [LanguageModelFeedbackAttachment.Issue.Category] { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/foundationmodels/languagemodelfeedbackattachment/issue/category/allcases-swift.type.property)*