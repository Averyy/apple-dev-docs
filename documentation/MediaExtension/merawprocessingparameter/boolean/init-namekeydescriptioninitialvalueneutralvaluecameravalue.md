...
*[View on Apple Developer](https://developer.apple.com/documentation/mediaextension/merawprocessingparameter/boolean/init(name:key:description:initialvalue:neutralvalue:cameravalue:))*