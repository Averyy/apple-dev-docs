...
```swift
static var invalidParameter: MEError.Code { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/mediaextension/meerror-swift.struct/invalidparameter)*