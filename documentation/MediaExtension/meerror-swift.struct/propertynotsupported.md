...
```swift
static var propertyNotSupported: MEError.Code { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/mediaextension/meerror-swift.struct/propertynotsupported)*