...
```swift
static var contentProvidingObjectNotAllowed: UNError.Code { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/usernotifications/unerror/contentprovidingobjectnotallowed)*