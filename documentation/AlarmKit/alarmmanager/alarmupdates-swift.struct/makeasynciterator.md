...
```swift
func makeAsyncIterator() -> AlarmManager.AlarmUpdates.Iterator
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/alarmkit/alarmmanager/alarmupdates-swift.struct/makeasynciterator())*