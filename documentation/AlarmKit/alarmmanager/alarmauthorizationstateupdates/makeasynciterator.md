...
```swift
func makeAsyncIterator() -> AlarmManager.AlarmAuthorizationStateUpdates.Iterator
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/alarmkit/alarmmanager/alarmauthorizationstateupdates/makeasynciterator())*