# AlarmManager.AlarmAuthorizationStateUpdates.Element
...
```swift
typealias Element = AlarmManager.AuthorizationState
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/alarmkit/alarmmanager/alarmauthorizationstateupdates/element)*