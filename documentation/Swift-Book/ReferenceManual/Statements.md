...
url: https://github.com/swiftlang/swift-book/blob/main/TSPL.docc/ReferenceManual/Statements.md
---
...
and a `continue` statement and is discussed in [Break Statement](Statements.md#Break-Statement) and
[Continue Statement](Statements.md#Continue-Statement) below.
...
as discussed in [Optional Binding](TheBasics.md#Optional-Binding).
...
and is discussed in [Break Statement](Statements.md#Break-Statement) below.
...
Control transfer statements are discussed in [Control Transfer Statements](Statements.md#Control-Transfer-Statements) below.
For more information on functions with the `Never` return type,
see [Functions that Never Return](Declarations.md#Functions-that-Never-Return).
...
see [Switch](ControlFlow.md#Switch) in [Control Flow](ControlFlow.md).
...
see [frozen](Attributes.md#frozen).
...
see [Fallthrough Statement](Statements.md#Fallthrough-Statement) below.
...
as discussed in [Break Statement](Statements.md#Break-Statement) and
[Continue Statement](Statements.md#Continue-Statement) below.
...
see [Labeled Statements](ControlFlow.md#Labeled-Statements) in [Control Flow](ControlFlow.md).
...
see [Break](ControlFlow.md#Break) and [Labeled Statements](ControlFlow.md#Labeled-Statements)
in [Control Flow](ControlFlow.md).
...
see [Continue](ControlFlow.md#Continue) and [Labeled Statements](ControlFlow.md#Labeled-Statements)
in [Control Flow](ControlFlow.md).
...
see [Control Transfer Statements](ControlFlow.md#Control-Transfer-Statements)
in [Control Flow](ControlFlow.md).
...
> Note: As described in [Failable Initializers](Declarations.md#Failable-Initializers), a special form of the `return` statement (`return nil`)
...
see [Propagating Errors Using Throwing Functions](ErrorHandling.md#Propagating-Errors-Using-Throwing-Functions)
...
see [Handling Errors](ErrorHandling.md#Handling-Errors).
...
see [Explicit Member Expression](Expressions.md#Explicit-Member-Expression).
...
see [Literal Expression](Expressions.md#Literal-Expression).
