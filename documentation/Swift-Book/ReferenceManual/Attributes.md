...
url: https://github.com/swiftlang/swift-book/blob/main/TSPL.docc/ReferenceManual/Attributes.md
---
...
see [Macro Expansion Expression](Expressions.md#Macro-Expansion-Expression).
For information about property wrappers,
see [propertyWrapper](Attributes.md#propertyWrapper).
...
- The implementation satisfies the requirements for an inlinable function,
  described in [inlinable](Attributes.md#inlinable).
...
as discussed in [inlinable](Attributes.md#inlinable).
...
as discussed in [Switching Over Future Enumeration Cases](Statements.md#Switching-Over-Future-Enumeration-Cases).
...
as discussed in [The Main Actor](Concurrency.md#The-Main-Actor).
...
as discussed in [Top Level Code](Declarations.md#Top-Level-Code).
...
> use the [main](Attributes.md#main) attribute instead.
> In Swift 6,
...
see [Result Builders](AdvancedOperators.md#Result-Builders).
...
see [Autoclosures](Closures.md#Autoclosures) and [Function Type](Types.md#Function-Type).
...
see [Escaping Closures](Closures.md#Escaping-Closures).
...
see [Switching Over Future Enumeration Cases](Statements.md#Switching-Over-Future-Enumeration-Cases).
