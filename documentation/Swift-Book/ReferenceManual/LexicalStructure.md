...
url: https://github.com/swiftlang/swift-book/blob/main/TSPL.docc/ReferenceManual/LexicalStructure.md
---
...
(see [Operators](LexicalStructure.md#Operators)),
...
as described in [Operators](LexicalStructure.md#Operators),
...
For more information, see the [propertyWrapper](Attributes.md#propertyWrapper) section
of the [Attributes](Attributes.md) chapter.
...
as described above in [Identifiers](LexicalStructure.md#Identifiers).
...
see [Strings And Characters](StringsAndCharacters.md)
...
and [Advanced Operators](AdvancedOperators.md).
...
see [Custom Operators](AdvancedOperators.md#Custom-Operators) and [Operator Declaration](Declarations.md#Operator-Declaration).
To learn how to overload existing operators,
see [Operator Methods](AdvancedOperators.md#Operator-Methods).
