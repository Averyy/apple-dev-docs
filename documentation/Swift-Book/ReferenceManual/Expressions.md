...
url: https://github.com/swiftlang/swift-book/blob/main/TSPL.docc/ReferenceManual/Expressions.md
---
...
see [Basic Operators](BasicOperators.md) and [Advanced Operators](AdvancedOperators.md).
...
as described in [Implicit Conversion to a Pointer Type](Expressions.md#Implicit-Conversion-to-a-Pointer-Type).
...
see [Ternary Conditional Operator](BasicOperators.md#Ternary-Conditional-Operator).
...
see [Type Casting](TypeCasting.md).
...
as described in [Function Declaration](Declarations.md#Function-Declaration).
...
see [Function Call Expression](Expressions.md#Function-Call-Expression).
...
For more information about escaping closures, see [Escaping Closures](Closures.md#Escaping-Closures).
...
see [Closure Expressions](Closures.md#Closure-Expressions).
For more information and examples of capture lists,
see [Resolving Strong Reference Cycles for Closures](AutomaticReferenceCounting.md#Resolving-Strong-Reference-Cycles-for-Closures).
...
[Postfix Expressions](Expressions.md#Postfix-Expressions).
...
use the custom attribute syntax described in [Attributes](Attributes.md).
...
as described in [Methods with Special Names](Declarations.md#Methods-with-Special-Names).
...
as described in [Attributes](Attributes.md).
...
see [Protocol Subscript Declaration](Declarations.md#Protocol-Subscript-Declaration).
