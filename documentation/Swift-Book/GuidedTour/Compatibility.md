...
url: https://github.com/swiftlang/swift-book/blob/main/TSPL.docc/GuidedTour/Compatibility.md
---
...
This book describes Swift 6.3,
the default version of Swift that's included in Xcode 26.4.
You can use the Swift 6.3 compiler to build code
that's written in Swift 6.3, Swift 5, Swift 4.2, or Swift 4.

When you use the Swift 6.3 compiler
to build code that uses the Swift 5 language mode,
you can use the new features from Swift 6.3 ---
they're enabled either by default or by an upcoming feature flag.
However, to enable strict concurrency checking,
you need to upgrade to the Swift 6.3 language mode.
...
A target written in Swift 6.3 can depend on
