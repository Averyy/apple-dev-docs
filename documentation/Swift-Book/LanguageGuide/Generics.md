...
url: https://github.com/swiftlang/swift-book/blob/main/TSPL.docc/LanguageGuide/Generics.md
---
...
as described in [In Out Parameters](Functions.md#In-Out-Parameters).
...
> as described in [Opaque Parameter Types](OpaqueTypes.md#Opaque-Parameter-Types).
<!--
...
as discussed in [Extensions with a Generic Where Clause](Generics.md#Extensions-with-a-Generic-Where-Clause) below.
...
As described in [Dictionaries](CollectionTypes.md#Dictionaries),
...
from [Generic Types](Generics.md#Generic-Types) above,
...
as described in [Adding Protocol Conformance with an Extension](Protocols.md#Adding-Protocol-Conformance-with-an-Extension).
...
as described in [Declaring Protocol Adoption with an Extension](Protocols.md#Declaring-Protocol-Adoption-with-an-Extension):
...
which is discussed in [Associated Types with a Generic Where Clause](Generics.md#Associated-Types-with-a-Generic-Where-Clause) below.
...
Type constraints, as described in [Type Constraints](Generics.md#Type-Constraints),
...
see [Implicit Conformance to a Protocol](Protocols.md#Implicit-Conformance-to-a-Protocol).
...
for more information,
see [Borrowing and Consuming Parameters](Declarations.md#Borrowing-and-Consuming-Parameters).
