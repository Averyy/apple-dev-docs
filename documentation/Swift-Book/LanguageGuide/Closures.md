...
url: https://github.com/swiftlang/swift-book/blob/main/TSPL.docc/LanguageGuide/Closures.md
---
...
> It's explained in detail below in [Capturing Values](Closures.md#Capturing-Values).

Global and nested functions, as introduced in [Functions](Functions.md),
...
Nested functions, as introduced in [Nested Functions](Functions.md#Nested-Functions),
...
For more about operator methods, see [Operator Methods](AdvancedOperators.md#Operator-Methods).
...
The string-sorting closure from the [Closure Expression Syntax](Closures.md#Closure-Expression-Syntax) section above
...
> as described in [Concurrency](Concurrency.md).
...
see [Function Types as Return Types](Functions.md#Function-Types-as-Return-Types).
...
> For more information, see [Strong Reference Cycles for Closures](AutomaticReferenceCounting.md#Strong-Reference-Cycles-for-Closures).
...
see [Automatic Reference Counting](AutomaticReferenceCounting.md).
...
as discussed in [Structures and Enumerations Are Value Types](ClassesAndStructures.md#Structures-and-Enumerations-Are-Value-Types).
...
The `@escaping` attribute is described above in [Escaping Closures](Closures.md#Escaping-Closures).
