...
url: https://github.com/swiftlang/swift-book/blob/main/TSPL.docc/LanguageGuide/CollectionTypes.md
---
...
> For more about generic types and collections, see [Generics](Generics.md).
...
(as described in [Enumerations](Enumerations.md))
...
> For information about conforming to protocols, see [Protocols](Protocols.md).
