...
url: https://github.com/swiftlang/swift-book/blob/main/TSPL.docc/LanguageGuide/StringsAndCharacters.md
---
...
> see [Bridging Between String and NSString](https://developer.apple.com/documentation/swift/string#Bridging-Between-String-and-NSString).
...
- An arbitrary Unicode scalar value, written as `\u{`*n*`}`,
  ...
  (Unicode is discussed in [Unicode](StringsAndCharacters.md#Unicode) below)
...
Value types are described in [Structures and Enumerations Are Value Types](ClassesAndStructures.md#Structures-and-Enumerations-Are-Value-Types).
...
The `for`-`in` loop is described in [For In Loops](ControlFlow.md#For-In-Loops).
...
as described in [Comparison Operators](BasicOperators.md#Comparison-Operators):
...
> as described in [String and Character Equality](StringsAndCharacters.md#String-and-Character-Equality).
...
This process is described in [Working with Characters](StringsAndCharacters.md#Working-with-Characters).
