...
url: https://github.com/swiftlang/swift-book/blob/main/TSPL.docc/LanguageGuide/Subscripts.md
---
...
see [Accessing and Modifying a Dictionary](CollectionTypes.md#Accessing-and-Modifying-a-Dictionary).
...
as discussed in [Variadic Parameters](Functions.md#Variadic-Parameters)
and [Default Parameter Values](Functions.md#Default-Parameter-Values).
...
in [Creating an Array with a Default Value](CollectionTypes.md#Creating-an-Array-with-a-Default-Value).
