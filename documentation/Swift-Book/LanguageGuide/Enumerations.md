...
url: https://github.com/swiftlang/swift-book/blob/main/TSPL.docc/LanguageGuide/Enumerations.md
---
...
[Properties](Properties.md), [Methods](Methods.md), [Initialization](Initialization.md),
...
As described in [Control Flow](ControlFlow.md),
...
For information about protocols, see [Protocols](Protocols.md).
...
[Matching Enumeration Values with a Switch Statement](Enumerations.md#Matching-Enumeration-Values-with-a-Switch-Statement).
This time, however,
...
see [Patterns](ControlFlow.md#Patterns).

## Raw Values

The barcode example in [Associated Values](Enumerations.md#Associated-Values)
...
`Character` values are described in [Strings And Characters](StringsAndCharacters.md).
...
> For more information, see [Failable Initializers](Declarations.md#Failable-Initializers).
