...
url: https://github.com/swiftlang/swift-book/blob/main/TSPL.docc/LanguageGuide/OpaqueTypes.md
---
...
in the [The Problem that Opaque Types Solve](OpaqueTypes.md#The-Problem-that-Opaque-Types-Solve) section earlier in this chapter.
...
For more information, see [Downcasting](TypeCasting.md#Downcasting).
...
For example,
here's a version of the `Container` protocol from [Generics](Generics.md):
...
described in [Generics](Generics.md) chapter,
