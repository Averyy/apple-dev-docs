...
url: https://github.com/swiftlang/swift-book/blob/main/TSPL.docc/LanguageGuide/AutomaticReferenceCounting.md
---
...
[Resolving Strong Reference Cycles Between Class Instances](AutomaticReferenceCounting.md#Resolving-Strong-Reference-Cycles-Between-Class-Instances).
...
as described in [Two Phase Initialization](Initialization.md#Two-Phase-Initialization).
...
as described in [Implicitly Unwrapped Optionals](TheBasics.md#Implicitly-Unwrapped-Optionals).
...
see [Capturing Values](Closures.md#Capturing-Values).)
...
from [Strong Reference Cycles for Closures](AutomaticReferenceCounting.md#Strong-Reference-Cycles-for-Closures) above.
...
see [Capture Lists](Expressions.md#Capture-Lists).
