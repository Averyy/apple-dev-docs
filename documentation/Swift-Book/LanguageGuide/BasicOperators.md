...
url: https://github.com/swiftlang/swift-book/blob/main/TSPL.docc/LanguageGuide/BasicOperators.md
---
...
[Advanced Operators](AdvancedOperators.md) covers Swift's advanced operators,
...
(such as `a &+ b`). See [Overflow Operators](AdvancedOperators.md#Overflow-Operators).
...
> For more information, see [Identity Operators](ClassesAndStructures.md#Identity-Operators).
...
For more about the `if` statement, see [Control Flow](ControlFlow.md).
...
For more about `for`-`in` loops, see [Control Flow](ControlFlow.md).
...
For more about arrays, see [Arrays](CollectionTypes.md#Arrays).
