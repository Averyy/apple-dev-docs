...
url: https://github.com/swiftlang/swift-book/blob/main/TSPL.docc/LanguageGuide/Macros.md
---
...
see [attached](Attributes.md#attached) and [freestanding](Attributes.md#freestanding)
in [Attributes](Attributes.md).
...
The [Implementing a Macro](Macros.md#Implementing-a-Macro) section below
