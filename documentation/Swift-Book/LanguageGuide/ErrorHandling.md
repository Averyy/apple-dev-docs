...
url: https://github.com/swiftlang/swift-book/blob/main/TSPL.docc/LanguageGuide/ErrorHandling.md
---
...
- In code that only propagates errors described by generic parameters,
  ...
  and using `rethrows`,
  see [Rethrowing Functions and Methods](Declarations.md#Rethrowing-Functions-and-Methods).
...
see [Deferred Actions](ControlFlow.md#Deferred-Actions).
