...
url: https://github.com/swiftlang/swift-book/blob/main/TSPL.docc/LanguageGuide/AdvancedOperators.md
---
...
In addition to the operators described in [Basic Operators](BasicOperators.md),
...
as described in [Bitwise Left and Right Shift Operators](AdvancedOperators.md#Bitwise-Left-and-Right-Shift-Operators).
...
as described in [Adopting a Protocol Using a Synthesized Implementation](Protocols.md#Adopting-a-Protocol-Using-a-Synthesized-Implementation).
...
See [Precedence and Associativity](AdvancedOperators.md#Precedence-and-Associativity) for an explanation of
...
see [Operator Declaration](Declarations.md#Operator-Declaration).
...
see [resultBuilder](Attributes.md#resultBuilder).
