...
url: https://github.com/swiftlang/swift-book/blob/main/TSPL.docc/LanguageGuide/OptionalChaining.md
---
...
As demonstrated in [Optional Chaining as an Alternative to Forced Unwrapping](OptionalChaining.md#Optional-Chaining-as-an-Alternative-to-Forced-Unwrapping),
...
as described in [Functions Without Return Values](Functions.md#Functions-Without-Return-Values).
...
The example above in [Accessing Properties Through Optional Chaining](OptionalChaining.md#Accessing-Properties-Through-Optional-Chaining)
