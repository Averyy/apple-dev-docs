...
url: https://github.com/swiftlang/swift-book/blob/main/TSPL.docc/LanguageGuide/ClassesAndStructures.md
---
...
[Properties](Properties.md), [Methods](Methods.md), [Subscripts](Subscripts.md), [Initialization](Initialization.md),
...
For more information, see
[Inheritance](Inheritance.md), [Type Casting](TypeCasting.md), [Deinitialization](Deinitialization.md),
...
> For information about actors, see [Concurrency](Concurrency.md).
...
in [Initialization](Initialization.md).
...
Initializers are described in more detail in [Initialization](Initialization.md).
...
is described in [Equivalence Operators](AdvancedOperators.md#Equivalence-Operators).
