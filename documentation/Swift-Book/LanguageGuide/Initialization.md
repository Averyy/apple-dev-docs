...
url: https://github.com/swiftlang/swift-book/blob/main/TSPL.docc/LanguageGuide/Initialization.md
---
...
For more information about deinitializers, see [Deinitialization](Deinitialization.md).
...
from [Initialization Parameters](Initialization.md#Initialization-Parameters) above,
...
as described in [Inheritance](Inheritance.md).
...
[Class Inheritance and Initialization](Initialization.md#Class-Inheritance-and-Initialization) below.
...
as described in [Automatic Initializer Inheritance](Initialization.md#Automatic-Initializer-Inheritance) below.
...
> For more information, see [Automatic Initializer Inheritance](Initialization.md#Automatic-Initializer-Inheritance) below.
...
as per the rules described above in [Initializer Delegation for Class Types](Initialization.md#Initializer-Delegation-for-Class-Types).
...
from [Two Phase Initialization](Initialization.md#Two-Phase-Initialization) above.
...
(as described in [Initializer Inheritance and Overriding](Initialization.md#Initializer-Inheritance-and-Overriding)).
