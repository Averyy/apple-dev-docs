...
url: https://github.com/swiftlang/swift-book/blob/main/TSPL.docc/LanguageGuide/Properties.md
---
...
as described in [Default Property Values](Initialization.md#Default-Property-Values).
...
as described in [Assigning Constant Properties During Initialization](Initialization.md#Assigning-Constant-Properties-During-Initialization).
...
as described in [Functions With an Implicit Return](Functions.md#Functions-With-an-Implicit-Return).
...
Overriding properties is described in [Overriding](Inheritance.md#Overriding).
...
> see [Initializer Delegation for Value Types](Initialization.md#Initializer-Delegation-for-Value-Types)
> and [Initializer Delegation for Class Types](Initialization.md#Initializer-Delegation-for-Class-Types).
...
> see [In Out Parameters](Declarations.md#In-Out-Parameters).
...
> For information about `private`, see [Access Control](AccessControl.md).
...
> in a similar manner to [Lazy Stored Properties](Properties.md#Lazy-Stored-Properties).
