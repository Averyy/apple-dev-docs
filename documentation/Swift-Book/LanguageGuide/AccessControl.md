...
url: https://github.com/swiftlang/swift-book/blob/main/TSPL.docc/LanguageGuide/AccessControl.md
---
...
as discussed below in [Subclassing](AccessControl.md#Subclassing).
...
one of the modifiers listed in [Access Levels](AccessControl.md#Access-Levels),
...
as described in [Default Access Levels](AccessControl.md#Default-Access-Levels).
...
a tuple type composed from two of the custom classes defined above in [Custom Types](AccessControl.md#Custom-Types).
...
(as defined in [Required Initializers](Initialization.md#Required-Initializers)).
