...
url: https://github.com/swiftlang/swift-book/blob/main/TSPL.docc/LanguageGuide/Concurrency.md
---
...
- Code in an unstructured child task,
  as shown in [Unstructured Concurrency](Concurrency.md#Unstructured-Concurrency) below.
...
in [Classes Are Reference Types](ClassesAndStructures.md#Classes-Are-Reference-Types)
...
as described in [globalActor](Attributes.md#globalActor).
...
as discussed in [Implicit Conformance to a Protocol](Protocols.md#Implicit-Conformance-to-a-Protocol).
