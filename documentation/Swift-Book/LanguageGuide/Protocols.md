...
url: https://github.com/swiftlang/swift-book/blob/main/TSPL.docc/LanguageGuide/Protocols.md
---
...
This process is described in [Modifying Value Types from Within Instance Methods](Methods.md#Modifying-Value-Types-from-Within-Instance-Methods).
...
see [Required Initializers](Initialization.md#Required-Initializers).
...
> For more about the `final` modifier, see [Preventing Overrides](Inheritance.md#Preventing-Overrides).
...
as defined in [Failable Initializers](Initialization.md#Failable-Initializers).
...
- [`Sendable`][] for values that can be shared across concurrency domains,
  as discussed in [Sendable Types](Concurrency.md#Sendable-Types).
- [`Copyable`][] for values that Swift can copy
  when you pass them to a function,
  as discussed in [Borrowing and Consuming Parameters](Declarations.md#Borrowing-and-Consuming-Parameters).
...
see [Opaque Types](OpaqueTypes.md).
...
For information about nesting types, see [Nested Types](NestedTypes.md).

To prevent strong reference cycles,
delegates are declared as weak references.
For information about weak references,
see [Strong Reference Cycles Between Class Instances](AutomaticReferenceCounting.md#Strong-Reference-Cycles-Between-Class-Instances).
...
as discussed in [Class Only Protocols](Protocols.md#Class-Only-Protocols).
...
as discussed in [Optional Chaining](OptionalChaining.md).
...
For more about extensions, see [Extensions](Extensions.md).
...
For more about generic `where` clauses, see [Generic Where Clauses](Generics.md#Generic-Where-Clauses).
...
as mentioned in [Protocols as Types](Protocols.md#Protocols-as-Types).
...
> and [Classes Are Reference Types](ClassesAndStructures.md#Classes-Are-Reference-Types).
...
You can use the `is` and `as` operators described in [Type Casting](TypeCasting.md)
...
see [Linking Multiple Levels of Chaining](OptionalChaining.md#Linking-Multiple-Levels-of-Chaining).
