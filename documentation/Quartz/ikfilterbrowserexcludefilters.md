...
The associated value is an [`NSArray`](https://developer.apple.com/documentation/Foundation/NSArray) object that lists the filters that you do  want to display in the filter browser.
