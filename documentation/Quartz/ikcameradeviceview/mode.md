...
The possible values are listed in [`IKCameraDeviceViewDisplayMode`](ikcameradeviceviewdisplaymode.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/quartz/ikcameradeviceview/mode)*