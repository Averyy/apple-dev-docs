...
It is the developer’s responsibility to compute the `imageFrame` such that it lies entirely within the cell’s [`frame()`](ikimagebrowsercell/frame().md) rectangle.
...
*[View on Apple Developer](https://developer.apple.com/documentation/quartz/ikimagebrowsercell/imageframe())*