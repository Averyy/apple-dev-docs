...
The possible constants are described in [`IKScannerDeviceViewDisplayMode`](ikscannerdeviceviewdisplaymode.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/quartz/ikscannerdeviceview/mode)*