...
- `wallTimeout`: The time at which to stop waiting for the dispatch item to finish. Specifying [`distantFuture`](dispatchtime/distantfuture.md) is equivalent to calling the [`wait()`](dispatchworkitem/wait().md) method.
...
*[View on Apple Developer](https://developer.apple.com/documentation/dispatch/dispatchworkitem/wait(walltimeout:))*