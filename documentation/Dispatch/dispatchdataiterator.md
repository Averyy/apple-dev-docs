...
- [func next() -> DispatchData.Element?](dispatchdataiterator/next.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/dispatch/dispatchdataiterator)*