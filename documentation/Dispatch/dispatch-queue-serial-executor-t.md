...
```swift
typealias dispatch_queue_serial_executor_t = _DispatchSerialExecutorQueue
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/dispatch/dispatch_queue_serial_executor_t)*