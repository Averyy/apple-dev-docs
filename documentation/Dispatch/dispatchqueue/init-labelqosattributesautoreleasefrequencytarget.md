...
- `autoreleaseFrequency`: The frequency with which to autorelease objects created by the blocks that the queue schedules. For a list of possible values, see [`DispatchQueue.AutoreleaseFrequency`](dispatchqueue/autoreleasefrequency.md).
