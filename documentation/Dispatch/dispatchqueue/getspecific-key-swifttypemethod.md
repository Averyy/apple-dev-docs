...
```swift
@preconcurrency
class func getSpecific<T>(key: DispatchSpecificKey<T>) -> T? where T : Sendable
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/dispatch/dispatchqueue/getspecific(key:)-swift.type.method)*