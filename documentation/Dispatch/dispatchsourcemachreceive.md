...
You do not adopt this protocol in your objects. Instead, use the [`makeMachReceiveSource(port:queue:)`](dispatchsource/makemachreceivesource(port:queue:).md) method to create an object that adopts this protocol.

## Topics

### Getting the Mach Port Handle
- [var handle: mach_port_t](dispatchsourcemachreceive/handle.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/dispatch/dispatchsourcemachreceive)*