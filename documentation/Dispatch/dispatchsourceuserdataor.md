...
You do not adopt this protocol in your objects. Instead, use the [`makeUserDataOrSource(queue:)`](dispatchsource/makeuserdataorsource(queue:).md) method to create an object that adopts this protocol.

To add custom data to the dispatch source, call the [`or(data:)`](dispatchsourceuserdataor/or(data:).md) method.

## Topics

### Getting the Event Data
- [func or(data: UInt)](dispatchsourceuserdataor/or(data:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/dispatch/dispatchsourceuserdataor)*