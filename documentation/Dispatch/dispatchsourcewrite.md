...
You do not adopt this protocol in your objects. Instead, use the [`makeWriteSource(fileDescriptor:queue:)`](dispatchsource/makewritesource(filedescriptor:queue:).md) method to create an object that adopts this protocol.
...
*[View on Apple Developer](https://developer.apple.com/documentation/dispatch/dispatchsourcewrite)*