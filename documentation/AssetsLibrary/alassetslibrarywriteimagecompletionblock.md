...
```swift
typealias ALAssetsLibraryWriteImageCompletionBlock = (URL?, (any Error)?) -> Void
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/assetslibrary/alassetslibrarywriteimagecompletionblock)*