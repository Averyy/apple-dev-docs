...
The input content height must be less than or equal to [`inputHeight`](mtlfxtemporalscaler/inputheight.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalfx/mtlfxtemporalscaler/inputcontentheight)*