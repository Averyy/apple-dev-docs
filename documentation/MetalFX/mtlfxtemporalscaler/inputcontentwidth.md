...
The input content width must be less than or equal to [`inputWidth`](mtlfxtemporalscaler/inputwidth.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalfx/mtlfxtemporalscaler/inputcontentwidth)*