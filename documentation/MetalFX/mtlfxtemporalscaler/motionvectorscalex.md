...
The scaler converts the horizontal component of each value in [`motionTexture`](mtlfxtemporalscaler/motiontexture.md) into fragment (pixel) coordinates by multiplying it by this property’s value.
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalfx/mtlfxtemporalscaler/motionvectorscalex)*