...
### Instance Methods
- [func encode(commandBuffer: any MTLCommandBuffer)](mtlfxframeinterpolator/encode(commandbuffer:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalfx/mtlfxframeinterpolator)*