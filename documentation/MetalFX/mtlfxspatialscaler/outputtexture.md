...
- The texture’s [`usage`](https://developer.apple.com/documentation/Metal/MTLTexture/usage) property uses [`colorTextureUsage`](mtlfxspatialscaler/colortextureusage.md) property’s [`MTLTextureUsage`](https://developer.apple.com/documentation/Metal/MTLTextureUsage) options as a minimum, and can use additional options.
- The texture’s dimensions is equal to the [`outputWidth`](mtlfxspatialscaler/outputwidth.md) and [`outputHeight`](mtlfxspatialscaler/outputheight.md) properties.
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalfx/mtlfxspatialscaler/outputtexture)*