...
The input content width must be less than or equal to [`inputWidth`](mtlfxspatialscaler/inputwidth.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalfx/mtlfxspatialscaler/inputcontentwidth)*