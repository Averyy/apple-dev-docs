...
```swift
var inputContentMaxScale: Float { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalfx/mtlfxtemporalscalerdescriptor/inputcontentmaxscale)*