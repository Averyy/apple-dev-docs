...
```swift
var isInputContentPropertiesEnabled: Bool { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalfx/mtlfxtemporalscalerdescriptor/isinputcontentpropertiesenabled)*