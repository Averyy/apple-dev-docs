...
### Instance Methods
- [func makeSpatialScaler(device: any MTLDevice, compiler: any MTL4Compiler) -> (any MTL4FXSpatialScaler)?](mtlfxspatialscalerdescriptor/makespatialscaler(device:compiler:).md)
