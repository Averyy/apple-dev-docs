...
```swift
protocol MTLFXFrameInterpolatableScaler : NSObjectProtocol
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalfx/mtlfxframeinterpolatablescaler)*