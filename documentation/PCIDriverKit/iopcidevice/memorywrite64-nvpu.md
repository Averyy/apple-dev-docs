...
```swift
void MemoryWrite64(uint8_t memoryIndex, uint64_t offset, uint64_t data, IOOptionBits options);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/pcidriverkit/iopcidevice/memorywrite64-nvpu)*