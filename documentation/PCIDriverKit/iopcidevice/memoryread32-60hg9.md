...
```swift
void MemoryRead32(uint8_t memoryIndex, uint64_t offset, uint32_t * readData);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/pcidriverkit/iopcidevice/memoryread32-60hg9)*