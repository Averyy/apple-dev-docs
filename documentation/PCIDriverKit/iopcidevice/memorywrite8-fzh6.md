...
```swift
void MemoryWrite8(uint8_t memoryIndex, uint64_t offset, uint8_t data);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/pcidriverkit/iopcidevice/memorywrite8-fzh6)*