...
- [TN3168: Making your App Clip available in the App Store](tn3168-making-your-app-clip-available-app-store.md)
  Learn how to configure your App Clip to prevent it from being unavailable in the App Store.
- [TN3124: Debugging coordinate space issues](tn3124-debugging-coordinate-transformations.md)
  Learn techniques to help debug any coordinate space issue.
- [TN3158: Resolving Xcode 15 device connection issues](tn3158-resolving-xcode-15-device-connection-issues.md)
...
- [TN3165: Packet Filter is not API](tn3165-packet-filter-is-not-api.md)
...
- [TN3156: Create rich previews for Messages](tn3156-create-rich-previews-for-messages.md)
  Learn best practices for creating rich text and image previews for display in the Messages app.
- [TN3157: Updating your watchOS project for SwiftUI and WidgetKit](tn3157-updating-your-watchos-project-for-swiftui-and-widgetkit.md)
  Update your watchOS app project to adopt SwiftUI, WidgetKit, and other modern features.
- [TN3155: Debugging universal links](tn3155-debugging-universal-links.md)
  Investigate why your universal links are opening in a web browser instead of your app.
- [TN3138: Handling App Store receipt signing certificate changes](tn3138-handling-app-store-receipt-signing-certificate-changes.md)
...
- [TN3154: Adopting SwiftUI navigation split view](tn3154-adopting-swiftui-navigation-split-view.md)
...
- [TN3117: Resolving architecture build errors on Apple silicon](tn3117-resolving-build-errors-for-apple-silicon.md)
  Update your app’s architecture build settings to support building macOS, iOS, watchOS, and tvOS apps on Apple silicon.
- [TN3147: Migrating to the latest notarization tool](tn3147-migrating-to-the-latest-notarization-tool.md)
  Migrate your notarization workflows to `notarytool` from the deprecated `altool`.
- [TN3145: HDR video metadata](tn3145-hdr-video-metadata.md)
...
- [TN3129: Resolving build errors from helper tools in Xcode Cloud and other build environments](tn3129-resolving-build-errors-from-helper-tools-in-xcode-cloud.md)
...
- [TN3125: Inside Code Signing: Provisioning Profiles](tn3125-inside-code-signing-provisioning-profiles.md)
...
- [TN3122: Receipt validation with the App Store fails with a non-zero error code](tn3122-receipt-validation-with-the-app-store-fails-with-a-non-zero-error-code.md)
  Identify common configurations that cause unsuccessful receipt validation with the App Store.
- [TN3113: Testing and debugging XPC code with an anonymous listener](tn3113-testing-xpc-code-with-an-anonymous-listener.md)
  Use an anonymous XPC listener to simplify your XPC testing and debugging.
- [TN3121: Selecting a pixel format for an AVCaptureVideoDataOutput](tn3121-selecting-a-pixel-format-for-an-avcapturevideodataoutput.md)
  Learn how to choose the best output pixel format for your app.
- [TN3123: Refactoring your storyboard](tn3123-refactoring-your-storyboard.md)
...
- [TN3108: Viewing the interface of your Swift code](tn3108-viewing-the-interface-of-your-swift-code.md)
  Learn how to navigate to the interface file of a Swift implementation file.
- [TN3104: Recording video in Apple ProRes](tn3104-recording-video-in-apple-prores.md)
  Configure pieces of an AVCaptureSession to capture video in Apple ProRes.
- [TN3103: Apple Pay on the Web troubleshooting guide](tn3103-apple-pay-on-the-web-troubleshooting-guide.md)
  Troubleshooting guide for implementing Apple Pay on the Web.
- [TN3102: HTTP/3 in your app](tn3102-http3-in-your-app.md)
  Get started with iOS 15’s new HTTP/3 support.


---

*[View on Apple Developer](https://developer.apple.com/documentation/Technotes)*