...
This method synchronizes the tensor’s [`data`](mlctensor/data.md) in host memory with the latest contents in device memory.
...
*[View on Apple Developer](https://developer.apple.com/documentation/mlcompute/mlctensor/synchronizedata())*