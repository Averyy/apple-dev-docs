...
```swift
@NSCopying
var outputResultActivation: MLCActivationDescriptor { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/mlcompute/mlclstmlayer/outputresultactivation)*