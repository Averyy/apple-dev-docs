...
### Instance Properties
- [action](ckdbrecordreference/action.md)
- [owner](ckdbrecordreference/owner.md)
  The owner of the referenced record.
- [recordName](ckdbrecordreference/recordname.md)
  The name of the referenced record.
- [zone](ckdbrecordreference/zone.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/cktooljs/ckdbrecordreference)*