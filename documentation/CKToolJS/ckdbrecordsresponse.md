...
### Instance Properties
- [continuationToken](ckdbrecordsresponse/continuationtoken.md)
  A string that indicates there are more records to fetch.
- [records](ckdbrecordsresponse/records.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/cktooljs/ckdbrecordsresponse)*