...
```javascript
import type { CKDBZoneResponse } from "@apple/cktool.database";
```

## Topics

### Instance Properties
- [zone](ckdbzoneresponse/zone.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/cktooljs/ckdbzoneresponse)*