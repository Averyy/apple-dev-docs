...
```javascript
import type { CKDBSessionUser } from "@apple/cktool.database";
```

## Topics

### Instance Properties
- [userRecordName](ckdbsessionuser/userrecordname.md)
  The record name that represents the current user.
...
*[View on Apple Developer](https://developer.apple.com/documentation/cktooljs/ckdbsessionuser)*