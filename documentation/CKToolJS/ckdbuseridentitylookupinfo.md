...
### Instance Properties
- [emailAddress](ckdbuseridentitylookupinfo/emailaddress.md)
  The user’s email address.
- [phoneNumber](ckdbuseridentitylookupinfo/phonenumber.md)
  The user’s phone number.
- [userRecordName](ckdbuseridentitylookupinfo/userrecordname.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/cktooljs/ckdbuseridentitylookupinfo)*