...
### Instance Properties
- [recordChangeTag](ckdbforrecord/recordchangetag.md)
  A string that contains the server change token for the record.
- [recordName](ckdbforrecord/recordname.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/cktooljs/ckdbforrecord)*