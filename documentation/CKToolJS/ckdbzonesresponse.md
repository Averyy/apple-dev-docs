...
### Instance Properties
- [continuationToken](ckdbzonesresponse/continuationtoken.md)
  A string value that indicates that there are more zones to fetch.
- [zones](ckdbzonesresponse/zones.md)
  The array of fetched zones.
...
*[View on Apple Developer](https://developer.apple.com/documentation/cktooljs/ckdbzonesresponse)*