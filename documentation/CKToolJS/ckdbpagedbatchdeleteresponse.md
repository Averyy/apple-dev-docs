...
### Instance Properties
- [continuationToken](ckdbpagedbatchdeleteresponse/continuationtoken.md)
  A string value that indicates there are more results to fetch.
- [deletedCount](ckdbpagedbatchdeleteresponse/deletedcount.md)
  The number of deleted resources.
- [errors](ckdbpagedbatchdeleteresponse/errors.md)
  The array of errors that occurred during the batch delete operation.
...
*[View on Apple Developer](https://developer.apple.com/documentation/cktooljs/ckdbpagedbatchdeleteresponse)*