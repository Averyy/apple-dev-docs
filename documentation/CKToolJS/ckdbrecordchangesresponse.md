...
### Instance Properties
- [changeToken](ckdbrecordchangesresponse/changetoken.md)
  A string that identifies a point in the database’s change history.
- [moreComing](ckdbrecordchangesresponse/morecoming.md)
  A Boolean value that indicates whether there are more changes to request.
- [recordResults](ckdbrecordchangesresponse/recordresults.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/cktooljs/ckdbrecordchangesresponse)*