...
### Instance Properties
- [errorMessage](ckdbvalidateschemaresponse/errormessage.md)
  A message if the schema string is not valid.
- [isValid](ckdbvalidateschemaresponse/isvalid.md)
  The status of the schema string validation.
...
*[View on Apple Developer](https://developer.apple.com/documentation/cktooljs/ckdbvalidateschemaresponse)*