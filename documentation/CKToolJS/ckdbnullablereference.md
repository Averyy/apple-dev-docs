...
```swift
dictionary CKDBNullableReference {
	string? recordName;
	CKDBZoneId? zone;
...
```javascript
import type { CKDBNullableReference } from "@apple/cktool.database";
```

## Topics

### Instance Properties
- [action](ckdbnullablereference/action.md)
- [recordName](ckdbnullablereference/recordname.md)
  The name of the referenced record.
- [zone](ckdbnullablereference/zone.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/cktooljs/ckdbnullablereference)*