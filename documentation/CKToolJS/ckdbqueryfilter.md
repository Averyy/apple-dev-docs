...
### Instance Properties
- [fieldName](ckdbqueryfilter/fieldname.md)
  The name of a field belonging to the record type.
- [fieldValue](ckdbqueryfilter/fieldvalue.md)
- [radiusInKilometers](ckdbqueryfilter/radiusinkilometers.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/cktooljs/ckdbqueryfilter)*