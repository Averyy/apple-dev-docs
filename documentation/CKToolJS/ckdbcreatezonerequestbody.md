...
### Instance Properties
- [zoneName](ckdbcreatezonerequestbody/zonename.md)
  The name that identifies the zone.
- [zoneType](ckdbcreatezonerequestbody/zonetype.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/cktooljs/ckdbcreatezonerequestbody)*