...
```swift
dictionary CKDBQueryRecordsRequestBody {
	CKDBQuery query;
	Int32? resultsLimit;
...
```javascript
import type { CKDBQueryRecordsRequestBody } from "@apple/cktool.database";
```

## Topics

### Instance Properties
- [continuationToken](ckdbqueryrecordsrequestbody/continuationtoken.md)
  The location of the last batch of results.
- [query](ckdbqueryrecordsrequestbody/query.md)
- [requestedFields](ckdbqueryrecordsrequestbody/requestedfields.md)
  An array of record field names that limit the amount of data the server returns in this operation.
- [resultsLimit](ckdbqueryrecordsrequestbody/resultslimit.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/cktooljs/ckdbqueryrecordsrequestbody)*