...
```swift
interface MaxValueNotNumericError
```
...
### Instance Properties
- [value](maxvaluenotnumericerror/value.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/cktooljs/maxvaluenotnumericerror)*