...
### Instance Properties
- [file](ckdbschemaimportrequestbody/file.md)
  A schema file that contains text-based schema.
...
*[View on Apple Developer](https://developer.apple.com/documentation/cktooljs/ckdbschemaimportrequestbody)*