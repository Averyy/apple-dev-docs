...
### Initializers
- [init(CFString)](cflocaleidentifier/init(_:).md)
- [init(rawValue: CFString)](cflocaleidentifier/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/corefoundation/cflocaleidentifier)*