...
### Initializers
- [init?(rawValue: CFIndex)](cfdateformatterstyle/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/corefoundation/cfdateformatterstyle)*