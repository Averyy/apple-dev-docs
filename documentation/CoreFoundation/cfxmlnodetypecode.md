...
### Initializers
- [init?(rawValue: CFIndex)](cfxmlnodetypecode/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/corefoundation/cfxmlnodetypecode)*