...
A flag that can be used to set the selected element of a pop-up menu when creating a user notification with [`CFUserNotificationCreate(_:_:_:_:_:)`](cfusernotificationcreate(_:_:_:_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/corefoundation/cfusernotificationpopupselection(_:))*