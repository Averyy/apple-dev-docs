...
Defers internal consistency-checking and coalescing for a mutable attributed string. You must balance a call to this function with a corresponding [`CFAttributedStringEndEditing(_:)`](cfattributedstringendediting(_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/corefoundation/cfattributedstringbeginediting(_:))*