# CFAllocatorAllocateTyped(_:_:_:_:)
...
```swift
func CFAllocatorAllocateTyped(_ allocator: CFAllocator!, _ size: CFIndex, _ descriptor: CFAllocatorTypeID, _ hint: CFOptionFlags) -> UnsafeMutableRawPointer!
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/corefoundation/cfallocatorallocatetyped(_:_:_:_:))*