...
The [`CFStringCreateExternalRepresentation(_:_:_:_:)`](cfstringcreateexternalrepresentation(_:_:_:_:).md) function complements this function by creating an “external representation” CFData object from a string.
...
*[View on Apple Developer](https://developer.apple.com/documentation/corefoundation/cfstringcreatefromexternalrepresentation(_:_:_:))*