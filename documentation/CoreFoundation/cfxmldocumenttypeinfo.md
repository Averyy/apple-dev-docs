...
- [init(externalID: CFXMLExternalID)](cfxmldocumenttypeinfo/init(externalid:).md)
### Instance Properties
- [var externalID: CFXMLExternalID](cfxmldocumenttypeinfo/externalid.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/corefoundation/cfxmldocumenttypeinfo)*