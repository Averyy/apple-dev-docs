...
See [`File Resource Types`](file-resource-types.md) for possible values.
...
*[View on Apple Developer](https://developer.apple.com/documentation/corefoundation/kcfurlfileresourcetypekey)*