...
Note that in OS X v10.4, [`maxType`](cfnumbertype/maxtype.md) was the same as [`CFNumberType.cfIndexType`](cfnumbertype/cfindextype.md) .
...
*[View on Apple Developer](https://developer.apple.com/documentation/corefoundation/cfnumbertype/maxtype)*