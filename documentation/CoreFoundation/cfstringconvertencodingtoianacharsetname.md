...
The [`CFStringConvertIANACharSetNameToEncoding(_:)`](cfstringconvertianacharsetnametoencoding(_:).md) function is complementary to this function.
...
*[View on Apple Developer](https://developer.apple.com/documentation/corefoundation/cfstringconvertencodingtoianacharsetname(_:))*