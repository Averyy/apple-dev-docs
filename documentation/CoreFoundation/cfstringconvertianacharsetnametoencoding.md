...
The [`CFStringConvertEncodingToIANACharSetName(_:)`](cfstringconvertencodingtoianacharsetname(_:).md) function is complementary to this function.
...
*[View on Apple Developer](https://developer.apple.com/documentation/corefoundation/cfstringconvertianacharsetnametoencoding(_:))*