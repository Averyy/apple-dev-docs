...
*[View on Apple Developer](https://developer.apple.com/documentation/corefoundation/cfbinaryheapcomparecontext/init(version:info:retain:release:copydescription:))*