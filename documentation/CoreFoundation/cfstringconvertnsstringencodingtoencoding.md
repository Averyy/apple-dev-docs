...
The [`CFStringConvertEncodingToNSStringEncoding(_:)`](cfstringconvertencodingtonsstringencoding(_:).md) function is complementary to this function.

## Parameters

- `encoding`: The Cocoa string encoding (of type  ) to use.
...
*[View on Apple Developer](https://developer.apple.com/documentation/corefoundation/cfstringconvertnsstringencodingtoencoding(_:))*