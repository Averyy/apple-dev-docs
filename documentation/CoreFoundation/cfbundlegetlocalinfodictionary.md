...
A dictionary containing the key-value pairs in `bundle`’s localized information dictionary (from the `InfoPlist.strings` file for the current locale). Ownership follows the [`The Get Rule`](https://developer.apple.comhttps://developer.apple.com/library/archive/documentation/CoreFoundation/Conceptual/CFMemoryMgmt/Concepts/Ownership.html#//apple_ref/doc/uid/20001148-SW1).
...
*[View on Apple Developer](https://developer.apple.com/documentation/corefoundation/cfbundlegetlocalinfodictionary(_:))*