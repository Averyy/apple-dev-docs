...
*[View on Apple Developer](https://developer.apple.com/documentation/corefoundation/cffiledescriptorcontext/init(version:info:retain:release:copydescription:))*