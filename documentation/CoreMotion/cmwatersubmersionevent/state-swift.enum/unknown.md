# CMWaterSubmersionEvent.State.unknown
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremotion/cmwatersubmersionevent/state-swift.enum/unknown)*