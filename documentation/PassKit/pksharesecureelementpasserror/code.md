# PKShareSecureElementPassError.Code
...
### Enumeration Cases
- [PKShareSecureElementPassError.Code.setupError](pksharesecureelementpasserror/code/setuperror.md)
- [PKShareSecureElementPassError.Code.unknownError](pksharesecureelementpasserror/code/unknownerror.md)
### Initializers
- [init?(rawValue: Int)](pksharesecureelementpasserror/code/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/passkit/pksharesecureelementpasserror/code)*