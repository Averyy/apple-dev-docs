...
- `handler`: A completion handler. Call this block after you have created your add payment request. - **request**: A newly created add payment request. You must pass a request object to the handler within 20 seconds or the request will fail and the system will display an error message to the user.
