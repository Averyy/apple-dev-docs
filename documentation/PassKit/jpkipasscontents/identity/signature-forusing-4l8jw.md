...
- Properties: - data: Data to be signed with the specified identity
...
*[View on Apple Developer](https://developer.apple.com/documentation/passkit/jpkipasscontents/identity/signature(for:using:)-4l8jw)*