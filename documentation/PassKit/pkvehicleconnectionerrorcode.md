...
### Initializers
- [init?(rawValue: Int)](pkvehicleconnectionerrorcode/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/passkit/pkvehicleconnectionerrorcode)*