...
> ❗ **Important**:  Activating payment passes requires a special entitlement issued from Apple. For more information, see [`developer.apple.com/apple-pay/`](https://developer.apple.comhttps://developer.apple.com/apple-pay/).

 Activating payment passes requires a special entitlement issued from Apple. For more information, see [`developer.apple.com/apple-pay/`](https://developer.apple.comhttps://developer.apple.com/apple-pay/).
...
*[View on Apple Developer](https://developer.apple.com/documentation/passkit/pkpasslibrary/activate(_:withactivationdata:completion:))*