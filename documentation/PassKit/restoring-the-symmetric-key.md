...
| Party V Info | The SHA-256 hash of your merchant ID string literal, which is 32 bytes in size. ![None](/images/com.apple.passkit/spacer.png) You can derive Party V Info from your payment processing certificate in either of two ways. ![None](/images/com.apple.passkit/spacer.png) Method 1: ![None](/images/com.apple.passkit/spacer.png) The UID field of the Common Name includes the plaintext merchant ID. Calculate the SHA-256 hash of that plaintext string. Use the result for Party V Info. ![None](/images/com.apple.passkit/spacer.png) Method 2: ![None](/images/com.apple.passkit/spacer.png) The OID 1.2.840.113635.100.6.32 includes the hex-encoded hash of the merchant ID . Hexadecimal-decode that hash string to produce the original (non-hex-encoded) 32-byte hash. Use the result for Party V Info. |
