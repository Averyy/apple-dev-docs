...
### Initializers
- [init?(rawValue: Int)](pksharesecureelementpassresult/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/passkit/pksharesecureelementpassresult)*