...
```swift
nonisolated
init(_ configuration: PKAddSecureElementPassConfiguration, onCompletion: @escaping (Result<[PKSecureElementPass], any Error>) -> Void)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/passkit/addpasstowalletbutton/init(_:oncompletion:)-5wkyi)*