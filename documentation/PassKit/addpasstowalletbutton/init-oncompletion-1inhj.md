...
```swift
nonisolated
init(_ passes: [PKPass], onCompletion: @escaping (Bool) -> Void)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/passkit/addpasstowalletbutton/init(_:oncompletion:)-1inhj)*