...
```swift
nonisolated
init(_ passes: [PKPass], onCompletion: @escaping (Bool) -> Void, @ViewBuilder fallback: () -> Fallback)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/passkit/addpasstowalletbutton/init(_:oncompletion:fallback:)-77t5g)*