...
```swift
nonisolated
init(_ configuration: PKAddSecureElementPassConfiguration, onCompletion: @escaping (Result<[PKSecureElementPass], any Error>) -> Void, @ViewBuilder fallback: () -> Fallback)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/passkit/addpasstowalletbutton/init(_:oncompletion:fallback:)-7adn5)*