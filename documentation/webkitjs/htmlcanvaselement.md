...
### Obtaining a Context
- [getContext](htmlcanvaselement/1629325-getcontext.md)
  Returns the drawing context for the canvas.
### Getting an Image
- [toDataURL](htmlcanvaselement/1630000-todataurl.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkitjs/htmlcanvaselement)*