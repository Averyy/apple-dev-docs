...
### Constants
- [top](canvasrenderingcontext2d/textbaseline_constants/1805390-top.md)
  Aligns the y-coordinate of the bounding box with top of text glyphs.
- [hanging](canvasrenderingcontext2d/textbaseline_constants/1805396-hanging.md)
  Aligns the y-coordinate of the bounding box just below the top of text glyphs.
- [middle](canvasrenderingcontext2d/textbaseline_constants/1805398-middle.md)
  Aligns the y-coordinate of the bounding box with the middle of text glyphs.
- [alphabetic](canvasrenderingcontext2d/textbaseline_constants/1805402-alphabetic.md)
  Aligns the y-coordinate of the bounding box with the bottom of alphabetic text glyphs without descenders.
- [ideographic](canvasrenderingcontext2d/textbaseline_constants/1805407-ideographic.md)
  Aligns the y-coordinate of the bounding box with the bottom of ideographic text glyphs.
- [bottom](canvasrenderingcontext2d/textbaseline_constants/1805412-bottom.md)
  Aligns the y-coordinate of the bounding box with the bottom of text glyphs with descenders.


---

*[View on Apple Developer](https://developer.apple.com/documentation/webkitjs/canvasrenderingcontext2d/textbaseline_constants)*