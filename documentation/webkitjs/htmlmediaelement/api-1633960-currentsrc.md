...
This property is an empty string if the [`networkState`](htmlmediaelement/1633289-networkstate.md) property is [`NETWORK_EMPTY`](htmlmediaelement/1629429-network_empty.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkitjs/htmlmediaelement/1633960-currentsrc)*