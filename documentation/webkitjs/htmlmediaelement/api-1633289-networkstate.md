...
Possible values are described in [`Network States`](htmlmediaelement/network_states.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkitjs/htmlmediaelement/1633289-networkstate)*