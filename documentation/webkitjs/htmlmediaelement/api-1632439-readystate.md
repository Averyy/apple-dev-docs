...
Possible values are described in [`Media Ready States`](htmlmediaelement/media_ready_states.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkitjs/htmlmediaelement/1632439-readystate)*