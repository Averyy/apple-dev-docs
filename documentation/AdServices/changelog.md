...
| --- | --- |
| January, 2026 | A new `supplyPlacement` field has been added to both detailed and standard attribution payloads, indicating the ad placement for an Apple Ads campaign. See [`Attribution payload descriptions`](aaattribution/attributiontoken()#Attribution-payload-descriptions.md). |
...
| March, 2025 | Introduced view-through attribution on March 27, 2025.  A new attribute, `impressionDate` has been added to detailed payloads for view-through attribution. A new value has been added to the `claimType` field. See [`attributionToken()`](aaattribution/attributiontoken().md). |
