...
- `data`: An [`NSData`](https://developer.apple.com/documentation/Foundation/NSData) object that contains recorded data. Often, this is obtained by calling the [`snapshotData`](gcgamepadsnapshot/snapshotdata.md) method of a  `GCMicroGamepadSnapshot`object.
