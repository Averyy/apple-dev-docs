...
- To get a racing wheel controller object, register for the [`GCRacingWheelDidConnect`](https://developer.apple.com/documentation/Foundation/NSNotification/Name-swift.struct/GCRacingWheelDidConnect) (Swift) or  [`GCRacingWheelDidConnectNotification`](gcracingwheeldidconnectnotification.md) (Objective-C) and [`GCRacingWheelDidDisconnect`](https://developer.apple.com/documentation/Foundation/NSNotification/Name-swift.struct/GCRacingWheelDidDisconnect) (Swift) or [`GCRacingWheelDidDisconnectNotification`](gcracingwheeldiddisconnectnotification.md) (Objective-C) notifications. Alternatively, check the `GCRacingWheel` [`connectedRacingWheels`](gcracingwheel/connectedracingwheels.md) class property for the currently connected controllers.
