# NSDataFromGCExtendedGamepadSnapshotData(_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/gamecontroller/nsdatafromgcextendedgamepadsnapshotdata(_:))*