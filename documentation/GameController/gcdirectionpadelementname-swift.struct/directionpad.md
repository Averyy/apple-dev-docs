...
```swift
static let directionPad: GCDirectionPadElementName
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/gamecontroller/gcdirectionpadelementname-swift.struct/directionpad)*