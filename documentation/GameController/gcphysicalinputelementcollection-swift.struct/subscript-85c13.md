...
```swift
subscript(elementName: GCPhysicalInputElementName) -> T? { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/gamecontroller/gcphysicalinputelementcollection-swift.struct/subscript(_:)-85c13)*