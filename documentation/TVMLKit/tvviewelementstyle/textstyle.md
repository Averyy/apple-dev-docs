...
For possible values, see [`Text Style Values`](text-style-values.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/tvmlkit/tvviewelementstyle/textstyle)*