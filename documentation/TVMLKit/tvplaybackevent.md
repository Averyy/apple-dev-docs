...
### Initializers
- [init(String)](tvplaybackevent/init(_:).md)
- [init(rawValue: String)](tvplaybackevent/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/tvmlkit/tvplaybackevent)*