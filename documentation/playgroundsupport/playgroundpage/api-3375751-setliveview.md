...
When you call [`setLiveView(_:)`](playgroundpage/3375751-setliveview.md), the system sets [`needsIndefiniteExecution`](playgroundpage/1964501-needsindefiniteexecution.md) to `true`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/playgroundsupport/playgroundpage/3375751-setliveview)*