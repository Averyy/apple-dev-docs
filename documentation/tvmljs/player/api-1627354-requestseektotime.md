...
This event is called after the left or right edge of the Siri Remote is pressed and released. Use [`shouldHandleStateChange`](player/1627428-shouldhandlestatechange.md) for press and hold events.
...
*[View on Apple Developer](https://developer.apple.com/documentation/tvmljs/player/1627354-requestseektotime)*