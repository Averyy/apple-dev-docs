...
```swift
var kLAErrorInvalidDimensions: Int32 { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/localauthentication/klaerrorinvaliddimensions)*