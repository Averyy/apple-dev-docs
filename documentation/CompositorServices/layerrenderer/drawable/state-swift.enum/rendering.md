# LayerRenderer.Drawable.State.rendering
...
*[View on Apple Developer](https://developer.apple.com/documentation/compositorservices/layerrenderer/drawable/state-swift.enum/rendering)*