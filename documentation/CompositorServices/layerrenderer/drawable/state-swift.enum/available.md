# LayerRenderer.Drawable.State.available
...
*[View on Apple Developer](https://developer.apple.com/documentation/compositorservices/layerrenderer/drawable/state-swift.enum/available)*