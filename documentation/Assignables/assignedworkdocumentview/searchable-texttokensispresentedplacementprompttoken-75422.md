...
*[View on Apple Developer](https://developer.apple.com/documentation/assignables/assignedworkdocumentview/searchable(text:tokens:ispresented:placement:prompt:token:)-75422)*