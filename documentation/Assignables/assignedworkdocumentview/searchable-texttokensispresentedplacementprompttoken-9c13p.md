...
*[View on Apple Developer](https://developer.apple.com/documentation/assignables/assignedworkdocumentview/searchable(text:tokens:ispresented:placement:prompt:token:)-9c13p)*