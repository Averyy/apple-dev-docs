...
*[View on Apple Developer](https://developer.apple.com/documentation/assignables/assignedworkdocumentview/fileexporter(ispresented:documents:contenttype:oncompletion:)-9x574)*