...
*[View on Apple Developer](https://developer.apple.com/documentation/assignables/assignedworkdocumentview/matchedgeometryeffect(id:in:properties:anchor:issource:))*