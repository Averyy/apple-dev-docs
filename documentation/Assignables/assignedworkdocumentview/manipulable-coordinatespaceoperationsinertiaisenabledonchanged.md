...
*[View on Apple Developer](https://developer.apple.com/documentation/assignables/assignedworkdocumentview/manipulable(coordinatespace:operations:inertia:isenabled:onchanged:))*