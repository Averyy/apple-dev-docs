...
*[View on Apple Developer](https://developer.apple.com/documentation/assignables/assignabledocumentview/manipulable(coordinatespace:operations:inertia:isenabled:onchanged:))*