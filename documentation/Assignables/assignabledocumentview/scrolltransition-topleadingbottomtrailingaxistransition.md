...
*[View on Apple Developer](https://developer.apple.com/documentation/assignables/assignabledocumentview/scrolltransition(topleading:bottomtrailing:axis:transition:))*