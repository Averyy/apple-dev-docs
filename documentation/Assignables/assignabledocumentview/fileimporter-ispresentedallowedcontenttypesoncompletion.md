...
*[View on Apple Developer](https://developer.apple.com/documentation/assignables/assignabledocumentview/fileimporter(ispresented:allowedcontenttypes:oncompletion:))*