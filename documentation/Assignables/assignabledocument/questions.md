...
```swift
var questions: [AssignableDocument.Question] { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/assignables/assignabledocument/questions)*