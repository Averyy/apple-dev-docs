...
```swift
var partIDs: [AssignableDocument.PartID] { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/assignables/assignabledocument/partids-swift.property)*