...
```swift
var id: AssignedWorkDocument.Page.ID { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/assignables/assignedworkdocument/page/id-swift.property)*