...
```swift
var scoreAnnotations: [AssignedWorkDocument.ScoreAnnotation] { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/assignables/assignedworkdocument/scoreannotations)*