...
```swift
var pagesDebugDescription: String { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/assignables/assignedworkdocument/pagesdebugdescription)*