...
![A diagram showing the layout of the extra large text complication. The diagram shows a small amount of text.](/images/com.apple.clockkit/media-2880722@2x.png)

## Topics

### Creating the Template
- [init(textProvider: CLKTextProvider)](clkcomplicationtemplateextralargesimpletext/init(textprovider:).md)
  Creates a new template from the provided text.
### Setting the Complication Data
- [var textProvider: CLKTextProvider](clkcomplicationtemplateextralargesimpletext/textprovider.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/clockkit/clkcomplicationtemplateextralargesimpletext)*