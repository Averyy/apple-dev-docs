...
- [CLKRelativeDateStyle.naturalFull](clkrelativedatestyle/naturalfull.md)
...
- [CLKRelativeDateStyle.timer](clkrelativedatestyle/timer.md)
  A timer style.
### Initializers
- [init?(rawValue: Int)](clkrelativedatestyle/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/clockkit/clkrelativedatestyle)*