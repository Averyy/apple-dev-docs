...
```swift
@_NilHidden
<Label> final var headerLabel: Label { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/clockkit/clkcomplicationtemplategraphicrectangularstandardbodyview/headerlabel)*