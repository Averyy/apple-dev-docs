...
```swift
@objc
final var body2TextProvider: CLKTextProvider?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/clockkit/clkcomplicationtemplategraphicrectangularstandardbodyview/body2textprovider)*