...
### Initializers
- [init?(rawValue: UInt)](clkcomplicationtimelineanimationbehavior/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/clockkit/clkcomplicationtimelineanimationbehavior)*