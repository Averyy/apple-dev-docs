...
```swift
@NSCopying
var bottomTextProvider: CLKTextProvider { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/clockkit/clkcomplicationtemplategraphiccircularopengaugesimpletext/bottomtextprovider)*