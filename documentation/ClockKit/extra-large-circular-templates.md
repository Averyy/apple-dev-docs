...
### Abstract superclass
- [class CLKComplicationTemplateGraphicExtraLargeCircular](clkcomplicationtemplategraphicextralargecircular.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/clockkit/extra-large-circular-templates)*