...
```swift
@NSCopying
var row3Column2TextProvider: CLKTextProvider { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/clockkit/clkcomplicationtemplatemodularlargecolumns/row3column2textprovider)*