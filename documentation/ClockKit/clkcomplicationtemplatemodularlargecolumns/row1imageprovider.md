...
```swift
@NSCopying
var row1ImageProvider: CLKImageProvider? { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/clockkit/clkcomplicationtemplatemodularlargecolumns/row1imageprovider)*