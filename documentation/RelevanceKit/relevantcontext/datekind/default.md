...
```swift
static var `default`: RelevantContext.DateKind { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/relevancekit/relevantcontext/datekind/default)*