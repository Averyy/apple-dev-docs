...
```swift
static var school: RelevantContext.InferredLocation { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/relevancekit/relevantcontext/inferredlocation/school)*