...
```swift
static var home: RelevantContext.InferredLocation { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/relevancekit/relevantcontext/inferredlocation/home)*