...
```swift
static var dragThatCannotResizeScene: UILayoutPriority { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uilayoutpriority/dragthatcannotresizescene)*