...
### Enumeration Cases
- [UIImage.SymbolColorRenderingMode.automatic](uiimage/symbolcolorrenderingmode/automatic.md)
  Automatically uses an appropriate color rendering mode for the symbol’s color layers.
- [UIImage.SymbolColorRenderingMode.flat](uiimage/symbolcolorrenderingmode/flat.md)
  Renders the symbol’s color layers using flat colors.
- [UIImage.SymbolColorRenderingMode.gradient](uiimage/symbolcolorrenderingmode/gradient.md)
  Renders the symbol’s color layers using gradients.
### Initializers
- [init?(rawValue: Int)](uiimage/symbolcolorrenderingmode/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uiimage/symbolcolorrenderingmode)*