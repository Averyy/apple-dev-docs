...
Use this method to retrieve system-defined symbol images. To retrieve a custom symbol image you store in an asset catalog, use the [`init(named:in:compatibleWith:)`](uiimage/init(named:in:compatiblewith:).md) method instead.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uiimage/init(systemname:compatiblewith:))*