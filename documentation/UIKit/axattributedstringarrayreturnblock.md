...
```swift
@MainActor
typealias AXAttributedStringArrayReturnBlock = () -> [NSAttributedString]?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/axattributedstringarrayreturnblock)*