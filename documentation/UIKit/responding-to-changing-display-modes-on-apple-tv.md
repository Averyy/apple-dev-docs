...
![Screenshot that shows the asset catalog configuration for sRGB and Display P3 image support.](/images/com.apple.uikit/responding-to-changing-display-modes-on-apple-tv-1@2x.png)
...
![Screenshot that shows adding 1x and 2x assets to their corresponding slots in an asset catalog.](/images/com.apple.uikit/responding-to-changing-display-modes-on-apple-tv-2@2x.png)
