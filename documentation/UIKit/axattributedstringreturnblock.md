...
```swift
@MainActor
typealias AXAttributedStringReturnBlock = () -> NSAttributedString?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/axattributedstringreturnblock)*