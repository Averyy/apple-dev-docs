...
```swift
var shadowProperties: UIShadowProperties { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uibackgroundconfiguration-swift.struct/shadowproperties)*