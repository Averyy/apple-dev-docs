...
This value is relative to the background, including any [`backgroundInsets`](uibackgroundconfiguration-swift.struct/backgroundinsets.md). The default value is `0.0`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uibackgroundconfiguration-swift.struct/strokeoutset)*