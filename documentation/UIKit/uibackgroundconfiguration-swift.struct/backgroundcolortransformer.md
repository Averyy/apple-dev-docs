...
If the value is `nil`, the configuration uses [`backgroundColor`](uibackgroundconfiguration-swift.struct/backgroundcolor.md) without any transformations.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uibackgroundconfiguration-swift.struct/backgroundcolortransformer)*