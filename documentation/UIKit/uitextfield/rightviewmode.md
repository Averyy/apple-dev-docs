...
The default value for this property is [`UITextField.ViewMode.never`](uitextfield/viewmode/never.md). Note that the right overlay view flips automatically in a right-to-left user interface.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uitextfield/rightviewmode)*