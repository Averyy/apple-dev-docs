...
You use this method to update the actions the menu displays. The method calls [`editMenuInteraction(_:menuFor:suggestedActions:)`](uieditmenuinteractiondelegate/editmenuinteraction(_:menufor:suggestedactions:).md) and updates the UI with the menu the delegate returns. The method has no effect if no menu is present.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uieditmenuinteraction/reloadvisiblemenu())*