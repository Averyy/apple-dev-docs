...
- [convenience init(frame: CGRect)](nscollectionlayoutgroupcustomitem/init(frame:).md)
  Creates a custom item with the specified frame.
- [convenience init(frame: CGRect, zIndex: Int)](nscollectionlayoutgroupcustomitem/init(frame:zindex:).md)
  Creates a custom item with the specified frame and vertical stacking order in relation to other items in the group.
### Getting the frame
- [var frame: CGRect](nscollectionlayoutgroupcustomitem/frame.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/nscollectionlayoutgroupcustomitem)*