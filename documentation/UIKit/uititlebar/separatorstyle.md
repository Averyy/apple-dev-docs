...
The default value is [`UITitlebarSeparatorStyle.automatic`](uititlebarseparatorstyle/automatic.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uititlebar/separatorstyle)*