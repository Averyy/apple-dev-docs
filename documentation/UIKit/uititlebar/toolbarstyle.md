...
The default value is [`UITitlebarToolbarStyle.automatic`](uititlebartoolbarstyle/automatic.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uititlebar/toolbarstyle)*