...
```swift
var cellDragState: UICellConfigurationState.DragState { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uicellconfigurationstate-swift.struct/celldragstate)*