...
```swift
var cellDropState: UICellConfigurationState.DropState { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uicellconfigurationstate-swift.struct/celldropstate)*