...
To specify `collisionMode`, use one of the values in the [`UICollisionBehavior.Mode`](uicollisionbehavior/mode.md) enum. The default value is [`everything`](uicollisionbehavior/mode/everything.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uicollisionbehavior/collisionmode)*