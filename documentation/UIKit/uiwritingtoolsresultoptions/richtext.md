...
```swift
static var richText: UIWritingToolsResultOptions { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uiwritingtoolsresultoptions/richtext)*