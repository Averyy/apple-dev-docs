...
```swift
static var table: UIWritingToolsResultOptions { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uiwritingtoolsresultoptions/table)*