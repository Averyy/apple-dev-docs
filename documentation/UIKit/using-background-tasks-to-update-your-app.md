...
![The Xcode project editor showing the Background Modes capabilities editor of the Signing & Capabilities pane.](/images/com.apple.uikit/using-background-tasks-to-update-your-app-1@2x.png)
...
![Flow diagram showing when a task object is run. The flow starts with app launch, after which the task is scheduled, run, and completed.](/images/com.apple.uikit/media-3399760@2x.png)
