...
### Managing vibrancy
- [var preferredVibrancy: UILabelVibrancy](uilabel/preferredvibrancy.md)
- [enum UILabelVibrancy](uilabelvibrancy.md)
### Drawing a shadow
...
- [var preferredMaxLayoutWidth: CGFloat](uilabel/preferredmaxlayoutwidth.md)
  The preferred maximum width, in points, for a multiline label.
### Accessing additional attributes
- [var isUserInteractionEnabled: Bool](uilabel/isuserinteractionenabled.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uilabel)*