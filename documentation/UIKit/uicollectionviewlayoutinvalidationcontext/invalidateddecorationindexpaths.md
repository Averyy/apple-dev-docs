...
The keys in this dictionary are the element kind strings of the invalid decoration views. The value for each key is an array of [`NSIndexPath`](https://developer.apple.com/documentation/Foundation/NSIndexPath) objects indicating which specific decoration views have layout changes.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uicollectionviewlayoutinvalidationcontext/invalidateddecorationindexpaths)*