...
```swift
@MainActor
typealias AXNavigationStyleReturnBlock = () -> UIAccessibilityNavigationStyle
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/axnavigationstylereturnblock)*