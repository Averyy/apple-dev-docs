...
If the title fits on one line, the system displays it as a single line quick action. If the title is too long for one line and you have not specified a [`localizedSubtitle`](uiapplicationshortcutitem/localizedsubtitle.md) string, the system displays the title on two lines.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uiapplicationshortcutitem/localizedtitle)*