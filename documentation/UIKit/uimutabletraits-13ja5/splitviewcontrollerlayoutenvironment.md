...
```swift
var splitViewControllerLayoutEnvironment: UISplitViewController.LayoutEnvironment { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uimutabletraits-13ja5/splitviewcontrollerlayoutenvironment)*