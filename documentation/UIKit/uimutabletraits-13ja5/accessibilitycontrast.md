...
```swift
var accessibilityContrast: UIAccessibilityContrast { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uimutabletraits-13ja5/accessibilitycontrast)*