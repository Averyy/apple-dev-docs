...
![A partial screenshot of Project navigator in Xcode that shows a template for a new single view app. The app contains source files for an app delegate, scene delegate, and view controller. It also contains storyboard, asset catalog, and Info.plist files.](/images/com.apple.uikit/about-app-development-with-uikit-1@2x.png)
...
![A screenshot of an asset catalog in Xcode that shows the variants for the app's icon.](/images/com.apple.uikit/about-app-development-with-uikit-2@2x.png)
...
![A screenshot of the Info tab in Xcode showing custom iOS target properties. The device capabilities include information such as whether the app requires a camera, location services, or a particular technology.](/images/com.apple.uikit/about-app-development-with-uikit-3@2x.png)
