...
```swift
@MainActor
@preconcurrency var configurationUpdateHandler: UICollectionViewCell.ConfigurationUpdateHandler? { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uicollectionviewcell/configurationupdatehandler-7rqbu)*