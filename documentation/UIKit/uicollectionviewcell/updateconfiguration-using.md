...
Avoid calling this method directly. Instead, use [`setNeedsUpdateConfiguration()`](uicollectionviewcell/setneedsupdateconfiguration().md) to request an update.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uicollectionviewcell/updateconfiguration(using:))*