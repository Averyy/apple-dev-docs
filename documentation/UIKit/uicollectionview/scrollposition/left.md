...
This option is mutually exclusive with the [`centeredHorizontally`](uicollectionview/scrollposition/centeredhorizontally.md) and [`right`](uicollectionview/scrollposition/right.md) options.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uicollectionview/scrollposition/left)*