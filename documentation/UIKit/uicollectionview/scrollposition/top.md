...
This option is mutually exclusive with the [`centeredVertically`](uicollectionview/scrollposition/centeredvertically.md) and [`bottom`](uicollectionview/scrollposition/bottom.md) options.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uicollectionview/scrollposition/top)*