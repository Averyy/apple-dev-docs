...
If the value of this property is [`true`](https://developer.apple.com/documentation/Swift/true) and [`bouncesHorizontally`](uiscrollview/bounceshorizontally.md) is [`true`](https://developer.apple.com/documentation/Swift/true), the scroll view allows horizontal dragging even if the content is smaller than the bounds of the scroll view. The default value is [`false`](https://developer.apple.com/documentation/Swift/false).
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uiscrollview/alwaysbouncehorizontal)*