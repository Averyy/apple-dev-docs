...
```swift
@MainActor
@preconcurrency weak var appIntentsDataSource: (any UITableViewAppIntentsDataSource)? { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uitableview/appintentsdatasource)*