...
To set a value for this property, use the [`startAnimation(afterDelay:)`](uiviewanimating/startanimation(afterdelay:).md) method when starting your animations.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uiviewpropertyanimator/delay)*