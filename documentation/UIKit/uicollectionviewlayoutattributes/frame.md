...
The frame rectangle is measured in points and specified in the coordinate system of the collection view. Setting the value of this property also sets the values of the [`center`](uicollectionviewlayoutattributes/center.md) and [`size`](uicollectionviewlayoutattributes/size.md) properties.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uicollectionviewlayoutattributes/frame)*