...
```swift
struct UITraitResolvesNaturalAlignmentWithBaseWritingDirection
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uitraitresolvesnaturalalignmentwithbasewritingdirection-swift.struct)*