...
Use this anchor to create constraints with the layout guide’s trailing edge. You can only combine this anchor with a subset of the [`NSLayoutXAxisAnchor`](nslayoutxaxisanchor.md) anchors. You can combine a [`trailingAnchor`](uilayoutguide/trailinganchor.md) with another `trailingAnchor`, a `leadingAnchor`, or a `centerXAnchor`. For more information, see [`NSLayoutAnchor`](nslayoutanchor.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uilayoutguide/trailinganchor)*