...
The app calls this method when it receives a [`setStatusBarOrientation(_:animated:)`](uiapplication/setstatusbarorientation(_:animated:).md) message and is about to change the interface orientation.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uiapplicationdelegate/application(_:willchangestatusbarframe:))*