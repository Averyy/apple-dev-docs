...
![Illustration of group nesting in a compositional layout. A larger group contains one large item on the leading side and two smaller items stacked vertically in a nested group on the trailing side.](/images/com.apple.uikit/media-3568666@2x.png)
...
- [class func horizontal(layoutSize: NSCollectionLayoutSize, repeatingSubitem: NSCollectionLayoutItem, count: Int) -> Self](nscollectionlayoutgroup/horizontal(layoutsize:repeatingsubitem:count:).md)
...
- [class func vertical(layoutSize: NSCollectionLayoutSize, repeatingSubitem: NSCollectionLayoutItem, count: Int) -> Self](nscollectionlayoutgroup/vertical(layoutsize:repeatingsubitem:count:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/nscollectionlayoutgroup)*