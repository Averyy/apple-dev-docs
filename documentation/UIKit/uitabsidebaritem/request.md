...
### Instance Properties
- [var content: UITabSidebarItem.Content](uitabsidebaritem/request/content.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uitabsidebaritem/request)*