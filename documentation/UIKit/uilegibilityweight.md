...
### Weights
- [UILegibilityWeight.unspecified](uilegibilityweight/unspecified.md)
  An unspecified text weight.
- [UILegibilityWeight.regular](uilegibilityweight/regular.md)
  A regular font weight.
- [UILegibilityWeight.bold](uilegibilityweight/bold.md)
  A bold font weight.
### Initializers
- [init(LegibilityWeight?)](uilegibilityweight/init(_:).md)
  Creates a legibility weight from the specified SwiftUI legibility weight.
- [init?(rawValue: Int)](uilegibilityweight/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uilegibilityweight)*