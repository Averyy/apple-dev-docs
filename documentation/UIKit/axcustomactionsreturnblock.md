...
```swift
@MainActor
typealias AXCustomActionsReturnBlock = () -> [UIAccessibilityCustomAction]?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/axcustomactionsreturnblock)*