...
```swift
@MainActor
@preconcurrency var headerContentConfiguration: (any UIContentConfiguration)? { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uitabbarcontroller/sidebar-swift.class/headercontentconfiguration)*