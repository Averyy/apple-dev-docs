...
```swift
var hdrHeadroomUsageLimit: UIHDRHeadroomUsageLimit { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uitraitcollection/hdrheadroomusagelimit)*