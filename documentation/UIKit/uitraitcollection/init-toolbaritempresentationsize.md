# init(toolbarItemPresentationSize:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uitraitcollection/init(toolbaritempresentationsize:))*