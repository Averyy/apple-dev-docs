...
```swift
init(activeAppearance userInterfaceActiveAppearance: UIUserInterfaceActiveAppearance)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uitraitcollection/init(activeappearance:))*