...
A new trait collection containing only the accessibility contrast trait.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uitraitcollection/init(accessibilitycontrast:))*