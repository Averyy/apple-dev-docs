...
```swift
@MainActor
typealias AXTextualContextReturnBlock = () -> UIAccessibilityTextualContext?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/axtextualcontextreturnblock)*