...
Use these constants with the [`returnKeyType`](uitextinputtraits/returnkeytype.md) property.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uireturnkeytype)*