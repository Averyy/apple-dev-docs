...
- `enabled`: Specify   to enable animations or   to disable them.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uiview/setanimationsenabled(_:))*