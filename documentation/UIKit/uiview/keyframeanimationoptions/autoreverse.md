...
This option must be combined with the [`repeat`](uiview/keyframeanimationoptions/repeat.md) option.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uiview/keyframeanimationoptions/autoreverse)*