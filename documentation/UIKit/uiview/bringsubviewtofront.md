...
This method moves the specified view to the end of the array of views in the [`subviews`](uiview/subviews.md) property.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uiview/bringsubviewtofront(_:))*