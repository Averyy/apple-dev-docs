...
```swift
var subclassForWritingToolsCoordinator: AnyClass { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uitextview/subclassforwritingtoolscoordinator)*