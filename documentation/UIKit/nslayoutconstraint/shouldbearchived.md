...
When a view is archived, it archives some but not all constraints in its [`constraints`](https://developer.apple.com/documentation/AppKit/NSView/constraints) array. The value of [`shouldBeArchived`](nslayoutconstraint/shouldbearchived.md) informs the view if a particular constraint should be archived by the view.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/nslayoutconstraint/shouldbearchived)*