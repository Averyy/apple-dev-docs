...
The system tries to call the [`accessibilityAttributedContent(forLineNumber:)`](uiaccessibilityreadingcontent/accessibilityattributedcontent(forlinenumber:).md) method before calling this method.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uiaccessibilityreadingcontent/accessibilitycontent(forlinenumber:))*