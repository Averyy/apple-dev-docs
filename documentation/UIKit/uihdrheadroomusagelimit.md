...
### Initializers
- [init?(rawValue: Int)](uihdrheadroomusagelimit/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uihdrheadroomusagelimit)*