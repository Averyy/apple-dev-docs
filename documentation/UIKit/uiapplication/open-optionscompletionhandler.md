...
- `options`: A dictionary of options to use when opening the URL. For a list of possible keys to include in this dictionary, see [`UIApplication.OpenExternalURLOptionsKey`](uiapplication/openexternalurloptionskey.md).
