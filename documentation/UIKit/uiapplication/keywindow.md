...
This property holds the [`UIWindow`](uiwindow.md) object in the [`windows`](uiapplication/windows.md) array that is most recently sent the [`makeKeyAndVisible()`](uiwindow/makekeyandvisible().md) message.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uiapplication/keywindow)*