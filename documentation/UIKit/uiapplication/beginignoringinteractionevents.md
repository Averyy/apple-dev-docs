...
You typically call this method before starting an animation or transition. Calls are nested with the [`endIgnoringInteractionEvents()`](uiapplication/endignoringinteractionevents().md) method.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uiapplication/beginignoringinteractionevents())*