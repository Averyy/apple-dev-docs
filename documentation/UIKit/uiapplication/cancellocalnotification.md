...
- `notification`: The local notification to cancel.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uiapplication/cancellocalnotification(_:))*