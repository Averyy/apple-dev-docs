...
- `touches`: A set of   instances that represent the touches for the starting phase of the event, which is represented by  . For touches in a view, this set contains only one touch by default. To receive multiple touches, you must set the view’s   property to  .
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uiresponder/touchesbegan(_:with:))*