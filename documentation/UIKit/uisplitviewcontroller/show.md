...
The split view controller chooses the appropriate transition to display the view controller in the specified column. For example, calling this method with [`UISplitViewController.Column.secondary`](uisplitviewcontroller/column/secondary.md) when the split behavior is [`UISplitViewController.SplitBehavior.displace`](uisplitviewcontroller/splitbehavior-swift.enum/displace.md) changes the display mode from [`UISplitViewController.DisplayMode.twoDisplaceSecondary`](uisplitviewcontroller/displaymode-swift.enum/twodisplacesecondary.md) to [`UISplitViewController.DisplayMode.oneBesideSecondary`](uisplitviewcontroller/displaymode-swift.enum/onebesidesecondary.md), which hides the primary column to show the unobstructed secondary column.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uisplitviewcontroller/show(_:))*