...
```swift
@MainActor
var additionalLeadingNavigationBarButtonItems: [UIBarButtonItem] { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uidocumentbrowserviewcontroller/additionalleadingnavigationbarbuttonitems)*