...
For more details, see [`setScopeBarButtonDividerImage(_:forLeftSegmentState:rightSegmentState:)`](uisearchbar/setscopebarbuttondividerimage(_:forleftsegmentstate:rightsegmentstate:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uisearchbar/scopebarbuttondividerimage(forleftsegmentstate:rightsegmentstate:))*