...
If [`configuration`](uibutton/configuration-5rlyb.md) is `nil`, this property is `nil`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uibutton/subtitlelabel)*