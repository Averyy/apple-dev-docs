...
The button uses this property to determine [`intrinsicContentSize`](uiview/intrinsiccontentsize.md) and [`sizeThatFits(_:)`](uiview/sizethatfits(_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uibutton/contentedgeinsets)*