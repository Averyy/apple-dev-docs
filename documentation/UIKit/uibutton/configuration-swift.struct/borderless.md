...
This style provides an alternative name for the [`plain()`](uibutton/configuration-swift.struct/plain().md) style.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uibutton/configuration-swift.struct/borderless())*