...
The first item in the array can also be set using the [`leftBarButtonItem`](uinavigationitem/leftbarbuttonitem.md) property.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uinavigationitem/leftbarbuttonitems)*