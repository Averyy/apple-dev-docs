...
Setting items through this property replaces the items you set through [`rightBarButtonItem`](uinavigationitem/rightbarbuttonitem.md) or [`rightBarButtonItems`](uinavigationitem/rightbarbuttonitems.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uinavigationitem/trailingitemgroups)*