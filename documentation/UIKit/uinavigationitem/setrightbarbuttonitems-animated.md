...
- `animated`: Specify   to animate the transition to the custom bar items when this item is the top item. Specify   to set the items immediately without animating the change.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uinavigationitem/setrightbarbuttonitems(_:animated:))*