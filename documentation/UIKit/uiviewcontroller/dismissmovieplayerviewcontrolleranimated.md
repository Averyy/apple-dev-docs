...
If the receiver’s [`modalViewController`](uiviewcontroller/modalviewcontroller.md) property does not contain a movie player view controller, this method does nothing.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uiviewcontroller/dismissmovieplayerviewcontrolleranimated())*