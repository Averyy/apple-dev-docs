...
See [`selectedSegmentIndex`](uisegmentedcontrol/selectedsegmentindex.md) for more information.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uisegmentedcontrol/nosegment)*