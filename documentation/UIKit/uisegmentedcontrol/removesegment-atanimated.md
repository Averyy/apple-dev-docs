...
- `animated`:   if the removal of the new segment must animate; otherwise,  .
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uisegmentedcontrol/removesegment(at:animated:))*