...
Applies only when [`numberOfSegments`](uisegmentedcontrol/numberofsegments.md) is greater than 1.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uisegmentedcontrol/segment/right)*