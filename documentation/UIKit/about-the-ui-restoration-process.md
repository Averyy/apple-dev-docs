...
2. **Asks the app delegate.** If the view controller had no restoration class, UIKit calls the [`application(_:viewControllerWithRestorationIdentifierPath:coder:)`](uiapplicationdelegate/application(_:viewcontrollerwithrestorationidentifierpath:coder:).md) method of the app delegate. If you return `nil` from that method, UIKit continues searching.
