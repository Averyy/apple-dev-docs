...
The default value of this property is the preferred font for [`body`](uifont/textstyle/body.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uicellaccessory-swift.struct/labeloptions/font)*