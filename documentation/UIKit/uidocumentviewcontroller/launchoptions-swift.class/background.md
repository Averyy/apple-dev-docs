...
```swift
@MainActor
@preconcurrency var background: UIBackgroundConfiguration { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uidocumentviewcontroller/launchoptions-swift.class/background)*