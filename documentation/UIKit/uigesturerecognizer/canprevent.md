...
- `preventedGestureRecognizer`: An instance of a subclass of  .
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uigesturerecognizer/canprevent(_:))*