...
If you set [`trackTintColor`](uiprogressview/tracktintcolor.md) to `nil`, the track uses the tint of its parent.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uiprogressview/tracktintcolor)*