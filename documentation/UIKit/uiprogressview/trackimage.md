...
If you provide a custom image, the [`trackTintColor`](uiprogressview/tracktintcolor.md) property is ignored.
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uiprogressview/trackimage)*