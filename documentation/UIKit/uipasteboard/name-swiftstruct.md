...
### Initializers
- [init(String)](uipasteboard/name-swift.struct/init(_:).md)
- [init(rawValue: String)](uipasteboard/name-swift.struct/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/uikit/uipasteboard/name-swift.struct)*