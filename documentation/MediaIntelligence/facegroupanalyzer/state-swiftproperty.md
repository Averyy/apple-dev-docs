...
```swift
nonisolated
(nonsending) final var state: FaceGroupAnalyzer.State { get async }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/mediaintelligence/facegroupanalyzer/state-swift.property)*