...
```swift
typealias CKShare_Participant_Permission = CKShare.ParticipantPermission
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/cloudkit/ckshare_participant_permission)*