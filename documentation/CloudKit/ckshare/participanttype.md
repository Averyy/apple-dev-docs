...
- [CKShare.ParticipantType.unknown](ckshare/participanttype/unknown.md)
  An unknown role.
...
### Initializers
- [init?(rawValue: Int)](ckshare/participanttype/init(rawvalue:).md)
...
- [var type: CKShare.ParticipantType](ckshare/participant/type.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/cloudkit/ckshare/participanttype)*