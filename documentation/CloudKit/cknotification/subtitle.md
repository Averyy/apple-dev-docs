...
The system ignores this property if [`subtitleLocalizationKey`](cknotification/subtitlelocalizationkey.md) has a value.
...
*[View on Apple Developer](https://developer.apple.com/documentation/cloudkit/cknotification/subtitle)*