...
This property takes precedence over [`title`](cknotification/title.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/cloudkit/cknotification/titlelocalizationkey)*