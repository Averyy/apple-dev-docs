...
The system ignores this property if [`titleLocalizationKey`](cknotification/titlelocalizationkey.md) has a value.
...
*[View on Apple Developer](https://developer.apple.com/documentation/cloudkit/cknotification/title)*