...
When the number of records that CloudKit returns exceeds this limit, the operation sets the `moreComing` property to [`true`](https://developer.apple.com/documentation/swift/true) when executing the [`recordZoneFetchCompletionBlock`](ckfetchrecordzonechangesoperation/recordzonefetchcompletionblock.md) handler.
