...
```swift
typealias CKShare_Participant_ParticipantType = CKShare.ParticipantType
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/cloudkit/ckshare_participant_participanttype)*