...
If you receive this error, file a [`bug report`](https://developer.apple.comhttp://radar.apple.com) that includes the error log.
...
*[View on Apple Developer](https://developer.apple.com/documentation/cloudkit/ckerror/code/internalerror)*