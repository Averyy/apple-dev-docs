...
If your app receives [`CKError.Code.limitExceeded`](ckerror/code/limitexceeded.md), it must split the operation in half and try both requests again.
...
*[View on Apple Developer](https://developer.apple.com/documentation/cloudkit/ckerror/code/limitexceeded)*