...
```swift
@preconcurrency
func fetchShareParticipants(forUserRecordIDs userRecordIDs: [CKRecord.ID], completionHandler: @escaping (Result<[CKRecord.ID : Result<CKShare.Participant, any Error>], any Error>) -> Void)
```
