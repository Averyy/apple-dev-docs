...
The user identity for the user record ID.
...
*[View on Apple Developer](https://developer.apple.com/documentation/cloudkit/ckcontainer/useridentity(foruserrecordid:))*