...
Returns true if the sign bit is set for the value in X, otherwise returns false
...
*[View on Apple Developer](https://developer.apple.com/documentation/shadergraph/realitykit/sign-bit-(realitykit))*