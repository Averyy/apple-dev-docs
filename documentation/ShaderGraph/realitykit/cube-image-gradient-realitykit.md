...
The Cube Image Gradient node produces a texture using the contents of the image file specified in the `File` parameter. It has a multitude of parameters that affect the properties of the rendered textures.
...
For an example on how to use this node, see the bottom of the [`Cube Image (RealityKit)`](realitykit/cube-image-(realitykit).md) node page.
