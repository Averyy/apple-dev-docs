...
Material nodes help you divide your graph into subsets of nodes, each with distinct inputs and outputs. A [`NodeGraph`](material/nodegraph.md) appears as a single node within your main graph. Editing that node hides the main graph and gives you an empty space that you can fill with additional nodes. Use that space to build a specific portion of your main graph, and use the [`NodeGraph`](material/nodegraph.md) to define the inputs and outputs to that separate space.

## Topics

### Nodes
- [NodeGraph](material/nodegraph.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/shadergraph/material)*