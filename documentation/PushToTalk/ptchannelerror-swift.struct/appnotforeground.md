...
```swift
static var appNotForeground: PTChannelError.Code { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/pushtotalk/ptchannelerror-swift.struct/appnotforeground)*