...
```swift
static var screenTimeRestriction: PTChannelError.Code { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/pushtotalk/ptchannelerror-swift.struct/screentimerestriction)*