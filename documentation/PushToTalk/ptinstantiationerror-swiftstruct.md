...
- [Error constants](ptinstantiation-error-constants.md)
  Error codes for instantiation operations.
### Type Properties
- [static var errorDomain: String](ptinstantiationerror-swift.struct/errordomain.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/pushtotalk/ptinstantiationerror-swift.struct)*