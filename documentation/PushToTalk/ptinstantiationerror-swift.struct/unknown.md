...
```swift
static var unknown: PTInstantiationError.Code { get }
```

## See Also

- [static var invalidPlatform: PTInstantiationError.Code](ptinstantiationerror-swift.struct/invalidplatform.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/pushtotalk/ptinstantiationerror-swift.struct/unknown)*