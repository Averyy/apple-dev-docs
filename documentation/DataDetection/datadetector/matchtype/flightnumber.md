...
> **Note**: The framework only supports International Air Transport Association (IATA) codes.
...
*[View on Apple Developer](https://developer.apple.com/documentation/datadetection/datadetector/matchtype/flightnumber)*