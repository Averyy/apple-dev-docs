...
![Screenshot of the location button with an icon that uses the filled arrow style and a label that shows Current Location.](/images/com.apple.CoreLocationUI/locationbutton-1@2x.png)
