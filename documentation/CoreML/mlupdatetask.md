...
- [func resume(withParameters: [MLParameterKey : Any])](mlupdatetask/resume(withparameters:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreml/mlupdatetask)*