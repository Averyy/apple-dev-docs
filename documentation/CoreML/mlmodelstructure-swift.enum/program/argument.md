...
- [let bindings: [MLModelStructure.Program.Binding]](mlmodelstructure-swift.enum/program/argument/bindings.md)
  The bindings.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreml/mlmodelstructure-swift.enum/program/argument)*