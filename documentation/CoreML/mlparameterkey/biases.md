...
> **Note**:  You can only override the biases of a model’s *updatable* layers. Model developers mark these layers as updatable with the [`Core ML Tools`](https://developer.apple.comhttps://coremltools.readme.io/).
