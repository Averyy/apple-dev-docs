...
The value type for the [`miniBatchSize`](mlparameterkey/minibatchsize.md) key is an [`Int64`](https://developer.apple.com/documentation/Swift/Int64).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreml/mlparameterkey/minibatchsize)*