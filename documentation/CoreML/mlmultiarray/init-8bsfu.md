...
Use this initializer to create a multiarray from a collection of [`Double`](https://developer.apple.com/documentation/Swift/Double) values, such as an array.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreml/mlmultiarray/init(_:)-8bsfu)*