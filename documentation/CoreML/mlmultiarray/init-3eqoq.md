...
Use this initializer to create a multiarray from a collection of [`Int`](https://developer.apple.com/documentation/Swift/Int) values, such as an array.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreml/mlmultiarray/init(_:)-3eqoq)*