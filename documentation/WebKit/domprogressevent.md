...
### Instance Properties
- [var lengthComputable: Bool](domprogressevent/lengthcomputable.md)
- [var loaded: UInt64](domprogressevent/loaded.md)
- [var total: UInt64](domprogressevent/total.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domprogressevent)*