...
### Instance Properties
- [var bottom: DOMCSSPrimitiveValue!](domrect/bottom.md)
- [var left: DOMCSSPrimitiveValue!](domrect/left.md)
- [var right: DOMCSSPrimitiveValue!](domrect/right.md)
- [var top: DOMCSSPrimitiveValue!](domrect/top.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domrect)*