...
### Instance Properties
- [var selectorText: String!](domcsspagerule/selectortext.md)
- [var style: DOMCSSStyleDeclaration!](domcsspagerule/style.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domcsspagerule)*