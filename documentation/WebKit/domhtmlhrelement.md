...
### Instance Properties
- [var align: String!](domhtmlhrelement/align.md)
- [var noShade: Bool](domhtmlhrelement/noshade.md)
- [var size: String!](domhtmlhrelement/size.md)
- [var width: String!](domhtmlhrelement/width.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domhtmlhrelement)*