...
### Instance Properties
- [var selectorText: String!](domcssstylerule/selectortext.md)
- [var style: DOMCSSStyleDeclaration!](domcssstylerule/style.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domcssstylerule)*