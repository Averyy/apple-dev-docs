...
### Instance Properties
- [var width: Int32](domhtmlpreelement/width.md)
- [var wrap: Bool](domhtmlpreelement/wrap.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domhtmlpreelement)*