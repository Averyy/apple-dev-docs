...
### Instance Properties
- [var length: UInt32](domcssvaluelist/length.md)
### Instance Methods
- [func item(UInt32) -> DOMCSSValue!](domcssvaluelist/item(_:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domcssvaluelist)*