...
### Instance Properties
- [var cols: String!](domhtmlframesetelement/cols.md)
- [var rows: String!](domhtmlframesetelement/rows.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domhtmlframesetelement)*