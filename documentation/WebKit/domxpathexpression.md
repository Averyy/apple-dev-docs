...
### Instance Methods
- [func evaluate(DOMNode!, type: UInt16, in: DOMXPathResult!) -> DOMXPathResult!](domxpathexpression/evaluate(_:type:in:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domxpathexpression)*