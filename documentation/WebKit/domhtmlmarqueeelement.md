...
### Instance Methods
- [func start()](domhtmlmarqueeelement/start.md)
- [func stop()](domhtmlmarqueeelement/stop.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domhtmlmarqueeelement)*