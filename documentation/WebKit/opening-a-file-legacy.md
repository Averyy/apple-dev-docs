...
### Opening a File (Legacy)
- [protocol WebOpenPanelResultListener](webopenpanelresultlistener.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/opening-a-file-legacy)*