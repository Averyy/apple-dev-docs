...
### Instance Properties
- [var defaultSelected: Bool](domhtmloptionelement/defaultselected.md)
- [var disabled: Bool](domhtmloptionelement/disabled.md)
- [var form: DOMHTMLFormElement!](domhtmloptionelement/form.md)
- [var index: Int32](domhtmloptionelement/index.md)
- [var label: String!](domhtmloptionelement/label.md)
- [var selected: Bool](domhtmloptionelement/selected.md)
- [var text: String!](domhtmloptionelement/text.md)
- [var value: String!](domhtmloptionelement/value.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domhtmloptionelement)*