...
### Instance Properties
- [var cssText: String!](domcssvalue/csstext.md)
- [var cssValueType: UInt16](domcssvalue/cssvaluetype.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domcssvalue)*