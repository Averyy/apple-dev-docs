...
### Instance Properties
- [var compact: Bool](domhtmlolistelement/compact.md)
- [var start: Int32](domhtmlolistelement/start.md)
- [var type: String!](domhtmlolistelement/type.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domhtmlolistelement)*