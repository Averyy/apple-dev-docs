...
### Instance Properties
- [var color: String!](domhtmlbasefontelement/color.md)
- [var face: String!](domhtmlbasefontelement/face.md)
- [var size: String!](domhtmlbasefontelement/size.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domhtmlbasefontelement)*