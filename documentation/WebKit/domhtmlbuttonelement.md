...
### Instance Properties
- [var autofocus: Bool](domhtmlbuttonelement/autofocus.md)
- [var disabled: Bool](domhtmlbuttonelement/disabled.md)
- [var form: DOMHTMLFormElement!](domhtmlbuttonelement/form.md)
- [var name: String!](domhtmlbuttonelement/name.md)
- [var type: String!](domhtmlbuttonelement/type.md)
- [var value: String!](domhtmlbuttonelement/value.md)
- [var willValidate: Bool](domhtmlbuttonelement/willvalidate.md)
### Instance Methods
- [func click()](domhtmlbuttonelement/click.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domhtmlbuttonelement)*