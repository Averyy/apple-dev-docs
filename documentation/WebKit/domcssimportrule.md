...
### Instance Properties
- [var href: String!](domcssimportrule/href.md)
- [var media: DOMMediaList!](domcssimportrule/media.md)
- [var styleSheet: DOMCSSStyleSheet!](domcssimportrule/stylesheet.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domcssimportrule)*