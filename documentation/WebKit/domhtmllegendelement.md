...
### Instance Properties
- [var align: String!](domhtmllegendelement/align.md)
- [var form: DOMHTMLFormElement!](domhtmllegendelement/form.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domhtmllegendelement)*