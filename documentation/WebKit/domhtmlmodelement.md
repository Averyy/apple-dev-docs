...
### Instance Properties
- [var cite: String!](domhtmlmodelement/cite.md)
- [var dateTime: String!](domhtmlmodelement/datetime.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domhtmlmodelement)*