...
The height returned by this method is used to calculate the rectangle passed to the [`webView(_:drawHeaderIn:)`](webuidelegate/webview(_:drawheaderin:).md) method.
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/webuidelegate/webviewheaderheight(_:))*