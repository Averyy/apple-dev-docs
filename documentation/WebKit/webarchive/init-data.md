...
Use the [`data`](webarchive/data.md) method to get the receiver’s data.
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/webarchive/init(data:))*