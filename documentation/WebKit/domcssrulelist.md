...
### Instance Properties
- [var length: UInt32](domcssrulelist/length.md)
### Instance Methods
- [func item(UInt32) -> DOMCSSRule!](domcssrulelist/item(_:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domcssrulelist)*