...
### Instance Properties
- [var disabled: Bool](domhtmloptgroupelement/disabled.md)
- [var label: String!](domhtmloptgroupelement/label.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domhtmloptgroupelement)*