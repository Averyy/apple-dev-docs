...
### Instance Properties
- [var length: UInt32](dommedialist/length.md)
- [var mediaText: String!](dommedialist/mediatext.md)
### Instance Methods
- [func appendMedium(String!)](dommedialist/appendmedium(_:).md)
- [func deleteMedium(String!)](dommedialist/deletemedium(_:).md)
- [func item(UInt32) -> String!](dommedialist/item(_:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/dommedialist)*