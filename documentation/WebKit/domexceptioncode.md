...
### Initializers
- [init(UInt32)](domexceptioncode/init(_:).md)
- [init(rawValue: UInt32)](domexceptioncode/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](domexceptioncode/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domexceptioncode)*