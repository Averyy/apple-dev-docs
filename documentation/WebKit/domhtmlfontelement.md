...
### Instance Properties
- [var color: String!](domhtmlfontelement/color.md)
- [var face: String!](domhtmlfontelement/face.md)
- [var size: String!](domhtmlfontelement/size.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domhtmlfontelement)*