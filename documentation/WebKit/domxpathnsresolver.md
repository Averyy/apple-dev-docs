...
### Instance Methods
- [func lookupNamespaceURI(String!) -> String!](domxpathnsresolver/lookupnamespaceuri(_:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domxpathnsresolver)*