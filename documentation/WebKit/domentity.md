...
### Instance Properties
- [var notationName: String!](domentity/notationname.md)
- [var publicId: String!](domentity/publicid.md)
- [var systemId: String!](domentity/systemid.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domentity)*