...
### Instance Properties
- [var alpha: DOMCSSPrimitiveValue!](domrgbcolor/alpha.md)
- [var blue: DOMCSSPrimitiveValue!](domrgbcolor/blue.md)
- [var color: NSColor!](domrgbcolor/color.md)
- [var green: DOMCSSPrimitiveValue!](domrgbcolor/green.md)
- [var red: DOMCSSPrimitiveValue!](domrgbcolor/red.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domrgbcolor)*