...
### Instance Properties
- [var form: DOMHTMLFormElement!](domhtmllabelelement/form.md)
- [var htmlFor: String!](domhtmllabelelement/htmlfor.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domhtmllabelelement)*