...
### Instance Properties
- [var length: UInt32](domfilelist/length.md)
### Instance Methods
- [func item(UInt32) -> DOMFile!](domfilelist/item(_:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domfilelist)*