...
```swift
@discardableResult
@MainActor final func load(_ request: URLRequest) -> some AsyncSequence<WebPage.NavigationEvent, any Error>
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/webpage/load(_:)-7kw3h)*