...
```swift
@discardableResult
@MainActor final func load(_ url: URL?) -> some AsyncSequence<WebPage.NavigationEvent, any Error>
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/webpage/load(_:)-8wfiq)*