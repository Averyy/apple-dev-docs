...
### Instance Properties
- [var wholeText: String!](domtext/wholetext.md)
### Instance Methods
- [func replaceWholeText(String!) -> DOMText!](domtext/replacewholetext(_:).md)
- [func splitText(UInt32) -> DOMText!](domtext/splittext(_:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/webkit/domtext)*