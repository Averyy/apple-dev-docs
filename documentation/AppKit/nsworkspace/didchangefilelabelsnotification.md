...
To observe this notification using Swift concurrency, use [`NSWorkspace.DidChangeFileLabelsMessage`](nsworkspace/didchangefilelabelsmessage.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsworkspace/didchangefilelabelsnotification)*