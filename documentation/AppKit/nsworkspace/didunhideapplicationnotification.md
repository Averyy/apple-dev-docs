...
The notification object is the shared [`NSWorkspace`](nsworkspace.md) instance. The `userInfo` dictionary contains the [`applicationUserInfoKey`](nsworkspace/applicationuserinfokey.md) key with a corresponding instance of [`NSRunningApplication`](nsrunningapplication.md) that represents the affected app.
...
To observe this notification using Swift concurrency, use [`NSWorkspace.DidUnhideApplicationMessage`](nsworkspace/didunhideapplicationmessage.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsworkspace/didunhideapplicationnotification)*