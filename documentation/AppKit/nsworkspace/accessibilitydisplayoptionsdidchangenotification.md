...
To observe this notification using Swift concurrency, use [`NSWorkspace.AccessibilityDisplayOptionsDidChangeMessage`](nsworkspace/accessibilitydisplayoptionsdidchangemessage.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsworkspace/accessibilitydisplayoptionsdidchangenotification)*