...
To observe this notification using Swift concurrency, use [`NSWorkspace.ActiveSpaceDidChangeMessage`](nsworkspace/activespacedidchangemessage.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsworkspace/activespacedidchangenotification)*