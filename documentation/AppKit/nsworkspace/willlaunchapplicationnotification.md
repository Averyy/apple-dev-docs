...
To observe this notification using Swift concurrency, use [`NSWorkspace.WillLaunchApplicationMessage`](nsworkspace/willlaunchapplicationmessage.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsworkspace/willlaunchapplicationnotification)*