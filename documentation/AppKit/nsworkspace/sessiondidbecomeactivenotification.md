...
To observe this notification using Swift concurrency, use [`NSWorkspace.SessionDidBecomeActiveMessage`](nsworkspace/sessiondidbecomeactivemessage.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsworkspace/sessiondidbecomeactivenotification)*