...
To observe this notification using Swift concurrency, use [`NSWorkspace.WillSleepMessage`](nsworkspace/willsleepmessage.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsworkspace/willsleepnotification)*