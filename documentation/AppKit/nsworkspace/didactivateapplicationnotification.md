...
To observe this notification using Swift concurrency, use [`NSWorkspace.DidActivateApplicationMessage`](nsworkspace/didactivateapplicationmessage.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsworkspace/didactivateapplicationnotification)*