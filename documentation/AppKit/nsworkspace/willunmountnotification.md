...
To observe this notification using Swift concurrency, use [`NSWorkspace.WillUnmountVolumeMessage`](nsworkspace/willunmountvolumemessage.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsworkspace/willunmountnotification)*