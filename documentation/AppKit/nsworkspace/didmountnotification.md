...
The notification object is the shared [`NSWorkspace`](nsworkspace.md) instance.
...
To observe this notification using Swift concurrency, use [`NSWorkspace.DidMountVolumeMessage`](nsworkspace/didmountvolumemessage.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsworkspace/didmountnotification)*