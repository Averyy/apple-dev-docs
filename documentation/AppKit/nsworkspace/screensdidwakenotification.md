...
To observe this notification using Swift concurrency, use [`NSWorkspace.ScreensDidWakeMessage`](nsworkspace/screensdidwakemessage.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsworkspace/screensdidwakenotification)*