# NSWorkspace.DidUnhideApplicationMessage
...
```swift
struct DidUnhideApplicationMessage
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsworkspace/didunhideapplicationmessage)*