...
- [NSRectAlignment.trailing](nsrectalignment/trailing.md)
...
### Initializers
- [init?(rawValue: Int)](nsrectalignment/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsrectalignment)*