...
### Structures
- [NSVerticalDirection.Set](nsverticaldirection/set.md)
  An efficient set of vertical directions.
### Enumeration Cases
- [NSVerticalDirection.down](nsverticaldirection/down.md)
  The downward direction.
- [NSVerticalDirection.up](nsverticaldirection/up.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsverticaldirection)*