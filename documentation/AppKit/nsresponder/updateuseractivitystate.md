...
Subclasses override this method to update the state of the supplied `userActivity`. Add state representing the user’s activity into `userActivity` using its [`addUserInfoEntries(from:)`](https://developer.apple.com/documentation/foundation/nsuseractivity/1410066-adduserinfoentries) method. When the state is dirty, set the [`needsSave`](https://developer.apple.com/documentation/foundation/nsuseractivity/1408791-needssave) property to [`true`](https://developer.apple.com/documentation/swift/true).
