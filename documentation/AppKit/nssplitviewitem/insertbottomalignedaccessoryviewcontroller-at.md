...
```swift
func insertBottomAlignedAccessoryViewController(_ childViewController: NSSplitViewItemAccessoryViewController, at index: Int)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nssplitviewitem/insertbottomalignedaccessoryviewcontroller(_:at:))*