...
```swift
func removeTopAlignedAccessoryViewController(at index: Int)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nssplitviewitem/removetopalignedaccessoryviewcontroller(at:))*