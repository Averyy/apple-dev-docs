...
```swift
func addBottomAlignedAccessoryViewController(_ childViewController: NSSplitViewItemAccessoryViewController)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nssplitviewitem/addbottomalignedaccessoryviewcontroller(_:))*