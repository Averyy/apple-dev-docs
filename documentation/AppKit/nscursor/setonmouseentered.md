...
Accepting [`mouseEntered(with:)`](nscursor/mouseentered(with:).md) event messages allows the cursor to be made the current cursor when the cursor enters a view’s cursor rectangle.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nscursor/setonmouseentered(_:))*