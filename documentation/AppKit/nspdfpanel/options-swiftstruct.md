...
- [static var showsOrientation: NSPDFPanel.Options](nspdfpanel/options-swift.struct/showsorientation.md)
...
### Initializers
- [init(rawValue: Int)](nspdfpanel/options-swift.struct/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nspdfpanel/options-swift.struct)*