...
The key-value pairs in this dictionary are used by the [`quotes`](nsspellchecker/optionkey/quotes.md) when replacing characters and words.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsspellchecker/userreplacementsdictionary)*