...
Invoke this method before [`closeSpellDocument(withTag:)`](nsspellchecker/closespelldocument(withtag:).md) if you want to store the ignored words.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsspellchecker/ignoredwords(inspelldocumentwithtag:))*