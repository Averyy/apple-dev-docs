...
- `options`: The marker options for the text list. Values for `mask` are listed in Constants.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nstextlist/init(markerformat:options:))*