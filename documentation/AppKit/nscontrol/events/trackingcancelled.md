...
```swift
static var trackingCancelled: NSControl.Events { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nscontrol/events/trackingcancelled)*