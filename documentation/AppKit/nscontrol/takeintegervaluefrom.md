...
- `sender`: The object from which to take the value. This object must respond to the [`floatValue`](nscontrol/floatvalue.md) message.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nscontrol/takeintegervaluefrom(_:))*