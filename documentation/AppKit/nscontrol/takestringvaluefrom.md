...
- `sender`: The object from which to take the value. This object must respond to the [`stringValue`](nscontrol/stringvalue.md) property.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nscontrol/takestringvaluefrom(_:))*