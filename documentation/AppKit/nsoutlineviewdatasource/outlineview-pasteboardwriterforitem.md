...
```swift
@MainActor
optional func outlineView(_ outlineView: NSOutlineView, pasteboardWriterForItem item: Any) -> (any NSPasteboardWriting)?
```
...
If this method is implemented, then [`outlineView(_:writeItems:to:)`](nsoutlineviewdatasource/outlineview(_:writeitems:to:).md) is not called.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsoutlineviewdatasource/outlineview(_:pasteboardwriterforitem:))*