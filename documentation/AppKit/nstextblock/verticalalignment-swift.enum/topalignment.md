...
```swift
static var topAlignment: NSTextBlock.VerticalAlignment { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nstextblock/verticalalignment-swift.enum/topalignment)*