...
```swift
func setBorderColor(_ borderColor: NSColor?, rectEdge: CGRectEdge)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nstextblock/setbordercolor(_:rectedge:))*