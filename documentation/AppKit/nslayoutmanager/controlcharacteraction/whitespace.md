...
The width for a glyph with this action is determined by the delegate method [`layoutManager(_:shouldUse:forControlCharacterAt:)`](nslayoutmanagerdelegate/layoutmanager(_:shoulduse:forcontrolcharacterat:).md) if the method is implemented; otherwise, same as `NSControlCharacterZeroAdvancementAction`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nslayoutmanager/controlcharacteraction/whitespace)*