...
If you don’t need the longest effective range, it’s far more efficient to use the [`temporaryAttributes(atCharacterIndex:effectiveRange:)`](nslayoutmanager/temporaryattributes(atcharacterindex:effectiverange:).md) method to retrieve the attribute value.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nslayoutmanager/temporaryattributes(atcharacterindex:longesteffectiverange:in:))*