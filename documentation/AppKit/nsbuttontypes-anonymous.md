...
### Constants
- [var NSCancelButton: Int](nscancelbutton.md)
  The Cancel button
- [var NSOKButton: Int](nsokbutton.md)
  The OK button
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsbuttontypes-anonymous)*