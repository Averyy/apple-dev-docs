...
For design guidance, see [`Human Interface Guidelines`](https://developer.apple.comhttps://developer.apple.com/design/human-interface-guidelines/macos/visual-design/color#dynamic-system-colors).
...
- [class var tertiaryLabelColor: NSColor](nscolor/tertiarylabelcolor.md)
...
- [class var textBackgroundColor: NSColor](nscolor/textbackgroundcolor.md)
...
- [class var selectedContentBackgroundColor: NSColor](nscolor/selectedcontentbackgroundcolor.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/ui-element-colors)*