...
See [`NSTextFinder`](nstextfinder.md) for information about the find bar.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nstextview/isincrementalsearchingenabled)*