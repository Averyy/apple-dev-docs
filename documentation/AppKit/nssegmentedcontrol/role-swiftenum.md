...
### Initializers
- [init?(rawValue: Int)](nssegmentedcontrol/role-swift.enum/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nssegmentedcontrol/role-swift.enum)*