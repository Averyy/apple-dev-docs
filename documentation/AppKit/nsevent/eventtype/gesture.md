...
[`NSEvent.EventType.gesture`](nsevent/eventtype/gesture.md) represents a gesture that is not otherwise specified by a type such as [`NSEvent.EventType.magnify`](nsevent/eventtype/magnify.md), [`NSEvent.EventType.swipe`](nsevent/eventtype/swipe.md), [`NSEvent.EventType.rotate`](nsevent/eventtype/rotate.md), [`NSEvent.EventType.beginGesture`](nsevent/eventtype/begingesture.md), or [`NSEvent.EventType.endGesture`](nsevent/eventtype/endgesture.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsevent/eventtype/gesture)*