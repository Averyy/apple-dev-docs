...
Use this mask to filter out [`NSEvent.EventType.directTouch`](nsevent/eventtype/directtouch.md) events.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsevent/eventtypemask/directtouch)*