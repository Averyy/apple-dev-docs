...
For design guidance, see [`Human Interface Guidelines`](https://developer.apple.comhttps://developer.apple.com/design/human-interface-guidelines/macos/visual-design/color#system-colors).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/standard-colors)*