...
### View
- [class NSTokenField](nstokenfield.md)
  A text field that converts text into visually distinct tokens.
### Management
- [protocol NSTokenFieldDelegate](nstokenfielddelegate.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/token-field)*