...
All columns are resized to the same size, up to a column’s maximum size. This method then invokes [`tile()`](nstableview/tile().md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nstableview/sizetofit())*