...
The index in the [`tableColumns`](nstableview/tablecolumns.md) array of the column `aPoint` lies in, or `–1` if `aPoint` lies outside the table view’s bounds.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nstableview/column(at:))*