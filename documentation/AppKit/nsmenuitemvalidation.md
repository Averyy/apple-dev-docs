...
- [func validateMenuItem(NSMenuItem) -> Bool](nsmenuitemvalidation/validatemenuitem(_:).md)
...
- [NSFontManager](nsfontmanager.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsmenuitemvalidation)*