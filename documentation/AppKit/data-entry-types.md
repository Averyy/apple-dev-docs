...
These constants are used by [`setEntryType:`](nscell/setentrytype:.md) and [`entryType`](nscell/entrytype.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/data-entry-types)*