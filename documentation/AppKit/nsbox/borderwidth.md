...
The receiver’s border width. It must be a custom box—that is, it has a type of [`NSBox.BoxType.custom`](nsbox/boxtype-swift.enum/custom.md)—and it must have a border style of [`NSBorderType.lineBorder`](nsbordertype/lineborder.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsbox/borderwidth)*