...
Use these constants as values for the [`location`](nsaccessibility-swift.struct/annotationattributekey/location.md) key.

## Topics

### Constants
- [NSAccessibilityAnnotationPosition.fullRange](nsaccessibilityannotationposition/fullrange.md)
- [NSAccessibilityAnnotationPosition.start](nsaccessibilityannotationposition/start.md)
- [NSAccessibilityAnnotationPosition.end](nsaccessibilityannotationposition/end.md)
### Initializers
- [init?(rawValue: Int)](nsaccessibilityannotationposition/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsaccessibilityannotationposition)*