...
The default alignments are `NSTickMarkBelow` and `NSTickMarkLeft`. This property has no effect if no tick marks have been assigned (that is, [`numberOfTickMarks`](nslevelindicator/numberoftickmarks.md) returns 0).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nslevelindicator/tickmarkposition)*