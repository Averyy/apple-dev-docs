...
### View
- [class NSSearchField](nssearchfield.md)
  A text field optimized for performing text-based searches.
### Cell
- [class NSSearchFieldCell](nssearchfieldcell.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/search-field)*