...
To observe this notification using Swift concurrency, use [`NSApplication.WillHideMessage`](nsapplication/willhidemessage.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsapplication/willhidenotification)*