...
To observe this notification using Swift concurrency, use [`NSApplication.DidUnhideMessage`](nsapplication/didunhidemessage.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsapplication/didunhidenotification)*