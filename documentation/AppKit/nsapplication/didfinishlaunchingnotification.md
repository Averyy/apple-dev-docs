...
The notification object is [`shared`](nsapplication/shared.md). See [`NSApplicationDidFinishLaunching User Info Keys`](nsapplicationdidfinishlaunching-user-info-keys.md) for the possible `userInfo` keys and values. The system posts this notification on the main actor.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsapplication/didfinishlaunchingnotification)*