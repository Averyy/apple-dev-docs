...
The notification object is [`shared`](nsapplication/shared.md). See [`NSApplicationDidFinishLaunching User Info Keys`](nsapplicationdidfinishlaunching-user-info-keys.md) for the possible `userInfo` keys and values.
