...
To observe this notification using Swift concurrency, use [`NSApplication.WillFinishLaunchingMessage`](nsapplication/willfinishlaunchingmessage.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsapplication/willfinishlaunchingnotification)*