...
To observe this notification using Swift concurrency, use [`NSApplication.DidResignActiveMessage`](nsapplication/didresignactivemessage.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsapplication/didresignactivenotification)*