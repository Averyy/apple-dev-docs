...
To observe this notification using Swift concurrency, use [`NSApplication.DidHideMessage`](nsapplication/didhidemessage.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsapplication/didhidenotification)*