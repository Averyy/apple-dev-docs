...
```swift
@NSCopying
class var hideText: NSUserInterfaceCompressionOptions { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsuserinterfacecompressionoptions/hidetext)*