...
```swift
@NSCopying
@MainActor class var valueReset: NSSliderAccessoryBehavior { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsslideraccessorybehavior/valuereset)*