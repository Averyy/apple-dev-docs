...
Using an autosave backup file for preserving versions is efficient. This is because an [`NSDocument`](nsdocument.md) instance is able to use the [`byMoving`](https://developer.apple.com/documentation/foundation/nsfileversion/replacingoptions/1416449-bymoving) option when it calls the [`replaceItem(at:options:)`](https://developer.apple.com/documentation/foundation/nsfileversion/1412297-replaceitem) method. The document gets the value of this property twice during saving:
