...
The system color used for scroll bars. For more information, see [`NSColor`](nscolor.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nscolor/scrollbarcolor)*