...
### Initializers
- [init?(rawValue: Int)](nstoolbaritemgroup/role-swift.enum/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nstoolbaritemgroup/role-swift.enum)*