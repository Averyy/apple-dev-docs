...
### Constants
- [class let oldScaleFactorUserInfoKey: String](nswindow/oldscalefactoruserinfokey.md)
  An NSNumber containing the old scale factor.
- [class let oldColorSpaceUserInfoKey: String](nswindow/oldcolorspaceuserinfokey.md)
  An [`NSColorSpace`](nscolorspace.md) instance containing the old colorspace.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nswindowdidchangebackingpropertiesnotification-user-info-properties)*