...
```swift
var tabPosition: NSTabView.TabPosition { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nstabview/tabposition-swift.property)*