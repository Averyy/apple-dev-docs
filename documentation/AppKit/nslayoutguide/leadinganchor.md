...
Use this anchor to create constraints with the layout guide’s leading edge. You can combine this anchor only with a subset of the [`NSLayoutXAxisAnchor`](https://developer.apple.com/documentation/UIKit/NSLayoutXAxisAnchor) anchors. You can combine a [`leadingAnchor`](nslayoutguide/leadinganchor.md) with another `leadingAnchor`, a `trailingAnchor`, or a `centerXAnchor`. For more information, see [`NSLayoutAnchor`](https://developer.apple.com/documentation/UIKit/NSLayoutAnchor).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nslayoutguide/leadinganchor)*