...
- `spacing`: The spacing between entries, measured in points in the user coordinate space.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsform/setinterlinespacing(_:))*