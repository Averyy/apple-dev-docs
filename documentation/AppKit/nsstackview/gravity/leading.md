...
For a left to right layout direction, the leading gravity area is on the left. Use only when the value of the [`orientation`](nsstackview/orientation.md) property is [`NSUserInterfaceLayoutOrientation.horizontal`](nsuserinterfacelayoutorientation/horizontal.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsstackview/gravity/leading)*