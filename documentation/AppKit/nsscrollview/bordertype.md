...
See [`NSBorderType`](nsbordertype.md) for a list of possible values.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsscrollview/bordertype)*