...
The view’s graphics state object will be regenerated using [`setUpGState()`](nsview/setupgstate().md) the next time the view is focused for drawing
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsview/renewgstate())*