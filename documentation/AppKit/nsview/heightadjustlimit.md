...
The value of this property is a floating point number in the range `0.0` to `1.0`. This fraction is used to calculate the bottom edge limit for an [`adjustPageHeightNew(_:top:bottom:limit:)`](nsview/adjustpageheightnew(_:top:bottom:limit:).md) message.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsview/heightadjustlimit)*