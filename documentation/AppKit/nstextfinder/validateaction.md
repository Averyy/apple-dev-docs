...
This method should be called by an implementation of [`validateUserInterfaceItem(_:)`](nsuserinterfacevalidations/validateuserinterfaceitem(_:).md) to properly validate items with an action of [`performTextFinderAction(_:)`](nsresponder/performtextfinderaction(_:).md). The responder’s [`validateUserInterfaceItem(_:)`](nsuserinterfacevalidations/validateuserinterfaceitem(_:).md) or [`validateMenuItem:`](https://developer.apple.com/documentation/objectivec/nsobject/1518160-validatemenuitem) implementation should pass the tag as the action for this method..
