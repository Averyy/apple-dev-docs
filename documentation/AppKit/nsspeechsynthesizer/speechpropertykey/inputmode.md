...
A string object that specifies whether the channel is currently in text input mode or phoneme input mode.The supported values are listed in [`NSSpeechSynthesizer.SpeechPropertyKey.Mode`](nsspeechsynthesizer/speechpropertykey/mode.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsspeechsynthesizer/speechpropertykey/inputmode)*