...
To observe this notification using Swift concurrency, use [`NSHelpManager.ContextHelpModeDidDeactivateMessage`](nshelpmanager/contexthelpmodediddeactivatemessage.md).
