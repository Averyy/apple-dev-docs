...
Use of this image is discouraged; instead, use [`networkName`](nsimage/networkname.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsimage/mobilemename)*