...
### Orientations
- [static let horizontal: NSAccessibility.OrientationValue](nsaccessibility-swift.struct/orientationvalue/horizontal.md)
  The element is oriented horizontally.
- [static let vertical: NSAccessibility.OrientationValue](nsaccessibility-swift.struct/orientationvalue/vertical.md)
  The element is oriented vertically.
- [static let unknown: NSAccessibility.OrientationValue](nsaccessibility-swift.struct/orientationvalue/unknown.md)
  The element has unknown orientation.
### Initializers
- [init(rawValue: String)](nsaccessibility-swift.struct/orientationvalue/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsaccessibility-swift.struct/orientationvalue)*