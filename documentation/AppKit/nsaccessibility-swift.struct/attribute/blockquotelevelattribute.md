...
```swift
static let blockQuoteLevelAttribute: NSAccessibility.Attribute
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsaccessibility-swift.struct/attribute/blockquotelevelattribute)*