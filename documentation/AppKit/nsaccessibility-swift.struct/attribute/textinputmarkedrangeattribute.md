...
```swift
static let textInputMarkedRangeAttribute: NSAccessibility.Attribute
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsaccessibility-swift.struct/attribute/textinputmarkedrangeattribute)*