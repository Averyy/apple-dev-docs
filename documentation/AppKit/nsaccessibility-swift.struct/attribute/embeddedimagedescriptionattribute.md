# embeddedImageDescriptionAttribute
...
```swift
static let embeddedImageDescriptionAttribute: NSAccessibility.Attribute
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsaccessibility-swift.struct/attribute/embeddedimagedescriptionattribute)*