...
```swift
static let pathAttribute: NSAccessibility.Attribute
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsaccessibility-swift.struct/attribute/pathattribute)*