...
```swift
static let NSAccessibilityDraggingDestinationDropAllowed: NSAccessibility.Notification
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsaccessibility-swift.struct/notification/nsaccessibilitydraggingdestinationdropallowed)*