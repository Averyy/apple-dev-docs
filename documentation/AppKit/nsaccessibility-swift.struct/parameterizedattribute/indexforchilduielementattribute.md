# indexForChildUIElementAttribute
...
```swift
static let indexForChildUIElementAttribute: NSAccessibility.ParameterizedAttribute
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsaccessibility-swift.struct/parameterizedattribute/indexforchilduielementattribute)*