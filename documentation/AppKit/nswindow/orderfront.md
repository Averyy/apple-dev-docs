...
The default animation based on the window type will be used when the window is ordered front unless it has been modified by the [`animationBehavior`](nswindow/animationbehavior-swift.property.md) property.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nswindow/orderfront(_:))*