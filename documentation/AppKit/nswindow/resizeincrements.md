...
Resize increments and aspect ratio are mutually exclusive attributes. For more information, see [`aspectRatio`](nswindow/aspectratio.md).

The [`contentResizeIncrements`](nswindow/contentresizeincrements.md) property takes precedence over this property.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nswindow/resizeincrements)*