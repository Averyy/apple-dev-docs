...
To avoid unnecessary flushing, use this method rather than [`flush()`](nswindow/flush().md) to flush an `NSWindow` object after flushing has been reenabled.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nswindow/flushifneeded())*