...
### Modes
- [NSWindow.TabbingMode.automatic](nswindow/tabbingmode-swift.enum/automatic.md)
...
### Initializers
- [init?(rawValue: Int)](nswindow/tabbingmode-swift.enum/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nswindow/tabbingmode-swift.enum)*