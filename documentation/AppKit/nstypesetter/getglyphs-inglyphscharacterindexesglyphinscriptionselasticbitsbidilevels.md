...
- `bidiLevelBuffer`: Contains the bidirectional level value generated by  , in case a subclass chooses to use this value.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nstypesetter/getglyphs(in:glyphs:characterindexes:glyphinscriptions:elasticbits:bidilevels:))*