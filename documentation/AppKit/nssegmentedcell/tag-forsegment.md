...
- `segment`: The index of the segment whose tool tag you want to get. This method raises an exception ( ) if the index is out of bounds.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nssegmentedcell/tag(forsegment:))*