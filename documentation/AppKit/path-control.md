...
### View
- [class NSPathControl](nspathcontrol.md)
  A display of a file system path or virtual path information.
### Management
- [protocol NSPathControlDelegate](nspathcontroldelegate.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/path-control)*