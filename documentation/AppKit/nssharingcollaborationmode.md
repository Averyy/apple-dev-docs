...
### Initializers
- [init?(rawValue: Int)](nssharingcollaborationmode/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nssharingcollaborationmode)*