...
- If you used the [`register(_:forSupplementaryViewOfKind:withIdentifier:)`](nscollectionview/register(_:forsupplementaryviewofkind:withidentifier:)-3dqa.md) method to register a class for the identifier, this method instantiates your view class and returns it.
- If you used the [`register(_:forSupplementaryViewOfKind:withIdentifier:)`](nscollectionview/register(_:forsupplementaryviewofkind:withidentifier:)-7gvf2.md) method to register a nib file for the identifier, this method loads the view from the nib file and returns it.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nscollectionview/makesupplementaryview(ofkind:withidentifier:for:))*