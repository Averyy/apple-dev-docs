...
The row’s cells are autoreleased. This method redraws the receiver. Your code should normally send [`sizeToCells()`](nsmatrix/sizetocells().md) after invoking this method to resize the receiver so it fits the reduced cell count.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsmatrix/removerow(_:))*