...
If the number of rows or columns in the receiver has been changed with [`renewRows(_:columns:)`](nsmatrix/renewrows(_:columns:).md), new cells are created only if they’re needed. This fact allows you to grow and shrink an [`NSMatrix`](nsmatrix.md) without repeatedly creating and freeing the cells.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsmatrix/insertcolumn(_:))*