...
```swift
static var table: NSWritingToolsResultOptions { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nswritingtoolsresultoptions/table)*