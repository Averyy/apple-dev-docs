...
```swift
static var plainText: NSWritingToolsResultOptions { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nswritingtoolsresultoptions/plaintext)*