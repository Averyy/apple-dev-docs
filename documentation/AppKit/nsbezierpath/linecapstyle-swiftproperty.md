...
The line cap style specifies the shape of the endpoints on an open path when stroked. The default value of this property is the value returned by the [`defaultLineCapStyle`](nsbezierpath/defaultlinecapstyle.md) method.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsbezierpath/linecapstyle-swift.property)*