...
In macOS 10.6 and later, use [`rtf`](nspasteboard/pasteboardtype/rtf.md) instead.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nspasteboard/pasteboardtype/rtf)*