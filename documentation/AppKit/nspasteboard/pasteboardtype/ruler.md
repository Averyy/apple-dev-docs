...
In macOS 10.6 and later, use [`ruler`](nspasteboard/pasteboardtype/ruler.md) instead.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nspasteboard/pasteboardtype/ruler)*