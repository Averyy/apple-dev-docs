...
Used with the [`propertyList(forType:)`](nspasteboard/propertylist(fortype:).md) method of [`NSPasteboard`](nspasteboard.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nspasteboard/pasteboardtype/findpanelsearchoptions)*