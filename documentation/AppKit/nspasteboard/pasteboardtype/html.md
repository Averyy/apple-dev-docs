...
In macOS 10.6 and later, use [`html`](nspasteboard/pasteboardtype/html.md) instead.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nspasteboard/pasteboardtype/html)*