...
In macOS 10.6 and later, use [`pdf`](nspasteboard/pasteboardtype/pdf.md) instead.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nspasteboard/pasteboardtype/pdf)*