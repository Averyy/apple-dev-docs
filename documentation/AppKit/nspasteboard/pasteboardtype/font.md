...
In macOS 10.6 and later, use [`font`](nspasteboard/pasteboardtype/font.md) instead.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nspasteboard/pasteboardtype/font)*