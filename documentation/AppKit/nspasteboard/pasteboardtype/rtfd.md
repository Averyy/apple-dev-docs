...
In macOS 10.6 and later, use [`rtfd`](nspasteboard/pasteboardtype/rtfd.md) instead.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nspasteboard/pasteboardtype/rtfd)*