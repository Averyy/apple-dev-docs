...
### Constants
- [NSCell.CellType.nullCellType](nscell/celltype/nullcelltype.md)
  Cell displays nothing.
- [NSCell.CellType.textCellType](nscell/celltype/textcelltype.md)
  Cell displays text.
- [NSCell.CellType.imageCellType](nscell/celltype/imagecelltype.md)
  Cell displays images.
### Initializers
- [init?(rawValue: UInt)](nscell/celltype/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nscell/celltype)*