...
The value in this property can also be modified when you change the value of the [`wraps`](nscell/wraps.md) property. For a list of supported line break modes, see NSLineBreakMode.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nscell/linebreakmode)*