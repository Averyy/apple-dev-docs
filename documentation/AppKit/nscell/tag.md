...
The default value of this property is `-1`. Setting the value of this property raises with [`internalInconsistencyException`](https://developer.apple.com/documentation/foundation/nsexceptionname/1416220-internalinconsistencyexception). Subclasses are expected to override this property if they support tags. The [`NSActionCell`](nsactioncell.md) class implements this property and stores the integer you specify.
