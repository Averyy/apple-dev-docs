...
To observe this notification using Swift concurrency, use [`NSMenu.WillSendActionMessage`](nsmenu/willsendactionmessage.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsmenu/willsendactionnotification)*