...
`NSAutoPagination`, `NSFitPagination`, or `NSClipPagination`. See [`verticalPagination`](nsprintinfo/verticalpagination.md) for details.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsprintinfo/attributekey/verticalpagination)*