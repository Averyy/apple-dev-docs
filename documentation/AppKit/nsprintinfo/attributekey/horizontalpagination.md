...
`NSAutoPagination`, `NSFitPagination`, or `NSClipPagination`. See [`horizontalPagination`](nsprintinfo/horizontalpagination.md) for details.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsprintinfo/attributekey/horizontalpagination)*