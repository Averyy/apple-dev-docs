...
`NSPrintSpoolJob`, `NSPrintPreviewJob`, `NSPrintSaveJob`, or `NSPrintCancelJob`. See [`jobDisposition`](nsprintinfo/jobdisposition-swift.property.md) for details.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsprintinfo/attributekey/jobdisposition)*