...
```swift
static var texturedRounded: NSButton.BezelStyle { get }
```
...
- [static var rounded: NSButton.BezelStyle](nsbutton/bezelstyle-swift.enum/rounded.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsbutton/bezelstyle-swift.enum/texturedrounded)*