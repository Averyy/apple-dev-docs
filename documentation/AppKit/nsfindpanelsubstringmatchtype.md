...
### Initializers
- [init?(rawValue: UInt)](nsfindpanelsubstringmatchtype/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsfindpanelsubstringmatchtype)*