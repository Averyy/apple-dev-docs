...
If `fontSize` is 0 or negative, returns the title bar font at the default size. This method is equivalent to [`boldSystemFont(ofSize:)`](nsfont/boldsystemfont(ofsize:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appkit/nsfont/titlebarfont(ofsize:))*