...
### Enumeration Cases
- [USDStage.InitialLoadRule.all](usdstage-4sfi1/initialloadrule/all.md)
  Load all loadable prims.
- [USDStage.InitialLoadRule.none](usdstage-4sfi1/initialloadrule/none.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/usdkit/usdstage-4sfi1/initialloadrule)*