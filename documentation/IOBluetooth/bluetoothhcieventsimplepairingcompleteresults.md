...
### Initializers
- [init()](bluetoothhcieventsimplepairingcompleteresults/init.md)
- [init(deviceAddress: BluetoothDeviceAddress)](bluetoothhcieventsimplepairingcompleteresults/init(deviceaddress:).md)
### Instance Properties
- [var deviceAddress: BluetoothDeviceAddress](bluetoothhcieventsimplepairingcompleteresults/deviceaddress.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcieventsimplepairingcompleteresults)*