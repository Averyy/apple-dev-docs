...
### Constants
- [var kInquiryScanDisabledPageScanEnabled: BluetoothHCIPageScanEnableStates](kinquiryscandisabledpagescanenabled.md)
- [var kInquiryScanEnabledPageScanDisabled: BluetoothHCIPageScanEnableStates](kinquiryscanenabledpagescandisabled.md)
- [var kInquiryScanEnabledPageScanEnabled: BluetoothHCIPageScanEnableStates](kinquiryscanenabledpagescanenabled.md)
- [var kNoScansEnabled: BluetoothHCIPageScanEnableStates](knoscansenabled.md)
### Initializers
- [init(UInt32)](bluetoothhcipagescanenablestates/init(_:).md)
- [init(rawValue: UInt32)](bluetoothhcipagescanenablestates/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothhcipagescanenablestates/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcipagescanenablestates)*