...
### Initializers
- [init()](bluetoothhcieventauthenticationcompleteresults/init.md)
- [init(connectionHandle: BluetoothConnectionHandle)](bluetoothhcieventauthenticationcompleteresults/init(connectionhandle:).md)
### Instance Properties
- [var connectionHandle: BluetoothConnectionHandle](bluetoothhcieventauthenticationcompleteresults/connectionhandle.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcieventauthenticationcompleteresults)*