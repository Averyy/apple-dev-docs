...
### Initializers
- [init?(rawValue: UInt)](iobluetoothhandsfreesmssupport/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/iobluetoothhandsfreesmssupport)*