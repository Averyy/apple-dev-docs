...
### Initializers
- [init()](bluetoothhciversioninfo/init.md)
- [init(manufacturerName: BluetoothManufacturerName, lmpVersion: BluetoothLMPVersion, lmpSubVersion: BluetoothLMPSubversion, hciVersion: UInt8, hciRevision: UInt16)](bluetoothhciversioninfo/init(manufacturername:lmpversion:lmpsubversion:hciversion:hcirevision:).md)
### Instance Properties
- [var hciRevision: UInt16](bluetoothhciversioninfo/hcirevision.md)
- [var hciVersion: UInt8](bluetoothhciversioninfo/hciversion.md)
- [var lmpSubVersion: BluetoothLMPSubversion](bluetoothhciversioninfo/lmpsubversion.md)
- [var lmpVersion: BluetoothLMPVersion](bluetoothhciversioninfo/lmpversion.md)
- [var manufacturerName: BluetoothManufacturerName](bluetoothhciversioninfo/manufacturername.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhciversioninfo)*