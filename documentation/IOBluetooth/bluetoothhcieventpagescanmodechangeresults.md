...
### Initializers
- [init()](bluetoothhcieventpagescanmodechangeresults/init.md)
- [init(deviceAddress: BluetoothDeviceAddress, pageScanMode: BluetoothPageScanMode)](bluetoothhcieventpagescanmodechangeresults/init(deviceaddress:pagescanmode:).md)
### Instance Properties
- [var deviceAddress: BluetoothDeviceAddress](bluetoothhcieventpagescanmodechangeresults/deviceaddress.md)
- [var pageScanMode: BluetoothPageScanMode](bluetoothhcieventpagescanmodechangeresults/pagescanmode.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcieventpagescanmodechangeresults)*