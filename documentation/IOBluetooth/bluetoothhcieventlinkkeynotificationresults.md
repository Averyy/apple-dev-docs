...
### Initializers
- [init()](bluetoothhcieventlinkkeynotificationresults/init.md)
- [init(deviceAddress: BluetoothDeviceAddress, linkKey: BluetoothKey, keyType: BluetoothKeyType)](bluetoothhcieventlinkkeynotificationresults/init(deviceaddress:linkkey:keytype:).md)
### Instance Properties
- [var deviceAddress: BluetoothDeviceAddress](bluetoothhcieventlinkkeynotificationresults/deviceaddress.md)
- [var keyType: BluetoothKeyType](bluetoothhcieventlinkkeynotificationresults/keytype.md)
- [var linkKey: BluetoothKey](bluetoothhcieventlinkkeynotificationresults/linkkey.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcieventlinkkeynotificationresults)*