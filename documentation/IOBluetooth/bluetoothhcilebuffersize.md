...
### Initializers
- [init()](bluetoothhcilebuffersize/init.md)
- [init(ACLDataPacketLength: UInt16, totalNumACLDataPackets: UInt8)](bluetoothhcilebuffersize/init(acldatapacketlength:totalnumacldatapackets:).md)
### Instance Properties
- [var ACLDataPacketLength: UInt16](bluetoothhcilebuffersize/acldatapacketlength.md)
- [var totalNumACLDataPackets: UInt8](bluetoothhcilebuffersize/totalnumacldatapackets.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcilebuffersize)*