...
### Constants
- [var kBluetoothL2CAPInformationResultNotSupported: BluetoothL2CAPInformationResult](kbluetoothl2capinformationresultnotsupported.md)
- [var kBluetoothL2CAPInformationResultSuccess: BluetoothL2CAPInformationResult](kbluetoothl2capinformationresultsuccess.md)
### Initializers
- [init(UInt32)](bluetoothl2capinformationresult/init(_:).md)
- [init(rawValue: UInt32)](bluetoothl2capinformationresult/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothl2capinformationresult/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothl2capinformationresult)*