...
### Initializers
- [init()](bluetoothhcibuffersize/init.md)
- [init(ACLDataPacketLength: UInt16, SCODataPacketLength: UInt8, totalNumACLDataPackets: UInt16, totalNumSCODataPackets: UInt16)](bluetoothhcibuffersize/init(acldatapacketlength:scodatapacketlength:totalnumacldatapackets:totalnumscodatapackets:).md)
### Instance Properties
- [var ACLDataPacketLength: UInt16](bluetoothhcibuffersize/acldatapacketlength.md)
- [var SCODataPacketLength: UInt8](bluetoothhcibuffersize/scodatapacketlength.md)
- [var totalNumACLDataPackets: UInt16](bluetoothhcibuffersize/totalnumacldatapackets.md)
- [var totalNumSCODataPackets: UInt16](bluetoothhcibuffersize/totalnumscodatapackets.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcibuffersize)*