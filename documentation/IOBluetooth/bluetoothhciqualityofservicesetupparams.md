...
### Initializers
- [init()](bluetoothhciqualityofservicesetupparams/init.md)
- [init(flags: UInt8, serviceType: UInt8, tokenRate: UInt32, peakBandwidth: UInt32, latency: UInt32, delayVariation: UInt32)](bluetoothhciqualityofservicesetupparams/init(flags:servicetype:tokenrate:peakbandwidth:latency:delayvariation:).md)
### Instance Properties
- [var delayVariation: UInt32](bluetoothhciqualityofservicesetupparams/delayvariation.md)
- [var flags: UInt8](bluetoothhciqualityofservicesetupparams/flags.md)
- [var latency: UInt32](bluetoothhciqualityofservicesetupparams/latency.md)
- [var peakBandwidth: UInt32](bluetoothhciqualityofservicesetupparams/peakbandwidth.md)
- [var serviceType: UInt8](bluetoothhciqualityofservicesetupparams/servicetype.md)
- [var tokenRate: UInt32](bluetoothhciqualityofservicesetupparams/tokenrate.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhciqualityofservicesetupparams)*