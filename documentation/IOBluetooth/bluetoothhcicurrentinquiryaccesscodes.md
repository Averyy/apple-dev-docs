...
### Initializers
- [init()](bluetoothhcicurrentinquiryaccesscodes/init.md)
- [init(count: BluetoothHCIInquiryAccessCodeCount, codes: UnsafeMutablePointer<BluetoothHCIInquiryAccessCode>!)](bluetoothhcicurrentinquiryaccesscodes/init(count:codes:).md)
### Instance Properties
- [var codes: UnsafeMutablePointer<BluetoothHCIInquiryAccessCode>!](bluetoothhcicurrentinquiryaccesscodes/codes.md)
- [var count: BluetoothHCIInquiryAccessCodeCount](bluetoothhcicurrentinquiryaccesscodes/count.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcicurrentinquiryaccesscodes)*