...
### Initializers
- [init()](bluetoothhcieventqossetupcompleteresults/init.md)
- [init(connectionHandle: BluetoothConnectionHandle, setupParams: BluetoothHCIQualityOfServiceSetupParams)](bluetoothhcieventqossetupcompleteresults/init(connectionhandle:setupparams:).md)
### Instance Properties
- [var connectionHandle: BluetoothConnectionHandle](bluetoothhcieventqossetupcompleteresults/connectionhandle.md)
- [var setupParams: BluetoothHCIQualityOfServiceSetupParams](bluetoothhcieventqossetupcompleteresults/setupparams.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcieventqossetupcompleteresults)*