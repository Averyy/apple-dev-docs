...
### Initializers
- [init()](obexgetcommandresponsedata/init.md)
- [init(serverResponseOpCode: OBEXOpCode, headerDataPtr: UnsafeMutableRawPointer!, headerDataLength: Int)](obexgetcommandresponsedata/init(serverresponseopcode:headerdataptr:headerdatalength:).md)
### Instance Properties
- [var headerDataLength: Int](obexgetcommandresponsedata/headerdatalength.md)
- [var headerDataPtr: UnsafeMutableRawPointer!](obexgetcommandresponsedata/headerdataptr.md)
- [var serverResponseOpCode: OBEXOpCode](obexgetcommandresponsedata/serverresponseopcode.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/obexgetcommandresponsedata)*