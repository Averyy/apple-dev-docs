...
### Initializers
- [init()](bluetoothhcifailedcontactinfo/init.md)
- [init(count: BluetoothHCIFailedContactCount, handle: BluetoothConnectionHandle)](bluetoothhcifailedcontactinfo/init(count:handle:).md)
### Instance Properties
- [var count: BluetoothHCIFailedContactCount](bluetoothhcifailedcontactinfo/count.md)
- [var handle: BluetoothConnectionHandle](bluetoothhcifailedcontactinfo/handle.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcifailedcontactinfo)*