...
### Constants
- [var kDefaultPageTimeout: BluetoothHCITimeoutValues](kdefaultpagetimeout.md)
### Initializers
- [init(UInt32)](bluetoothhcitimeoutvalues/init(_:).md)
- [init(rawValue: UInt32)](bluetoothhcitimeoutvalues/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothhcitimeoutvalues/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcitimeoutvalues)*