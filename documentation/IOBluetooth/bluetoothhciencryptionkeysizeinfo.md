...
### Initializers
- [init()](bluetoothhciencryptionkeysizeinfo/init.md)
- [init(handle: BluetoothConnectionHandle, keySize: BluetoothHCIEncryptionKeySize)](bluetoothhciencryptionkeysizeinfo/init(handle:keysize:).md)
### Instance Properties
- [var handle: BluetoothConnectionHandle](bluetoothhciencryptionkeysizeinfo/handle.md)
- [var keySize: BluetoothHCIEncryptionKeySize](bluetoothhciencryptionkeysizeinfo/keysize.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhciencryptionkeysizeinfo)*