...
### Initializers
- [init()](bluetoothhcieventflushoccurredresults/init.md)
- [init(connectionHandle: BluetoothConnectionHandle)](bluetoothhcieventflushoccurredresults/init(connectionhandle:).md)
### Instance Properties
- [var connectionHandle: BluetoothConnectionHandle](bluetoothhcieventflushoccurredresults/connectionhandle.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcieventflushoccurredresults)*