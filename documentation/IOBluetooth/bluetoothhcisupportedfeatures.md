...
### Initializers
- [init()](bluetoothhcisupportedfeatures/init.md)
- [init(data: (UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8))](bluetoothhcisupportedfeatures/init(data:).md)
### Instance Properties
- [var data: (UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8)](bluetoothhcisupportedfeatures/data.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcisupportedfeatures)*