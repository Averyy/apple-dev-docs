...
### Initializers
- [init()](bluetoothhciinquirywithrssiresult/init.md)
- [init(deviceAddress: BluetoothDeviceAddress, pageScanRepetitionMode: BluetoothPageScanRepetitionMode, reserved: UInt8, classOfDevice: BluetoothClassOfDevice, clockOffset: BluetoothClockOffset, RSSIValue: BluetoothHCIRSSIValue)](bluetoothhciinquirywithrssiresult/init(deviceaddress:pagescanrepetitionmode:reserved:classofdevice:clockoffset:rssivalue:).md)
### Instance Properties
- [var RSSIValue: BluetoothHCIRSSIValue](bluetoothhciinquirywithrssiresult/rssivalue.md)
- [var classOfDevice: BluetoothClassOfDevice](bluetoothhciinquirywithrssiresult/classofdevice.md)
- [var clockOffset: BluetoothClockOffset](bluetoothhciinquirywithrssiresult/clockoffset.md)
- [var deviceAddress: BluetoothDeviceAddress](bluetoothhciinquirywithrssiresult/deviceaddress.md)
- [var pageScanRepetitionMode: BluetoothPageScanRepetitionMode](bluetoothhciinquirywithrssiresult/pagescanrepetitionmode.md)
- [var reserved: UInt8](bluetoothhciinquirywithrssiresult/reserved.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhciinquirywithrssiresult)*