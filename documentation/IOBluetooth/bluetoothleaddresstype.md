...
### Constants
- [var BluetoothLEAddressTypePublic: BluetoothLEAddressType](bluetoothleaddresstypepublic.md)
- [var BluetoothLEAddressTypeRandom: BluetoothLEAddressType](bluetoothleaddresstyperandom.md)
### Initializers
- [init(UInt32)](bluetoothleaddresstype/init(_:).md)
- [init(rawValue: UInt32)](bluetoothleaddresstype/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothleaddresstype/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothleaddresstype)*