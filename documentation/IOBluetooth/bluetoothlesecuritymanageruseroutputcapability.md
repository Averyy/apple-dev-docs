...
### Constants
- [var kBluetoothLESecurityManagerUserOutputCapabilityNoOutput: BluetoothLESecurityManagerUserOutputCapability](kbluetoothlesecuritymanageruseroutputcapabilitynooutput.md)
- [var kBluetoothLESecurityManagerUserOutputCapabilityNumericOutput: BluetoothLESecurityManagerUserOutputCapability](kbluetoothlesecuritymanageruseroutputcapabilitynumericoutput.md)
### Initializers
- [init(UInt32)](bluetoothlesecuritymanageruseroutputcapability/init(_:).md)
- [init(rawValue: UInt32)](bluetoothlesecuritymanageruseroutputcapability/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothlesecuritymanageruseroutputcapability/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothlesecuritymanageruseroutputcapability)*