...
### Initializers
- [init()](bluetoothhcieventdisconnectioncompleteresults/init.md)
- [init(connectionHandle: BluetoothConnectionHandle, reason: BluetoothReasonCode)](bluetoothhcieventdisconnectioncompleteresults/init(connectionhandle:reason:).md)
### Instance Properties
- [var connectionHandle: BluetoothConnectionHandle](bluetoothhcieventdisconnectioncompleteresults/connectionhandle.md)
- [var reason: BluetoothReasonCode](bluetoothhcieventdisconnectioncompleteresults/reason.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcieventdisconnectioncompleteresults)*