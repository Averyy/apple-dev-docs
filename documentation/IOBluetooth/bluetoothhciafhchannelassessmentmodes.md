...
### Constants
- [var kAFHChannelAssessmentModeDisabled: BluetoothHCIAFHChannelAssessmentModes](kafhchannelassessmentmodedisabled.md)
- [var kAFHChannelAssessmentModeEnabled: BluetoothHCIAFHChannelAssessmentModes](kafhchannelassessmentmodeenabled.md)
### Initializers
- [init(UInt32)](bluetoothhciafhchannelassessmentmodes/init(_:).md)
- [init(rawValue: UInt32)](bluetoothhciafhchannelassessmentmodes/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothhciafhchannelassessmentmodes/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhciafhchannelassessmentmodes)*