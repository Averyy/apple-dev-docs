...
### Constants
- [var BluetoothRFCOMMLineStatusFramingError: BluetoothRFCOMMLineStatus](bluetoothrfcommlinestatusframingerror.md)
- [var BluetoothRFCOMMLineStatusNoError: BluetoothRFCOMMLineStatus](bluetoothrfcommlinestatusnoerror.md)
- [var BluetoothRFCOMMLineStatusOverrunError: BluetoothRFCOMMLineStatus](bluetoothrfcommlinestatusoverrunerror.md)
- [var BluetoothRFCOMMLineStatusParityError: BluetoothRFCOMMLineStatus](bluetoothrfcommlinestatusparityerror.md)
### Initializers
- [init(UInt32)](bluetoothrfcommlinestatus/init(_:).md)
- [init(rawValue: UInt32)](bluetoothrfcommlinestatus/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothrfcommlinestatus/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothrfcommlinestatus)*