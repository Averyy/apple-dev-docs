...
### Constants
- [var BluetoothLEScanDuplicateFilterDisable: BluetoothLEScanDuplicateFilter](bluetoothlescanduplicatefilterdisable.md)
- [var BluetoothLEScanDuplicateFilterEnable: BluetoothLEScanDuplicateFilter](bluetoothlescanduplicatefilterenable.md)
### Initializers
- [init(UInt32)](bluetoothlescanduplicatefilter/init(_:).md)
- [init(rawValue: UInt32)](bluetoothlescanduplicatefilter/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothlescanduplicatefilter/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothlescanduplicatefilter)*