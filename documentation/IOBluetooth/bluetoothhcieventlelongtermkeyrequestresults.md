...
### Initializers
- [init()](bluetoothhcieventlelongtermkeyrequestresults/init.md)
- [init(connectionHandle: BluetoothConnectionHandle, randomNumber: (UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8), ediv: UInt16)](bluetoothhcieventlelongtermkeyrequestresults/init(connectionhandle:randomnumber:ediv:).md)
### Instance Properties
- [var connectionHandle: BluetoothConnectionHandle](bluetoothhcieventlelongtermkeyrequestresults/connectionhandle.md)
- [var ediv: UInt16](bluetoothhcieventlelongtermkeyrequestresults/ediv.md)
- [var randomNumber: (UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8)](bluetoothhcieventlelongtermkeyrequestresults/randomnumber.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcieventlelongtermkeyrequestresults)*