...
### Initializers
- [init()](bluetoothkeypressnotification/init.md)
- [init(deviceAddress: BluetoothDeviceAddress, notificationType: BluetoothKeypressNotificationType)](bluetoothkeypressnotification/init(deviceaddress:notificationtype:).md)
### Instance Properties
- [var deviceAddress: BluetoothDeviceAddress](bluetoothkeypressnotification/deviceaddress.md)
- [var notificationType: BluetoothKeypressNotificationType](bluetoothkeypressnotification/notificationtype.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothkeypressnotification)*