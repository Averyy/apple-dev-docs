...
### Initializers
- [init()](bluetoothhcieventencryptionkeyrefreshcompleteresults/init.md)
- [init(connectionHandle: BluetoothConnectionHandle)](bluetoothhcieventencryptionkeyrefreshcompleteresults/init(connectionhandle:).md)
### Instance Properties
- [var connectionHandle: BluetoothConnectionHandle](bluetoothhcieventencryptionkeyrefreshcompleteresults/connectionhandle.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcieventencryptionkeyrefreshcompleteresults)*