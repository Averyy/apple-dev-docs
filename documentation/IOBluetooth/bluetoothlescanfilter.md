...
### Constants
- [var BluetoothLEScanFilterNone: BluetoothLEScanFilter](bluetoothlescanfilternone.md)
- [var BluetoothLEScanFilterWhitelist: BluetoothLEScanFilter](bluetoothlescanfilterwhitelist.md)
- [var BluetoothLEScanFilterSafelist: BluetoothLEScanFilter](bluetoothlescanfiltersafelist.md)
### Initializers
- [init(UInt32)](bluetoothlescanfilter/init(_:).md)
- [init(rawValue: UInt32)](bluetoothlescanfilter/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothlescanfilter/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothlescanfilter)*