...
### Initializers
- [init()](bluetoothhcireadlocaloobdataresults/init.md)
- [init(hash: BluetoothHCISimplePairingOOBData, randomizer: BluetoothHCISimplePairingOOBData)](bluetoothhcireadlocaloobdataresults/init(hash:randomizer:).md)
### Instance Properties
- [var hash: BluetoothHCISimplePairingOOBData](bluetoothhcireadlocaloobdataresults/hash.md)
- [var randomizer: BluetoothHCISimplePairingOOBData](bluetoothhcireadlocaloobdataresults/randomizer.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcireadlocaloobdataresults)*