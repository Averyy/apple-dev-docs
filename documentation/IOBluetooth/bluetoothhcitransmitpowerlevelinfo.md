...
### Initializers
- [init()](bluetoothhcitransmitpowerlevelinfo/init.md)
- [init(handle: BluetoothConnectionHandle, level: BluetoothHCITransmitPowerLevel)](bluetoothhcitransmitpowerlevelinfo/init(handle:level:).md)
### Instance Properties
- [var handle: BluetoothConnectionHandle](bluetoothhcitransmitpowerlevelinfo/handle.md)
- [var level: BluetoothHCITransmitPowerLevel](bluetoothhcitransmitpowerlevelinfo/level.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcitransmitpowerlevelinfo)*