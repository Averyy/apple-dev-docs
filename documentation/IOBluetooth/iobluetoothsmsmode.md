...
### Enumeration Cases
- [IOBluetoothSMSMode.PDU](iobluetoothsmsmode/pdu.md)
- [IOBluetoothSMSMode.text](iobluetoothsmsmode/text.md)
### Initializers
- [init?(rawValue: UInt)](iobluetoothsmsmode/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/iobluetoothsmsmode)*