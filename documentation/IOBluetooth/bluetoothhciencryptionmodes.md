...
### Constants
- [var kEncryptionDisabled: BluetoothHCIEncryptionModes](kencryptiondisabled.md)
- [var kEncryptionForBothPointToPointAndBroadcastPackets: BluetoothHCIEncryptionModes](kencryptionforbothpointtopointandbroadcastpackets.md)
- [var kEncryptionOnlyForPointToPointPackets: BluetoothHCIEncryptionModes](kencryptiononlyforpointtopointpackets.md)
### Initializers
- [init(UInt32)](bluetoothhciencryptionmodes/init(_:).md)
- [init(rawValue: UInt32)](bluetoothhciencryptionmodes/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothhciencryptionmodes/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhciencryptionmodes)*