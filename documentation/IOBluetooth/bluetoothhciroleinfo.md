...
### Initializers
- [init()](bluetoothhciroleinfo/init.md)
- [init(role: UInt8, handle: BluetoothConnectionHandle)](bluetoothhciroleinfo/init(role:handle:).md)
### Instance Properties
- [var handle: BluetoothConnectionHandle](bluetoothhciroleinfo/handle.md)
- [var role: UInt8](bluetoothhciroleinfo/role.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhciroleinfo)*