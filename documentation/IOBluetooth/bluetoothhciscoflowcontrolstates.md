...
### Constants
- [var kSCOFlowControlDisabled: BluetoothHCISCOFlowControlStates](kscoflowcontroldisabled.md)
- [var kSCOFlowControlEnabled: BluetoothHCISCOFlowControlStates](kscoflowcontrolenabled.md)
### Initializers
- [init(UInt32)](bluetoothhciscoflowcontrolstates/init(_:).md)
- [init(rawValue: UInt32)](bluetoothhciscoflowcontrolstates/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothhciscoflowcontrolstates/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhciscoflowcontrolstates)*