...
### Initializers
- [init()](bluetoothhcieventsniffsubratingresults/init.md)
- [init(connectionHandle: BluetoothConnectionHandle, maxTransmitLatency: UInt16, maxReceiveLatency: UInt16, minRemoteTimeout: UInt16, minLocalTimeout: UInt16)](bluetoothhcieventsniffsubratingresults/init(connectionhandle:maxtransmitlatency:maxreceivelatency:minremotetimeout:minlocaltimeout:).md)
### Instance Properties
- [var connectionHandle: BluetoothConnectionHandle](bluetoothhcieventsniffsubratingresults/connectionhandle.md)
- [var maxReceiveLatency: UInt16](bluetoothhcieventsniffsubratingresults/maxreceivelatency.md)
- [var maxTransmitLatency: UInt16](bluetoothhcieventsniffsubratingresults/maxtransmitlatency.md)
- [var minLocalTimeout: UInt16](bluetoothhcieventsniffsubratingresults/minlocaltimeout.md)
- [var minRemoteTimeout: UInt16](bluetoothhcieventsniffsubratingresults/minremotetimeout.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcieventsniffsubratingresults)*