...
### Constants
- [var kBluetoothL2CAPInformationTypeConnectionlessMTU: BluetoothL2CAPInformationType](kbluetoothl2capinformationtypeconnectionlessmtu.md)
- [var kBluetoothL2CAPInformationTypeExtendedFeatures: BluetoothL2CAPInformationType](kbluetoothl2capinformationtypeextendedfeatures.md)
- [var kBluetoothL2CAPInformationTypeFixedChannelsSupported: BluetoothL2CAPInformationType](kbluetoothl2capinformationtypefixedchannelssupported.md)
### Initializers
- [init(UInt32)](bluetoothl2capinformationtype/init(_:).md)
- [init(rawValue: UInt32)](bluetoothl2capinformationtype/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothl2capinformationtype/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothl2capinformationtype)*