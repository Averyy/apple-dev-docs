...
### Initializers
- [init()](bluetoothreadclockinfo/init.md)
- [init(handle: BluetoothConnectionHandle, clock: UInt32, accuracy: UInt16)](bluetoothreadclockinfo/init(handle:clock:accuracy:).md)
### Instance Properties
- [var accuracy: UInt16](bluetoothreadclockinfo/accuracy.md)
- [var clock: UInt32](bluetoothreadclockinfo/clock.md)
- [var handle: BluetoothConnectionHandle](bluetoothreadclockinfo/handle.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothreadclockinfo)*