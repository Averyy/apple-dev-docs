...
### Constants
- [var kBluetoothL2CAPQoSTypeBestEffort: BluetoothL2CAPQoSType](kbluetoothl2capqostypebesteffort.md)
- [var kBluetoothL2CAPQoSTypeGuaranteed: BluetoothL2CAPQoSType](kbluetoothl2capqostypeguaranteed.md)
- [var kBluetoothL2CAPQoSTypeNoTraffic: BluetoothL2CAPQoSType](kbluetoothl2capqostypenotraffic.md)
### Initializers
- [init(UInt32)](bluetoothl2capqostype/init(_:).md)
- [init(rawValue: UInt32)](bluetoothl2capqostype/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothl2capqostype/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothl2capqostype)*