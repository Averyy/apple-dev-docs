...
### Initializers
- [init()](bluetoothhcieventhardwareerrorresults/init.md)
- [init(error: BluetoothHCIStatus)](bluetoothhcieventhardwareerrorresults/init(error:).md)
### Instance Properties
- [var error: BluetoothHCIStatus](bluetoothhcieventhardwareerrorresults/error.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcieventhardwareerrorresults)*