...
### Initializers
- [init?(rawValue: UInt)](iobluetoothhandsfreecallholdmodes/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/iobluetoothhandsfreecallholdmodes)*