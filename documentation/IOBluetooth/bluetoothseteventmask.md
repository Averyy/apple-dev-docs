...
### Initializers
- [init()](bluetoothseteventmask/init.md)
- [init(data: (UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8))](bluetoothseteventmask/init(data:).md)
### Instance Properties
- [var data: (UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8)](bluetoothseteventmask/data.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothseteventmask)*