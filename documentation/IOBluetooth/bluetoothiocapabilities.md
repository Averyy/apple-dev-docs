...
### Constants
- [var kBluetoothCapabilityTypeDisplayOnly: BluetoothIOCapabilities](kbluetoothcapabilitytypedisplayonly.md)
- [var kBluetoothCapabilityTypeDisplayYesNo: BluetoothIOCapabilities](kbluetoothcapabilitytypedisplayyesno.md)
- [var kBluetoothCapabilityTypeKeyboardOnly: BluetoothIOCapabilities](kbluetoothcapabilitytypekeyboardonly.md)
- [var kBluetoothCapabilityTypeNoInputNoOutput: BluetoothIOCapabilities](kbluetoothcapabilitytypenoinputnooutput.md)
### Initializers
- [init(UInt32)](bluetoothiocapabilities/init(_:).md)
- [init(rawValue: UInt32)](bluetoothiocapabilities/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothiocapabilities/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothiocapabilities)*