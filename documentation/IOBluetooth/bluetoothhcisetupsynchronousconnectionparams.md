...
### Initializers
- [init()](bluetoothhcisetupsynchronousconnectionparams/init.md)
- [init(transmitBandwidth: UInt32, receiveBandwidth: UInt32, maxLatency: UInt16, voiceSetting: UInt16, retransmissionEffort: UInt8, packetType: UInt16)](bluetoothhcisetupsynchronousconnectionparams/init(transmitbandwidth:receivebandwidth:maxlatency:voicesetting:retransmissioneffort:packettype:).md)
### Instance Properties
- [var maxLatency: UInt16](bluetoothhcisetupsynchronousconnectionparams/maxlatency.md)
- [var packetType: UInt16](bluetoothhcisetupsynchronousconnectionparams/packettype.md)
- [var receiveBandwidth: UInt32](bluetoothhcisetupsynchronousconnectionparams/receivebandwidth.md)
- [var retransmissionEffort: UInt8](bluetoothhcisetupsynchronousconnectionparams/retransmissioneffort.md)
- [var transmitBandwidth: UInt32](bluetoothhcisetupsynchronousconnectionparams/transmitbandwidth.md)
- [var voiceSetting: UInt16](bluetoothhcisetupsynchronousconnectionparams/voicesetting.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcisetupsynchronousconnectionparams)*