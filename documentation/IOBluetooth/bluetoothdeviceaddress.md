...
### Initializers
- [init()](bluetoothdeviceaddress/init.md)
- [init(data: (UInt8, UInt8, UInt8, UInt8, UInt8, UInt8))](bluetoothdeviceaddress/init(data:).md)
### Instance Properties
- [var data: (UInt8, UInt8, UInt8, UInt8, UInt8, UInt8)](bluetoothdeviceaddress/data.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothdeviceaddress)*