...
### Initializers
- [init()](bluetoothuserconfirmationrequest/init.md)
- [init(deviceAddress: BluetoothDeviceAddress, numericValue: BluetoothNumericValue)](bluetoothuserconfirmationrequest/init(deviceaddress:numericvalue:).md)
### Instance Properties
- [var deviceAddress: BluetoothDeviceAddress](bluetoothuserconfirmationrequest/deviceaddress.md)
- [var numericValue: BluetoothNumericValue](bluetoothuserconfirmationrequest/numericvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothuserconfirmationrequest)*