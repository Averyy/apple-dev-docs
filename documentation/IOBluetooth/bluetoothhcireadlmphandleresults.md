...
### Initializers
- [init()](bluetoothhcireadlmphandleresults/init.md)
- [init(handle: BluetoothConnectionHandle, lmp_handle: BluetoothLMPHandle, reserved: UInt32)](bluetoothhcireadlmphandleresults/init(handle:lmp_handle:reserved:).md)
### Instance Properties
- [var handle: BluetoothConnectionHandle](bluetoothhcireadlmphandleresults/handle.md)
- [var lmp_handle: BluetoothLMPHandle](bluetoothhcireadlmphandleresults/lmp_handle.md)
- [var reserved: UInt32](bluetoothhcireadlmphandleresults/reserved.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcireadlmphandleresults)*