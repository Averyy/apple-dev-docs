...
### Constants
- [var kBluetoothAMPManagerCommandRejectReasonCommandNotRecognized: BluetoothAMPCommandRejectReason](kbluetoothampmanagercommandrejectreasoncommandnotrecognized.md)
### Initializers
- [init(UInt32)](bluetoothampcommandrejectreason/init(_:).md)
- [init(rawValue: UInt32)](bluetoothampcommandrejectreason/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothampcommandrejectreason/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothampcommandrejectreason)*