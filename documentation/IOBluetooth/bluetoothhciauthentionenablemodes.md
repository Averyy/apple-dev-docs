...
### Constants
- [var kAuthenticationDisabled: BluetoothHCIAuthentionEnableModes](kauthenticationdisabled.md)
- [var kAuthenticationEnabled: BluetoothHCIAuthentionEnableModes](kauthenticationenabled.md)
### Initializers
- [init(UInt32)](bluetoothhciauthentionenablemodes/init(_:).md)
- [init(rawValue: UInt32)](bluetoothhciauthentionenablemodes/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothhciauthentionenablemodes/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhciauthentionenablemodes)*