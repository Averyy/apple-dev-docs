...
### Initializers
- [init()](bluetoothhcistoredlinkkeysinfo/init.md)
- [init(numLinkKeysRead: UInt16, maxNumLinkKeysAllowedInDevice: UInt16)](bluetoothhcistoredlinkkeysinfo/init(numlinkkeysread:maxnumlinkkeysallowedindevice:).md)
### Instance Properties
- [var maxNumLinkKeysAllowedInDevice: UInt16](bluetoothhcistoredlinkkeysinfo/maxnumlinkkeysallowedindevice.md)
- [var numLinkKeysRead: UInt16](bluetoothhcistoredlinkkeysinfo/numlinkkeysread.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcistoredlinkkeysinfo)*