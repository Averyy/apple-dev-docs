...
### Initializers
- [init()](bluetoothkey/init.md)
- [init(data: (UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8))](bluetoothkey/init(data:).md)
### Instance Properties
- [var data: (UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8)](bluetoothkey/data.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothkey)*