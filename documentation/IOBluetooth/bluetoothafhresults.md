...
### Initializers
- [init()](bluetoothafhresults/init.md)
- [init(handle: BluetoothConnectionHandle, mode: BluetoothAFHMode, afhMap: (UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8))](bluetoothafhresults/init(handle:mode:afhmap:).md)
### Instance Properties
- [var afhMap: (UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8)](bluetoothafhresults/afhmap.md)
- [var handle: BluetoothConnectionHandle](bluetoothafhresults/handle.md)
- [var mode: BluetoothAFHMode](bluetoothafhresults/mode.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothafhresults)*