...
### Initializers
- [init()](bluetoothhcireadextendedinquiryresponseresults/init.md)
- [init(outFECRequired: BluetoothHCIFECRequired, extendedInquiryResponse: BluetoothHCIExtendedInquiryResponse)](bluetoothhcireadextendedinquiryresponseresults/init(outfecrequired:extendedinquiryresponse:).md)
### Instance Properties
- [var extendedInquiryResponse: BluetoothHCIExtendedInquiryResponse](bluetoothhcireadextendedinquiryresponseresults/extendedinquiryresponse.md)
- [var outFECRequired: BluetoothHCIFECRequired](bluetoothhcireadextendedinquiryresponseresults/outfecrequired.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcireadextendedinquiryresponseresults)*