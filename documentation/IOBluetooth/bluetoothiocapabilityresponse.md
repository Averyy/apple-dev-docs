...
### Initializers
- [init()](bluetoothiocapabilityresponse/init.md)
- [init(deviceAddress: BluetoothDeviceAddress, ioCapability: BluetoothIOCapability, OOBDataPresence: BluetoothOOBDataPresence, authenticationRequirements: BluetoothAuthenticationRequirements)](bluetoothiocapabilityresponse/init(deviceaddress:iocapability:oobdatapresence:authenticationrequirements:).md)
### Instance Properties
- [var OOBDataPresence: BluetoothOOBDataPresence](bluetoothiocapabilityresponse/oobdatapresence.md)
- [var authenticationRequirements: BluetoothAuthenticationRequirements](bluetoothiocapabilityresponse/authenticationrequirements.md)
- [var deviceAddress: BluetoothDeviceAddress](bluetoothiocapabilityresponse/deviceaddress.md)
- [var ioCapability: BluetoothIOCapability](bluetoothiocapabilityresponse/iocapability.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothiocapabilityresponse)*