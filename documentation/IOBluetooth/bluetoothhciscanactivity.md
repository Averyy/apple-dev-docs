...
### Initializers
- [init()](bluetoothhciscanactivity/init.md)
- [init(scanInterval: UInt16, scanWindow: UInt16)](bluetoothhciscanactivity/init(scaninterval:scanwindow:).md)
### Instance Properties
- [var scanInterval: UInt16](bluetoothhciscanactivity/scaninterval.md)
- [var scanWindow: UInt16](bluetoothhciscanactivity/scanwindow.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhciscanactivity)*