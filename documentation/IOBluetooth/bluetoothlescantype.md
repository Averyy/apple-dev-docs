...
### Constants
- [var BluetoothLEScanTypeActive: BluetoothLEScanType](bluetoothlescantypeactive.md)
- [var BluetoothLEScanTypePassive: BluetoothLEScanType](bluetoothlescantypepassive.md)
### Initializers
- [init(UInt32)](bluetoothlescantype/init(_:).md)
- [init(rawValue: UInt32)](bluetoothlescantype/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothlescantype/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothlescantype)*