...
### Constants
- [var kBluetoothHCIPageScanTypeInterlaced: BluetoothHCIPageScanTypes](kbluetoothhcipagescantypeinterlaced.md)
- [var kBluetoothHCIPageScanTypeReservedEnd: BluetoothHCIPageScanTypes](kbluetoothhcipagescantypereservedend.md)
- [var kBluetoothHCIPageScanTypeReservedStart: BluetoothHCIPageScanTypes](kbluetoothhcipagescantypereservedstart.md)
- [var kBluetoothHCIPageScanTypeStandard: BluetoothHCIPageScanTypes](kbluetoothhcipagescantypestandard.md)
### Initializers
- [init(UInt32)](bluetoothhcipagescantypes/init(_:).md)
- [init(rawValue: UInt32)](bluetoothhcipagescantypes/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothhcipagescantypes/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcipagescantypes)*