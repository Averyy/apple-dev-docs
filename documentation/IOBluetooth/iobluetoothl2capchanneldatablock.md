...
### Initializers
- [init()](iobluetoothl2capchanneldatablock/init.md)
- [init(dataPtr: UnsafeMutableRawPointer!, dataSize: Int)](iobluetoothl2capchanneldatablock/init(dataptr:datasize:).md)
### Instance Properties
- [var dataPtr: UnsafeMutableRawPointer!](iobluetoothl2capchanneldatablock/dataptr.md)
- [var dataSize: Int](iobluetoothl2capchanneldatablock/datasize.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/iobluetoothl2capchanneldatablock)*