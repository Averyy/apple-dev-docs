...
### Initializers
- [init()](bluetoothhcieventconnectionpackettyperesults/init.md)
- [init(connectionHandle: BluetoothConnectionHandle, packetType: BluetoothPacketType)](bluetoothhcieventconnectionpackettyperesults/init(connectionhandle:packettype:).md)
### Instance Properties
- [var connectionHandle: BluetoothConnectionHandle](bluetoothhcieventconnectionpackettyperesults/connectionhandle.md)
- [var packetType: BluetoothPacketType](bluetoothhcieventconnectionpackettyperesults/packettype.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcieventconnectionpackettyperesults)*