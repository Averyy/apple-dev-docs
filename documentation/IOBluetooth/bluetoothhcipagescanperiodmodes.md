...
### Constants
- [var kP0Mode: BluetoothHCIPageScanPeriodModes](kp0mode.md)
- [var kP1Mode: BluetoothHCIPageScanPeriodModes](kp1mode.md)
- [var kP2Mode: BluetoothHCIPageScanPeriodModes](kp2mode.md)
### Initializers
- [init(UInt32)](bluetoothhcipagescanperiodmodes/init(_:).md)
- [init(rawValue: UInt32)](bluetoothhcipagescanperiodmodes/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothhcipagescanperiodmodes/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcipagescanperiodmodes)*