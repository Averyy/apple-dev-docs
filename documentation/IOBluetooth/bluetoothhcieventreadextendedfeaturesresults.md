...
### Initializers
- [init()](bluetoothhcieventreadextendedfeaturesresults/init.md)
- [init(connectionHandle: BluetoothConnectionHandle, supportedFeaturesInfo: BluetoothHCIExtendedFeaturesInfo)](bluetoothhcieventreadextendedfeaturesresults/init(connectionhandle:supportedfeaturesinfo:).md)
### Instance Properties
- [var connectionHandle: BluetoothConnectionHandle](bluetoothhcieventreadextendedfeaturesresults/connectionhandle.md)
- [var supportedFeaturesInfo: BluetoothHCIExtendedFeaturesInfo](bluetoothhcieventreadextendedfeaturesresults/supportedfeaturesinfo.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcieventreadextendedfeaturesresults)*