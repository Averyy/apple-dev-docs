...
### Constants
- [var kBluetoothHCIFECNotRequired: BluetoothHCIFECRequiredValues](kbluetoothhcifecnotrequired.md)
- [var kBluetoothHCIFECRequired: BluetoothHCIFECRequiredValues](kbluetoothhcifecrequired.md)
### Initializers
- [init(UInt32)](bluetoothhcifecrequiredvalues/init(_:).md)
- [init(rawValue: UInt32)](bluetoothhcifecrequiredvalues/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothhcifecrequiredvalues/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcifecrequiredvalues)*