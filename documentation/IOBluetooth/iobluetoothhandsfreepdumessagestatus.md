...
### Initializers
- [init?(rawValue: UInt)](iobluetoothhandsfreepdumessagestatus/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/iobluetoothhandsfreepdumessagestatus)*