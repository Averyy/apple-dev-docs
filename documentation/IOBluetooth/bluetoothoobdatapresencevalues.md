...
### Constants
- [var kBluetoothOOBAuthenticationDataFromRemoteDevicePresent: BluetoothOOBDataPresenceValues](kbluetoothoobauthenticationdatafromremotedevicepresent.md)
- [var kBluetoothOOBAuthenticationDataNotPresent: BluetoothOOBDataPresenceValues](kbluetoothoobauthenticationdatanotpresent.md)
### Initializers
- [init(UInt32)](bluetoothoobdatapresencevalues/init(_:).md)
- [init(rawValue: UInt32)](bluetoothoobdatapresencevalues/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothoobdatapresencevalues/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothoobdatapresencevalues)*