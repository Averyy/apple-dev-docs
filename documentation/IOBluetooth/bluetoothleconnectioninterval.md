...
### Constants
- [var BluetoothLEConnectionIntervalMax: BluetoothLEConnectionInterval](bluetoothleconnectionintervalmax.md)
- [var BluetoothLEConnectionIntervalMin: BluetoothLEConnectionInterval](bluetoothleconnectionintervalmin.md)
### Initializers
- [init(UInt32)](bluetoothleconnectioninterval/init(_:).md)
- [init(rawValue: UInt32)](bluetoothleconnectioninterval/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothleconnectioninterval/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothleconnectioninterval)*