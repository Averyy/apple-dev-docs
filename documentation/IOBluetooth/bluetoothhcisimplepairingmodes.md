...
### Constants
- [var kBluetoothHCISimplePairingModeEnabled: BluetoothHCISimplePairingModes](kbluetoothhcisimplepairingmodeenabled.md)
- [var kBluetoothHCISimplePairingModeNotSet: BluetoothHCISimplePairingModes](kbluetoothhcisimplepairingmodenotset.md)
### Initializers
- [init(UInt32)](bluetoothhcisimplepairingmodes/init(_:).md)
- [init(rawValue: UInt32)](bluetoothhcisimplepairingmodes/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothhcisimplepairingmodes/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcisimplepairingmodes)*