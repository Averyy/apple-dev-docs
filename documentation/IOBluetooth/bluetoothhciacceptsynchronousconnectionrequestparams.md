...
### Initializers
- [init()](bluetoothhciacceptsynchronousconnectionrequestparams/init.md)
- [init(transmitBandwidth: UInt32, receiveBandwidth: UInt32, maxLatency: UInt16, contentFormat: UInt16, retransmissionEffort: UInt8, packetType: UInt16)](bluetoothhciacceptsynchronousconnectionrequestparams/init(transmitbandwidth:receivebandwidth:maxlatency:contentformat:retransmissioneffort:packettype:).md)
### Instance Properties
- [var contentFormat: UInt16](bluetoothhciacceptsynchronousconnectionrequestparams/contentformat.md)
- [var maxLatency: UInt16](bluetoothhciacceptsynchronousconnectionrequestparams/maxlatency.md)
- [var packetType: UInt16](bluetoothhciacceptsynchronousconnectionrequestparams/packettype.md)
- [var receiveBandwidth: UInt32](bluetoothhciacceptsynchronousconnectionrequestparams/receivebandwidth.md)
- [var retransmissionEffort: UInt8](bluetoothhciacceptsynchronousconnectionrequestparams/retransmissioneffort.md)
- [var transmitBandwidth: UInt32](bluetoothhciacceptsynchronousconnectionrequestparams/transmitbandwidth.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhciacceptsynchronousconnectionrequestparams)*