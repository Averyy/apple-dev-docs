...
### Initializers
- [init()](iobluetoothl2capchannelevent/init.md)
- [init(eventType: IOBluetoothL2CAPChannelEventType, u: IOBluetoothL2CAPChannelEvent.__Unnamed_union_u, status: IOReturn)](iobluetoothl2capchannelevent/init(eventtype:u:status:).md)
### Instance Properties
- [var eventType: IOBluetoothL2CAPChannelEventType](iobluetoothl2capchannelevent/eventtype.md)
- [var status: IOReturn](iobluetoothl2capchannelevent/status.md)
- [var u: IOBluetoothL2CAPChannelEvent.__Unnamed_union_u](iobluetoothl2capchannelevent/u.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/iobluetoothl2capchannelevent)*