...
### Constants
- [var kIOBluetoothL2CAPChannelEventTypeClosed: IOBluetoothL2CAPChannelEventType](kiobluetoothl2capchanneleventtypeclosed.md)
- [var kIOBluetoothL2CAPChannelEventTypeData: IOBluetoothL2CAPChannelEventType](kiobluetoothl2capchanneleventtypedata.md)
- [var kIOBluetoothL2CAPChannelEventTypeOpenComplete: IOBluetoothL2CAPChannelEventType](kiobluetoothl2capchanneleventtypeopencomplete.md)
- [var kIOBluetoothL2CAPChannelEventTypeQueueSpaceAvailable: IOBluetoothL2CAPChannelEventType](kiobluetoothl2capchanneleventtypequeuespaceavailable.md)
- [var kIOBluetoothL2CAPChannelEventTypeReconfigured: IOBluetoothL2CAPChannelEventType](kiobluetoothl2capchanneleventtypereconfigured.md)
- [var kIOBluetoothL2CAPChannelEventTypeWriteComplete: IOBluetoothL2CAPChannelEventType](kiobluetoothl2capchanneleventtypewritecomplete.md)
### Initializers
- [init(UInt32)](iobluetoothl2capchanneleventtype/init(_:).md)
- [init(rawValue: UInt32)](iobluetoothl2capchanneleventtype/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](iobluetoothl2capchanneleventtype/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/iobluetoothl2capchanneleventtype)*