...
### Constants
- [var kMandatoryPageScanMode: BluetoothHCIPageScanModes](kmandatorypagescanmode.md)
- [var kOptionalPageScanMode1: BluetoothHCIPageScanModes](koptionalpagescanmode1.md)
- [var kOptionalPageScanMode2: BluetoothHCIPageScanModes](koptionalpagescanmode2.md)
- [var kOptionalPageScanMode3: BluetoothHCIPageScanModes](koptionalpagescanmode3.md)
### Initializers
- [init(UInt32)](bluetoothhcipagescanmodes/init(_:).md)
- [init(rawValue: UInt32)](bluetoothhcipagescanmodes/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothhcipagescanmodes/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcipagescanmodes)*