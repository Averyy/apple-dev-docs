...
### Constants
- [var kBluetoothHCIMasterRole: BluetoothHCIRoles](kbluetoothhcimasterrole.md)
- [var kBluetoothHCISlaveRole: BluetoothHCIRoles](kbluetoothhcislaverole.md)
- [var kBluetoothHCICentralRole: BluetoothHCIRoles](kbluetoothhcicentralrole.md)
- [var kBluetoothHCIPeripheralRole: BluetoothHCIRoles](kbluetoothhciperipheralrole.md)
### Initializers
- [init(UInt32)](bluetoothhciroles/init(_:).md)
- [init(rawValue: UInt32)](bluetoothhciroles/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothhciroles/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhciroles)*