...
### Initializers
- [init(UInt32)](bluetoothampcreatephysicallinkresponsestatus/init(_:).md)
- [init(rawValue: UInt32)](bluetoothampcreatephysicallinkresponsestatus/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothampcreatephysicallinkresponsestatus/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothampcreatephysicallinkresponsestatus)*