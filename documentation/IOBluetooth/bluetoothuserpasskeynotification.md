...
### Initializers
- [init()](bluetoothuserpasskeynotification/init.md)
- [init(deviceAddress: BluetoothDeviceAddress, passkey: BluetoothPasskey)](bluetoothuserpasskeynotification/init(deviceaddress:passkey:).md)
### Instance Properties
- [var deviceAddress: BluetoothDeviceAddress](bluetoothuserpasskeynotification/deviceaddress.md)
- [var passkey: BluetoothPasskey](bluetoothuserpasskeynotification/passkey.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothuserpasskeynotification)*