...
- [var kBluetoothLESecurityManagerCommandCodeSigningInfo: BluetoothLESecurityManagerCommandCode](kbluetoothlesecuritymanagercommandcodesigninginfo.md)
### Initializers
- [init(UInt32)](bluetoothlesecuritymanagercommandcode/init(_:).md)
- [init(rawValue: UInt32)](bluetoothlesecuritymanagercommandcode/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothlesecuritymanagercommandcode/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothlesecuritymanagercommandcode)*