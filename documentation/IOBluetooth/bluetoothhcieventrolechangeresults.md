...
### Initializers
- [init()](bluetoothhcieventrolechangeresults/init.md)
- [init(connectionHandle: BluetoothConnectionHandle, deviceAddress: BluetoothDeviceAddress, role: BluetoothRole)](bluetoothhcieventrolechangeresults/init(connectionhandle:deviceaddress:role:).md)
### Instance Properties
- [var connectionHandle: BluetoothConnectionHandle](bluetoothhcieventrolechangeresults/connectionhandle.md)
- [var deviceAddress: BluetoothDeviceAddress](bluetoothhcieventrolechangeresults/deviceaddress.md)
- [var role: BluetoothRole](bluetoothhcieventrolechangeresults/role.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcieventrolechangeresults)*