...
### Constants
- [var kDeleteAllStoredLinkKeys: BluetoothHCIDeleteStoredLinkKeyFlags](kdeleteallstoredlinkkeys.md)
- [var kDeleteKeyForSpecifiedDeviceOnly: BluetoothHCIDeleteStoredLinkKeyFlags](kdeletekeyforspecifieddeviceonly.md)
### Initializers
- [init(UInt32)](bluetoothhcideletestoredlinkkeyflags/init(_:).md)
- [init(rawValue: UInt32)](bluetoothhcideletestoredlinkkeyflags/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothhcideletestoredlinkkeyflags/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcideletestoredlinkkeyflags)*