...
- [var kOBEXConnectFlagSupportMultipleItLMPConnections: OBEXConnectFlagValues](kobexconnectflagsupportmultipleitlmpconnections.md)
### Initializers
- [init(UInt32)](obexconnectflagvalues/init(_:).md)
- [init(rawValue: UInt32)](obexconnectflagvalues/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](obexconnectflagvalues/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/obexconnectflagvalues)*