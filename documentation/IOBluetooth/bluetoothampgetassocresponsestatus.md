...
### Constants
- [var kBluetoothAMPManagerGetAssocResponseInvalidControllerID: BluetoothAMPGetAssocResponseStatus](kbluetoothampmanagergetassocresponseinvalidcontrollerid.md)
- [var kBluetoothAMPManagerGetAssocResponseSuccess: BluetoothAMPGetAssocResponseStatus](kbluetoothampmanagergetassocresponsesuccess.md)
### Initializers
- [init(UInt32)](bluetoothampgetassocresponsestatus/init(_:).md)
- [init(rawValue: UInt32)](bluetoothampgetassocresponsestatus/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothampgetassocresponsestatus/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothampgetassocresponsestatus)*