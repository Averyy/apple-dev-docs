...
### Constants
- [var kOBEXVersion10: OBEXVersions](kobexversion10.md)
### Initializers
- [init(UInt32)](obexversions/init(_:).md)
- [init(rawValue: UInt32)](obexversions/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](obexversions/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/obexversions)*