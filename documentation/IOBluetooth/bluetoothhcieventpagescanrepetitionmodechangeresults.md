...
### Initializers
- [init()](bluetoothhcieventpagescanrepetitionmodechangeresults/init.md)
- [init(deviceAddress: BluetoothDeviceAddress, pageScanRepetitionMode: BluetoothPageScanRepetitionMode)](bluetoothhcieventpagescanrepetitionmodechangeresults/init(deviceaddress:pagescanrepetitionmode:).md)
### Instance Properties
- [var deviceAddress: BluetoothDeviceAddress](bluetoothhcieventpagescanrepetitionmodechangeresults/deviceaddress.md)
- [var pageScanRepetitionMode: BluetoothPageScanRepetitionMode](bluetoothhcieventpagescanrepetitionmodechangeresults/pagescanrepetitionmode.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcieventpagescanrepetitionmodechangeresults)*