...
### Initializers
- [init()](bluetoothhcieventlereadremoteusedfeaturescompleteresults/init.md)
- [init(connectionHandle: BluetoothConnectionHandle, usedFeatures: BluetoothHCISupportedFeatures)](bluetoothhcieventlereadremoteusedfeaturescompleteresults/init(connectionhandle:usedfeatures:).md)
### Instance Properties
- [var connectionHandle: BluetoothConnectionHandle](bluetoothhcieventlereadremoteusedfeaturescompleteresults/connectionhandle.md)
- [var usedFeatures: BluetoothHCISupportedFeatures](bluetoothhcieventlereadremoteusedfeaturescompleteresults/usedfeatures.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcieventlereadremoteusedfeaturescompleteresults)*