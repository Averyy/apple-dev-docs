...
### Initializers
- [init()](bluetoothhcieventremotenamerequestresults/init.md)
- [init(deviceAddress: BluetoothDeviceAddress, deviceName: BluetoothDeviceName)](bluetoothhcieventremotenamerequestresults/init(deviceaddress:devicename:).md)
### Instance Properties
- [var deviceAddress: BluetoothDeviceAddress](bluetoothhcieventremotenamerequestresults/deviceaddress.md)
- [var deviceName: BluetoothDeviceName](bluetoothhcieventremotenamerequestresults/devicename.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcieventremotenamerequestresults)*