...
### Constants
- [var kHCIACLDataPacketsOffHCISCODataPacketsOn: BluetoothHCIGeneralFlowControlStates](khciacldatapacketsoffhciscodatapacketson.md)
- [var kHCIACLDataPacketsOnHCISCODataPacketsOff: BluetoothHCIGeneralFlowControlStates](khciacldatapacketsonhciscodatapacketsoff.md)
- [var kHCIACLDataPacketsOnHCISCODataPacketsOn: BluetoothHCIGeneralFlowControlStates](khciacldatapacketsonhciscodatapacketson.md)
- [var kHostControllerToHostFlowControlOff: BluetoothHCIGeneralFlowControlStates](khostcontrollertohostflowcontroloff.md)
### Initializers
- [init(UInt32)](bluetoothhcigeneralflowcontrolstates/init(_:).md)
- [init(rawValue: UInt32)](bluetoothhcigeneralflowcontrolstates/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothhcigeneralflowcontrolstates/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcigeneralflowcontrolstates)*