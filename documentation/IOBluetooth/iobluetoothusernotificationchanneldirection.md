...
### Constants
- [var kIOBluetoothUserNotificationChannelDirectionAny: IOBluetoothUserNotificationChannelDirection](kiobluetoothusernotificationchanneldirectionany.md)
- [var kIOBluetoothUserNotificationChannelDirectionIncoming: IOBluetoothUserNotificationChannelDirection](kiobluetoothusernotificationchanneldirectionincoming.md)
- [var kIOBluetoothUserNotificationChannelDirectionOutgoing: IOBluetoothUserNotificationChannelDirection](kiobluetoothusernotificationchanneldirectionoutgoing.md)
### Initializers
- [init(UInt32)](iobluetoothusernotificationchanneldirection/init(_:).md)
- [init(rawValue: UInt32)](iobluetoothusernotificationchanneldirection/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](iobluetoothusernotificationchanneldirection/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/iobluetoothusernotificationchanneldirection)*