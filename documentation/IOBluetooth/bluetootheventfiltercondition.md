...
### Initializers
- [init()](bluetootheventfiltercondition/init.md)
- [init(data: (UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8))](bluetootheventfiltercondition/init(data:).md)
### Instance Properties
- [var data: (UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8)](bluetootheventfiltercondition/data.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetootheventfiltercondition)*