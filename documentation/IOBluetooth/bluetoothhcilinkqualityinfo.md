...
### Initializers
- [init()](bluetoothhcilinkqualityinfo/init.md)
- [init(handle: BluetoothConnectionHandle, qualityValue: BluetoothHCILinkQuality)](bluetoothhcilinkqualityinfo/init(handle:qualityvalue:).md)
### Instance Properties
- [var handle: BluetoothConnectionHandle](bluetoothhcilinkqualityinfo/handle.md)
- [var qualityValue: BluetoothHCILinkQuality](bluetoothhcilinkqualityinfo/qualityvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcilinkqualityinfo)*