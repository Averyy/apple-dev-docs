...
### Constants
- [var kBluetoothL2CAPSupervisoryFuctionTypeReceiverNotReady: BluetoothL2CAPSupervisoryFuctionType](kbluetoothl2capsupervisoryfuctiontypereceivernotready.md)
- [var kBluetoothL2CAPSupervisoryFuctionTypeReceiverReady: BluetoothL2CAPSupervisoryFuctionType](kbluetoothl2capsupervisoryfuctiontypereceiverready.md)
- [var kBluetoothL2CAPSupervisoryFuctionTypeReject: BluetoothL2CAPSupervisoryFuctionType](kbluetoothl2capsupervisoryfuctiontypereject.md)
- [var kBluetoothL2CAPSupervisoryFuctionTypeSelectiveReject: BluetoothL2CAPSupervisoryFuctionType](kbluetoothl2capsupervisoryfuctiontypeselectivereject.md)
### Initializers
- [init(UInt32)](bluetoothl2capsupervisoryfuctiontype/init(_:).md)
- [init(rawValue: UInt32)](bluetoothl2capsupervisoryfuctiontype/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothl2capsupervisoryfuctiontype/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothl2capsupervisoryfuctiontype)*