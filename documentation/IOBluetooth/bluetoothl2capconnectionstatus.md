...
### Constants
- [var kBluetoothL2CAPConnectionStatusAuthenticationPending: BluetoothL2CAPConnectionStatus](kbluetoothl2capconnectionstatusauthenticationpending.md)
- [var kBluetoothL2CAPConnectionStatusAuthorizationPending: BluetoothL2CAPConnectionStatus](kbluetoothl2capconnectionstatusauthorizationpending.md)
- [var kBluetoothL2CAPConnectionStatusNoInfoAvailable: BluetoothL2CAPConnectionStatus](kbluetoothl2capconnectionstatusnoinfoavailable.md)
### Initializers
- [init(UInt32)](bluetoothl2capconnectionstatus/init(_:).md)
- [init(rawValue: UInt32)](bluetoothl2capconnectionstatus/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothl2capconnectionstatus/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothl2capconnectionstatus)*