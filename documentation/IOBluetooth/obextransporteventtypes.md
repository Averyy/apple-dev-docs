...
### Constants
- [var kOBEXTransportEventTypeDataReceived: OBEXTransportEventTypes](kobextransporteventtypedatareceived.md)
- [var kOBEXTransportEventTypeStatus: OBEXTransportEventTypes](kobextransporteventtypestatus.md)
### Initializers
- [init(UInt32)](obextransporteventtypes/init(_:).md)
- [init(rawValue: UInt32)](obextransporteventtypes/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](obextransporteventtypes/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/obextransporteventtypes)*