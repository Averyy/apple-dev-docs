...
```swift
typealias IOBluetoothOBEXSessionOpenConnectionCallback = (OBEXSessionRef?, OBEXError, UnsafeMutableRawPointer?) -> Void
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/iobluetoothobexsessionopenconnectioncallback)*