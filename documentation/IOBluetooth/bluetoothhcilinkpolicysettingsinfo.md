...
### Initializers
- [init()](bluetoothhcilinkpolicysettingsinfo/init.md)
- [init(settings: BluetoothHCILinkPolicySettings, handle: BluetoothConnectionHandle)](bluetoothhcilinkpolicysettingsinfo/init(settings:handle:).md)
### Instance Properties
- [var handle: BluetoothConnectionHandle](bluetoothhcilinkpolicysettingsinfo/handle.md)
- [var settings: BluetoothHCILinkPolicySettings](bluetoothhcilinkpolicysettingsinfo/settings.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcilinkpolicysettingsinfo)*