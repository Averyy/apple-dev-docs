...
### Initializers
- [init()](bluetoothhciinquiryaccesscode/init.md)
- [init(data: (UInt8, UInt8, UInt8))](bluetoothhciinquiryaccesscode/init(data:).md)
### Instance Properties
- [var data: (UInt8, UInt8, UInt8)](bluetoothhciinquiryaccesscode/data.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhciinquiryaccesscode)*