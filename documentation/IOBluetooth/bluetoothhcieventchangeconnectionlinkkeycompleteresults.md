...
### Initializers
- [init()](bluetoothhcieventchangeconnectionlinkkeycompleteresults/init.md)
- [init(connectionHandle: BluetoothConnectionHandle)](bluetoothhcieventchangeconnectionlinkkeycompleteresults/init(connectionhandle:).md)
### Instance Properties
- [var connectionHandle: BluetoothConnectionHandle](bluetoothhcieventchangeconnectionlinkkeycompleteresults/connectionhandle.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcieventchangeconnectionlinkkeycompleteresults)*