...
### Constants
- [var kBluetoothLESecurityManagerOOBAuthenticationDataNotPresent: BluetoothLESecurityManagerOOBData](kbluetoothlesecuritymanageroobauthenticationdatanotpresent.md)
- [var kBluetoothLESecurityManagerOOBAuthenticationDataPresent: BluetoothLESecurityManagerOOBData](kbluetoothlesecuritymanageroobauthenticationdatapresent.md)
- [var kBluetoothLESecurityManagerOOBDataReservedEnd: BluetoothLESecurityManagerOOBData](kbluetoothlesecuritymanageroobdatareservedend.md)
- [var kBluetoothLESecurityManagerOOBDataReservedStart: BluetoothLESecurityManagerOOBData](kbluetoothlesecuritymanageroobdatareservedstart.md)
### Initializers
- [init(UInt32)](bluetoothlesecuritymanageroobdata/init(_:).md)
- [init(rawValue: UInt32)](bluetoothlesecuritymanageroobdata/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothlesecuritymanageroobdata/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothlesecuritymanageroobdata)*