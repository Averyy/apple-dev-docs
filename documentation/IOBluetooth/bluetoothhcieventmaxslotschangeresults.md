...
### Initializers
- [init()](bluetoothhcieventmaxslotschangeresults/init.md)
- [init(connectionHandle: BluetoothConnectionHandle, maxSlots: BluetoothMaxSlots)](bluetoothhcieventmaxslotschangeresults/init(connectionhandle:maxslots:).md)
### Instance Properties
- [var connectionHandle: BluetoothConnectionHandle](bluetoothhcieventmaxslotschangeresults/connectionhandle.md)
- [var maxSlots: BluetoothMaxSlots](bluetoothhcieventmaxslotschangeresults/maxslots.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcieventmaxslotschangeresults)*