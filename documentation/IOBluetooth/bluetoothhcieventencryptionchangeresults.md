...
### Initializers
- [init()](bluetoothhcieventencryptionchangeresults/init.md)
- [init(connectionHandle: BluetoothConnectionHandle, enable: BluetoothEncryptionEnable)](bluetoothhcieventencryptionchangeresults/init(connectionhandle:enable:).md)
### Instance Properties
- [var connectionHandle: BluetoothConnectionHandle](bluetoothhcieventencryptionchangeresults/connectionhandle.md)
- [var enable: BluetoothEncryptionEnable](bluetoothhcieventencryptionchangeresults/enable.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcieventencryptionchangeresults)*