...
### Constants
- [var kBluetoothHCIPowerStateOFF: BluetoothHCIPowerState](kbluetoothhcipowerstateoff.md)
- [var kBluetoothHCIPowerStateON: BluetoothHCIPowerState](kbluetoothhcipowerstateon.md)
- [var kBluetoothHCIPowerStateUnintialized: BluetoothHCIPowerState](kbluetoothhcipowerstateunintialized.md)
### Initializers
- [init(UInt32)](bluetoothhcipowerstate/init(_:).md)
- [init(rawValue: UInt32)](bluetoothhcipowerstate/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](bluetoothhcipowerstate/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcipowerstate)*