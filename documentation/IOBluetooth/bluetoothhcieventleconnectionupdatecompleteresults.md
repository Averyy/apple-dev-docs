...
### Initializers
- [init()](bluetoothhcieventleconnectionupdatecompleteresults/init.md)
- [init(connectionHandle: BluetoothConnectionHandle, connInterval: UInt16, connLatency: UInt16, supervisionTimeout: UInt16)](bluetoothhcieventleconnectionupdatecompleteresults/init(connectionhandle:conninterval:connlatency:supervisiontimeout:).md)
### Instance Properties
- [var connInterval: UInt16](bluetoothhcieventleconnectionupdatecompleteresults/conninterval.md)
- [var connLatency: UInt16](bluetoothhcieventleconnectionupdatecompleteresults/connlatency.md)
- [var connectionHandle: BluetoothConnectionHandle](bluetoothhcieventleconnectionupdatecompleteresults/connectionhandle.md)
- [var supervisionTimeout: UInt16](bluetoothhcieventleconnectionupdatecompleteresults/supervisiontimeout.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcieventleconnectionupdatecompleteresults)*