...
- [enum IOBluetoothHandsFreeAudioGatewayFeatures](iobluetoothhandsfreeaudiogatewayfeatures.md)
- [enum IOBluetoothHandsFreeCallHoldModes](iobluetoothhandsfreecallholdmodes.md)
- [enum IOBluetoothHandsFreeCodecID](iobluetoothhandsfreecodecid.md)
- [enum IOBluetoothHandsFreeDeviceFeatures](iobluetoothhandsfreedevicefeatures.md)
- [enum IOBluetoothHandsFreePDUMessageStatus](iobluetoothhandsfreepdumessagestatus.md)
- [enum IOBluetoothHandsFreeSMSSupport](iobluetoothhandsfreesmssupport.md)
- [struct IOBluetoothL2CAPChannelEventType](iobluetoothl2capchanneleventtype.md)
- [enum IOBluetoothSMSMode](iobluetoothsmsmode.md)
...
- [BluetoothHCIUSBDeviceMatchingConstants](bluetoothhciusbdevicematchingconstants-8yru7.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/iobluetooth-enumerations)*