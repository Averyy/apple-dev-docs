...
### Initializers
- [init()](bluetoothhcieventreadremoteversioninforesults/init.md)
- [init(connectionHandle: BluetoothConnectionHandle, lmpVersion: BluetoothLMPVersion, manufacturerName: BluetoothManufacturerName, lmpSubversion: BluetoothLMPSubversion)](bluetoothhcieventreadremoteversioninforesults/init(connectionhandle:lmpversion:manufacturername:lmpsubversion:).md)
### Instance Properties
- [var connectionHandle: BluetoothConnectionHandle](bluetoothhcieventreadremoteversioninforesults/connectionhandle.md)
- [var lmpSubversion: BluetoothLMPSubversion](bluetoothhcieventreadremoteversioninforesults/lmpsubversion.md)
- [var lmpVersion: BluetoothLMPVersion](bluetoothhcieventreadremoteversioninforesults/lmpversion.md)
- [var manufacturerName: BluetoothManufacturerName](bluetoothhcieventreadremoteversioninforesults/manufacturername.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iobluetooth/bluetoothhcieventreadremoteversioninforesults)*