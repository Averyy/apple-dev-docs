...
```swift
static func decodeAtomicRepresentation(_ representation: consuming WordPair.AtomicRepresentation) -> WordPair
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/synchronization/wordpair/decodeatomicrepresentation(_:))*