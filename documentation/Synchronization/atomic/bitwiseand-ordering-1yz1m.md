...
```swift
@discardableResult
func bitwiseAnd(_ operand: Int8, ordering: AtomicUpdateOrdering) -> (oldValue: Int8, newValue: Int8)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/synchronization/atomic/bitwiseand(_:ordering:)-1yz1m)*