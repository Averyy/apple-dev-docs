...
```swift
@discardableResult
func bitwiseOr(_ operand: Int32, ordering: AtomicUpdateOrdering) -> (oldValue: Int32, newValue: Int32)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/synchronization/atomic/bitwiseor(_:ordering:)-206dk)*