...
```swift
@discardableResult
func subtract(_ operand: Int, ordering: AtomicUpdateOrdering) -> (oldValue: Int, newValue: Int)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/synchronization/atomic/subtract(_:ordering:)-1iop7)*