...
```swift
@discardableResult
func bitwiseAnd(_ operand: UInt32, ordering: AtomicUpdateOrdering) -> (oldValue: UInt32, newValue: UInt32)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/synchronization/atomic/bitwiseand(_:ordering:)-5iaoz)*