...
```swift
@discardableResult
func subtract(_ operand: Int32, ordering: AtomicUpdateOrdering) -> (oldValue: Int32, newValue: Int32)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/synchronization/atomic/subtract(_:ordering:)-7ebxd)*