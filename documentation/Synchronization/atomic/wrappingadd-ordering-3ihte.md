...
```swift
@discardableResult
func wrappingAdd(_ operand: Int, ordering: AtomicUpdateOrdering) -> (oldValue: Int, newValue: Int)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/synchronization/atomic/wrappingadd(_:ordering:)-3ihte)*