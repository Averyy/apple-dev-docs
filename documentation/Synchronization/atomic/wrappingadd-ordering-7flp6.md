...
```swift
@discardableResult
func wrappingAdd(_ operand: Int8, ordering: AtomicUpdateOrdering) -> (oldValue: Int8, newValue: Int8)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/synchronization/atomic/wrappingadd(_:ordering:)-7flp6)*