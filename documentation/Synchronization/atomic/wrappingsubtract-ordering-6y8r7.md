...
```swift
@discardableResult
func wrappingSubtract(_ operand: UInt32, ordering: AtomicUpdateOrdering) -> (oldValue: UInt32, newValue: UInt32)
```
...
> **Note**: This operation silently wraps around on overflow, like the `&-` operator does on `UInt32` values.
...
*[View on Apple Developer](https://developer.apple.com/documentation/synchronization/atomic/wrappingsubtract(_:ordering:)-6y8r7)*