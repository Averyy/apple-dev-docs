...
```swift
@discardableResult
func wrappingSubtract(_ operand: Int8, ordering: AtomicUpdateOrdering) -> (oldValue: Int8, newValue: Int8)
```
...
> **Note**: This operation silently wraps around on overflow, like the `&-` operator does on `Int8` values.
...
*[View on Apple Developer](https://developer.apple.com/documentation/synchronization/atomic/wrappingsubtract(_:ordering:)-6xyiw)*