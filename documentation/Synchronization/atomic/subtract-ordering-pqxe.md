...
```swift
@discardableResult
func subtract(_ operand: UInt, ordering: AtomicUpdateOrdering) -> (oldValue: UInt, newValue: UInt)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/synchronization/atomic/subtract(_:ordering:)-pqxe)*