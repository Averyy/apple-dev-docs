...
```swift
@discardableResult
func max(_ operand: UInt32, ordering: AtomicUpdateOrdering) -> (oldValue: UInt32, newValue: UInt32)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/synchronization/atomic/max(_:ordering:)-7qnkd)*