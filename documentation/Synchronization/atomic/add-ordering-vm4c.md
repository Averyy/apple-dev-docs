...
```swift
@discardableResult
func add(_ operand: Int32, ordering: AtomicUpdateOrdering) -> (oldValue: Int32, newValue: Int32)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/synchronization/atomic/add(_:ordering:)-vm4c)*