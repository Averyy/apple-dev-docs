...
```swift
@discardableResult
func wrappingSubtract(_ operand: UInt128, ordering: AtomicUpdateOrdering) -> (oldValue: UInt128, newValue: UInt128)
```
...
> **Note**: This operation silently wraps around on overflow, like the `&-` operator does on `UInt128` values.
...
*[View on Apple Developer](https://developer.apple.com/documentation/synchronization/atomic/wrappingsubtract(_:ordering:)-43111)*