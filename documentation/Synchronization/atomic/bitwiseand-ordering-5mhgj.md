...
```swift
@discardableResult
func bitwiseAnd(_ operand: UInt, ordering: AtomicUpdateOrdering) -> (oldValue: UInt, newValue: UInt)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/synchronization/atomic/bitwiseand(_:ordering:)-5mhgj)*