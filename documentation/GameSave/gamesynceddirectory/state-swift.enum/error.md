# GameSyncedDirectory.State.error(_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/gamesave/gamesynceddirectory/state-swift.enum/error(_:))*