# GameSyncedDirectory.State.conflicted(versions:)
...
```swift
case conflicted(versions: [GameSyncedDirectory.Version])
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/gamesave/gamesynceddirectory/state-swift.enum/conflicted(versions:))*