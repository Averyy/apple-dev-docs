...
```swift
final let remoteLanguage: Locale.Language
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/livecommunicationkit/settranslatingaction/remotelanguage)*