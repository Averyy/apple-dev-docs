...
```swift
let direction: ConversationHistoryManager.RecentConversation.Direction
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/livecommunicationkit/conversationhistorymanager/recentconversation/direction-swift.property)*