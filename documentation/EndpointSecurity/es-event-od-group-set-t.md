...
### Initializers
- [init(instigator: UnsafeMutablePointer<es_process_t>?, error_code: Int32, group_name: es_string_token_t, members: UnsafeMutablePointer<es_od_member_id_array_t>, node_name: es_string_token_t, db_path: es_string_token_t, instigator_token: audit_token_t)](es_event_od_group_set_t/init(instigator:error_code:group_name:members:node_name:db_path:instigator_token:).md)
### Instance Properties
- [var db_path: es_string_token_t](es_event_od_group_set_t/db_path.md)
- [var error_code: Int32](es_event_od_group_set_t/error_code.md)
- [var group_name: es_string_token_t](es_event_od_group_set_t/group_name.md)
- [var instigator: UnsafeMutablePointer<es_process_t>?](es_event_od_group_set_t/instigator.md)
- [var instigator_token: audit_token_t](es_event_od_group_set_t/instigator_token.md)
- [var members: UnsafeMutablePointer<es_od_member_id_array_t>](es_event_od_group_set_t/members.md)
- [var node_name: es_string_token_t](es_event_od_group_set_t/node_name.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_event_od_group_set_t)*