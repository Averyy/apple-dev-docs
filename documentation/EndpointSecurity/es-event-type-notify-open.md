...
```swift
var ES_EVENT_TYPE_NOTIFY_OPEN: es_event_type_t { get }
```

#### Discussion

This identifier corresponds to the [`es_events_t`](es_events_t.md) union member [`open`](es_events_t/open.md), which has the type [`es_event_open_t`](es_event_open_t.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_event_type_notify_open)*