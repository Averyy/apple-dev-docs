...
```swift
var get_task_inspect: es_event_get_task_inspect_t { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_events_t/get_task_inspect)*