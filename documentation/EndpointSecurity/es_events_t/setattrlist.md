...
```swift
var setattrlist: es_event_setattrlist_t { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_events_t/setattrlist)*