...
```swift
var listextattr: es_event_listextattr_t { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_events_t/listextattr)*