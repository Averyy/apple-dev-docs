...
```swift
var file_provider_materialize: es_event_file_provider_materialize_t { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_events_t/file_provider_materialize)*