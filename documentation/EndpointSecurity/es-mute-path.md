...
To mute a subset of events from a path, use [`es_mute_path_events(_:_:_:_:_:)`](es_mute_path_events(_:_:_:_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_mute_path(_:_:_:))*