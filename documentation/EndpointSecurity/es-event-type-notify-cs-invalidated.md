...
```swift
var ES_EVENT_TYPE_NOTIFY_CS_INVALIDATED: es_event_type_t { get }
```

#### Discussion

This identifier corresponds to the [`es_events_t`](es_events_t.md) union member [`cs_invalidated`](es_events_t/cs_invalidated.md), which has the type [`es_event_cs_invalidated_t`](es_event_cs_invalidated_t.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_event_type_notify_cs_invalidated)*