...
### Initializers
- [init()](es_event_xpc_connect_t/init.md)
- [init(service_name: es_string_token_t, service_domain_type: es_xpc_domain_type_t)](es_event_xpc_connect_t/init(service_name:service_domain_type:).md)
### Instance Properties
- [var service_domain_type: es_xpc_domain_type_t](es_event_xpc_connect_t/service_domain_type.md)
- [var service_name: es_string_token_t](es_event_xpc_connect_t/service_name.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_event_xpc_connect_t)*