...
```swift
struct es_event_profile_remove_t
```

## Topics

### Initializers
- [init(instigator: UnsafeMutablePointer<es_process_t>?, profile: UnsafeMutablePointer<es_profile_t>, instigator_token: audit_token_t)](es_event_profile_remove_t/init(instigator:profile:instigator_token:).md)
### Instance Properties
- [var instigator: UnsafeMutablePointer<es_process_t>?](es_event_profile_remove_t/instigator.md)
- [var instigator_token: audit_token_t](es_event_profile_remove_t/instigator_token.md)
- [var profile: UnsafeMutablePointer<es_profile_t>](es_event_profile_remove_t/profile.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_event_profile_remove_t)*