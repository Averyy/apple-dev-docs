...
### Initializers
- [init()](es_event_authentication_auto_unlock_t/init.md)
- [init(username: es_string_token_t, type: es_auto_unlock_type_t)](es_event_authentication_auto_unlock_t/init(username:type:).md)
### Instance Properties
- [var type: es_auto_unlock_type_t](es_event_authentication_auto_unlock_t/type.md)
- [var username: es_string_token_t](es_event_authentication_auto_unlock_t/username.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_event_authentication_auto_unlock_t)*