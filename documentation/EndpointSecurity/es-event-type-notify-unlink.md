...
```swift
var ES_EVENT_TYPE_NOTIFY_UNLINK: es_event_type_t { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_event_type_notify_unlink)*