...
```swift
struct es_event_lw_session_unlock_t
```

## Topics

### Initializers
- [init()](es_event_lw_session_unlock_t/init.md)
- [init(username: es_string_token_t, graphical_session_id: es_graphical_session_id_t)](es_event_lw_session_unlock_t/init(username:graphical_session_id:).md)
### Instance Properties
- [var graphical_session_id: es_graphical_session_id_t](es_event_lw_session_unlock_t/graphical_session_id.md)
- [var username: es_string_token_t](es_event_lw_session_unlock_t/username.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_event_lw_session_unlock_t)*