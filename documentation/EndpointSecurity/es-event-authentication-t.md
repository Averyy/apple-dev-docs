...
### Initializers
- [init()](es_event_authentication_t/init.md)
- [init(success: Bool, type: es_authentication_type_t, data: es_event_authentication_t.__Unnamed_union_data)](es_event_authentication_t/init(success:type:data:).md)
### Instance Properties
- [var data: es_event_authentication_t.__Unnamed_union_data](es_event_authentication_t/data.md)
- [var success: Bool](es_event_authentication_t/success.md)
- [var type: es_authentication_type_t](es_event_authentication_t/type.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_event_authentication_t)*