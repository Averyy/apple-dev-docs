...
To unmute all events from a path, use [`es_unmute_path(_:_:_:)`](es_unmute_path(_:_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_unmute_path_events(_:_:_:_:_:))*