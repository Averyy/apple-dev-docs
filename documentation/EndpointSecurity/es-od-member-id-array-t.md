...
### Initializers
- [init()](es_od_member_id_array_t/init.md)
- [init(member_type: es_od_member_type_t, member_count: Int, member_array: es_od_member_id_array_t.__Unnamed_union_member_array)](es_od_member_id_array_t/init(member_type:member_count:member_array:).md)
### Instance Properties
- [var member_array: es_od_member_id_array_t.__Unnamed_union_member_array](es_od_member_id_array_t/member_array.md)
- [var member_count: Int](es_od_member_id_array_t/member_count.md)
- [var member_type: es_od_member_type_t](es_od_member_id_array_t/member_type.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_od_member_id_array_t)*