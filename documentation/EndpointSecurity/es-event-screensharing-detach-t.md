...
### Initializers
- [init()](es_event_screensharing_detach_t/init.md)
- [init(source_address_type: es_address_type_t, source_address: es_string_token_t, viewer_appleid: es_string_token_t, graphical_session_id: es_graphical_session_id_t)](es_event_screensharing_detach_t/init(source_address_type:source_address:viewer_appleid:graphical_session_id:).md)
### Instance Properties
- [var graphical_session_id: es_graphical_session_id_t](es_event_screensharing_detach_t/graphical_session_id.md)
- [var source_address: es_string_token_t](es_event_screensharing_detach_t/source_address.md)
- [var source_address_type: es_address_type_t](es_event_screensharing_detach_t/source_address_type.md)
- [var viewer_appleid: es_string_token_t](es_event_screensharing_detach_t/viewer_appleid.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_event_screensharing_detach_t)*