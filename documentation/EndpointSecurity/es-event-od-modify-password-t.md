...
### Initializers
- [init()](es_event_od_modify_password_t/init.md)
- [init(instigator: UnsafeMutablePointer<es_process_t>?, error_code: Int32, account_type: es_od_account_type_t, account_name: es_string_token_t, node_name: es_string_token_t, db_path: es_string_token_t, instigator_token: audit_token_t)](es_event_od_modify_password_t/init(instigator:error_code:account_type:account_name:node_name:db_path:instigator_token:).md)
### Instance Properties
- [var account_name: es_string_token_t](es_event_od_modify_password_t/account_name.md)
- [var account_type: es_od_account_type_t](es_event_od_modify_password_t/account_type.md)
- [var db_path: es_string_token_t](es_event_od_modify_password_t/db_path.md)
- [var error_code: Int32](es_event_od_modify_password_t/error_code.md)
- [var instigator: UnsafeMutablePointer<es_process_t>?](es_event_od_modify_password_t/instigator.md)
- [var instigator_token: audit_token_t](es_event_od_modify_password_t/instigator_token.md)
- [var node_name: es_string_token_t](es_event_od_modify_password_t/node_name.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_event_od_modify_password_t)*