...
```swift
var ES_EVENT_TYPE_NOTIFY_GET_TASK_READ: es_event_type_t { get }
```
...
Endpoint Security delivers this event when a process obtains a send control right to a task control port. This is a result of calling APIs like `SYS_task_read_for_pid` or `task_identity_token_get_task_port(_:_:_:)`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_event_type_notify_get_task_read)*