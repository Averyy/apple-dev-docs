...
```swift
var ES_EVENT_TYPE_NOTIFY_GETATTRLIST: es_event_type_t { get }
```

#### Discussion

This identifier corresponds to the [`es_events_t`](es_events_t.md) union member [`getattrlist`](es_events_t/getattrlist.md), which has type [`es_event_getattrlist_t`](es_event_getattrlist_t.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_event_type_notify_getattrlist)*