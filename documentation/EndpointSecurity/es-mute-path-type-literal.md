...
```swift
var ES_MUTE_PATH_TYPE_LITERAL: es_mute_path_type_t { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_mute_path_type_literal)*