...
```swift
var ES_EVENT_TYPE_NOTIFY_SETREUID: es_event_type_t { get }
```

#### Discussion

This identifier corresponds to the [`es_events_t`](es_events_t.md) union member [`setreuid`](es_events_t/setreuid.md), which has the type [`es_event_setreuid_t`](es_event_setreuid_t.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_event_type_notify_setreuid)*