...
### Initializers
- [init()](es_event_login_login_t/init.md)
- [init(success: Bool, failure_message: es_string_token_t, username: es_string_token_t, has_uid: Bool, uid: es_event_login_login_t.__Unnamed_union_uid)](es_event_login_login_t/init(success:failure_message:username:has_uid:uid:).md)
### Instance Properties
- [var failure_message: es_string_token_t](es_event_login_login_t/failure_message.md)
- [var has_uid: Bool](es_event_login_login_t/has_uid.md)
- [var success: Bool](es_event_login_login_t/success.md)
- [var uid: es_event_login_login_t.__Unnamed_union_uid](es_event_login_login_t/uid.md)
- [var username: es_string_token_t](es_event_login_login_t/username.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_event_login_login_t)*