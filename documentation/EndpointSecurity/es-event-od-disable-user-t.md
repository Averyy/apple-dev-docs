...
```swift
struct es_event_od_disable_user_t
```

## Topics

### Initializers
- [init()](es_event_od_disable_user_t/init.md)
- [init(instigator: UnsafeMutablePointer<es_process_t>?, error_code: Int32, user_name: es_string_token_t, node_name: es_string_token_t, db_path: es_string_token_t, instigator_token: audit_token_t)](es_event_od_disable_user_t/init(instigator:error_code:user_name:node_name:db_path:instigator_token:).md)
### Instance Properties
- [var db_path: es_string_token_t](es_event_od_disable_user_t/db_path.md)
- [var error_code: Int32](es_event_od_disable_user_t/error_code.md)
- [var instigator: UnsafeMutablePointer<es_process_t>?](es_event_od_disable_user_t/instigator.md)
- [var instigator_token: audit_token_t](es_event_od_disable_user_t/instigator_token.md)
- [var node_name: es_string_token_t](es_event_od_disable_user_t/node_name.md)
- [var user_name: es_string_token_t](es_event_od_disable_user_t/user_name.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_event_od_disable_user_t)*