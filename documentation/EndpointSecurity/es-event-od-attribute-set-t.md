...
### Initializers
- [init()](es_event_od_attribute_set_t/init.md)
- [init(instigator: UnsafeMutablePointer<es_process_t>?, error_code: Int32, record_type: es_od_record_type_t, record_name: es_string_token_t, attribute_name: es_string_token_t, attribute_value_count: Int, attribute_values: UnsafeMutablePointer<es_string_token_t>?, node_name: es_string_token_t, db_path: es_string_token_t, instigator_token: audit_token_t)](es_event_od_attribute_set_t/init(instigator:error_code:record_type:record_name:attribute_name:attribute_value_count:attribute_values:node_name:db_path:instigator_token:).md)
### Instance Properties
- [var attribute_name: es_string_token_t](es_event_od_attribute_set_t/attribute_name.md)
- [var attribute_value_count: Int](es_event_od_attribute_set_t/attribute_value_count.md)
- [var attribute_values: UnsafeMutablePointer<es_string_token_t>?](es_event_od_attribute_set_t/attribute_values.md)
- [var db_path: es_string_token_t](es_event_od_attribute_set_t/db_path.md)
- [var error_code: Int32](es_event_od_attribute_set_t/error_code.md)
- [var instigator: UnsafeMutablePointer<es_process_t>?](es_event_od_attribute_set_t/instigator.md)
- [var instigator_token: audit_token_t](es_event_od_attribute_set_t/instigator_token.md)
- [var node_name: es_string_token_t](es_event_od_attribute_set_t/node_name.md)
- [var record_name: es_string_token_t](es_event_od_attribute_set_t/record_name.md)
- [var record_type: es_od_record_type_t](es_event_od_attribute_set_t/record_type.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_event_od_attribute_set_t)*