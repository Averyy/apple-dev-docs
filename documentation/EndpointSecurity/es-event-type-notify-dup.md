...
```swift
var ES_EVENT_TYPE_NOTIFY_DUP: es_event_type_t { get }
```

#### Discussion

This identifier corresponds to the [`es_events_t`](es_events_t.md) union member [`dup`](es_events_t/dup.md), which has the type [`es_event_dup_t`](es_event_dup_t.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_event_type_notify_dup)*