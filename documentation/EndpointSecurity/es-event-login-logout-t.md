...
### Initializers
- [init()](es_event_login_logout_t/init.md)
- [init(username: es_string_token_t, uid: uid_t)](es_event_login_logout_t/init(username:uid:).md)
### Instance Properties
- [var uid: uid_t](es_event_login_logout_t/uid.md)
- [var username: es_string_token_t](es_event_login_logout_t/username.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_event_login_logout_t)*