...
```swift
struct es_od_member_id_t
```

## Topics

### Initializers
- [init()](es_od_member_id_t/init.md)
- [init(member_type: es_od_member_type_t, member_value: es_od_member_id_t.__Unnamed_union_member_value)](es_od_member_id_t/init(member_type:member_value:).md)
### Instance Properties
- [var member_type: es_od_member_type_t](es_od_member_id_t/member_type.md)
- [var member_value: es_od_member_id_t.__Unnamed_union_member_value](es_od_member_id_t/member_value.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_od_member_id_t)*