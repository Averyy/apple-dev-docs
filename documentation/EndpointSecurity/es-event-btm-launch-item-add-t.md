...
### Initializers
- [init(instigator: UnsafeMutablePointer<es_process_t>?, app: UnsafeMutablePointer<es_process_t>?, item: UnsafeMutablePointer<es_btm_launch_item_t>, executable_path: es_string_token_t, instigator_token: UnsafeMutablePointer<audit_token_t>?, app_token: UnsafeMutablePointer<audit_token_t>?)](es_event_btm_launch_item_add_t/init(instigator:app:item:executable_path:instigator_token:app_token:).md)
### Instance Properties
- [var app: UnsafeMutablePointer<es_process_t>?](es_event_btm_launch_item_add_t/app.md)
- [var app_token: UnsafeMutablePointer<audit_token_t>?](es_event_btm_launch_item_add_t/app_token.md)
- [var executable_path: es_string_token_t](es_event_btm_launch_item_add_t/executable_path.md)
- [var instigator: UnsafeMutablePointer<es_process_t>?](es_event_btm_launch_item_add_t/instigator.md)
- [var instigator_token: UnsafeMutablePointer<audit_token_t>?](es_event_btm_launch_item_add_t/instigator_token.md)
- [var item: UnsafeMutablePointer<es_btm_launch_item_t>](es_event_btm_launch_item_add_t/item.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_event_btm_launch_item_add_t)*