...
```swift
var ES_EVENT_TYPE_NOTIFY_EXEC: es_event_type_t { get }
```

#### Discussion

This identifier corresponds to the [`es_events_t`](es_events_t.md) union member [`exec`](es_events_t/exec.md), which has the type [`es_event_exec_t`](es_event_exec_t.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_event_type_notify_exec)*