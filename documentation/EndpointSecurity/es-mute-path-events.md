...
To mute all events from a path, use [`es_mute_path(_:_:_:)`](es_mute_path(_:_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_mute_path_events(_:_:_:_:_:))*