...
### Initializers
- [init()](es_signed_file_info_t/init.md)
- [init(cdhash: es_cdhash_t, signing_id: es_string_token_t, team_id: es_string_token_t)](es_signed_file_info_t/init(cdhash:signing_id:team_id:).md)
### Instance Properties
- [var cdhash: es_cdhash_t](es_signed_file_info_t/cdhash.md)
- [var signing_id: es_string_token_t](es_signed_file_info_t/signing_id.md)
- [var team_id: es_string_token_t](es_signed_file_info_t/team_id.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_signed_file_info_t)*