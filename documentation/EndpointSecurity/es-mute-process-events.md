...
To mute all events from a process, use [`es_mute_process(_:_:)`](es_mute_process(_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_mute_process_events(_:_:_:_:))*