...
### Initializers
- [init(instigator: UnsafeMutablePointer<es_process_t>?, is_update: Bool, profile: UnsafeMutablePointer<es_profile_t>, instigator_token: audit_token_t)](es_event_profile_add_t/init(instigator:is_update:profile:instigator_token:).md)
### Instance Properties
- [var instigator: UnsafeMutablePointer<es_process_t>?](es_event_profile_add_t/instigator.md)
- [var instigator_token: audit_token_t](es_event_profile_add_t/instigator_token.md)
- [var is_update: Bool](es_event_profile_add_t/is_update.md)
- [var profile: UnsafeMutablePointer<es_profile_t>](es_event_profile_add_t/profile.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_event_profile_add_t)*