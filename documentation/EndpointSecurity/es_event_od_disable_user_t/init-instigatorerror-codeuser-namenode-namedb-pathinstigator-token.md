...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_event_od_disable_user_t/init(instigator:error_code:user_name:node_name:db_path:instigator_token:))*