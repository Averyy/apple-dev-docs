...
```swift
var ES_EVENT_TYPE_AUTH_FSGETPATH: es_event_type_t { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_event_type_auth_fsgetpath)*