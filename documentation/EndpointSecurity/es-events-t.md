...
- [init(bootstrap_check_in: UnsafeMutablePointer<es_event_bootstrap_check_in_t>)](es_events_t/init(bootstrap_check_in:).md)
- [init(bootstrap_look_up: UnsafeMutablePointer<es_event_bootstrap_look_up_t>)](es_events_t/init(bootstrap_look_up:).md)
...
- [var bootstrap_check_in: UnsafeMutablePointer<es_event_bootstrap_check_in_t>](es_events_t/bootstrap_check_in.md)
- [var bootstrap_look_up: UnsafeMutablePointer<es_event_bootstrap_look_up_t>](es_events_t/bootstrap_look_up.md)
