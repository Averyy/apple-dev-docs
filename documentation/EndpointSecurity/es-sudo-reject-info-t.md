...
### Initializers
- [init()](es_sudo_reject_info_t/init.md)
- [init(plugin_name: es_string_token_t, plugin_type: es_sudo_plugin_type_t, failure_message: es_string_token_t)](es_sudo_reject_info_t/init(plugin_name:plugin_type:failure_message:).md)
### Instance Properties
- [var failure_message: es_string_token_t](es_sudo_reject_info_t/failure_message.md)
- [var plugin_name: es_string_token_t](es_sudo_reject_info_t/plugin_name.md)
- [var plugin_type: es_sudo_plugin_type_t](es_sudo_reject_info_t/plugin_type.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/endpointsecurity/es_sudo_reject_info_t)*