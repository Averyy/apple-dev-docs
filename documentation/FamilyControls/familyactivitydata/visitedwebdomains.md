...
> ❗ **Important**:  Authorize your app with doc://com.apple.documentation/documentation/familycontrols/authorizationcenter and ensure data access is available before accessing this variable. Otherwise, it will always throw an error.
