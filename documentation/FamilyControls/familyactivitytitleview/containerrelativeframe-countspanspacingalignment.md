...
*[View on Apple Developer](https://developer.apple.com/documentation/familycontrols/familyactivitytitleview/containerrelativeframe(_:count:span:spacing:alignment:))*