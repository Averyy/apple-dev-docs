...
*[View on Apple Developer](https://developer.apple.com/documentation/familycontrols/familyactivitytitleview/contextmenu(forselectiontype:menu:primaryaction:))*