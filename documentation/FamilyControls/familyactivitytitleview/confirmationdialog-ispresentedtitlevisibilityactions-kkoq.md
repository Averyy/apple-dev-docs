...
*[View on Apple Developer](https://developer.apple.com/documentation/familycontrols/familyactivitytitleview/confirmationdialog(_:ispresented:titlevisibility:actions:)-kkoq)*