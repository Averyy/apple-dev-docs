...
- [func controlSize(ControlSize) -> some View](familyactivitytitleview/controlsize(_:).md)
...
- [func sensoryFeedback<T>(trigger: T, (T, T) -> SensoryFeedback?) -> some View](familyactivitytitleview/sensoryfeedback(trigger:_:).md)
