...
*[View on Apple Developer](https://developer.apple.com/documentation/familycontrols/familyactivitytitleview/searchable(text:tokens:ispresented:placement:prompt:token:)-3qngw)*