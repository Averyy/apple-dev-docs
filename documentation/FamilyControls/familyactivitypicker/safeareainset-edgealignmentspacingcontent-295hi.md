...
*[View on Apple Developer](https://developer.apple.com/documentation/familycontrols/familyactivitypicker/safeareainset(edge:alignment:spacing:content:)-295hi)*