...
*[View on Apple Developer](https://developer.apple.com/documentation/familycontrols/familyactivitypicker/searchable(text:ispresented:placement:prompt:)-23yf3)*