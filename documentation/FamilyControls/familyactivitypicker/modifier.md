...
You can use [`modifier(_:)`](familyactivitypicker/modifier(_:).md) to extend `View` to create new modifier for applying the `BorderedCaption` defined above:
...
*[View on Apple Developer](https://developer.apple.com/documentation/familycontrols/familyactivitypicker/modifier(_:))*