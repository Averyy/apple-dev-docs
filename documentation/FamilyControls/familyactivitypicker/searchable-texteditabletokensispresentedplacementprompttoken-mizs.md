...
*[View on Apple Developer](https://developer.apple.com/documentation/familycontrols/familyactivitypicker/searchable(text:editabletokens:ispresented:placement:prompt:token:)-mizs)*