...
*[View on Apple Developer](https://developer.apple.com/documentation/familycontrols/familyactivityiconview/matchedgeometryeffect(id:in:properties:anchor:issource:))*