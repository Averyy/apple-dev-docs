...
*[View on Apple Developer](https://developer.apple.com/documentation/familycontrols/familyactivityiconview/filemover(ispresented:files:oncompletion:oncancellation:))*