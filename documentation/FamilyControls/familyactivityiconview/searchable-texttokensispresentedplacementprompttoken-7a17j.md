...
*[View on Apple Developer](https://developer.apple.com/documentation/familycontrols/familyactivityiconview/searchable(text:tokens:ispresented:placement:prompt:token:)-7a17j)*