...
*[View on Apple Developer](https://developer.apple.com/documentation/familycontrols/familyactivityiconview/confirmationdialog(_:ispresented:titlevisibility:actions:)-4j9up)*