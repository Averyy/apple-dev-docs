...
*[View on Apple Developer](https://developer.apple.com/documentation/familycontrols/familyactivityiconview/containerrelativeframe(_:count:span:spacing:alignment:))*