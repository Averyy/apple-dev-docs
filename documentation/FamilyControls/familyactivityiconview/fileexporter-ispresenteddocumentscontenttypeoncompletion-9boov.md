...
*[View on Apple Developer](https://developer.apple.com/documentation/familycontrols/familyactivityiconview/fileexporter(ispresented:documents:contenttype:oncompletion:)-9boov)*