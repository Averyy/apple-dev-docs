...
*[View on Apple Developer](https://developer.apple.com/documentation/familycontrols/familyactivityiconview/searchable(text:editabletokens:placement:prompt:token:)-4lrdp)*