...
```swift
@MainActor
protocol NSCollectionViewAppIntentsDataSource : AnyObject
```
...
### Instance Methods
- [func collectionView(NSCollectionView, appEntityIdentifierForItemAt: IndexPath) -> EntityIdentifier?](nscollectionviewappintentsdatasource/collectionview(_:appentityidentifierforitemat:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/nscollectionviewappintentsdatasource)*