...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/shortcutslink/manipulable(coordinatespace:operations:inertia:isenabled:onchanged:))*