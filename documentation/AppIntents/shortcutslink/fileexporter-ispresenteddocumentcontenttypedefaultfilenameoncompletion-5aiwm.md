...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/shortcutslink/fileexporter(ispresented:document:contenttype:defaultfilename:oncompletion:)-5aiwm)*