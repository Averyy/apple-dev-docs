...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/shortcutslink/searchable(text:tokens:ispresented:placement:prompt:token:)-44lnk)*