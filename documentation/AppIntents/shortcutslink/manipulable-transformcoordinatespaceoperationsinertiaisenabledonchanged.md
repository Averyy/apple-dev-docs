...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/shortcutslink/manipulable(transform:coordinatespace:operations:inertia:isenabled:onchanged:))*