...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/shortcutslink/fileexporter(ispresented:documents:contenttypes:oncompletion:oncancellation:)-6urmh)*