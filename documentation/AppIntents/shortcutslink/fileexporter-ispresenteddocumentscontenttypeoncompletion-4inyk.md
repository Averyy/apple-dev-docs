...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/shortcutslink/fileexporter(ispresented:documents:contenttype:oncompletion:)-4inyk)*