...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/resolverspecificationbuilder/specification/split(maxsplits:omittingemptysubsequences:whereseparator:))*