...
```swift
func resolve(from input: Int, context: IntentParameterContext<Int>) async throws -> Int?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/intresolver/resolve(from:context:))*