...
```swift
func resolve(from input: Double, context: IntentParameterContext<Double>) async throws -> Double?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/doubleresolver/resolve(from:context:))*