...
The following example shows an app intent that conforms to the `.wordProcessor.open` schema:
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschema/intentschema/open-a0vk)*