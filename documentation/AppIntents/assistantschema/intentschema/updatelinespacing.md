...
The following example shows an app intent that conforms to the `.books.updateLineSpacing` schema:
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschema/intentschema/updatelinespacing)*