...
The following example shows an app intent that conforms to the `.photos.pasteEdits` schema:

```swift
@AssistantIntent(schema: .photos.pasteEdits)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/photosintent/pasteedits)*