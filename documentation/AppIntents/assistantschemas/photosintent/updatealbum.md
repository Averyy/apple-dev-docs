...
The following example shows an app intent that conforms to the `.photos.updateAlbum` schema:
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/photosintent/updatealbum)*