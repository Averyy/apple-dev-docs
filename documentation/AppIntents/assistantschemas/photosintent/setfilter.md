...
The following example shows an app intent that conforms to the `.photos.setFilter` schema:
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/photosintent/setfilter)*