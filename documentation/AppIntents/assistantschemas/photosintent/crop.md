...
The following example shows an app intent that conforms to the `.photos.crop` schema:

```swift
@AssistantIntent(schema: .photos.crop)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/photosintent/crop)*