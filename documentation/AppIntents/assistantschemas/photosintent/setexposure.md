...
The following example shows an app intent that conforms to the `.photos.setExposure` schema:

```swift
@AssistantIntent(schema: .photos.setExposure)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/photosintent/setexposure)*