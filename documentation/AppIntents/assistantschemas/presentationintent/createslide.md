...
The following example shows an app intent that conforms to the `.presentation.createSlide` schema:
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/presentationintent/createslide)*