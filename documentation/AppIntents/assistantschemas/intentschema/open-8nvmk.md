...
The following example shows an app intent that conforms to the `.spreadsheet.open` schema:
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/intentschema/open-8nvmk)*