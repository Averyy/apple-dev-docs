...
```swift
var deleteDraft: some AssistantSchemas.Intent { get }
```
...
The following example shows an app intent that conforms to the `.mail.deleteDraft` schema:
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/intentschema/deletedraft)*