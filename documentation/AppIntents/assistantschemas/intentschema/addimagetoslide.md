...
The following example shows an app intent that conforms to the `.presentation.addImageToSlide` schema:

```swift
@AssistantIntent(schema: .presentation.addImageToSlide)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/intentschema/addimagetoslide)*