...
The following example shows an app intent that conforms to the `.whiteboard.updateBoard` schema:

```swift
@AssistantIntent(schema: .whiteboard.updateBoard)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/intentschema/updateboard)*