...
The following example shows an app intent that conforms to the `.photos.removeAssetsFromAlbum` schema:
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/intentschema/removeassetsfromalbum)*