...
The following example shows an app intent that conforms to the `.photos.postToSharedAlbum` schema:

```swift
@AssistantIntent(schema: .photos.postToSharedAlbum)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/intentschema/posttosharedalbum)*