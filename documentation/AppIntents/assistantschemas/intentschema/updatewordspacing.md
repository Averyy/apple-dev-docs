...
The following example shows an app intent that conforms to the `.books.updateWordSpacing` schema:
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/intentschema/updatewordspacing)*