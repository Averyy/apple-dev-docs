...
The following example shows an app intent that conforms to the `.spreadsheet.delete` schema:

```swift
@AssistantIntent(schema: .spreadsheet.delete)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/intentschema/delete)*