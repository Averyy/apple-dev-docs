...
The following example shows an app intent that conforms to the `.files.moveFiles` schema:

```swift
@AssistantIntent(schema: .files.moveFiles)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/intentschema/movefiles)*