...
The following example shows an app intent that conforms to the `.photos.search` schema:
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/intentschema/search-7tw5s)*