...
The following example shows an app intent that conforms to the `.reader.enhanceDocuments` schema:

```swift
@AssistantIntent(schema: .reader.enhanceDocuments)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/intentschema/enhancedocuments)*