...
The following example shows an app intent that conforms to the `.journal.search` schema:
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/intentschema/search-8m2k3)*