...
The following example shows an app intent that conforms to the `.reader.insertPages` schema:
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/intentschema/insertpages)*