...
The following example shows an app intent that conforms to the `.photos.copyEdits` schema:

```swift
@AssistantIntent(schema: .photos.copyEdits)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/intentschema/copyedits)*