...
The following example shows an app intent that conforms to the `.photos.straighten` schema:

```swift
@AssistantIntent(schema: .photos.straighten)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/intentschema/straighten)*