...
The following example shows an app intent that conforms to the `.photos.cleanupPhoto` schema:

```swift
@AssistantIntent(schema: .photos.cleanupPhoto)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/intentschema/cleanupphoto)*