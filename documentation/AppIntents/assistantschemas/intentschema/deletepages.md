...
The following example shows an app intent that conforms to the `.reader.deletePages` schema:

```swift
@AssistantIntent(schema: .reader.deletePages)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/intentschema/deletepages)*