...
The following example shows an app intent that conforms to the `.spreadsheet.openSheet` schema:

```swift
@AssistantIntent(schema: .spreadsheet.openSheet)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/intentschema/opensheet)*