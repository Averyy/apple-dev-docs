...
The following example shows an app intent that conforms to the `.browser.clearHistory` schema:
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/browserintent/clearhistory)*