...
The following example shows an app enum that conforms to the `.books.font` schema:

```swift
@AssistantEnum(schema: .books.font)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/enumschema/font)*