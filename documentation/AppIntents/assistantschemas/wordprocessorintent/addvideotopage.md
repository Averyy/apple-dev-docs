...
The following example shows an app intent that conforms to the `.wordProcessor.addVideoToPage` schema:
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/assistantschemas/wordprocessorintent/addvideotopage)*