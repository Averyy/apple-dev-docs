...
```swift
func resolve(from input: String, context: IntentParameterContext<Bool>) async throws -> Bool?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/boolfromstringresolver/resolve(from:context:))*