...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/emptyresolverspecification/split(maxsplits:omittingemptysubsequences:whereseparator:))*