...
```swift
@MainActor
protocol UICollectionViewAppIntentsDataSource : AnyObject
```
...
### Instance Methods
- [func collectionView(UICollectionView, appEntityIdentifierForItemAt: IndexPath) -> EntityIdentifier?](uicollectionviewappintentsdatasource/collectionview(_:appentityidentifierforitemat:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/uicollectionviewappintentsdatasource)*