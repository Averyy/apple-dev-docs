...
```swift
func resolve(from input: String, context: IntentParameterContext<Double>) async throws -> Double?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/doublefromstringresolver/resolve(from:context:))*