...
- [IntentParameter.ElectricCurrent](intentparameter/electriccurrent.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/intentparameter-measurements-electric-current)*