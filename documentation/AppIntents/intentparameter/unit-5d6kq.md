...
```swift
final var unit: IntentParameter<Value>.Illuminance? { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/intentparameter/unit-5d6kq)*