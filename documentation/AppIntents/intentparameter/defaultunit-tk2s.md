...
```swift
final var defaultUnit: IntentParameter<Value>.Dispersion? { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/intentparameter/defaultunit-tk2s)*