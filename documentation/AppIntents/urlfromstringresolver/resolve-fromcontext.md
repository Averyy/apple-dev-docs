...
```swift
func resolve(from input: String, context: IntentParameterContext<URL>) async throws -> URL?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/urlfromstringresolver/resolve(from:context:))*