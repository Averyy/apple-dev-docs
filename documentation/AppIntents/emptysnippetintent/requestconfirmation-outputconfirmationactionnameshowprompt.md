...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/emptysnippetintent/requestconfirmation(output:confirmationactionname:showprompt:))*