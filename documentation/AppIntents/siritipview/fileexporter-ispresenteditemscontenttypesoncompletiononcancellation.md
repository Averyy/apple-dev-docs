...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/siritipview/fileexporter(ispresented:items:contenttypes:oncompletion:oncancellation:))*