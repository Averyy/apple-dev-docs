...
- [func accessibilityAction<S>(named: S, () -> Void) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilityaction(named:_:)-4stzv.md)
  Adds an accessibility action to the view. Actions allow assistive technologies, such as the VoiceOver, to interact with the view by invoking the action.
- [func accessibilityAction(named: LocalizedStringResource, () -> Void) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilityaction(named:_:)-6j98q.md)
  Adds an accessibility action to the view. Actions allow assistive technologies, such as the VoiceOver, to interact with the view by invoking the action.
...
- [func accessibilityAction<I>(named: LocalizedStringResource, intent: I) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilityaction(named:intent:)-2jnnw.md)
...
- [func accessibilityCustomContent<V>(AccessibilityCustomContentKey, V, importance: AXCustomContent.Importance) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilitycustomcontent(_:_:importance:)-1z6jd.md)
  Add additional accessibility information to the view.
- [func accessibilityCustomContent(AccessibilityCustomContentKey, LocalizedStringResource, importance: AXCustomContent.Importance) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilitycustomcontent(_:_:importance:)-2myh6.md)
  Add additional accessibility information to the view.
- [func accessibilityCustomContent(LocalizedStringKey, Text, importance: AXCustomContent.Importance) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilitycustomcontent(_:_:importance:)-3vtie.md)
  Add additional accessibility information to the view.
- [func accessibilityCustomContent(LocalizedStringResource, LocalizedStringResource, importance: AXCustomContent.Importance) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilitycustomcontent(_:_:importance:)-51j9b.md)
  Add additional accessibility information to the view.
- [func accessibilityCustomContent<V>(LocalizedStringKey, V, importance: AXCustomContent.Importance) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilitycustomcontent(_:_:importance:)-57vxv.md)
  Add additional accessibility information to the view.
- [func accessibilityCustomContent(LocalizedStringResource, Text, importance: AXCustomContent.Importance) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilitycustomcontent(_:_:importance:)-5sv2.md)
  Add additional accessibility information to the view.
- [func accessibilityCustomContent<V>(LocalizedStringResource, V, importance: AXCustomContent.Importance) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilitycustomcontent(_:_:importance:)-63jep.md)
  Add additional accessibility information to the view.
...
- [func accessibilityCustomContent<L, V>(L, V, importance: AXCustomContent.Importance) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilitycustomcontent(_:_:importance:)-9quxh.md)
  Add additional accessibility information to the view.
- [func accessibilityDefaultFocus<Value>(AccessibilityFocusState<Value>.Binding, Value) -> some View](siritipview/accessibilitydefaultfocus(_:_:).md)
...
- [func accessibilityDragPoint(UnitPoint, description: LocalizedStringResource) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilitydragpoint(_:description:)-5uadu.md)
...
- [func accessibilityDragPoint(UnitPoint, description: Text, isEnabled: Bool) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilitydragpoint(_:description:isenabled:)-6hdke.md)
  The point an assistive technology should use to begin a drag interaction.
- [func accessibilityDragPoint(UnitPoint, description: LocalizedStringResource, isEnabled: Bool) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilitydragpoint(_:description:isenabled:)-98j2i.md)
  The point an assistive technology should use to begin a drag interaction.
...
- [func accessibilityDropPoint(UnitPoint, description: LocalizedStringKey) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilitydroppoint(_:description:)-7guvg.md)
  The point an assistive technology should use to end a drag interaction.
- [func accessibilityDropPoint(UnitPoint, description: LocalizedStringResource) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilitydroppoint(_:description:)-xttg.md)
  The point an assistive technology should use to end a drag interaction.
...
- [func accessibilityDropPoint(UnitPoint, description: LocalizedStringKey, isEnabled: Bool) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilitydroppoint(_:description:isenabled:)-5as3a.md)
  The point an assistive technology should use to end a drag interaction.
- [func accessibilityDropPoint(UnitPoint, description: LocalizedStringResource, isEnabled: Bool) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilitydroppoint(_:description:isenabled:)-7a9hm.md)
  The point an assistive technology should use to end a drag interaction.
...
- [func accessibilityHidden(Bool, isEnabled: Bool) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilityhidden(_:isenabled:).md)
  Specifies whether to hide this view from system accessibility features.
- [func accessibilityHint(LocalizedStringResource) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilityhint(_:)-5hh26.md)
  Communicates to the user what happens after performing the view’s action.
...
- [func accessibilityHint<S>(S, isEnabled: Bool) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilityhint(_:isenabled:)-8la4n.md)
  Communicates to the user what happens after performing the view’s action.
- [func accessibilityHint(LocalizedStringResource, isEnabled: Bool) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilityhint(_:isenabled:)-90oft.md)
  Communicates to the user what happens after performing the view’s action.
...
- [func accessibilityLabel(LocalizedStringKey) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilitylabel(_:)-2eyy8.md)
  Adds a label to the view that describes its contents.
- [func accessibilityLabel(LocalizedStringResource) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilitylabel(_:)-3zop9.md)
  Adds a label to the view that describes its contents.
- [func accessibilityLabel(Text) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilitylabel(_:)-54g4w.md)
  Adds a label to the view that describes its contents.
- [func accessibilityLabel(LocalizedStringResource, isEnabled: Bool) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilitylabel(_:isenabled:)-14b4w.md)
  Adds a label to the view that describes its contents.
...
- [func accessibilityRotor<L, Content>(L, entries: () -> Content) -> some View](siritipview/accessibilityrotor(_:entries:)-5q90i.md)
  Create an Accessibility Rotor with the specified user-visible label, and entries generated from the content closure.
- [func accessibilityRotor<Content>(LocalizedStringResource, entries: () -> Content) -> some View](siritipview/accessibilityrotor(_:entries:)-92cns.md)
  Create an Accessibility Rotor with the specified user-visible label, and entries generated from the content closure.
...
- [func accessibilityRotor<EntryModel, ID>(AccessibilitySystemRotor, entries: [EntryModel], entryID: KeyPath<EntryModel, ID>, entryLabel: KeyPath<EntryModel, String>) -> some View](siritipview/accessibilityrotor(_:entries:entryid:entrylabel:)-5l6m6.md)
  Create an Accessibility Rotor replacing the specified system-provided Rotor.
- [func accessibilityRotor<EntryModel, ID>(LocalizedStringResource, entries: [EntryModel], entryID: KeyPath<EntryModel, ID>, entryLabel: KeyPath<EntryModel, String>) -> some View](siritipview/accessibilityrotor(_:entries:entryid:entrylabel:)-8fn5b.md)
  Create an Accessibility Rotor with the specified user-visible label and entries.
...
- [func accessibilityRotor<EntryModel>(LocalizedStringKey, entries: [EntryModel], entryLabel: KeyPath<EntryModel, String>) -> some View](siritipview/accessibilityrotor(_:entries:entrylabel:)-6nzyt.md)
  Create an Accessibility Rotor with the specified user-visible label and entries.
- [func accessibilityRotor<EntryModel>(LocalizedStringResource, entries: [EntryModel], entryLabel: KeyPath<EntryModel, String>) -> some View](siritipview/accessibilityrotor(_:entries:entrylabel:)-7m090.md)
  Create an Accessibility Rotor with the specified user-visible label and entries.
...
- [func accessibilityRotor(LocalizedStringResource, textRanges: [Range<String.Index>]) -> some View](siritipview/accessibilityrotor(_:textranges:)-6c8id.md)
  Create an Accessibility Rotor with the specified user-visible label and entries for each of the specified ranges. The Rotor will be attached to the current Accessibility element, and each entry will go the specified range of that element.
...
- [func accessibilityScrollStatus(LocalizedStringResource, isEnabled: Bool) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilityscrollstatus(_:isenabled:)-2t9mn.md)
  Changes the announcement provided by accessibility technologies when a user scrolls a scroll view within this view.
- [func accessibilityScrollStatus(some StringProtocol, isEnabled: Bool) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilityscrollstatus(_:isenabled:)-3hnd0.md)
  Changes the announcement provided by accessibility technologies when a user scrolls a scroll view within this view.
- [func accessibilityScrollStatus(Text, isEnabled: Bool) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilityscrollstatus(_:isenabled:)-599a.md)
  Changes the announcement provided by accessibility technologies when a user scrolls a scroll view within this view.
- [func accessibilityScrollStatus(LocalizedStringKey, isEnabled: Bool) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilityscrollstatus(_:isenabled:)-9keb9.md)
  Changes the announcement provided by accessibility technologies when a user scrolls a scroll view within this view.
...
- [func accessibilityValue(LocalizedStringResource) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilityvalue(_:)-495wc.md)
  Adds a textual description of the value that the view contains.
...
- [func accessibilityValue(Text, isEnabled: Bool) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilityvalue(_:isenabled:)-13v4x.md)
  Adds a textual description of the value that the view contains.
- [func accessibilityValue(LocalizedStringResource, isEnabled: Bool) -> ModifiedContent<Self, AccessibilityAttachmentModifier>](siritipview/accessibilityvalue(_:isenabled:)-29mbu.md)
  Adds a textual description of the value that the view contains.
...
- [func alert<A>(LocalizedStringResource, isPresented: Binding<Bool>, actions: () -> A) -> some View](siritipview/alert(_:ispresented:actions:)-86383.md)
...
- [func alert<A, M>(LocalizedStringResource, isPresented: Binding<Bool>, actions: () -> A, message: () -> M) -> some View](siritipview/alert(_:ispresented:actions:message:)-8cp69.md)
  Presents an alert with a message when a given condition is true, using a localized string resource for a title.
- [func alert<A, T>(LocalizedStringResource, isPresented: Binding<Bool>, presenting: T?, actions: (T) -> A) -> some View](siritipview/alert(_:ispresented:presenting:actions:)-1yeda.md)
...
- [func alert<A, M, T>(LocalizedStringResource, isPresented: Binding<Bool>, presenting: T?, actions: (T) -> A, message: (T) -> M) -> some View](siritipview/alert(_:ispresented:presenting:actions:message:)-5uufe.md)
...
- [func alert<Item>(item: Binding<Item?>, content: (Item) -> Alert) -> some View](siritipview/alert(item:content:).md)
  Presents an alert to the user.
- [func alignmentGuide(DepthAlignment, computeValue: (ViewDimensions3D) -> CGFloat) -> some View](siritipview/alignmentguide(_:computevalue:)-11x0i.md)
...
- [func allowsWindowActivationEvents() -> some View](siritipview/allowswindowactivationevents.md)
...
- [func aspectRatio3D(Size3D?, contentMode: ContentMode) -> some View](siritipview/aspectratio3d(_:contentmode:).md)
  Constrains this view’s dimensions to the specified 3D aspect ratio.
- [func assistiveAccessNavigationIcon(Image) -> some View](siritipview/assistiveaccessnavigationicon(_:).md)
  Configures the view’s icon for purposes of navigation.
- [func assistiveAccessNavigationIcon(systemImage: String) -> some View](siritipview/assistiveaccessnavigationicon(systemimage:).md)
  Configures the view’s icon for purposes of navigation.
- [func attributedTextFormattingDefinition<S>(KeyPath<AttributeScopes, S.Type>) -> some View](siritipview/attributedtextformattingdefinition(_:)-36kub.md)
  Apply an attribute-only text formatting definition to all nested editor views.
- [func attributedTextFormattingDefinition<S>(S.Type) -> some View](siritipview/attributedtextformattingdefinition(_:)-7ghvo.md)
  Apply an attribute-only text formatting definition to all nested editor views.
- [func attributedTextFormattingDefinition<D>(D) -> some View](siritipview/attributedtextformattingdefinition(_:)-7o4fw.md)
...
- [func backgroundExtensionEffect() -> some View](siritipview/backgroundextensioneffect.md)
...
- [func badge(LocalizedStringResource?) -> some View](siritipview/badge(_:)-4hvgt.md)
...
- [func breakthroughEffect(BreakthroughEffect) -> some View](siritipview/breakthrougheffect(_:).md)
...
- [func buttonSizing(ButtonSizing) -> some View](siritipview/buttonsizing(_:).md)
...
- [func confirmationDialog<A>(LocalizedStringResource, isPresented: Binding<Bool>, titleVisibility: Visibility, actions: () -> A) -> some View](siritipview/confirmationdialog(_:ispresented:titlevisibility:actions:)-8imin.md)
...
- [func confirmationDialog<A, M>(LocalizedStringResource, isPresented: Binding<Bool>, titleVisibility: Visibility, actions: () -> A, message: () -> M) -> some View](siritipview/confirmationdialog(_:ispresented:titlevisibility:actions:message:)-2vm8q.md)
...
- [func confirmationDialog<A, T>(LocalizedStringResource, isPresented: Binding<Bool>, titleVisibility: Visibility, presenting: T?, actions: (T) -> A) -> some View](siritipview/confirmationdialog(_:ispresented:titlevisibility:presenting:actions:)-ysep.md)
  Presents a confirmation dialog using data to produce the dialog’s content and a localized string resource for the title.
- [func confirmationDialog<A, M, T>(LocalizedStringResource, isPresented: Binding<Bool>, titleVisibility: Visibility, presenting: T?, actions: (T) -> A, message: (T) -> M) -> some View](siritipview/confirmationdialog(_:ispresented:titlevisibility:presenting:actions:message:)-1es1k.md)
...
- [func contentCaptureProtected(Bool) -> some View](siritipview/contentcaptureprotected(_:).md)
...
- [func controlSize<T>(T) -> some View](siritipview/controlsize(_:)-6r31i.md)
  Limits the control size within the view to the given range.
- [func controlSize(ControlSize) -> some View](siritipview/controlsize(_:)-7a0ke.md)
...
- [func dialogSuppressionToggle<S>(S, isSuppressed: Binding<Bool>) -> some View](siritipview/dialogsuppressiontoggle(_:issuppressed:)-4i59d.md)
  Enables user suppression of dialogs and alerts presented within `self`, with a custom suppression message on macOS. Unused on other platforms.
- [func dialogSuppressionToggle(LocalizedStringResource, isSuppressed: Binding<Bool>) -> some View](siritipview/dialogsuppressiontoggle(_:issuppressed:)-5wd4k.md)
  Enables user suppression of dialogs and alerts presented within `self`, with a custom suppression message on macOS. Unused on other platforms.
...
- [func dragConfiguration(DragConfiguration) -> some View](siritipview/dragconfiguration(_:).md)
  Configures a drag session.
- [func dragContainer<ItemID, Item, Data>(for: Item.Type, id: (Item) -> ItemID, in: Namespace.ID?, (ItemID) -> Data) -> some View](siritipview/dragcontainer(for:id:in:_:).md)
  A container with draggable views. The drag payload is based on the current selection.
- [func dragContainer<ItemID, Item, Data>(for: Item.Type, id: (consuming Item) -> ItemID, in: Namespace.ID?, selection: @autoclosure () -> Array<ItemID>, (Array<ItemID>) -> Data) -> some View](siritipview/dragcontainer(for:id:in:selection:_:)-1j0md.md)
...
- [func dragContainer<Item, ItemID>(for: Item.Type, id: (Item) -> ItemID, in: Namespace.ID?, selection: @autoclosure () -> ItemID?, (ItemID) -> Item?) -> some View](siritipview/dragcontainer(for:id:in:selection:_:)-4lx1f.md)
...
- [func dragContainer<Item, Data>(for: Item.Type, in: Namespace.ID?, (Item.ID) -> Data) -> some View](siritipview/dragcontainer(for:in:_:).md)
...
- [func dragContainer<Item>(for: Item.Type, in: Namespace.ID?, selection: @autoclosure () -> Item.ID?, (Item.ID) -> Item?) -> some View](siritipview/dragcontainer(for:in:selection:_:)-4l0fc.md)
...
- [func dragContainer<Item, Data>(for: Item.Type, in: Namespace.ID?, selection: @autoclosure () -> Array<Item.ID>, (Array<Item.ID>) -> Data) -> some View](siritipview/dragcontainer(for:in:selection:_:)-7inyu.md)
...
- [func draggable<V, T>(@autoclosure () -> T, preview: () -> V) -> some View](siritipview/draggable(_:preview:).md)
  Activates this view as the source of a drag and drop operation.
- [func draggable<T, ID>(for: T.Type, id: ID, (ID) -> T?) -> some View](siritipview/draggable(for:id:_:).md)
  Activates this view as the source of a drag-and-drop operation.
...
- [func dropConfiguration((DropSession) -> DropConfiguration) -> some View](siritipview/dropconfiguration(_:).md)
...
- [func dropDestination<T>(for: T.Type, isEnabled: Bool, action: ([T], DropSession) -> Void) -> some View](siritipview/dropdestination(for:isenabled:action:).md)
...
- [func fileDialogConfirmationLabel(LocalizedStringResource) -> some View](siritipview/filedialogconfirmationlabel(_:)-2lfa4.md)
  On macOS, configures the the `fileExporter`, `fileImporter`, or `fileMover` with a custom confirmation button label.
...
- [func fileDialogMessage(LocalizedStringResource) -> some View](siritipview/filedialogmessage(_:)-1sv6w.md)
  On macOS, configures the the `fileExporter`, `fileImporter`, or `fileMover` with a custom message that is presented to the user, similar to a title.
...
- [func fileExporterFilenameLabel(LocalizedStringResource) -> some View](siritipview/fileexporterfilenamelabel(_:)-5hyrz.md)
...
- [func glassEffect(Glass, in: some Shape, isEnabled: Bool) -> some View](siritipview/glasseffect(_:in:isenabled:).md)
  Applies a glass effect to this view.
- [func glassEffectID((some Hashable & Sendable)?, in: Namespace.ID) -> some View](siritipview/glasseffectid(_:in:).md)
  Associates an identity value to glass effects defined within this view.
- [func glassEffectTransition(GlassEffectTransition, isEnabled: Bool) -> some View](siritipview/glasseffecttransition(_:isenabled:).md)
  Associates a glass effect transition with any glass effects defined within this view.
- [func glassEffectUnion(id: (some Hashable & Sendable)?, namespace: Namespace.ID) -> some View](siritipview/glasseffectunion(id:namespace:).md)
...
- [func help(LocalizedStringResource) -> some View](siritipview/help(_:)-2vg8g.md)
...
- [func labelIconToTitleSpacing(CGFloat) -> some View](siritipview/labelicontotitlespacing(_:).md)
  Set the spacing between the icon and title in labels.
- [func labelReservedIconWidth(CGFloat) -> some View](siritipview/labelreservediconwidth(_:).md)
...
- [func lineHeight(AttributedString.LineHeight?) -> some View](siritipview/lineheight(_:).md)
...
- [func listRowInsets(Edge.Set, CGFloat?) -> some View](siritipview/listrowinsets(_:_:).md)
...
- [func listSectionIndexVisibility(Visibility) -> some View](siritipview/listsectionindexvisibility(_:).md)
  Changes the visibility of the list section index.
- [func listSectionMargins(Edge.Set, CGFloat?) -> some View](siritipview/listsectionmargins(_:_:).md)
...
- [func multilineTextAlignment(strategy: Text.AlignmentStrategy) -> some View](siritipview/multilinetextalignment(strategy:).md)
...
- [func navigationDocument<D, I>(D, preview: SharePreview<Never, I>) -> some View](siritipview/navigationdocument(_:preview:)-850xe.md)
  Configures the view’s document for purposes of navigation.
- [func navigationLinkIndicatorVisibility(Visibility) -> some View](siritipview/navigationlinkindicatorvisibility(_:).md)
...
- [func navigationSubtitle(Text) -> some View](siritipview/navigationsubtitle(_:)-3cbg5.md)
  Configures the view’s subtitle for purposes of navigation.
- [func navigationSubtitle(LocalizedStringKey) -> some View](siritipview/navigationsubtitle(_:)-3ep8c.md)
  Configures the view’s subtitle for purposes of navigation, using a localized string.
- [func navigationSubtitle<S>(S) -> some View](siritipview/navigationsubtitle(_:)-4cfgv.md)
  Configures the view’s subtitle for purposes of navigation, using a string.
- [func navigationSubtitle(LocalizedStringResource) -> some View](siritipview/navigationsubtitle(_:)-8bsdg.md)
...
- [func navigationTitle(LocalizedStringResource) -> some View](siritipview/navigationtitle(_:)-6ue6a.md)
...
- [func onAppIntentExecution<I>(I.Type, perform: (I) -> Void) -> some View](siritipview/onappintentexecution(_:perform:).md)
...
- [func onDrag<V>(() -> NSItemProvider, preview: () -> V) -> some View](siritipview/ondrag(_:preview:).md)
  Activates this view as the source of a drag and drop operation.
- [func onDragSessionUpdated((DragSession) -> Void) -> some View](siritipview/ondragsessionupdated(_:).md)
...
- [func onDropSessionUpdated((DropSession) -> Void) -> some View](siritipview/ondropsessionupdated(_:).md)
...
- [func onOpenURL(prefersInApp: Bool) -> some View](siritipview/onopenurl(prefersinapp:).md)
...
- [func onWorldRecenter(action: () -> Void) -> some View](siritipview/onworldrecenter(action:)-3ap5i.md)
  Adds an action to perform when recentering the view with the digital crown.
- [func onWorldRecenter(action: (WorldRecenterPhase) -> Void) -> some View](siritipview/onworldrecenter(action:)-40g8o.md)
  Adds an action to perform when recentering the view with the digital crown.
- [func opacity(Double) -> some View](siritipview/opacity(_:).md)
  Sets the transparency of this view.
- [func ornament<Content>(visibility: Visibility, attachmentAnchor: OrnamentAttachmentAnchor, contentAlignment: Alignment3D, ornament: () -> Content) -> some View](siritipview/ornament(visibility:attachmentanchor:contentalignment:ornament:)-32lki.md)
  Presents an ornament.
- [func ornament<Content>(visibility: Visibility, attachmentAnchor: OrnamentAttachmentAnchor, contentAlignment: Alignment, ornament: () -> Content) -> some View](siritipview/ornament(visibility:attachmentanchor:contentalignment:ornament:)-92mk4.md)
  Presents an ornament.
...
- [func preferredWindowClippingMargins(Edge3D.Set, EdgeInsets3D) -> some View](siritipview/preferredwindowclippingmargins(_:_:)-107ne.md)
  Requests additional margins for drawing beyond the bounds of the window.
- [func preferredWindowClippingMargins(Edge3D.Set, CGFloat?) -> some View](siritipview/preferredwindowclippingmargins(_:_:)-6wv0j.md)
  Requests additional margins for drawing beyond the bounds of the window.
...
- [func presentationBreakthroughEffect(BreakthroughEffect) -> some View](siritipview/presentationbreakthrougheffect(_:).md)
...
- [func rotation3DEffect(Angle, axis: (x: CGFloat, y: CGFloat, z: CGFloat), anchor: UnitPoint, anchorZ: CGFloat, perspective: CGFloat) -> some View](siritipview/rotation3deffect(_:axis:anchor:anchorz:perspective:).md)
  Renders a view’s content as if it’s rotated in three dimensions around the specified axis.
- [func rotation3DLayout(Rotation3D) -> some View](siritipview/rotation3dlayout(_:).md)
  Rotates a view with impacts to its frame in a containing layout
- [func rotation3DLayout(Angle, axis: RotationAxis3D) -> some View](siritipview/rotation3dlayout(_:axis:)-6x09.md)
  Rotates a view with impacts to its frame in a containing layout
- [func rotation3DLayout(Angle, axis: (x: CGFloat, y: CGFloat, z: CGFloat)) -> some View](siritipview/rotation3dlayout(_:axis:)-w6yb.md)
  Rotates a view with impacts to its frame in a containing layout
- [func rotationEffect(Angle, anchor: UnitPoint) -> some View](siritipview/rotationeffect(_:anchor:).md)
  Rotates a view’s rendered output in two dimensions around the specified point.
- [func safeAreaBar(edge: VerticalEdge, alignment: HorizontalAlignment, spacing: CGFloat?, content: () -> some View) -> some View](siritipview/safeareabar(edge:alignment:spacing:content:)-4hvn.md)
  Renders the provided content appropriate to be displayed as a custom bar.
- [func safeAreaBar(edge: HorizontalEdge, alignment: VerticalAlignment, spacing: CGFloat?, content: () -> some View) -> some View](siritipview/safeareabar(edge:alignment:spacing:content:)-4i1sf.md)
...
- [func scaledToFill3D() -> some View](siritipview/scaledtofill3d.md)
  Scales this view to fill its parent.
- [func scaledToFit() -> some View](siritipview/scaledtofit.md)
  Scales this view to fit its parent.
- [func scaledToFit3D() -> some View](siritipview/scaledtofit3d.md)
  Scales this view to fit its parent.
...
- [func scrollEdgeEffectDisabled(Bool, for: Edge.Set) -> some View](siritipview/scrolledgeeffectdisabled(_:for:).md)
  Disables any scroll edge effects for scroll views within this hierarchy.
- [func scrollEdgeEffectStyle(ScrollEdgeEffectStyle?, for: Edge.Set) -> some View](siritipview/scrolledgeeffectstyle(_:for:).md)
...
- [func searchSelection(Binding<TextSelection?>) -> some View](siritipview/searchselection(_:).md)
...
- [func searchToolbarBehavior(SearchToolbarBehavior) -> some View](siritipview/searchtoolbarbehavior(_:).md)
  Configures the behavior for search in the toolbar.
- [func searchable<C>(text: Binding<String>, editableTokens: Binding<C>, isPresented: Binding<Bool>, placement: SearchFieldPlacement, prompt: LocalizedStringResource, token: (Binding<C.Element>) -> some View) -> some View](siritipview/searchable(text:editabletokens:ispresented:placement:prompt:token:)-543zk.md)
...
- [func searchable<C>(text: Binding<String>, editableTokens: Binding<C>, isPresented: Binding<Bool>, placement: SearchFieldPlacement, prompt: some StringProtocol, token: (Binding<C.Element>) -> some View) -> some View](siritipview/searchable(text:editabletokens:ispresented:placement:prompt:token:)-8tjlr.md)
  Marks this view as searchable, which configures the display of a search field.
- [func searchable<C>(text: Binding<String>, editableTokens: Binding<C>, placement: SearchFieldPlacement, prompt: LocalizedStringResource, token: (Binding<C.Element>) -> some View) -> some View](siritipview/searchable(text:editabletokens:placement:prompt:token:)-67d5y.md)
  Marks this view as searchable, which configures the display of a search field.
...
- [func searchable<C>(text: Binding<String>, editableTokens: Binding<C>, placement: SearchFieldPlacement, prompt: LocalizedStringKey, token: (Binding<C.Element>) -> some View) -> some View](siritipview/searchable(text:editabletokens:placement:prompt:token:)-9umjl.md)
  Marks this view as searchable, which configures the display of a search field.
- [func searchable(text: Binding<String>, isPresented: Binding<Bool>, placement: SearchFieldPlacement, prompt: LocalizedStringResource) -> some View](siritipview/searchable(text:ispresented:placement:prompt:)-1u1i6.md)
...
- [func searchable(text: Binding<String>, isPresented: Binding<Bool>, placement: SearchFieldPlacement, prompt: Text?) -> some View](siritipview/searchable(text:ispresented:placement:prompt:)-80rmz.md)
  Marks this view as searchable with programmatic presentation of the search field.
- [func searchable(text: Binding<String>, placement: SearchFieldPlacement, prompt: LocalizedStringResource) -> some View](siritipview/searchable(text:placement:prompt:)-1iiie.md)
  Marks this view as searchable, which configures the display of a search field.
...
- [func searchable<C, T>(text: Binding<String>, tokens: Binding<C>, isPresented: Binding<Bool>, placement: SearchFieldPlacement, prompt: Text?, token: (C.Element) -> T) -> some View](siritipview/searchable(text:tokens:ispresented:placement:prompt:token:)-dxwe.md)
  Marks this view as searchable with text and tokens, as well as programmatic presentation.
- [func searchable<C, T>(text: Binding<String>, tokens: Binding<C>, isPresented: Binding<Bool>, placement: SearchFieldPlacement, prompt: LocalizedStringResource, token: (C.Element) -> T) -> some View](siritipview/searchable(text:tokens:ispresented:placement:prompt:token:)-kbsb.md)
  Marks this view as searchable with text and tokens, as well as programmatic presentation.
- [func searchable<C, T>(text: Binding<String>, tokens: Binding<C>, placement: SearchFieldPlacement, prompt: LocalizedStringResource, token: (C.Element) -> T) -> some View](siritipview/searchable(text:tokens:placement:prompt:token:)-4e6jg.md)
...
- [func searchable<C, T>(text: Binding<String>, tokens: Binding<C>, suggestedTokens: Binding<C>, isPresented: Binding<Bool>, placement: SearchFieldPlacement, prompt: Text?, token: (C.Element) -> T) -> some View](siritipview/searchable(text:tokens:suggestedtokens:ispresented:placement:prompt:token:)-8k677.md)
  Marks this view as searchable with text, tokens, and suggestions, as well as programmatic presentation.
- [func searchable<C, T>(text: Binding<String>, tokens: Binding<C>, suggestedTokens: Binding<C>, isPresented: Binding<Bool>, placement: SearchFieldPlacement, prompt: LocalizedStringResource, token: (C.Element) -> T) -> some View](siritipview/searchable(text:tokens:suggestedtokens:ispresented:placement:prompt:token:)-9lgf7.md)
  Marks this view as searchable with text, tokens, and suggestions, as well as programmatic presentation.
...
- [func searchable<C, T>(text: Binding<String>, tokens: Binding<C>, suggestedTokens: Binding<C>, placement: SearchFieldPlacement, prompt: LocalizedStringResource, token: (C.Element) -> T) -> some View](siritipview/searchable(text:tokens:suggestedtokens:placement:prompt:token:)-5umzt.md)
  Marks this view as searchable with text, tokens, and suggestions.
...
- [func sectionIndexLabel<S>(S?) -> some View](siritipview/sectionindexlabel(_:)-2ezjp.md)
  Sets the title that is used for the section index label pointing to this section, typically only a single character long.
- [func sectionIndexLabel(Text?) -> some View](siritipview/sectionindexlabel(_:)-8iprk.md)
...
- [func sensoryFeedback<T>(trigger: T, () -> SensoryFeedback?) -> some View](siritipview/sensoryfeedback(trigger:_:)-33g5x.md)
  Plays feedback when returned from the `feedback` closure after the provided `trigger` value changes.
- [func sensoryFeedback<T>(trigger: T, (T, T) -> SensoryFeedback?) -> some View](siritipview/sensoryfeedback(trigger:_:)-7tjfb.md)
  Plays feedback when returned from the `feedback` closure after the provided `trigger` value changes.
...
- [func spatialOverlay<V>(alignment: Alignment3D, content: () -> V) -> some View](siritipview/spatialoverlay(alignment:content:).md)
  Adds secondary views within the 3D bounds of this view.
- [func spatialOverlayPreferenceValue<K, V>(K.Type, alignment: Alignment3D, (K.Value) -> V) -> some View](siritipview/spatialoverlaypreferencevalue(_:alignment:_:).md)
...
- [func symbolColorRenderingMode(SymbolColorRenderingMode?) -> some View](siritipview/symbolcolorrenderingmode(_:).md)
...
- [func symbolVariableValueMode(SymbolVariableValueMode?) -> some View](siritipview/symbolvariablevaluemode(_:).md)
...
- [func tabBarMinimizeBehavior(TabBarMinimizeBehavior) -> some View](siritipview/tabbarminimizebehavior(_:).md)
  Sets the behavior for tab bar minimization.
- [func tabItem<V>(() -> V) -> some View](siritipview/tabitem(_:).md)
  Sets the tab bar item associated with this view.
- [func tabViewBottomAccessory<Content>(content: () -> Content) -> some View](siritipview/tabviewbottomaccessory(content:).md)
...
- [func textInputFormattingControlVisibility(Visibility, for: TextInputFormattingControlPlacement.Set) -> some View](siritipview/textinputformattingcontrolvisibility(_:for:).md)
...
- [func typeSelectEquivalent(Text?) -> some View](siritipview/typeselectequivalent(_:)-3tubc.md)
  Sets an explicit type select equivalent text in a collection, such as a list or table.
- [func typeSelectEquivalent(LocalizedStringResource) -> some View](siritipview/typeselectequivalent(_:)-5yfmf.md)
  Sets an explicit type select equivalent text in a collection, such as a list or table.
...
- [func writingDirection(strategy: Text.WritingDirectionStrategy) -> some View](siritipview/writingdirection(strategy:).md)
