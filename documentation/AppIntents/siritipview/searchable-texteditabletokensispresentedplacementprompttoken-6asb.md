...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/siritipview/searchable(text:editabletokens:ispresented:placement:prompt:token:)-6asb)*