...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/siritipview/onlongpressgesture(minimumduration:maximumdistance:perform:onpressingchanged:))*