...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/siritipview/searchable(text:tokens:ispresented:placement:prompt:token:)-8vatr)*