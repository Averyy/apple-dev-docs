...
The following example shows an intent that conforms to the `searchDocuments` schema:

```swift
@AppIntent(schema: .reader.searchDocuments)
struct SearchReaderDocumentsIntent {
    var criteria: String
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/appschema/readerintent/searchdocuments)*