...
```swift
struct ParameterSummaryTupleCaseCondition<Intent, Value, ValueType> where Intent : AppIntent, Value : _IntentValue
```

## Topics

### Type Aliases
- [ParameterSummaryTupleCaseCondition.Summary](parametersummarytuplecasecondition/summary.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/appintents/parametersummarytuplecasecondition)*