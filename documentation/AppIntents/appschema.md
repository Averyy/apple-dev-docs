...
- [AppSchema.MailEnum](appschema/mailenum.md)
  Identifies enum schemas in the mail domain.
...
- [AppSchema.RemindersIntent](appschema/remindersintent.md)
...
- [AppSchema.Enum](appschema/enum.md)
- [AppSchema.Intent](appschema/intent.md)
### Initializers
- [init(some AppSchemaIntent)](appschema/init(_:)-1jgk1.md)
- [init(some AppSchemaEnum)](appschema/init(_:)-2j9qr.md)
- [init(some AppSchemaEntity)](appschema/init(_:)-4xxeu.md)
...
- [protocol AppSchemaIntent](appschemaintent.md)


---

*[View on Apple Developer](https://developer.apple.com/documentation/appintents/appschema)*