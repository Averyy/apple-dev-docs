...
- [availableKilobytes](target/1811975-availablekilobytes.md)
...
- [receiptForIdentifier](target/1812064-receiptforidentifier.md)
  Provides information about the receipt for a given package on the installation host.


---

*[View on Apple Developer](https://developer.apple.com/documentation/installer_js/target)*