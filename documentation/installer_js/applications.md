...
This object is accessed using the `system.applications` property.
...
*[View on Apple Developer](https://developer.apple.com/documentation/installer_js/applications)*