...
If you don’t provide a dashboard symbol image, CarPlay uses [`symbolImage`](cpmaneuver/symbolimage.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/carplay/cpmaneuver/dashboardsymbolimage)*