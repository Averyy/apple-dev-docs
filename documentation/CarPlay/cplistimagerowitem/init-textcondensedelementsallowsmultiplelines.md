# init(text:condensedElements:allowsMultipleLines:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/carplay/cplistimagerowitem/init(text:condensedelements:allowsmultiplelines:))*