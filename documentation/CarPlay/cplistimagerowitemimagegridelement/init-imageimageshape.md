...
```swift
@MainActor
init(image: UIImage, imageShape: CPListImageRowItemImageGridElementShape)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/carplay/cplistimagerowitemimagegridelement/init(image:imageshape:))*