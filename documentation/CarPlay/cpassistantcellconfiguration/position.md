...
```swift
var position: CPListItem.AssistantCellPosition { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/carplay/cpassistantcellconfiguration/position)*