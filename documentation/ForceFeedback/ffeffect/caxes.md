...
This member must be filled in by the caller if changing or setting the axis list or the direction list.
...
*[View on Apple Developer](https://developer.apple.com/documentation/forcefeedback/ffeffect/caxes)*