...
- [convenience init()](gkmersennetwisterrandomsource/init.md)
  Initializes a random source from a nondeterministic seed.


---

*[View on Apple Developer](https://developer.apple.com/documentation/gameplaykit/gkmersennetwisterrandomsource/init(seed:))*