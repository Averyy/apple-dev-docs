...
- [init(seed: UInt64)](gklinearcongruentialrandomsource/init(seed:).md)
  Initializes a random source with the specified seed value.
### Replicating Random Behavior
- [var seed: UInt64](gklinearcongruentialrandomsource/seed.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/gameplaykit/gklinearcongruentialrandomsource)*