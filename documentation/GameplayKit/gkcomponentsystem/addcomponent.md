...
The component instance must be of the same [`GKComponent`](gkcomponent.md) subclass specified by the [`componentClass`](gkcomponentsystem/componentclass.md) property.
...
*[View on Apple Developer](https://developer.apple.com/documentation/gameplaykit/gkcomponentsystem/addcomponent(_:))*