...
- `agents`: The agents with whom to maintain alignment.
...
*[View on Apple Developer](https://developer.apple.com/documentation/gameplaykit/gkgoal/init(toalignwith:maxdistance:maxangle:))*