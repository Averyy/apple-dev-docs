# ParallelizationTrait.TestScopeProvider
...
```swift
typealias TestScopeProvider = ParallelizationTrait
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/testing/parallelizationtrait/testscopeprovider)*