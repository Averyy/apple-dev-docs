...
```swift
func equipmentIDs(childrenOf parent: some Equipment) -> [EquipmentIdentifier]
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/tabletopkit/tablesnapshot/equipmentids(childrenof:)-432sk)*