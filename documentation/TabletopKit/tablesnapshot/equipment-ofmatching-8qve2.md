...
```swift
func equipment<E>(of type: E.Type, matching equipmentID: EquipmentIdentifier) -> (E, E.State)? where E : Equipment
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/tabletopkit/tablesnapshot/equipment(of:matching:)-8qve2)*