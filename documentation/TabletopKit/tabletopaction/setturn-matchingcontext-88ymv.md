...
```swift
static func setTurn(matching seatIDs: [TableSeatIdentifier], context: UInt64 = 0) -> Self
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/tabletopkit/tabletopaction/setturn(matching:context:)-88ymv)*