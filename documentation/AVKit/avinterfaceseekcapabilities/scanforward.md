...
```swift
static var scanForward: AVInterfaceSeekCapabilities { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/avkit/avinterfaceseekcapabilities/scanforward)*