...
If the value is [`true`](https://developer.apple.com/documentation/swift/true), a player view tries to find objects, text, and people when you pause media playback. If it finds an object, the user is able to interact with it using a long press to present a context menu.
