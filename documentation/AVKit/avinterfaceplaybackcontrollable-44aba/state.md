...
```swift
@MainActor
var state: AVInterfacePlaybackState { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/avkit/avinterfaceplaybackcontrollable-44aba/state)*