...
```swift
@MainActor
var playbackError: (any Error)? { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/avkit/avinterfaceplaybackcontrollable-44aba/playbackerror)*