...
```swift
class var endVideoRecording: AVCaptureEventSound! { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/avkit/avcaptureeventsound/endvideorecording)*