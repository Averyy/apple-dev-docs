...
```swift
class var cameraShutter: AVCaptureEventSound { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/avkit/avcaptureeventsound/camerashutter)*