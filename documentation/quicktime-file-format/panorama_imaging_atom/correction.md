...
This can be either `kQTVRNoCorrection`, `kQTVRPartialCorrection`, or `kQTVRFullCorrection`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/quicktime-file-format/panorama_imaging_atom/correction)*