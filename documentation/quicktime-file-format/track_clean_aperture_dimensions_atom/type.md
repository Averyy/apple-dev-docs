...
This field must be set to `‘clef’`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/quicktime-file-format/track_clean_aperture_dimensions_atom/type)*