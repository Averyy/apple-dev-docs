...
The value of this field must be less than the value of the `maxPan` field.
...
*[View on Apple Developer](https://developer.apple.com/documentation/quicktime-file-format/object_sample_atom/minpan)*