...
The default value is `–90.0`. The value of this field must be greater than the value of the `minTilt` field.
...
*[View on Apple Developer](https://developer.apple.com/documentation/quicktime-file-format/object_sample_atom/maxtilt)*