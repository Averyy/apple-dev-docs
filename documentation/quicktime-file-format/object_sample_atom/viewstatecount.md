...
A view state selects an alternate set of images for an object’s views. The value of this field must be positive.
...
*[View on Apple Developer](https://developer.apple.com/documentation/quicktime-file-format/object_sample_atom/viewstatecount)*