...
The value in this field must be greater than or equal to the value of the `minFieldOfView` field.
...
*[View on Apple Developer](https://developer.apple.com/documentation/quicktime-file-format/object_sample_atom/fieldofview)*