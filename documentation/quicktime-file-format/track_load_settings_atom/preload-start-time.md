...
Used in conjunction with the preload duration.
...
*[View on Apple Developer](https://developer.apple.com/documentation/quicktime-file-format/track_load_settings_atom/preload_start_time)*