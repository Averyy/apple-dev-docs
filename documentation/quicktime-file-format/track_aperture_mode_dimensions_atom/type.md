...
This field must be set to `‘tapt’`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/quicktime-file-format/track_aperture_mode_dimensions_atom/type)*