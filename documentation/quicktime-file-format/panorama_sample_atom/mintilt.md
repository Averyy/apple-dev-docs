...
For a high-resolution panorama, a typical value for this field is `–42.5`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/quicktime-file-format/panorama_sample_atom/mintilt)*