...
The width of each frame (which is `imageSizeX/imageNumFramesX`) should be divisible by 4.
...
*[View on Apple Developer](https://developer.apple.com/documentation/quicktime-file-format/panorama_sample_atom/imagenumframesx)*