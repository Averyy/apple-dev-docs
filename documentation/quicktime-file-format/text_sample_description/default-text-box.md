...
Typically this field is set to all zeros.
...
*[View on Apple Developer](https://developer.apple.com/documentation/quicktime-file-format/text_sample_description/default_text_box)*