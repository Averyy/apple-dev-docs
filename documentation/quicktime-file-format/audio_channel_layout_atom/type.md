...
Contains the four-character code `'chan'`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/quicktime-file-format/audio_channel_layout_atom/type)*