...
For more information, see [`Compressed movie resources`](compressed_movie_resources.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/quicktime-file-format/movie_atom/compressed_movie_atom)*