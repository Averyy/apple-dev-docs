...
For more information, see [`Reference movies`](reference_movies.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/quicktime-file-format/movie_atom/reference_movie_atom)*