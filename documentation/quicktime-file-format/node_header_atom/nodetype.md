...
This field should contain either `kQTVRPanoramaType` or `kQTVRObjectType`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/quicktime-file-format/node_header_atom/nodetype)*