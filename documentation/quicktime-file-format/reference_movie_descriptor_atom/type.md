...
This field must be set to `'rmda'`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/quicktime-file-format/reference_movie_descriptor_atom/type)*