...
> **Note**:  This document was previously titled *Security Objective-C API*. The documentation for the SFAuthorization class is now in a separate document, [`Security Foundation`](https://developer.apple.com/documentation/SecurityFoundation).
