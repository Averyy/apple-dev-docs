...
See [`Node Types`](1497602-node-types.md) for recognized node type values.
...
*[View on Apple Developer](https://developer.apple.com/documentation/opendirectory/odnodetype)*