...
See [`Match Types`](match-types.md) for recognized match type values.
...
*[View on Apple Developer](https://developer.apple.com/documentation/opendirectory/odmatchtype)*