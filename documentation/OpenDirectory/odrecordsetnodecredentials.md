...
If you want to set credentials for all references to a node, use [`ODNodeSetCredentials(_:_:_:_:_:)`](odnodesetcredentials(_:_:_:_:_:).md) instead.
...
*[View on Apple Developer](https://developer.apple.com/documentation/opendirectory/odrecordsetnodecredentials(_:_:_:_:))*