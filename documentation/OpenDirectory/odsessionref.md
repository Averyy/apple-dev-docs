...
Session objects are usually created with [`ODSessionCreate(_:_:_:)`](odsessioncreate(_:_:_:).md), and are typically passed to node functions.
...
*[View on Apple Developer](https://developer.apple.com/documentation/opendirectory/odsessionref)*