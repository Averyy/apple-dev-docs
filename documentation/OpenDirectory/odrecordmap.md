...
### Instance Properties
- [var attributes: [AnyHashable : Any]!](odrecordmap/attributes-swift.property.md)
- [var native: String!](odrecordmap/native-swift.property.md)
- [var odPredicate: [AnyHashable : Any]!](odrecordmap/odpredicate-swift.property.md)
- [var standardAttributeTypes: [Any]!](odrecordmap/standardattributetypes.md)
### Instance Methods
- [func attributeMap(forStandardAttribute: String!) -> ODAttributeMap!](odrecordmap/attributemap(forstandardattribute:).md)
- [func setAttribute(ODAttributeMap!, forStandardAttribute: String!)](odrecordmap/setattribute(_:forstandardattribute:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/opendirectory/odrecordmap)*