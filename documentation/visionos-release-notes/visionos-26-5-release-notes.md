# visionOS 26.5 Beta Release Notes
...
The visionOS 26.5 SDK provides support for developing apps for Apple Vision Pro devices running visionOS 26.5 beta. The SDK comes bundled with Xcode 26.5, available from the Mac App Store. For information on the compatibility requirements for Xcode 26.5, see [`Xcode 26.5 Release Notes`](https://developer.apple.com/documentation/Xcode-Release-Notes/xcode-26_5-release-notes).
