# visionOS 26.6 RC Release Notes
...
The visionOS 26.6 SDK provides support to develop apps for Apple Vision Pro devices running visionOS 26.6 RC. The SDK comes bundled with Xcode 26.6, available from the Mac App Store. For information on the compatibility requirements for Xcode 26.6, see [`Xcode 26.6 Release Notes`](https://developer.apple.com/documentation/Xcode-Release-Notes/xcode-26_6-release-notes).
