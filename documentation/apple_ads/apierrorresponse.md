...
- `error` (ErrorResponseBody): A container for error message details.
...
*[View on Apple Developer](https://developer.apple.com/documentation/apple_ads/apierrorresponse)*