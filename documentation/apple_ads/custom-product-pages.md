...
> **Note**:  If you’ve been using Creative Sets with the API, see section 4.1 in  [`Apple Ads Campaign Management API 4`](apple-search-ads-campaign-management-api-4.md) for Creative Sets deprecation details.
...
*[View on Apple Developer](https://developer.apple.com/documentation/apple_ads/custom-product-pages)*