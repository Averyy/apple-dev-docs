...
```swift
init(translation offset: Vector3D)
```

## Parameters

- `offset`: A size structure that specifies the translation.
...
*[View on Apple Developer](https://developer.apple.com/documentation/spatial/affinetransform3d/init(translation:)-9czpj)*