...
```swift
init?(projectiveTransform transform: ProjectiveTransform3D)
```

## Parameters

- `transform`: The source projective transform.
...
*[View on Apple Developer](https://developer.apple.com/documentation/spatial/affinetransform3d/init(projectivetransform:))*