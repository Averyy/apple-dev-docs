...
The rectangle that results from shearing over an axis by shear factors for the other two axes.
...
*[View on Apple Developer](https://developer.apple.com/documentation/spatial/rect3d/sheared(_:))*