...
- `origin`: A vector that specifies the rectangle’s origin.
...
*[View on Apple Developer](https://developer.apple.com/documentation/spatial/rect3d/init(origin:size:)-7o8ad)*