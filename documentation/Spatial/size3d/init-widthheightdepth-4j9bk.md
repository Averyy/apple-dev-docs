...
```swift
init(width: Double = 0, height: Double = 0, depth: Double = 0)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/spatial/size3d/init(width:height:depth:)-4j9bk)*