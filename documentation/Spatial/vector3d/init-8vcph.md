...
- `point`: A point structure that specifies the elememnt values.
...
*[View on Apple Developer](https://developer.apple.com/documentation/spatial/vector3d/init(_:)-8vcph)*