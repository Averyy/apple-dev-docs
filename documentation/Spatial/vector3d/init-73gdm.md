...
- `xyz`: A single-precision vector that specifies the element values.
...
*[View on Apple Developer](https://developer.apple.com/documentation/spatial/vector3d/init(_:)-73gdm)*