...
```swift
func applying(_ transform: ProjectiveTransform3D) -> Vector3D
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/spatial/vector3d/applying(_:)-5y3xb)*