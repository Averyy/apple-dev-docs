...
- `offset`: A vector that specifies the translation.
...
*[View on Apple Developer](https://developer.apple.com/documentation/spatial/projectivetransform3d/init(translation:)-7l5gj)*