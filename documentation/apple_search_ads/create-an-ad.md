...
In API version 5.2, this endpoint supports default product page ads. For more information, see [`Apple Search Ads Campaign Management API 5`](apple-search-ads-campaign-management-api-5.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/apple_search_ads/create-an-ad)*