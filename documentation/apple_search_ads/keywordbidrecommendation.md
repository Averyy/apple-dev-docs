...
In [`Apple Search Ads Campaign Management API 5`](apple-search-ads-campaign-management-api-5.md), the `suggestedBidAmount` field  replaces the deprecated `bidMin` and `bidMax` fields.
...
*[View on Apple Developer](https://developer.apple.com/documentation/apple_search_ads/keywordbidrecommendation)*