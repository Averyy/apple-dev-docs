...
To return all targeting keywords for a campaign, use the associated `campaignId` and `adgroupId` in the URI. You can also use a partial fetch. For more information, see the Use a Partial Fetch section of [`Using Apple Search Ads API Functionality`](using-apple-search-ads-api-functionality.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/apple_search_ads/get-all-targeting-keywords-in-an-ad-group)*