...
To use budget orders, you need to receive approval from Apple. Search Ads payment model options include pay-as-you-go (`PAYG)` or standard monthly invoicing (`LOC`). Use either `PAYG` or `LOC`, but not both. Refer to the [`Search Ads help`](https://developer.apple.comhttps://searchads.apple.com/help/billing/0031-monthly-invoicing) for billing details.
...
*[View on Apple Developer](https://developer.apple.com/documentation/apple_search_ads/budget-orders)*