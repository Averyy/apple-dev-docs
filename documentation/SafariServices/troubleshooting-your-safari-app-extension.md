...
**Check URL patterns.** Make sure your URL patterns are right. For more details, see [`Specify URL patterns`](using-permissions-for-scripts-and-style-sheets#Specify-URL-patterns.md).
