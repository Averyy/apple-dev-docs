...
### First steps
- [Using Safari app extension default keys](using-safari-app-extension-default-keys.md)
...
- [Using content script and style sheet keys](using-content-script-and-style-sheet-keys.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/safariservices/safari-app-extension-information-property-list-keys)*