...
Static factory method to allocate and initialize an IOUserVideoStereoPanControl.

If IOUserVideoStereoPanControl is subclassed to override behavior, Create should not be used to allocate/initialize the custom subclass.
...
*[View on Apple Developer](https://developer.apple.com/documentation/videodriverkit/iouservideostereopancontrol/create)*