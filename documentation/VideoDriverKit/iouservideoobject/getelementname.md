...
Get the name for the given element and scope of the IOUserVideoObject. Getting the value will be synchronized using the work queue created by the object.
