# kColorSyncTransformProfileSequnce
...
```swift
var kColorSyncTransformProfileSequnce: Unmanaged<CFString>!
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/colorsync/kcolorsynctransformprofilesequnce)*