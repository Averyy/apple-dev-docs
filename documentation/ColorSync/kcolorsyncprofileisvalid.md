...
```swift
var kColorSyncProfileIsValid: Unmanaged<CFString>!
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/colorsync/kcolorsyncprofileisvalid)*