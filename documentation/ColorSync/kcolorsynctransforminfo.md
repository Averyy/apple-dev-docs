...
```swift
var kColorSyncTransformInfo: Unmanaged<CFString>!
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/colorsync/kcolorsynctransforminfo)*