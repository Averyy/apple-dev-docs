...
```swift
var kColorSyncHDRDerivative: Unmanaged<CFString>!
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/colorsync/kcolorsynchdrderivative)*