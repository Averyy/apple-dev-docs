...
- [`beginView()`](appimpression/beginview().md)
- [`endView()`](appimpression/endview().md)

#### Processing Interactions with Click Through Ads

- [`handleTap()`](appimpression/handletap().md)
- [`handleTap(reengagementURL:)`](appimpression/handletap(reengagementurl:).md)

#### Instance Methods

- [`hash(into:)`](appimpression/hash(into:).md)
...
- [var hashValue: Int](appimpression/hashvalue.md)
  The hash value.
- [var id: UUID](appimpression/id-swift.property.md)
...
### Type Aliases
- [AppImpression.ID](appimpression/id-swift.typealias.md)
...
- [Equatable Implementations](appimpression/equatable-implementations.md)
