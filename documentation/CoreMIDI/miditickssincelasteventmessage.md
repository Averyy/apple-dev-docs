# MIDITicksSinceLastEventMessage(_:)
...
```swift
func MIDITicksSinceLastEventMessage(_ ticksSinceLastEvent: UInt32) -> MIDIMessage_32
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremidi/miditickssincelasteventmessage(_:))*