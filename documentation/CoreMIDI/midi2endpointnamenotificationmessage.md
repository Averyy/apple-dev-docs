# MIDI2EndpointNameNotificationMessage(_:_:_:)
...
```swift
func MIDI2EndpointNameNotificationMessage(_ format: UMPStreamMessageFormat, _ data: UnsafePointer<CChar>!, _ length: Int) -> MIDIMessage_128
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremidi/midi2endpointnamenotificationmessage(_:_:_:))*