...
### Initializers
- [init(rawValue: UInt8)](midipernotemanagementoptions/init(rawvalue:).md)
### Type Properties
- [static var detach: MIDIPerNoteManagementOptions](midipernotemanagementoptions/detach.md)
- [static var reset: MIDIPerNoteManagementOptions](midipernotemanagementoptions/reset.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremidi/midipernotemanagementoptions)*