...
### Initializers
- [init(UInt8)](midicipropertyexchangerequestid/init(_:).md)
- [init(rawValue: UInt8)](midicipropertyexchangerequestid/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremidi/midicipropertyexchangerequestid)*