...
### Initializers
- [init?(rawValue: UInt8)](midiumpciobjectbackingtype/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremidi/midiumpciobjectbackingtype)*