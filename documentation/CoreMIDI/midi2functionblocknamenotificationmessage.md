# MIDI2FunctionBlockNameNotificationMessage(_:_:_:_:)
...
```swift
func MIDI2FunctionBlockNameNotificationMessage(_ format: UMPStreamMessageFormat, _ blockNumber: UInt8, _ data: UnsafePointer<CChar>!, _ length: Int) -> MIDIMessage_128
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremidi/midi2functionblocknamenotificationmessage(_:_:_:_:))*