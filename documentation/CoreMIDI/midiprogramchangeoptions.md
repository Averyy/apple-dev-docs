...
### Initializers
- [init(rawValue: UInt8)](midiprogramchangeoptions/init(rawvalue:).md)
### Type Properties
- [static var bankValid: MIDIProgramChangeOptions](midiprogramchangeoptions/bankvalid.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremidi/midiprogramchangeoptions)*