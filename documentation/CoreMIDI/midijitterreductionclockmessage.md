# MIDIJitterReductionClockMessage(_:)
...
```swift
func MIDIJitterReductionClockMessage(_ senderClockTime: UInt16) -> MIDIMessage_32
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremidi/midijitterreductionclockmessage(_:))*