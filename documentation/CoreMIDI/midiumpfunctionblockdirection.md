...
### Initializers
- [init?(rawValue: Int32)](midiumpfunctionblockdirection/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremidi/midiumpfunctionblockdirection)*