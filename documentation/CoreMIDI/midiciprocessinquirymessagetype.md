...
### Initializers
- [init?(rawValue: MIDIUInteger7)](midiciprocessinquirymessagetype/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremidi/midiciprocessinquirymessagetype)*