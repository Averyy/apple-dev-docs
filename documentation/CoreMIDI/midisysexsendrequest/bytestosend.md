...
Initially, the number of bytes to send. [`MIDISendSysex(_:)`](midisendsysex(_:).md) decrements this counter as it sends bytes.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremidi/midisysexsendrequest/bytestosend)*