# MIDIDeltaClockstampTicksPerQuarterNoteMessage(_:)
...
```swift
func MIDIDeltaClockstampTicksPerQuarterNoteMessage(_ ticksPerQuarterNote: UInt16) -> MIDIMessage_32
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremidi/midideltaclockstampticksperquarternotemessage(_:))*