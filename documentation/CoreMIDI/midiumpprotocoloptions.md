...
### Initializers
- [init(rawValue: MIDIUInteger4)](midiumpprotocoloptions/init(rawvalue:).md)
### Type Properties
- [static var midi1: MIDIUMPProtocolOptions](midiumpprotocoloptions/midi1.md)
- [static var midi2: MIDIUMPProtocolOptions](midiumpprotocoloptions/midi2.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremidi/midiumpprotocoloptions)*