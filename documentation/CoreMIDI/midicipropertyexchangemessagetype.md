...
### Initializers
- [init?(rawValue: MIDIUInteger7)](midicipropertyexchangemessagetype/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremidi/midicipropertyexchangemessagetype)*