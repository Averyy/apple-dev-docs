...
### Initializers
- [init?(rawValue: UInt8)](umpstreammessageformat/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremidi/umpstreammessageformat)*