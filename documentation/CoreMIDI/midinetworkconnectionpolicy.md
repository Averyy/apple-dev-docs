...
### Initializers
- [init?(rawValue: UInt)](midinetworkconnectionpolicy/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremidi/midinetworkconnectionpolicy)*