# MIDIJitterReductionTimestampMessage(_:)
...
```swift
func MIDIJitterReductionTimestampMessage(_ senderClockTimestamp: UInt16) -> MIDIMessage_32
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremidi/midijitterreductiontimestampmessage(_:))*