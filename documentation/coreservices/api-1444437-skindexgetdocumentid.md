...
The document ID identifies a document URL object (of type [`SKDocument`](skdocument.md)) in an index. The ID is available as soon as you add a document URL object to an index using [`SKIndexAddDocumentWithText(_:_:_:_:)`](1444518-skindexadddocumentwithtext.md) or [`SKIndexAddDocument(_:_:_:_:)`](1444897-skindexadddocument.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreservices/1444437-skindexgetdocumentid)*