...
Use the URL resource property [`kCFURLIsHiddenKey`](https://developer.apple.com/documentation/corefoundation/kcfurlishiddenkey)/[`isHiddenKey`](https://developer.apple.com/documentation/foundation/urlresourcekey/ishiddenkey) instead.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreservices/klsitemisinvisible)*