...
When your application has the ID of a term, perhaps as a result of calling [`SKIndexCopyTermIDArrayForDocumentID(_:_:)`](1446868-skindexcopytermidarrayfordocumen.md), use this function to derive the term’s text string.

To perform the inverse operation of deriving a term ID from a term string in a given index, use [`SKIndexGetTermIDForTermString(_:_:)`](1448558-skindexgettermidfortermstring.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreservices/1442802-skindexcopytermstringfortermid)*