...
- [let kLSItemQuarantineProperties: CFString!](klsitemquarantineproperties.md)
- [var kLSSharedFileListFavoriteItems: Unmanaged<CFString>](klssharedfilelistfavoriteitems.md)
- [var kLSSharedFileListFavoriteVolumes: Unmanaged<CFString>](klssharedfilelistfavoritevolumes.md)
- [var kLSSharedFileListItemBeforeFirst: Unmanaged<LSSharedFileListItem>](klssharedfilelistitembeforefirst.md)
- [var kLSSharedFileListItemHidden: Unmanaged<CFString>](klssharedfilelistitemhidden.md)
- [var kLSSharedFileListItemLast: Unmanaged<LSSharedFileListItem>](klssharedfilelistitemlast.md)
- [var kLSSharedFileListLoginItemHidden: Unmanaged<CFString>](klssharedfilelistloginitemhidden.md)
- [var kLSSharedFileListRecentApplicationItems: Unmanaged<CFString>](klssharedfilelistrecentapplicationitems.md)
- [var kLSSharedFileListRecentDocumentItems: Unmanaged<CFString>](klssharedfilelistrecentdocumentitems.md)
- [var kLSSharedFileListRecentItemsMaxAmount: Unmanaged<CFString>](klssharedfilelistrecentitemsmaxamount.md)
- [var kLSSharedFileListRecentServerItems: Unmanaged<CFString>](klssharedfilelistrecentserveritems.md)
- [var kLSSharedFileListSessionLoginItems: Unmanaged<CFString>](klssharedfilelistsessionloginitems.md)
- [var kLSSharedFileListVolumesComputerVisible: Unmanaged<CFString>](klssharedfilelistvolumescomputervisible.md)
- [var kLSSharedFileListVolumesNetworkVisible: Unmanaged<CFString>](klssharedfilelistvolumesnetworkvisible.md)
...
- [var kLSNotInitializedErr: OSStatus](klsnotinitializederr.md)
  Not currently used.
- [var kLSUnknownTypeErr: OSStatus](klsunknowntypeerr.md)
  Not currently used.
- [var kLSDataTooOldErr: OSStatus](klsdatatooolderr.md)
  Not currently used.
- [var kLSNotRegisteredErr: OSStatus](klsnotregisterederr.md)
  Not currently used.
- [var kLSAppDoesNotClaimTypeErr: OSStatus](klsappdoesnotclaimtypeerr.md)
  Not currently used.
- [var kLSAppDoesNotSupportSchemeWarning: OSStatus](klsappdoesnotsupportschemewarning.md)
  Not currently used.
- [var kLSNoRegistrationInfoErr: OSStatus](klsnoregistrationinfoerr.md)
  Not currently used.
- [var kLSNoClassicEnvironmentErr: OSStatus](klsnoclassicenvironmenterr.md)
  Not currently used.


---

*[View on Apple Developer](https://developer.apple.com/documentation/coreservices/launch_services/deprecated_symbols)*