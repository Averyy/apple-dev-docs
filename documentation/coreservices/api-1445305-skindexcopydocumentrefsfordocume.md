...
The [`SKIndexCopyDocumentRefsForDocumentIDs(_:_:_:_:)`](1445305-skindexcopydocumentrefsfordocume.md) function lets you get a batch of document URL objects (of type [`SKDocument`](skdocument.md)) in one step, based on a list of document IDs.

If you want to get lightweight URLs in the form of CFURL objects instead, use [`SKIndexCopyDocumentURLsForDocumentIDs(_:_:_:_:)`](1443501-skindexcopydocumenturlsfordocume.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreservices/1445305-skindexcopydocumentrefsfordocume)*