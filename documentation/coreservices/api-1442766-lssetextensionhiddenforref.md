...
A result code; see [`Result Codes`](launch_services#1661359.md). The function will return the result code `kLSCannotSetInfoErr` if:
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreservices/1442766-lssetextensionhiddenforref)*