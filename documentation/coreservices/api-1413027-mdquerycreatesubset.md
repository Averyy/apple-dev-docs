...
- `allocator`: The CFAllocator object to be used to allocate memory for the new object. Pass NULL or   to use the current default allocator.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreservices/1413027-mdquerycreatesubset)*