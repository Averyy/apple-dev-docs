...
A [`CFTypeID`](https://developer.apple.com/documentation/corefoundation/cftypeid) object containing the type identifier for the document URL object (of type [`SKDocument`](skdocument.md)).

#### Discussion

Search Kit represents document URL objects with the [`SKDocument`](skdocument.md) opaque type. If your code needs to determine whether a particular data type is a document URL object, you can use this function along with the [`CFGetTypeID(_:)`](https://developer.apple.com/documentation/corefoundation/cfgettypeid(_:)) function and perform a comparison.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreservices/1448891-skdocumentgettypeid)*