...
Call this function to balance a preceding call to [`AEStreamOpenRecord(_:_:)`](1447141-aestreamopenrecord.md). This function completes the definition of the Apple event record. 
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreservices/1449522-aestreamcloserecord)*