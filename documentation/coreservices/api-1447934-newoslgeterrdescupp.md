...
See [`OSLGetErrDescUPP`](oslgeterrdescupp.md).

#### Discussion

See the [`OSLGetErrDescProcPtr`](oslgeterrdescprocptr.md) callback function. 
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreservices/1447934-newoslgeterrdescupp)*