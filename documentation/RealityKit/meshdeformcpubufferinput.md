...
```swift
typealias MeshDeformCPUBufferInput = UnsafeBufferPointer<UInt8>
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/meshdeformcpubufferinput)*