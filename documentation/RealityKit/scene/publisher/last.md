...
Use [`last()`](scene/publisher/last().md) when you need to emit only the last element from an upstream publisher.
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/scene/publisher/last())*