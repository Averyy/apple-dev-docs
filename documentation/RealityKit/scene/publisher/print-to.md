...
Use [`print(_:to:)`](scene/publisher/print(_:to:).md) to log messages the console.
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/scene/publisher/print(_:to:))*