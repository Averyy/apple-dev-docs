...
- [func compare<Comparator>(Comparator.Compared, Comparator.Compared) -> ComparisonResult](scene/anchorcollection/compare(_:_:).md)
...
- [func count<E>(where: (Self.Element) throws(E) -> Bool) throws(E) -> Int](scene/anchorcollection/count(where:).md)
...
- [func formatted<S>(S) -> S.FormatOutput](scene/anchorcollection/formatted(_:).md)
...
- [func sorted<S, Comparator>(using: S) -> [Self.Element]](scene/anchorcollection/sorted(using:)-6lbv2.md)
  Returns the elements of the sequence, sorted using the given array of `SortComparator`s to compare elements.
- [func sorted<Comparator>(using: Comparator) -> [Self.Element]](scene/anchorcollection/sorted(using:)-767bf.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/scene/anchorcollection/sequence-implementations)*