...
- [func indices(where: (Self.Element) throws -> Bool) rethrows -> RangeSet<Self.Index>](scene/anchorcollection/indices(where:).md)
  Returns the indices of all the elements that match the given predicate.
- [func map<T, E>((Self.Element) throws(E) -> T) throws(E) -> [T]](scene/anchorcollection/map(_:)-7jdb3.md)
...
- [func removingSubranges(RangeSet<Self.Index>) -> DiscontiguousSlice<Self>](scene/anchorcollection/removingsubranges(_:).md)
...
- [func trimmingPrefix(while: (Self.Element) throws -> Bool) rethrows -> Self.SubSequence](scene/anchorcollection/trimmingprefix(while:).md)


---

*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/scene/anchorcollection/collection-implementations)*