...
### Structures
- [Entity.ConfigurationCatalog.Configuration](entity/configurationcatalog-2tett/configuration.md)
  A type that represents an alternative that you can choose.
- [Entity.ConfigurationCatalog.ConfigurationCombination](entity/configurationcatalog-2tett/configurationcombination.md)
  A type that associates an entity with a combination of configurations.
- [Entity.ConfigurationCatalog.ConfigurationSet](entity/configurationcatalog-2tett/configurationset.md)
  A collection of alternatives to choose from.
### Initializers
- [init(configurationSets:combinations:)](entity/configurationcatalog-2tett/init(configurationsets:combinations:).md)
  Creates a configuration catalog from in-memory entities and an array of configuration sets.
- [init(from:)](entity/configurationcatalog-2tett/init(from:).md)
  Loads a configuration catalog from a USD or reality file.
### Instance Properties
- [var configurationSets: [String : Entity.ConfigurationCatalog.ConfigurationSet]](entity/configurationcatalog-2tett/configurationsets.md)
  The configuration sets that configure the default prim or entity.
### Instance Methods
- [func write(to:)](entity/configurationcatalog-2tett/write(to:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/entity/configurationcatalog-2tett)*