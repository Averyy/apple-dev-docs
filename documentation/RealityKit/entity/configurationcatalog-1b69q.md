...
### Structures
- [Entity.ConfigurationCatalog.Configuration](entity/configurationcatalog-1b69q/configuration.md)
  A type that represents an alternative that you can choose.
- [Entity.ConfigurationCatalog.ConfigurationCombination](entity/configurationcatalog-1b69q/configurationcombination.md)
  A type that associates an entity with a combination of configurations.
- [Entity.ConfigurationCatalog.ConfigurationSet](entity/configurationcatalog-1b69q/configurationset.md)
...
### Instance Properties
- [var configurationSets: [String : Entity.ConfigurationCatalog.ConfigurationSet]](entity/configurationcatalog-1b69q/configurationsets.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/entity/configurationcatalog-1b69q)*