...
```swift
@MainActor
@preconcurrency var accessibilityValue: LocalizedStringResource? { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/entity/accessibilityvalue)*