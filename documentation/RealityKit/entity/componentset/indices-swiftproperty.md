...
```swift
@MainActor
@preconcurrency var indices: Entity.ComponentSet.Indices { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/entity/componentset/indices-swift.property)*