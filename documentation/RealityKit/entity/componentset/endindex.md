...
```swift
@MainActor
@preconcurrency var endIndex: Entity.ComponentSet.Index { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/entity/componentset/endindex)*