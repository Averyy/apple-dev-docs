...
```swift
@MainActor
@preconcurrency var accessibilityDescription: String? { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/entity/accessibilitydescription)*