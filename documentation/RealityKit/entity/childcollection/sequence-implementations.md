...
- [func compare<Comparator>(Comparator.Compared, Comparator.Compared) -> ComparisonResult](entity/childcollection/compare(_:_:).md)
...
- [func count<E>(where: (Self.Element) throws(E) -> Bool) throws(E) -> Int](entity/childcollection/count(where:).md)
...
- [func filter(Predicate<Self.Element>) throws -> [Self.Element]](entity/childcollection/filter(_:)-7uwp4.md)
...
- [func formatted<S>(S) -> S.FormatOutput](entity/childcollection/formatted(_:).md)
...
- [func map<T, E>((Self.Element) throws(E) -> T) throws(E) -> [T]](entity/childcollection/map(_:)-1f7qw.md)
...
- [func sorted<S, Comparator>(using: S) -> [Self.Element]](entity/childcollection/sorted(using:)-2qlab.md)
  Returns the elements of the sequence, sorted using the given array of `SortComparator`s to compare elements.
- [func sorted<Comparator>(using: Comparator) -> [Self.Element]](entity/childcollection/sorted(using:)-6cy2p.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/entity/childcollection/sequence-implementations)*