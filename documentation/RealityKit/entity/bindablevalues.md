...
```swift
@MainActor
@preconcurrency var bindableValues: BindableValuesReference { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/entity/bindablevalues)*