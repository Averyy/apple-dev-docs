...
### Subscripts
- [subscript(_:_:)](entity/parameterset-3cp4c/subscript(_:_:).md)
  Accessor for the parameters, returns a bindable value.


---

*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/entity/parameterset-3cp4c)*