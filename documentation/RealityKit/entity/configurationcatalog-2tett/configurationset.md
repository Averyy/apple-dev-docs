...
### Instance Properties
- [var configurations: [String : Entity.ConfigurationCatalog.Configuration]](entity/configurationcatalog-2tett/configurationset/configurations.md)
  The alternative configurations that are available in a set.
- [var defaultConfiguration: Entity.ConfigurationCatalog.Configuration](entity/configurationcatalog-2tett/configurationset/defaultconfiguration.md)
  The default configuration, if you don’t explicitly set one.
- [var id: String](entity/configurationcatalog-2tett/configurationset/id.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/entity/configurationcatalog-2tett/configurationset)*