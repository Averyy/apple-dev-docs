# LightmapResource.IndirectDiffuseIrradianceSHBakeDescriptor
...
```swift
struct IndirectDiffuseIrradianceSHBakeDescriptor
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/lightmapresource/indirectdiffuseirradianceshbakedescriptor)*