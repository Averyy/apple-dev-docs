...
### Structures
- [MeshResource.Contents](meshresource/contents-6qlpp.md)
  Value of the contents of the resource.
- [MeshResource.Contents](meshresource/contents-8xls5.md)
  Value of the contents of the resource.
- [MeshResource.GenerateTextOptions](meshresource/generatetextoptions-8smto.md)
  A type that determines the configuration for rendering text in 2D, before it is extruded.
- [MeshResource.GenerateTextOptions](meshresource/generatetextoptions-hg3h.md)
  A type that determines the configuration for rendering text in 2D, before it is extruded.
- [MeshResource.Instance](meshresource/instance-553cc.md)
  An object that transforms a model to a location.
- [MeshResource.Instance](meshresource/instance-9pl29.md)
  An object that transforms a model to a location.
- [MeshResource.JointInfluences](meshresource/jointinfluences-3lla9.md)
  A buffer of vertex-joint influences which bind the mesh part’s vertices to a skeleton via a skinning deformation.
- [MeshResource.JointInfluences](meshresource/jointinfluences-7s4yp.md)
  A buffer of vertex-joint influences which bind the mesh part’s vertices to a skeleton via a skinning deformation.
- [MeshResource.Model](meshresource/model-1kpgf.md)
  A model consists of a list of parts.
- [MeshResource.Model](meshresource/model-2zswr.md)
  A model consists of a list of parts.
...
- [MeshResource.Part](meshresource/part-4ge48.md)
  A part of a model consisting of a single material.
- [MeshResource.ShapeExtrusionOptions](meshresource/shapeextrusionoptions-3sc8p.md)
  A type that determines the extrusion, chamfering, and material assignment of an extruded shape.
- [MeshResource.ShapeExtrusionOptions](meshresource/shapeextrusionoptions-84mf2.md)
  A type that determines the extrusion, chamfering, and material assignment of an extruded shape.
- [MeshResource.Skeleton](meshresource/skeleton-2378.md)
...
- [MeshResource.Skeleton](meshresource/skeleton-2om5m.md)
  A skeleton consists of a hierarchy of joints. Each joint defines a coordinate space. Portions of a model may be thought of as having a position in a joint’s local space.
### Initializers
...
- [convenience(shape:)](meshresource/init(shape:).md)
  Generates a MeshResource from a ShapeResource.
### Instance Properties
- [var contents: MeshResource.Contents](meshresource/contents-3kv16.md)
  Get the contents of the mesh asset.
- [var contents: MeshResource.Contents](meshresource/contents-5wvwo.md)
  Get the contents of the mesh asset.
- [var lowLevelMesh: LowLevelMesh?](meshresource/lowlevelmesh-1zo8q.md)
...
- [func replace(with:)](meshresource/replace(with:).md)
  Replace the contents of this mesh resource.
### Type Aliases
- [MeshResource.Font](meshresource/font-6ok15.md)
  A platform-specific type that represents a font for use in generating a text mesh.
- [MeshResource.Font](meshresource/font-92otw.md)
  A platform-specific type that represents a font for use in generating a text mesh.
### Type Methods
