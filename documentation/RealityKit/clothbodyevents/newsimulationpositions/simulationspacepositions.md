...
```swift
var simulationSpacePositions: Span<SIMD3<Float>> { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/clothbodyevents/newsimulationpositions/simulationspacepositions)*