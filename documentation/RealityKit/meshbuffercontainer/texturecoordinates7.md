...
```swift
var textureCoordinates7: MeshBuffers.TextureCoordinates? { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/meshbuffercontainer/texturecoordinates7)*