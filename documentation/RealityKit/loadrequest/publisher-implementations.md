...
### Instance Properties
- [var values: AsyncThrowingPublisher<Self>](loadrequest/values.md)
...
- [func append<P>(P) -> Publishers.Concatenate<Self, P>](loadrequest/append(_:)-497kh.md)
  Appends the output of this publisher with the elements emitted by the given publisher.
- [func append(Self.Output...) -> Publishers.Concatenate<Self, Publishers.Sequence<[Self.Output], Self.Failure>>](loadrequest/append(_:)-5mm6y.md)
  Appends a publisher’s output with the specified elements.
- [func append<S>(S) -> Publishers.Concatenate<Self, Publishers.Sequence<S, Self.Failure>>](loadrequest/append(_:)-zcv8.md)
...
- [func flatMap<P>(maxPublishers: Subscribers.Demand, (Self.Output) -> P) -> Publishers.FlatMap<Publishers.SetFailureType<P, Self.Failure>, Self>](loadrequest/flatmap(maxpublishers:_:)-u40q.md)
  Transforms all elements from an upstream publisher into a new publisher up to a maximum number of publishers you specify.
...
- [func merge(with: Self) -> Publishers.MergeMany<Self>](loadrequest/merge(with:)-3tx8u.md)
  Combines elements from this publisher with those from another publisher of the same type, delivering an interleaved sequence of elements.
- [func merge<P>(with: P) -> Publishers.Merge<Self, P>](loadrequest/merge(with:)-9idmr.md)
...
- [func prepend(Self.Output...) -> Publishers.Concatenate<Publishers.Sequence<[Self.Output], Self.Failure>, Self>](loadrequest/prepend(_:)-2jjdg.md)
  Prefixes a publisher’s output with the specified values.
- [func prepend<S>(S) -> Publishers.Concatenate<Publishers.Sequence<S, Self.Failure>, Self>](loadrequest/prepend(_:)-3laqv.md)
  Prefixes a publisher’s output with the specified sequence.
- [func prepend<P>(P) -> Publishers.Concatenate<P, Self>](loadrequest/prepend(_:)-viom.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/loadrequest/publisher-implementations)*