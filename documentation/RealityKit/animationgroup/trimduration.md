...
If you set a value for this property and both [`trimStart`](animationgroup/trimstart.md) and [`trimEnd`](animationgroup/trimend.md) are `nil`, the animation observes this property as an edited duration.

A value greater than [`duration`](animationgroup/duration.md) causes the animation to repeat, applying the characteristics defined by [`repeatMode`](animationgroup/repeatmode.md). Assign this property [`greatestFiniteMagnitude`](https://developer.apple.com/documentation/Swift/Double/greatestFiniteMagnitude) to repeat indefinitely.
