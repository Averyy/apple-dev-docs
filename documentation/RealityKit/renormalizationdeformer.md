...
```swift
struct RenormalizationDeformer
```

## Topics

### Initializers
- [init()](renormalizationdeformer/init.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/renormalizationdeformer)*