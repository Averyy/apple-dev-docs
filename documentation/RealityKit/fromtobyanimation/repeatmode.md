...
If you call [`trimmed(start:end:duration:)`](fromtobyanimation/trimmed(start:end:duration:).md) with a `start` or `end` that lies outside of the timeline defined by [`duration`](fromtobyanimation/duration.md), the animation fills the additional playback by applying this property.
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/fromtobyanimation/repeatmode)*