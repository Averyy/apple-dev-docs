...
If you set a non-zero value for this property and both [`trimStart`](fromtobyanimation/trimstart.md) and [`trimEnd`](fromtobyanimation/trimend.md) are `nil`, the animation observes this property as an edited duration.

When you set [`repeatMode`](fromtobyanimation/repeatmode.md) to make the animation repeat:

- If this property is `nil`, the animation repeats forever.
- If set to a value greater than [`duration`](fromtobyanimation/duration.md), the animation repeats for the specified duration.
