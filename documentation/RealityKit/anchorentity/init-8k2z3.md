...
```swift
@MainActor
@preconcurrency convenience init(_ anchor: any Anchor)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/anchorentity/init(_:)-8k2z3)*