...
```swift
@MainActor
@preconcurrency convenience init(raycastResult: ARRaycastResult)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/anchorentity/init(raycastresult:))*