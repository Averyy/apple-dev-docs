...
```swift
@MainActor
@preconcurrency convenience init(world position: SIMD3<Float>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/anchorentity/init(world:)-u9qv)*