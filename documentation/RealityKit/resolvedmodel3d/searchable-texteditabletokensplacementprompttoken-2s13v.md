...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/resolvedmodel3d/searchable(text:editabletokens:placement:prompt:token:)-2s13v)*