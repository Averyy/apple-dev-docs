...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/resolvedmodel3d/searchable(text:editabletokens:ispresented:placement:prompt:token:)-6ske3)*