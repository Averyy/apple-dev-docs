...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/resolvedmodel3d/fileexporter(ispresented:documents:contenttype:oncompletion:)-7rezx)*