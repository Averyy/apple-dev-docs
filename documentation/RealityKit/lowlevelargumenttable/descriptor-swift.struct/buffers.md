...
```swift
var buffers: [LowLevelArgumentTable.Descriptor.Buffer] { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/lowlevelargumenttable/descriptor-swift.struct/buffers)*