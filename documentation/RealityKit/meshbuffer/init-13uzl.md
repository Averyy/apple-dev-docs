...
```swift
init<S>(_ sequence: S) where S : Sequence, S.Element == SIMD4<Float>
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/meshbuffer/init(_:)-13uzl)*