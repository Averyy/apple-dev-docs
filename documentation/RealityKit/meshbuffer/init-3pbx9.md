...
```swift
init<S>(_ sequence: S) where S : Sequence, S.Element == SIMD2<Float>
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/meshbuffer/init(_:)-3pbx9)*