...
```swift
@MainActor
@preconcurrency func convert(direction: SIMD3<Float>, to referenceEntity: Entity?) -> SIMD3<Float>
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/hastransform/convert(direction:to:))*