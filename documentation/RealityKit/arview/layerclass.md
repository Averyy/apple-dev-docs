...
```swift
@MainActor
@preconcurrency override dynamic class var layerClass: AnyClass { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/arview/layerclass)*