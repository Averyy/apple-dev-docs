...
```swift
@MainActor
@preconcurrency func hitTest(_ point: CGPoint, types: ARHitTestResult.ResultType) -> [ARHitTestResult]
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/arview/hittest(_:types:))*