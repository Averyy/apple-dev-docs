...
```swift
@MainActor
@preconcurrency override dynamic func makeBackingLayer() -> CALayer
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/arview/makebackinglayer())*