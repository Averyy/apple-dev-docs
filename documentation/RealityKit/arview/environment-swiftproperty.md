...
```swift
@MainActor
@preconcurrency var environment: ARView.Environment { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/arview/environment-swift.property)*