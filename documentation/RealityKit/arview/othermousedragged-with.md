...
```swift
@MainActor
@preconcurrency override dynamic func otherMouseDragged(with event: NSEvent)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/arview/othermousedragged(with:))*