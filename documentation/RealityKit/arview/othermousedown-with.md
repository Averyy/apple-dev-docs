...
```swift
@MainActor
@preconcurrency override dynamic func otherMouseDown(with event: NSEvent)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/arview/othermousedown(with:))*