...
```swift
@MainActor
@preconcurrency override dynamic func mouseDragged(with event: NSEvent)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/arview/mousedragged(with:))*