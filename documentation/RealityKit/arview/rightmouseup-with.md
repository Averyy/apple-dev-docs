...
```swift
@MainActor
@preconcurrency override dynamic func rightMouseUp(with event: NSEvent)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/arview/rightmouseup(with:))*