...
```swift
@MainActor
@preconcurrency override dynamic func rightMouseDragged(with event: NSEvent)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/arview/rightmousedragged(with:))*