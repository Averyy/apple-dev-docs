...
```swift
@MainActor
@preconcurrency override dynamic func didMoveToSuperview()
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/arview/didmovetosuperview())*