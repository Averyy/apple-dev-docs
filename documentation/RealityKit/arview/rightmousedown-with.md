...
```swift
@MainActor
@preconcurrency override dynamic func rightMouseDown(with event: NSEvent)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/arview/rightmousedown(with:))*