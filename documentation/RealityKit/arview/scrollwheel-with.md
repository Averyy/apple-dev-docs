...
```swift
@MainActor
@preconcurrency override dynamic func scrollWheel(with event: NSEvent)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/arview/scrollwheel(with:))*