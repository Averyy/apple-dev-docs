...
This array contains sequential values for the animated property when [`bindTarget`](animationdefinition/bindtarget.md) is an array of [`simd`](https://developer.apple.com/documentation/accelerate/simd) floating-point pairs.
