...
```swift
static let extractAll: SampledAnimation<JointTransforms>.SkeletalAnimationOperation.RootMotionOptions
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/sampledanimation/skeletalanimationoperation/rootmotionoptions/extractall)*