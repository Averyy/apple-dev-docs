...
```swift
static let translationY: SampledAnimation<JointTransforms>.SkeletalAnimationOperation.RootMotionOptions
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/sampledanimation/skeletalanimationoperation/rootmotionoptions/translationy)*