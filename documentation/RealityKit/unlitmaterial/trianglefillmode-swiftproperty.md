...
```swift
var triangleFillMode: UnlitMaterial.TriangleFillMode { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/unlitmaterial/trianglefillmode-swift.property)*