...
```swift
@MainActor
@preconcurrency var skybox: TextureResource { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/environmentresource/skybox-6vyow)*