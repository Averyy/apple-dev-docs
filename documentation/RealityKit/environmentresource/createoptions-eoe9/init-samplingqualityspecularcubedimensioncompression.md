...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/environmentresource/createoptions-eoe9/init(samplingquality:specularcubedimension:compression:))*