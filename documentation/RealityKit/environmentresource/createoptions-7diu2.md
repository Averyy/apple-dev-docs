...
### Instance Properties
- [var compression: EnvironmentResource.Compression](environmentresource/createoptions-7diu2/compression.md)
  The compression to apply to environment textures.
- [var samplingQuality: EnvironmentResource.CreateOptions.SamplingQuality](environmentresource/createoptions-7diu2/samplingquality-swift.property.md)
  The skybox sampling quality for lighting textures.
- [var specularCubeDimension: Int?](environmentresource/createoptions-7diu2/specularcubedimension.md)
  The dimension of the computed specular cubemap for material reflections.
### Enumerations
- [EnvironmentResource.CreateOptions.SamplingQuality](environmentresource/createoptions-7diu2/samplingquality-swift.enum.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/environmentresource/createoptions-7diu2)*