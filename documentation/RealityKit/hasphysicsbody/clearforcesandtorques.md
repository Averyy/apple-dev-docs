...
```swift
@MainActor
@preconcurrency func clearForcesAndTorques()
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/hasphysicsbody/clearforcesandtorques())*