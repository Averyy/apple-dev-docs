...
This value is equivalent to [`indexCapacity`](lowlevelmesh/descriptor-swift.struct/indexcapacity.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/lowlevelmesh/indexcapacity)*