...
This value is equivalent to [`vertexCapacity`](lowlevelmesh/descriptor-swift.struct/vertexcapacity.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/lowlevelmesh/vertexcapacity)*