...
```swift
@MainActor
func replaceUnsafeMutableIndices(_ callback: (UnsafeMutableRawBufferPointer) -> Void)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/lowlevelmesh/replaceunsafemutableindices(_:))*