...
```swift
@MainActor
final let descriptor: LowLevelMesh.Descriptor
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/lowlevelmesh/descriptor-swift.property)*