...
```swift
typealias Element = AnchoringComponent.Target.Classification
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/anchoringcomponent/target-swift.enum/classification/element)*