...
### Type Properties
- [static let continuous: AnchoringComponent.TrackingMode](anchoringcomponent/trackingmode-1qdav/continuous.md)
...
- [static let once: AnchoringComponent.TrackingMode](anchoringcomponent/trackingmode-1qdav/once.md)
  Anchors the entity to the target on the first frame the target is found.
- [static let predicted: AnchoringComponent.TrackingMode](anchoringcomponent/trackingmode-1qdav/predicted.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/anchoringcomponent/trackingmode-1qdav)*