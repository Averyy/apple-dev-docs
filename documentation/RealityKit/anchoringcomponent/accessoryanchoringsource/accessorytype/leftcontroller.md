...
```swift
static var leftController: AnchoringComponent.AccessoryAnchoringSource.AccessoryType { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/anchoringcomponent/accessoryanchoringsource/accessorytype/leftcontroller)*