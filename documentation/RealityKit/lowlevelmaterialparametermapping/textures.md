...
```swift
var textures: [LowLevelMaterialParameterMapping.TextureParameter] { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/lowlevelmaterialparametermapping/textures)*