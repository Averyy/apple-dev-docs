...
This property doesn’t affect the animation’s [`delay`](animationdefinition/delay.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/animationdefinition/speed)*