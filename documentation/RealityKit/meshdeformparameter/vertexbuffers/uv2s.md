...
```swift
let uv2s: MeshDeformParameter<InputBuffer, OutputBuffer>.VertexBuffers<Buffer>.Data?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/meshdeformparameter/vertexbuffers/uv2s)*