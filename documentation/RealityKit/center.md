...
To reside at an arbitrary location in its parent’s coordinate space, a prim needs the translation component of a transform. Therefore, assign this property an [`Xformable`](https://developer.apple.comhttps://graphics.pixar.com/usd/docs/api/class_usd_geom_xformable.html) prim.
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/center)*