...
### Instance Properties
- [var coordinateSpaceID: String?](scene/coordinatespaceid.md)
- [var timebase: CMTimebase](scene/timebase-4c9np.md)
...
- [var timebase: CMTimebase](scene/timebase-6un6i.md)
  The default timebase for the scene, useful for driving custom times managed by the user which are derived from the scene time.
### Enumerations
- [Scene.AnchoringTrackingState](scene/anchoringtrackingstate-2nost.md)
  Describes the tracking state of the device anchor running the RealityKit App
- [Scene.AnchoringTrackingState](scene/anchoringtrackingstate-wu3p.md)
  Describes the tracking state of the device anchor running the RealityKit App
