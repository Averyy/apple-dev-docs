...
The default value is zero. This property is in stage linear units; for more information, see [`Encoding Stage Linear Units`](https://developer.apple.comhttps://graphics.pixar.com/usd/docs/api/group___usd_geom_linear_units__group.html).
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/movedistance)*