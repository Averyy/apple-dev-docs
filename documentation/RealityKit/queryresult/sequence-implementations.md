...
- [func compare<Comparator>(Comparator.Compared, Comparator.Compared) -> ComparisonResult](queryresult/compare(_:_:).md)
...
- [func count<E>(where: (Self.Element) throws(E) -> Bool) throws(E) -> Int](queryresult/count(where:).md)
...
- [func dropFirst(Int) -> DropFirstSequence<Self>](queryresult/dropfirst(_:).md)
  Returns a sequence containing all but the given number of initial elements.
- [func dropLast(Int) -> [Self.Element]](queryresult/droplast(_:).md)
...
- [func first<T>(matchingCategory: CMTypedTag<T>.Category) -> CMTypedTag<T>?](queryresult/first(matchingcategory:).md)
  Finds and returns the first tag matching the specified category.
- [func first(where: (Self.Element) throws -> Bool) rethrows -> Self.Element?](queryresult/first(where:).md)
  Returns the first element of the sequence that satisfies the given predicate.
- [func firstValue<T>(matchingCategory: CMTypedTag<T>.Category) -> T?](queryresult/firstvalue(matchingcategory:).md)
...
- [func formatted() -> String](queryresult/formatted.md)
- [func formatted<S>(S) -> S.FormatOutput](queryresult/formatted(_:).md)
...
- [func lexicographicallyPrecedes<OtherSequence>(OtherSequence) -> Bool](queryresult/lexicographicallyprecedes(_:).md)
  Returns a Boolean value indicating whether the sequence precedes another sequence in a lexicographical (dictionary) ordering, using the less-than operator (`<`) to compare elements.
- [func lexicographicallyPrecedes<OtherSequence>(OtherSequence, by: (Self.Element, Self.Element) throws -> Bool) rethrows -> Bool](queryresult/lexicographicallyprecedes(_:by:).md)
...
- [func max() -> Self.Element?](queryresult/max.md)
...
- [func min() -> Self.Element?](queryresult/min.md)
  Returns the minimum element in the sequence.
- [func min(by: (Self.Element, Self.Element) throws -> Bool) rethrows -> Self.Element?](queryresult/min(by:).md)
...
- [func reduce<Result>(into: Result, (inout Result, Self.Element) throws -> ()) rethrows -> Result](queryresult/reduce(into:_:).md)
  Returns the result of combining the elements of the sequence using the given closure.
- [func reversed() -> [Self.Element]](queryresult/reversed.md)
...
- [func sorted() -> [Self.Element]](queryresult/sorted.md)
  Returns the elements of the sequence, sorted.
- [func sorted(by: (Self.Element, Self.Element) throws -> Bool) rethrows -> [Self.Element]](queryresult/sorted(by:).md)
  Returns the elements of the sequence, sorted using the given predicate as the comparison between elements.
- [func sorted<S, Comparator>(using: S) -> [Self.Element]](queryresult/sorted(using:)-9q18w.md)
  Returns the elements of the sequence, sorted using the given array of `SortComparator`s to compare elements.
- [func sorted<Comparator>(using: Comparator) -> [Self.Element]](queryresult/sorted(using:)-er6u.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/queryresult/sequence-implementations)*