...
```swift
final var renderTargetDescriptor: LowLevelRenderTarget.Descriptor { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/lowlevelrenderer/rendertargetdescriptor)*