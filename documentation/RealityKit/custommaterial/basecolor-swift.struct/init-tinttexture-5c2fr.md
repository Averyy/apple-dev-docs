...
```swift
init(tint: UIColor = .white, texture: CustomMaterial.Texture? = nil)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/custommaterial/basecolor-swift.struct/init(tint:texture:)-5c2fr)*