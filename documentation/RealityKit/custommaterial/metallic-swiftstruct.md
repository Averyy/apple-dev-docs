...
For more information on using metallic values in a custom material, see [`metallic`](custommaterial/metallic-swift.property.md).
...
- [var scale: Float](custommaterial/metallic-swift.struct/scale.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/custommaterial/metallic-swift.struct)*