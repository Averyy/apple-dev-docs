...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/realityviewentitycollection/split(maxsplits:omittingemptysubsequences:whereseparator:))*