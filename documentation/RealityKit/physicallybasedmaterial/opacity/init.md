...
```swift
init(_ value: CustomMaterial.Opacity)
```

## Parameters

- `value`: The custom material’s opacity property.
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/physicallybasedmaterial/opacity/init(_:))*