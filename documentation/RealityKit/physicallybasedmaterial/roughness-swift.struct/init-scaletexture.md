...
![An illustration showing three spheres with different amounts of](/images/com.apple.RealityKit/PhysicallyBasedMaterial-Roughness-swift-struct-init(scale:texture:)-1@2x.png)
