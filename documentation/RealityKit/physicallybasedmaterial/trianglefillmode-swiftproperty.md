...
```swift
var triangleFillMode: PhysicallyBasedMaterial.TriangleFillMode { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/physicallybasedmaterial/trianglefillmode-swift.property)*