# PhysicallyBasedMaterial.SubsurfaceWeight
...
```swift
struct SubsurfaceWeight
```

## Topics

### Accessing material keys
- [static let textureKey: String](physicallybasedmaterial/subsurfaceweight-swift.struct/texturekey.md)
- [static let scaleKey: String](physicallybasedmaterial/subsurfaceweight-swift.struct/scalekey.md)
### Initializers
- [init(scale: Float, texture: PhysicallyBasedMaterial.Texture?)](physicallybasedmaterial/subsurfaceweight-swift.struct/init(scale:texture:).md)
### Instance Properties
- [var scale: Float](physicallybasedmaterial/subsurfaceweight-swift.struct/scale.md)
- [var texture: PhysicallyBasedMaterial.Texture?](physicallybasedmaterial/subsurfaceweight-swift.struct/texture.md)
### Type Properties
- [static let textureSemantic: TextureResource.Semantic](physicallybasedmaterial/subsurfaceweight-swift.struct/texturesemantic.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/physicallybasedmaterial/subsurfaceweight-swift.struct)*