...
```swift
init(_ value: CustomMaterial.Clearcoat)
```

## Parameters

- `value`: The custom material’s clearcoat property.
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/physicallybasedmaterial/clearcoat-swift.struct/init(_:))*