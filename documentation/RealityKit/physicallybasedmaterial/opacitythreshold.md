...
When the `opacityThreshold` property is set, the blend mode of the [`blending`](physicallybasedmaterial/blending-swift.property.md) property is ignored and the renderer applies the masking behavior.
