...
```swift
var subsurfaceRadius: PhysicallyBasedMaterial.SubsurfaceRadius { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/physicallybasedmaterial/subsurfaceradius-swift.property)*