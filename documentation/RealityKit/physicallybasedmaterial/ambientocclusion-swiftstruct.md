...
- [init(texture: PhysicallyBasedMaterial.Texture?)](physicallybasedmaterial/ambientocclusion-swift.struct/init(texture:).md)
  Creates an object from an image texture.
- [init(CustomMaterial.AmbientOcclusion)](physicallybasedmaterial/ambientocclusion-swift.struct/init(_:).md)
  Creates an object from a custom material’s ambient occlusion property.
### Accessing ambient occlusion values
- [var texture: PhysicallyBasedMaterial.Texture?](physicallybasedmaterial/ambientocclusion-swift.struct/texture.md)
  The amount of ambient occlusion specified using a UV-mapped image.
- [static let textureSemantic: TextureResource.Semantic](physicallybasedmaterial/ambientocclusion-swift.struct/texturesemantic.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/physicallybasedmaterial/ambientocclusion-swift.struct)*