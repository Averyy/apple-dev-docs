...
```swift
var faceCulling: ShaderGraphMaterial.FaceCulling { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/shadergraphmaterial/faceculling-swift.property)*