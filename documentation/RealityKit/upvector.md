...
This property defines the axis around which the runtime rotates the target to create the effect of a prim looking at the user. Normally, an asset defines this value to match the stage’s [`upAxis`](https://developer.apple.comhttps://graphics.pixar.com/usd/docs/api/group___usd_geom_up_axis__group.html). The default value points positively in the y-direction.
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/upvector)*