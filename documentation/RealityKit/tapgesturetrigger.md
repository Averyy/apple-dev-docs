...
For an example, see [`Trigger animation for a tapped cube`](preliminary-behavior#Trigger-animation-for-a-tapped-cube.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/tapgesturetrigger)*