...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/tonemappingcomponent/init(exposure:toestrength:toelength:shoulderstrength:shoulderlength:shoulderangle:))*