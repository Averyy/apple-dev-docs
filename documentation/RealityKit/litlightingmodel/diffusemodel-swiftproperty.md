...
```swift
var diffuseModel: LitLightingModel.DiffuseModel
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/litlightingmodel/diffusemodel-swift.property)*