...
Use a  unique [`id`](photogrammetrysample/id-swift.property.md) for each [`PhotogrammetrySession`](photogrammetrysession.md) so RealityKit can distinguish different [`PhotogrammetrySample`](photogrammetrysample.md) instances in status updates, error messages, and other contexts.
...
- [let id: Int](photogrammetrysample/id-swift.property.md)
  Unique identifier for the sample.
- [PhotogrammetrySample.ID](photogrammetrysample/id-swift.typealias.md)
...
### Initializers
- [init(contentsOf: URL) async throws](photogrammetrysample/init(contentsof:)-1a52u.md)
...
- [init(contentsOf: URL) throws](photogrammetrysample/init(contentsof:)-41l8i.md)
...
- [CustomStringConvertible Implementations](photogrammetrysample/customstringconvertible-implementations.md)
