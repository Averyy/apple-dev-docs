...
This action animates from the target prim’s current transform to the [`xformTarget`](xformtarget.md) transform.
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/transformaction)*