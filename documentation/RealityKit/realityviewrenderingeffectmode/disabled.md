...
```swift
static var disabled: RealityViewRenderingEffectMode { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/realityviewrenderingeffectmode/disabled)*