...
```swift
subscript(position: IKRig.JointCollection.Index) -> IKRig.JointCollection.Element { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/ikrig/jointcollection/subscript(_:)-6stmh)*