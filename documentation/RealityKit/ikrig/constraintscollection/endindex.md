...
```swift
var endIndex: IKRig.ConstraintsCollection.Index { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/ikrig/constraintscollection/endindex)*