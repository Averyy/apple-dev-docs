...
- [func count<E>(where: (Self.Element) throws(E) -> Bool) throws(E) -> Int](jointtransforms/count(where:).md)
...
- [func map<T, E>((Self.Element) throws(E) -> T) throws(E) -> [T]](jointtransforms/map(_:)-2v3es.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/jointtransforms/sequence-implementations)*