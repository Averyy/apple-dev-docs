...
```swift
func hitTest(point: CGPoint, in space: some CoordinateSpaceProtocol, query: CollisionCastQueryType = .all, mask: CollisionGroup = .all) -> [CollisionCastHit]
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/realityviewcameracontent/hittest(point:in:query:mask:))*