...
```swift
var geometryModifier: LowLevelMaterialResource.GeometryModifier? { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/lowlevelmaterialresource/shadergraphoutput/geometrymodifier)*