...
```swift
var fractionPerPositiveEdge: SIMD3<Float>
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/clippingprimitivecomponent/feather-swift.struct/fractionperpositiveedge)*