...
```swift
static var tangents: MeshDeformerVertexOptions { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/meshdeformervertexoptions/tangents)*