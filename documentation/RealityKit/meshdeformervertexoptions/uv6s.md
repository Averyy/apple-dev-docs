...
```swift
static var uv6s: MeshDeformerVertexOptions { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/meshdeformervertexoptions/uv6s)*