...
```swift
static var tangentFrame: MeshDeformerVertexOptions { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/meshdeformervertexoptions/tangentframe)*