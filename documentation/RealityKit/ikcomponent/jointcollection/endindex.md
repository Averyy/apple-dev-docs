...
```swift
var endIndex: IKComponent.JointCollection.Index { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/ikcomponent/jointcollection/endindex)*