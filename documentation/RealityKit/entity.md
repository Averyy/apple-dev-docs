...
- [convenience init(from: Data, named: String?, contentType: UTType) async throws](entity/init(from:named:contenttype:).md)
...
- [func attach(GeometricPin?, to: GeometricPin)](entity/attach(_:to:).md)
