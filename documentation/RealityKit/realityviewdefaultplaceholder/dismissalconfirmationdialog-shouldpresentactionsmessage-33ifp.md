...
```swift
nonisolated
func dismissalConfirmationDialog<A, M>(_ titleKey: LocalizedStringKey, shouldPresent: Bool, @ViewBuilder actions: () -> A, @ViewBuilder message: () -> M) -> some View where A : View, M : View
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/realityviewdefaultplaceholder/dismissalconfirmationdialog(_:shouldpresent:actions:message:)-33ifp)*