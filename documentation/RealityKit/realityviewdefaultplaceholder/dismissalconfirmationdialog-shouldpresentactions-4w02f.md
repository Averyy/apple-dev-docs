...
```swift
nonisolated
func dismissalConfirmationDialog<A>(_ titleKey: LocalizedStringKey, shouldPresent: Bool, @ViewBuilder actions: () -> A) -> some View where A : View
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/realityviewdefaultplaceholder/dismissalconfirmationdialog(_:shouldpresent:actions:)-4w02f)*