...
```swift
@MainActor
static func box(size: SIMD3<Float>, targetEdgeLength: Float = defaultTargetEdgeLength) throws -> Self
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/clothmeshresource/box(size:targetedgelength:))*