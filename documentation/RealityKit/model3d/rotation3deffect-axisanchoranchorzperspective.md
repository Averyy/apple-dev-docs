...
> ❗ **Important**: In visionOS, create this effect with [`perspectiveRotationEffect(_:axis:anchor:anchorZ:perspective:)`](model3d/perspectiverotationeffect(_:axis:anchor:anchorz:perspective:).md) instead. To truly rotate a view in three dimensions, use a 3D rotation modifier without a perspective input like `rotation3DEffect(_:axis:anchor:)`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/model3d/rotation3deffect(_:axis:anchor:anchorz:perspective:))*