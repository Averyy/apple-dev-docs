...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/model3d/fileexporter(ispresented:items:contenttypes:oncompletion:oncancellation:))*