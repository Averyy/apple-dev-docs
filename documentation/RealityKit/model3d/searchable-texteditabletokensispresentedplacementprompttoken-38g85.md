...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/model3d/searchable(text:editabletokens:ispresented:placement:prompt:token:)-38g85)*