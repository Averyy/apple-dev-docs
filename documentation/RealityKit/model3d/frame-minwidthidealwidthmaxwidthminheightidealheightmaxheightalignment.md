...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/model3d/frame(minwidth:idealwidth:maxwidth:minheight:idealheight:maxheight:alignment:))*