...
```swift
@MainActor
@preconcurrency static func == (lhs: TextureResource, rhs: TextureResource) -> Bool
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/textureresource/==(_:_:)-2oq54)*