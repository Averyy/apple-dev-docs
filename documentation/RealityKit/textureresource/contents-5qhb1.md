...
### Structures
- [TextureResource.Contents.MipmapLevel](textureresource/contents-5qhb1/mipmaplevel.md)
  An object that references the pixel data for a single mipmap of a texture.
- [TextureResource.Contents.Slice](textureresource/contents-5qhb1/slice.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/textureresource/contents-5qhb1)*