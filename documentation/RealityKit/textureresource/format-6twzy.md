...
- [TextureResource.Format.NormalEncoding](textureresource/format-6twzy/normalencoding.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/textureresource/format-6twzy)*