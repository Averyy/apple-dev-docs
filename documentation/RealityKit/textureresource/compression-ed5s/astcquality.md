...
### Enumeration Cases
- [TextureResource.Compression.ASTCQuality.exhaustive](textureresource/compression-ed5s/astcquality/exhaustive.md)
  Compresses optimally, achieving minor gains over high-level compression at the cost of much longer processing times.
- [TextureResource.Compression.ASTCQuality.fast](textureresource/compression-ed5s/astcquality/fast.md)
  Compresses as fast as possible.
- [TextureResource.Compression.ASTCQuality.high](textureresource/compression-ed5s/astcquality/high.md)
...
- [TextureResource.Compression.ASTCQuality.normal](textureresource/compression-ed5s/astcquality/normal.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/textureresource/compression-ed5s/astcquality)*