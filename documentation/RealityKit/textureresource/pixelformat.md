...
```swift
@MainActor
@preconcurrency var pixelFormat: MTLPixelFormat { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/textureresource/pixelformat)*