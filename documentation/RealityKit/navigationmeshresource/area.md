...
### Initializers
- [init(UInt8)](navigationmeshresource/area/init(_:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/navigationmeshresource/area)*