...
```swift
func removeAreaInBox(boundingBox: BoundingBox, area: NavigationMeshResource.Area)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/navigationmeshresource/removeareainbox(boundingbox:area:))*