# markFlagInBox(boundingBox:flag:)
...
```swift
func markFlagInBox(boundingBox: BoundingBox, flag: NavigationMeshResource.Flag)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/navigationmeshresource/markflaginbox(boundingbox:flag:))*