...
### Initializers
- [init(UInt32)](navigationmeshresource/layer-swift.struct/init(_:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/navigationmeshresource/layer-swift.struct)*