...
```swift
final var geometryArguments: LowLevelArgumentTable? { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/lowlevelmeshinstance/geometryarguments)*