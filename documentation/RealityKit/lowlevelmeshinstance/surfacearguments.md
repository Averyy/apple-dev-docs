...
```swift
final var surfaceArguments: LowLevelArgumentTable? { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/lowlevelmeshinstance/surfacearguments)*