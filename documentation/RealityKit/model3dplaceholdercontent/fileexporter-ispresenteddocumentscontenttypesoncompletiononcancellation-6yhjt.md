...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/model3dplaceholdercontent/fileexporter(ispresented:documents:contenttypes:oncompletion:oncancellation:)-6yhjt)*