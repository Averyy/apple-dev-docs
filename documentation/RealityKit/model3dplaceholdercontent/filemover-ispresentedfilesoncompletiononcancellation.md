...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/model3dplaceholdercontent/filemover(ispresented:files:oncompletion:oncancellation:))*