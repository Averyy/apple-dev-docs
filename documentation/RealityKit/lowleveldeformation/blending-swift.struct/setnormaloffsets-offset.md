...
```swift
func setNormalOffsets(_ buffer: any MTLBuffer, offset: Int) throws(LowLevelDeformation.Error)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/lowleveldeformation/blending-swift.struct/setnormaloffsets(_:offset:))*