...
```swift
@MainActor
@preconcurrency func velocity(in entity: Entity?) -> SIMD3<Float>
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/entitytranslationgesturerecognizer/velocity(in:))*