...
```swift
@MainActor
@preconcurrency func translation(in entity: Entity?) -> SIMD3<Float>?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/entitytranslationgesturerecognizer/translation(in:))*