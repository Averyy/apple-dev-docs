...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/realityview/dismissalconfirmationdialog(_:shouldpresent:actions:message:)-1h5t5)*