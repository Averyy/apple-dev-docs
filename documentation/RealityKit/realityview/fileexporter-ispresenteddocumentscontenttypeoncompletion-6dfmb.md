...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/realityview/fileexporter(ispresented:documents:contenttype:oncompletion:)-6dfmb)*