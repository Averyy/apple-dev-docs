...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/realityview/searchable(text:tokens:ispresented:placement:prompt:token:)-5n441)*