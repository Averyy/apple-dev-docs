...
### Instance Properties
- [var inverseBindPoseMatrix: simd_float4x4](meshresource/skeleton-2om5m/joint/inversebindposematrix.md)
  A matrix which transforms from the authored pose (the “bind pose”) of the bound model to the local space of this joint.
- [var name: String](meshresource/skeleton-2om5m/joint/name.md)
  The name of this joint.
- [var parentIndex: Int?](meshresource/skeleton-2om5m/joint/parentindex.md)
  The index of this joint’s parent, or nil if this joint has no parent.
- [var restPoseTransform: Transform](meshresource/skeleton-2om5m/joint/restposetransform.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/meshresource/skeleton-2om5m/joint)*