...
```swift
nonisolated
convenience init(from content: MeshResource.Contents) async throws
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/meshresource/init(from:)-869q3)*