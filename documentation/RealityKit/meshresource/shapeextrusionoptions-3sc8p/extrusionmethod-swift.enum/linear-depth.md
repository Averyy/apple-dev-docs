...
You can also use [`MeshResource.ShapeExtrusionOptions.ExtrusionMethod.tracePositions(_:)`](meshresource/shapeextrusionoptions-3sc8p/extrusionmethod-swift.enum/tracepositions(_:).md) an equivalent way.
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/meshresource/shapeextrusionoptions-3sc8p/extrusionmethod-swift.enum/linear(depth:))*