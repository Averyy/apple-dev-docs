...
```swift
@MainActor
@preconcurrency static func generateBox(size: SIMD3<Float>, cornerRadius: Float = 0) -> MeshResource
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/meshresource/generatebox(size:cornerradius:)-2ovma)*