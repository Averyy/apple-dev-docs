...
You can also use [`MeshResource.ShapeExtrusionOptions.ExtrusionMethod.tracePositions(_:)`](meshresource/shapeextrusionoptions-84mf2/extrusionmethod-swift.enum/tracepositions(_:).md) an equivalent way.
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/meshresource/shapeextrusionoptions-84mf2/extrusionmethod-swift.enum/linear(depth:))*