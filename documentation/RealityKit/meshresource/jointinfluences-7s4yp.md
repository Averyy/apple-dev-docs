...
### Instance Properties
- [var influences: MeshBuffers.JointInfluences](meshresource/jointinfluences-7s4yp/influences.md)
  Buffer of joint influences.


---

*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/meshresource/jointinfluences-7s4yp)*