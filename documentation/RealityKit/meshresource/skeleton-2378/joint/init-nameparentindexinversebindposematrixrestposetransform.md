...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/meshresource/skeleton-2378/joint/init(name:parentindex:inversebindposematrix:restposetransform:))*