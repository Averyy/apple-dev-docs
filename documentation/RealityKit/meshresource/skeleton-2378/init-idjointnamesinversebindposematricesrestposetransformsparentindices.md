...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/meshresource/skeleton-2378/init(id:jointnames:inversebindposematrices:restposetransforms:parentindices:))*