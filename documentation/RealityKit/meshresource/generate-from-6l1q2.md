...
```swift
@MainActor
@preconcurrency static func generate(from descriptors: [MeshDescriptor]) throws -> MeshResource
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/realitykit/meshresource/generate(from:)-6l1q2)*