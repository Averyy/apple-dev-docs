...
| `signInButton` | The sign-in button to display to the user. The properties are: ![None](/images/com.apple.cloudkitjs/spacer.png) id: The DOM element ID. The default value is `apple-sign-in-button`. ![None](/images/com.apple.cloudkitjs/spacer.png) theme: The button theme. The default value is `medium`. ![None](/images/com.apple.cloudkitjs/spacer.png) If `null`, uses the default property values. |
| `signOutButton` | The sign-out button to display to the user. The properties are: ![None](/images/com.apple.cloudkitjs/spacer.png) id: The DOM element ID. The default value is `apple-sign-out-button`. ![None](/images/com.apple.cloudkitjs/spacer.png) theme: The button theme. The default value is `medium`. ![None](/images/com.apple.cloudkitjs/spacer.png) If `null`, uses the default property values. |
