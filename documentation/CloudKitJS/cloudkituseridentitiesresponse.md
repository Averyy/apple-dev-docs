...
### Response Properties
- [users](cloudkit.useridentitiesresponse/users.md)
  The fetched user identities.
### Identifying the Class
- [isUserIdentitiesResponse](cloudkit.useridentitiesresponse/isuseridentitiesresponse.md)
...
### Logging
- [toString](cloudkit.useridentitiesresponse/tostring.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/cloudkitjs/cloudkit.useridentitiesresponse)*