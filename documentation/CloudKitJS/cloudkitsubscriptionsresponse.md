...
- [subscriptions](cloudkit.subscriptionsresponse/subscriptions.md)
  Contains the subscriptions for the successful operations.
### Identifying the Class
- [isSubscriptionsResponse](cloudkit.subscriptionsresponse/issubscriptionsresponse.md)
  Boolean value indicating whether this object is an instance of the [`CloudKit.SubscriptionsResponse`](cloudkit.subscriptionsresponse.md) class.
### Logging
- [toString](cloudkit.subscriptionsresponse/tostring.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/cloudkitjs/cloudkit.subscriptionsresponse)*