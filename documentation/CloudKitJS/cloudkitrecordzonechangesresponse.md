...
### Response Properties
- [zones](cloudkit.recordzonechangesresponse/zones.md)
  The records that changed in each zone.
### Identifying the Class
- [isRecordZoneChangesResponse](cloudkit.recordzonechangesresponse/isrecordzonechangesresponse.md)
  A Boolean value indicating whether this object is an instance of the [`CloudKit.RecordZoneChangesResponse`](cloudkit.recordzonechangesresponse.md) class.
...
*[View on Apple Developer](https://developer.apple.com/documentation/cloudkitjs/cloudkit.recordzonechangesresponse)*