...
### Instance Properties
- [rootRecord](cloudkit.recordinfo/rootrecord.md)
  The root shared record.
- [share](cloudkit.recordinfo/share.md)
  The shared record.
...
*[View on Apple Developer](https://developer.apple.com/documentation/cloudkitjs/cloudkit.recordinfo)*