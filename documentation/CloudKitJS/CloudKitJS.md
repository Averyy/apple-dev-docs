...
``` > **Note**:  The CloudKit JS version number is in the URL. For example, `2` specifies CloudKit JS 2.0.  The CloudKit JS version number is in the URL. For example, `2` specifies CloudKit JS 2.0.
