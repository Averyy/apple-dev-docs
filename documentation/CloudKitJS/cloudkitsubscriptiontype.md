...
### Enumeration Cases
- [DATABASE](cloudkit.subscriptiontype/database.md)
  A database subscription.
- [QUERY](cloudkit.subscriptiontype/query.md)
  A query subscription.
- [RECORD_ZONE](cloudkit.subscriptiontype/record_zone.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/cloudkitjs/cloudkit.subscriptiontype)*