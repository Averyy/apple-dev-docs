...
```swift
const String AUTHENTICATION_REQUIRED;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/cloudkitjs/cloudkit.ckerror/authentication_required)*