...
```swift
const String VALIDATING_REFERENCE_ERROR;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/cloudkitjs/cloudkit.ckerror/validating_reference_error)*