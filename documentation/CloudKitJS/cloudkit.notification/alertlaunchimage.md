...
```swift
readonly attribute String alertLaunchImage;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/cloudkitjs/cloudkit.notification/alertlaunchimage)*