...
```swift
readonly attribute String alertActionLocalizationKey;
```
...
- [alertLocalizationArgs](cloudkit.notification/alertlocalizationargs.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/cloudkitjs/cloudkit.notification/alertactionlocalizationkey)*