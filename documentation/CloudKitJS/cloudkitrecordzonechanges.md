...
### Instance Properties
- [desiredKeys](cloudkit.recordzonechanges/desiredkeys.md)
...
- [desiredRecordTypes](cloudkit.recordzonechanges/desiredrecordtypes.md)
...
- [errors](cloudkit.recordzonechanges/errors.md)
  Errors that may have occurred fetching the changed records.
- [moreComing](cloudkit.recordzonechanges/morecoming.md)
...
- [records](cloudkit.recordzonechanges/records.md)
  The records that changed.
- [resultsLimit](cloudkit.recordzonechanges/resultslimit.md)
  The maximum number of records to fetch.
- [syncToken](cloudkit.recordzonechanges/synctoken.md)
...
- [zoneID](cloudkit.recordzonechanges/zoneid.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/cloudkitjs/cloudkit.recordzonechanges)*