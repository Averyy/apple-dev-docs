...
```swift
var longWordTouchUpDown: [ProbabilityMetric<UnitDuration>] { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/sensorkit/srkeyboardmetrics/longwordtouchupdown)*