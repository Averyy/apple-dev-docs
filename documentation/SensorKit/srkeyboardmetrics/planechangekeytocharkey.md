...
```swift
var planeChangeKeyToCharKey: SRKeyboardMetrics.ProbabilityMetric<UnitDuration> { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/sensorkit/srkeyboardmetrics/planechangekeytocharkey)*