...
```swift
var longWordTouchDownDown: [SRKeyboardMetrics.ProbabilityMetric<UnitDuration>] { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/sensorkit/srkeyboardmetrics/longwordtouchdowndown)*