...
```swift
var deleteToDeletes: [SRKeyboardMetrics.ProbabilityMetric<UnitDuration>] { get }
```

#### Discussion

Each entry in the array is a distribution of [`deleteToDelete`](srkeyboardmetrics/deletetodelete.md) for a key’s position in a word.
...
*[View on Apple Developer](https://developer.apple.com/documentation/sensorkit/srkeyboardmetrics/deletetodeletes)*