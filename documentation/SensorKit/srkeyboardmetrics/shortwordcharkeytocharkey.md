...
```swift
var shortWordCharKeyToCharKey: SRKeyboardMetrics.ProbabilityMetric<UnitDuration> { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/sensorkit/srkeyboardmetrics/shortwordcharkeytocharkey)*