...
```swift
var pathToDelete: SRKeyboardMetrics.ProbabilityMetric<UnitDuration> { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/sensorkit/srkeyboardmetrics/pathtodelete)*