...
```swift
var deleteToShiftKey: SRKeyboardMetrics.ProbabilityMetric<UnitDuration> { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/sensorkit/srkeyboardmetrics/deletetoshiftkey)*