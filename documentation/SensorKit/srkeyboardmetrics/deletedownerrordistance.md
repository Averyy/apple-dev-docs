...
```swift
var deleteDownErrorDistance: SRKeyboardMetrics.ProbabilityMetric<UnitLength> { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/sensorkit/srkeyboardmetrics/deletedownerrordistance)*