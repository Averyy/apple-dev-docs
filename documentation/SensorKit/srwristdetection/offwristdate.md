...
The initial value of the [`offWristDate`](srwristdetection/offwristdate.md) property is the current date and the [`onWristDate`](srwristdetection/onwristdate.md) property is [`nil`](https://developer.apple.com/documentation/ObjectiveC/nil-227m0). The system changes the value of these properties as follows:
...
*[View on Apple Developer](https://developer.apple.com/documentation/sensorkit/srwristdetection/offwristdate)*