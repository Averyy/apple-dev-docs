...
```swift
static var offWrist: SRWristTemperature.Condition { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/sensorkit/srwristtemperature/condition-swift.struct/offwrist)*