...
```swift
attribute mapkit.PointOfInterestFilter mapkit.filterExcludingAllCategories;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/mapkitjs/mapkit/mapkit.filterexcludingallcategories)*