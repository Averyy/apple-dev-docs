...
This property is only available when the [`featureType`](mapkit.mapfeatureannotation/featuretype.md) is [`PointOfInterest`](mapkit.mapfeaturetype/pointofinterest.md) and it contains a [`mapkit.MapFeatureAnnotationGlyphImage`](mapkit.mapfeatureannotationglyphimage.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/mapkitjs/mapkit.mapfeatureannotation/glyphimage)*