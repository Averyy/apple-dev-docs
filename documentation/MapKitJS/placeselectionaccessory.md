...
- [const PlaceSelectionAccessoryStyle](placeselectionaccessorystyle.md)
  The set of styles for configuring how a place selection accessory appears.
### Static properties
- [Styles](placeselectionaccessory/styles.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/mapkitjs/placeselectionaccessory)*