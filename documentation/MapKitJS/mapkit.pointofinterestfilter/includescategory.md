...
boolean includesCategory(
	mapkit.PointOfInterestCategory category
);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/mapkitjs/mapkit.pointofinterestfilter/includescategory)*