...
```swift
dictionary PlaceSelectionAccessoryOptions {
	mapkit.PlaceSelectionAccessory.Styles style;
};
```
...
### Getting properties
- [style](placeselectionaccessoryoptions/style.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/mapkitjs/placeselectionaccessoryoptions)*