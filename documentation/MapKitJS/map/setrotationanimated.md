...
By default, MapKit JS animates the rotation change. This function changes the map’s rotation even if [`isRotationEnabled`](map/isrotationenabled.md) is `false`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/mapkitjs/map/setrotationanimated)*