...
When accessing [`center`](map/center.md), MapKit JS copies the [`Coordinate`](coordinate.md) instance.
...
*[View on Apple Developer](https://developer.apple.com/documentation/mapkitjs/map/center)*