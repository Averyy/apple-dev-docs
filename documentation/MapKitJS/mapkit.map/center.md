...
When accessing [`center`](mapkit.map/center.md), MapKit JS copies the [`mapkit.Coordinate`](mapkit.coordinate/mapkit.coordinate.md) instance.
...
*[View on Apple Developer](https://developer.apple.com/documentation/mapkitjs/mapkit.map/center)*