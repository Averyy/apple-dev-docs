...
```swift
func setAttachment(_ anObject: any Sendable, forKey key: String)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/iosurface/iosurface/setattachment(_:forkey:))*