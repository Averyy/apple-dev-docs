...
For the list of the supported audio formats, see [`append(_:at:)`](shsignaturegenerator/append(_:at:).md).
...
- [static var signatureDurationInvalid: SHError.Code](sherror/signaturedurationinvalid.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/shazamkit/sherror/invalidaudioformat)*