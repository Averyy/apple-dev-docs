...
```swift
static var mediaLibrarySyncFailed: SHError.Code { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/shazamkit/sherror/medialibrarysyncfailed)*