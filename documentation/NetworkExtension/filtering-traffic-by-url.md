...
![A single-window macOS app that represents a running URL filter. A large network badge icon fills most of the space, with text below that reads Running. At the bottom of the window there are two buttons: Disable and Configure. The Configure button is tinted to indicate it’s the default.](https://docs-assets.developer.apple.com/published/3304d396dd2b88732405a3a658382363/filtering-traffic-by-url-01%402x.png)
