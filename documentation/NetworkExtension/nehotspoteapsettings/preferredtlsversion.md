...
Optional. For possible values see [`NEHotspotEAPSettings.TLSVersion`](nehotspoteapsettings/tlsversion.md). The default value is Version 1.2.
...
*[View on Apple Developer](https://developer.apple.com/documentation/networkextension/nehotspoteapsettings/preferredtlsversion)*