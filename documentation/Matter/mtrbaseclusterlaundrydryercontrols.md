...
- [func writeAttributeSelectedDrynessLevel(withValue: NSNumber?, completion: MTRStatusCompletion)](mtrbaseclusterlaundrydryercontrols/writeattributeselecteddrynesslevel(withvalue:completion:).md)
- [func writeAttributeSelectedDrynessLevel(withValue: NSNumber?, params: MTRWriteParams?, completion: MTRStatusCompletion)](mtrbaseclusterlaundrydryercontrols/writeattributeselecteddrynesslevel(withvalue:params:completion:).md)
### Type Methods
