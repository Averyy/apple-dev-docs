...
- [func writeAttributeNodeLabel(withValue: String, completion: ((any Error)?) -> Void)](mtrbaseclusterbridgeddevicebasicinformation/writeattributenodelabel(withvalue:completion:).md)
- [func writeAttributeNodeLabel(withValue: String, params: MTRWriteParams?, completion: ((any Error)?) -> Void)](mtrbaseclusterbridgeddevicebasicinformation/writeattributenodelabel(withvalue:params:completion:).md)
- [func keepActive(with: MTRBridgedDeviceBasicInformationClusterKeepActiveParams, completion: ((any Error)?) -> Void)](mtrbaseclusterbridgeddevicebasicinformation/keepactive(with:completion:).md)
  Command KeepActive
