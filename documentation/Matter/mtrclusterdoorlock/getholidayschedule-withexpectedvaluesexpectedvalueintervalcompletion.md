...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclusterdoorlock/getholidayschedule(with:expectedvalues:expectedvalueinterval:completion:))*