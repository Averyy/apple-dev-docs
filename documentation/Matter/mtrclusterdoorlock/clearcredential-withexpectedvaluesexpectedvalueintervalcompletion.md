...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclusterdoorlock/clearcredential(with:expectedvalues:expectedvalueinterval:completion:))*