...
- [func writeAttributeSupportedStreamingProtocols(withValue: NSNumber, completion: ((any Error)?) -> Void)](mtrbaseclustercontentlauncher/writeattributesupportedstreamingprotocols(withvalue:completion:).md)
- [func writeAttributeSupportedStreamingProtocols(withValue: NSNumber, completionHandler: ((any Error)?) -> Void)](mtrbaseclustercontentlauncher/writeattributesupportedstreamingprotocols(withvalue:completionhandler:).md)
- [func writeAttributeSupportedStreamingProtocols(withValue: NSNumber, params: MTRWriteParams?, completion: ((any Error)?) -> Void)](mtrbaseclustercontentlauncher/writeattributesupportedstreamingprotocols(withvalue:params:completion:).md)
- [func writeAttributeSupportedStreamingProtocols(withValue: NSNumber, params: MTRWriteParams?, completionHandler: ((any Error)?) -> Void)](mtrbaseclustercontentlauncher/writeattributesupportedstreamingprotocols(withvalue:params:completionhandler:).md)
### Type Methods
