# seek(with:expectedValues:expectedValueInterval:completionHandler:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclustermediaplayback/seek(with:expectedvalues:expectedvalueinterval:completionhandler:))*