...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclustermediainput/renameinput(with:expectedvalues:expectedvalueinterval:completion:))*