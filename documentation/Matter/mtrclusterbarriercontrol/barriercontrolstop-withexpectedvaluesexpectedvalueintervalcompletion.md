...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclusterbarriercontrol/barriercontrolstop(withexpectedvalues:expectedvalueinterval:completion:))*