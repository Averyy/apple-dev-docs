...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrbaseclustervalveconfigurationandcontrol/readattributedefaultopenlevel(withclusterstatecache:endpoint:queue:completion:))*