...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclustercommissionercontrol/commissionnode(with:expectedvalues:expectedvalueinterval:completion:))*