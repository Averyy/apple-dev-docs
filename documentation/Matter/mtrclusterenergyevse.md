...
### Instance Methods
- [func clearTargets(with: MTREnergyEVSEClusterClearTargetsParams?, expectedValues: [[String : Any]]?, expectedValueInterval: NSNumber?, completion: MTRStatusCompletion)](mtrclusterenergyevse/cleartargets(with:expectedvalues:expectedvalueinterval:completion:).md)
- [func clearTargets(withExpectedValues: [[String : Any]]?, expectedValueInterval: NSNumber?, completion: MTRStatusCompletion)](mtrclusterenergyevse/cleartargets(withexpectedvalues:expectedvalueinterval:completion:).md)
- [func disable(with: MTREnergyEVSEClusterDisableParams?, expectedValues: [[String : Any]]?, expectedValueInterval: NSNumber?, completion: MTRStatusCompletion)](mtrclusterenergyevse/disable(with:expectedvalues:expectedvalueinterval:completion:).md)
- [func disable(withExpectedValues: [[String : Any]]?, expectedValueInterval: NSNumber?, completion: MTRStatusCompletion)](mtrclusterenergyevse/disable(withexpectedvalues:expectedvalueinterval:completion:).md)
- [func enableCharging(with: MTREnergyEVSEClusterEnableChargingParams, expectedValues: [[String : Any]]?, expectedValueInterval: NSNumber?, completion: MTRStatusCompletion)](mtrclusterenergyevse/enablecharging(with:expectedvalues:expectedvalueinterval:completion:).md)
...
- [func setTargetsWith(MTREnergyEVSEClusterSetTargetsParams, expectedValues: [[String : Any]]?, expectedValueInterval: NSNumber?, completion: MTRStatusCompletion)](mtrclusterenergyevse/settargetswith(_:expectedvalues:expectedvalueinterval:completion:).md)
- [func startDiagnostics(with: MTREnergyEVSEClusterStartDiagnosticsParams?, expectedValues: [[String : Any]]?, expectedValueInterval: NSNumber?, completion: MTRStatusCompletion)](mtrclusterenergyevse/startdiagnostics(with:expectedvalues:expectedvalueinterval:completion:).md)
- [func startDiagnostics(withExpectedValues: [[String : Any]]?, expectedValueInterval: NSNumber?, completion: MTRStatusCompletion)](mtrclusterenergyevse/startdiagnostics(withexpectedvalues:expectedvalueinterval:completion:).md)
