...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclustercolorcontrol/colorloopset(with:expectedvalues:expectedvalueinterval:completion:))*