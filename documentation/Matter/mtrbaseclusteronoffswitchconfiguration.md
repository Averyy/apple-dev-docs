...
- [func writeAttributeSwitchActions(withValue: NSNumber, completion: MTRStatusCompletion)](mtrbaseclusteronoffswitchconfiguration/writeattributeswitchactions(withvalue:completion:).md)
- [func writeAttributeSwitchActions(withValue: NSNumber, completionHandler: MTRStatusCompletion)](mtrbaseclusteronoffswitchconfiguration/writeattributeswitchactions(withvalue:completionhandler:).md)
- [func writeAttributeSwitchActions(withValue: NSNumber, params: MTRWriteParams?, completion: MTRStatusCompletion)](mtrbaseclusteronoffswitchconfiguration/writeattributeswitchactions(withvalue:params:completion:).md)
- [func writeAttributeSwitchActions(withValue: NSNumber, params: MTRWriteParams?, completionHandler: MTRStatusCompletion)](mtrbaseclusteronoffswitchconfiguration/writeattributeswitchactions(withvalue:params:completionhandler:).md)
### Type Methods
