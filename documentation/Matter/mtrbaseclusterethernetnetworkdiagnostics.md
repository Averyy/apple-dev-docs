...
- [func resetCounts(completion: MTRStatusCompletion)](mtrbaseclusterethernetnetworkdiagnostics/resetcounts(completion:).md)
- [func resetCounts(completionHandler: MTRStatusCompletion)](mtrbaseclusterethernetnetworkdiagnostics/resetcounts(completionhandler:).md)
- [func resetCounts(with: MTREthernetNetworkDiagnosticsClusterResetCountsParams?, completion: MTRStatusCompletion)](mtrbaseclusterethernetnetworkdiagnostics/resetcounts(with:completion:).md)
- [func resetCounts(with: MTREthernetNetworkDiagnosticsClusterResetCountsParams?, completionHandler: MTRStatusCompletion)](mtrbaseclusterethernetnetworkdiagnostics/resetcounts(with:completionhandler:).md)
