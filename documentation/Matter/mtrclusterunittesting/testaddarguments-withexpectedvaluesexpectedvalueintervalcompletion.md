...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclusterunittesting/testaddarguments(with:expectedvalues:expectedvalueinterval:completion:))*