...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclusterunittesting/testemittesteventrequest(with:expectedvalues:expectedvalueinterval:completion:))*