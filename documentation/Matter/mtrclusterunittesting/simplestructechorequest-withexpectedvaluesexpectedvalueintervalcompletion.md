...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclusterunittesting/simplestructechorequest(with:expectedvalues:expectedvalueinterval:completion:))*