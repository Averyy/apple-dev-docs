...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclusterdeviceenergymanagement/requestconstraintbasedforecast(with:expectedvalues:expectedvalueinterval:completion:))*