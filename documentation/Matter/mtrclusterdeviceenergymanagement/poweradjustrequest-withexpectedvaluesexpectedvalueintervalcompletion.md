...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclusterdeviceenergymanagement/poweradjustrequest(with:expectedvalues:expectedvalueinterval:completion:))*