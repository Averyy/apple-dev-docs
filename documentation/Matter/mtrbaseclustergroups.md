...
- [func addGroupIfIdentifying(with: MTRGroupsClusterAddGroupIfIdentifyingParams, completion: MTRStatusCompletion)](mtrbaseclustergroups/addgroupifidentifying(with:completion:).md)
- [func addGroupIfIdentifying(with: MTRGroupsClusterAddGroupIfIdentifyingParams, completionHandler: MTRStatusCompletion)](mtrbaseclustergroups/addgroupifidentifying(with:completionhandler:).md)
...
- [func removeAllGroups(completion: MTRStatusCompletion)](mtrbaseclustergroups/removeallgroups(completion:).md)
- [func removeAllGroups(completionHandler: MTRStatusCompletion)](mtrbaseclustergroups/removeallgroups(completionhandler:).md)
- [func removeAllGroups(with: MTRGroupsClusterRemoveAllGroupsParams?, completion: MTRStatusCompletion)](mtrbaseclustergroups/removeallgroups(with:completion:).md)
- [func removeAllGroups(with: MTRGroupsClusterRemoveAllGroupsParams?, completionHandler: MTRStatusCompletion)](mtrbaseclustergroups/removeallgroups(with:completionhandler:).md)
