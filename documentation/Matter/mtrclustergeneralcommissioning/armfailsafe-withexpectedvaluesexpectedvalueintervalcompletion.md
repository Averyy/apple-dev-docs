...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclustergeneralcommissioning/armfailsafe(with:expectedvalues:expectedvalueinterval:completion:))*