...
### Instance Methods
- [func openBasicCommissioningWindow(with: MTRAdministratorCommissioningClusterOpenBasicCommissioningWindowParams, completion: MTRStatusCompletion)](mtrbaseclusteradministratorcommissioning/openbasiccommissioningwindow(with:completion:).md)
- [func openBasicCommissioningWindow(with: MTRAdministratorCommissioningClusterOpenBasicCommissioningWindowParams, completionHandler: MTRStatusCompletion)](mtrbaseclusteradministratorcommissioning/openbasiccommissioningwindow(with:completionhandler:).md)
- [func openWindow(with: MTRAdministratorCommissioningClusterOpenCommissioningWindowParams, completion: MTRStatusCompletion)](mtrbaseclusteradministratorcommissioning/openwindow(with:completion:).md)
- [func openWindow(with: MTRAdministratorCommissioningClusterOpenCommissioningWindowParams, completionHandler: MTRStatusCompletion)](mtrbaseclusteradministratorcommissioning/openwindow(with:completionhandler:).md)
...
- [func revokeCommissioning(completion: MTRStatusCompletion)](mtrbaseclusteradministratorcommissioning/revokecommissioning(completion:).md)
- [func revokeCommissioning(completionHandler: MTRStatusCompletion)](mtrbaseclusteradministratorcommissioning/revokecommissioning(completionhandler:).md)
- [func revokeCommissioning(with: MTRAdministratorCommissioningClusterRevokeCommissioningParams?, completion: MTRStatusCompletion)](mtrbaseclusteradministratorcommissioning/revokecommissioning(with:completion:).md)
- [func revokeCommissioning(with: MTRAdministratorCommissioningClusterRevokeCommissioningParams?, completionHandler: MTRStatusCompletion)](mtrbaseclusteradministratorcommissioning/revokecommissioning(with:completionhandler:).md)
