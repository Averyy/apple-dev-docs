...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclusterrvcoperationalstate/gohome(withexpectedvalues:expectedvalueinterval:completion:))*