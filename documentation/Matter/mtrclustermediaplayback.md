...
- [func activateAudioTrack(with: MTRMediaPlaybackClusterActivateAudioTrackParams, expectedValues: [[String : Any]]?, expectedValueInterval: NSNumber?, completion: ((any Error)?) -> Void)](mtrclustermediaplayback/activateaudiotrack(with:expectedvalues:expectedvalueinterval:completion:).md)
- [func activateTextTrack(with: MTRMediaPlaybackClusterActivateTextTrackParams, expectedValues: [[String : Any]]?, expectedValueInterval: NSNumber?, completion: ((any Error)?) -> Void)](mtrclustermediaplayback/activatetexttrack(with:expectedvalues:expectedvalueinterval:completion:).md)
- [func deactivateTextTrack(with: MTRMediaPlaybackClusterDeactivateTextTrackParams?, expectedValues: [[String : Any]]?, expectedValueInterval: NSNumber?, completion: ((any Error)?) -> Void)](mtrclustermediaplayback/deactivatetexttrack(with:expectedvalues:expectedvalueinterval:completion:).md)
- [func deactivateTextTrack(withExpectedValues: [[String : Any]]?, expectedValueInterval: NSNumber?, completion: ((any Error)?) -> Void)](mtrclustermediaplayback/deactivatetexttrack(withexpectedvalues:expectedvalueinterval:completion:).md)
