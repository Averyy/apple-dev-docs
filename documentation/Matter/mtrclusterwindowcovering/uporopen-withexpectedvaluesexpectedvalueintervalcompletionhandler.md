...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclusterwindowcovering/uporopen(withexpectedvalues:expectedvalueinterval:completionhandler:))*