...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclustericdmanagement/stayactiverequest(with:expectedvalues:expectedvalueinterval:completion:))*