...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclustergeneraldiagnostics/payloadtestrequest(with:expectedvalues:expectedvalueinterval:completion:))*