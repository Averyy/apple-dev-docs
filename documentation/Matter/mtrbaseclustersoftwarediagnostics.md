...
- [func resetWatermarks(completion: ((any Error)?) -> Void)](mtrbaseclustersoftwarediagnostics/resetwatermarks(completion:).md)
- [func resetWatermarks(completionHandler: ((any Error)?) -> Void)](mtrbaseclustersoftwarediagnostics/resetwatermarks(completionhandler:).md)
- [func resetWatermarks(with: MTRSoftwareDiagnosticsClusterResetWatermarksParams?, completion: ((any Error)?) -> Void)](mtrbaseclustersoftwarediagnostics/resetwatermarks(with:completion:).md)
- [func resetWatermarks(with: MTRSoftwareDiagnosticsClusterResetWatermarksParams?, completionHandler: ((any Error)?) -> Void)](mtrbaseclustersoftwarediagnostics/resetwatermarks(with:completionhandler:).md)
