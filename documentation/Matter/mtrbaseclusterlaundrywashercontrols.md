...
- [func writeAttributeNumberOfRinses(withValue: NSNumber, completion: MTRStatusCompletion)](mtrbaseclusterlaundrywashercontrols/writeattributenumberofrinses(withvalue:completion:).md)
- [func writeAttributeNumberOfRinses(withValue: NSNumber, params: MTRWriteParams?, completion: MTRStatusCompletion)](mtrbaseclusterlaundrywashercontrols/writeattributenumberofrinses(withvalue:params:completion:).md)
- [func writeAttributeSpinSpeedCurrent(withValue: NSNumber?, completion: MTRStatusCompletion)](mtrbaseclusterlaundrywashercontrols/writeattributespinspeedcurrent(withvalue:completion:).md)
- [func writeAttributeSpinSpeedCurrent(withValue: NSNumber?, params: MTRWriteParams?, completion: MTRStatusCompletion)](mtrbaseclusterlaundrywashercontrols/writeattributespinspeedcurrent(withvalue:params:completion:).md)
### Type Methods
