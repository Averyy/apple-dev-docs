...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclusterkeypadinput/sendkey(with:expectedvalues:expectedvalueinterval:completion:))*