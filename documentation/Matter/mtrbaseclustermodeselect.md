...
### Instance Methods
- [func changeToMode(with: MTRModeSelectClusterChangeToModeParams, completion: MTRStatusCompletion)](mtrbaseclustermodeselect/changetomode(with:completion:).md)
- [func changeToMode(with: MTRModeSelectClusterChangeToModeParams, completionHandler: MTRStatusCompletion)](mtrbaseclustermodeselect/changetomode(with:completionhandler:).md)
...
- [func writeAttributeOnMode(withValue: NSNumber?, completion: MTRStatusCompletion)](mtrbaseclustermodeselect/writeattributeonmode(withvalue:completion:).md)
- [func writeAttributeOnMode(withValue: NSNumber?, completionHandler: MTRStatusCompletion)](mtrbaseclustermodeselect/writeattributeonmode(withvalue:completionhandler:).md)
- [func writeAttributeOnMode(withValue: NSNumber?, params: MTRWriteParams?, completion: MTRStatusCompletion)](mtrbaseclustermodeselect/writeattributeonmode(withvalue:params:completion:).md)
- [func writeAttributeOnMode(withValue: NSNumber?, params: MTRWriteParams?, completionHandler: MTRStatusCompletion)](mtrbaseclustermodeselect/writeattributeonmode(withvalue:params:completionhandler:).md)
- [func writeAttributeStartUpMode(withValue: NSNumber?, completion: MTRStatusCompletion)](mtrbaseclustermodeselect/writeattributestartupmode(withvalue:completion:).md)
- [func writeAttributeStartUpMode(withValue: NSNumber?, completionHandler: MTRStatusCompletion)](mtrbaseclustermodeselect/writeattributestartupmode(withvalue:completionhandler:).md)
- [func writeAttributeStartUpMode(withValue: NSNumber?, params: MTRWriteParams?, completion: MTRStatusCompletion)](mtrbaseclustermodeselect/writeattributestartupmode(withvalue:params:completion:).md)
- [func writeAttributeStartUpMode(withValue: NSNumber?, params: MTRWriteParams?, completionHandler: MTRStatusCompletion)](mtrbaseclustermodeselect/writeattributestartupmode(withvalue:params:completionhandler:).md)
### Type Methods
