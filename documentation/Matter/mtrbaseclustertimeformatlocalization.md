...
- [func writeAttributeActiveCalendarType(withValue: NSNumber, completion: ((any Error)?) -> Void)](mtrbaseclustertimeformatlocalization/writeattributeactivecalendartype(withvalue:completion:).md)
- [func writeAttributeActiveCalendarType(withValue: NSNumber, completionHandler: ((any Error)?) -> Void)](mtrbaseclustertimeformatlocalization/writeattributeactivecalendartype(withvalue:completionhandler:).md)
- [func writeAttributeActiveCalendarType(withValue: NSNumber, params: MTRWriteParams?, completion: ((any Error)?) -> Void)](mtrbaseclustertimeformatlocalization/writeattributeactivecalendartype(withvalue:params:completion:).md)
- [func writeAttributeActiveCalendarType(withValue: NSNumber, params: MTRWriteParams?, completionHandler: ((any Error)?) -> Void)](mtrbaseclustertimeformatlocalization/writeattributeactivecalendartype(withvalue:params:completionhandler:).md)
- [func writeAttributeHourFormat(withValue: NSNumber, completion: ((any Error)?) -> Void)](mtrbaseclustertimeformatlocalization/writeattributehourformat(withvalue:completion:).md)
- [func writeAttributeHourFormat(withValue: NSNumber, completionHandler: ((any Error)?) -> Void)](mtrbaseclustertimeformatlocalization/writeattributehourformat(withvalue:completionhandler:).md)
- [func writeAttributeHourFormat(withValue: NSNumber, params: MTRWriteParams?, completion: ((any Error)?) -> Void)](mtrbaseclustertimeformatlocalization/writeattributehourformat(withvalue:params:completion:).md)
- [func writeAttributeHourFormat(withValue: NSNumber, params: MTRWriteParams?, completionHandler: ((any Error)?) -> Void)](mtrbaseclustertimeformatlocalization/writeattributehourformat(withvalue:params:completionhandler:).md)
### Type Methods
