...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrbaseclusterpowersource/readattributefeaturemap(withclusterstatecache:endpoint:queue:completion:))*