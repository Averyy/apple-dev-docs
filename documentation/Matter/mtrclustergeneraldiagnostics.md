...
- [func testEventTrigger(with: MTRGeneralDiagnosticsClusterTestEventTriggerParams, expectedValues: [[String : Any]]?, expectedValueInterval: NSNumber?, completion: MTRStatusCompletion)](mtrclustergeneraldiagnostics/testeventtrigger(with:expectedvalues:expectedvalueinterval:completion:).md)
- [func testEventTrigger(with: MTRGeneralDiagnosticsClusterTestEventTriggerParams, expectedValues: [[String : Any]]?, expectedValueInterval: NSNumber?, completionHandler: MTRStatusCompletion)](mtrclustergeneraldiagnostics/testeventtrigger(with:expectedvalues:expectedvalueinterval:completionhandler:).md)
