...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrbaseclusteroperationalstate/readattributeoperationalerror(withclusterstatecache:endpoint:queue:completion:))*