...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclustertestcluster/testemittestfabricscopedeventrequest(with:expectedvalues:expectedvalueinterval:completionhandler:))*