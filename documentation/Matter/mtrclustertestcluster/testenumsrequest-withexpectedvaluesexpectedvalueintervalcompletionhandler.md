# testEnumsRequest(with:expectedValues:expectedValueInterval:completionHandler:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclustertestcluster/testenumsrequest(with:expectedvalues:expectedvalueinterval:completionhandler:))*