...
### Instance Methods
- [func identify(with: MTRIdentifyClusterIdentifyParams, completion: ((any Error)?) -> Void)](mtrbaseclusteridentify/identify(with:completion:).md)
- [func identify(with: MTRIdentifyClusterIdentifyParams, completionHandler: ((any Error)?) -> Void)](mtrbaseclusteridentify/identify(with:completionhandler:).md)
...
- [func triggerEffect(with: MTRIdentifyClusterTriggerEffectParams, completion: ((any Error)?) -> Void)](mtrbaseclusteridentify/triggereffect(with:completion:).md)
- [func triggerEffect(with: MTRIdentifyClusterTriggerEffectParams, completionHandler: ((any Error)?) -> Void)](mtrbaseclusteridentify/triggereffect(with:completionhandler:).md)
- [func writeAttributeIdentifyTime(withValue: NSNumber, completion: ((any Error)?) -> Void)](mtrbaseclusteridentify/writeattributeidentifytime(withvalue:completion:).md)
- [func writeAttributeIdentifyTime(withValue: NSNumber, completionHandler: ((any Error)?) -> Void)](mtrbaseclusteridentify/writeattributeidentifytime(withvalue:completionhandler:).md)
- [func writeAttributeIdentifyTime(withValue: NSNumber, params: MTRWriteParams?, completion: ((any Error)?) -> Void)](mtrbaseclusteridentify/writeattributeidentifytime(withvalue:params:completion:).md)
- [func writeAttributeIdentifyTime(withValue: NSNumber, params: MTRWriteParams?, completionHandler: ((any Error)?) -> Void)](mtrbaseclusteridentify/writeattributeidentifytime(withvalue:params:completionhandler:).md)
### Type Methods
