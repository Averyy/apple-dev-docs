...
- [func sleep(completion: MTRStatusCompletion)](mtrbaseclusterlowpower/sleep(completion:).md)
- [func sleep(completionHandler: MTRStatusCompletion)](mtrbaseclusterlowpower/sleep(completionhandler:).md)
- [func sleep(with: MTRLowPowerClusterSleepParams?, completion: MTRStatusCompletion)](mtrbaseclusterlowpower/sleep(with:completion:).md)
- [func sleep(with: MTRLowPowerClusterSleepParams?, completionHandler: MTRStatusCompletion)](mtrbaseclusterlowpower/sleep(with:completionhandler:).md)
