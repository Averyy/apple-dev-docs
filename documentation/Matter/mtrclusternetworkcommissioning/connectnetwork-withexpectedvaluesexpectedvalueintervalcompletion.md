...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclusternetworkcommissioning/connectnetwork(with:expectedvalues:expectedvalueinterval:completion:))*