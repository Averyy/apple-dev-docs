# reorderNetwork(with:expectedValues:expectedValueInterval:completion:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclusternetworkcommissioning/reordernetwork(with:expectedvalues:expectedvalueinterval:completion:))*