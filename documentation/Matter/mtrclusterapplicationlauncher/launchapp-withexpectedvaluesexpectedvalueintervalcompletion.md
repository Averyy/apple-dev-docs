...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclusterapplicationlauncher/launchapp(withexpectedvalues:expectedvalueinterval:completion:))*