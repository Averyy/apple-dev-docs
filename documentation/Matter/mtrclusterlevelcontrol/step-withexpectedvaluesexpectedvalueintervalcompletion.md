...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclusterlevelcontrol/step(with:expectedvalues:expectedvalueinterval:completion:))*