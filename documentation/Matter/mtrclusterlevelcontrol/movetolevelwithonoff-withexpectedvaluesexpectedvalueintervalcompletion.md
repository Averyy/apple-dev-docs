...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclusterlevelcontrol/movetolevelwithonoff(with:expectedvalues:expectedvalueinterval:completion:))*