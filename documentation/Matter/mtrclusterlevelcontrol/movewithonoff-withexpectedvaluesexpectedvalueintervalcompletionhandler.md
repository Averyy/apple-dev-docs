...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclusterlevelcontrol/movewithonoff(with:expectedvalues:expectedvalueinterval:completionhandler:))*