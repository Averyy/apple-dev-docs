...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclusterlevelcontrol/move(with:expectedvalues:expectedvalueinterval:completion:))*