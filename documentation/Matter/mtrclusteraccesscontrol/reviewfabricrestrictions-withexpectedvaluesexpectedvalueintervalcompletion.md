...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclusteraccesscontrol/reviewfabricrestrictions(with:expectedvalues:expectedvalueinterval:completion:))*