...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrbaseclusterunittesting/readattributeoctetstring(withclusterstatecache:endpoint:queue:completion:))*