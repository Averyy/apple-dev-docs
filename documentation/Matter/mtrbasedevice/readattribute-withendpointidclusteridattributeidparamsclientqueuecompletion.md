...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrbasedevice/readattribute(withendpointid:clusterid:attributeid:params:clientqueue:completion:))*