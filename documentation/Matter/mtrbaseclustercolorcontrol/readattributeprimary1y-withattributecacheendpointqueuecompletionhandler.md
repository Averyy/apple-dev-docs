...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrbaseclustercolorcontrol/readattributeprimary1y(withattributecache:endpoint:queue:completionhandler:))*