...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclusteroperationalcredentials/updatefabriclabel(with:expectedvalues:expectedvalueinterval:completionhandler:))*