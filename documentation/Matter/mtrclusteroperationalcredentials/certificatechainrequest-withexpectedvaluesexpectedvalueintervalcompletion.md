# certificateChainRequest(with:expectedValues:expectedValueInterval:completion:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclusteroperationalcredentials/certificatechainrequest(with:expectedvalues:expectedvalueinterval:completion:))*