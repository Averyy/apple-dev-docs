...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclusteroperationalcredentials/removefabric(with:expectedvalues:expectedvalueinterval:completionhandler:))*