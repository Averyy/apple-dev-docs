...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclusteroperationalcredentials/updatenoc(with:expectedvalues:expectedvalueinterval:completionhandler:))*