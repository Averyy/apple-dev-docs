...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclusteroperationalcredentials/addtrustedrootcertificate(with:expectedvalues:expectedvalueinterval:completion:))*