...
- [func invokeCommand(withEndpointID: NSNumber, clusterID: NSNumber, commandID: NSNumber, commandFields: [String : Any]?, expectedValues: [[String : Any]]?, expectedValueInterval: NSNumber?, queue: dispatch_queue_t, completion: ([[String : Any]]?, (any Error)?) -> Void)](mtrdevice/invokecommand(withendpointid:clusterid:commandid:commandfields:expectedvalues:expectedvalueinterval:queue:completion:).md)
- [func invokeCommand(withEndpointID: NSNumber, clusterID: NSNumber, commandID: NSNumber, commandFields: Any, expectedValues: [[String : Any]]?, expectedValueInterval: NSNumber?, timedInvokeTimeout: NSNumber?, clientQueue: dispatch_queue_t, completion: ([[String : Any]]?, (any Error)?) -> Void)](mtrdevice/invokecommand(withendpointid:clusterid:commandid:commandfields:expectedvalues:expectedvalueinterval:timedinvoketimeout:clientqueue:completion:).md)
- [func invokeCommand(withEndpointID: NSNumber, clusterID: NSNumber, commandID: NSNumber, commandFields: Any, expectedValues: [[String : Any]]?, expectedValueInterval: NSNumber?, timedInvokeTimeout: NSNumber?, queue: dispatch_queue_t, completion: ([[String : Any]]?, (any Error)?) -> Void)](mtrdevice/invokecommand(withendpointid:clusterid:commandid:commandfields:expectedvalues:expectedvalueinterval:timedinvoketimeout:queue:completion:).md)
- [func openCommissioningWindow(withDiscriminator: NSNumber, duration: NSNumber, queue: dispatch_queue_t, completion: (MTRSetupPayload?, (any Error)?) -> Void)](mtrdevice/opencommissioningwindow(withdiscriminator:duration:queue:completion:).md)
- [func openCommissioningWindow(withSetupPasscode: NSNumber, discriminator: NSNumber, duration: NSNumber, queue: dispatch_queue_t, completion: (MTRSetupPayload?, (any Error)?) -> Void)](mtrdevice/opencommissioningwindow(withsetuppasscode:discriminator:duration:queue:completion:).md)
...
- [func invokeCommands([[MTRCommandWithRequiredResponse]], queue: dispatch_queue_t, completion: ([[String : Any]]?, (any Error)?) -> Void)](mtrdevice/invokecommands(_:queue:completion:).md)
