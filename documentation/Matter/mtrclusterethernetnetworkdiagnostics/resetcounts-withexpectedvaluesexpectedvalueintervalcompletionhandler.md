...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclusterethernetnetworkdiagnostics/resetcounts(withexpectedvalues:expectedvalueinterval:completionhandler:))*