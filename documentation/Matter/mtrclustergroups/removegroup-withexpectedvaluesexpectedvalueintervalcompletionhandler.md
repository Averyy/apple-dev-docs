...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclustergroups/removegroup(with:expectedvalues:expectedvalueinterval:completionhandler:))*