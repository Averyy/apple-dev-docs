...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclustertimesynchronization/setutctimewith(_:expectedvalues:expectedvalueinterval:completion:))*