...
*[View on Apple Developer](https://developer.apple.com/documentation/matter/mtrclusterbooleanstateconfiguration/suppressalarm(with:expectedvalues:expectedvalueinterval:completion:))*