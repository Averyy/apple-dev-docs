...
### Instance Methods
- [func hideStatus(completion: MTRStatusCompletion)](mtrbaseclustermediainput/hidestatus(completion:).md)
- [func hideStatus(completionHandler: MTRStatusCompletion)](mtrbaseclustermediainput/hidestatus(completionhandler:).md)
- [func hideStatus(with: MTRMediaInputClusterHideInputStatusParams?, completion: MTRStatusCompletion)](mtrbaseclustermediainput/hidestatus(with:completion:).md)
- [func hideStatus(with: MTRMediaInputClusterHideInputStatusParams?, completionHandler: MTRStatusCompletion)](mtrbaseclustermediainput/hidestatus(with:completionhandler:).md)
...
- [func renameInput(with: MTRMediaInputClusterRenameInputParams, completion: MTRStatusCompletion)](mtrbaseclustermediainput/renameinput(with:completion:).md)
- [func renameInput(with: MTRMediaInputClusterRenameInputParams, completionHandler: MTRStatusCompletion)](mtrbaseclustermediainput/renameinput(with:completionhandler:).md)
- [func select(with: MTRMediaInputClusterSelectInputParams, completion: MTRStatusCompletion)](mtrbaseclustermediainput/select(with:completion:).md)
- [func select(with: MTRMediaInputClusterSelectInputParams, completionHandler: MTRStatusCompletion)](mtrbaseclustermediainput/select(with:completionhandler:).md)
- [func showStatus(completion: MTRStatusCompletion)](mtrbaseclustermediainput/showstatus(completion:).md)
- [func showStatus(completionHandler: MTRStatusCompletion)](mtrbaseclustermediainput/showstatus(completionhandler:).md)
- [func showStatus(with: MTRMediaInputClusterShowInputStatusParams?, completion: MTRStatusCompletion)](mtrbaseclustermediainput/showstatus(with:completion:).md)
- [func showStatus(with: MTRMediaInputClusterShowInputStatusParams?, completionHandler: MTRStatusCompletion)](mtrbaseclustermediainput/showstatus(with:completionhandler:).md)
