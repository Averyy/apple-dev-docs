...
| [`Audio Toolbox`](https://developer.apple.com/documentation/audiotoolbox) | Create and modify audio in any app that uses sound, including music production apps such as GarageBand or Logic Pro X. | ✅ | ✅ |  | ✅ |  |
