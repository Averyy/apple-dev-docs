...
When you need to [`Translating text within your app`](https://developer.apple.com/documentation/Translation/translating-text-within-your-app) in your app, use a translation session directly. The system provides a session automatically when you attach the translation modifier to your view, and allows for performing a single translation or a [`translate(batch:)`](https://developer.apple.com/documentation/Translation/TranslationSession/translate(batch:)) to translate several strings at once.
