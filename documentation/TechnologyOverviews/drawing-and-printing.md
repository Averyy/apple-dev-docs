...
![An illustration that shows two images drawn together in two different ways. The drawing order of the images changes the final output that appears onscreen.](/images/com.apple.TechnologyOverviews/drawing-order.png)
