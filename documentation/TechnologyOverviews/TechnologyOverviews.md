...
Consult the [`Apple Developer Documentation`](https://developer.apple.comhttps://developer.apple.com/documentation/) for in-depth information about individual technologies. The developer documentation includes API reference, articles, sample code, and tutorials to help you learn how to use a given technology. It also offers guidance about the best way to solve specific challenges.

## Topics

### Get started
- [App design and UI](app-design-and-ui.md)
...
- [Core experiences](core-experiences.md)
  Embrace features that improve people’s experience with your app on Apple devices.
- [Apple Intelligence and machine learning](ai-machine-learning.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/TechnologyOverviews)*