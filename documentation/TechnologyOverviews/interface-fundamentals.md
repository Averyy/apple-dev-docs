...
-  are a [`VolumetricWindowStyle`](https://developer.apple.com/documentation/SwiftUI/VolumetricWindowStyle) of window that you use to [`Adding 3D content to your app`](https://developer.apple.com/documentation/visionOS/adding-3d-content-to-your-app#Display-3D-content-in-a-volume) in visionOS.
