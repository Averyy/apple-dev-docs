...
- *Volumes* are a [`VolumetricWindowStyle`](https://developer.apple.com/documentation/swiftui/volumetricwindowstyle) of window that you use to [`Adding 3D content to your app`](https://developer.apple.com/documentation/visionos/adding-3d-content-to-your-app) in visionOS.
