...
And once you know the type of data your app needs, focus on [`Generating content and performing tasks with Foundation Models`](https://developer.apple.com/documentation/FoundationModels/generating-content-and-performing-tasks-with-foundation-models) that produce better results. It takes time and practice to craft a good prompt, so try [`LanguageModelSession`](https://developer.apple.com/documentation/FoundationModels/LanguageModelSession) and test the output the model returns.
