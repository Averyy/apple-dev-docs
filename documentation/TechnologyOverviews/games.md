...
Catch mistakes early by setting up a project to remotely build a CMake-based project from within Microsoft Visual Studio on a target Mac system. Use this setup to [`Building your macOS game remotely from your PC`](building-your-macos-game-remotely-from-your-pc.md) from your PC.

## Topics

### New games
- [Game technologies](games-technologies.md)
  Plan the creation of your game and incorporate the gameplay features people expect.
### Porting
- [Building your macOS game remotely from your PC](building-your-macos-game-remotely-from-your-pc.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/technologyoverviews/games)*