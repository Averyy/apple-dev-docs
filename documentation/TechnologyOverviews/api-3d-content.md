...
![A screenshot of a mesh for a 3D model that represents a fish with an aviator cap and goggles.](https://docs-assets.developer.apple.com/published/52fe0b4e8e5d899c61974f9714f98214/3d-content-3d-objects.png)
...
![A screenshot of a scene in Reality Composer Pro. The scene depicts a desert landscape with a rock formation. The editor window shows the objects that comprise the scene. ](https://docs-assets.developer.apple.com/published/b8a4f1ce858c177af6f2cb538a96f6b8/3d-content-rc-pro-screenshot.png)
...
![A screenshot of the Shader Graph editor in Reality Composer Pro. The editor shows a graph of nodes, and wires that manage the flow of data from one node to the next. The result is a texture that you can apply to an object in your 3d scene.](https://docs-assets.developer.apple.com/published/8850a05b32acc5a80613dcc2a35f56e7/3d-content-shader-graph-screenshot.png)
