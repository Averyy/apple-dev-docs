...
- [Spatial and immersive media](immersive-media.md)
  Create immersive video experiences in visionOS.
- [Media streaming](streaming.md)
  Stream audio and video content to a device, or to AirPlay-enabled hardware.


---

*[View on Apple Developer](https://developer.apple.com/documentation/technologyoverviews/audio-and-video)*