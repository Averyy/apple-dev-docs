...
- To [`Authentication Services`](https://developer.apple.com/documentation/AuthenticationServices#Sign-In-with-Apple) from your app, use the [`Authentication Services`](https://developer.apple.com/documentation/AuthenticationServices) framework
