...
Give people the information they need, and help them access it quickly. Make content available from your app and from other parts of the system, such as the [`Home Screen, Lock Screen, or Today view`](https://developer.apple.comhttps://support.apple.com/en-us/118610). Integrate new types of information that are difficult to produce and manage on your own, such as maps or weather information.
...
- [Communication and connection](communication-and-connection.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/technologyoverviews/core-experiences)*