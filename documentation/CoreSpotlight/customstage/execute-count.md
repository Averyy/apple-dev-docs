...
```swift
nonisolated
(nonsending) func execute(count: Int) async throws -> SearchPipelineData
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/corespotlight/customstage/execute(count:))*