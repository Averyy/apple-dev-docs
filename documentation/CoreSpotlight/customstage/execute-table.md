...
```swift
nonisolated
(nonsending) func execute(table: SearchResultsTable) async throws -> SearchPipelineData
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/corespotlight/customstage/execute(table:))*