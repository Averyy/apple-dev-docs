...
```swift
nonisolated
(nonsending) func execute(scoredItems: [ScoredSearchableItem]) async throws -> SearchPipelineData
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/corespotlight/customstage/execute(scoreditems:))*