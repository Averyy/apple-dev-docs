...
```swift
nonisolated
(nonsending) func execute(statisticName: String, value: Double) async throws -> SearchPipelineData
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/corespotlight/customstage/execute(statisticname:value:))*