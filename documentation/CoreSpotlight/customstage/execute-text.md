...
```swift
nonisolated
(nonsending) func execute(text: String) async throws -> SearchPipelineData
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/corespotlight/customstage/execute(text:))*