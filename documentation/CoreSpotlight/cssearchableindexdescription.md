...
- [init?(coder: NSCoder)](cssearchableindexdescription/init(coder:).md)
### Describing the Spotlight index
- [var protectionClass: FileProtectionType?](cssearchableindexdescription/protectionclass.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/corespotlight/cssearchableindexdescription)*