...
```swift
var album: [SearchableItemAttribute]?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/corespotlight/spotlightsearchtool/contentdomain/audio-swift.struct/album)*