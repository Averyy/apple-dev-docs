...
```swift
static func audio(_ config: SpotlightSearchTool.ContentDomain.Audio) -> SpotlightSearchTool.ContentDomain
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/corespotlight/spotlightsearchtool/contentdomain/audio(_:))*