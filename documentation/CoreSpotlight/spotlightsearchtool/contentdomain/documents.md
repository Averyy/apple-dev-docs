...
```swift
static func documents(_ config: SpotlightSearchTool.ContentDomain.Documents) -> SpotlightSearchTool.ContentDomain
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/corespotlight/spotlightsearchtool/contentdomain/documents(_:))*