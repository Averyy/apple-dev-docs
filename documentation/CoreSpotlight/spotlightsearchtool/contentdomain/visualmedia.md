...
```swift
static func visualMedia(_ config: SpotlightSearchTool.ContentDomain.VisualMedia) -> SpotlightSearchTool.ContentDomain
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/corespotlight/spotlightsearchtool/contentdomain/visualmedia(_:))*