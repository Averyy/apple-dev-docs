...
```swift
static func items(_ config: SpotlightSearchTool.ContentDomain.Items) -> SpotlightSearchTool.ContentDomain
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/corespotlight/spotlightsearchtool/contentdomain/items(_:))*