...
```swift
static var items: SpotlightSearchTool.ContentDomain { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/corespotlight/spotlightsearchtool/contentdomain/items-swift.type.property)*