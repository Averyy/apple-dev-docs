...
```swift
static var calendar: SpotlightSearchTool.ContentDomain { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/corespotlight/spotlightsearchtool/contentdomain/calendar-swift.type.property)*