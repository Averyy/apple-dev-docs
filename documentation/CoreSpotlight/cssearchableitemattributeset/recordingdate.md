...
This property contains the original recording date of the song or composition and is supplementary to [`contentCreationDate`](cssearchableitemattributeset/contentcreationdate.md), which indicates the date of an edited or optimized version.
...
*[View on Apple Developer](https://developer.apple.com/documentation/corespotlight/cssearchableitemattributeset/recordingdate)*