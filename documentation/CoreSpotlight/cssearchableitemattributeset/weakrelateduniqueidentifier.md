...
Unlike the similar [`relatedUniqueIdentifier`](cssearchableitemattributeset/relateduniqueidentifier.md) property, this property does not link the lifetime of the item to the lifetime of the activity. In particular, deleting the item does not delete the activity.
...
*[View on Apple Developer](https://developer.apple.com/documentation/corespotlight/cssearchableitemattributeset/weakrelateduniqueidentifier)*