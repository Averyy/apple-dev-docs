...
```swift
var recipientEmailAddresses: [String]? { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/corespotlight/cssearchableitemattributeset/recipientemailaddresses)*