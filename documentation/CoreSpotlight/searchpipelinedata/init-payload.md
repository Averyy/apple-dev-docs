...
- `payload`: The data your custom stage produced as its output. Use the [`SearchPipelineData.Payload`](searchpipelinedata/payload-swift.enum.md) type to construct this value.
...
*[View on Apple Developer](https://developer.apple.com/documentation/corespotlight/searchpipelinedata/init(payload:))*