...
Don’t call this method if you fetch the query results using the [`results`](cssearchquery/results-swift.property.md) property. Accessing that property automatically starts the query.
