...
Possible values for this property are [`complete`](https://developer.apple.com/documentation/foundation/fileprotectiontype/1616200-complete), [`completeUnlessOpen`](https://developer.apple.com/documentation/foundation/fileprotectiontype/1617188-completeunlessopen), and [`completeUntilFirstUserAuthentication`](https://developer.apple.com/documentation/foundation/fileprotectiontype/1616633-completeuntilfirstuserauthentica). By default, the system retrives the data protection class from the `com.apple.developer.default-data-protection` entitlement, if it exists; otherwise, the default value is [`completeUntilFirstUserAuthentication`](https://developer.apple.com/documentation/foundation/fileprotectiontype/1616633-completeuntilfirstuserauthentica).
