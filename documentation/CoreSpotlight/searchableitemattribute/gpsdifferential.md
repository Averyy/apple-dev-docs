...
```swift
static let gpsDifferential: SearchableItemAttribute
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/corespotlight/searchableitemattribute/gpsdifferential)*