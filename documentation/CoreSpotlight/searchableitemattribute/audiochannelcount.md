...
```swift
static let audioChannelCount: SearchableItemAttribute
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/corespotlight/searchableitemattribute/audiochannelcount)*