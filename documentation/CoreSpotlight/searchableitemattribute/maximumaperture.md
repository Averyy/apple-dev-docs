...
```swift
static let maximumAperture: SearchableItemAttribute
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/corespotlight/searchableitemattribute/maximumaperture)*