...
```swift
static let timestamp: SearchableItemAttribute
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/corespotlight/searchableitemattribute/timestamp)*