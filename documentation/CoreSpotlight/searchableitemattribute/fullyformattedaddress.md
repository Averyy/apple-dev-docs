...
```swift
static let fullyFormattedAddress: SearchableItemAttribute
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/corespotlight/searchableitemattribute/fullyformattedaddress)*