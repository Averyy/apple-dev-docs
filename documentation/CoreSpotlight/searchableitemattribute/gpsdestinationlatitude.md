...
```swift
static let gpsDestinationLatitude: SearchableItemAttribute
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/corespotlight/searchableitemattribute/gpsdestinationlatitude)*