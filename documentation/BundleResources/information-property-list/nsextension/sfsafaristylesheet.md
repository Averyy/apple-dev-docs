...
- [Allowed URL Patterns](information-property-list/nsextension/sfsafaristylesheet/allowed-url-patterns.md)
  The webpages that the style sheet can be injected into.
- [Excluded URL Patterns](information-property-list/nsextension/sfsafaristylesheet/excluded-url-patterns.md)
  The webpages that the style sheet can’t be injected into.
### Path
- [Style Sheet](information-property-list/nsextension/sfsafaristylesheet/style-sheet.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/bundleresources/information-property-list/nsextension/sfsafaristylesheet)*