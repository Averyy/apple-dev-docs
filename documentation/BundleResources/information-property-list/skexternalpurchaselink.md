...
Use this information property list key if your app has the [`com.apple.developer.storekit.external-purchase-link`](entitlements/com.apple.developer.storekit.external-purchase-link.md) entitlement and your app has a minimum OS version prior to iOS 17.5, macOS 14.5, watchOS 10.5, tvOS 17.5, or visionOS 1.2. Otherwise, use the [`SKExternalPurchaseMultiLink`](information-property-list/skexternalpurchasemultilink.md) property list key to provide multiple URLs for country codes that allow multiple links.
