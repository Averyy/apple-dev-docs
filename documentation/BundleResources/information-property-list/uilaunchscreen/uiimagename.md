...
If you don’t specify an image, the display shows the background color, as given by the [`UIColorName`](information-property-list/uilaunchscreen/uicolorname.md) key. The background color may also show through any transparency in your image.
...
*[View on Apple Developer](https://developer.apple.com/documentation/bundleresources/information-property-list/uilaunchscreen/uiimagename)*