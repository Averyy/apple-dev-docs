...
Add this entitlement with a value of `true` to your alternative browser engine’s extension that manages HTTP traffic.
...
*[View on Apple Developer](https://developer.apple.com/documentation/bundleresources/entitlements/com.apple.developer.web-browser-engine.networking)*