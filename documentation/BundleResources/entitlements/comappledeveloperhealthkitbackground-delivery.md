...
If this key is [`true`](https://developer.apple.com/documentation/swift/true), your app can enable background delivery of [`HKObserverQuery`](https://developer.apple.com/documentation/HealthKit/HKObserverQuery) instances by calling the HealthKit store’s [`enableBackgroundDelivery(for:frequency:withCompletion:)`](https://developer.apple.com/documentation/healthkit/hkhealthstore/1614175-enablebackgrounddelivery) method. By default, the value is [`false`](https://developer.apple.com/documentation/swift/false).
