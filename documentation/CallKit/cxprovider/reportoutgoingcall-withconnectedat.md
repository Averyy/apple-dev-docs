...
An outgoing call should call this method after calling the [`reportOutgoingCall(with:startedConnectingAt:)`](cxprovider/reportoutgoingcall(with:startedconnectingat:).md) and after the call is connected.
...
*[View on Apple Developer](https://developer.apple.com/documentation/callkit/cxprovider/reportoutgoingcall(with:connectedat:))*