...
> **Note**:  To check at runtime if a particular block of code is running on the main thread, inspect [`isMainThread`](https://developer.apple.com/documentation/Foundation/Thread/isMainThread-swift.property).
