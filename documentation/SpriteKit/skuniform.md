...
- [init?(coder: NSCoder)](skuniform/init(coder:).md)
- [convenience init(name: String, floatMatrix2: GLKMatrix2)](skuniform/init(name:floatmatrix2:)-39w1i.md)
- [init(name: String, floatMatrix2: GLKMatrix2)](skuniform/init(name:floatmatrix2:)-3zlmz.md)
- [convenience init(name: String, floatMatrix3: GLKMatrix3)](skuniform/init(name:floatmatrix3:)-5kh8w.md)
- [init(name: String, floatMatrix3: GLKMatrix3)](skuniform/init(name:floatmatrix3:)-xf7x.md)
- [init(name: String, floatMatrix4: GLKMatrix4)](skuniform/init(name:floatmatrix4:)-13pbm.md)
- [convenience init(name: String, floatMatrix4: GLKMatrix4)](skuniform/init(name:floatmatrix4:)-9xcfm.md)
- [convenience init(name: String, floatVector2: GLKVector2)](skuniform/init(name:floatvector2:)-2yocf.md)
- [init(name: String, floatVector2: GLKVector2)](skuniform/init(name:floatvector2:)-7fwo7.md)
- [init(name: String, floatVector3: GLKVector3)](skuniform/init(name:floatvector3:)-8gnuo.md)
- [convenience init(name: String, floatVector3: GLKVector3)](skuniform/init(name:floatvector3:)-984ul.md)
- [init(name: String, floatVector4: GLKVector4)](skuniform/init(name:floatvector4:)-298dz.md)
- [convenience init(name: String, floatVector4: GLKVector4)](skuniform/init(name:floatvector4:)-o019.md)
### Instance Properties
