...
- `velocity`: The maximum speed at which the node should move.
...
*[View on Apple Developer](https://developer.apple.com/documentation/spritekit/skaction/reach(to:rootnode:velocity:)-8xv45)*