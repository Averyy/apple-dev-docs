...
When the action executes, the audio node’s reverb animates from its current value to its new value. For more information, see [`AVAudio3DMixing`](https://developer.apple.com/documentation/AVFAudio/AVAudio3DMixing).
...
*[View on Apple Developer](https://developer.apple.com/documentation/spritekit/skaction/changereverb(to:duration:))*