...
When the action executes, the audio node’s occlusion animates from its current value to its new value. For more information, see [`AVAudio3DMixing`](https://developer.apple.com/documentation/AVFAudio/AVAudio3DMixing).
...
*[View on Apple Developer](https://developer.apple.com/documentation/spritekit/skaction/changeocclusion(by:duration:))*