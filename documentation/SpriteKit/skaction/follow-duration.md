...
Calling this method is equivalent to calling the [`follow(_:asOffset:orientToPath:duration:)`](skaction/follow(_:asoffset:orienttopath:duration:).md) method, passing in [`true`](https://developer.apple.com/documentation/swift/true) to both the `offset` and `orient` parameters.
...
*[View on Apple Developer](https://developer.apple.com/documentation/spritekit/skaction/follow(_:duration:))*