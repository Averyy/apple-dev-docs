...
- `xScale`: The new value for the node’s x scale value.
- `yScale`: The new value for the node’s y scale value.
...
*[View on Apple Developer](https://developer.apple.com/documentation/spritekit/skaction/scalex(to:y:duration:))*