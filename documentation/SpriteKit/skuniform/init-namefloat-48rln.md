...
An initialized uniform object whose type is set to [`SKUniformType.float`](skuniformtype/float.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/spritekit/skuniform/init(name:float:)-48rln)*