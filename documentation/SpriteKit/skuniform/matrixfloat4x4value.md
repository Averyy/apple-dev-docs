...
```swift
var matrixFloat4x4Value: matrix_float4x4 { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/spritekit/skuniform/matrixfloat4x4value)*