...
```swift
var matrixFloat2x2Value: matrix_float2x2 { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/spritekit/skuniform/matrixfloat2x2value)*