...
The strength of the field measures the strength of the spring. A positive number indicates that the body is accelerating toward the field node. The [`falloff`](skfieldnode/falloff.md) property of a spring field node is set by default to `-1`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/spritekit/skfieldnode/springfield())*