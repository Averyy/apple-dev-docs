...
The force is applied in the opposite direction of the physics body’s [`velocity`](skphysicsbody/velocity.md) property and has a magnitude proportional to the field’s [`strength`](skfieldnode/strength.md) property and the physics body’s speed.  This field models Stoke’s Law.
...
*[View on Apple Developer](https://developer.apple.com/documentation/spritekit/skfieldnode/dragfield())*