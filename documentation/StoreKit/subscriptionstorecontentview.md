...
```swift
@MainActor
@preconcurrency struct SubscriptionStoreContentView<Content> where Content : StoreContent
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/storekit/subscriptionstorecontentview)*