...
```swift
@MainActor
@preconcurrency static var pagedProminentPicker: PagedProminentPickerSubscriptionStoreControlStyle { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/storekit/subscriptionstorecontrolstyle/pagedprominentpicker)*