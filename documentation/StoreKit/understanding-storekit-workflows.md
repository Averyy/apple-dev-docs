...
For more information on the product types that App Store Connect supports, see [`Apple In-App Purchase types`](https://developer.apple.comhttps://developer.apple.com/help/app-store-connect/reference/in-app-purchase-types/)
...
#### Reset the Projects Apple in App Purchases
