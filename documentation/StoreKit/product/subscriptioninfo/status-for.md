...
To get the subscription group identifier of a subscription, see [`subscriptionGroupID`](product/subscriptioninfo/subscriptiongroupid.md) in [`Product.SubscriptionInfo`](product/subscriptioninfo.md), or [`subscriptionGroupID`](transaction/subscriptiongroupid.md) in [`Transaction`](transaction.md). You originally create subscription group identifiers when you set up Apple In-App Purchases in App Store Connect. For more information, see [`Offer auto-renewable subscriptions`](https://developer.apple.comhttps://help.apple.com/app-store-connect/#/dev75708c031).
