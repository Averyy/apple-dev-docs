...
- `order`: A collection of product identifiers ([`id`](product/id.md)) in the order that you want the promoted Apple In-App Purchases to appear, from first to last. Use an empty list to cancel previous changes.
