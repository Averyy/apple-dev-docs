...
```swift
nonisolated
init(_ configuration: SubscriptionOfferViewStyleConfiguration) where Icon == SubscriptionOfferViewStyleConfiguration.Icon, PlaceholderIcon == SubscriptionOfferViewStyleConfiguration.Icon
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/storekit/subscriptionofferview/init(_:))*