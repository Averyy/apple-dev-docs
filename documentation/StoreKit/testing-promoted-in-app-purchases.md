...
| **Parameter** `productIdentifier` | The Apple In-App Purchase product ID you want to test; for example: ![None](/images/com.apple.storekit/spacer.png) `com.example.product` |
