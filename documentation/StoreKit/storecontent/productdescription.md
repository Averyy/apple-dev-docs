...
```swift
@MainActor
@preconcurrency func productDescription(_ visibility: Visibility) -> some StoreContent
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/storekit/storecontent/productdescription(_:))*