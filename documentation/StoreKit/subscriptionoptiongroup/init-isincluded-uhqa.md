...
```swift
@MainActor
@preconcurrency init(_ label: LocalizedStringKey, isIncluded: @escaping (Product) -> Bool) where Content == Never
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/storekit/subscriptionoptiongroup/init(_:isincluded:)-uhqa)*