...
```swift
@MainActor
@preconcurrency init(@StoreContentBuilder content: () -> Content)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/storekit/subscriptionoptiongroup/init(content:))*