...
```swift
@MainActor
@preconcurrency init(_ label: LocalizedStringKey, @StoreContentBuilder content: () -> Content, @ViewBuilder marketingContent: () -> MarketingContent)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/storekit/subscriptionoptiongroup/init(_:content:marketingcontent:)-9jybc)*