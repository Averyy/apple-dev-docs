...
```swift
@MainActor
@preconcurrency init(@StoreContentBuilder content: () -> Content, @ViewBuilder label: () -> Label)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/storekit/subscriptionoptiongroup/init(content:label:))*