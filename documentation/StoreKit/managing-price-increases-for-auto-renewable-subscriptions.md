...
| --- | --- | --- |
| `PRICE_INCREASE` ![None](/images/com.apple.storekit/spacer.png) | `PENDING` | Indicates that the App Store informed the customer of the price increase for the auto-renewable subscription, and the customer hasn’t yet responded. |
