...
```swift
@MainActor
@preconcurrency static var regular: RegularProductViewStyle { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/storekit/productviewstyle/regular)*