...
```swift
@MainActor
@preconcurrency static var large: LargeProductViewStyle { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/storekit/productviewstyle/large)*