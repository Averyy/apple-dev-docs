...
For more information about using the [`deviceVerification`](verificationresult/deviceverification-69lvx.md) value, see [`deviceVerification`](transaction/deviceverification.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/storekit/verificationresult/deviceverification-69lvx)*