...
Use this [`signature`](verificationresult/signature-7t1ne.md) with [`Apple CryptoKit`](https://developer.apple.com/documentation/CryptoKit) if you verify the signature on the device.
...
*[View on Apple Developer](https://developer.apple.com/documentation/storekit/verificationresult/signature-7t1ne)*