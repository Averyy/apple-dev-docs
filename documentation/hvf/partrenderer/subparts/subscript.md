...
```swift
subscript(index: Int) -> PartRenderer.PartParameters { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/hvf/partrenderer/subparts/subscript(_:))*