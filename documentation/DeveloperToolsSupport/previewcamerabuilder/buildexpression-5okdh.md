...
```swift
static func buildExpression(_ camera: PreviewCamera) -> [PreviewCamera]
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/developertoolssupport/previewcamerabuilder/buildexpression(_:)-5okdh)*