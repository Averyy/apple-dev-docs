...
```swift
@MainActor
static var landscapeLeft: PreviewTrait<Preview.ViewTraits> { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/developertoolssupport/previewtrait/landscapeleft)*