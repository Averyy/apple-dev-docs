...
```swift
typedef enum { ... } ar_surface_classification_t;
```

## Topics

### Enumeration Cases
- [ar_surface_classification_bed](ar_surface_classification_t/ar_surface_classification_bed.md)
  A value describing the classification of a surface.
- [ar_surface_classification_cabinet](ar_surface_classification_t/ar_surface_classification_cabinet.md)
  A value describing the classification of a surface.
- [ar_surface_classification_ceiling](ar_surface_classification_t/ar_surface_classification_ceiling.md)
  A value describing the classification of a surface.
- [ar_surface_classification_door](ar_surface_classification_t/ar_surface_classification_door.md)
  A value describing the classification of a surface.
- [ar_surface_classification_floor](ar_surface_classification_t/ar_surface_classification_floor.md)
  A value describing the classification of a surface.
- [ar_surface_classification_home_appliance](ar_surface_classification_t/ar_surface_classification_home_appliance.md)
  A value describing the classification of a surface.
- [ar_surface_classification_none](ar_surface_classification_t/ar_surface_classification_none.md)
  A value describing the classification of a surface.
- [ar_surface_classification_plant](ar_surface_classification_t/ar_surface_classification_plant.md)
  A value describing the classification of a surface.
- [ar_surface_classification_seat](ar_surface_classification_t/ar_surface_classification_seat.md)
  A value describing the classification of a surface.
- [ar_surface_classification_stairs](ar_surface_classification_t/ar_surface_classification_stairs.md)
  A value describing the classification of a surface.
- [ar_surface_classification_table](ar_surface_classification_t/ar_surface_classification_table.md)
  A value describing the classification of a surface.
- [ar_surface_classification_tv](ar_surface_classification_t/ar_surface_classification_tv.md)
  A value describing the classification of a surface.
- [ar_surface_classification_wall](ar_surface_classification_t/ar_surface_classification_wall.md)
  A value describing the classification of a surface.
- [ar_surface_classification_window](ar_surface_classification_t/ar_surface_classification_window.md)
  A value describing the classification of a surface.
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_surface_classification_t)*