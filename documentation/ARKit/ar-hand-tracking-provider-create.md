...
```swift
extern ar_hand_tracking_provider_t ar_hand_tracking_provider_create(ar_hand_tracking_configuration_t hand_tracking_configuration);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_hand_tracking_provider_create)*