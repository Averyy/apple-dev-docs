...
```swift
typedef NSObject<OS_ar_geometry_element> * ar_geometry_element_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_geometry_element_t)*