...
```swift
protocol OS_ar_plane_detection_provider : OS_ar_data_provider
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/os_ar_plane_detection_provider)*