...
```swift
extern ar_room_anchors_t ar_room_tracking_provider_copy_all_room_anchors(ar_room_tracking_provider_t room_tracking_provider);
```
...
- [room_tracking_h](room_tracking_h.md)


---

*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_room_tracking_provider_copy_all_room_anchors)*