...
```swift
typedef NSObject<OS_ar_stereo_properties_provider> * ar_stereo_properties_provider_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_stereo_properties_provider_t)*