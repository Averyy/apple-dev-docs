...
```swift
extern size_t ar_image_anchors_get_count(ar_image_anchors_t image_anchors);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_image_anchors_get_count)*