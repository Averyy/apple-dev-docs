...
```swift
extern const char * ar_reference_object_get_name(ar_reference_object_t reference_object);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_reference_object_get_name)*