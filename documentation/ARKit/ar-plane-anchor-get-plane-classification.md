...
```swift
extern ar_plane_classification_t ar_plane_anchor_get_plane_classification(ar_plane_anchor_t plane_anchor);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_plane_anchor_get_plane_classification)*