...
```swift
typedef _Bool (^)(NSObject<OS_ar_image_anchor> *) ar_image_anchors_enumerator_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_image_anchors_enumerator_t)*