...
When you receive collaboration data from other users, you instantiate an [`ARSession.CollaborationData`](arsession/collaborationdata.md) object with it, and pass the object to your session via [`update(with:)`](arsession/update(with:).md).
