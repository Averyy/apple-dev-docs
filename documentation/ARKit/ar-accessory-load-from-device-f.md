...
```swift
extern void ar_accessory_load_from_device_f(id<GCDevice> device, void * context, ar_accessory_device_load_completion_handler_function_t completion_handler_function);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_accessory_load_from_device_f)*