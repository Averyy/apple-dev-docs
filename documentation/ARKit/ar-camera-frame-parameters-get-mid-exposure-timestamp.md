...
```swift
extern CFTimeInterval ar_camera_frame_parameters_get_mid_exposure_timestamp(ar_camera_frame_parameters_t camera_frame_parameters);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_camera_frame_parameters_get_mid_exposure_timestamp)*