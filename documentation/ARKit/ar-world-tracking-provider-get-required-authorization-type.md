...
```swift
extern ar_authorization_type_t ar_world_tracking_provider_get_required_authorization_type();
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_world_tracking_provider_get_required_authorization_type)*