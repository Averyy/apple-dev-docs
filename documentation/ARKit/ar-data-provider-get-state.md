...
```swift
extern ar_data_provider_state_t ar_data_provider_get_state(ar_data_provider_t data_provider);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_data_provider_get_state)*