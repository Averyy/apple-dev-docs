...
```swift
typedef NSObject<OS_ar_hand_tracking_configuration> * ar_hand_tracking_configuration_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_hand_tracking_configuration_t)*