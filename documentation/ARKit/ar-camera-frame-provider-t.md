...
```swift
typedef NSObject<OS_ar_camera_frame_provider> * ar_camera_frame_provider_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_camera_frame_provider_t)*