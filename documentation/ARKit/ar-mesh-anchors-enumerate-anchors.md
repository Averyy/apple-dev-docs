...
```swift
extern void ar_mesh_anchors_enumerate_anchors(ar_mesh_anchors_t mesh_anchors, ar_mesh_anchors_enumerator_tmesh_anchors_enumerator);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_mesh_anchors_enumerate_anchors)*