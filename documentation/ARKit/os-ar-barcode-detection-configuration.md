...
```swift
protocol OS_ar_barcode_detection_configuration : NSObjectProtocol
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/os_ar_barcode_detection_configuration)*