...
```swift
extern ar_plane_extent_t ar_plane_geometry_get_plane_extent(ar_plane_geometry_t plane_geometry);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_plane_geometry_get_plane_extent)*