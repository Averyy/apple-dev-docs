...
- `successful`:  if all anchors were successfully removed from the world tracking provider,   otherwise.
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_world_tracking_remove_all_anchors_completion_handler_function_t)*