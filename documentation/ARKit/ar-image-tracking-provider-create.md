...
```swift
extern ar_image_tracking_provider_t ar_image_tracking_provider_create(ar_image_tracking_configuration_t image_tracking_configuration);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_image_tracking_provider_create)*