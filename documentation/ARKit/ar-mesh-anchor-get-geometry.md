...
```swift
extern ar_mesh_geometry_t ar_mesh_anchor_get_geometry(ar_mesh_anchor_t mesh_anchor);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_mesh_anchor_get_geometry)*