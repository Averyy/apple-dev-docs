...
```swift
extern ar_accessory_t ar_accessory_anchor_get_accessory(ar_accessory_anchor_t accessory_anchor);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_accessory_anchor_get_accessory)*