...
```swift
extern ar_coordinate_space_data_t ar_shared_coordinate_space_provider_copy_next_coordinate_space_data(ar_shared_coordinate_space_provider_t shared_coordinate_space_provider);
```

#### Return Value

Coordinate space data if available, `nil` otherwise.
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_shared_coordinate_space_provider_copy_next_coordinate_space_data)*