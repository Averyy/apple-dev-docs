...
```swift
extern void ar_room_anchor_get_identifier(ar_room_anchor_t room_anchor, uuid_t out_identifier);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_room_anchor_get_identifier)*