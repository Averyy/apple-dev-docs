...
```swift
extern simd_float3 ar_barcode_anchor_get_extent(ar_barcode_anchor_t barcode_anchor);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_barcode_anchor_get_extent)*