...
```swift
typedef void (*)(void *, NSObject<OS_ar_authorization_result> *) ar_authorization_update_handler_function_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_authorization_update_handler_function_t)*