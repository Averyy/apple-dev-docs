...
```swift
extern ar_accessory_tracking_configuration_t ar_accessory_tracking_configuration_create();
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_accessory_tracking_configuration_create)*