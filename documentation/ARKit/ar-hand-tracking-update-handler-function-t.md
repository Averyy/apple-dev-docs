...
```swift
typedef void (*)(void *, NSObject<OS_ar_hand_anchor> *, NSObject<OS_ar_hand_anchor> *) ar_hand_tracking_update_handler_function_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_hand_tracking_update_handler_function_t)*