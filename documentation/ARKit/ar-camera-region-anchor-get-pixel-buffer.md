...
```swift
extern CVPixelBufferRef ar_camera_region_anchor_get_pixel_buffer(ar_camera_region_anchor_t camera_region_anchor);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_camera_region_anchor_get_pixel_buffer)*