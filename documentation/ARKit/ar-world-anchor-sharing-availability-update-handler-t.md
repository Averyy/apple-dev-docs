...
```swift
typedef void (^)(ar_world_anchor_sharing_availability_t) ar_world_anchor_sharing_availability_update_handler_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_world_anchor_sharing_availability_update_handler_t)*