...
```swift
extern void ar_accessory_load_from_device(id<GCDevice> device, ar_accessory_device_load_completion_handler_tcompletion_handler);
```

## Parameters

- `device`: The   for which to load the accessory.
- `completion_handler`: Handler triggered after the request to load an accessory completes.
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_accessory_load_from_device)*