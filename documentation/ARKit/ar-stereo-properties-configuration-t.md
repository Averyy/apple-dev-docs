...
```swift
typedef NSObject<OS_ar_stereo_properties_configuration> * ar_stereo_properties_configuration_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_stereo_properties_configuration_t)*