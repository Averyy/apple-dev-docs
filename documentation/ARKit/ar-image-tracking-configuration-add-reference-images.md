...
```swift
extern void ar_image_tracking_configuration_add_reference_images(ar_image_tracking_configuration_t image_tracking_configuration, ar_reference_images_t reference_images);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_image_tracking_configuration_add_reference_images)*