...
```swift
extern CVPixelBufferRef ar_camera_frame_sample_get_pixel_buffer(ar_camera_frame_sample_t camera_frame_sample);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_camera_frame_sample_get_pixel_buffer)*