...
```swift
extern void ar_camera_region_provider_remove_camera_region_anchor_with_identifier(ar_camera_region_provider_t camera_region_provider, uuid_t camera_region_anchor_identifier, ar_camera_region_remove_anchor_with_identifier_completion_handler_tremove_anchor_with_identifier_completion_handler);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_camera_region_provider_remove_camera_region_anchor_with_identifier)*