...
```swift
typedef NSObject<OS_ar_plane_detection_provider> * ar_plane_detection_provider_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_plane_detection_provider_t)*