...
```swift
extern const char * const ar_accessory_location_name_aim;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_accessory_location_name_aim)*