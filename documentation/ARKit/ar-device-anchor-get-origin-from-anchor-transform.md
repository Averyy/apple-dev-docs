...
- [ar_device_anchor_get_tracking_state](ar_device_anchor_get_tracking_state.md)
  Gets the tracking state of the device anchor.


---

*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_device_anchor_get_origin_from_anchor_transform)*