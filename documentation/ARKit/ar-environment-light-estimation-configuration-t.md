...
```swift
typedef NSObject<OS_ar_environment_light_estimation_configuration> * ar_environment_light_estimation_configuration_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_environment_light_estimation_configuration_t)*