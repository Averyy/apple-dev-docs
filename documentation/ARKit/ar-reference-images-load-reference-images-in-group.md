...
```swift
extern ar_reference_images_t ar_reference_images_load_reference_images_in_group(const char * group_name, CFBundleRef bundle);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_reference_images_load_reference_images_in_group)*