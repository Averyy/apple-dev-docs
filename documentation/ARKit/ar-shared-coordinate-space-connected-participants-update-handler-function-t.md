...
```swift
typedef void (*)(void *, NSObject<OS_ar_identifiers> *) ar_shared_coordinate_space_connected_participants_update_handler_function_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_shared_coordinate_space_connected_participants_update_handler_function_t)*