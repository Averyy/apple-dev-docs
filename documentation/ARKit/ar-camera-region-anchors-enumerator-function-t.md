...
```swift
typedef _Bool (*)(void *, NSObject<OS_ar_camera_region_anchor> *) ar_camera_region_anchors_enumerator_function_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_camera_region_anchors_enumerator_function_t)*