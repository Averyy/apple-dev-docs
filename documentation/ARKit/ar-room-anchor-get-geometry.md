...
```swift
extern ar_mesh_geometry_t ar_room_anchor_get_geometry(ar_room_anchor_t room_anchor);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_room_anchor_get_geometry)*