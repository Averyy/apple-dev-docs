...
```swift
extern ar_camera_frame_sample_t ar_camera_frame_get_frame_sample(ar_camera_frame_t camera_frame, ar_camera_position_t camera_position);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_camera_frame_get_frame_sample)*