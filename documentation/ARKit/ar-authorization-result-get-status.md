...
```swift
extern ar_authorization_status_t ar_authorization_result_get_status(ar_authorization_result_t authorization_result);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_authorization_result_get_status)*