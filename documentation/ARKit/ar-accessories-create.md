...
```swift
extern ar_accessories_t ar_accessories_create();
```

#### Return Value

An instance of `ar_accessories_t`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_accessories_create)*