...
```swift
extern ar_camera_type_t ar_camera_frame_parameters_get_camera_type(ar_camera_frame_parameters_t camera_frame_parameters);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_camera_frame_parameters_get_camera_type)*