...
```swift
extern bool ar_trackable_anchor_is_tracked(ar_trackable_anchor_t anchor);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_trackable_anchor_is_tracked)*