...
```swift
extern ar_image_tracking_configuration_t ar_image_tracking_configuration_create();
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_image_tracking_configuration_create)*