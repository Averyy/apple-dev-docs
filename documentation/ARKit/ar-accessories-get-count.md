...
```swift
extern size_t ar_accessories_get_count(ar_accessories_t accessories);
```

#### Return Value

The number of accessories in the collection.
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_accessories_get_count)*