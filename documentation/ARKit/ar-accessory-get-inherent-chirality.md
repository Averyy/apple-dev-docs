...
```swift
extern ar_accessory_chirality_t ar_accessory_get_inherent_chirality(ar_accessory_t accessory);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_accessory_get_inherent_chirality)*