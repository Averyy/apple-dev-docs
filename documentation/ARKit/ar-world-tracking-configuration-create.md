...
```swift
extern ar_world_tracking_configuration_t ar_world_tracking_configuration_create();
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_world_tracking_configuration_create)*