...
```swift
extern void ar_session_set_data_provider_state_change_handler(ar_session_t session, dispatch_queue_t queue, ar_session_data_provider_state_change_handler_tdata_provider_state_change_handler);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_session_set_data_provider_state_change_handler)*