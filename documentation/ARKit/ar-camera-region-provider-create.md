...
```swift
extern ar_camera_region_provider_t ar_camera_region_provider_create(ar_camera_region_configuration_t camera_region_configuration);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_camera_region_provider_create)*