...
```swift
extern void ar_plane_detection_configuration_set_alignment(ar_plane_detection_configuration_t plane_detection_configuration, ar_plane_alignment_t alignment);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_plane_detection_configuration_set_alignment)*