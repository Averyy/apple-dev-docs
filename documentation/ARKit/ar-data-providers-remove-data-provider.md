...
```swift
extern void ar_data_providers_remove_data_provider(ar_data_providers_t data_providers, ar_data_provider_t data_provider_to_remove);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_data_providers_remove_data_provider)*