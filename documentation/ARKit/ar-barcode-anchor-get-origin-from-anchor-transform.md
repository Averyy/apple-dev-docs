...
```swift
extern simd_float4x4 ar_barcode_anchor_get_origin_from_anchor_transform(ar_barcode_anchor_t anchor);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_barcode_anchor_get_origin_from_anchor_transform)*