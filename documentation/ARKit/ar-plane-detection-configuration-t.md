...
```swift
typedef NSObject<OS_ar_plane_detection_configuration> * ar_plane_detection_configuration_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_plane_detection_configuration_t)*