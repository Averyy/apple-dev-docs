...
```swift
extern CFTimeInterval ar_room_anchor_get_timestamp(ar_room_anchor_t room_anchor);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_room_anchor_get_timestamp)*