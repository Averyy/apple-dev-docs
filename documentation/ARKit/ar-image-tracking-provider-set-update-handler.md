...
```swift
extern void ar_image_tracking_provider_set_update_handler(ar_image_tracking_provider_t image_tracking_provider, dispatch_queue_t image_tracking_updates_queue, ar_image_tracking_update_handler_timage_tracking_update_handler);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_image_tracking_provider_set_update_handler)*