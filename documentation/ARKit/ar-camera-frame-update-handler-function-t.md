...
```swift
typedef void (*)(void *, NSObject<OS_ar_camera_frame> *) ar_camera_frame_update_handler_function_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_camera_frame_update_handler_function_t)*