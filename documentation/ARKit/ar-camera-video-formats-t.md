...
```swift
typedef NSObject<OS_ar_camera_video_formats> * ar_camera_video_formats_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_camera_video_formats_t)*