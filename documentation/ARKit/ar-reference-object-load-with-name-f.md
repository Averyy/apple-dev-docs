...
```swift
extern void ar_reference_object_load_with_name_f(const char * name, CFBundleRef bundle, void * context, ar_reference_object_bundle_load_completion_handler_function_t completion_handler_function);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_reference_object_load_with_name_f)*