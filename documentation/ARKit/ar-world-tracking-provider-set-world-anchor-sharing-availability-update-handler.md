...
```swift
extern void ar_world_tracking_provider_set_world_anchor_sharing_availability_update_handler(ar_world_tracking_provider_t world_tracking_provider, dispatch_queue_t world_tracking_updates_queue, ar_world_anchor_sharing_availability_update_handler_tworld_anchor_sharing_availability_update_handler);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_world_tracking_provider_set_world_anchor_sharing_availability_update_handler)*