...
```swift
extern ar_reference_image_t ar_reference_image_create_from_pixel_buffer(CVPixelBufferRef pixelBuffer, CGImagePropertyOrientation orientation, float physicalWidth);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_reference_image_create_from_pixel_buffer)*