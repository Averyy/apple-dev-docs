...
```swift
extern CFURLRef ar_accessory_get_usdz_file_path(ar_accessory_t accessory);
```

#### Return Value

The path to the USDZ file.
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_accessory_get_usdz_file_path)*