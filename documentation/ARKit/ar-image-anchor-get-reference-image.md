...
```swift
extern ar_reference_image_t ar_image_anchor_get_reference_image(ar_image_anchor_t image_anchor);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_image_anchor_get_reference_image)*