...
```swift
extern MTLVertexFormat ar_geometry_source_get_format(ar_geometry_source_t geometry_source);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_geometry_source_get_format)*