...
```swift
enum ARTrackingState : NSInteger;
```
...
- [ARTrackingStateLimited](artrackingstate/artrackingstatelimited.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/artrackingstate)*