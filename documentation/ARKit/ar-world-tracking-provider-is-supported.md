...
```swift
extern bool ar_world_tracking_provider_is_supported();
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_world_tracking_provider_is_supported)*