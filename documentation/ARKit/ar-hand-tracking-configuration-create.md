...
```swift
extern ar_hand_tracking_configuration_t ar_hand_tracking_configuration_create();
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_hand_tracking_configuration_create)*