...
```swift
extern ar_hand_chirality_t ar_hand_anchor_get_chirality(ar_hand_anchor_t hand_anchor);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_hand_anchor_get_chirality)*