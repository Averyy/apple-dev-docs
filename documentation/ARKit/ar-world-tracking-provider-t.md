...
```swift
typedef NSObject<OS_ar_world_tracking_provider> * ar_world_tracking_provider_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_world_tracking_provider_t)*