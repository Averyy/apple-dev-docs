...
```swift
extern ar_camera_type_t ar_camera_video_format_get_camera_type(ar_camera_video_format_t video_format);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_camera_video_format_get_camera_type)*