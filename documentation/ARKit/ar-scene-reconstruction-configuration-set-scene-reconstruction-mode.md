...
```swift
extern void ar_scene_reconstruction_configuration_set_scene_reconstruction_mode(ar_scene_reconstruction_configuration_t scene_reconstruction_configuration, ar_scene_reconstruction_mode_t scene_reconstruction_mode);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_scene_reconstruction_configuration_set_scene_reconstruction_mode)*