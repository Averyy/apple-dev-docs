...
```swift
extern float ar_object_tracking_configuration_get_stationary_object_tracking_rate(ar_object_tracking_configuration_t object_tracking_configuration);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_object_tracking_configuration_get_stationary_object_tracking_rate)*