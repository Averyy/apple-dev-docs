...
```swift
typedef NSObject<OS_ar_image_tracking_configuration> * ar_image_tracking_configuration_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_image_tracking_configuration_t)*