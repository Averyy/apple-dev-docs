...
```swift
extern void ar_data_providers_add_data_providers(ar_data_providers_t data_providers, ar_data_providers_t data_providers_to_add);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_data_providers_add_data_providers)*