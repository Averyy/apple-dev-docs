...
```swift
extern ar_barcode_detection_configuration_t ar_barcode_detection_configuration_create();
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_barcode_detection_configuration_create)*