...
```swift
extern ar_viewpoint_properties_t ar_viewpoint_properties_create();
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_viewpoint_properties_create)*