...
```swift
typedef NSObject<OS_ar_environment_probe_anchors> * ar_environment_probe_anchors_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_environment_probe_anchors_t)*