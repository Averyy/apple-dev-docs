...
```swift
extern void ar_reference_images_enumerate_images_f(ar_reference_images_t reference_images, void * context, ar_reference_images_enumerator_function_t reference_images_enumerator_function);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_reference_images_enumerate_images_f)*