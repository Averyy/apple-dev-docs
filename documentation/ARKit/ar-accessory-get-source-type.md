...
```swift
extern ar_accessory_source_type_t ar_accessory_get_source_type(ar_accessory_t accessory);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_accessory_get_source_type)*