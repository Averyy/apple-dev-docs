...
```swift
typedef NSObject<OS_ar_reference_objects> * ar_reference_objects_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_reference_objects_t)*