...
```swift
extern ar_camera_frame_provider_t ar_camera_frame_provider_create();
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_camera_frame_provider_create)*