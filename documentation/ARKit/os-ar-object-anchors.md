...
```swift
protocol OS_ar_object_anchors : NSObjectProtocol
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/os_ar_object_anchors)*