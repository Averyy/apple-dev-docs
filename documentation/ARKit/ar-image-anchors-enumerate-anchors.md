...
```swift
extern void ar_image_anchors_enumerate_anchors(ar_image_anchors_t image_anchors, ar_image_anchors_enumerator_timage_anchors_enumerator);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_image_anchors_enumerate_anchors)*