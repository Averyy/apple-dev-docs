...
```swift
extern ar_reference_images_t ar_reference_images_create();
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_reference_images_create)*