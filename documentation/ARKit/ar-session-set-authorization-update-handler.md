...
```swift
extern void ar_session_set_authorization_update_handler(ar_session_t session, dispatch_queue_t authorization_update_queue, ar_authorization_update_handler_tauthorization_update_handler);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_session_set_authorization_update_handler)*