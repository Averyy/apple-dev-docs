...
```swift
extern ar_scene_reconstruction_provider_t ar_scene_reconstruction_provider_create(ar_scene_reconstruction_configuration_t scene_reconstruction_configuration);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_scene_reconstruction_provider_create)*