...
```swift
extern void ar_camera_region_anchors_enumerate_anchors_f(ar_camera_region_anchors_t camera_region_anchors, void * context, ar_camera_region_anchors_enumerator_function_t camera_region_anchors_enumerator_function);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_camera_region_anchors_enumerate_anchors_f)*