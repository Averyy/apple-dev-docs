...
```swift
typedef void (*)(void *, NSObject<OS_ar_accessory_anchors> *, NSObject<OS_ar_accessory_anchors> *, NSObject<OS_ar_accessory_anchors> *) ar_accessory_tracking_update_handler_function_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_accessory_tracking_update_handler_function_t)*