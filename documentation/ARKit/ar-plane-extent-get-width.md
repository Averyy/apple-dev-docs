...
```swift
extern float ar_plane_extent_get_width(ar_plane_extent_t plane_extent);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_plane_extent_get_width)*