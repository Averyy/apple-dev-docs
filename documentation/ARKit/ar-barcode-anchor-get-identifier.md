...
```swift
extern void ar_barcode_anchor_get_identifier(ar_barcode_anchor_t anchor, uuid_t out_identifier);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_barcode_anchor_get_identifier)*