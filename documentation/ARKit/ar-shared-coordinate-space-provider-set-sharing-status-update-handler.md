...
```swift
extern void ar_shared_coordinate_space_provider_set_sharing_status_update_handler(ar_shared_coordinate_space_provider_t shared_coordinate_space_provider, dispatch_queue_t status_updates_queue, ar_shared_coordinate_space_sharing_status_update_handler_tsharing_status_update_handler);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_shared_coordinate_space_provider_set_sharing_status_update_handler)*