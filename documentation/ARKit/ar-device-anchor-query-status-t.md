...
### Query status
- [ar_device_anchor_query_status_success](ar_device_anchor_query_status_t/ar_device_anchor_query_status_success.md)
  The device anchor query succeeded.
- [ar_device_anchor_query_status_failure](ar_device_anchor_query_status_t/ar_device_anchor_query_status_failure.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_device_anchor_query_status_t)*