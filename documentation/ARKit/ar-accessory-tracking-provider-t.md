...
```swift
typedef NSObject<OS_ar_accessory_tracking_provider> * ar_accessory_tracking_provider_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_accessory_tracking_provider_t)*