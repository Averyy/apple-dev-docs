...
```swift
typedef NSObject<OS_ar_reference_images> * ar_reference_images_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_reference_images_t)*