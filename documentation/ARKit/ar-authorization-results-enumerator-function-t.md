...
```swift
typedef _Bool (*)(void *, NSObject<OS_ar_authorization_result> *) ar_authorization_results_enumerator_function_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_authorization_results_enumerator_function_t)*