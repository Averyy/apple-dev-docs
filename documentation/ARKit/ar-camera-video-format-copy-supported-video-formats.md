...
```swift
extern ar_camera_video_formats_t ar_camera_video_format_copy_supported_video_formats(ar_camera_type_t camera_type, ar_camera_position_t camera_position);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_camera_video_format_copy_supported_video_formats)*