...
```swift
extern size_t ar_camera_video_formats_get_count(ar_camera_video_formats_t camera_video_formats);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_camera_video_formats_get_count)*