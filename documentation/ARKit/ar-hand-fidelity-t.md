...
```swift
typedef enum { ... } ar_hand_fidelity_t;
```

## Topics

### Enumeration Cases
- [ar_hand_fidelity_high](ar_hand_fidelity_t/ar_hand_fidelity_high.md)
  Enum for hand fidelity.
- [ar_hand_fidelity_nominal](ar_hand_fidelity_t/ar_hand_fidelity_nominal.md)
  Enum for hand fidelity.
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_hand_fidelity_t)*