...
```swift
extern void ar_accessories_add_accessory(ar_accessories_t accessories, ar_accessory_t accessory_to_add);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_accessories_add_accessory)*