...
```swift
typedef NSObject<OS_ar_reference_object> * ar_reference_object_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_reference_object_t)*