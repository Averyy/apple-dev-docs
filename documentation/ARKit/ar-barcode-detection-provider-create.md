...
```swift
extern ar_barcode_detection_provider_t ar_barcode_detection_provider_create(ar_barcode_detection_configuration_t barcode_detection_configuration);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_barcode_detection_provider_create)*