...
```swift
typedef NSObject<OS_ar_camera_frame_samples> * ar_camera_frame_samples_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_camera_frame_samples_t)*