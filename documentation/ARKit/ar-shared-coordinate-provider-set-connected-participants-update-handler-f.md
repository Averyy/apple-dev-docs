...
- `connected_participants_update_handler_function`: Function to be called when there is an update to shared coordinate space connected   participants. Refer to   for function signature.
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_shared_coordinate_provider_set_connected_participants_update_handler_f)*