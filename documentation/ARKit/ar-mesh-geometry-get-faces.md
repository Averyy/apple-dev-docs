...
```swift
extern ar_geometry_element_t ar_mesh_geometry_get_faces(ar_mesh_geometry_t mesh_geometry);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_mesh_geometry_get_faces)*