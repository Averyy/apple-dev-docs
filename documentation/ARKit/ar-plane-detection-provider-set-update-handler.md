...
```swift
extern void ar_plane_detection_provider_set_update_handler(ar_plane_detection_provider_t plane_detection_provider, dispatch_queue_t plane_detection_updates_queue, ar_plane_detection_update_handler_tplane_detection_update_handler);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_plane_detection_provider_set_update_handler)*