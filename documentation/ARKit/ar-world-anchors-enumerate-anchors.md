...
```swift
extern void ar_world_anchors_enumerate_anchors(ar_world_anchors_t world_anchors, ar_world_anchors_enumerator_tworld_anchors_enumerator);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_world_anchors_enumerate_anchors)*