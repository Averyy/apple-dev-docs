...
```swift
typedef enum { ... } ar_world_tracking_error_code_t;
```

## Topics

### Determining causes for tracking failures
- [ar_world_tracking_error_code_add_anchor_failed](ar_world_tracking_error_code_t/ar_world_tracking_error_code_add_anchor_failed.md)
  The error code for when a world tracking provider can’t add a world anchor.
- [ar_world_tracking_error_code_remove_anchor_failed](ar_world_tracking_error_code_t/ar_world_tracking_error_code_remove_anchor_failed.md)
  The error code for when a world tracking provider can’t remove a world anchor.
- [ar_world_tracking_error_code_anchor_max_limit_reached](ar_world_tracking_error_code_t/ar_world_tracking_error_code_anchor_max_limit_reached.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_world_tracking_error_code_t)*