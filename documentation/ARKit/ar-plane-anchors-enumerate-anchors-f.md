...
```swift
extern void ar_plane_anchors_enumerate_anchors_f(ar_plane_anchors_t plane_anchors, void * context, ar_plane_anchors_enumerator_function_t plane_anchors_enumerator_function);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_plane_anchors_enumerate_anchors_f)*