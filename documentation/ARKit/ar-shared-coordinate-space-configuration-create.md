...
```swift
extern ar_shared_coordinate_space_configuration_t ar_shared_coordinate_space_configuration_create();
```

#### Return Value

An instance of `ar_shared_coordinate_space_configuration_t`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_shared_coordinate_space_configuration_create)*