...
The App Clip Code anchor’s [`url`](arappclipcodeanchor/url.md) is defined in this state.
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/arappclipcodeanchor/urldecodingstate-swift.enum/decoded)*