...
```swift
extern ar_data_t ar_barcode_anchor_copy_payload_data(ar_barcode_anchor_t barcode_anchor);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_barcode_anchor_copy_payload_data)*