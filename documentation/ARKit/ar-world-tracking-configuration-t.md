...
```swift
typedef NSObject<OS_ar_world_tracking_configuration> * ar_world_tracking_configuration_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_world_tracking_configuration_t)*