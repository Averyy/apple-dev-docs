...
```swift
extern bool ar_camera_video_format_is_equal_to_camera_video_format(ar_camera_video_format_t camera_video_format, ar_camera_video_format_t other_camera_video_format);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_camera_video_format_is_equal_to_camera_video_format)*