...
```swift
extern ar_scene_reconstruction_configuration_t ar_scene_reconstruction_configuration_create();
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_scene_reconstruction_configuration_create)*