...
```swift
extern ar_shared_coordinate_space_provider_t ar_shared_coordinate_space_provider_create(ar_shared_coordinate_space_configuration_t shared_coordinate_space_configuration);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_shared_coordinate_space_provider_create)*