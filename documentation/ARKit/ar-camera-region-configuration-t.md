...
```swift
typedef NSObject<OS_ar_camera_region_configuration> * ar_camera_region_configuration_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_camera_region_configuration_t)*