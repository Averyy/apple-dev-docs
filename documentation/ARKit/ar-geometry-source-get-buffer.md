...
```swift
extern id<MTLBuffer> ar_geometry_source_get_buffer(ar_geometry_source_t geometry_source);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_geometry_source_get_buffer)*