...
```swift
extern size_t ar_camera_frame_samples_get_count(ar_camera_frame_samples_t camera_frame_samples);
```

#### Return Value

The number of camera frame samples in the collection.

## Parameters

- `camera_frame_samples`: The collection of camera frame samples.
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_camera_frame_samples_get_count)*