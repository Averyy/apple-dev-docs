...
```swift
typedef NSObject<OS_ar_camera_video_format> * ar_camera_video_format_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_camera_video_format_t)*