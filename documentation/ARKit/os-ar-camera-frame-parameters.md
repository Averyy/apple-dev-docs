...
```swift
protocol OS_ar_camera_frame_parameters : NSObjectProtocol
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/os_ar_camera_frame_parameters)*