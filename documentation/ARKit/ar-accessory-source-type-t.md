...
```swift
typedef enum { ... } ar_accessory_source_type_t;
```

## Topics

### Enumeration Cases
- [ar_accessory_source_type_device](ar_accessory_source_type_t/ar_accessory_source_type_device.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_accessory_source_type_t)*