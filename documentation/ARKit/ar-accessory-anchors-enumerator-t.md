...
```swift
typedef _Bool (^)(NSObject<OS_ar_accessory_anchor> *) ar_accessory_anchors_enumerator_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_accessory_anchors_enumerator_t)*