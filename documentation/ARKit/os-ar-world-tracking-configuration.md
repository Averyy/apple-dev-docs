...
```swift
protocol OS_ar_world_tracking_configuration : NSObjectProtocol
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/os_ar_world_tracking_configuration)*