...
```swift
extern OSType ar_camera_video_format_get_pixel_format(ar_camera_video_format_t video_format);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_camera_video_format_get_pixel_format)*