...
```swift
typedef enum { ... } ar_accessory_tracking_error_code_t;
```

## Topics

### Enumeration Cases
- [ar_accessory_tracking_error_code_accessory_loading_failed](ar_accessory_tracking_error_code_t/ar_accessory_tracking_error_code_accessory_loading_failed.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_accessory_tracking_error_code_t)*