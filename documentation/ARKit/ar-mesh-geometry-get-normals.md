...
```swift
extern ar_geometry_source_t ar_mesh_geometry_get_normals(ar_mesh_geometry_t mesh_geometry);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_mesh_geometry_get_normals)*