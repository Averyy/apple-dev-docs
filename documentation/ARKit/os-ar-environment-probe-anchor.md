# OS_ar_environment_probe_anchor
...
```swift
protocol OS_ar_environment_probe_anchor : OS_ar_anchor
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/os_ar_environment_probe_anchor)*