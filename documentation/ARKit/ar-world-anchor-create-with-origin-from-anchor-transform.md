...
```swift
extern ar_world_anchor_t ar_world_anchor_create_with_origin_from_anchor_transform(simd_float4x4 origin_from_anchor_transform);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_world_anchor_create_with_origin_from_anchor_transform)*