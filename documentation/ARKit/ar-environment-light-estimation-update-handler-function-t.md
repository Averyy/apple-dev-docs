...
```swift
typedef void (*)(void *, NSObject<OS_ar_environment_probe_anchors> *, NSObject<OS_ar_environment_probe_anchors> *, NSObject<OS_ar_environment_probe_anchors> *) ar_environment_light_estimation_update_handler_function_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_environment_light_estimation_update_handler_function_t)*