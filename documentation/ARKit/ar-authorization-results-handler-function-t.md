...
```swift
typedef void (*)(void *, NSObject<OS_ar_authorization_results> *, NSObject<OS_ar_error> *) ar_authorization_results_handler_function_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_authorization_results_handler_function_t)*