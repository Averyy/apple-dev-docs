...
```swift
extern ar_identifiers_t ar_room_anchor_get_mesh_anchor_identifiers(ar_room_anchor_t room_anchor);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_room_anchor_get_mesh_anchor_identifiers)*