...
```swift
typedef _Bool (^)(NSObject<OS_ar_reference_image> *) ar_reference_images_enumerator_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_reference_images_enumerator_t)*