...
```swift
typedef void (^)(void *, _Bool) ar_shared_coordinate_space_sharing_status_update_handler_function_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_shared_coordinate_space_sharing_status_update_handler_function_t)*