...
```swift
extern ar_accessory_anchor_t ar_accessory_anchor_create();
```

#### Return Value

An instance of `ar_accessory_anchor_t`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_accessory_anchor_create)*