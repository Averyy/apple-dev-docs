...
```swift
typedef enum { ... } ar_accessory_chirality_t;
```

## Topics

### Enumeration Cases
- [ar_accessory_chirality_left](ar_accessory_chirality_t/ar_accessory_chirality_left.md)
  Left-handed accessory, or non-handed accessory held in left hand.
- [ar_accessory_chirality_right](ar_accessory_chirality_t/ar_accessory_chirality_right.md)
  Right-handed accessory, or non-handed accessory held in right hand.
- [ar_accessory_chirality_unspecified](ar_accessory_chirality_t/ar_accessory_chirality_unspecified.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_accessory_chirality_t)*