# OS_ar_barcode_detection_provider
...
```swift
protocol OS_ar_barcode_detection_provider : OS_ar_data_provider
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/os_ar_barcode_detection_provider)*