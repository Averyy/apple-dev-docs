...
```swift
extern ar_strings_t ar_accessory_copy_location_names(ar_accessory_t accessory);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_accessory_copy_location_names)*