...
ARKit produces this error when an app passes invalid data into the [`update(with:)`](arsession/update(with:).md) function.
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/arerror/code/invalidcollaborationdata)*