...
Call [`isSupported`](arconfiguration/issupported.md) on an [`ARConfiguration`](arconfiguration.md) to ensure it’s supported before attempting to create and run it on the session with [`runWithConfiguration:`](arsession/runwithconfiguration:.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/arerror/code/unsupportedconfiguration)*