...
```swift
static var highResolutionFrameCaptureInProgress: ARError.Code { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/arerror/highresolutionframecaptureinprogress)*