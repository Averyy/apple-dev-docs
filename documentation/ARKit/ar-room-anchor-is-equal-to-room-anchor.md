...
```swift
extern bool ar_room_anchor_is_equal_to_room_anchor(ar_room_anchor_t room_anchor, ar_room_anchor_t other_room_anchor);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_room_anchor_is_equal_to_room_anchor)*