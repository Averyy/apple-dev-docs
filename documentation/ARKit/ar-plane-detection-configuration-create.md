...
```swift
extern ar_plane_detection_configuration_t ar_plane_detection_configuration_create();
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_plane_detection_configuration_create)*