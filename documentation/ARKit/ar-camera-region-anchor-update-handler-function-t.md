...
```swift
typedef void (*)(void *, NSObject<OS_ar_camera_region_anchor> *, NSObject<OS_ar_camera_region_anchor> *, NSObject<OS_ar_camera_region_anchor> *) ar_camera_region_anchor_update_handler_function_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_camera_region_anchor_update_handler_function_t)*