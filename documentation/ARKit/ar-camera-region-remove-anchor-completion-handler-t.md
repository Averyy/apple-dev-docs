...
```swift
typedef void (^)(NSObject<OS_ar_camera_region_anchor> *, _Bool, NSObject<OS_ar_error> *) ar_camera_region_remove_anchor_completion_handler_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_camera_region_remove_anchor_completion_handler_t)*