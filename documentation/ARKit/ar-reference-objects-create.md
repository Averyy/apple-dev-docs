...
```swift
extern ar_reference_objects_t ar_reference_objects_create();
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_reference_objects_create)*