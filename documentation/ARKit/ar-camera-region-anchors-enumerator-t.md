...
```swift
typedef _Bool (^)(NSObject<OS_ar_camera_region_anchor> *) ar_camera_region_anchors_enumerator_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_camera_region_anchors_enumerator_t)*