...
```swift
extern ar_geometry_element_t ar_plane_geometry_get_mesh_faces(ar_plane_geometry_t plane_geometry);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/arkit/ar_plane_geometry_get_mesh_faces)*