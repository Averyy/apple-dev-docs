...
### Exposure Events
- [HKCategoryValueAudioExposureEvent.loudEnvironment](hkcategoryvalueaudioexposureevent/loudenvironment.md)
  Exposure to a loud environment.
### Initializers
- [init?(rawValue: Int)](hkcategoryvalueaudioexposureevent/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/healthkit/hkcategoryvalueaudioexposureevent)*