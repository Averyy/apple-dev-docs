...
### Initializers
- [init?(rawValue: Int)](hkaudiogramsensitivitytestside/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/healthkit/hkaudiogramsensitivitytestside)*