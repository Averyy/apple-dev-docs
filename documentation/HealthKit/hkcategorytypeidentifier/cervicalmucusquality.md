...
These samples use values from the [`HKCategoryValueCervicalMucusQuality`](hkcategoryvaluecervicalmucusquality.md) enum.
...
*[View on Apple Developer](https://developer.apple.com/documentation/healthkit/hkcategorytypeidentifier/cervicalmucusquality)*