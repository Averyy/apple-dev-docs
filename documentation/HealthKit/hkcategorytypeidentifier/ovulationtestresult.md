...
These samples use values from the [`HKCategoryValueOvulationTestResult`](hkcategoryvalueovulationtestresult.md) enum.
...
*[View on Apple Developer](https://developer.apple.com/documentation/healthkit/hkcategorytypeidentifier/ovulationtestresult)*