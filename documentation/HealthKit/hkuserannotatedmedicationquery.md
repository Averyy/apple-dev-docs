...
### Initializers
- [init(predicate: NSPredicate?, limit: Int, resultsHandler: (HKUserAnnotatedMedicationQuery, HKUserAnnotatedMedication?, Bool, (any Error)?) -> Void)](hkuserannotatedmedicationquery/init(predicate:limit:resultshandler:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/healthkit/hkuserannotatedmedicationquery)*