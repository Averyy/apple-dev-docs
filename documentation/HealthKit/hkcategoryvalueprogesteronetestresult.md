...
### Test Results
- [HKCategoryValueProgesteroneTestResult.positive](hkcategoryvalueprogesteronetestresult/positive.md)
  The test returned a positive result.
- [HKCategoryValueProgesteroneTestResult.negative](hkcategoryvalueprogesteronetestresult/negative.md)
  The test returned a negative result.
- [HKCategoryValueProgesteroneTestResult.indeterminate](hkcategoryvalueprogesteronetestresult/indeterminate.md)
  The test was inconclusive.
### Initializers
- [init?(rawValue: Int)](hkcategoryvalueprogesteronetestresult/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/healthkit/hkcategoryvalueprogesteronetestresult)*