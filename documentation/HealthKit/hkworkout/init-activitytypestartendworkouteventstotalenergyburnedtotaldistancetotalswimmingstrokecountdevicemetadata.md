...
- `totalSwimmingStrokeCount`: A quantity unit using count units or `nil`. This property sets the workout’s [`totalSwimmingStrokeCount`](hkworkout/totalswimmingstrokecount.md) property.
