...
Use this method to create an [`HKSamplePredicate`](hksamplepredicate.md) instance that you can use to query for [`HKCorrelation`](hkcorrelation.md) objects.

## Parameters

- `correlationType`: A type that matches samples that contain a set of subsamples.
...
*[View on Apple Developer](https://developer.apple.com/documentation/healthkit/hksamplepredicate/correlation(type:predicate:))*