...
The [`HKQuantity`](hkquantity.md) object for this property must use [`count()`](hkunit/count().md) units.
...
*[View on Apple Developer](https://developer.apple.com/documentation/healthkit/hkactivitysummary/applestandhours)*