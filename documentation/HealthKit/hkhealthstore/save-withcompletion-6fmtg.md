...
- `object`: The HealthKit object to be saved. This object can be any concrete subclass of the   class (any of the  ,  ,  , or   classes).
...
*[View on Apple Developer](https://developer.apple.com/documentation/healthkit/hkhealthstore/save(_:withcompletion:)-6fmtg)*