...
### Events
- [HKCategoryValueLowCardioFitnessEvent.lowFitness](hkcategoryvaluelowcardiofitnessevent/lowfitness.md)
  An event that indicates a low level of cardio fitness, based on the VO2 max readings from the user’s Apple Watch.
### Initializers
- [init?(rawValue: Int)](hkcategoryvaluelowcardiofitnessevent/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/healthkit/hkcategoryvaluelowcardiofitnessevent)*