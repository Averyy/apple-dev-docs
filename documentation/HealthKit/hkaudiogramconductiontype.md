...
### Enumeration Cases
- [HKAudiogramConductionType.air](hkaudiogramconductiontype/air.md)
### Initializers
- [init?(rawValue: Int)](hkaudiogramconductiontype/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/healthkit/hkaudiogramconductiontype)*