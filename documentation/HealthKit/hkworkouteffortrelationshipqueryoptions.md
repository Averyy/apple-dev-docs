...
### Initializers
- [init?(rawValue: Int)](hkworkouteffortrelationshipqueryoptions/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/healthkit/hkworkouteffortrelationshipqueryoptions)*