...
### Constants
- [HKCategoryValue.notApplicable](hkcategoryvalue/notapplicable.md)
  A category value for types that don’t have a defined value.
### Initializers
- [init?(rawValue: Int)](hkcategoryvalue/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/healthkit/hkcategoryvalue)*