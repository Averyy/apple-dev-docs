...
### Events
- [HKCategoryValueHeadphoneAudioExposureEvent.sevenDayLimit](hkcategoryvalueheadphoneaudioexposureevent/sevendaylimit.md)
  Exposure to significant audio levels from headphones over a seven-day period.
### Initializers
- [init?(rawValue: Int)](hkcategoryvalueheadphoneaudioexposureevent/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/healthkit/hkcategoryvalueheadphoneaudioexposureevent)*