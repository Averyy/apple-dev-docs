...
### Type Properties
- [static var errorBackgroundWorkoutSessionNotAllowed: HKError.Code](hkerror/errorbackgroundworkoutsessionnotallowed.md)
- [static var errorDataSizeExceeded: HKError.Code](hkerror/errordatasizeexceeded.md)
- [static var errorDomain: String](hkerror/errordomain.md)
- [static var errorNotPermissibleForGuestUserMode: HKError.Code](hkerror/errornotpermissibleforguestusermode.md)
  The app attempted to write HealthKit data while in a Guest User session in visionOS.
- [static var errorWorkoutActivityNotAllowed: HKError.Code](hkerror/errorworkoutactivitynotallowed.md)
- [static var unknownError: HKError.Code](hkerror/unknownerror.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/healthkit/hkerror)*