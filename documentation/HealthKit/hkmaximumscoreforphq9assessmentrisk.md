...
- [HKMaximumScoreForGAD7AssessmentRisk](hkmaximumscoreforgad7assessmentrisk.md)
  Returns the upper bound of the score range for the given GAD-7 risk classification.
- [HKMinimumScoreForGAD7AssessmentRisk](hkminimumscoreforgad7assessmentrisk.md)
  Returns the lower bound of the score range for the given GAD-7 risk classification.
- [HKMinimumScoreForPHQ9AssessmentRisk](hkminimumscoreforphq9assessmentrisk.md)
  Returns the lower bound of the score range for the given PHQ-9 risk classification.


---

*[View on Apple Developer](https://developer.apple.com/documentation/healthkit/hkmaximumscoreforphq9assessmentrisk)*