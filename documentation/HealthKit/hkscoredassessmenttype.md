...
### Initializers
- [convenience init(HKScoredAssessmentTypeIdentifier)](hkscoredassessmenttype/init(_:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/healthkit/hkscoredassessmenttype)*