...
```swift
@NSCopying
var amount: HKQuantity { get }
```

#### Discussion

This is the total correction strength, measured in [`prismDiopter()`](hkunit/prismdiopter().md) units.
...
*[View on Apple Developer](https://developer.apple.com/documentation/healthkit/hkvisionprism/amount)*