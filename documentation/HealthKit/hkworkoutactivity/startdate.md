...
If the [`endDate`](hkworkoutactivity/enddate.md) property is non-`nil`, the activity’s start date must be equal to or earlier than its end date.
...
*[View on Apple Developer](https://developer.apple.com/documentation/healthkit/hkworkoutactivity/startdate)*