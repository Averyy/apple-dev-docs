...
```swift
@NSCopying
var farPupillaryDistance: HKQuantity? { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/healthkit/hkglasseslensspecification/farpupillarydistance)*