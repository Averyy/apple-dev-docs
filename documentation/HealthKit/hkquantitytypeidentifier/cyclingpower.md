...
These samples use power units (described in [`HKUnit`](hkunit.md)) and measure discrete values (described in [`HKQuantityAggregationStyle`](hkquantityaggregationstyle.md)). Cycling power can be automatically collected by peripherals connected to an Apple Watch during cycling workouts.
...
*[View on Apple Developer](https://developer.apple.com/documentation/healthkit/hkquantitytypeidentifier/cyclingpower)*