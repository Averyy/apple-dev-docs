...
```swift
static let workoutEffortScore: HKQuantityTypeIdentifier
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/healthkit/hkquantitytypeidentifier/workouteffortscore)*