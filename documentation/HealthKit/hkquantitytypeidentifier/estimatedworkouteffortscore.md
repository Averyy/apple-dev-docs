...
```swift
static let estimatedWorkoutEffortScore: HKQuantityTypeIdentifier
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/healthkit/hkquantitytypeidentifier/estimatedworkouteffortscore)*