...
- `duration`: The duration of the audio event, in seconds.
...
*[View on Apple Developer](https://developer.apple.com/documentation/corehaptics/chhapticevent/init(audioresourceid:parameters:relativetime:duration:))*