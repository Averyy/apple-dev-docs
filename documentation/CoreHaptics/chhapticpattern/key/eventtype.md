...
The type is a [`CHHapticEvent.EventType`](chhapticevent/eventtype.md) value.
...
*[View on Apple Developer](https://developer.apple.com/documentation/corehaptics/chhapticpattern/key/eventtype)*