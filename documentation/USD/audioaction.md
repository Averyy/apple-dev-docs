...
This prim implements one of two ways to play audio in a scene; to play audio without [`AudioAction`](audioaction.md), use [`SpatialAudio`](https://developer.apple.comhttps://openusd.org/docs/UsdAudio-Proposal.html).
...
*[View on Apple Developer](https://developer.apple.com/documentation/usd/audioaction)*