...
- [static func image(Image) -> Shader.Argument](shader/argument/image(_:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/shader/argument/float4(_:_:_:_:))*