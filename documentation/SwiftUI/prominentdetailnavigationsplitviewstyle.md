...
```swift
@MainActor
@preconcurrency struct ProminentDetailNavigationSplitViewStyle
```
...
- [init()](prominentdetailnavigationsplitviewstyle/init.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/prominentdetailnavigationsplitviewstyle)*