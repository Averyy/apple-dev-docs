...
```swift
@MainActor
@preconcurrency override dynamic func otherMouseDragged(with nsEvent: NSEvent)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/nshostingview/othermousedragged(with:))*