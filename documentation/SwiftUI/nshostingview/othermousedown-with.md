...
```swift
@MainActor
@preconcurrency override dynamic func otherMouseDown(with nsEvent: NSEvent)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/nshostingview/othermousedown(with:))*