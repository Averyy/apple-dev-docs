...
```swift
@MainActor
@preconcurrency override dynamic func rightMouseUp(with nsEvent: NSEvent)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/nshostingview/rightmouseup(with:))*