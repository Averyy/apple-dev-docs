...
```swift
@MainActor
@preconcurrency override dynamic func rightMouseDragged(with nsEvent: NSEvent)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/nshostingview/rightmousedragged(with:))*