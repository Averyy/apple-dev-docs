...
```swift
@MainActor
@preconcurrency override dynamic func mouseDragged(with nsEvent: NSEvent)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/nshostingview/mousedragged(with:))*