...
```swift
@MainActor
@preconcurrency override dynamic func cursorUpdate(with event: NSEvent)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/nshostingview/cursorupdate(with:))*