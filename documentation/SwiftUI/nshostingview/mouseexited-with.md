...
```swift
@MainActor
@preconcurrency override dynamic func mouseExited(with nsEvent: NSEvent)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/nshostingview/mouseexited(with:))*