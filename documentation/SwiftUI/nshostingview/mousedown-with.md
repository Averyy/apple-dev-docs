...
```swift
@MainActor
@preconcurrency override dynamic func mouseDown(with nsEvent: NSEvent)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/nshostingview/mousedown(with:))*