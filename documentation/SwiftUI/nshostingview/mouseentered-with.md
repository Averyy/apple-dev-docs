...
```swift
@MainActor
@preconcurrency override dynamic func mouseEntered(with nsEvent: NSEvent)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/nshostingview/mouseentered(with:))*