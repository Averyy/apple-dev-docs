...
### Creating a keyframe
- [var body: Self.Body](keyframetrackcontent/body-swift.property.md)
  The composition of content that comprise the keyframe track.
- [associatedtype Body : KeyframeTrackContent](keyframetrackcontent/body-swift.associatedtype.md)
- [associatedtype Value : Animatable = Self.Body.Value](keyframetrackcontent/value.md)

## Relationships

### Conforming Types
- [CubicKeyframe](cubickeyframe.md)
- [KeyframeTrackContentBuilder.Conditional](keyframetrackcontentbuilder/conditional.md)
- [LinearKeyframe](linearkeyframe.md)
- [MoveKeyframe](movekeyframe.md)
- [SpringKeyframe](springkeyframe.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/keyframetrackcontent)*