...
```swift
@MainActor
@preconcurrency static var balanced: BalancedNavigationSplitViewStyle { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/navigationsplitviewstyle/balanced)*