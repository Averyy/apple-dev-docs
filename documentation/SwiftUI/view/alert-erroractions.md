...
```swift
nonisolated
func alert<E, A>(error: Binding<E?>, @ContentBuilder actions: () -> A) -> some View where E : Error, A : View
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/view/alert(error:actions:))*