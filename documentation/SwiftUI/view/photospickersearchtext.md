...
```swift
nonisolated
func photosPickerSearchText(_ searchText: PHPickerSearchText?) -> some View
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/view/photospickersearchtext(_:))*