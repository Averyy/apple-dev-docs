...
You can also control the shape of the picker item background using [`subscriptionStorePickerItemBackground(_:in:)`](view/subscriptionstorepickeritembackground(_:in:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/view/subscriptionstorepickeritembackground(_:))*