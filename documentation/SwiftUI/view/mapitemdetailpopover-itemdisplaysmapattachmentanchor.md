...
Use this modifier if you want the system to choose the best orientation of the popover’s arrow. If you want to specify a particular edge for the arrow, use [`mapItemDetailPopover(item:displaysMap:attachmentAnchor:arrowEdge:)`](view/mapitemdetailpopover(item:displaysmap:attachmentanchor:arrowedge:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/view/mapitemdetailpopover(item:displaysmap:attachmentanchor:))*