...
```swift
nonisolated
func chartXScale<Domain>(domain: Domain, type: ScaleType? = nil) -> some View where Domain : ScaleDomain
```

## Parameters

- `domain`: The possible data values along the x axis in the   chart. You can define the domain with a   for number or    values (e.g.,  ), and with an array for categorical   values (e.g.,  )
- `type`: The scale type.
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/view/chartxscale(domain:type:))*