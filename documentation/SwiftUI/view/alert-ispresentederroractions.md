...
```swift
nonisolated
func alert<E, A>(isPresented: Binding<Bool>, error: E?, @ContentBuilder actions: () -> A) -> some View where E : LocalizedError, A : View
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/view/alert(ispresented:error:actions:))*