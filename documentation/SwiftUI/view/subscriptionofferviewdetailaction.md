...
```swift
nonisolated
func subscriptionOfferViewDetailAction(_ action: (() -> ())?) -> some View
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/view/subscriptionofferviewdetailaction(_:))*