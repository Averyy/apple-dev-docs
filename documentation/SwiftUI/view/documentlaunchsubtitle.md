...
```swift
nonisolated
func documentLaunchSubtitle(_ subtitle: Text) -> some View
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/view/documentlaunchsubtitle(_:))*