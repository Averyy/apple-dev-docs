...
Apply this modifier to the content of a column in a [`NavigationSplitView`](navigationsplitview.md) to specify a fixed preferred width for the column. Use [`navigationSplitViewColumnWidth(min:ideal:max:)`](view/navigationsplitviewcolumnwidth(min:ideal:max:).md) if you need to specify a flexible width.
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/view/navigationsplitviewcolumnwidth(_:))*