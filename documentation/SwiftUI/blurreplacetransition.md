...
```swift
@MainActor
@preconcurrency struct BlurReplaceTransition
```
...
- [BlurReplaceTransition.Configuration](blurreplacetransition/configuration-swift.struct.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/blurreplacetransition)*