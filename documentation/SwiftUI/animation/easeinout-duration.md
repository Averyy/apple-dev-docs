...
Use `easeInOut(duration:)` when you want to specify the time it takes for the animation to complete. Otherwise, use [`easeInOut`](animation/easeinout.md) to perform the animation for a default length of time.
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/animation/easeinout(duration:))*