...
```swift
@frozen
struct HierarchicalShapeStyleModifier<Base> where Base : ShapeStyle
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/hierarchicalshapestylemodifier)*