...
```swift
@MainActor
@preconcurrency struct AccessoryLinearCapacityGaugeStyle
```
...
- [init()](accessorylinearcapacitygaugestyle/init.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/accessorylinearcapacitygaugestyle)*