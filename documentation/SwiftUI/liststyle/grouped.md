...
On iOS, the grouped list style displays a larger header and footer than the [`plain`](liststyle/plain.md) style, which visually distances the members of different sections.
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/liststyle/grouped)*