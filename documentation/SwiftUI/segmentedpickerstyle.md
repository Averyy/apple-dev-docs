...
You can also use [`segmented`](pickerstyle/segmented.md) to construct this style.

## Topics

### Creating the picker style
- [init()](segmentedpickerstyle/init.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/segmentedpickerstyle)*