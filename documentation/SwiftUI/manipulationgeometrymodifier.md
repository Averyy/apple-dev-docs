...
```swift
@MainActor
@preconcurrency struct ManipulationGeometryModifier
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/manipulationgeometrymodifier)*