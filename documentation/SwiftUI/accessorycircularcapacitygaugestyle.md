...
```swift
@MainActor
@preconcurrency struct AccessoryCircularCapacityGaugeStyle
```

#### Overview

Use [`accessoryCircularCapacity`](gaugestyle/accessorycircularcapacity.md) to construct this style.

## Topics

### Creating the gauge style
- [init()](accessorycircularcapacitygaugestyle/init.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/accessorycircularcapacitygaugestyle)*