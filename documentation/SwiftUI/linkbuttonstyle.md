...
- [init()](linkbuttonstyle/init.md)
  Creates a link button style.
### Supporting types
- [func makeBody(configuration: LinkButtonStyle.Configuration) -> some View](linkbuttonstyle/makebody(configuration:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/linkbuttonstyle)*