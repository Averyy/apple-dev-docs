...
- [init(KeyPath<FocusedValues, Binding<Value>?>)](focusedbinding/init(_:).md)
  A new property wrapper for the given key path.
### Getting the value
- [var projectedValue: Binding<Value?>](focusedbinding/projectedvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/focusedbinding)*