...
You can pass this value to a [`contentTransition(_:)`](view/contenttransition(_:).md) modifier to selectively disable animations that would otherwise be applied by a [`withAnimation(_:_:)`](withanimation(_:_:).md) block.
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/contenttransition/identity)*