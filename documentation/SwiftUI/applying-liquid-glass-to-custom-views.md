...
![An image of the Landmarks sample code on iPad, in landscape, showing the Mount Fuji landmark.](/images/com.apple.SwiftUI/liquid-glass-landmarks-hero@2x.png)
...
![Two Image views representing a scribble symbol on the left, and an eraser symbol on the right. The views are close to each other, which causes the Liquid Glass effects to merge the views.](/images/com.apple.SwiftUI/liquid-glass-joined-view@2x.png)
