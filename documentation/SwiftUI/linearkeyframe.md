...
- [init(Value, duration: TimeInterval, timingCurve: UnitCurve)](linearkeyframe/init(_:duration:timingcurve:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/linearkeyframe)*