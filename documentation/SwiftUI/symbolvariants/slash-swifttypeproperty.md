...
Use this variant with a call to the [`symbolVariant(_:)`](view/symbolvariant(_:).md) modifier to draw symbols with a slash, for those symbols that have such a variant:
...
![A screenshot showing two rows of four symbols each. Both rows contain](https://docs-assets.developer.apple.com/published/be96d8406c76a32c883616d2630cdf93/SymbolVariants-slash-1%402x.png)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/symbolvariants/slash-swift.type.property)*