...
You can also use [`palette`](pickerstyle/palette.md) to construct this style.

## Topics

### Creating the picker style
- [init()](palettepickerstyle/init.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/palettepickerstyle)*