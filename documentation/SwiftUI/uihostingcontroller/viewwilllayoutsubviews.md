...
```swift
@MainActor
@preconcurrency override dynamic func viewWillLayoutSubviews()
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/uihostingcontroller/viewwilllayoutsubviews())*