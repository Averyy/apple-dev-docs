...
```swift
@MainActor
@preconcurrency override dynamic func willMove(toParent parent: UIViewController?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/uihostingcontroller/willmove(toparent:))*