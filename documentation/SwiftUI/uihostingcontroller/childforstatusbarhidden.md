...
```swift
@MainActor
@preconcurrency override dynamic var childForStatusBarHidden: UIViewController? { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/uihostingcontroller/childforstatusbarhidden)*