...
```swift
@MainActor
@preconcurrency override dynamic var childForStatusBarStyle: UIViewController? { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/uihostingcontroller/childforstatusbarstyle)*