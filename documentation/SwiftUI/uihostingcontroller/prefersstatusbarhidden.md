...
```swift
@MainActor
@preconcurrency override dynamic var prefersStatusBarHidden: Bool { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/uihostingcontroller/prefersstatusbarhidden)*