...
```swift
@MainActor
@frozen @preconcurrency struct EmptyControlWidgetTemplate
```

## Topics

### Initializers
- [init()](emptycontrolwidgettemplate/init.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/emptycontrolwidgettemplate)*