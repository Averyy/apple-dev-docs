...
nonisolated init(_ title: LocalizedStringResource, image name: String, description: Text? = nil)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/contentunavailableview/init(_:image:description:))*