...
```swift
@MainActor
@preconcurrency struct MinimumValueLabel
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/gaugestyleconfiguration/minimumvaluelabel-swift.struct)*