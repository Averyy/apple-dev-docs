...
```swift
nonisolated
init(initialValue: Value, trigger: some Equatable, @ContentBuilder content: @escaping (Value) -> Content, @KeyframesBuilder<Value> keyframes: @escaping (Value) -> KeyframePath)
```
