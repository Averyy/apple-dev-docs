...
```swift
nonisolated
init(initialValue: Value, repeating: Bool = true, @ContentBuilder content: @escaping (Value) -> Content, @KeyframesBuilder<Value> keyframes: @escaping (Value) -> KeyframePath)
```
