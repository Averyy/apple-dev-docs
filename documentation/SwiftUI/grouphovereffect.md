...
Use the [`hoverEffectGroup(_:)`](customhovereffect/hovereffectgroup(_:)-swift.type.method.md) or [`hoverEffectGroup(id:in:behavior:)`](customhovereffect/hovereffectgroup(id:in:behavior:)-swift.type.method.md) methods to construct a [`GroupHoverEffect`](grouphovereffect.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/grouphovereffect)*