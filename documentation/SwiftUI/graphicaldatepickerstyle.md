...
You can also use [`graphical`](datepickerstyle/graphical.md) to construct this style.

## Topics

### Creating the date picker style
- [init()](graphicaldatepickerstyle/init.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/graphicaldatepickerstyle)*