...
If you want to specify the input directly in terms of width and height, use [`defaultSize(width:height:)`](scene/defaultsize(width:height:).md) instead.
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/scene/defaultsize(_:))*