...
```swift
@MainActor
@preconcurrency class var sashColor: Color? { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/wkusernotificationhostingcontroller/sashcolor)*