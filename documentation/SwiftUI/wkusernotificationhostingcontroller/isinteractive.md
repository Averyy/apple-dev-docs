...
```swift
@MainActor
@preconcurrency class var isInteractive: Bool { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/wkusernotificationhostingcontroller/isinteractive)*