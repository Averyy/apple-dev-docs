...
- `prompt`: A   which provides users with guidance on what to enter   into the text field.
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/textfield/init(value:formatter:prompt:label:))*