...
nonisolated static var linear: LinearProgressViewStyle { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/progressviewstyle/linear)*