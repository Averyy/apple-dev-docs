...
SwiftUI calls this method before calling the [`makeUIViewController(context:)`](uiviewcontrollerrepresentable/makeuiviewcontroller(context:).md) method. The system provides your coordinator either directly or as part of a context structure when calling the other methods of your representable instance.
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/uiviewcontrollerrepresentable/makecoordinator())*