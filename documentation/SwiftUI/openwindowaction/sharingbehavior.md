...
### Type Properties
- [static let requested: OpenWindowAction.SharingBehavior](openwindowaction/sharingbehavior/requested.md)
...
- [static let required: OpenWindowAction.SharingBehavior](openwindowaction/sharingbehavior/required.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/openwindowaction/sharingbehavior)*