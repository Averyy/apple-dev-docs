...
You can also use [`inline`](pickerstyle/inline.md) to construct this style.

## Topics

### Creating the picker style
- [init()](inlinepickerstyle/init.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/inlinepickerstyle)*