...
Use [`borderedProminent`](primitivebuttonstyle/borderedprominent.md) to construct this style.

## Topics

### Creating the button style
- [init()](borderedprominentbuttonstyle/init.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/borderedprominentbuttonstyle)*