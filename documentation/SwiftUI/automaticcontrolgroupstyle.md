...
You can also use [`automatic`](controlgroupstyle/automatic.md) to construct this style.
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/automaticcontrolgroupstyle)*