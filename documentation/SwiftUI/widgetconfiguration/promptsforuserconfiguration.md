...
```swift
@MainActor
@preconcurrency func promptsForUserConfiguration() -> some WidgetConfiguration
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/widgetconfiguration/promptsforuserconfiguration())*