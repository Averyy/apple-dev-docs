...
You might want to set this pointer style explicitly using the [`pointerStyle(_:)`](view/pointerstyle(_:).md) modifier to override another style in the environment.
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/pointerstyle/default)*