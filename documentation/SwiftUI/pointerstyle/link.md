...
This pointer style displays a pointing hand. You may apply this pointer style to a single view or a view hierarchy using the [`pointerStyle(_:)`](view/pointerstyle(_:).md) modifier.
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/pointerstyle/link)*