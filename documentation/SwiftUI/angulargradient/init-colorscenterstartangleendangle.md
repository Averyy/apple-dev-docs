...
nonisolated init(colors: [Color], center: UnitPoint, startAngle: Angle, endAngle: Angle)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/angulargradient/init(colors:center:startangle:endangle:))*