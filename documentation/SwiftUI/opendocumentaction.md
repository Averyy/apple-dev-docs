...
### Calling the action
- [func callAsFunction(at: URL) async throws](opendocumentaction/callasfunction(at:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/opendocumentaction)*