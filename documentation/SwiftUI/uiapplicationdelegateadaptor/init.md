...
If your delegate isn’t observable, SwiftUI invokes the [`init(_:)`](uiapplicationdelegateadaptor/init(_:)-59sfu.md) initializer rather than this one, and doesn’t put the delegate instance in the environment.

## Parameters

- `delegateType`: The type of application delegate that you define in your app, which conforms to the [`UIApplicationDelegate`](https://developer.apple.com/documentation/UIKit/UIApplicationDelegate) and [`Observable`](https://developer.apple.com/documentation/Observation/Observable) protocols.


---

*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/uiapplicationdelegateadaptor/init(_:))*