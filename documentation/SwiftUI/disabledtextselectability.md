...
Don’t use this type directly. Instead, use [`disabled`](textselectability/disabled.md).

## Relationships

### Conforms To
- [TextSelectability](textselectability.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/disabledtextselectability)*