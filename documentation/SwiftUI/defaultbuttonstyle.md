...
- [init()](defaultbuttonstyle/init.md)
  Creates a default button style.
### Supporting types
- [func makeBody(configuration: DefaultButtonStyle.Configuration) -> some View](defaultbuttonstyle/makebody(configuration:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/defaultbuttonstyle)*