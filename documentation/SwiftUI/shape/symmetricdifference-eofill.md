...
```swift
nonisolated
func symmetricDifference<T>(_ other: T, eoFill: Bool = false) -> some Shape where T : Shape
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/shape/symmetricdifference(_:eofill:))*