...
```swift
@MainActor
@preconcurrency static var compactMenu: CompactMenuControlGroupStyle { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/controlgroupstyle/compactmenu)*