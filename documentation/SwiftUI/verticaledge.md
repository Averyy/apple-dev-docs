...
### Getting the edges
- [VerticalEdge.top](verticaledge/top.md)
  The top edge.
- [VerticalEdge.bottom](verticaledge/bottom.md)
  The bottom edge.
### Accessing sets of edges
- [VerticalEdge.Set](verticaledge/set.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/verticaledge)*