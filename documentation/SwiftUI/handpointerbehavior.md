...
### Type Properties
- [static let drawing: HandPointerBehavior](handpointerbehavior/drawing.md)
  Enables the hand pointer refined for drawing.
- [static let inactive: HandPointerBehavior](handpointerbehavior/inactive.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/handpointerbehavior)*