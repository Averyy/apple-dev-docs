...
```swift
static let automatic: ToolbarItemVisibilityPriority
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/toolbaritemvisibilitypriority/automatic)*