...
nonisolated init(_ titleResource: LocalizedStringResource, image name: String)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/label/init(_:image:))*