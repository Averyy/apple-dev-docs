...
```swift
@MainActor
@preconcurrency static var borderedProminent: BorderedProminentButtonStyle { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/primitivebuttonstyle/borderedprominent)*