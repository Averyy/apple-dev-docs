...
- [init()](circulargaugestyle/init.md)
  Creates a circular gauge.
- [init(tint:)](circulargaugestyle/init(tint:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/swiftui/circulargaugestyle)*