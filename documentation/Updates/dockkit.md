...
Browse notable changes in [`DockKit`](https://developer.apple.comhttps://developer.apple.com/documentation/dockkit).
...
*[View on Apple Developer](https://developer.apple.com/documentation/updates/dockkit)*