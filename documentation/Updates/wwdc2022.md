...
- [@MainActor class UIFindInteraction](../UIKit/UIFindInteraction.md)
  An interaction that provides text finding and replacing operations using a system find panel.
- [@MainActor class UIEditMenuInteraction](../UIKit/UIEditMenuInteraction.md)
  An interaction that provides edit operations using a menu.
- [@MainActor var interactionActivityTrackingBaseName: String? { get set }](../UIKit/UIViewController/interactionActivityTrackingBaseName.md)
...
- [@MainActor class UIPageControl](../UIKit/UIPageControl.md)
  A control that displays a horizontal series of dots, each of which corresponds to a page in the app’s document or other data-model entity.
- [@MainActor class UICalendarView](../UIKit/UICalendarView.md)
...
- [@MainActor class NSComboButton](../AppKit/NSComboButton.md)
  A button with a pull-down menu and a default action.
- [protocol NSPreviewRepresentableActivityItem : NSObjectProtocol](../AppKit/NSPreviewRepresentableActivityItem.md)
...
### Shared with You
- [Shared With You](../SharedWithYou-technology/SharedWithYou-technology.md)
  Surface shared content and collaborate in your app.
- [@MainActor class SWAttributionView](../SharedWithYou/SWAttributionView.md)
...
- [protocol SWHighlightCenterDelegate : NSObjectProtocol](../SharedWithYou/SWHighlightCenterDelegate.md)
...
- [var isCameraAssistanceEnabled: Bool { get set }](../NearbyInteraction/NINearbyPeerConfiguration/isCameraAssistanceEnabled.md)
...
- [protocol MTLDevice : NSObjectProtocol, Sendable](../Metal/MTLDevice.md)
