...
- To identify a task during debugging, you can set a name for a detached task using [`init(name:priority:operation:)`](https://developer.apple.com/documentation/Swift/Task/init(name:priority:operation:)-43wmk), and for a task in a task group using [`addTask(name:priority:operation:)`](https://developer.apple.com/documentation/Swift/TaskGroup/addTask(name:priority:operation:)). Access the current task’s name using doc://com.apple.documentation/documentation/Swift/Task/name.
