...
*[View on Apple Developer](https://developer.apple.com/documentation/managedappdistribution/managedcontentview/searchable(text:tokens:ispresented:placement:prompt:token:)-72po0)*