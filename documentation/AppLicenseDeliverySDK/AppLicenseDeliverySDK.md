...
You can download this SDK from [`Downloads`](https://developer.apple.comhttps://developer.apple.com/download/all/) if your developer account qualifies to distribute apps from your website. For more information, see  [`Distributing your app from your website`](https://developer.apple.com/documentation/marketplacekit/distributing-your-app-from-your-website).
