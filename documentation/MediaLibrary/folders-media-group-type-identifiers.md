...
### Constants
- [let MLFolderRootGroupTypeIdentifier: String](mlfolderrootgrouptypeidentifier.md)
  The root media group for folder-based media.
- [let MLFolderGroupTypeIdentifier: String](mlfoldergrouptypeidentifier.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/medialibrary/folders-media-group-type-identifiers)*