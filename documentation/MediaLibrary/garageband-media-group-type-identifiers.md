...
### Constants
- [let MLGarageBandRootGroupTypeIdentifier: String](mlgaragebandrootgrouptypeidentifier.md)
  The root media group for GarageBand.
- [let MLGarageBandFolderGroupTypeIdentifier: String](mlgaragebandfoldergrouptypeidentifier.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/medialibrary/garageband-media-group-type-identifiers)*