...
### Constants
- [MLMediaType.audio](mlmediatype/audio.md)
  Audio media type.
- [MLMediaType.image](mlmediatype/image.md)
  Image media type.
- [MLMediaType.movie](mlmediatype/movie.md)
  Video media type.
### Initializers
- [init?(rawValue: UInt)](mlmediatype/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/medialibrary/mlmediatype)*