# vmnet_return_t.VMNET_INVALID_ACCESS
...
Indicates failure due to insufficient permissions.
...
*[View on Apple Developer](https://developer.apple.com/documentation/vmnet/vmnet_return_t/vmnet_invalid_access)*