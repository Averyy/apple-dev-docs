# vmnet_return_t.VMNET_BUFFER_EXHAUSTED
...
Indicates failure due to buffers being temporarily exhausted in the kernel.
...
*[View on Apple Developer](https://developer.apple.com/documentation/vmnet/vmnet_return_t/vmnet_buffer_exhausted)*