# vmnet_return_t.VMNET_SETUP_INCOMPLETE
...
Indicates failure due to an incomplete interface setup.
...
*[View on Apple Developer](https://developer.apple.com/documentation/vmnet/vmnet_return_t/vmnet_setup_incomplete)*