...
**Availability**:
- App Store Server Notifications 2.21+

## Declaration

```swift
timestamp commitmentExpiresDate
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreservernotifications/commitmentexpiresdate)*