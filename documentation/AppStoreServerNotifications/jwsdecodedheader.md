...
The App Store signs transaction and renewal information that you receive in [`App Store Server Notifications V2`](app-store-server-notifications-v2.md) and in the [`App Store Server API`](https://developer.apple.com/documentation/AppStoreServerAPI). It uses the following `x5c` certificate chain, in the following order:
