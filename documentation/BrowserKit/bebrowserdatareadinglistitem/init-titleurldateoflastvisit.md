# init(title:url:dateOfLastVisit:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/browserkit/bebrowserdatareadinglistitem/init(title:url:dateoflastvisit:))*