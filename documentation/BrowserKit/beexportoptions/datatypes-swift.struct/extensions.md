...
```swift
static var extensions: BEExportOptions.DataTypes { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/browserkit/beexportoptions/datatypes-swift.struct/extensions)*