...
```swift
static var readingList: BEExportOptions.DataTypes { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/browserkit/beexportoptions/datatypes-swift.struct/readinglist)*