...
```swift
var redirectDestinationDateOfVisit: Date? { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/browserkit/bebrowserdatahistoryvisit/redirectdestinationdateofvisit)*