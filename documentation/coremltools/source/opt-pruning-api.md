...
url: https://apple.github.io/coremltools/docs-guides/source/opt-pruning-api.html
---
...
- [.md](../_sources/source/opt-pruning-api.md)
- **
...
For more details, refer to [PyTorch Conversion Workflow](convert-pytorch-workflow.md).
