---
source: coremltools
url: https://apple.github.io/coremltools/docs-guides/source/stateful-models.html
---
...
- [.md](../_sources/source/stateful-models.md)
- **
...
The code for converting and deploying Mistral 7B model is released in [Hugging Face Mistral7B Example](https://github.com/huggingface/swift-transformers/blob/preview/Examples/Mistral7B/export.py) along with the
