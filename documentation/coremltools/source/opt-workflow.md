...
url: https://apple.github.io/coremltools/docs-guides/source/opt-workflow.html
---
...
- [.md](../_sources/source/opt-workflow.md)
- **
...
- [Post-training data-free compression](#post-training-data-free-compression)
- [Post-training calibration data based compression](#post-training-calibration-data-based-compression)
- [Model fine-tuning based compression](#model-fine-tuning-based-compression)
- [APIs for each workflow](#apis-for-each-workflow)
...
- [Quantizing activations to 8 bits](opt-quantization-api.md) for latency gains on the Neural Engine.
...
To find a list of APIs, see [What’s New](opt-whats-new.html#core-ml-tools-optimization-apis).
...
[palettization](https://apple.github.io/coremltools/_examples/dkm_palettization.md),
[quantization](https://apple.github.io/coremltools/_examples/linear_quantization.md),
and
[pruning](https://apple.github.io/coremltools/_examples/magnitude_pruning.md)
