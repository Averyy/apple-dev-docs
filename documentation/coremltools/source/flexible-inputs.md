...
url: https://apple.github.io/coremltools/docs-guides/source/flexible-inputs.html
---
...
- [.md](../_sources/source/flexible-inputs.md)
- **
...
1. Defines the model `TestConvModule` using [torch.nn.Module](https://pytorch.org/docs/stable/generated/torch.nn.Module.md), the base class for neural network modules, and traces the model with random input.
...
Torch.Export Dynamism

If the source PyTorch model is exported by [torch.export.export](https://pytorch.org/docs/stable/export.html#torch.export.export), then user will need to [express dynamism in torch.export](https://pytorch.org/docs/stable/export.html#expressing-dynamism), and only the torch.export dynamic dimensions are allowed to have more-than-1 possible sizes, see [Model Exporting](model-exporting.md).
