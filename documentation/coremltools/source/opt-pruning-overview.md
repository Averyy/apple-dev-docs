...
url: https://apple.github.io/coremltools/docs-guides/source/opt-pruning-overview.html
---
...
- [.md](../_sources/source/opt-pruning-overview.md)
- **
...
using a *sparse* representation rather than the typical *dense*
...
![Creating a sparse representation](../_images/sparse_weights.png)
