...
url: https://apple.github.io/coremltools/docs-guides/source/opt-quantization-overview.html
---
...
- [.md](../_sources/source/opt-quantization-overview.md)
- **
...
Unlike the [Pruning](opt-pruning.md) or [Palettization](opt-palettization.md) compression schemes
