...
```swift
typedef struct nicproxy_inet_info_s nicproxy_inet_info_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/networkingdriverkit/nicproxy_inet_info_t)*