...
```swift
struct rr_null_record_s;
```

## Topics

### Instance Properties
- [data](rr_null_record_s/data.md)
- [rr_record](rr_null_record_s/rr_record.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/networkingdriverkit/rr_null_record_s)*