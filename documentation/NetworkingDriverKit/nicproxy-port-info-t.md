...
```swift
typedef struct nicproxy_port_info_s nicproxy_port_info_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/networkingdriverkit/nicproxy_port_info_t)*