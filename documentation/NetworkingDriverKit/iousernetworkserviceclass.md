...
```swift
typedef uint32_t IOUserNetworkServiceClass;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/networkingdriverkit/iousernetworkserviceclass)*