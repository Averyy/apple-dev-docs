...
```swift
#define IOUSERNETWORKKEEPALIVEOFFLOADFRAME_AIRPLAY
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/networkingdriverkit/iousernetworkkeepaliveoffloadframe_airplay)*