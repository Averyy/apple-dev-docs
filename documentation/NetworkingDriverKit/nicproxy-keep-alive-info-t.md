...
```swift
typedef struct nicproxy_keep_alive_info_s nicproxy_keep_alive_info_t;
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/networkingdriverkit/nicproxy_keep_alive_info_t)*