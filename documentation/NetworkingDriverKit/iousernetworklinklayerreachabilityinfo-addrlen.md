...
```swift
#define IOUSERNETWORKLINKLAYERREACHABILITYINFO_ADDRLEN
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/networkingdriverkit/iousernetworklinklayerreachabilityinfo_addrlen)*