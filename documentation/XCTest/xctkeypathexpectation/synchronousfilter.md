...
```swift
typealias SynchronousFilter = (T, NSKeyValueObservedChange<V>) -> Bool
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/xctest/xctkeypathexpectation/synchronousfilter)*