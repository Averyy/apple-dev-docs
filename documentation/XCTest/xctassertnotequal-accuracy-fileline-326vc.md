...
- `accuracy`: An expression of type  , where   conforms to  . This parameter describes the maximum difference between   and   for these values to be considered not equal.
