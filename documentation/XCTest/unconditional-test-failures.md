...
### Unconditional Test Failures
- [func XCTFail(String, file: StaticString, line: UInt)](xctfail(_:file:line:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/xctest/unconditional-test-failures)*