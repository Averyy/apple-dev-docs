...
```swift
func wait(for expectations: [XCTestExpectation], enforceOrder enforceOrderOfFulfillment: Bool) -> XCTWaiter.Result
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/xctest/xctwaiter/wait(for:enforceorder:)-swift.method)*