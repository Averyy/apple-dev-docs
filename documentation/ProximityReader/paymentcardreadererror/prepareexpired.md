...
This error occurs when too much time elapses after calling the [`prepare(using:)`](paymentcardreader/prepare(using:).md) method. Call the method again.
...
*[View on Apple Developer](https://developer.apple.com/documentation/proximityreader/paymentcardreadererror/prepareexpired)*