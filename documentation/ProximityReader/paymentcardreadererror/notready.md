# PaymentCardReaderError.notReady
...
Prepare the session again to try and resolve the issue.
...
*[View on Apple Developer](https://developer.apple.com/documentation/proximityreader/paymentcardreadererror/notready)*