...
The merchant has already accepted the Terms and Conditions. Your app needs to call [`prepare(using:)`](paymentcardreader/prepare(using:).md) to configure the device.
...
*[View on Apple Developer](https://developer.apple.com/documentation/proximityreader/paymentcardreadererror/accountalreadylinked)*