...
The merchant must accept the Terms and Conditions before configuring the device. See [`linkAccount(using:)`](paymentcardreader/linkaccount(using:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/proximityreader/paymentcardreadererror/accountnotlinked)*