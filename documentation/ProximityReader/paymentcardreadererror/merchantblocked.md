# PaymentCardReaderError.merchantBlocked
...
This merchant has been restricted from using Tap to Pay on iPhone.
...
*[View on Apple Developer](https://developer.apple.com/documentation/proximityreader/paymentcardreadererror/merchantblocked)*