...
Generate a new reader token and call [`prepare(using:)`](mobiledocumentreader/prepare(using:).md) again.
...
*[View on Apple Developer](https://developer.apple.com/documentation/proximityreader/mobiledocumentreadererror/sessionexpired)*