...
```swift
var nonRetainedElements: [MobilePhotoIDRawDataRequest.Element]
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/proximityreader/mobilephotoidrawdatarequest/nonretainedelements)*