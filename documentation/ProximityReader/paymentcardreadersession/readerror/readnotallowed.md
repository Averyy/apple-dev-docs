# PaymentCardReaderSession.ReadError.readNotAllowed
...
*[View on Apple Developer](https://developer.apple.com/documentation/proximityreader/paymentcardreadersession/readerror/readnotallowed)*