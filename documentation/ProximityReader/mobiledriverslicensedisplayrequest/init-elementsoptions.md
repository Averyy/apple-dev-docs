...
```swift
init(elements: [MobileDriversLicenseDisplayRequest.Element] = [], options: MobileDriversLicenseDisplayRequest.Options = .init())
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/proximityreader/mobiledriverslicensedisplayrequest/init(elements:options:))*