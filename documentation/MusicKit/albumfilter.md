...
### Instance Properties
- [var id: MusicItemID](albumfilter/id.md)
  The unique identifier for the album.
- [var upc: String?](albumfilter/upc.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/musickit/albumfilter)*