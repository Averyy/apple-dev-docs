...
*[View on Apple Developer](https://developer.apple.com/documentation/musickit/artworkimage/searchable(text:editabletokens:ispresented:placement:prompt:token:)-8mr68)*