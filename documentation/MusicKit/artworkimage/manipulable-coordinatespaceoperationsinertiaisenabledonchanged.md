...
*[View on Apple Developer](https://developer.apple.com/documentation/musickit/artworkimage/manipulable(coordinatespace:operations:inertia:isenabled:onchanged:))*