...
*[View on Apple Developer](https://developer.apple.com/documentation/musickit/artworkimage/frame(minwidth:idealwidth:maxwidth:minheight:idealheight:maxheight:alignment:))*