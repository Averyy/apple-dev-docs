...
*[View on Apple Developer](https://developer.apple.com/documentation/musickit/artworkimage/dismissalconfirmationdialog(_:shouldpresent:actions:message:)-8mrni)*