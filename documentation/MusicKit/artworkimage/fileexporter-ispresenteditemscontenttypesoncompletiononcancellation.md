...
*[View on Apple Developer](https://developer.apple.com/documentation/musickit/artworkimage/fileexporter(ispresented:items:contenttypes:oncompletion:oncancellation:))*