...
- [func controlSize(ControlSize) -> some View](artworkimage/controlsize(_:).md)
...
- [func gesture(some UIGestureRecognizerRepresentable) -> some View](artworkimage/gesture(_:).md)
...
- [func ornament<Content>(visibility: Visibility, attachmentAnchor: OrnamentAttachmentAnchor, contentAlignment: Alignment, ornament: () -> Content) -> some View](artworkimage/ornament(visibility:attachmentanchor:contentalignment:ornament:).md)
...
- [func sensoryFeedback<T>(trigger: T, (T, T) -> SensoryFeedback?) -> some View](artworkimage/sensoryfeedback(trigger:_:).md)
