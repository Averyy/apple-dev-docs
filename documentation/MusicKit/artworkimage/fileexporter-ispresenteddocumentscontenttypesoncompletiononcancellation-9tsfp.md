...
*[View on Apple Developer](https://developer.apple.com/documentation/musickit/artworkimage/fileexporter(ispresented:documents:contenttypes:oncompletion:oncancellation:)-9tsfp)*