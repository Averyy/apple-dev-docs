...
*[View on Apple Developer](https://developer.apple.com/documentation/musickit/artworkimage/fileexporter(ispresented:documents:contenttype:oncompletion:)-4a6wl)*