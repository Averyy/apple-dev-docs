...
*[View on Apple Developer](https://developer.apple.com/documentation/musickit/artworkimage/manipulable(transform:coordinatespace:operations:inertia:isenabled:onchanged:))*