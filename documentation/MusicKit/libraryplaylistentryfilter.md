...
### Instance Properties
- [var id: MusicItemID](libraryplaylistentryfilter/id.md)
  The unique identifier for the playlist entry.


---

*[View on Apple Developer](https://developer.apple.com/documentation/musickit/libraryplaylistentryfilter)*