...
### Instance Properties
- [var id: MusicItemID](songfilter/id.md)
  The unique identifier for the song.
- [var isrc: String?](songfilter/isrc.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/musickit/songfilter)*