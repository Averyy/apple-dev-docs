...
```swift
var endIndex: MusicItemCollection<MusicItemType>.Index { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/musickit/musicitemcollection/endindex)*