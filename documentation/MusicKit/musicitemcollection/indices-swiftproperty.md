...
```swift
var indices: MusicItemCollection<MusicItemType>.Indices { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/musickit/musicitemcollection/indices-swift.property)*