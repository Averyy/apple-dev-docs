...
```swift
subscript(position: MusicItemCollection<MusicItemType>.Index) -> MusicItemCollection<MusicItemType>.Element { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/musickit/musicitemcollection/subscript(_:)-766rl)*