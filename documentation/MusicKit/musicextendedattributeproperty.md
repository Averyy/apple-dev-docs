...
### Instance Properties
- [var description: String](musicextendedattributeproperty/description.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/musickit/musicextendedattributeproperty)*