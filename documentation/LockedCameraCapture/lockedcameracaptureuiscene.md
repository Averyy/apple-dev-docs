...
### Instance Properties
- [var body: some AppExtensionScene](lockedcameracaptureuiscene/body-swift.property.md)
...
### Type Aliases
- [LockedCameraCaptureUIScene.Body](lockedcameracaptureuiscene/body-swift.typealias.md)
