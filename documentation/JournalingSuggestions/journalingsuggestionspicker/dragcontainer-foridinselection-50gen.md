...
*[View on Apple Developer](https://developer.apple.com/documentation/journalingsuggestions/journalingsuggestionspicker/dragcontainer(for:id:in:selection:_:)-50gen)*