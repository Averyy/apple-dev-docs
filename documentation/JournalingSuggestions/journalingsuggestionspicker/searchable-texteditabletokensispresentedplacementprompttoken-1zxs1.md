...
*[View on Apple Developer](https://developer.apple.com/documentation/journalingsuggestions/journalingsuggestionspicker/searchable(text:editabletokens:ispresented:placement:prompt:token:)-1zxs1)*