...
- `string`: The string to use as a type select equivalent for a   view in a collection.


---

*[View on Apple Developer](https://developer.apple.com/documentation/journalingsuggestions/journalingsuggestionspicker/typeselectequivalent(_:)-4b6dl)*