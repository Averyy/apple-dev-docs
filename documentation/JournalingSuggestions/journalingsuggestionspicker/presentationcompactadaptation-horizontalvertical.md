...
*[View on Apple Developer](https://developer.apple.com/documentation/journalingsuggestions/journalingsuggestionspicker/presentationcompactadaptation(horizontal:vertical:))*