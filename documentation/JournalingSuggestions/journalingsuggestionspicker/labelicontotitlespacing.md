...
```swift
nonisolated
func labelIconToTitleSpacing(_ value: CGFloat) -> some View
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/journalingsuggestions/journalingsuggestionspicker/labelicontotitlespacing(_:))*