...
*[View on Apple Developer](https://developer.apple.com/documentation/journalingsuggestions/journalingsuggestionspicker/contextmenu(forselectiontype:menu:primaryaction:))*