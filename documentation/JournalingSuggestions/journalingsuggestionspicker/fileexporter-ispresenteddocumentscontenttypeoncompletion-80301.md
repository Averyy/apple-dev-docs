...
*[View on Apple Developer](https://developer.apple.com/documentation/journalingsuggestions/journalingsuggestionspicker/fileexporter(ispresented:documents:contenttype:oncompletion:)-80301)*