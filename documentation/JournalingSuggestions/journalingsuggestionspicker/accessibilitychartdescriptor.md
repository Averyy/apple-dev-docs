...
- `chartDescriptor`: The    used to describe your chart and its data.


---

*[View on Apple Developer](https://developer.apple.com/documentation/journalingsuggestions/journalingsuggestionspicker/accessibilitychartdescriptor(_:))*