...
- `dismissal`: The menu action dismissal behavior to apply.


---

*[View on Apple Developer](https://developer.apple.com/documentation/journalingsuggestions/journalingsuggestionspicker/menuactiondismissbehavior(_:))*