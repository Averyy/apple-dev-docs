...
*[View on Apple Developer](https://developer.apple.com/documentation/journalingsuggestions/journalingsuggestionspicker/searchable(text:editabletokens:placement:prompt:token:)-8uku9)*