...
- `object`: The observable object to associate with focus, or   if   no object is currently available.


---

*[View on Apple Developer](https://developer.apple.com/documentation/journalingsuggestions/journalingsuggestionspicker/focusedobject(_:)-84i41)*