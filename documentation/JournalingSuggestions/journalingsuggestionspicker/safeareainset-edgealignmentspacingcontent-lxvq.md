...
*[View on Apple Developer](https://developer.apple.com/documentation/journalingsuggestions/journalingsuggestionspicker/safeareainset(edge:alignment:spacing:content:)-lxvq)*