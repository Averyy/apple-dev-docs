...
*[View on Apple Developer](https://developer.apple.com/documentation/journalingsuggestions/journalingsuggestionspicker/swipeactions(edge:allowsfullswipe:content:))*