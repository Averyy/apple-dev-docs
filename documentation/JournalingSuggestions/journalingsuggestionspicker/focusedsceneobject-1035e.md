...
- `object`: The observable object to associate with the scene, or    if no object is currently available.


---

*[View on Apple Developer](https://developer.apple.com/documentation/journalingsuggestions/journalingsuggestionspicker/focusedsceneobject(_:)-1035e)*