...
*[View on Apple Developer](https://developer.apple.com/documentation/journalingsuggestions/journalingsuggestionspicker/dragcontainer(for:in:selection:_:)-4ffff)*