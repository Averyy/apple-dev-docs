...
- `number`: The line limit. If  , no line limit applies.


---

*[View on Apple Developer](https://developer.apple.com/documentation/journalingsuggestions/journalingsuggestionspicker/linelimit(_:)-1ddrr)*