...
- `geometry`: The scroll geometry at the time of the scroll   phase change.


---

*[View on Apple Developer](https://developer.apple.com/documentation/journalingsuggestions/journalingsuggestionspicker/onscrollphasechange(_:)-9xmz0)*