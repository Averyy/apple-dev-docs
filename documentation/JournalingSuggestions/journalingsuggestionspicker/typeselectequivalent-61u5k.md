...
- `text`: The explicit text value to use as a type select   equivalent for a view in a collection.


---

*[View on Apple Developer](https://developer.apple.com/documentation/journalingsuggestions/journalingsuggestionspicker/typeselectequivalent(_:)-61u5k)*