...
- `value`: The focus value to publish, or   if no value is   currently available.


---

*[View on Apple Developer](https://developer.apple.com/documentation/journalingsuggestions/journalingsuggestionspicker/focusedscenevalue(_:_:)-5vzu3)*