...
*[View on Apple Developer](https://developer.apple.com/documentation/journalingsuggestions/journalingsuggestionspicker/keyboardshortcut(_:modifiers:localization:))*