...
*[View on Apple Developer](https://developer.apple.com/documentation/journalingsuggestions/journalingsuggestionspicker/filemover(ispresented:files:oncompletion:oncancellation:))*