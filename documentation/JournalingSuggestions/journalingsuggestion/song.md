...
The system provides an instance of this structure to your app when a person chooses a song suggestion in the [`JournalingSuggestionsPicker`](journalingsuggestionspicker.md).

## Topics

### Identifying the song
- [var song: String?](journalingsuggestion/song/song.md)
  The name of the song.
- [var artist: String?](journalingsuggestion/song/artist.md)
  The song’s musician.
- [var album: String?](journalingsuggestion/song/album.md)
  The album that contains the song.
- [var artwork: URL?](journalingsuggestion/song/artwork.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/journalingsuggestions/journalingsuggestion/song)*