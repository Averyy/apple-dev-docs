...
- [var name: String](journalingsuggestion/contact/name.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/journalingsuggestions/journalingsuggestion/contact)*