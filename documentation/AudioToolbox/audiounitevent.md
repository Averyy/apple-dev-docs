...
### Initializers
- [init()](audiounitevent/init.md)
- [init(mEventType: AudioUnitEventType, mArgument: AudioUnitEvent.__Unnamed_union_mArgument)](audiounitevent/init(meventtype:margument:).md)
### Instance Properties
- [var mArgument: AudioUnitEvent.__Unnamed_union_mArgument](audiounitevent/margument.md)
- [var mEventType: AudioUnitEventType](audiounitevent/meventtype.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/audiounitevent)*