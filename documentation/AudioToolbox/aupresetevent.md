...
### Initializers
- [init(scope: AudioUnitScope, element: AudioUnitElement, preset: Unmanaged<CFPropertyList>)](aupresetevent/init(scope:element:preset:).md)
### Instance Properties
- [var element: AudioUnitElement](aupresetevent/element.md)
- [var preset: Unmanaged<CFPropertyList>](aupresetevent/preset.md)
- [var scope: AudioUnitScope](aupresetevent/scope.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/aupresetevent)*