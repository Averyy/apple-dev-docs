...
### Constants
- [static var spatialMixerRenderingFlags_DistanceAttenuation: AUSpatialMixerRenderingFlags](auspatialmixerrenderingflags/spatialmixerrenderingflags_distanceattenuation.md)
- [static var spatialMixerRenderingFlags_InterAuralDelay: AUSpatialMixerRenderingFlags](auspatialmixerrenderingflags/spatialmixerrenderingflags_interauraldelay.md)
### Initializers
- [init(rawValue: UInt32)](auspatialmixerrenderingflags/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/auspatialmixerrenderingflags)*