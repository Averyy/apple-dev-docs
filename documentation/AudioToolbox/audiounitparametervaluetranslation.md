...
### Initializers
- [init()](audiounitparametervaluetranslation/init.md)
- [init(otherDesc: AudioUnitOtherPluginDesc, otherParamID: UInt32, otherValue: Float32, auParamID: AudioUnitParameterID, auValue: AudioUnitParameterValue)](audiounitparametervaluetranslation/init(otherdesc:otherparamid:othervalue:auparamid:auvalue:).md)
### Instance Properties
- [var auParamID: AudioUnitParameterID](audiounitparametervaluetranslation/auparamid.md)
- [var auValue: AudioUnitParameterValue](audiounitparametervaluetranslation/auvalue.md)
- [var otherDesc: AudioUnitOtherPluginDesc](audiounitparametervaluetranslation/otherdesc.md)
- [var otherParamID: UInt32](audiounitparametervaluetranslation/otherparamid.md)
- [var otherValue: Float32](audiounitparametervaluetranslation/othervalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/audiounitparametervaluetranslation)*