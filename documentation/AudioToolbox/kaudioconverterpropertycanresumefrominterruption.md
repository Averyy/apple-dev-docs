...
If the property is unimplemented (in which case, a call to the [`AudioConverterGetProperty(_:_:_:_:)`](audioconvertergetproperty(_:_:_:_:).md) function for this property returns an error), then the codec is not a hardware codec.
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/kaudioconverterpropertycanresumefrominterruption)*