...
### Initializers
- [init(midiOutputCallback: AUMIDIOutputCallback, userData: UnsafeMutableRawPointer?)](aumidioutputcallbackstruct/init(midioutputcallback:userdata:).md)
### Instance Properties
- [var midiOutputCallback: AUMIDIOutputCallback](aumidioutputcallbackstruct/midioutputcallback.md)
  The callback function for an audio unit that provides MIDI output.
- [var userData: UnsafeMutableRawPointer?](aumidioutputcallbackstruct/userdata.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/aumidioutputcallbackstruct)*