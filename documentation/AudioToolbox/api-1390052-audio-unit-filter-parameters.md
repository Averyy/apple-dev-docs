...
### Constants
- [var kMultibandFilter_Bandwidth1: AudioUnitParameterID](kmultibandfilter_bandwidth1.md)
- [var kMultibandFilter_Bandwidth2: AudioUnitParameterID](kmultibandfilter_bandwidth2.md)
- [var kMultibandFilter_Bandwidth3: AudioUnitParameterID](kmultibandfilter_bandwidth3.md)
- [var kMultibandFilter_CenterFreq1: AudioUnitParameterID](kmultibandfilter_centerfreq1.md)
- [var kMultibandFilter_CenterFreq2: AudioUnitParameterID](kmultibandfilter_centerfreq2.md)
- [var kMultibandFilter_CenterFreq3: AudioUnitParameterID](kmultibandfilter_centerfreq3.md)
- [var kMultibandFilter_CenterGain1: AudioUnitParameterID](kmultibandfilter_centergain1.md)
- [var kMultibandFilter_CenterGain2: AudioUnitParameterID](kmultibandfilter_centergain2.md)
- [var kMultibandFilter_CenterGain3: AudioUnitParameterID](kmultibandfilter_centergain3.md)
- [var kMultibandFilter_HighFilterType: AudioUnitParameterID](kmultibandfilter_highfiltertype.md)
- [var kMultibandFilter_HighFrequency: AudioUnitParameterID](kmultibandfilter_highfrequency.md)
- [var kMultibandFilter_HighGain: AudioUnitParameterID](kmultibandfilter_highgain.md)
- [var kMultibandFilter_LowFilterType: AudioUnitParameterID](kmultibandfilter_lowfiltertype.md)
- [var kMultibandFilter_LowFrequency: AudioUnitParameterID](kmultibandfilter_lowfrequency.md)
- [var kMultibandFilter_LowGain: AudioUnitParameterID](kmultibandfilter_lowgain.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/1390052-audio-unit-filter-parameters)*