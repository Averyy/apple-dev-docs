...
### Initializers
- [init(hostName: Unmanaged<CFString>, hostVersion: AUNumVersion)](auhostidentifier/init(hostname:hostversion:).md)
### Instance Properties
- [var hostName: Unmanaged<CFString>](auhostidentifier/hostname.md)
- [var hostVersion: AUNumVersion](auhostidentifier/hostversion.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/auhostidentifier)*