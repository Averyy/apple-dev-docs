# kAudioCodecPropertyAdjustCompressionProfile
...
```swift
var kAudioCodecPropertyAdjustCompressionProfile: AudioCodecPropertyID { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecpropertyadjustcompressionprofile)*