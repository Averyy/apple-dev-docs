...
### Initializers
- [init()](audependentparameter/init.md)
- [init(mScope: AudioUnitScope, mParameterID: AudioUnitParameterID)](audependentparameter/init(mscope:mparameterid:).md)
### Instance Properties
- [var mParameterID: AudioUnitParameterID](audependentparameter/mparameterid.md)
- [var mScope: AudioUnitScope](audependentparameter/mscope.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/audependentparameter)*