...
### Initializers
- [init()](mixerdistanceparams/init.md)
- [init(mReferenceDistance: Float32, mMaxDistance: Float32, mMaxAttenuation: Float32)](mixerdistanceparams/init(mreferencedistance:mmaxdistance:mmaxattenuation:).md)
### Instance Properties
- [var mMaxAttenuation: Float32](mixerdistanceparams/mmaxattenuation.md)
- [var mMaxDistance: Float32](mixerdistanceparams/mmaxdistance.md)
- [var mReferenceDistance: Float32](mixerdistanceparams/mreferencedistance.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/mixerdistanceparams)*