...
### Properties
- [var element: AudioUnitElement](parameterevent/element.md)
- [var parameterID: AudioUnitParameterID](parameterevent/parameterid.md)
- [var scope: AudioUnitScope](parameterevent/scope.md)
- [var value: AudioUnitParameterValue](parameterevent/value.md)
### Initializers
- [init()](parameterevent/init.md)
- [init(parameterID: AudioUnitParameterID, scope: AudioUnitScope, element: AudioUnitElement, value: AudioUnitParameterValue)](parameterevent/init(parameterid:scope:element:value:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/parameterevent)*