...
### Initializers
- [init()](audiopacketrolldistancetranslation/init.md)
- [init(mPacket: Int64, mRollDistance: Int64)](audiopacketrolldistancetranslation/init(mpacket:mrolldistance:).md)
### Instance Properties
- [var mPacket: Int64](audiopacketrolldistancetranslation/mpacket.md)
- [var mRollDistance: Int64](audiopacketrolldistancetranslation/mrolldistance.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/audiopacketrolldistancetranslation)*