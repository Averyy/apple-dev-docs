...
### Constants
- [var kAudioSessionCategory_UserInterfaceSoundEffects: Int](kaudiosessioncategory_userinterfacesoundeffects.md)
  For sound effects such as touch feedback, explosions, and so on.
- [var kAudioSessionCategory_LiveAudio: Int](kaudiosessioncategory_liveaudio.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/1618459-deprecated-audio-session-categor)*