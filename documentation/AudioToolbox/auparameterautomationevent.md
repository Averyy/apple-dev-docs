...
### Initializers
- [init()](auparameterautomationevent/init.md)
- [init(hostTime: UInt64, address: AUParameterAddress, value: AUValue, eventType: AUParameterAutomationEventType, reserved: UInt64)](auparameterautomationevent/init(hosttime:address:value:eventtype:reserved:).md)
### Instance Properties
- [var address: AUParameterAddress](auparameterautomationevent/address.md)
- [var eventType: AUParameterAutomationEventType](auparameterautomationevent/eventtype.md)
- [var hostTime: UInt64](auparameterautomationevent/hosttime.md)
- [var reserved: UInt64](auparameterautomationevent/reserved.md)
- [var value: AUValue](auparameterautomationevent/value.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/auparameterautomationevent)*