...
### Modes
- [AUSpatialMixerPointSourceInHeadMode.spatialMixerPointSourceInHeadMode_Bypass](auspatialmixerpointsourceinheadmode/spatialmixerpointsourceinheadmode_bypass.md)
- [AUSpatialMixerPointSourceInHeadMode.spatialMixerPointSourceInHeadMode_Mono](auspatialmixerpointsourceinheadmode/spatialmixerpointsourceinheadmode_mono.md)
### Initializers
- [init?(rawValue: UInt32)](auspatialmixerpointsourceinheadmode/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/auspatialmixerpointsourceinheadmode)*