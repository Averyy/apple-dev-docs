...
See [`AUParameterEventType`](auparametereventtype.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/audiounitparameterevent/eventtype)*