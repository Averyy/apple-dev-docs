...
### Initializers
- [init()](audiounitmeterclipping/init.md)
- [init(peakValueSinceLastCall: Float32, sawInfinity: DarwinBoolean, sawNotANumber: DarwinBoolean)](audiounitmeterclipping/init(peakvaluesincelastcall:sawinfinity:sawnotanumber:).md)
### Instance Properties
- [var peakValueSinceLastCall: Float32](audiounitmeterclipping/peakvaluesincelastcall.md)
  The maximum value seen on the channel since the last time the property was retrieved.
- [var sawInfinity: DarwinBoolean](audiounitmeterclipping/sawinfinity.md)
  `TRUE` if there was an infinite value on this channel since the last time the property was retrieved.
- [var sawNotANumber: DarwinBoolean](audiounitmeterclipping/sawnotanumber.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/audiounitmeterclipping)*