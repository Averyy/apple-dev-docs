...
Your application must call this function before making any other Audio Session Services calls. You may activate and deactivate your audio session as needed (see [`AudioSessionSetActive(_:)`](audiosessionsetactive(_:).md)), but should initialize it only once.
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/audiosessioninitialize(_:_:_:_:))*