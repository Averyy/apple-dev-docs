...
### Constants
- [var kAULowShelfParam_CutoffFrequency: AudioUnitParameterID](kaulowshelfparam_cutofffrequency.md)
- [var kAULowShelfParam_Gain: AudioUnitParameterID](kaulowshelfparam_gain.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/1389995-aulowshelf_parameters)*