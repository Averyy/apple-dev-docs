...
```swift
var kAudioUnitProperty_SupportsMPE: AudioUnitPropertyID { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/kaudiounitproperty_supportsmpe)*