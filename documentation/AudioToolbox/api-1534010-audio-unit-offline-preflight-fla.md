...
### Constants
- [var kOfflinePreflight_NotRequired: Int](kofflinepreflight_notrequired.md)
- [var kOfflinePreflight_Optional: Int](kofflinepreflight_optional.md)
- [var kOfflinePreflight_Required: Int](kofflinepreflight_required.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/1534010-audio-unit-offline-preflight-fla)*