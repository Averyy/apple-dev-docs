...
### Initializers
- [init(buffer: UnsafeMutablePointer<UInt8>, size: UInt32)](audiounitexternalbuffer/init(buffer:size:).md)
### Instance Properties
- [var buffer: UnsafeMutablePointer<UInt8>](audiounitexternalbuffer/buffer.md)
- [var size: UInt32](audiounitexternalbuffer/size.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/audiounitexternalbuffer)*