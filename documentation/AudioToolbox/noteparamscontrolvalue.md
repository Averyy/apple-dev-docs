...
### Initializers
- [init()](noteparamscontrolvalue/init.md)
- [init(mID: AudioUnitParameterID, mValue: AudioUnitParameterValue)](noteparamscontrolvalue/init(mid:mvalue:).md)
### Instance Properties
- [var mID: AudioUnitParameterID](noteparamscontrolvalue/mid.md)
- [var mValue: AudioUnitParameterValue](noteparamscontrolvalue/mvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/noteparamscontrolvalue)*