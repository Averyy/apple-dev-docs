...
### Initializers
- [init()](audiounitparameterhistoryinfo/init.md)
- [init(updatesPerSecond: Float32, historyDurationInSeconds: Float32)](audiounitparameterhistoryinfo/init(updatespersecond:historydurationinseconds:).md)
### Instance Properties
- [var historyDurationInSeconds: Float32](audiounitparameterhistoryinfo/historydurationinseconds.md)
- [var updatesPerSecond: Float32](audiounitparameterhistoryinfo/updatespersecond.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/audiounitparameterhistoryinfo)*