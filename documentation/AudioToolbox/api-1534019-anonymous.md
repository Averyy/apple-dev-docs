...
### Constants
- [var kAUSamplerProperty_BankAndPreset: AudioUnitPropertyID](kausamplerproperty_bankandpreset.md)
- [var kAUSamplerProperty_LoadPresetFromBank: AudioUnitPropertyID](kausamplerproperty_loadpresetfrombank.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/1534019-anonymous)*