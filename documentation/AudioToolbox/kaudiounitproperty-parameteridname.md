...
Value is a read-only [`AudioUnitParameterNameInfo`](audiounitparameternameinfo.md) data structure, valid on any audio unit scope.
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/kaudiounitproperty_parameteridname)*