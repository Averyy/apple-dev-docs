...
```swift
var kAudioUnitType_HeadTrackingBinauralRenderer: UInt32 { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/kaudiounittype_headtrackingbinauralrenderer)*