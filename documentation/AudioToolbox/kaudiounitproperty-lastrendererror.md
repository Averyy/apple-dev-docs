...
This property is set if a call to the [`AudioUnitRender(_:_:_:_:_:_:)`](audiounitrender(_:_:_:_:_:_:).md) function returns an error. To be notified of errors, register a callback function as a property listener using the [`AudioUnitAddPropertyListener(_:_:_:_:)`](audiounitaddpropertylistener(_:_:_:_:).md) function.
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/kaudiounitproperty_lastrendererror)*