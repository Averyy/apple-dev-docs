...
### Constants
- [var kAudioUnitSubType_AUiPodTime: UInt32](kaudiounitsubtype_auipodtime.md)
  An iOS audio unit that provides simple, limited control over playback rate and time.
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/1619504-anonymous)*