...
### Flags
- [static var bytePacketTranslationFlag_IsEstimate: AudioBytePacketTranslationFlags](audiobytepackettranslationflags/bytepackettranslationflag_isestimate.md)
  If set, the result value is an estimate.
### Initializers
- [init(rawValue: UInt32)](audiobytepackettranslationflags/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/audiobytepackettranslationflags)*