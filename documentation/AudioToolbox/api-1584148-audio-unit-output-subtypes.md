...
### Constants
- [var kAudioUnitSubType_DefaultOutput: UInt32](kaudiounitsubtype_defaultoutput.md)
- [var kAudioUnitSubType_HALOutput: UInt32](kaudiounitsubtype_haloutput.md)
- [var kAudioUnitSubType_SystemOutput: UInt32](kaudiounitsubtype_systemoutput.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/1584148-audio-unit-output-subtypes)*