...
### Initializers
- [init()](audiounitmidicontrolmapping/init.md)
- [init(midiNRPN: UInt16, midiControl: UInt8, scope: UInt8, element: AudioUnitElement, parameter: AudioUnitParameterID)](audiounitmidicontrolmapping/init(midinrpn:midicontrol:scope:element:parameter:).md)
### Instance Properties
- [var element: AudioUnitElement](audiounitmidicontrolmapping/element.md)
- [var midiControl: UInt8](audiounitmidicontrolmapping/midicontrol.md)
- [var midiNRPN: UInt16](audiounitmidicontrolmapping/midinrpn.md)
- [var parameter: AudioUnitParameterID](audiounitmidicontrolmapping/parameter.md)
- [var scope: UInt8](audiounitmidicontrolmapping/scope.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/audiounitmidicontrolmapping)*