...
`AudioUnitParameterIDName` is a `typedef` for [`AudioUnitParameterNameInfo`](audiounitparameternameinfo.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/audiounitparameteridname)*