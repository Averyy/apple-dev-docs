...
### Instance Properties
- [var MIDI: AUMIDIEvent](aurenderevent/midi.md)
  Use this field for MIDI events.
- [var head: AURenderEventHeader](aurenderevent/head.md)
  Use this field to determine the event type.
- [var parameter: AUParameterEvent](aurenderevent/parameter.md)
  Use this field for parameter events.
- [var MIDIEventsList: AUMIDIEventList](aurenderevent/midieventslist.md)
### Initializers
- [init()](aurenderevent/init.md)
- [init(MIDI: AUMIDIEvent)](aurenderevent/init(midi:).md)
- [init(MIDIEventsList: AUMIDIEventList)](aurenderevent/init(midieventslist:).md)
- [init(head: AURenderEventHeader)](aurenderevent/init(head:).md)
- [init(parameter: AUParameterEvent)](aurenderevent/init(parameter:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/aurenderevent)*