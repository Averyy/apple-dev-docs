...
### Initializers
- [init(hostName: Unmanaged<CFString>, hostVersion: UInt32)](auhostversionidentifier/init(hostname:hostversion:).md)
### Instance Properties
- [var hostName: Unmanaged<CFString>](auhostversionidentifier/hostname.md)
- [var hostVersion: UInt32](auhostversionidentifier/hostversion.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/auhostversionidentifier)*