...
### Constants
- [var kAudioUnitParameterFlag_HasName: Int](kaudiounitparameterflag_hasname.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/1534166-audio-unit-parameter-flags)*