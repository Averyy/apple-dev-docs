...
A [`CFString`](https://developer.apple.com/documentation/CoreFoundation/CFString) object, defined by the accessory, that describes an audio input source and that is suitable for displaying in a user interface.
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/kaudiosession_inputsourcekey_description)*