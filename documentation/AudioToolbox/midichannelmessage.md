...
### Initializers
- [init()](midichannelmessage/init.md)
- [init(status: UInt8, data1: UInt8, data2: UInt8, reserved: UInt8)](midichannelmessage/init(status:data1:data2:reserved:).md)
### Instance Properties
- [var data1: UInt8](midichannelmessage/data1.md)
- [var data2: UInt8](midichannelmessage/data2.md)
- [var reserved: UInt8](midichannelmessage/reserved.md)
- [var status: UInt8](midichannelmessage/status.md)
  Data specific to the channel message.
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/midichannelmessage)*