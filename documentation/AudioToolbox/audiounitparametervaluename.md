...
### Initializers
- [init(inParamID: AudioUnitParameterID, inValue: UnsafePointer<Float32>, outName: Unmanaged<CFString>)](audiounitparametervaluename/init(inparamid:invalue:outname:).md)
### Instance Properties
- [var inParamID: AudioUnitParameterID](audiounitparametervaluename/inparamid.md)
- [var inValue: UnsafePointer<Float32>](audiounitparametervaluename/invalue.md)
- [var outName: Unmanaged<CFString>](audiounitparametervaluename/outname.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/audiounitparametervaluename)*