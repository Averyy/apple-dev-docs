...
The value is a read-only [`AudioFileID`](audiofileid.md) object.
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/kextaudiofileproperty_audiofile)*