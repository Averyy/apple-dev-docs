...
To use offline mode or to return to normal mode, use the [`AudioQueueSetOfflineRenderFormat(_:_:_:)`](audioqueuesetofflinerenderformat(_:_:_:).md) function.
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/kaudioqueueerr_invalidofflinemode)*