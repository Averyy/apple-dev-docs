...
Call this function in advance of playback to reduce a music player’s startup latency. If you call [`MusicPlayerStart(_:)`](musicplayerstart(_:).md) without first calling this function, the player will call this function before beginning playback.
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/musicplayerpreroll(_:))*