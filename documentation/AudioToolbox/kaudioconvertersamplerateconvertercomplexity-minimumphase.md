...
```swift
var kAudioConverterSampleRateConverterComplexity_MinimumPhase: UInt32 { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/kaudioconvertersamplerateconvertercomplexity_minimumphase)*