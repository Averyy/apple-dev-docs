...
### Constants
- [var kAudioUnitParameterName_Full: Int](kaudiounitparametername_full.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/1534055-audio-unit-full-name-parameter)*