...
A [`CFDictionary`](https://developer.apple.com/documentation/CoreFoundation/CFDictionary) object that describes the current audio route. For specifics on the contents of this dictionary, see [`kAudioSession_AudioRouteKey_Inputs`](kaudiosession_audioroutekey_inputs.md) and [`kAudioSession_AudioRouteKey_Outputs`](kaudiosession_audioroutekey_outputs.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/kaudiosession_audioroutechangekey_currentroutedescription)*