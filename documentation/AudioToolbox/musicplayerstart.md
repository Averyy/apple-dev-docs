...
If you call this function without first calling [`MusicPlayerPreroll(_:)`](musicplayerpreroll(_:).md), the player will call that function before beginning playback.
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/musicplayerstart(_:))*