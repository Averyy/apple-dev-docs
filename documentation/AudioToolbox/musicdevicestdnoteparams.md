...
### Initializers
- [init()](musicdevicestdnoteparams/init.md)
- [init(argCount: UInt32, mPitch: Float32, mVelocity: Float32)](musicdevicestdnoteparams/init(argcount:mpitch:mvelocity:).md)
### Instance Properties
- [var argCount: UInt32](musicdevicestdnoteparams/argcount.md)
- [var mPitch: Float32](musicdevicestdnoteparams/mpitch.md)
- [var mVelocity: Float32](musicdevicestdnoteparams/mvelocity.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/musicdevicestdnoteparams)*