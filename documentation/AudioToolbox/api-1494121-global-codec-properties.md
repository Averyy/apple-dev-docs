...
These properties are used with the [`AudioCodecGetProperty(_:_:_:_:)`](audiocodecgetproperty(_:_:_:_:).md) function.
...
### Constants
- [var kAudioCodecPropertyFormatCFString: AudioCodecPropertyID](kaudiocodecpropertyformatcfstring.md)
- [var kAudioCodecPropertyManufacturerCFString: AudioCodecPropertyID](kaudiocodecpropertymanufacturercfstring.md)
- [var kAudioCodecPropertyNameCFString: AudioCodecPropertyID](kaudiocodecpropertynamecfstring.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/1494121-global-codec-properties)*