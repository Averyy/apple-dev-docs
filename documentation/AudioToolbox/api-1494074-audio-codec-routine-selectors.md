...
### Constants
- [var kAudioCodecAppendInputBufferListSelect: UInt32](kaudiocodecappendinputbufferlistselect.md)
- [var kAudioCodecAppendInputDataSelect: UInt32](kaudiocodecappendinputdataselect.md)
- [var kAudioCodecGetPropertyInfoSelect: UInt32](kaudiocodecgetpropertyinfoselect.md)
- [var kAudioCodecGetPropertySelect: UInt32](kaudiocodecgetpropertyselect.md)
- [var kAudioCodecInitializeSelect: UInt32](kaudiocodecinitializeselect.md)
- [var kAudioCodecProduceOutputBufferListSelect: UInt32](kaudiocodecproduceoutputbufferlistselect.md)
- [var kAudioCodecProduceOutputDataSelect: UInt32](kaudiocodecproduceoutputdataselect.md)
- [var kAudioCodecResetSelect: UInt32](kaudiocodecresetselect.md)
- [var kAudioCodecSetPropertySelect: UInt32](kaudiocodecsetpropertyselect.md)
- [var kAudioCodecUninitializeSelect: UInt32](kaudiocodecuninitializeselect.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/1494074-audio-codec-routine-selectors)*