...
Relative musical pitch in cents, where 1,200 cents are equal to one octave. 100 cents are equal to one semitone. See also the [`AudioUnitParameterUnit.absoluteCents`](audiounitparameterunit/absolutecents.md) property.
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/audiounitparameterunit/cents)*