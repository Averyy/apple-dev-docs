...
Typical range is –180 through +180 and is intended to represent the phase difference between two signals. See also the [`AudioUnitParameterUnit.degrees`](audiounitparameterunit/degrees.md) property.
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/audiounitparameterunit/phase)*