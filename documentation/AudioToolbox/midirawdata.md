...
### Initializers
- [init()](midirawdata/init.md)
- [init(length: UInt32, data: UInt8)](midirawdata/init(length:data:).md)
### Instance Properties
- [var data: UInt8](midirawdata/data.md)
- [var length: UInt32](midirawdata/length.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/midirawdata)*