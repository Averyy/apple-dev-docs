...
### Initializers
- [init(rawValue: UInt)](auhosttransportstateflags/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/auhosttransportstateflags)*