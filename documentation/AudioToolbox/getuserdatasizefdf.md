...
```swift
typealias GetUserDataSizeFDF = (UnsafeMutableRawPointer, UInt32, UInt32, UnsafeMutablePointer<UInt32>) -> OSStatus
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/getuserdatasizefdf)*