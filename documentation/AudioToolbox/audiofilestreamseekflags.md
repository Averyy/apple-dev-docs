...
### Initializers
- [init(rawValue: UInt32)](audiofilestreamseekflags/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/audiofilestreamseekflags)*