...
### Initializers
- [init(inParamID: AudioUnitParameterID, inString: Unmanaged<CFString>, outValue: AudioUnitParameterValue)](audiounitparametervaluefromstring/init(inparamid:instring:outvalue:).md)
### Instance Properties
- [var inParamID: AudioUnitParameterID](audiounitparametervaluefromstring/inparamid.md)
- [var inString: Unmanaged<CFString>](audiounitparametervaluefromstring/instring.md)
- [var outValue: AudioUnitParameterValue](audiounitparametervaluefromstring/outvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/audiounitparametervaluefromstring)*