...
### Constants
- [AURenderEventType.MIDI](aurendereventtype/midi.md)
  A MIDI event.
- [AURenderEventType.midiSysEx](aurendereventtype/midisysex.md)
  A system-exclusive MIDI event.
- [AURenderEventType.parameter](aurendereventtype/parameter.md)
  A parameter event.
- [AURenderEventType.parameterRamp](aurendereventtype/parameterramp.md)
  A ramped parameter event.
### Enumeration Cases
- [AURenderEventType.midiEventList](aurendereventtype/midieventlist.md)
### Initializers
- [init?(rawValue: UInt8)](aurendereventtype/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/aurendereventtype)*