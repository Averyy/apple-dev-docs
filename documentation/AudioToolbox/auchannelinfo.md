...
### Initializers
- [init()](auchannelinfo/init.md)
- [init(inChannels: Int16, outChannels: Int16)](auchannelinfo/init(inchannels:outchannels:).md)
### Instance Properties
- [var inChannels: Int16](auchannelinfo/inchannels.md)
  The number of input channels.
- [var outChannels: Int16](auchannelinfo/outchannels.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/auchannelinfo)*