...
### Constants
- [AUAudioUnitBusType.input](auaudiounitbustype/input.md)
  An input bus.
- [AUAudioUnitBusType.output](auaudiounitbustype/output.md)
  An output bus.
### Initializers
- [init?(rawValue: Int)](auaudiounitbustype/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/auaudiounitbustype)*