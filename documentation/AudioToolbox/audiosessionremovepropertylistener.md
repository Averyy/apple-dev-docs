...
```swift
func AudioSessionRemovePropertyListener(_ inID: AudioSessionPropertyID) -> OSStatus
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/audiosessionremovepropertylistener(_:))*