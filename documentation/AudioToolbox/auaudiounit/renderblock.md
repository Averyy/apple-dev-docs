...
This block will call a subclass’s [`internalRenderBlock`](auaudiounit/internalrenderblock.md) implementation, providing all realtime events scheduled for the current render time interval, bracketed by calls to any render observers. Subclasses should override their [`internalRenderBlock`](auaudiounit/internalrenderblock.md) implementation, not this property.

This version 3 property is bridged to the version 2 [`AudioUnitRender(_:_:_:_:_:_:)`](audiounitrender(_:_:_:_:_:_:).md) API.
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/auaudiounit/renderblock)*