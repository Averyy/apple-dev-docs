...
### Initializers
- [init(rawValue: UInt32)](audiofilestreamparseflags/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/audiofilestreamparseflags)*