...
### Initializers
- [init()](aupreset/init.md)
- [init(presetNumber: Int32, presetName: Unmanaged<CFString>?)](aupreset/init(presetnumber:presetname:).md)
### Instance Properties
- [var presetName: Unmanaged<CFString>?](aupreset/presetname.md)
  If a factory preset, the name of the specified factory preset.
- [var presetNumber: Int32](aupreset/presetnumber.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/aupreset)*