...
### Initializers
- [init(rawValue: UInt32)](audiofilestreampropertyflags/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/audiofilestreampropertyflags)*