...
### Constants
- [var kAudioUnitErr_IllegalInstrument: OSStatus](kaudiouniterr_illegalinstrument.md)
- [var kAudioUnitErr_InstrumentTypeNotFound: OSStatus](kaudiouniterr_instrumenttypenotfound.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/1584141-audio-unit-instrument-errors)*