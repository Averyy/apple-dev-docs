...
### Initializers
- [init()](musicdevicenoteparams/init.md)
- [init(argCount: UInt32, mPitch: Float32, mVelocity: Float32, mControls: NoteParamsControlValue)](musicdevicenoteparams/init(argcount:mpitch:mvelocity:mcontrols:).md)
### Instance Properties
- [var argCount: UInt32](musicdevicenoteparams/argcount.md)
- [var mControls: NoteParamsControlValue](musicdevicenoteparams/mcontrols.md)
- [var mPitch: Float32](musicdevicenoteparams/mpitch.md)
- [var mVelocity: Float32](musicdevicenoteparams/mvelocity.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/musicdevicenoteparams)*