...
### Initializers
- [init()](extendedtempoevent/init.md)
- [init(bpm: Float64)](extendedtempoevent/init(bpm:).md)
### Instance Properties
- [var bpm: Float64](extendedtempoevent/bpm.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/extendedtempoevent)*