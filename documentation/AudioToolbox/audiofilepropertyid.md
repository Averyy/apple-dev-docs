...
For a list of audio file properties, see [`Audio File Properties`](1576499-audio-file-properties.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/audiofilepropertyid)*