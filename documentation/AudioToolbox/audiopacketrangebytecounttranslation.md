...
### Initializers
- [init()](audiopacketrangebytecounttranslation/init.md)
- [init(mPacket: Int64, mPacketCount: Int64, mByteCountUpperBound: Int64)](audiopacketrangebytecounttranslation/init(mpacket:mpacketcount:mbytecountupperbound:).md)
### Instance Properties
- [var mByteCountUpperBound: Int64](audiopacketrangebytecounttranslation/mbytecountupperbound.md)
- [var mPacket: Int64](audiopacketrangebytecounttranslation/mpacket.md)
- [var mPacketCount: Int64](audiopacketrangebytecounttranslation/mpacketcount.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/audiopacketrangebytecounttranslation)*