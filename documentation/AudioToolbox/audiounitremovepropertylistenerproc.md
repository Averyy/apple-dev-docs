...
```swift
typealias AudioUnitRemovePropertyListenerProc = (UnsafeMutableRawPointer, AudioUnitPropertyID, AudioUnitPropertyListenerProc) -> OSStatus
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/audiotoolbox/audiounitremovepropertylistenerproc)*