...
```swift
static let instrumentActivity: AnalysisType
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/musicunderstanding/analysistype/instrumentactivity)*