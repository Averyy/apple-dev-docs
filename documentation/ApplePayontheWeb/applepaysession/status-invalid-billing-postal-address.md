...
Use this status code only for Apple Pay API version 1 or 2  calls. For version 3, use an [`ApplePayError`](applepayerror.md) with a status of [`STATUS_FAILURE`](applepaysession/status_failure.md)  and error code instead.
...
*[View on Apple Developer](https://developer.apple.com/documentation/applepayontheweb/applepaysession/status_invalid_billing_postal_address)*