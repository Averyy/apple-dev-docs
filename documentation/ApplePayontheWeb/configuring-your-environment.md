...
Domains can’t be behind a proxy or redirect, and must be accessible to the Apple servers listed in [`Allow Apple IP Addresses for Domain Verification`](setting-up-your-server#Allow-Apple-IP-Addresses-for-Domain-Verification.md).
