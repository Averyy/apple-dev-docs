...
Calling this method marks the process so that accessing the URL won’t materialize the item. Instead, any attempt to read or write to an unmaterialized item fails with a [`EDEADLK`](https://developer.apple.com/documentation/foundation/posixerror/2293380-edeadlk) POSIX error.
