...
- [var renamedItem: NSFileProviderItem](nsfileprovidertestingcollisionresolution/renameditem.md)
  A description of the renamed item.
- [var side: NSFileProviderTestingOperationSide](nsfileprovidertestingcollisionresolution/side.md)
  The item’s location.
...
*[View on Apple Developer](https://developer.apple.com/documentation/fileprovider/nsfileprovidertestingcollisionresolution)*