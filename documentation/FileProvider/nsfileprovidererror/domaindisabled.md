...
```swift
static var domainDisabled: NSFileProviderError.Code { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/fileprovider/nsfileprovidererror/domaindisabled)*