...
### Decoding
- [init(from: any Decoder) throws](electrichvacloadevent/electricalmeasurement/init(from:).md)
  Creates a new instance by decoding from the given decoder.
### Instance Methods
- [func encode(to: any Encoder) throws](electrichvacloadevent/electricalmeasurement/encode(to:).md)
