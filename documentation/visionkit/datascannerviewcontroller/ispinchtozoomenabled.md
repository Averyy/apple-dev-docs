...
```swift
@MainActor
final let isPinchToZoomEnabled: Bool
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/visionkit/datascannerviewcontroller/ispinchtozoomenabled)*