...
```swift
@MainActor
final var supplementaryInterfaceContentInsets: NSEdgeInsets { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/visionkit/imageanalysisoverlayview/supplementaryinterfacecontentinsets)*