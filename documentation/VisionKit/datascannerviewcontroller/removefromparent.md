...
```swift
@MainActor
override dynamic func removeFromParent()
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/visionkit/datascannerviewcontroller/removefromparent())*