...
### Instance Properties
- [var label: String?](mtl4compilerdescriptor/label.md)
  Assigns an optional descriptor label to the compiler for debugging purposes.
- [var pipelineDataSetSerializer: (any MTL4PipelineDataSetSerializer)?](mtl4compilerdescriptor/pipelinedatasetserializer.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metal/mtl4compilerdescriptor)*