...
An object that describes the pointer. If [`dataType`](mtlstructmember/datatype.md) indicates that this member isn’t a pointer, this method returns `nil`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/metal/mtlstructmember/pointertype())*