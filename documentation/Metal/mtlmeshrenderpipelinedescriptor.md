...
- [var requiredThreadsPerMeshThreadgroup: MTLSize](mtlmeshrenderpipelinedescriptor/requiredthreadspermeshthreadgroup.md)
- [var requiredThreadsPerObjectThreadgroup: MTLSize](mtlmeshrenderpipelinedescriptor/requiredthreadsperobjectthreadgroup.md)
