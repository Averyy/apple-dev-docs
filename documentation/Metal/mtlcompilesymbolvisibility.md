...
### Initializers
- [init?(rawValue: Int)](mtlcompilesymbolvisibility/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metal/mtlcompilesymbolvisibility)*