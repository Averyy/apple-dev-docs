...
![A block diagram that shows the previous contents of a render target and its loaded contents after a Don’t Care load action.](/images/com.apple.metal/setting-load-and-store-actions-6@2x.png)
...
![A block diagram that shows the previous contents of a render target and its loaded contents after a Clear load action.](/images/com.apple.metal/setting-load-and-store-actions-5@2x.png)
...
![A block diagram that shows the previous contents of a render target and its loaded contents after a Load load action.](/images/com.apple.metal/setting-load-and-store-actions-1@2x.png)
...
![A block diagram that shows the previous contents of a render target and its stored contents after a Don’t Care store action.](/images/com.apple.metal/setting-load-and-store-actions-8@2x.png)
...
![A block diagram that shows the previous contents of a render target and its stored contents after a Store store action.](/images/com.apple.metal/setting-load-and-store-actions-7@2x.png)
...
![A block diagram that shows a store and load sequence for a single render target. The render target uses a Don’t Care store action and a Don’t Care load action.](/images/com.apple.metal/setting-load-and-store-actions-2@2x.png)

![A block diagram that shows a store and load sequence for a single render target. The render target uses a Don’t Care store action and a Clear load action.](/images/com.apple.metal/setting-load-and-store-actions-3@2x.png)
...
![A block diagram that shows a store and load sequence for a single render target. The render target uses a Store, Multisample Resolve, or Store And Multisample Resolve store action, and then uses a Load load action.](/images/com.apple.metal/setting-load-and-store-actions-4@2x.png)
