...
### Enumeration Cases
- [MTL4IndirectCommandBufferSupportState.disabled](mtl4indirectcommandbuffersupportstate/disabled.md)
  Disables support for indirect command buffers.
- [MTL4IndirectCommandBufferSupportState.enabled](mtl4indirectcommandbuffersupportstate/enabled.md)
  Enables support for indirect command buffers.
### Initializers
- [init?(rawValue: Int)](mtl4indirectcommandbuffersupportstate/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metal/mtl4indirectcommandbuffersupportstate)*