...
![A horizontal bar chart that shows the relative bandwidths of Thunderbolt 3 (1x), PCIe with 8 lanes (2x), and PCIe with 16 lanes (4x).](https://docs-assets.developer.apple.com/published/94b6398aae2e8085a01a628a2dd31fa3/adjusting-for-gpu-memory-bandwidth-tradeoffs-2%402x.png)
