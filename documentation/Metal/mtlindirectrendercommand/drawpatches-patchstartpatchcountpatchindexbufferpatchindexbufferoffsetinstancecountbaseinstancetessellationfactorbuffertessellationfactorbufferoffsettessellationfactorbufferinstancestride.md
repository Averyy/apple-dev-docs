...
- `numberOfPatchControlPoints`: The number of control points per patch.   This value needs to be between   and  , inclusive.
...
- `offset`: The distance, in bytes, between the start of the data and the start of the buffer. This value needs to be a multiple of   bytes.
