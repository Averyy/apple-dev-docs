...
![A diagram of an imageblock that shows three separate grids that stack together named: albedo, specular and normal.](https://docs-assets.developer.apple.com/published/5f5bd1e427d89a46e03bc277f20f9bf2/tailor-your-apps-for-apple-gpus-and-tile-based-deferred-rendering-2%402x.png)
...
![A diagram that shows an opaque triangle that covers two other transparent triangles. The opaque triangle covers all four sample positions within the pixel.](https://docs-assets.developer.apple.com/published/f9eb0c2f8d6939c0613e8a5b6c44f74b/tailor-your-apps-for-apple-gpus-and-tile-based-deferred-rendering-14%402x.png)
...
![A block diagram that shows three blocks accessing tile memory: opaque geometry, blended geometry, and a resolve algorithm.](https://docs-assets.developer.apple.com/published/5ca6eae81348741f3068a0d1b12ffd53/tailor-your-apps-for-apple-gpus-and-tile-based-deferred-rendering-15%402x.png)
