...
### Instance Properties
- [var library: (any MTLLibrary)?](mtl4libraryfunctiondescriptor/library.md)
  Returns a reference to the library containing the function.
- [var name: String?](mtl4libraryfunctiondescriptor/name.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metal/mtl4libraryfunctiondescriptor)*