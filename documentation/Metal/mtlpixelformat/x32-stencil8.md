...
You can’t directly read the stencil value of a texture with the [`MTLPixelFormat.depth32Float_stencil8`](mtlpixelformat/depth32float_stencil8.md) format. To read stencil values from a texture with the [`MTLPixelFormat.depth32Float_stencil8`](mtlpixelformat/depth32float_stencil8.md) format, create a texture view of that texture using the [`MTLPixelFormat.x32_stencil8`](mtlpixelformat/x32_stencil8.md) format, and sample the texture view instead.
...
*[View on Apple Developer](https://developer.apple.com/documentation/metal/mtlpixelformat/x32_stencil8)*