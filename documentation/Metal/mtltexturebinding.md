...
### Instance Properties
- [var arrayLength: Int](mtltexturebinding/arraylength.md)
- [var isDepthTexture: Bool](mtltexturebinding/isdepthtexture.md)
- [var textureDataType: MTLDataType](mtltexturebinding/texturedatatype.md)
- [var textureType: MTLTextureType](mtltexturebinding/texturetype.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metal/mtltexturebinding)*