...
### Initializers
- [init?(rawValue: UInt)](mtltessellationfactorformat/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metal/mtltessellationfactorformat)*