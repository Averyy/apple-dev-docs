...
### Enumeration Cases
- [MTL4AlphaToOneState.disabled](mtl4alphatoonestate/disabled.md)
  Disables alpha-to-one.
- [MTL4AlphaToOneState.enabled](mtl4alphatoonestate/enabled.md)
  Enables alpha-to-one.
### Initializers
- [init?(rawValue: Int)](mtl4alphatoonestate/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metal/mtl4alphatoonestate)*