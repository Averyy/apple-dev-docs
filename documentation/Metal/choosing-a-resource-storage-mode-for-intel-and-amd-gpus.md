...
![A system diagram that shows the memory location of a shared mode resource in system memory that connects to the GPU and CPU with bidirectional arrows.](/images/com.apple.metal/choosing-a-resource-storage-mode-for-intel-and-amd-gpus-1@2x.png)
