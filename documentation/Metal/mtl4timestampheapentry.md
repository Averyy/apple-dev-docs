...
- [init(timestamp: UInt64)](mtl4timestampheapentry/init(timestamp:).md)
### Instance Properties
- [var timestamp: UInt64](mtl4timestampheapentry/timestamp.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metal/mtl4timestampheapentry)*