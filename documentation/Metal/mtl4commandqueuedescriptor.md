...
### Instance Properties
- [var feedbackQueue: dispatch_queue_t?](mtl4commandqueuedescriptor/feedbackqueue.md)
  Assigns a dispatch queue to which Metal submits feedback notification blocks.
- [var label: String?](mtl4commandqueuedescriptor/label.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metal/mtl4commandqueuedescriptor)*