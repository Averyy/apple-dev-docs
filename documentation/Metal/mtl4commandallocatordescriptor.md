...
### Instance Properties
- [var label: String?](mtl4commandallocatordescriptor/label.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metal/mtl4commandallocatordescriptor)*