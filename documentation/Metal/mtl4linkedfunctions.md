...
### Instance Properties
- [var binaryFunctions: [any MTL4BinaryFunction]?](mtl4linkedfunctions/binaryfunctions.md)
  Provides an array of binary functions to link.
- [var functionDescriptors: [MTL4FunctionDescriptor]?](mtl4linkedfunctions/functiondescriptors.md)
  Provides an array of functions to link at the Metal IR level.
- [var groups: [String : [MTL4FunctionDescriptor]]?](mtl4linkedfunctions/groups.md)
  Assigns groups of functions to match call-site attributes in shader code.
- [var privateFunctionDescriptors: [MTL4FunctionDescriptor]?](mtl4linkedfunctions/privatefunctiondescriptors.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metal/mtl4linkedfunctions)*