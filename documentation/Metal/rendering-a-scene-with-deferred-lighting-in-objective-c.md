...
![Screenshot of the sample app running to show the rich lighting effects.](/images/com.apple.metal/deferred-lighting-objc-1-DeferredLighting.png)
...
![Diagram showing the outputs of the two render passes in a traditional deferred lighting algorithm.](/images/com.apple.metal/deferred-lighting-objc-2-TraditionalDeferredLighting.png)
...
![Diagram showing how geometry buffer data in a traditional deferred lighting algorithm is transferred between the GPU and system memory.](/images/com.apple.metal/deferred-lighting-objc-3-TraditionalDeferredLightingOnTBDR.png)
...
![Diagram showing how geometry buffer data in a single-pass deferred lighting algorithm is accessed in tile memory.](/images/com.apple.metal/deferred-lighting-objc-4-SinglePassDeferredLightingOnTBDR.png)
...
![Diagram showing two lights executed by a fragment shader, without raster order groups.](/images/com.apple.metal/deferred-lighting-objc-5-DeferredLightingWithoutRasterOrderGroups.png)
...
![Diagram showing two lights executed by a fragment shader, with raster order groups.](/images/com.apple.metal/deferred-lighting-objc-6-DeferredLightingWithRasterOrderGroups.png)
...
![Rendering that shows the shadow map.](/images/com.apple.metal/deferred-lighting-objc-7-ShadowMap.png)
...
![Rendering that shows the geometry buffer textures.](/images/com.apple.metal/deferred-lighting-objc-8-GBufferTextures.png)
...
![Rendering that shows point light fragment coverage when the stencil mask is enabled.](/images/com.apple.metal/deferred-lighting-objc-9-StencilMaskOnly.png)
...
![Rendering that shows point light fragment coverage when the stencil mask is disabled.](/images/com.apple.metal/deferred-lighting-objc-10-StencilMaskVSFullVolumes.png)
