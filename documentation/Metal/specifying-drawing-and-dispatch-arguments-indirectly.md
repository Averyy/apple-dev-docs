...
![Flow diagram showing the idle time caused by reading the data back on the CPU. ](/images/com.apple.metal/specifying-drawing-and-dispatch-arguments-indirectly-1@2x.png)
...
![Flow diagram showing two commands encoded on the CPU followed by two commands executing on the GPU, with no idle time.](/images/com.apple.metal/specifying-drawing-and-dispatch-arguments-indirectly-2@2x.png)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metal/specifying-drawing-and-dispatch-arguments-indirectly)*