...
### Enumeration Cases
- [MTL4AlphaToCoverageState.disabled](mtl4alphatocoveragestate/disabled.md)
  Disables alpha-to-coverage.
- [MTL4AlphaToCoverageState.enabled](mtl4alphatocoveragestate/enabled.md)
  Enables alpha-to-coverage.
### Initializers
- [init?(rawValue: Int)](mtl4alphatocoveragestate/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metal/mtl4alphatocoveragestate)*