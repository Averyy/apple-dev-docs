...
### Enumeration Cases
- [MTL4BlendState.disabled](mtl4blendstate/disabled.md)
  Disables blending.
- [MTL4BlendState.enabled](mtl4blendstate/enabled.md)
  Enables blending.
- [MTL4BlendState.unspecialized](mtl4blendstate/unspecialized.md)
  Defers determining the blending stage.
### Initializers
- [init?(rawValue: Int)](mtl4blendstate/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metal/mtl4blendstate)*