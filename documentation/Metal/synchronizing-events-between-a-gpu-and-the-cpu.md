...
![Timeline diagram that shows shareable synchronization events for a GPU and the CPU, and the work that the GPU and CPU do.](/images/com.apple.metal/synchronizing-events-between-a-gpu-and-the-cpu-1@2x.png)
