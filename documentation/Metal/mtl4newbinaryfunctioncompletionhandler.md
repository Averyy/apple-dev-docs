...
```swift
typealias MTL4NewBinaryFunctionCompletionHandler = ((any MTL4BinaryFunction)?, (any Error)?) -> Void
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/metal/mtl4newbinaryfunctioncompletionhandler)*