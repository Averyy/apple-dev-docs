...
### Instance Properties
- [var functionDescriptors: [MTL4FunctionDescriptor]?](mtl4staticlinkingdescriptor/functiondescriptors.md)
  Provides an array of functions to link at the Metal IR level.
- [var groups: [String : [MTL4FunctionDescriptor]]?](mtl4staticlinkingdescriptor/groups.md)
  Assigns groups of functions to match call-site attributes in shader code.
- [var privateFunctionDescriptors: [MTL4FunctionDescriptor]?](mtl4staticlinkingdescriptor/privatefunctiondescriptors.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metal/mtl4staticlinkingdescriptor)*