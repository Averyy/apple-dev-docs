...
- `resources`: A pointer to a C array of   instances that subsequent draw commands depend on.
...
- `stages`: All the render stages that depend on elements in  , including  ,  ,  ,  , and  .
...
*[View on Apple Developer](https://developer.apple.com/documentation/metal/mtlrendercommandencoder/use(_:count:usage:stages:))*