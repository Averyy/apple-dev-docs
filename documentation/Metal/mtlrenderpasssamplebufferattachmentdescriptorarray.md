...
- [subscript(Int) -> MTLRenderPassSampleBufferAttachmentDescriptor!](mtlrenderpasssamplebufferattachmentdescriptorarray/subscript(_:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metal/mtlrenderpasssamplebufferattachmentdescriptorarray)*