...
-  Allow the sample to automatically select the best device for the display, or indicate that you want to manually select a device.
-  Manually select a device from a list of available devices.
