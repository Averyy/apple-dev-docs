...
### Initializers
- [init()](mtlpackedfloatquaternion/init.md)
- [init(x: Float, y: Float, z: Float, w: Float)](mtlpackedfloatquaternion/init(x:y:z:w:).md)
### Instance Properties
- [var w: Float](mtlpackedfloatquaternion/w.md)
- [var x: Float](mtlpackedfloatquaternion/x.md)
- [var y: Float](mtlpackedfloatquaternion/y.md)
- [var z: Float](mtlpackedfloatquaternion/z.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metal/mtlpackedfloatquaternion)*