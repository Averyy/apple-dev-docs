...
### Instance Properties
- [var name: String?](mtl4librarydescriptor/name.md)
  Assigns an optional name to the Metal library.
- [var options: MTLCompileOptions?](mtl4librarydescriptor/options.md)
  Provides compile-time options for the Metal library.
- [var source: String?](mtl4librarydescriptor/source.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metal/mtl4librarydescriptor)*