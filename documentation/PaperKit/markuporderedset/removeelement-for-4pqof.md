...
```swift
@discardableResult
mutating func removeElement<T>(for id: MarkupID<T>) -> T? where T : Markup
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/paperkit/markuporderedset/removeelement(for:)-4pqof)*