...
```swift
@discardableResult
mutating func removeStroke(for id: UUID) -> PKStroke?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/paperkit/markuporderedset/removestroke(for:))*