...
- `tint`: The color to apply to the image. Defaults to the system accent color.
...
*[View on Apple Developer](https://developer.apple.com/documentation/paperkit/markupadornment/imageconfiguration-swift.struct/systemimage(_:tint:size:alignmentanchor:)-4itb9)*