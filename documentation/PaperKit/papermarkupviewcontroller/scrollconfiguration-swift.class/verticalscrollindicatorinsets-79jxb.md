...
```swift
final var verticalScrollIndicatorInsets: UIEdgeInsets { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/paperkit/papermarkupviewcontroller/scrollconfiguration-swift.class/verticalscrollindicatorinsets-79jxb)*