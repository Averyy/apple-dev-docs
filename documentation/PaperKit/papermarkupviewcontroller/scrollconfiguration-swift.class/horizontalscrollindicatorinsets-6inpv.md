...
```swift
final var horizontalScrollIndicatorInsets: NSEdgeInsets { get set }
```

#### Discussion

Default is `NSEdgeInsetsZero`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/paperkit/papermarkupviewcontroller/scrollconfiguration-swift.class/horizontalscrollindicatorinsets-6inpv)*