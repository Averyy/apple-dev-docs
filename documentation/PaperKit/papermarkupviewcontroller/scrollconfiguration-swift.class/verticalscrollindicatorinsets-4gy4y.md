...
```swift
final var verticalScrollIndicatorInsets: NSEdgeInsets { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/paperkit/papermarkupviewcontroller/scrollconfiguration-swift.class/verticalscrollindicatorinsets-4gy4y)*