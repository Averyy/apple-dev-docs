...
```swift
final func resignID(_ id: LocalTestingDistributedActorSystem.ActorID)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/distributed/localtestingdistributedactorsystem/resignid(_:))*