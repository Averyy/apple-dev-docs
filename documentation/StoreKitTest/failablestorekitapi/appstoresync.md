...
```swift
static var appStoreSync: StoreKitAppStoreSyncAPI { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/storekittest/failablestorekitapi/appstoresync)*