...
Check that you provide a signature in [`validate(_:publicKey:)`](skadtestsession/validate(_:publickey:).md) or [`validateImpression(parameters:publicKey:)`](skadtestsession/validateimpression(parameters:publickey:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/storekittest/skadtesterror/code/missingsignature)*