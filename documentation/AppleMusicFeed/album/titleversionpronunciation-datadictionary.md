...
- `titleVersionPronunciation` (string): A localized pronunciation of the album title version.
...
*[View on Apple Developer](https://developer.apple.com/documentation/applemusicfeed/album/titleversionpronunciation-data.dictionary)*