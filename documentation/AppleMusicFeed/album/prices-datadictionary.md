...
### Related objects
- [object Album.Prices.Price](album/prices-data.dictionary/price.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/applemusicfeed/album/prices-data.dictionary)*