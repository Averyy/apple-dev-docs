# RCSService.GroupChatEvent.started(_:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/telephonymessagingkit/rcsservice/groupchatevent/started(_:))*