...
```swift
let telephoneDetails: RCSService.Business.TelephoneDetails
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/telephonymessagingkit/rcsservice/business/communicationaddress-swift.struct/telephonedetails)*