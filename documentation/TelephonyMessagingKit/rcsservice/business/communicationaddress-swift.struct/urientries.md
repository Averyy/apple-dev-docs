...
```swift
let uriEntries: [RCSService.Business.URIEntry]
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/telephonymessagingkit/rcsservice/business/communicationaddress-swift.struct/urientries)*