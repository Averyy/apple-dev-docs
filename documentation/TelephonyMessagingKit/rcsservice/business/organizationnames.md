...
```swift
let organizationNames: [RCSService.Business.OrganizationName]
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/telephonymessagingkit/rcsservice/business/organizationnames)*