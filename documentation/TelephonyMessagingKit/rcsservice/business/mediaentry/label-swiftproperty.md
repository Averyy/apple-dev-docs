...
```swift
let label: RCSService.Business.MediaEntry.Label
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/telephonymessagingkit/rcsservice/business/mediaentry/label-swift.property)*