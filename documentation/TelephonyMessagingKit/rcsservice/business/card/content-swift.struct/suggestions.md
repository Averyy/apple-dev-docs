...
```swift
let suggestions: [RCSService.Business.Suggestion]
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/telephonymessagingkit/rcsservice/business/card/content-swift.struct/suggestions)*