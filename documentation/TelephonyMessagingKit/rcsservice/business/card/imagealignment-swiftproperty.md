...
```swift
let imageAlignment: RCSService.Business.Card.ImageAlignment?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/telephonymessagingkit/rcsservice/business/card/imagealignment-swift.property)*