...
- [init(from: any Decoder) throws](rcsservice/business/menu/init(from:).md)
  Creates a new instance by decoding from the given decoder.
- [func encode(to: any Encoder) throws](rcsservice/business/menu/encode(to:).md)
  Encodes this value into the given encoder.
### Comparing menus
- [static func == (RCSService.Business.Menu, RCSService.Business.Menu) -> Bool](rcsservice/business/menu/==(_:_:).md)
  Returns a Boolean value indicating whether two values are equal.
### Default Implementations
- [Equatable Implementations](rcsservice/business/menu/equatable-implementations.md)
