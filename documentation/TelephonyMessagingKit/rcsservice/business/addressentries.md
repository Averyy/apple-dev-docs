...
```swift
let addressEntries: [RCSService.Business.AddressEntry]
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/telephonymessagingkit/rcsservice/business/addressentries)*