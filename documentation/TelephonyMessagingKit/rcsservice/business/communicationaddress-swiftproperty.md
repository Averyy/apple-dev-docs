...
```swift
let communicationAddress: RCSService.Business.CommunicationAddress?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/telephonymessagingkit/rcsservice/business/communicationaddress-swift.property)*