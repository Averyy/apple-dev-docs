...
```swift
let label: RCSService.Business.URIEntry.Label
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/telephonymessagingkit/rcsservice/business/urientry/label-swift.property)*