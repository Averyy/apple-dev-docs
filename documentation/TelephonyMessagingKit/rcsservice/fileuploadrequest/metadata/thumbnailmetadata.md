...
```swift
let thumbnailMetadata: RCSFileTransferMetadata?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/telephonymessagingkit/rcsservice/fileuploadrequest/metadata/thumbnailmetadata)*