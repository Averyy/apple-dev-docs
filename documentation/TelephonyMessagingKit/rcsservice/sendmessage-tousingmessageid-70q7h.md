...
> **Note**:  If RCS messaging isn’t supported, this method throws [`RCSService.Error.notSupported`](rcsservice/error/notsupported.md). If the message exceeds the maximum size, it throws [`RCSService.Error.maximumSizeExceeded`](rcsservice/error/maximumsizeexceeded.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/telephonymessagingkit/rcsservice/sendmessage(_:to:using:messageid:)-70q7h)*