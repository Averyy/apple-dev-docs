...
```swift
final var groupChatEvents: some AsyncSequence<RCSService.GroupChatEvent, Never> { get throws }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/telephonymessagingkit/rcsservice/groupchatevents)*