...
- [init(cellularServiceID: CellularServiceID, groupHandle: RCSHandle.Group, participants: [RCSHandle.URI])](rcsservice/addgroupchatparticipantsrequest/init(cellularserviceid:grouphandle:participants:).md)
### Accessing request properties
- [var cellularServiceID: CellularServiceID](rcsservice/addgroupchatparticipantsrequest/cellularserviceid.md)
  Service identifier to use for this request.
- [var groupHandle: RCSHandle.Group](rcsservice/addgroupchatparticipantsrequest/grouphandle.md)
  Group handle indicating the group to which to add participants.
- [var participants: [RCSHandle.URI]](rcsservice/addgroupchatparticipantsrequest/participants.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/telephonymessagingkit/rcsservice/addgroupchatparticipantsrequest)*