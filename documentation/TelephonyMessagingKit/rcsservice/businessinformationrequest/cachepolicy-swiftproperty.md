...
```swift
var cachePolicy: RCSService.BusinessInformationRequest.CachePolicy
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/telephonymessagingkit/rcsservice/businessinformationrequest/cachepolicy-swift.property)*