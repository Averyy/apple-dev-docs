...
```swift
mutating func addCustomHeader(_ header: MMSPartContent.MMSCustomHeader)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/telephonymessagingkit/mmspartcontent/addcustomheader(_:))*