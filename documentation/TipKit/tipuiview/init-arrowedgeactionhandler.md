...
```swift
@MainActor
@preconcurrency init(_ tip: any Tip, arrowEdge: Edge? = nil, actionHandler: @escaping @MainActor @Sendable (Tips.Action) -> Void = { _ in })
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/tipkit/tipuiview/init(_:arrowedge:actionhandler:))*