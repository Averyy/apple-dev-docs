...
### Instance Properties
- [let handler: () -> Void](tips/action/handler.md)
- [let id: String](tips/action/id.md)
  The identifier for a tip’s action.
- [let index: Int?](tips/action/index.md)
- [let label: () -> Text](tips/action/label.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/tipkit/tips/action)*