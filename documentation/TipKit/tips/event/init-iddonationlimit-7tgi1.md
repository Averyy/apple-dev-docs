...
```swift
init(id: String, donationLimit: Tips.DonationLimit) where DonationInfo == Tips.EmptyDonation
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/tipkit/tips/event/init(id:donationlimit:)-7tgi1)*