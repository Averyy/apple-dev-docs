...
Call [`CFHostStartInfoResolution(_:_:_:)`](cfhoststartinforesolution(_:_:_:).md) to resolve the return object’s name and reachability information.
...
*[View on Apple Developer](https://developer.apple.com/documentation/cfnetwork/cfhostcreatewithaddress(_:_:))*