...
- [init(rawValue: CFOptionFlags)](cfnetserviceregisterflags/init(rawvalue:).md)
  Initializes a flag value with the specified bitfield.
### Constants
- [static var noAutoRename: CFNetServiceRegisterFlags](cfnetserviceregisterflags/noautorename.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/cfnetwork/cfnetserviceregisterflags)*