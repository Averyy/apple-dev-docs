...
After calling [`CFHTTPMessageAppendBytes(_:_:_:)`](cfhttpmessageappendbytes(_:_:_:).md), call this function to see if the message header is complete.
...
*[View on Apple Developer](https://developer.apple.com/documentation/cfnetwork/cfhttpmessageisheadercomplete(_:))*