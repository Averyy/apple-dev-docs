...
Before calling this function, call [`CFNetServiceSetClient(_:_:_:)`](cfnetservicesetclient(_:_:_:).md) to prepare a CFNetService for use in asynchronous mode.
...
*[View on Apple Developer](https://developer.apple.com/documentation/cfnetwork/cfnetserviceschedulewithrunloop(_:_:_:))*