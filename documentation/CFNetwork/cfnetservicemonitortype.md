...
### Constants
- [CFNetServiceMonitorType.TXT](cfnetservicemonitortype/txt.md)
  Watch for TXT record changes.
### Initializers
- [init?(rawValue: Int32)](cfnetservicemonitortype/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/cfnetwork/cfnetservicemonitortype)*