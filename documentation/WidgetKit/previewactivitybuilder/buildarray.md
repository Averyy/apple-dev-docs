...
```swift
static func buildArray(_ components: [[A.ContentState]]) -> [A.ContentState]
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/widgetkit/previewactivitybuilder/buildarray(_:))*