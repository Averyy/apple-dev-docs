...
```swift
static func buildExpression(_ contentState: A.ContentState) -> [A.ContentState]
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/widgetkit/previewactivitybuilder/buildexpression(_:))*