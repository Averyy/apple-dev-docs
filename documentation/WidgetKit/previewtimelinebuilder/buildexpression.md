...
```swift
static func buildExpression(_ entry: some TimelineEntry) -> [any TimelineEntry]
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/widgetkit/previewtimelinebuilder/buildexpression(_:))*