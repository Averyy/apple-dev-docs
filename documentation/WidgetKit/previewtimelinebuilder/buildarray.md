...
```swift
static func buildArray(_ components: [[any TimelineEntry]]) -> [any TimelineEntry]
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/widgetkit/previewtimelinebuilder/buildarray(_:))*