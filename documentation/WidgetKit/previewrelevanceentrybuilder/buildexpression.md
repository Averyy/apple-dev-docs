...
```swift
static func buildExpression(_ entry: Entry) -> [Entry]
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/widgetkit/previewrelevanceentrybuilder/buildexpression(_:))*