...
```swift
static func buildArray(_ components: [[Entry]]) -> [Entry]
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/widgetkit/previewrelevanceentrybuilder/buildarray(_:))*