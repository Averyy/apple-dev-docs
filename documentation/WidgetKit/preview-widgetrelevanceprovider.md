...
The preview will allow you to step through the entries generated by the provider. It might be helpful to instantiate your relevance provider with sample data.
...
- `relevanceProvider`: A closure producing the relevance provider that will generate the preview’s relevances and entries.
