...
```swift
struct AccessorySecurity
```

## Topics

### Managing cryptographic operations
- [AccessorySecurity.Crypto](accessorysecurity/crypto.md)
  Cryptographic types and operations.
### Handling security events
- [AccessorySecurity.Event](accessorysecurity/event.md)
  An enumeration of security events during the key exchange process.
### Identifying errors
- [AccessorySecurity.Error](accessorysecurity/error.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/accessorytransportextension/accessorysecurity)*