...
*[View on Apple Developer](https://developer.apple.com/documentation/tabulardata/dataframe/rows-swift.struct/split(separator:maxsplits:omittingemptysubsequences:))*