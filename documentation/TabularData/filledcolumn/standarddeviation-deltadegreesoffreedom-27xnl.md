...
```swift
func standardDeviation(deltaDegreesOfFreedom: Int = 1) -> FilledColumn<Base>.Element?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/tabulardata/filledcolumn/standarddeviation(deltadegreesoffreedom:)-27xnl)*