...
```swift
init<S>(name: String, contents: S) where S : Sequence, S.Element == WrappedElement?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/tabulardata/column/init(name:contents:)-8nxtj)*