...
- `columnIDs`: The column identifiers of the data frame and the other data frame type,  , respectively.
...
*[View on Apple Developer](https://developer.apple.com/documentation/tabulardata/dataframeprotocol/joined(_:on:kind:)-9629e)*