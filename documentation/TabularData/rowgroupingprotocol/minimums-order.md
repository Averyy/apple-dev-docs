...
```swift
func minimums<N>(_ columnID: ColumnID<N>, order: Order? = nil) -> DataFrame where N : Comparable
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/tabulardata/rowgroupingprotocol/minimums(_:order:))*