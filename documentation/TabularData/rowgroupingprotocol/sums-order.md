...
```swift
func sums<N>(_ columnID: ColumnID<N>, order: Order? = nil) -> DataFrame where N : AdditiveArithmetic, N : Comparable
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/tabulardata/rowgroupingprotocol/sums(_:order:))*