...
- `j`: The zero based index of the row to query.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sparse_get_matrix_nonzero_count_for_column(_:_:))*