...
```swift
func dlaed4_(_ n: UnsafePointer<__LAPACK_int>, _ i: UnsafePointer<__LAPACK_int>, _ d: UnsafePointer<Double>?, _ z: UnsafePointer<Double>?, _ delta: UnsafeMutablePointer<Double>?, _ rho: UnsafePointer<Double>, _ dlam: UnsafeMutablePointer<Double>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlaed4_(_:_:_:_:_:_:_:_:))*