# ctgsy2_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func ctgsy2_(_ trans: UnsafePointer<CChar>, _ ijob: UnsafePointer<__LAPACK_int>, _ m: UnsafePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ a: OpaquePointer?, _ lda: UnsafePointer<__LAPACK_int>, _ b: OpaquePointer?, _ ldb: UnsafePointer<__LAPACK_int>, _ c: OpaquePointer?, _ ldc: UnsafePointer<__LAPACK_int>, _ d: OpaquePointer?, _ ldd: UnsafePointer<__LAPACK_int>, _ e: OpaquePointer?, _ lde: UnsafePointer<__LAPACK_int>, _ f: OpaquePointer?, _ ldf: UnsafePointer<__LAPACK_int>, _ scale: UnsafeMutablePointer<Float>, _ rdsum: UnsafeMutablePointer<Float>, _ rdscal: UnsafeMutablePointer<Float>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/ctgsy2_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*