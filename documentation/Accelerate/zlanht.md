...
```swift
func zlanht_(_ norm: UnsafePointer<CChar>, _ n: UnsafePointer<__LAPACK_int>, _ d: UnsafePointer<Double>?, _ e: OpaquePointer?) -> Double
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/zlanht_(_:_:_:_:))*