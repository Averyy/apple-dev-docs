...
```swift
func dlae2_(_ a: UnsafePointer<Double>, _ b: UnsafePointer<Double>, _ c: UnsafePointer<Double>, _ rt1: UnsafeMutablePointer<Double>, _ rt2: UnsafeMutablePointer<Double>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlae2_(_:_:_:_:_:))*