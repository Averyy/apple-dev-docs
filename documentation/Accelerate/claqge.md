...
```swift
func claqge_(_ m: UnsafePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ a: OpaquePointer?, _ lda: UnsafePointer<__LAPACK_int>, _ r: UnsafePointer<Float>?, _ c: UnsafePointer<Float>?, _ rowcnd: UnsafePointer<Float>, _ colcnd: UnsafePointer<Float>, _ amax: UnsafePointer<Float>, _ equed: UnsafeMutablePointer<CChar>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/claqge_(_:_:_:_:_:_:_:_:_:_:))*