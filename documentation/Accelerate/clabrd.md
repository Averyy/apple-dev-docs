# clabrd_(_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func clabrd_(_ m: UnsafePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ nb: UnsafePointer<__LAPACK_int>, _ a: OpaquePointer?, _ lda: UnsafePointer<__LAPACK_int>, _ d: UnsafeMutablePointer<Float>?, _ e: UnsafeMutablePointer<Float>?, _ tauq: OpaquePointer?, _ taup: OpaquePointer?, _ x: OpaquePointer?, _ ldx: UnsafePointer<__LAPACK_int>, _ y: OpaquePointer?, _ ldy: UnsafePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/clabrd_(_:_:_:_:_:_:_:_:_:_:_:_:_:))*