# vImageMax_ARGB8888(_:_:_:_:_:_:_:_:)
...
- `flags`: The options to use when performing the operation. If your code implements its own tiling or its own multithreading, pass [`kvImageDoNotTile`](kvimagedonottile.md); otherwise, pass [`kvImageNoFlags`](kvimagenoflags.md). To instruct the function to return the minimum size of the workspace memory, set the [`kvImageGetTempBufferSize`](kvimagegettempbuffersize.md) flag. To specify that the function doesn’t apply the operation to the alpha channel, set the [`kvImageLeaveAlphaUnchanged`](kvimageleavealphaunchanged.md) flag. To determine the minimum size for the temporary buffer, set the [`kvImageGetTempBufferSize`](kvimagegettempbuffersize.md) flag.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimagemax_argb8888(_:_:_:_:_:_:_:_:))*