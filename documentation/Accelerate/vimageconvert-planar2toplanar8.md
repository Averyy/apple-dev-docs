# vImageConvert_Planar2toPlanar8(_:_:_:)
...
```swift
func vImageConvert_Planar2toPlanar8(_ src: UnsafePointer<vImage_Buffer>, _ dest: UnsafePointer<vImage_Buffer>, _ flags: vImage_Flags) -> vImage_Error
```
...
The conversion uses the source pixel value multiplied by `85` as the corresponding destination pixel value.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimageconvert_planar2toplanar8(_:_:_:))*