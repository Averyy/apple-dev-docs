# vImageBufferFill_ARGB8888(_:_:_:)
...
```swift
func vImageBufferFill_ARGB8888(_ dest: UnsafePointer<vImage_Buffer>, _ color: UnsafePointer<UInt8>, _ flags: vImage_Flags) -> vImage_Error
```
...
let fillColor: [Pixel_8] = [64, 127, 192, 255]

pixelBuffer.withUnsafePointerToVImageBuffer { buf in
    _ = vImageBufferFill_ARGB8888(buf,
                                 fillColor,
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimagebufferfill_argb8888(_:_:_:))*