# dtgevc_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func dtgevc_(_ side: UnsafePointer<CChar>, _ howmny: UnsafePointer<CChar>, _ select: UnsafePointer<__LAPACK_bool>?, _ n: UnsafePointer<__LAPACK_int>, _ s: UnsafePointer<Double>?, _ lds: UnsafePointer<__LAPACK_int>, _ p: UnsafePointer<Double>?, _ ldp: UnsafePointer<__LAPACK_int>, _ vl: UnsafeMutablePointer<Double>?, _ ldvl: UnsafePointer<__LAPACK_int>, _ vr: UnsafeMutablePointer<Double>?, _ ldvr: UnsafePointer<__LAPACK_int>, _ mm: UnsafePointer<__LAPACK_int>, _ m: UnsafeMutablePointer<__LAPACK_int>, _ work: UnsafeMutablePointer<Double>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dtgevc_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*