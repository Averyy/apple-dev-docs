...
```swift
func dlagtf_(_ n: UnsafePointer<__LAPACK_int>, _ a: UnsafeMutablePointer<Double>?, _ lambda: UnsafePointer<Double>, _ b: UnsafeMutablePointer<Double>?, _ c: UnsafeMutablePointer<Double>?, _ tol: UnsafePointer<Double>, _ d: UnsafeMutablePointer<Double>?, _ in: UnsafeMutablePointer<__LAPACK_int>?, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlagtf_(_:_:_:_:_:_:_:_:_:))*