...
```swift
func slasd5_(_ i: UnsafePointer<__LAPACK_int>, _ d: UnsafePointer<Float>?, _ z: UnsafePointer<Float>?, _ delta: UnsafeMutablePointer<Float>?, _ rho: UnsafePointer<Float>, _ dsigma: UnsafeMutablePointer<Float>, _ work: UnsafeMutablePointer<Float>?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slasd5_(_:_:_:_:_:_:_:))*