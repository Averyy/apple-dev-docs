# zggglm_(_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func zggglm_(_ n: UnsafePointer<__LAPACK_int>, _ m: UnsafePointer<__LAPACK_int>, _ p: UnsafePointer<__LAPACK_int>, _ a: OpaquePointer?, _ lda: UnsafePointer<__LAPACK_int>, _ b: OpaquePointer?, _ ldb: UnsafePointer<__LAPACK_int>, _ d: OpaquePointer?, _ x: OpaquePointer?, _ y: OpaquePointer?, _ work: OpaquePointer, _ lwork: UnsafePointer<__LAPACK_int>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/zggglm_(_:_:_:_:_:_:_:_:_:_:_:_:_:))*