...
```swift
static func normalize(_ vector: some AccelerateBuffer<Double>) -> [Double]
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vdsp/normalize(_:)-9hp3n)*