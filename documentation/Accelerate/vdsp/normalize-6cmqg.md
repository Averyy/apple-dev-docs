...
```swift
static func normalize(_ vector: some AccelerateBuffer<Float>) -> [Float]
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vdsp/normalize(_:)-6cmqg)*