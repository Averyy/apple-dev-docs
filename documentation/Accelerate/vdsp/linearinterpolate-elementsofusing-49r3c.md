...
![A graph of the linearly interpolated values based on a control vector created with a ramp.](/images/com.apple.accelerate/media-3521343@2x.png)
...
![A graph of the linearly interpolated values based on a control vector created with a sigmoid function.](/images/com.apple.accelerate/media-3521334@2x.png)
