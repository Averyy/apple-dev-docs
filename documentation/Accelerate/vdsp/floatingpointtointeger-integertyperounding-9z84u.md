...
- `integerType`: The integer type that the function converts the source values to.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vdsp/floatingpointtointeger(_:integertype:rounding:)-9z84u)*