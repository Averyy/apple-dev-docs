...
The following is an example of using [`sumOfMagnitudes(_:)`](vdsp/sumofmagnitudes(_:)-3mdj2.md):
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vdsp/sumofmagnitudes(_:)-3mdj2)*