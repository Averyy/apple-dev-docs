...
The following is an example of using [`rootMeanSquare(_:)`](vdsp/rootmeansquare(_:)-9xkkk.md):
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vdsp/rootmeansquare(_:)-9xkkk)*