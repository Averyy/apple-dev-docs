...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vdsp/dftdoubleprecisionsplitcomplexfunctions/makediscretefouriertransform(previous:count:direction:transformtype:))*