...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vdsp/linearinterpolate(lookuptable:withoffsets:scale:baseoffset:result:)-4ownc)*