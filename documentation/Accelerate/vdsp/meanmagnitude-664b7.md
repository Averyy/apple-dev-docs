...
```swift
static func meanMagnitude<U>(_ vector: U) -> Double where U : AccelerateBuffer, U.Element == Double
```
...
The following is an example of using [`meanMagnitude(_:)`](vdsp/meanmagnitude(_:)-3fica.md):
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vdsp/meanmagnitude(_:)-664b7)*