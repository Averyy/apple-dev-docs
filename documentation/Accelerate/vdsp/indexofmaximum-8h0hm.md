...
```swift
static func indexOfMaximum<U>(_ vector: U) -> (UInt, Double) where U : AccelerateBuffer, U.Element == Double
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vdsp/indexofmaximum(_:)-8h0hm)*