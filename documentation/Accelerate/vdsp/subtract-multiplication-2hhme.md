...
- `multiplication`: The input scalar value   in  .
- `vector`: A tuple that contains the vectors   and   in  .
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vdsp/subtract(multiplication:_:)-2hhme)*