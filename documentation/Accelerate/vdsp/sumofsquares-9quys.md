...
The following is an example of using [`sumOfSquares(_:)`](vdsp/sumofsquares(_:)-2sew6.md):
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vdsp/sumofsquares(_:)-9quys)*