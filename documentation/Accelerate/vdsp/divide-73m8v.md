...
```swift
static func divide<U>(_ scalar: Double, _ vector: U) -> [Double] where U : AccelerateBuffer, U.Element == Double
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vdsp/divide(_:_:)-73m8v)*