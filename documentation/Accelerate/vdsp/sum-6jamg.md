...
The following is an example of using [`sum(_:)`](vdsp/sum(_:)-8hq9.md):
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vdsp/sum(_:)-6jamg)*