...
The following is an example of using [`meanSquare(_:)`](vdsp/meansquare(_:)-751e5.md):
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vdsp/meansquare(_:)-751e5)*