...
```swift
static func add<U>(_ scalar: Float, _ vector: U) -> [Float] where U : AccelerateBuffer, U.Element == Float
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vdsp/add(_:_:)-53nh9)*