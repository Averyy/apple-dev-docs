...
```swift
func dlaqz1_(_ a: UnsafePointer<Double>?, _ lda: UnsafePointer<__LAPACK_int>, _ b: UnsafePointer<Double>?, _ ldb: UnsafePointer<__LAPACK_int>, _ sr1: UnsafePointer<Double>, _ sr2: UnsafePointer<Double>, _ si: UnsafePointer<Double>, _ beta1: UnsafePointer<Double>, _ beta2: UnsafePointer<Double>, _ v: UnsafeMutablePointer<Double>?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlaqz1_(_:_:_:_:_:_:_:_:_:_:))*