...
```swift
func dlaqr1_(_ n: UnsafePointer<__LAPACK_int>, _ h: UnsafePointer<Double>?, _ ldh: UnsafePointer<__LAPACK_int>, _ sr1: UnsafePointer<Double>, _ si1: UnsafePointer<Double>, _ sr2: UnsafePointer<Double>, _ si2: UnsafePointer<Double>, _ v: UnsafeMutablePointer<Double>?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlaqr1_(_:_:_:_:_:_:_:_:))*