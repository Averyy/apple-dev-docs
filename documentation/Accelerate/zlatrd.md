...
```swift
func zlatrd_(_ uplo: UnsafePointer<CChar>, _ n: UnsafePointer<__LAPACK_int>, _ nb: UnsafePointer<__LAPACK_int>, _ a: OpaquePointer?, _ lda: UnsafePointer<__LAPACK_int>, _ e: UnsafeMutablePointer<Double>?, _ tau: OpaquePointer?, _ w: OpaquePointer?, _ ldw: UnsafePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/zlatrd_(_:_:_:_:_:_:_:_:_:))*