...
```swift
typealias Pixel_16F16F = (UInt16, UInt16)
```

#### Discussion

A two-channel, 16-bit floating-point per channel pixel.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/pixel_16f16f)*