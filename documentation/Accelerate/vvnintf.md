...
The following code shows an example of using [`vvnintf(_:_:_:)`](vvnintf(_:_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vvnintf(_:_:_:))*