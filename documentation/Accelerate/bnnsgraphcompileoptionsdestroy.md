...
- `options`: The compilation options object that the function destroys.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnsgraphcompileoptionsdestroy(_:))*