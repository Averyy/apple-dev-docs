# zlasyf_aa_(_:_:_:_:_:_:_:_:_:_:)
...
```swift
func zlasyf_aa_(_ uplo: UnsafePointer<CChar>, _ j1: UnsafePointer<__LAPACK_int>, _ m: UnsafePointer<__LAPACK_int>, _ nb: UnsafePointer<__LAPACK_int>, _ a: OpaquePointer?, _ lda: UnsafePointer<__LAPACK_int>, _ ipiv: UnsafeMutablePointer<__LAPACK_int>?, _ h: OpaquePointer?, _ ldh: UnsafePointer<__LAPACK_int>, _ work: OpaquePointer?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/zlasyf_aa_(_:_:_:_:_:_:_:_:_:_:))*