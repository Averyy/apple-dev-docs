...
- `C`: Pointer to an uninitialized sparse matrix object.  On success a newly allocated sparse matrix object is returned in this pointer.  On error, this set to `NULL`.You are responsible for calling [`sparse_matrix_destroy(_:)`](sparse_matrix_destroy(_:).md) on this matrix object.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sparse_outer_product_dense_float(_:_:_:_:_:_:_:_:_:))*