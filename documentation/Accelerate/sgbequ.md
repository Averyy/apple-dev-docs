# sgbequ_(_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func sgbequ_(_ m: UnsafePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ kl: UnsafePointer<__LAPACK_int>, _ ku: UnsafePointer<__LAPACK_int>, _ ab: UnsafePointer<Float>?, _ ldab: UnsafePointer<__LAPACK_int>, _ r: UnsafeMutablePointer<Float>?, _ c: UnsafeMutablePointer<Float>?, _ rowcnd: UnsafeMutablePointer<Float>, _ colcnd: UnsafeMutablePointer<Float>, _ amax: UnsafeMutablePointer<Float>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sgbequ_(_:_:_:_:_:_:_:_:_:_:_:_:))*