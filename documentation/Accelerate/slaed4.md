...
```swift
func slaed4_(_ n: UnsafePointer<__LAPACK_int>, _ i: UnsafePointer<__LAPACK_int>, _ d: UnsafePointer<Float>?, _ z: UnsafePointer<Float>?, _ delta: UnsafeMutablePointer<Float>?, _ rho: UnsafePointer<Float>, _ dlam: UnsafeMutablePointer<Float>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slaed4_(_:_:_:_:_:_:_:_:))*