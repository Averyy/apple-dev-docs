...
```swift
func dlacon_(_ n: UnsafePointer<__LAPACK_int>, _ v: UnsafeMutablePointer<Double>?, _ x: UnsafeMutablePointer<Double>?, _ isgn: UnsafeMutablePointer<__LAPACK_int>?, _ est: UnsafeMutablePointer<Double>, _ kase: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlacon_(_:_:_:_:_:_:))*