...
```swift
func dlaisnan_(_ din1: UnsafePointer<Double>, _ din2: UnsafePointer<Double>) -> __LAPACK_bool
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlaisnan_(_:_:))*