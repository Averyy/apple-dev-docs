...
```swift
static vUInt16 vU16HalfMultiply(vUInt16 __vbasicops_vA, vUInt16 __vbasicops_vB);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vu16halfmultiply)*