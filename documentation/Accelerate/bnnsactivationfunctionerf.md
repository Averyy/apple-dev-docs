...
```swift
var BNNSActivationFunctionErf: BNNSActivationFunction { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnsactivationfunctionerf)*