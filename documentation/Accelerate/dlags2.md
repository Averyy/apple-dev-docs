# dlags2_(_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func dlags2_(_ upper: UnsafePointer<__LAPACK_bool>, _ a1: UnsafePointer<Double>, _ a2: UnsafePointer<Double>, _ a3: UnsafePointer<Double>, _ b1: UnsafePointer<Double>, _ b2: UnsafePointer<Double>, _ b3: UnsafePointer<Double>, _ csu: UnsafeMutablePointer<Double>, _ snu: UnsafeMutablePointer<Double>, _ csv: UnsafeMutablePointer<Double>, _ snv: UnsafeMutablePointer<Double>, _ csq: UnsafeMutablePointer<Double>, _ snq: UnsafeMutablePointer<Double>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlags2_(_:_:_:_:_:_:_:_:_:_:_:_:_:))*