# sparse_get_vector_nonzero_count_double_complex(_:_:_:)
...
```swift
func sparse_get_vector_nonzero_count_double_complex(_ N: sparse_dimension, _ x: OpaquePointer!, _ incx: sparse_stride) -> Int
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sparse_get_vector_nonzero_count_double_complex(_:_:_:))*