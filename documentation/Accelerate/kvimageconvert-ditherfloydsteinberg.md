...
The following shows an 8-bit RGB image converted to a 1-bit planar image with [`vImageConvert_Planar8toPlanar1(_:_:_:_:_:)`](vimageconvert_planar8toplanar1(_:_:_:_:_:).md) using [`kvImageConvert_DitherFloydSteinberg`](kvimageconvert_ditherfloydsteinberg.md):

![Photos showing the original image and the dithered image.](https://docs-assets.developer.apple.com/published/d63c0633ff5457b0cc6611fcd71da79b/media-3358021%402x.png)
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/kvimageconvert_ditherfloydsteinberg)*