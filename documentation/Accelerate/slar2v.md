...
```swift
func slar2v_(_ n: UnsafePointer<__LAPACK_int>, _ x: UnsafeMutablePointer<Float>?, _ y: UnsafeMutablePointer<Float>?, _ z: UnsafeMutablePointer<Float>?, _ incx: UnsafePointer<__LAPACK_int>, _ c: UnsafePointer<Float>?, _ s: UnsafePointer<Float>?, _ incc: UnsafePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slar2v_(_:_:_:_:_:_:_:_:))*