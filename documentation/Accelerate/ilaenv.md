...
```swift
func ilaenv_(_ ispec: UnsafePointer<__LAPACK_int>, _ name: UnsafePointer<CChar>, _ opts: UnsafePointer<CChar>, _ n1: UnsafePointer<__LAPACK_int>, _ n2: UnsafePointer<__LAPACK_int>, _ n3: UnsafePointer<__LAPACK_int>, _ n4: UnsafePointer<__LAPACK_int>) -> __LAPACK_int
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/ilaenv_(_:_:_:_:_:_:_:))*