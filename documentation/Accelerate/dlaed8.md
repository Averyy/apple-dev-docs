# dlaed8_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func dlaed8_(_ icompq: UnsafePointer<__LAPACK_int>, _ k: UnsafeMutablePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ qsiz: UnsafePointer<__LAPACK_int>, _ d: UnsafeMutablePointer<Double>?, _ q: UnsafeMutablePointer<Double>?, _ ldq: UnsafePointer<__LAPACK_int>, _ indxq: UnsafeMutablePointer<__LAPACK_int>?, _ rho: UnsafeMutablePointer<Double>, _ cutpnt: UnsafePointer<__LAPACK_int>, _ z: UnsafeMutablePointer<Double>?, _ dlamda: UnsafeMutablePointer<Double>?, _ q2: UnsafeMutablePointer<Double>?, _ ldq2: UnsafePointer<__LAPACK_int>, _ w: UnsafeMutablePointer<Double>?, _ perm: UnsafeMutablePointer<__LAPACK_int>?, _ givptr: UnsafeMutablePointer<__LAPACK_int>, _ givcol: UnsafeMutablePointer<__LAPACK_int>?, _ givnum: UnsafeMutablePointer<Double>?, _ indxp: UnsafeMutablePointer<__LAPACK_int>?, _ indx: UnsafeMutablePointer<__LAPACK_int>?, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlaed8_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*