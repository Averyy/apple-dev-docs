...
```swift
func zaxpy_(_ N: UnsafePointer<__LAPACK_int>, _ ALPHA: OpaquePointer, _ X: OpaquePointer?, _ INCX: UnsafePointer<__LAPACK_int>, _ Y: OpaquePointer?, _ INCY: UnsafePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/zaxpy_(_:_:_:_:_:_:))*