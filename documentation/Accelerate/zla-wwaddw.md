...
```swift
func zla_wwaddw_(_ n: UnsafePointer<__LAPACK_int>, _ x: OpaquePointer?, _ y: OpaquePointer?, _ w: OpaquePointer?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/zla_wwaddw_(_:_:_:_:))*