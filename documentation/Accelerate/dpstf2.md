...
```swift
func dpstf2_(_ uplo: UnsafePointer<CChar>, _ n: UnsafePointer<__LAPACK_int>, _ a: UnsafeMutablePointer<Double>?, _ lda: UnsafePointer<__LAPACK_int>, _ piv: UnsafeMutablePointer<__LAPACK_int>?, _ rank: UnsafeMutablePointer<__LAPACK_int>, _ tol: UnsafePointer<Double>, _ work: UnsafeMutablePointer<Double>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dpstf2_(_:_:_:_:_:_:_:_:_:))*