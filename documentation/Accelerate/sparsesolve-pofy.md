...
```swift
func SparseSolve(_ Factored: SparseOpaqueFactorization_Double, _ xb: DenseVector_Double)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sparsesolve(_:_:)-pofy)*