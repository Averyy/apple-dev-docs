# dlasd3_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func dlasd3_(_ nl: UnsafePointer<__LAPACK_int>, _ nr: UnsafePointer<__LAPACK_int>, _ sqre: UnsafePointer<__LAPACK_int>, _ k: UnsafePointer<__LAPACK_int>, _ d: UnsafeMutablePointer<Double>?, _ q: UnsafeMutablePointer<Double>?, _ ldq: UnsafePointer<__LAPACK_int>, _ dsigma: UnsafeMutablePointer<Double>?, _ u: UnsafeMutablePointer<Double>?, _ ldu: UnsafePointer<__LAPACK_int>, _ u2: UnsafePointer<Double>?, _ ldu2: UnsafePointer<__LAPACK_int>, _ vt: UnsafeMutablePointer<Double>?, _ ldvt: UnsafePointer<__LAPACK_int>, _ vt2: UnsafeMutablePointer<Double>?, _ ldvt2: UnsafePointer<__LAPACK_int>, _ idxc: UnsafePointer<__LAPACK_int>?, _ ctot: UnsafePointer<__LAPACK_int>?, _ z: UnsafeMutablePointer<Double>?, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlasd3_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*