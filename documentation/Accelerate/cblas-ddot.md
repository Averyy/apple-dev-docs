...
```swift
func cblas_ddot(_ N: __LAPACK_int, _ X: UnsafePointer<Double>?, _ INCX: __LAPACK_int, _ Y: UnsafePointer<Double>?, _ INCY: __LAPACK_int) -> Double
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/cblas_ddot(_:_:_:_:_:))*