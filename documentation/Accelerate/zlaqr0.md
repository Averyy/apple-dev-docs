# zlaqr0_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func zlaqr0_(_ wantt: UnsafePointer<__LAPACK_bool>, _ wantz: UnsafePointer<__LAPACK_bool>, _ n: UnsafePointer<__LAPACK_int>, _ ilo: UnsafePointer<__LAPACK_int>, _ ihi: UnsafePointer<__LAPACK_int>, _ h: OpaquePointer?, _ ldh: UnsafePointer<__LAPACK_int>, _ w: OpaquePointer?, _ iloz: UnsafePointer<__LAPACK_int>, _ ihiz: UnsafePointer<__LAPACK_int>, _ z: OpaquePointer?, _ ldz: UnsafePointer<__LAPACK_int>, _ work: OpaquePointer, _ lwork: UnsafePointer<__LAPACK_int>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/zlaqr0_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*