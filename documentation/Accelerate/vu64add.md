...
```swift
static vUInt32 vU64Add(vUInt32 __vbasicops_vA, vUInt32 __vbasicops_vB);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vu64add)*