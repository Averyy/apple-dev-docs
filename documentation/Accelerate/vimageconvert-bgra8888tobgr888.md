...
```swift
#define vImageConvert_BGRA8888toBGR888(_bgraSrc, _bgrDest, _flags)
```
...
- `_bgraSrc`: The source vImage buffer.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimageconvert_bgra8888tobgr888)*