# sorbdb4_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func sorbdb4_(_ m: UnsafePointer<__LAPACK_int>, _ p: UnsafePointer<__LAPACK_int>, _ q: UnsafePointer<__LAPACK_int>, _ x11: UnsafeMutablePointer<Float>?, _ ldx11: UnsafePointer<__LAPACK_int>, _ x21: UnsafeMutablePointer<Float>?, _ ldx21: UnsafePointer<__LAPACK_int>, _ theta: UnsafeMutablePointer<Float>?, _ phi: UnsafeMutablePointer<Float>?, _ taup1: UnsafeMutablePointer<Float>?, _ taup2: UnsafeMutablePointer<Float>?, _ tauq1: UnsafeMutablePointer<Float>?, _ phantom: UnsafeMutablePointer<Float>?, _ work: UnsafeMutablePointer<Float>, _ lwork: UnsafePointer<__LAPACK_int>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sorbdb4_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*