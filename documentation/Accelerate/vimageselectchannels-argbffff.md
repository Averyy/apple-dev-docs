# vImageSelectChannels_ARGBFFFF(_:_:_:_:_:)
...
```swift
func vImageSelectChannels_ARGBFFFF(_ newSrc: UnsafePointer<vImage_Buffer>, _ origSrc: UnsafePointer<vImage_Buffer>, _ dest: UnsafePointer<vImage_Buffer>, _ copyMask: UInt8, _ flags: vImage_Flags) -> vImage_Error
```
...
let newSource = vImage.PixelBuffer<vImage.InterleavedFx4>(
...
pixelBuffer.withUnsafePointerToVImageBuffer { buf in
    newSource.withUnsafePointerToVImageBuffer { new in
        _ = vImageSelectChannels_ARGBFFFF(new,
                                          buf,
                                          buf,
                                          0x8,
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimageselectchannels_argbffff(_:_:_:_:_:))*