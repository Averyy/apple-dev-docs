...
```swift
func dlatdf_(_ ijob: UnsafePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ z: UnsafePointer<Double>?, _ ldz: UnsafePointer<__LAPACK_int>, _ rhs: UnsafeMutablePointer<Double>?, _ rdsum: UnsafeMutablePointer<Double>, _ rdscal: UnsafeMutablePointer<Double>, _ ipiv: UnsafePointer<__LAPACK_int>?, _ jpiv: UnsafePointer<__LAPACK_int>?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlatdf_(_:_:_:_:_:_:_:_:_:))*