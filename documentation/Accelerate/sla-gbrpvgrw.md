...
```swift
func sla_gbrpvgrw_(_ n: UnsafePointer<__LAPACK_int>, _ kl: UnsafePointer<__LAPACK_int>, _ ku: UnsafePointer<__LAPACK_int>, _ ncols: UnsafePointer<__LAPACK_int>, _ ab: UnsafePointer<Float>?, _ ldab: UnsafePointer<__LAPACK_int>, _ afb: UnsafePointer<Float>?, _ ldafb: UnsafePointer<__LAPACK_int>) -> Float
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sla_gbrpvgrw_(_:_:_:_:_:_:_:_:))*