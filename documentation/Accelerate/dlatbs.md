# dlatbs_(_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func dlatbs_(_ uplo: UnsafePointer<CChar>, _ trans: UnsafePointer<CChar>, _ diag: UnsafePointer<CChar>, _ normin: UnsafePointer<CChar>, _ n: UnsafePointer<__LAPACK_int>, _ kd: UnsafePointer<__LAPACK_int>, _ ab: UnsafePointer<Double>?, _ ldab: UnsafePointer<__LAPACK_int>, _ x: UnsafeMutablePointer<Double>?, _ scale: UnsafeMutablePointer<Double>, _ cnorm: UnsafeMutablePointer<Double>?, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlatbs_(_:_:_:_:_:_:_:_:_:_:_:_:))*