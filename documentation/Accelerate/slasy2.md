# slasy2_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func slasy2_(_ ltranl: UnsafePointer<__LAPACK_bool>, _ ltranr: UnsafePointer<__LAPACK_bool>, _ isgn: UnsafePointer<__LAPACK_int>, _ n1: UnsafePointer<__LAPACK_int>, _ n2: UnsafePointer<__LAPACK_int>, _ tl: UnsafePointer<Float>?, _ ldtl: UnsafePointer<__LAPACK_int>, _ tr: UnsafePointer<Float>?, _ ldtr: UnsafePointer<__LAPACK_int>, _ b: UnsafePointer<Float>?, _ ldb: UnsafePointer<__LAPACK_int>, _ scale: UnsafeMutablePointer<Float>, _ x: UnsafeMutablePointer<Float>?, _ ldx: UnsafePointer<__LAPACK_int>, _ xnorm: UnsafeMutablePointer<Float>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slasy2_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*