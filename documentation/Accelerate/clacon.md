...
```swift
func clacon_(_ n: UnsafePointer<__LAPACK_int>, _ v: OpaquePointer?, _ x: OpaquePointer?, _ est: UnsafeMutablePointer<Float>, _ kase: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/clacon_(_:_:_:_:_:))*