...
The inner product of sparse vector  with dense vector .  Returns zero if `nz` is less than or equal to zero.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sparse_inner_product_dense_double(_:_:_:_:_:))*