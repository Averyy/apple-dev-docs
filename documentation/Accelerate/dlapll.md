...
```swift
func dlapll_(_ n: UnsafePointer<__LAPACK_int>, _ x: UnsafeMutablePointer<Double>?, _ incx: UnsafePointer<__LAPACK_int>, _ y: UnsafeMutablePointer<Double>?, _ incy: UnsafePointer<__LAPACK_int>, _ ssmin: UnsafeMutablePointer<Double>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlapll_(_:_:_:_:_:_:))*