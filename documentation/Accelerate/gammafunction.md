...
You use this data type when you create a gamma function. See [`vImageCreateGammaFunction(_:_:_:)`](vimagecreategammafunction(_:_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/gammafunction)*