...
```swift
func dladiv2_(_ a: UnsafePointer<Double>, _ b: UnsafePointer<Double>, _ c: UnsafePointer<Double>, _ d: UnsafePointer<Double>, _ r: UnsafePointer<Double>, _ t: UnsafePointer<Double>) -> Double
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dladiv2_(_:_:_:_:_:_:))*