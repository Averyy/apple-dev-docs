# dlarrj_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func dlarrj_(_ n: UnsafePointer<__LAPACK_int>, _ d: UnsafePointer<Double>?, _ e2: UnsafePointer<Double>?, _ ifirst: UnsafePointer<__LAPACK_int>, _ ilast: UnsafePointer<__LAPACK_int>, _ rtol: UnsafePointer<Double>, _ offset: UnsafePointer<__LAPACK_int>, _ w: UnsafeMutablePointer<Double>?, _ werr: UnsafeMutablePointer<Double>?, _ work: UnsafeMutablePointer<Double>, _ iwork: UnsafeMutablePointer<__LAPACK_int>?, _ pivmin: UnsafePointer<Double>, _ spdiam: UnsafePointer<Double>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlarrj_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*