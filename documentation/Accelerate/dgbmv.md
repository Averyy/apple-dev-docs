# dgbmv_(_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func dgbmv_(_ TRANS: UnsafePointer<CChar>, _ M: UnsafePointer<__LAPACK_int>, _ N: UnsafePointer<__LAPACK_int>, _ KL: UnsafePointer<__LAPACK_int>, _ KU: UnsafePointer<__LAPACK_int>, _ ALPHA: UnsafePointer<Double>, _ A: UnsafePointer<Double>?, _ LDA: UnsafePointer<__LAPACK_int>, _ X: UnsafePointer<Double>?, _ INCX: UnsafePointer<__LAPACK_int>, _ BETA: UnsafePointer<Double>, _ Y: UnsafeMutablePointer<Double>?, _ INCY: UnsafePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dgbmv_(_:_:_:_:_:_:_:_:_:_:_:_:_:))*