...
let destination = vImage.PixelBuffer<vImage.InterleavedFx3>(
    size: .init(width: 5, height: 1))
...
- `table`: A lookup table that contains 256 [`Pixel_FFFF`](pixel_ffff.md) values. Elements `1`, `2`, and `3` store the red, green, and blue values.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimagelookuptable_planar8toplanar96(_:_:_:_:))*