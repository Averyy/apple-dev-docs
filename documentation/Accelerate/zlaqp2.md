...
```swift
func zlaqp2_(_ m: UnsafePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ offset: UnsafePointer<__LAPACK_int>, _ a: OpaquePointer?, _ lda: UnsafePointer<__LAPACK_int>, _ jpvt: UnsafeMutablePointer<__LAPACK_int>?, _ tau: OpaquePointer?, _ vn1: UnsafeMutablePointer<Double>?, _ vn2: UnsafeMutablePointer<Double>?, _ work: OpaquePointer?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/zlaqp2_(_:_:_:_:_:_:_:_:_:_:))*