...
```swift
func slacon_(_ n: UnsafePointer<__LAPACK_int>, _ v: UnsafeMutablePointer<Float>?, _ x: UnsafeMutablePointer<Float>?, _ isgn: UnsafeMutablePointer<__LAPACK_int>?, _ est: UnsafeMutablePointer<Float>, _ kase: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slacon_(_:_:_:_:_:_:))*