# clags2_(_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func clags2_(_ upper: UnsafePointer<__LAPACK_bool>, _ a1: UnsafePointer<Float>, _ a2: OpaquePointer, _ a3: UnsafePointer<Float>, _ b1: UnsafePointer<Float>, _ b2: OpaquePointer, _ b3: UnsafePointer<Float>, _ csu: UnsafeMutablePointer<Float>, _ snu: OpaquePointer, _ csv: UnsafeMutablePointer<Float>, _ snv: OpaquePointer, _ csq: UnsafeMutablePointer<Float>, _ snq: OpaquePointer)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/clags2_(_:_:_:_:_:_:_:_:_:_:_:_:_:))*