# BNNSRelationalOperatorLogicalNOT
...
```swift
var BNNSRelationalOperatorLogicalNOT: BNNSRelationalOperator { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnsrelationaloperatorlogicalnot)*