...
```swift
func dlarfp_(_ n: UnsafePointer<__LAPACK_int>, _ alpha: UnsafeMutablePointer<Double>, _ x: UnsafeMutablePointer<Double>?, _ incx: UnsafePointer<__LAPACK_int>, _ tau: UnsafeMutablePointer<Double>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlarfp_(_:_:_:_:_:))*