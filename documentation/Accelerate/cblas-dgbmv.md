# cblas_dgbmv(_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func cblas_dgbmv(_ ORDER: CBLAS_ORDER, _ TRANSA: CBLAS_TRANSPOSE, _ M: __LAPACK_int, _ N: __LAPACK_int, _ KL: __LAPACK_int, _ KU: __LAPACK_int, _ ALPHA: Double, _ A: UnsafePointer<Double>?, _ LDA: __LAPACK_int, _ X: UnsafePointer<Double>?, _ INCX: __LAPACK_int, _ BETA: Double, _ Y: UnsafeMutablePointer<Double>?, _ INCY: __LAPACK_int)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/cblas_dgbmv(_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*