...
- `__Setup`: A setup object as returned by a call to  .   must be specified in the call to  .   is preserved for reuse.
...
- `__Direction`: A forward/inverse directional flag, which must specify   (+1) or   (-1)for an inverse transform.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vdsp_fft3_zop)*