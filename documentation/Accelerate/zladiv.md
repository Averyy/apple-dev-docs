...
```swift
func zladiv_(_ ret: OpaquePointer, _ x: OpaquePointer, _ y: OpaquePointer)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/zladiv_(_:_:_:))*