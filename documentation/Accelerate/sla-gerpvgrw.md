...
```swift
func sla_gerpvgrw_(_ n: UnsafePointer<__LAPACK_int>, _ ncols: UnsafePointer<__LAPACK_int>, _ a: UnsafePointer<Float>?, _ lda: UnsafePointer<__LAPACK_int>, _ af: UnsafePointer<Float>?, _ ldaf: UnsafePointer<__LAPACK_int>) -> Float
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sla_gerpvgrw_(_:_:_:_:_:_:))*