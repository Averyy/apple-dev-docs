...
```swift
func sgttrf_(_ n: UnsafePointer<__LAPACK_int>, _ dl: UnsafeMutablePointer<Float>?, _ d: UnsafeMutablePointer<Float>?, _ du: UnsafeMutablePointer<Float>?, _ du2: UnsafeMutablePointer<Float>?, _ ipiv: UnsafeMutablePointer<__LAPACK_int>?, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sgttrf_(_:_:_:_:_:_:_:))*