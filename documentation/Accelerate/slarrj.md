# slarrj_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func slarrj_(_ n: UnsafePointer<__LAPACK_int>, _ d: UnsafePointer<Float>?, _ e2: UnsafePointer<Float>?, _ ifirst: UnsafePointer<__LAPACK_int>, _ ilast: UnsafePointer<__LAPACK_int>, _ rtol: UnsafePointer<Float>, _ offset: UnsafePointer<__LAPACK_int>, _ w: UnsafeMutablePointer<Float>?, _ werr: UnsafeMutablePointer<Float>?, _ work: UnsafeMutablePointer<Float>, _ iwork: UnsafeMutablePointer<__LAPACK_int>?, _ pivmin: UnsafePointer<Float>, _ spdiam: UnsafePointer<Float>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slarrj_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*