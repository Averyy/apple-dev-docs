...
The following code shows an example of using [`vvrsqrt(_:_:_:)`](vvrsqrt(_:_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vvrsqrt(_:_:_:))*