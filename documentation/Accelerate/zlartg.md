...
```swift
func zlartg_(_ f: OpaquePointer, _ g: OpaquePointer, _ cs: UnsafeMutablePointer<Double>, _ sn: OpaquePointer, _ r: OpaquePointer)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/zlartg_(_:_:_:_:_:))*