...
```swift
func dlamc4_(_ emin: UnsafeMutablePointer<__LAPACK_int>, _ start: UnsafePointer<Double>, _ base: UnsafePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlamc4_(_:_:_:))*