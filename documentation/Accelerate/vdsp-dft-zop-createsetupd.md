...
- `__Length`: The number of complex elements to process. The supported values are   * 2** , where   is 1, 3, 5, or 15 and   is at least 3.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vdsp_dft_zop_createsetupd)*