# sggglm_(_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func sggglm_(_ n: UnsafePointer<__LAPACK_int>, _ m: UnsafePointer<__LAPACK_int>, _ p: UnsafePointer<__LAPACK_int>, _ a: UnsafeMutablePointer<Float>?, _ lda: UnsafePointer<__LAPACK_int>, _ b: UnsafeMutablePointer<Float>?, _ ldb: UnsafePointer<__LAPACK_int>, _ d: UnsafeMutablePointer<Float>?, _ x: UnsafeMutablePointer<Float>?, _ y: UnsafeMutablePointer<Float>?, _ work: UnsafeMutablePointer<Float>, _ lwork: UnsafePointer<__LAPACK_int>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sggglm_(_:_:_:_:_:_:_:_:_:_:_:_:_:))*