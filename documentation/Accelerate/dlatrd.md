...
```swift
func dlatrd_(_ uplo: UnsafePointer<CChar>, _ n: UnsafePointer<__LAPACK_int>, _ nb: UnsafePointer<__LAPACK_int>, _ a: UnsafeMutablePointer<Double>?, _ lda: UnsafePointer<__LAPACK_int>, _ e: UnsafeMutablePointer<Double>?, _ tau: UnsafeMutablePointer<Double>?, _ w: UnsafeMutablePointer<Double>?, _ ldw: UnsafePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlatrd_(_:_:_:_:_:_:_:_:_:))*