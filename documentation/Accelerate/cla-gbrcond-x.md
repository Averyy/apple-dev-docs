# cla_gbrcond_x_(_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func cla_gbrcond_x_(_ trans: UnsafePointer<CChar>, _ n: UnsafePointer<__LAPACK_int>, _ kl: UnsafePointer<__LAPACK_int>, _ ku: UnsafePointer<__LAPACK_int>, _ ab: OpaquePointer?, _ ldab: UnsafePointer<__LAPACK_int>, _ afb: OpaquePointer?, _ ldafb: UnsafePointer<__LAPACK_int>, _ ipiv: UnsafePointer<__LAPACK_int>?, _ x: OpaquePointer?, _ info: UnsafeMutablePointer<__LAPACK_int>, _ work: OpaquePointer, _ rwork: UnsafeMutablePointer<Float>?) -> Float
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/cla_gbrcond_x_(_:_:_:_:_:_:_:_:_:_:_:_:_:))*