...
```swift
func ctrexc_(_ compq: UnsafePointer<CChar>, _ n: UnsafePointer<__LAPACK_int>, _ t: OpaquePointer?, _ ldt: UnsafePointer<__LAPACK_int>, _ q: OpaquePointer?, _ ldq: UnsafePointer<__LAPACK_int>, _ ifst: UnsafePointer<__LAPACK_int>, _ ilst: UnsafePointer<__LAPACK_int>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/ctrexc_(_:_:_:_:_:_:_:_:_:))*