# zhseqr_(_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func zhseqr_(_ job: UnsafePointer<CChar>, _ compz: UnsafePointer<CChar>, _ n: UnsafePointer<__LAPACK_int>, _ ilo: UnsafePointer<__LAPACK_int>, _ ihi: UnsafePointer<__LAPACK_int>, _ h: OpaquePointer?, _ ldh: UnsafePointer<__LAPACK_int>, _ w: OpaquePointer?, _ z: OpaquePointer?, _ ldz: UnsafePointer<__LAPACK_int>, _ work: OpaquePointer, _ lwork: UnsafePointer<__LAPACK_int>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/zhseqr_(_:_:_:_:_:_:_:_:_:_:_:_:_:))*