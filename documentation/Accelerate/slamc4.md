...
```swift
func slamc4_(_ emin: UnsafeMutablePointer<__LAPACK_int>, _ start: UnsafePointer<Float>, _ base: UnsafePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slamc4_(_:_:_:))*