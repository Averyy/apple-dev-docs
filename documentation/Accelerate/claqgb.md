# claqgb_(_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func claqgb_(_ m: UnsafePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ kl: UnsafePointer<__LAPACK_int>, _ ku: UnsafePointer<__LAPACK_int>, _ ab: OpaquePointer?, _ ldab: UnsafePointer<__LAPACK_int>, _ r: UnsafePointer<Float>?, _ c: UnsafePointer<Float>?, _ rowcnd: UnsafePointer<Float>, _ colcnd: UnsafePointer<Float>, _ amax: UnsafePointer<Float>, _ equed: UnsafeMutablePointer<CChar>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/claqgb_(_:_:_:_:_:_:_:_:_:_:_:_:))*