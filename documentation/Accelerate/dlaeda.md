# dlaeda_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func dlaeda_(_ n: UnsafePointer<__LAPACK_int>, _ tlvls: UnsafePointer<__LAPACK_int>, _ curlvl: UnsafePointer<__LAPACK_int>, _ curpbm: UnsafePointer<__LAPACK_int>, _ prmptr: UnsafePointer<__LAPACK_int>?, _ perm: UnsafePointer<__LAPACK_int>?, _ givptr: UnsafePointer<__LAPACK_int>?, _ givcol: UnsafePointer<__LAPACK_int>?, _ givnum: UnsafePointer<Double>?, _ q: UnsafePointer<Double>?, _ qptr: UnsafePointer<__LAPACK_int>?, _ z: UnsafeMutablePointer<Double>?, _ ztemp: UnsafeMutablePointer<Double>?, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlaeda_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*