...
The path that the [`BNNSGraphCompileOptionsSetOutputPath(_:_:)`](bnnsgraphcompileoptionssetoutputpath(_:_:).md) function defines, if any.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnsgraphcompileoptionsgetoutputpath(_:))*