...
```swift
func dlartgs_(_ x: UnsafePointer<Double>, _ y: UnsafePointer<Double>, _ sigma: UnsafePointer<Double>, _ cs: UnsafeMutablePointer<Double>, _ sn: UnsafeMutablePointer<Double>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlartgs_(_:_:_:_:_:))*