...
```swift
func slaneg_(_ n: UnsafePointer<__LAPACK_int>, _ d: UnsafePointer<Float>?, _ lld: UnsafePointer<Float>?, _ sigma: UnsafePointer<Float>, _ pivmin: UnsafePointer<Float>, _ r: UnsafePointer<__LAPACK_int>) -> __LAPACK_int
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slaneg_(_:_:_:_:_:_:))*