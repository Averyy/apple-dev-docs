...
The following code shows an example of using [`vvfloorf(_:_:_:)`](vvfloorf(_:_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vvfloorf(_:_:_:))*