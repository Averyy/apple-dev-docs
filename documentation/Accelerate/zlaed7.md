# zlaed7_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func zlaed7_(_ n: UnsafePointer<__LAPACK_int>, _ cutpnt: UnsafePointer<__LAPACK_int>, _ qsiz: UnsafePointer<__LAPACK_int>, _ tlvls: UnsafePointer<__LAPACK_int>, _ curlvl: UnsafePointer<__LAPACK_int>, _ curpbm: UnsafePointer<__LAPACK_int>, _ d: UnsafeMutablePointer<Double>?, _ q: OpaquePointer?, _ ldq: UnsafePointer<__LAPACK_int>, _ rho: UnsafeMutablePointer<Double>, _ indxq: UnsafeMutablePointer<__LAPACK_int>?, _ qstore: UnsafeMutablePointer<Double>?, _ qptr: UnsafeMutablePointer<__LAPACK_int>?, _ prmptr: UnsafeMutablePointer<__LAPACK_int>?, _ perm: UnsafeMutablePointer<__LAPACK_int>?, _ givptr: UnsafeMutablePointer<__LAPACK_int>?, _ givcol: UnsafeMutablePointer<__LAPACK_int>?, _ givnum: UnsafeMutablePointer<Double>?, _ work: OpaquePointer, _ rwork: UnsafeMutablePointer<Double>?, _ iwork: UnsafeMutablePointer<__LAPACK_int>?, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/zlaed7_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*