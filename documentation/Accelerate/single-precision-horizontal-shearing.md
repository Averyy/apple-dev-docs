...
- [func vImageHorizontalShear_Planar8(UnsafePointer<vImage_Buffer>, UnsafePointer<vImage_Buffer>, vImagePixelCount, vImagePixelCount, Float, Float, ResamplingFilter!, Pixel_8, vImage_Flags) -> vImage_Error](vimagehorizontalshear_planar8(_:_:_:_:_:_:_:_:_:).md)
...
- [func vImageHorizontalShear_XRGB2101010W(UnsafePointer<vImage_Buffer>, UnsafePointer<vImage_Buffer>, vImagePixelCount, vImagePixelCount, Float, Float, ResamplingFilter!, Pixel_32U, vImage_Flags) -> vImage_Error](vimagehorizontalshear_xrgb2101010w(_:_:_:_:_:_:_:_:_:).md)
...
- [func vImageHorizontalShear_CbCr16F(UnsafePointer<vImage_Buffer>, UnsafePointer<vImage_Buffer>, vImagePixelCount, vImagePixelCount, Float, Float, ResamplingFilter!, UnsafePointer<UInt16>!, vImage_Flags) -> vImage_Error](vimagehorizontalshear_cbcr16f(_:_:_:_:_:_:_:_:_:).md)
...
- [func vImageHorizontalShear_PlanarF(UnsafePointer<vImage_Buffer>, UnsafePointer<vImage_Buffer>, vImagePixelCount, vImagePixelCount, Float, Float, ResamplingFilter!, Pixel_F, vImage_Flags) -> vImage_Error](vimagehorizontalshear_planarf(_:_:_:_:_:_:_:_:_:).md)
  Performs a single-precision horizontal shear on a region of interest within a 32-bit planar image.
- [func vImageHorizontalShear_ARGBFFFF(UnsafePointer<vImage_Buffer>, UnsafePointer<vImage_Buffer>, vImagePixelCount, vImagePixelCount, Float, Float, ResamplingFilter!, UnsafePointer<Float>!, vImage_Flags) -> vImage_Error](vimagehorizontalshear_argbffff(_:_:_:_:_:_:_:_:_:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/single-precision-horizontal-shearing)*