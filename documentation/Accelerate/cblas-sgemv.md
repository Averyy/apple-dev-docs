# cblas_sgemv(_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func cblas_sgemv(_ ORDER: CBLAS_ORDER, _ TRANSA: CBLAS_TRANSPOSE, _ M: __LAPACK_int, _ N: __LAPACK_int, _ ALPHA: Float, _ A: UnsafePointer<Float>?, _ LDA: __LAPACK_int, _ X: UnsafePointer<Float>?, _ INCX: __LAPACK_int, _ BETA: Float, _ Y: UnsafeMutablePointer<Float>?, _ INCY: __LAPACK_int)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/cblas_sgemv(_:_:_:_:_:_:_:_:_:_:_:_:))*