...
```swift
func dlasv2_(_ f: UnsafePointer<Double>, _ g: UnsafePointer<Double>, _ h: UnsafePointer<Double>, _ ssmin: UnsafeMutablePointer<Double>, _ ssmax: UnsafeMutablePointer<Double>, _ snr: UnsafeMutablePointer<Double>, _ csr: UnsafeMutablePointer<Double>, _ snl: UnsafeMutablePointer<Double>, _ csl: UnsafeMutablePointer<Double>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlasv2_(_:_:_:_:_:_:_:_:_:))*