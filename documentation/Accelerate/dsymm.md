# dsymm_(_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func dsymm_(_ SIDE: UnsafePointer<CChar>, _ UPLO: UnsafePointer<CChar>, _ M: UnsafePointer<__LAPACK_int>, _ N: UnsafePointer<__LAPACK_int>, _ ALPHA: UnsafePointer<Double>, _ A: UnsafePointer<Double>?, _ LDA: UnsafePointer<__LAPACK_int>, _ B: UnsafePointer<Double>?, _ LDB: UnsafePointer<__LAPACK_int>, _ BETA: UnsafePointer<Double>, _ C: UnsafeMutablePointer<Double>?, _ LDC: UnsafePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dsymm_(_:_:_:_:_:_:_:_:_:_:_:_:))*