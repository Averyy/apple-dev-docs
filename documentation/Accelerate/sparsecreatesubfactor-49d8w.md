...
A `SparseOpaqueSubfactor_Double` structure that represents the subfactor. You must free the resource through a call to [`SparseCleanup(_:)`](sparsecleanup(_:)-15kpj.md) after you finish with the object.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sparsecreatesubfactor(_:_:)-49d8w)*