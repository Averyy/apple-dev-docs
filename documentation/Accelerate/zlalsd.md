# zlalsd_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func zlalsd_(_ uplo: UnsafePointer<CChar>, _ smlsiz: UnsafePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ nrhs: UnsafePointer<__LAPACK_int>, _ d: UnsafeMutablePointer<Double>?, _ e: UnsafeMutablePointer<Double>?, _ b: OpaquePointer?, _ ldb: UnsafePointer<__LAPACK_int>, _ rcond: UnsafePointer<Double>, _ rank: UnsafeMutablePointer<__LAPACK_int>, _ work: OpaquePointer, _ rwork: UnsafeMutablePointer<Double>?, _ iwork: UnsafeMutablePointer<__LAPACK_int>?, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/zlalsd_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*