# slasda_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func slasda_(_ icompq: UnsafePointer<__LAPACK_int>, _ smlsiz: UnsafePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ sqre: UnsafePointer<__LAPACK_int>, _ d: UnsafeMutablePointer<Float>?, _ e: UnsafeMutablePointer<Float>?, _ u: UnsafeMutablePointer<Float>?, _ ldu: UnsafePointer<__LAPACK_int>, _ vt: UnsafeMutablePointer<Float>?, _ k: UnsafeMutablePointer<__LAPACK_int>?, _ difl: UnsafeMutablePointer<Float>?, _ difr: UnsafeMutablePointer<Float>?, _ z: UnsafeMutablePointer<Float>?, _ poles: UnsafeMutablePointer<Float>?, _ givptr: UnsafeMutablePointer<__LAPACK_int>?, _ givcol: UnsafeMutablePointer<__LAPACK_int>?, _ ldgcol: UnsafePointer<__LAPACK_int>, _ perm: UnsafeMutablePointer<__LAPACK_int>?, _ givnum: UnsafeMutablePointer<Float>?, _ c: UnsafeMutablePointer<Float>?, _ s: UnsafeMutablePointer<Float>?, _ work: UnsafeMutablePointer<Float>, _ iwork: UnsafeMutablePointer<__LAPACK_int>?, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slasda_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*