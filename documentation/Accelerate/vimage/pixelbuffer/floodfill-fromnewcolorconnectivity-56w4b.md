...
![Two versions of a line drawing of a star. On the left is the original outline drawing of a star, and on the right is the same star but flood-filled with a solid color.](https://docs-assets.developer.apple.com/published/c92befd5e401ee5a0934b6c48ee125d8/media-4165182%402x.png)
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimage/pixelbuffer/floodfill(from:newcolor:connectivity:)-56w4b)*