...
Use this function to deinterleave a buffer and create three new planar buffers that contain copies of each source channel. For example, the following code generates three 1 x 1 planar buffers from an [`vImage.Interleaved8x3`](vimage/interleaved8x3.md) pixel buffer:
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimage/pixelbuffer/planarbuffers()-5r3ds)*