...
```swift
func rotate(_ rotation: vImage.Rotation, backgroundColor: Pixel_8? = Pixel_8(0), destination: vImage.PixelBuffer<Format>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimage/pixelbuffer/rotate(_:backgroundcolor:destination:)-7patt)*