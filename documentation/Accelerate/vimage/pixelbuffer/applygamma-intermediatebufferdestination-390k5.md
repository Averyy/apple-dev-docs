...
This operation applies gamma to an [`vImage.Interleaved8x2`](vimage/interleaved8x2.md) buffer by calling the underlying function [`vImageGamma_Planar8toPlanarF(_:_:_:_:)`](vimagegamma_planar8toplanarf(_:_:_:_:).md). Therefore, it requires an intermediate [`vImage.InterleavedFx2`](vimage/interleavedfx2.md) buffer. For the best performance, pass an existing [`vImage.InterleavedFx2`](vimage/interleavedfx2.md) buffer to `intermediateBuffer`, alternatively, pass ``nil`` to specify that the function creates the intermediate buffer.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimage/pixelbuffer/applygamma(_:intermediatebuffer:destination:)-390k5)*