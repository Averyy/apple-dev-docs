...
This operation applies gamma to an [`vImage.Interleaved8x3`](vimage/interleaved8x3.md) buffer by calling the underlying function [`vImageGamma_Planar8toPlanarF(_:_:_:_:)`](vimagegamma_planar8toplanarf(_:_:_:_:).md). Therefore, it requires an intermediate [`vImage.InterleavedFx3`](vimage/interleavedfx3.md) buffer. For the best performance, pass an existing [`vImage.InterleavedFx3`](vimage/interleavedfx3.md) buffer to `intermediateBuffer`, alternatively, pass ``nil`` to specify that the function creates the intermediate buffer.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimage/pixelbuffer/applygamma(_:intermediatebuffer:destination:)-3yu0w)*