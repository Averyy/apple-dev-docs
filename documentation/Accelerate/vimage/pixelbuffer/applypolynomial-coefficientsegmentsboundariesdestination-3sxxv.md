...
The following code shows an example of applying three polynomials to an [`vImage.Interleaved8x2`](vimage/interleaved8x2.md) buffer:
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimage/pixelbuffer/applypolynomial(coefficientsegments:boundaries:destination:)-3sxxv)*