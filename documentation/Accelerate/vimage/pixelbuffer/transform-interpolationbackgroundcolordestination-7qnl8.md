...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimage/pixelbuffer/transform(_:interpolation:backgroundcolor:destination:)-7qnl8)*