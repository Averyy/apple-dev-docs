...
Use this function to deinterleave a buffer and create two new planar buffers that contain copies of each source channel. For example, the following code generates two 1 x 1 planar buffers from an [`vImage.Interleaved8x2`](vimage/interleaved8x2.md) pixel buffer:
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimage/pixelbuffer/planarbuffers()-462ja)*