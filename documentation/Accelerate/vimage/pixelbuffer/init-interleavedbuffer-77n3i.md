...
For example, the following code creates a new [`vImage.PlanarFx3`](vimage/planarfx3.md) pixel buffer from a [`vImage.InterleavedFx3`](vimage/interleavedfx3.md) pixel buffer:
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimage/pixelbuffer/init(interleavedbuffer:)-77n3i)*