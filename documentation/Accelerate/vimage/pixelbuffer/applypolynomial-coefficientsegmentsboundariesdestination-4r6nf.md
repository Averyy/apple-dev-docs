...
The following code shows an example of applying three polynomials to a [`vImage.InterleavedFx3`](vimage/interleavedfx3.md) buffer:
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimage/pixelbuffer/applypolynomial(coefficientsegments:boundaries:destination:)-4r6nf)*