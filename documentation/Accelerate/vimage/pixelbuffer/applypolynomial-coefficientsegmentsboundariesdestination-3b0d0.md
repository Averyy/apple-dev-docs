...
The following code shows an example of applying three polynomials to a [`vImage.PlanarF`](vimage/planarf.md) buffer:
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimage/pixelbuffer/applypolynomial(coefficientsegments:boundaries:destination:)-3b0d0)*