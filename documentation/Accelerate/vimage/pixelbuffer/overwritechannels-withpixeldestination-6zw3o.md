...
```swift
func overwriteChannels(_ channels: [UInt8], withPixel pixel: Pixel_ARGB_16U, destination: vImage.PixelBuffer<Format>)
```
...
```swift
let pixelValues: [Pixel_16U] = [ 1, 2, 3, 4,
                                 5, 6, 7, 8 ]
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimage/pixelbuffer/overwritechannels(_:withpixel:destination:)-6zw3o)*