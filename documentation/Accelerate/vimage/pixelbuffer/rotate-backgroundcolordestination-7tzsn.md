...
```swift
func rotate(_ rotation: vImage.Rotation, backgroundColor: Pixel_F? = Pixel_F(0), destination: vImage.PixelBuffer<Format>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimage/pixelbuffer/rotate(_:backgroundcolor:destination:)-7tzsn)*