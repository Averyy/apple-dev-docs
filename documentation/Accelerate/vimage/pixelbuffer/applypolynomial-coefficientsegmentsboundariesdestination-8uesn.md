...
The following code shows an example of applying three polynomials to an [`vImage.InterleavedFx4`](vimage/interleavedfx4.md) buffer:
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimage/pixelbuffer/applypolynomial(coefficientsegments:boundaries:destination:)-8uesn)*