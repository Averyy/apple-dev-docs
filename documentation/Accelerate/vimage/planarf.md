...
### Type Methods
- [static func makePixel(Pixel_16F) -> Pixel_F](vimage/planarf/makepixel(_:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimage/planarf)*