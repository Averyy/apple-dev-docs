# vImage.MorphologyOperation.maximize(kernelSize:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimage/morphologyoperation/maximize(kernelsize:))*