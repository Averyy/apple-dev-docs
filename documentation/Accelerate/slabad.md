...
```swift
func slabad_(_ small: UnsafeMutablePointer<Float>, _ large: UnsafeMutablePointer<Float>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slabad_(_:_:))*