...
```swift
func vU256Divide(_ numerator: UnsafePointer<vU256>, _ divisor: UnsafePointer<vU256>, _ result: UnsafeMutablePointer<vU256>, _ remainder: UnsafeMutablePointer<vU256>?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vu256divide(_:_:_:_:))*