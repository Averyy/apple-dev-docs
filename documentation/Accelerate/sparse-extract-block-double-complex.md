# sparse_extract_block_double_complex(_:_:_:_:_:_:)
...
```swift
func sparse_extract_block_double_complex(_ A: sparse_matrix_double_complex!, _ bi: sparse_index, _ bj: sparse_index, _ row_stride: sparse_dimension, _ col_stride: sparse_dimension, _ val: OpaquePointer!) -> sparse_status
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sparse_extract_block_double_complex(_:_:_:_:_:_:))*