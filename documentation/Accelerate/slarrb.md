# slarrb_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func slarrb_(_ n: UnsafePointer<__LAPACK_int>, _ d: UnsafePointer<Float>?, _ lld: UnsafePointer<Float>?, _ ifirst: UnsafePointer<__LAPACK_int>, _ ilast: UnsafePointer<__LAPACK_int>, _ rtol1: UnsafePointer<Float>, _ rtol2: UnsafePointer<Float>, _ offset: UnsafePointer<__LAPACK_int>, _ w: UnsafeMutablePointer<Float>?, _ wgap: UnsafeMutablePointer<Float>?, _ werr: UnsafeMutablePointer<Float>?, _ work: UnsafeMutablePointer<Float>, _ iwork: UnsafeMutablePointer<__LAPACK_int>?, _ pivmin: UnsafePointer<Float>, _ spdiam: UnsafePointer<Float>, _ twist: UnsafePointer<__LAPACK_int>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slarrb_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*