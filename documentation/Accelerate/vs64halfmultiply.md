...
```swift
func vS64HalfMultiply(_ vA: vSInt32, _ vB: vSInt32) -> vSInt32
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vs64halfmultiply(_:_:))*