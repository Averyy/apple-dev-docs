...
```swift
func zlaed0_(_ qsiz: UnsafePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ d: UnsafeMutablePointer<Double>?, _ e: UnsafeMutablePointer<Double>?, _ q: OpaquePointer?, _ ldq: UnsafePointer<__LAPACK_int>, _ qstore: OpaquePointer?, _ ldqs: UnsafePointer<__LAPACK_int>, _ rwork: UnsafeMutablePointer<Double>?, _ iwork: UnsafeMutablePointer<__LAPACK_int>?, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/zlaed0_(_:_:_:_:_:_:_:_:_:_:_:))*