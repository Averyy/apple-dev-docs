...
```swift
func dgttrf_(_ n: UnsafePointer<__LAPACK_int>, _ dl: UnsafeMutablePointer<Double>?, _ d: UnsafeMutablePointer<Double>?, _ du: UnsafeMutablePointer<Double>?, _ du2: UnsafeMutablePointer<Double>?, _ ipiv: UnsafeMutablePointer<__LAPACK_int>?, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dgttrf_(_:_:_:_:_:_:_:))*