...
A [`SparseOpaquePreconditioner_Float`](sparseopaquepreconditioner_float.md) structure.  You must free the resource through a call to [`SparseCleanup(_:)`](sparsecleanup(_:)-45lq7.md) after you finish with the object.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sparsecreatepreconditioner(_:_:)-59ql5)*