# vImageVerticalShear_XRGB2101010W(_:_:_:_:_:_:_:_:_:)
...
```swift
func vImageVerticalShear_XRGB2101010W(_ src: UnsafePointer<vImage_Buffer>, _ dest: UnsafePointer<vImage_Buffer>, _ srcOffsetToROI_X: vImagePixelCount, _ srcOffsetToROI_Y: vImagePixelCount, _ yTranslate: Float, _ shearSlope: Float, _ filter: ResamplingFilter!, _ backColor: Pixel_32U, _ flags: vImage_Flags) -> vImage_Error
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimageverticalshear_xrgb2101010w(_:_:_:_:_:_:_:_:_:))*