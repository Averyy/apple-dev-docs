...
### Initializers
- [init(alpha: Float, i_desc: BNNSNDArrayDescriptor, o_desc: BNNSNDArrayDescriptor)](bnnslayerparametersgram/init(alpha:i_desc:o_desc:).md)
  Returns a new Gram matrix layer parameters structure from the specified parameters.
- [init()](bnnslayerparametersgram/init.md)
  Returns a new Gram matrix layer parameters structure.
### Instance Properties
- [var alpha: Float](bnnslayerparametersgram/alpha.md)
  A value to scale the result.
- [var i_desc: BNNSNDArrayDescriptor](bnnslayerparametersgram/i_desc.md)
  The descriptor of the input.
- [var o_desc: BNNSNDArrayDescriptor](bnnslayerparametersgram/o_desc.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnslayerparametersgram)*