# sparse_insert_col_double(_:_:_:_:_:)
...
- `indx`: An array of column indices that correspond to the values in val. Must hold   values.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sparse_insert_col_double(_:_:_:_:_:))*