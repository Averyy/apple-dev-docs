# slagtm_(_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func slagtm_(_ trans: UnsafePointer<CChar>, _ n: UnsafePointer<__LAPACK_int>, _ nrhs: UnsafePointer<__LAPACK_int>, _ alpha: UnsafePointer<Float>, _ dl: UnsafePointer<Float>?, _ d: UnsafePointer<Float>?, _ du: UnsafePointer<Float>?, _ x: UnsafePointer<Float>?, _ ldx: UnsafePointer<__LAPACK_int>, _ beta: UnsafePointer<Float>, _ b: UnsafeMutablePointer<Float>?, _ ldb: UnsafePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slagtm_(_:_:_:_:_:_:_:_:_:_:_:_:))*