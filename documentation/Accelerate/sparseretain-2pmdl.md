...
```swift
func SparseRetain(_ Subfactor: SparseOpaqueSubfactor_Double) -> SparseOpaqueSubfactor_Double
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sparseretain(_:)-2pmdl)*