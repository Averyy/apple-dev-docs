...
```swift
func slarfgp_(_ n: UnsafePointer<__LAPACK_int>, _ alpha: UnsafeMutablePointer<Float>, _ x: UnsafeMutablePointer<Float>?, _ incx: UnsafePointer<__LAPACK_int>, _ tau: UnsafeMutablePointer<Float>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slarfgp_(_:_:_:_:_:))*