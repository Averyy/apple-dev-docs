# dlaed3_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func dlaed3_(_ k: UnsafePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ n1: UnsafePointer<__LAPACK_int>, _ d: UnsafeMutablePointer<Double>?, _ q: UnsafeMutablePointer<Double>?, _ ldq: UnsafePointer<__LAPACK_int>, _ rho: UnsafePointer<Double>, _ dlamda: UnsafeMutablePointer<Double>?, _ q2: UnsafePointer<Double>?, _ indx: UnsafePointer<__LAPACK_int>?, _ ctot: UnsafePointer<__LAPACK_int>?, _ w: UnsafeMutablePointer<Double>?, _ s: UnsafeMutablePointer<Double>?, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlaed3_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*