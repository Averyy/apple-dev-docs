...
```swift
func cblas_zdotu_sub(_ N: __LAPACK_int, _ X: OpaquePointer?, _ INCX: __LAPACK_int, _ Y: OpaquePointer?, _ INCY: __LAPACK_int, _ DOTU: OpaquePointer)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/cblas_zdotu_sub(_:_:_:_:_:_:))*