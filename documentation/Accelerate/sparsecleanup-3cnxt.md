...
```swift
func SparseCleanup(_ toFree: SparseOpaqueFactorization_Double)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sparsecleanup(_:)-3cnxt)*