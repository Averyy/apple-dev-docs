...
The following code shows an example of using [`vvintf(_:_:_:)`](vvintf(_:_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vvintf(_:_:_:))*