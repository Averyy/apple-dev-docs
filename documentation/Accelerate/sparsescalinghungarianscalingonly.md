# SparseScalingHungarianScalingOnly
...
```swift
var SparseScalingHungarianScalingOnly: SparseScaling_t { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sparsescalinghungarianscalingonly)*