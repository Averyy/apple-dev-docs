...
```swift
func catlas_sset(_ N: __LAPACK_int, _ ALPHA: Float, _ X: UnsafeMutablePointer<Float>, _ INCX: __LAPACK_int)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/catlas_sset(_:_:_:_:))*