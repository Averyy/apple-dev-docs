...
- `alpha`: The source vImage buffer that provides the precalculated alpha values of the composite image. Precalculate these values by calling the function [`vImagePremultipliedAlphaBlend_PlanarF(_:_:_:_:_:)`](vimagepremultipliedalphablend_planarf(_:_:_:_:_:).md).
