# zlar1v_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func zlar1v_(_ n: UnsafePointer<__LAPACK_int>, _ b1: UnsafePointer<__LAPACK_int>, _ bn: UnsafePointer<__LAPACK_int>, _ lambda: UnsafePointer<Double>, _ d: UnsafePointer<Double>?, _ l: UnsafePointer<Double>?, _ ld: UnsafePointer<Double>?, _ lld: UnsafePointer<Double>?, _ pivmin: UnsafePointer<Double>, _ gaptol: UnsafePointer<Double>, _ z: OpaquePointer?, _ wantnc: UnsafePointer<__LAPACK_bool>, _ negcnt: UnsafeMutablePointer<__LAPACK_int>, _ ztz: UnsafeMutablePointer<Double>, _ mingma: UnsafeMutablePointer<Double>, _ r: UnsafeMutablePointer<__LAPACK_int>, _ isuppz: UnsafeMutablePointer<__LAPACK_int>?, _ nrminv: UnsafeMutablePointer<Double>, _ resid: UnsafeMutablePointer<Double>, _ rqcorr: UnsafeMutablePointer<Double>, _ work: UnsafeMutablePointer<Double>?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/zlar1v_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*