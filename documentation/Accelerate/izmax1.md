...
```swift
func izmax1_(_ n: UnsafePointer<__LAPACK_int>, _ zx: OpaquePointer?, _ incx: UnsafePointer<__LAPACK_int>) -> __LAPACK_int
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/izmax1_(_:_:_:))*