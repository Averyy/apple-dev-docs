...
```swift
func chla_transtype_(_ ret_val: UnsafeMutablePointer<CChar>, _ ret_value_len: __LAPACK_int, _ trans: UnsafePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/chla_transtype_(_:_:_:))*