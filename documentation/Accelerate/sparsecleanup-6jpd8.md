...
```swift
func SparseCleanup(_ toFree: SparseOpaqueSymbolicFactorization)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sparsecleanup(_:)-6jpd8)*