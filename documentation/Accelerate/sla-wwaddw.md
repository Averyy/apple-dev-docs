...
```swift
func sla_wwaddw_(_ n: UnsafePointer<__LAPACK_int>, _ x: UnsafeMutablePointer<Float>?, _ y: UnsafeMutablePointer<Float>?, _ w: UnsafePointer<Float>?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sla_wwaddw_(_:_:_:_:))*