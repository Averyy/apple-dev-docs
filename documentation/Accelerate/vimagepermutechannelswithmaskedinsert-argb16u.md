# vImagePermuteChannelsWithMaskedInsert_ARGB16U(_:_:_:_:_:_:)
...
```swift
func vImagePermuteChannelsWithMaskedInsert_ARGB16U(_ src: UnsafePointer<vImage_Buffer>, _ dest: UnsafePointer<vImage_Buffer>, _ permuteMap: UnsafePointer<UInt8>, _ copyMask: UInt8, _ backgroundColor: UnsafePointer<UInt16>, _ flags: vImage_Flags) -> vImage_Error
```
...
This fused operation provides the same functionality as [`vImagePermuteChannels_ARGB16U(_:_:_:_:)`](vimagepermutechannels_argb16u(_:_:_:_:).md) followed by `vImageOverwriteChannelsWithScalar_ARGB16U` but offers higher performance than calling the two functions separately.
...
let backgroundColor: [Pixel_16U] = [101, 102, 103, 104]

pixelBuffer.withUnsafePointerToVImageBuffer { buf in
    _ = vImagePermuteChannelsWithMaskedInsert_ARGB16U(buf,
                                                       buf,
                                                       [3, 2, 1, 0],
                                                       0x8,
                                                       backgroundColor,
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimagepermutechannelswithmaskedinsert_argb16u(_:_:_:_:_:_:))*