...
Note that this option overrides the path that [`BNNSGraphCompileOptionsSetOutputPath(_:_:)`](bnnsgraphcompileoptionssetoutputpath(_:_:).md) sets.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnsgraphcompileoptionssetoutputfd(_:_:))*