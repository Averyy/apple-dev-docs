# cgesvd_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func cgesvd_(_ jobu: UnsafePointer<CChar>, _ jobvt: UnsafePointer<CChar>, _ m: UnsafePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ a: OpaquePointer?, _ lda: UnsafePointer<__LAPACK_int>, _ s: UnsafeMutablePointer<Float>?, _ u: OpaquePointer?, _ ldu: UnsafePointer<__LAPACK_int>, _ vt: OpaquePointer?, _ ldvt: UnsafePointer<__LAPACK_int>, _ work: OpaquePointer, _ lwork: UnsafePointer<__LAPACK_int>, _ rwork: UnsafeMutablePointer<Float>?, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/cgesvd_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*