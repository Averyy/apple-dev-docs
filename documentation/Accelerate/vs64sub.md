...
```swift
static vSInt32 vS64Sub(vSInt32 __vbasicops_vA, vSInt32 __vbasicops_vB);
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vs64sub)*