...
```swift
var BNNSReduceFunctionArgMin: BNNSReduceFunction { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnsreducefunctionargmin)*