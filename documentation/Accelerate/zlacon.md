...
```swift
func zlacon_(_ n: UnsafePointer<__LAPACK_int>, _ v: OpaquePointer?, _ x: OpaquePointer?, _ est: UnsafeMutablePointer<Double>, _ kase: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/zlacon_(_:_:_:_:_:))*