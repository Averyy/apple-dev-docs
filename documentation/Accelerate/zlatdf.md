...
```swift
func zlatdf_(_ ijob: UnsafePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ z: OpaquePointer?, _ ldz: UnsafePointer<__LAPACK_int>, _ rhs: OpaquePointer?, _ rdsum: UnsafeMutablePointer<Double>, _ rdscal: UnsafeMutablePointer<Double>, _ ipiv: UnsafePointer<__LAPACK_int>?, _ jpiv: UnsafePointer<__LAPACK_int>?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/zlatdf_(_:_:_:_:_:_:_:_:_:))*