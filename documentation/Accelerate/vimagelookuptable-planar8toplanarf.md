...
- `table`: A lookup table that contains 256 [`Pixel_F`](pixel_f.md) values.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimagelookuptable_planar8toplanarf(_:_:_:_:))*