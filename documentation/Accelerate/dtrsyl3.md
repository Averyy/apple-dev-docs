# dtrsyl3_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func dtrsyl3_(_ trana: UnsafePointer<CChar>, _ tranb: UnsafePointer<CChar>, _ isgn: UnsafePointer<__LAPACK_int>, _ m: UnsafePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ a: UnsafePointer<Double>?, _ lda: UnsafePointer<__LAPACK_int>, _ b: UnsafePointer<Double>?, _ ldb: UnsafePointer<__LAPACK_int>, _ c: UnsafeMutablePointer<Double>?, _ ldc: UnsafePointer<__LAPACK_int>, _ scale: UnsafeMutablePointer<Double>, _ iwork: UnsafeMutablePointer<__LAPACK_int>?, _ liwork: UnsafePointer<__LAPACK_int>, _ swork: UnsafeMutablePointer<Double>?, _ ldswork: UnsafeMutablePointer<__LAPACK_int>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dtrsyl3_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*