...
```swift
func dlartgp_(_ f: UnsafePointer<Double>, _ g: UnsafePointer<Double>, _ cs: UnsafeMutablePointer<Double>, _ sn: UnsafeMutablePointer<Double>, _ r: UnsafeMutablePointer<Double>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlartgp_(_:_:_:_:_:))*