# slarrd_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func slarrd_(_ range: UnsafePointer<CChar>, _ order: UnsafePointer<CChar>, _ n: UnsafePointer<__LAPACK_int>, _ vl: UnsafePointer<Float>, _ vu: UnsafePointer<Float>, _ il: UnsafePointer<__LAPACK_int>, _ iu: UnsafePointer<__LAPACK_int>, _ gers: UnsafePointer<Float>?, _ reltol: UnsafePointer<Float>, _ d: UnsafePointer<Float>?, _ e: UnsafePointer<Float>?, _ e2: UnsafePointer<Float>?, _ pivmin: UnsafePointer<Float>, _ nsplit: UnsafePointer<__LAPACK_int>, _ isplit: UnsafePointer<__LAPACK_int>?, _ m: UnsafeMutablePointer<__LAPACK_int>, _ w: UnsafeMutablePointer<Float>?, _ werr: UnsafeMutablePointer<Float>?, _ wl: UnsafeMutablePointer<Float>, _ wu: UnsafeMutablePointer<Float>, _ iblock: UnsafeMutablePointer<__LAPACK_int>?, _ indexw: UnsafeMutablePointer<__LAPACK_int>?, _ work: UnsafeMutablePointer<Float>, _ iwork: UnsafeMutablePointer<__LAPACK_int>?, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slarrd_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*