...
### Initializers
- [init(UInt32)](cblas_uplo/init(_:).md)
- [init(rawValue: UInt32)](cblas_uplo/init(rawvalue:).md)
### Instance Properties
- [var rawValue: UInt32](cblas_uplo/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/cblas_uplo)*