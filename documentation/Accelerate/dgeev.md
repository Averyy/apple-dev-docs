# dgeev_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func dgeev_(_ jobvl: UnsafePointer<CChar>, _ jobvr: UnsafePointer<CChar>, _ n: UnsafePointer<__LAPACK_int>, _ a: UnsafeMutablePointer<Double>?, _ lda: UnsafePointer<__LAPACK_int>, _ wr: UnsafeMutablePointer<Double>?, _ wi: UnsafeMutablePointer<Double>?, _ vl: UnsafeMutablePointer<Double>?, _ ldvl: UnsafePointer<__LAPACK_int>, _ vr: UnsafeMutablePointer<Double>?, _ ldvr: UnsafePointer<__LAPACK_int>, _ work: UnsafeMutablePointer<Double>, _ lwork: UnsafePointer<__LAPACK_int>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dgeev_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*