...
| [`SPARSE_NORM_ONE`](sparse_norm_one.md) | *sumᵢ ( | x[i] | )* | |—|—| | [`SPARSE_NORM_TWO`](sparse_norm_two.md) | *sqrt* *( sumᵢ (x[i])² )*__ | | [`SPARSE_NORM_INF`](sparse_norm_inf.md) | *maxᵢ( | x[i] | )*__ | | [`SPARSE_NORM_R1`](sparse_norm_r1.md) | Not supported, undefined. |
