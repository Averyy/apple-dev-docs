...
Compute the specified norm of the sparse vector .  Specify one of:

| [`SPARSE_NORM_ONE`](sparse_norm_one.md) |  | |—|—| | [`SPARSE_NORM_TWO`](sparse_norm_two.md) |  __ | | [`SPARSE_NORM_INF`](sparse_norm_inf.md) | __ | | [`SPARSE_NORM_R1`](sparse_norm_r1.md) | Not supported, undefined. |
...
- `x`: Pointer to the dense storage for the values of the sparse vector  . The corresponding entry in indx holds the index of the value. Contains   values.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sparse_vector_norm_float(_:_:_:_:))*