# vImageVerticalShear_Planar16F(_:_:_:_:_:_:_:_:_:)
...
```swift
func vImageVerticalShear_Planar16F(_ src: UnsafePointer<vImage_Buffer>, _ dest: UnsafePointer<vImage_Buffer>, _ srcOffsetToROI_X: vImagePixelCount, _ srcOffsetToROI_Y: vImagePixelCount, _ yTranslate: Float, _ shearSlope: Float, _ filter: ResamplingFilter!, _ backColor: Pixel_16F, _ flags: vImage_Flags) -> vImage_Error
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimageverticalshear_planar16f(_:_:_:_:_:_:_:_:_:))*