...
Use [`integerLinearSaturate(scale:offset:shift:)`](bnnsactivation/integerlinearsaturate(scale:offset:shift:).md) to generate an integer linear saturate function.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnsactivationfunction/integerlinearsaturate)*