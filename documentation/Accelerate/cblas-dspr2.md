...
```swift
func cblas_dspr2(_ ORDER: CBLAS_ORDER, _ UPLO: CBLAS_UPLO, _ N: __LAPACK_int, _ ALPHA: Double, _ X: UnsafePointer<Double>?, _ INCX: __LAPACK_int, _ Y: UnsafePointer<Double>?, _ INCY: __LAPACK_int, _ A: UnsafeMutablePointer<Double>?)
```
...
- `A`: Matrix `A` (in packed storage format).
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/cblas_dspr2(_:_:_:_:_:_:_:_:_:))*