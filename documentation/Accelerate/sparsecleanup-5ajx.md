...
```swift
func SparseCleanup(_ Preconditioner: SparseOpaquePreconditioner_Complex_Double)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sparsecleanup(_:)-5ajx)*