...
```swift
func dlagts_(_ job: UnsafePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ a: UnsafePointer<Double>?, _ b: UnsafePointer<Double>?, _ c: UnsafePointer<Double>?, _ d: UnsafePointer<Double>?, _ in: UnsafePointer<__LAPACK_int>?, _ y: UnsafeMutablePointer<Double>?, _ tol: UnsafeMutablePointer<Double>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlagts_(_:_:_:_:_:_:_:_:_:_:))*