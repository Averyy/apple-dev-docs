...
```swift
func vS512Neg(_ a: UnsafePointer<vS512>, _ result: UnsafeMutablePointer<vS512>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vs512neg(_:_:))*