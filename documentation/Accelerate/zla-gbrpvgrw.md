...
```swift
func zla_gbrpvgrw_(_ n: UnsafePointer<__LAPACK_int>, _ kl: UnsafePointer<__LAPACK_int>, _ ku: UnsafePointer<__LAPACK_int>, _ ncols: UnsafePointer<__LAPACK_int>, _ ab: OpaquePointer?, _ ldab: UnsafePointer<__LAPACK_int>, _ afb: OpaquePointer?, _ ldafb: UnsafePointer<__LAPACK_int>) -> Double
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/zla_gbrpvgrw_(_:_:_:_:_:_:_:_:))*