...
![Diagram showing a series of dots, that indicate known data points, joined by a continuous curve, that indicates interpolated values.](/images/com.apple.accelerate/media-3521008@2x.png)
...
![Equation that shows the form of a 5 x 5 Vandermonde matrix. Each row corresponds to an element in the source vector, x, raised to the power of 0, 1, 2, 3, and 4.](/images/com.apple.accelerate/media-3521355@2x.png)
...
![Equation that shows a 5 row matrix containing the values 0, 10, 1, -2, 2, 3, 3, -10, 4, 16.](/images/com.apple.accelerate/media-3521356@2x.png)

The resulting Vandermonde matrix contains the following values:

![Equation that shows the derived Vandermonde matrix.](/images/com.apple.accelerate/media-3521354@2x.png)
...
![Equation that shows Ax=b.](/images/com.apple.accelerate/media-3521363@2x.png)
...
![Equation that shows the polynomial evaluation for the coefficients five, six, and seven, and the variables one, two, and three.](/images/com.apple.accelerate/media-3521367@2x.png)
...
![Diagram showing a series of dots, that indicate known data points, joined by a continuous curve, that indicates interpolated values.](/images/com.apple.accelerate/media-3521370@2x.png)
