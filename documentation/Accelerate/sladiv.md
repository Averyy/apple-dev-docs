...
```swift
func sladiv_(_ a: UnsafePointer<Float>, _ b: UnsafePointer<Float>, _ c: UnsafePointer<Float>, _ d: UnsafePointer<Float>, _ p: UnsafeMutablePointer<Float>, _ q: UnsafeMutablePointer<Float>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sladiv_(_:_:_:_:_:_:))*