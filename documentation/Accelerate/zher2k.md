# zher2k_(_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func zher2k_(_ UPLO: UnsafePointer<CChar>, _ TRANS: UnsafePointer<CChar>, _ N: UnsafePointer<__LAPACK_int>, _ K: UnsafePointer<__LAPACK_int>, _ ALPHA: OpaquePointer, _ A: OpaquePointer?, _ LDA: UnsafePointer<__LAPACK_int>, _ B: OpaquePointer?, _ LDB: UnsafePointer<__LAPACK_int>, _ BETA: UnsafePointer<Double>, _ C: OpaquePointer?, _ LDC: UnsafePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/zher2k_(_:_:_:_:_:_:_:_:_:_:_:_:))*