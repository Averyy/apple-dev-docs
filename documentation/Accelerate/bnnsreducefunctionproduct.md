...
```swift
var BNNSReduceFunctionProduct: BNNSReduceFunction { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnsreducefunctionproduct)*