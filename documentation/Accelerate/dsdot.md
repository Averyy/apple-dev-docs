...
```swift
func dsdot_(_ N: UnsafePointer<__LAPACK_int>, _ X: UnsafePointer<Float>?, _ INCX: UnsafePointer<__LAPACK_int>, _ Y: UnsafePointer<Float>?, _ INCY: UnsafePointer<__LAPACK_int>) -> Double
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dsdot_(_:_:_:_:_:))*