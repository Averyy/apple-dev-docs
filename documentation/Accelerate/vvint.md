...
The following code shows an example of using [`vvint(_:_:_:)`](vvint(_:_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vvint(_:_:_:))*