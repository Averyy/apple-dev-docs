# vImageHorizontalReflect_ARGB16F(_:_:_:)
...
```swift
func vImageHorizontalReflect_ARGB16F(_ src: UnsafePointer<vImage_Buffer>, _ dest: UnsafePointer<vImage_Buffer>, _ flags: vImage_Flags) -> vImage_Error
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimagehorizontalreflect_argb16f(_:_:_:))*