...
```swift
func vL256Rotate(_ a: UnsafePointer<vU256>, _ rotateAmount: UInt32, _ result: UnsafeMutablePointer<vU256>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vl256rotate(_:_:_:))*