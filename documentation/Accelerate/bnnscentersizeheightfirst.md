...
```swift
var BNNSCenterSizeHeightFirst: BNNSBoxCoordinateMode { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnscentersizeheightfirst)*