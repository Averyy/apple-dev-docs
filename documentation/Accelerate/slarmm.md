...
```swift
func slarmm_(_ anorm: UnsafePointer<Float>, _ bnorm: UnsafePointer<Float>, _ cnorm: UnsafePointer<Float>) -> Float
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slarmm_(_:_:_:))*