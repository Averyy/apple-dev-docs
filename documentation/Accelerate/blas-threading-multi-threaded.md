...
```swift
var BLAS_THREADING_MULTI_THREADED: BLAS_THREADING { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/blas_threading_multi_threaded)*