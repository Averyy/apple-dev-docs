...
The required size of workspace in bytes for a call to a sparse solve function is [`solveWorkspaceRequiredStatic`](sparseopaquefactorization_double/solveworkspacerequiredstatic.md) `+ nrhs *` [`solveWorkspaceRequiredPerRHS`](sparseopaquefactorization_double/solveworkspacerequiredperrhs.md) where `nrhs` is the number of right-hand-side vectors.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sparseopaquefactorization_double/solveworkspacerequiredstatic)*