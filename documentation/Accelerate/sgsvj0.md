# sgsvj0_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func sgsvj0_(_ jobv: UnsafePointer<CChar>, _ m: UnsafePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ a: UnsafeMutablePointer<Float>?, _ lda: UnsafePointer<__LAPACK_int>, _ d: UnsafeMutablePointer<Float>?, _ sva: UnsafeMutablePointer<Float>?, _ mv: UnsafePointer<__LAPACK_int>, _ v: UnsafeMutablePointer<Float>?, _ ldv: UnsafePointer<__LAPACK_int>, _ eps: UnsafePointer<Float>, _ sfmin: UnsafePointer<Float>, _ tol: UnsafePointer<Float>, _ nsweep: UnsafePointer<__LAPACK_int>, _ work: UnsafeMutablePointer<Float>, _ lwork: UnsafePointer<__LAPACK_int>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sgsvj0_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*