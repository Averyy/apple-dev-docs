...
```swift
func slasr_(_ side: UnsafePointer<CChar>, _ pivot: UnsafePointer<CChar>, _ direct: UnsafePointer<CChar>, _ m: UnsafePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ c: UnsafePointer<Float>?, _ s: UnsafePointer<Float>?, _ a: UnsafeMutablePointer<Float>?, _ lda: UnsafePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slasr_(_:_:_:_:_:_:_:_:_:))*