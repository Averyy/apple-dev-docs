...
If  is nearly zero, the expression  will be highly inaccurate due to floating point rounding errors in . This function provides an alternative, more accurate means to calculate this value.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vvlog1pf(_:_:_:))*