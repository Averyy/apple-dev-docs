# ztrsna_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func ztrsna_(_ job: UnsafePointer<CChar>, _ howmny: UnsafePointer<CChar>, _ select: UnsafePointer<__LAPACK_bool>?, _ n: UnsafePointer<__LAPACK_int>, _ t: OpaquePointer?, _ ldt: UnsafePointer<__LAPACK_int>, _ vl: OpaquePointer?, _ ldvl: UnsafePointer<__LAPACK_int>, _ vr: OpaquePointer?, _ ldvr: UnsafePointer<__LAPACK_int>, _ s: UnsafeMutablePointer<Double>?, _ sep: UnsafeMutablePointer<Double>?, _ mm: UnsafePointer<__LAPACK_int>, _ m: UnsafeMutablePointer<__LAPACK_int>, _ work: OpaquePointer, _ ldwork: UnsafePointer<__LAPACK_int>, _ rwork: UnsafeMutablePointer<Double>?, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/ztrsna_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*