...
This fused operation provides the same functionality as [`vImagePermuteChannels_ARGB8888(_:_:_:_:)`](vimagepermutechannels_argb8888(_:_:_:_:).md) followed by [`vImageOverwriteChannelsWithScalar_ARGB8888(_:_:_:_:_:)`](vimageoverwritechannelswithscalar_argb8888(_:_:_:_:_:).md) but offers higher performance than calling the two functions separately.
...
- `backgroundColor`: The 8-bit-per-channel ARGB value that the function writes to the destination based on the   value.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimagepermutechannelswithmaskedinsert_argb8888(_:_:_:_:_:_:))*