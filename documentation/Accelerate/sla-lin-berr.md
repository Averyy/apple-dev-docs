...
```swift
func sla_lin_berr_(_ n: UnsafePointer<__LAPACK_int>, _ nz: UnsafePointer<__LAPACK_int>, _ nrhs: UnsafePointer<__LAPACK_int>, _ res: UnsafePointer<Float>?, _ ayb: UnsafePointer<Float>?, _ berr: UnsafeMutablePointer<Float>?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sla_lin_berr_(_:_:_:_:_:_:))*