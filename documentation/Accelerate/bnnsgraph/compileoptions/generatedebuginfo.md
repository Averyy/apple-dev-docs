...
```swift
var generateDebugInfo: Bool { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnsgraph/compileoptions/generatedebuginfo)*