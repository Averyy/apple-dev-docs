# dptrfs_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func dptrfs_(_ n: UnsafePointer<__LAPACK_int>, _ nrhs: UnsafePointer<__LAPACK_int>, _ d: UnsafePointer<Double>?, _ e: UnsafePointer<Double>?, _ df: UnsafePointer<Double>?, _ ef: UnsafePointer<Double>?, _ b: UnsafePointer<Double>?, _ ldb: UnsafePointer<__LAPACK_int>, _ x: UnsafeMutablePointer<Double>?, _ ldx: UnsafePointer<__LAPACK_int>, _ ferr: UnsafeMutablePointer<Double>?, _ berr: UnsafeMutablePointer<Double>?, _ work: UnsafeMutablePointer<Double>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dptrfs_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*