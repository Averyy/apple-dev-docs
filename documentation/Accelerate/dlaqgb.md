# dlaqgb_(_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func dlaqgb_(_ m: UnsafePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ kl: UnsafePointer<__LAPACK_int>, _ ku: UnsafePointer<__LAPACK_int>, _ ab: UnsafeMutablePointer<Double>?, _ ldab: UnsafePointer<__LAPACK_int>, _ r: UnsafePointer<Double>?, _ c: UnsafePointer<Double>?, _ rowcnd: UnsafePointer<Double>, _ colcnd: UnsafePointer<Double>, _ amax: UnsafePointer<Double>, _ equed: UnsafeMutablePointer<CChar>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlaqgb_(_:_:_:_:_:_:_:_:_:_:_:_:))*