# slasd2_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func slasd2_(_ nl: UnsafePointer<__LAPACK_int>, _ nr: UnsafePointer<__LAPACK_int>, _ sqre: UnsafePointer<__LAPACK_int>, _ k: UnsafeMutablePointer<__LAPACK_int>, _ d: UnsafeMutablePointer<Float>?, _ z: UnsafeMutablePointer<Float>?, _ alpha: UnsafePointer<Float>, _ beta: UnsafePointer<Float>, _ u: UnsafeMutablePointer<Float>?, _ ldu: UnsafePointer<__LAPACK_int>, _ vt: UnsafeMutablePointer<Float>?, _ ldvt: UnsafePointer<__LAPACK_int>, _ dsigma: UnsafeMutablePointer<Float>?, _ u2: UnsafeMutablePointer<Float>?, _ ldu2: UnsafePointer<__LAPACK_int>, _ vt2: UnsafeMutablePointer<Float>?, _ ldvt2: UnsafePointer<__LAPACK_int>, _ idxp: UnsafeMutablePointer<__LAPACK_int>?, _ idx: UnsafeMutablePointer<__LAPACK_int>?, _ idxc: UnsafeMutablePointer<__LAPACK_int>?, _ idxq: UnsafeMutablePointer<__LAPACK_int>?, _ coltyp: UnsafeMutablePointer<__LAPACK_int>?, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slasd2_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*