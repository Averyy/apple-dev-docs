...
```swift
func slapll_(_ n: UnsafePointer<__LAPACK_int>, _ x: UnsafeMutablePointer<Float>?, _ incx: UnsafePointer<__LAPACK_int>, _ y: UnsafeMutablePointer<Float>?, _ incy: UnsafePointer<__LAPACK_int>, _ ssmin: UnsafeMutablePointer<Float>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slapll_(_:_:_:_:_:_:))*