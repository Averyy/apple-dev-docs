# chetrf_aa_2stage_(_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func chetrf_aa_2stage_(_ uplo: UnsafePointer<CChar>, _ n: UnsafePointer<__LAPACK_int>, _ a: OpaquePointer?, _ lda: UnsafePointer<__LAPACK_int>, _ tb: OpaquePointer?, _ ltb: UnsafePointer<__LAPACK_int>, _ ipiv: UnsafeMutablePointer<__LAPACK_int>?, _ ipiv2: UnsafeMutablePointer<__LAPACK_int>?, _ work: OpaquePointer, _ lwork: UnsafePointer<__LAPACK_int>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/chetrf_aa_2stage_(_:_:_:_:_:_:_:_:_:_:_:))*