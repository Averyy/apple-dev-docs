...
```swift
var QUADRATURE_INTEGRATE_QAG_WORKSPACE_PER_INTERVAL: Int32 { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/quadrature_integrate_qag_workspace_per_interval)*