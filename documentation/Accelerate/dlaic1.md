...
```swift
func dlaic1_(_ job: UnsafePointer<__LAPACK_int>, _ j: UnsafePointer<__LAPACK_int>, _ x: UnsafePointer<Double>?, _ sest: UnsafePointer<Double>, _ w: UnsafePointer<Double>?, _ gamma: UnsafePointer<Double>, _ sestpr: UnsafeMutablePointer<Double>, _ s: UnsafeMutablePointer<Double>, _ c: UnsafeMutablePointer<Double>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlaic1_(_:_:_:_:_:_:_:_:_:))*