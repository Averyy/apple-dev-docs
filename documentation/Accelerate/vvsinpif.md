...
The following code shows an example of using [`vvsinpif(_:_:_:)`](vvsinpif(_:_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vvsinpif(_:_:_:))*