# vImagePermuteChannels_ARGBFFFF(_:_:_:_:)
...
```swift
func vImagePermuteChannels_ARGBFFFF(_ src: UnsafePointer<vImage_Buffer>, _ dest: UnsafePointer<vImage_Buffer>, _ permuteMap: UnsafePointer<UInt8>, _ flags: vImage_Flags) -> vImage_Error
```
...
pixelBuffer.withUnsafePointerToVImageBuffer { buf in
    _ = vImagePermuteChannels_ARGBFFFF(buf,
                                      buf,
                                      [3, 2, 1, 0],
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimagepermutechannels_argbffff(_:_:_:_:))*