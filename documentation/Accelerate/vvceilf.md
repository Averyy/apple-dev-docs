...
The following code shows an example of using [`vvceilf(_:_:_:)`](vvceilf(_:_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vvceilf(_:_:_:))*