...
```swift
func dlas2_(_ f: UnsafePointer<Double>, _ g: UnsafePointer<Double>, _ h: UnsafePointer<Double>, _ ssmin: UnsafeMutablePointer<Double>, _ ssmax: UnsafeMutablePointer<Double>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlas2_(_:_:_:_:_:))*