...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vdsp_discretetransformlifecyclefunctions/makediscretefouriertransform(previous:count:direction:transformtype:))*