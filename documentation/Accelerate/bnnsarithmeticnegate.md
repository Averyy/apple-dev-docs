...
```swift
var BNNSArithmeticNegate: BNNSArithmeticFunction { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnsarithmeticnegate)*