...
```swift
func vS1024Divide(_ numerator: UnsafePointer<vS1024>, _ divisor: UnsafePointer<vS1024>, _ result: UnsafeMutablePointer<vS1024>, _ remainder: UnsafeMutablePointer<vS1024>?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vs1024divide(_:_:_:_:))*