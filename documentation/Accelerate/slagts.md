...
```swift
func slagts_(_ job: UnsafePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ a: UnsafePointer<Float>?, _ b: UnsafePointer<Float>?, _ c: UnsafePointer<Float>?, _ d: UnsafePointer<Float>?, _ in: UnsafePointer<__LAPACK_int>?, _ y: UnsafeMutablePointer<Float>?, _ tol: UnsafeMutablePointer<Float>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slagts_(_:_:_:_:_:_:_:_:_:_:))*