# cblas_chbmv(_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func cblas_chbmv(_ ORDER: CBLAS_ORDER, _ UPLO: CBLAS_UPLO, _ N: __LAPACK_int, _ K: __LAPACK_int, _ ALPHA: OpaquePointer, _ A: OpaquePointer?, _ LDA: __LAPACK_int, _ X: OpaquePointer?, _ INCX: __LAPACK_int, _ BETA: OpaquePointer, _ Y: OpaquePointer?, _ INCY: __LAPACK_int)
```
...
- `BETA`: Scaling factor that vector   is multiplied by.
- `Y`: Vector  . Replaced by results on return.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/cblas_chbmv(_:_:_:_:_:_:_:_:_:_:_:_:))*