...
```swift
func zlarfg_(_ n: UnsafePointer<__LAPACK_int>, _ alpha: OpaquePointer, _ x: OpaquePointer?, _ incx: UnsafePointer<__LAPACK_int>, _ tau: OpaquePointer)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/zlarfg_(_:_:_:_:_:))*