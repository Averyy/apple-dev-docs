...
```swift
func dlarmm_(_ anorm: UnsafePointer<Double>, _ bnorm: UnsafePointer<Double>, _ cnorm: UnsafePointer<Double>) -> Double
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlarmm_(_:_:_:))*