...
```swift
func cblas_drot(_ N: __LAPACK_int, _ X: UnsafeMutablePointer<Double>?, _ INCX: __LAPACK_int, _ Y: UnsafeMutablePointer<Double>?, _ INCY: __LAPACK_int, _ C: Double, _ S: Double)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/cblas_drot(_:_:_:_:_:_:_:))*