...
- `__A`: The complex single-precision input signal vector. The length of this vector must be at least  .
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vdsp_zconv)*