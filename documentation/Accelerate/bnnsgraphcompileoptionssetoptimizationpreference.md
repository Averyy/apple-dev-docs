...
```swift
func BNNSGraphCompileOptionsSetOptimizationPreference(_ options: bnns_graph_compile_options_t, _ preference: BNNSGraphOptimizationPreference)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnsgraphcompileoptionssetoptimizationpreference(_:_:))*