...
```swift
func zlascl_(_ type: UnsafePointer<CChar>, _ kl: UnsafePointer<__LAPACK_int>, _ ku: UnsafePointer<__LAPACK_int>, _ cfrom: UnsafePointer<Double>, _ cto: UnsafePointer<Double>, _ m: UnsafePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ a: OpaquePointer?, _ lda: UnsafePointer<__LAPACK_int>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/zlascl_(_:_:_:_:_:_:_:_:_:_:))*