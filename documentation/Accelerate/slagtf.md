...
```swift
func slagtf_(_ n: UnsafePointer<__LAPACK_int>, _ a: UnsafeMutablePointer<Float>?, _ lambda: UnsafePointer<Float>, _ b: UnsafeMutablePointer<Float>?, _ c: UnsafeMutablePointer<Float>?, _ tol: UnsafePointer<Float>, _ d: UnsafeMutablePointer<Float>?, _ in: UnsafeMutablePointer<__LAPACK_int>?, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slagtf_(_:_:_:_:_:_:_:_:_:))*