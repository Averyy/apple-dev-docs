...
```swift
func cla_lin_berr_(_ n: UnsafePointer<__LAPACK_int>, _ nz: UnsafePointer<__LAPACK_int>, _ nrhs: UnsafePointer<__LAPACK_int>, _ res: OpaquePointer?, _ ayb: UnsafePointer<Float>?, _ berr: UnsafeMutablePointer<Float>?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/cla_lin_berr_(_:_:_:_:_:_:))*