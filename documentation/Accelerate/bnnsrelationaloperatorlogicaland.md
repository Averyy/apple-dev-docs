...
```swift
var BNNSRelationalOperatorLogicalAND: BNNSRelationalOperator { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnsrelationaloperatorlogicaland)*