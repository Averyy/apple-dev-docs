# vImageClipToAlpha_RGBA8888(_:_:_:)
...
```swift
func vImageClipToAlpha_RGBA8888(_ src: UnsafePointer<vImage_Buffer>, _ dest: UnsafePointer<vImage_Buffer>, _ flags: vImage_Flags) -> vImage_Error
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimagecliptoalpha_rgba8888(_:_:_:))*