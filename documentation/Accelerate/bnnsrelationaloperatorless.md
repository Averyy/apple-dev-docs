...
```swift
var BNNSRelationalOperatorLess: BNNSRelationalOperator { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnsrelationaloperatorless)*