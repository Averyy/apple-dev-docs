...
```swift
func BNNSGraphCompileOptionsGetOptimizationPreference(_ options: bnns_graph_compile_options_t) -> BNNSGraphOptimizationPreference
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnsgraphcompileoptionsgetoptimizationpreference(_:))*