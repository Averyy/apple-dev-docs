...
```swift
func zrot_(_ n: UnsafePointer<__LAPACK_int>, _ cx: OpaquePointer?, _ incx: UnsafePointer<__LAPACK_int>, _ cy: OpaquePointer?, _ incy: UnsafePointer<__LAPACK_int>, _ c: UnsafePointer<Double>, _ s: OpaquePointer)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/zrot_(_:_:_:_:_:_:_:))*