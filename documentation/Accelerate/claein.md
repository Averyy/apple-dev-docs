# claein_(_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func claein_(_ rightv: UnsafePointer<__LAPACK_bool>, _ noinit: UnsafePointer<__LAPACK_bool>, _ n: UnsafePointer<__LAPACK_int>, _ h: OpaquePointer?, _ ldh: UnsafePointer<__LAPACK_int>, _ w: OpaquePointer, _ v: OpaquePointer?, _ b: OpaquePointer?, _ ldb: UnsafePointer<__LAPACK_int>, _ rwork: UnsafeMutablePointer<Float>?, _ eps3: UnsafePointer<Float>, _ smlnum: UnsafePointer<Float>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/claein_(_:_:_:_:_:_:_:_:_:_:_:_:_:))*