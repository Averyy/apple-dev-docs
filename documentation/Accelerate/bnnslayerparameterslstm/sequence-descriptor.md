...
If [`seq_len`](bnnslayerparameterslstm/seq_len.md) is greater than `1` and the [`data`](bnnsndarraydescriptor/data.md) property of this descriptor is `nil`, BNNS uses the same [`batch_size`](bnnslayerparameterslstm/batch_size.md) for the entire sequence.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnslayerparameterslstm/sequence_descriptor)*