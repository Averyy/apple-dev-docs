...
- [`BNNSDataLayoutSNE`](bnnsdatalayoutsne.md) with the shape (num_directions*[`hidden_size`](bnnslayerparameterslstm/hidden_size.md),[`batch_size`](bnnslayerparameterslstm/batch_size.md),[`seq_len`](bnnslayerparameterslstm/seq_len.md))
- [`BNNSDataLayoutNSE`](bnnsdatalayoutnse.md) with the shape (num_directions*[`hidden_size`](bnnslayerparameterslstm/hidden_size.md),[`seq_len`](bnnslayerparameterslstm/seq_len.md),[`batch_size`](bnnslayerparameterslstm/batch_size.md))

BNNS can upack the first dimension as a 2D array with [`hidden_size`](bnnslayerparameterslstm/hidden_size.md) as the major dimension. That is, BNNS can interpret the dimension as a C array with the shape `[num_directions][` [`hidden_size`](bnnslayerparameterslstm/hidden_size.md) `]`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnslayerparameterslstm/output_descriptor)*