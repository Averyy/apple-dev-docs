...
- [`BNNSDataLayoutSNE`](bnnsdatalayoutsne.md) with the shape ([`input_size`](bnnslayerparameterslstm/input_size.md),[`batch_size`](bnnslayerparameterslstm/batch_size.md),[`seq_len`](bnnslayerparameterslstm/seq_len.md))
- [`BNNSDataLayoutNSE`](bnnsdatalayoutnse.md) with the shape  ([`input_size`](bnnslayerparameterslstm/input_size.md),[`seq_len`](bnnslayerparameterslstm/seq_len.md),[`batch_size`](bnnslayerparameterslstm/batch_size.md))
...
If the corresponding data of the [`hidden_desc`](bnnslstmdatadescriptor/hidden_desc.md) and [`cell_state_desc`](bnnslstmdatadescriptor/cell_state_desc.md) descriptors is `nil`, BNNS treats their [`input_descriptor`](bnnslayerparameterslstm/input_descriptor.md) as zero-filled arrays.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnslayerparameterslstm/input_descriptor)*