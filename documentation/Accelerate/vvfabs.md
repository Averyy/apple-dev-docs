...
The following code shows an example of using [`vvfabs(_:_:_:)`](vvfabs(_:_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vvfabs(_:_:_:))*