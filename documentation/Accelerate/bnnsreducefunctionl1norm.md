...
```swift
var BNNSReduceFunctionL1Norm: BNNSReduceFunction { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnsreducefunctionl1norm)*