...
```swift
func cptcon_(_ n: UnsafePointer<__LAPACK_int>, _ d: UnsafePointer<Float>?, _ e: OpaquePointer?, _ anorm: UnsafePointer<Float>, _ rcond: UnsafeMutablePointer<Float>, _ rwork: UnsafeMutablePointer<Float>?, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/cptcon_(_:_:_:_:_:_:_:))*