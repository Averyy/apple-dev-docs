# zlaein_(_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func zlaein_(_ rightv: UnsafePointer<__LAPACK_bool>, _ noinit: UnsafePointer<__LAPACK_bool>, _ n: UnsafePointer<__LAPACK_int>, _ h: OpaquePointer?, _ ldh: UnsafePointer<__LAPACK_int>, _ w: OpaquePointer, _ v: OpaquePointer?, _ b: OpaquePointer?, _ ldb: UnsafePointer<__LAPACK_int>, _ rwork: UnsafeMutablePointer<Double>?, _ eps3: UnsafePointer<Double>, _ smlnum: UnsafePointer<Double>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/zlaein_(_:_:_:_:_:_:_:_:_:_:_:_:_:))*