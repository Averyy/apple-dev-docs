# cblas_dsyr2k(_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
- `N`: Order of matrix `C`.
- `K`: Specifies the number of columns in matrices `A` and `B` if `trans='N'`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/cblas_dsyr2k(_:_:_:_:_:_:_:_:_:_:_:_:_:))*