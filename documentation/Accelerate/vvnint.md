...
The following code shows an example of using [`vvnint(_:_:_:)`](vvnint(_:_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vvnint(_:_:_:))*