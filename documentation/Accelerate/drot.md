...
```swift
func drot_(_ N: UnsafePointer<__LAPACK_int>, _ X: UnsafeMutablePointer<Double>?, _ INCX: UnsafePointer<__LAPACK_int>, _ Y: UnsafeMutablePointer<Double>?, _ INCY: UnsafePointer<__LAPACK_int>, _ C: UnsafePointer<Double>, _ S: UnsafePointer<Double>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/drot_(_:_:_:_:_:_:_:))*