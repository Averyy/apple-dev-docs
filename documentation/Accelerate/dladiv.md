...
```swift
func dladiv_(_ a: UnsafePointer<Double>, _ b: UnsafePointer<Double>, _ c: UnsafePointer<Double>, _ d: UnsafePointer<Double>, _ p: UnsafeMutablePointer<Double>, _ q: UnsafeMutablePointer<Double>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dladiv_(_:_:_:_:_:_:))*