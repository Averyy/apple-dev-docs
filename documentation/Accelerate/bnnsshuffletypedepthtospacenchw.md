# BNNSShuffleTypeDepthToSpaceNCHW
...
```swift
var BNNSShuffleTypeDepthToSpaceNCHW: BNNSShuffleType { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnsshuffletypedepthtospacenchw)*