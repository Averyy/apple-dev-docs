# sla_gercond_(_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func sla_gercond_(_ trans: UnsafePointer<CChar>, _ n: UnsafePointer<__LAPACK_int>, _ a: UnsafePointer<Float>?, _ lda: UnsafePointer<__LAPACK_int>, _ af: UnsafePointer<Float>?, _ ldaf: UnsafePointer<__LAPACK_int>, _ ipiv: UnsafePointer<__LAPACK_int>?, _ cmode: UnsafePointer<__LAPACK_int>, _ c: UnsafePointer<Float>?, _ info: UnsafeMutablePointer<__LAPACK_int>, _ work: UnsafeMutablePointer<Float>, _ iwork: UnsafeMutablePointer<__LAPACK_int>?) -> Float
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sla_gercond_(_:_:_:_:_:_:_:_:_:_:_:_:))*