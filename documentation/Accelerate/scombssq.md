...
```swift
func scombssq_(_ v1: UnsafeMutablePointer<Float>?, _ v2: UnsafePointer<Float>?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/scombssq_(_:_:))*