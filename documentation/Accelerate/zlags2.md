# zlags2_(_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func zlags2_(_ upper: UnsafePointer<__LAPACK_bool>, _ a1: UnsafePointer<Double>, _ a2: OpaquePointer, _ a3: UnsafePointer<Double>, _ b1: UnsafePointer<Double>, _ b2: OpaquePointer, _ b3: UnsafePointer<Double>, _ csu: UnsafeMutablePointer<Double>, _ snu: OpaquePointer, _ csv: UnsafeMutablePointer<Double>, _ snv: OpaquePointer, _ csq: UnsafeMutablePointer<Double>, _ snq: OpaquePointer)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/zlags2_(_:_:_:_:_:_:_:_:_:_:_:_:_:))*