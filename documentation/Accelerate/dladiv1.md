...
```swift
func dladiv1_(_ a: UnsafeMutablePointer<Double>, _ b: UnsafePointer<Double>, _ c: UnsafePointer<Double>, _ d: UnsafePointer<Double>, _ p: UnsafeMutablePointer<Double>, _ q: UnsafeMutablePointer<Double>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dladiv1_(_:_:_:_:_:_:))*