# sgemqrt_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func sgemqrt_(_ side: UnsafePointer<CChar>, _ trans: UnsafePointer<CChar>, _ m: UnsafePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ k: UnsafePointer<__LAPACK_int>, _ nb: UnsafePointer<__LAPACK_int>, _ v: UnsafePointer<Float>?, _ ldv: UnsafePointer<__LAPACK_int>, _ t: UnsafePointer<Float>?, _ ldt: UnsafePointer<__LAPACK_int>, _ c: UnsafeMutablePointer<Float>?, _ ldc: UnsafePointer<__LAPACK_int>, _ work: UnsafeMutablePointer<Float>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sgemqrt_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*