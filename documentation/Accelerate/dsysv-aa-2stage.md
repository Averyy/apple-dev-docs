# dsysv_aa_2stage_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func dsysv_aa_2stage_(_ uplo: UnsafePointer<CChar>, _ n: UnsafePointer<__LAPACK_int>, _ nrhs: UnsafePointer<__LAPACK_int>, _ a: UnsafeMutablePointer<Double>?, _ lda: UnsafePointer<__LAPACK_int>, _ tb: UnsafeMutablePointer<Double>?, _ ltb: UnsafePointer<__LAPACK_int>, _ ipiv: UnsafeMutablePointer<__LAPACK_int>?, _ ipiv2: UnsafeMutablePointer<__LAPACK_int>?, _ b: UnsafeMutablePointer<Double>?, _ ldb: UnsafePointer<__LAPACK_int>, _ work: UnsafeMutablePointer<Double>, _ lwork: UnsafePointer<__LAPACK_int>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dsysv_aa_2stage_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*