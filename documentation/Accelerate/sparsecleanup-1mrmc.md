...
```swift
func SparseCleanup(_ toFree: SparseOpaqueSubfactor_Float)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sparsecleanup(_:)-1mrmc)*