# cla_gercond_c_(_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func cla_gercond_c_(_ trans: UnsafePointer<CChar>, _ n: UnsafePointer<__LAPACK_int>, _ a: OpaquePointer?, _ lda: UnsafePointer<__LAPACK_int>, _ af: OpaquePointer?, _ ldaf: UnsafePointer<__LAPACK_int>, _ ipiv: UnsafePointer<__LAPACK_int>?, _ c: UnsafePointer<Float>?, _ capply: UnsafePointer<__LAPACK_bool>, _ info: UnsafeMutablePointer<__LAPACK_int>, _ work: OpaquePointer, _ rwork: UnsafeMutablePointer<Float>?) -> Float
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/cla_gercond_c_(_:_:_:_:_:_:_:_:_:_:_:_:))*