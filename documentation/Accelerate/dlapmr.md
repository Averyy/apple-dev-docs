...
```swift
func dlapmr_(_ forwrd: UnsafePointer<__LAPACK_bool>, _ m: UnsafePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ x: UnsafeMutablePointer<Double>?, _ ldx: UnsafePointer<__LAPACK_int>, _ k: UnsafeMutablePointer<__LAPACK_int>?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlapmr_(_:_:_:_:_:_:))*