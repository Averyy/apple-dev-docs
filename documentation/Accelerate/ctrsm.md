...
```swift
func ctrsm_(_ SIDE: UnsafePointer<CChar>, _ UPLO: UnsafePointer<CChar>, _ TRANSA: UnsafePointer<CChar>, _ DIAG: UnsafePointer<CChar>, _ M: UnsafePointer<__LAPACK_int>, _ N: UnsafePointer<__LAPACK_int>, _ ALPHA: OpaquePointer, _ A: OpaquePointer?, _ LDA: UnsafePointer<__LAPACK_int>, _ B: OpaquePointer?, _ LDB: UnsafePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/ctrsm_(_:_:_:_:_:_:_:_:_:_:_:))*