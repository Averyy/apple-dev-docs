...
```swift
var BNNSActivationFunctionELU: BNNSActivationFunction { get }
```
...
![Graph that shows input values for the activation function on horizontal axis and its output values on vertical axis. ](https://docs-assets.developer.apple.com/published/279cfb6738d5664523e7160e85768e03/media-3560473%402x.png)
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnsactivationfunctionelu)*