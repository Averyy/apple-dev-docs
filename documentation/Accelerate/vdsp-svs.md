...
The following code shows an example of using [`vDSP_svs`](vdsp_svs.md):
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vdsp_svs)*