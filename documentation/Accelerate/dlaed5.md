...
```swift
func dlaed5_(_ i: UnsafePointer<__LAPACK_int>, _ d: UnsafePointer<Double>?, _ z: UnsafePointer<Double>?, _ delta: UnsafeMutablePointer<Double>?, _ rho: UnsafePointer<Double>, _ dlam: UnsafeMutablePointer<Double>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlaed5_(_:_:_:_:_:_:))*