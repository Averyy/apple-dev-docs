...
```swift
var BNNSPoolingFunctionAverageCountExcludePadding: BNNSPoolingFunction { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnspoolingfunctionaveragecountexcludepadding)*