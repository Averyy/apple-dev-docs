...
- [var BNNSPointerSpecifierAlpha: BNNSPointerSpecifier](bnnspointerspecifieralpha.md)
  A constant that specifies the alpha pointer.
- [var BNNSPointerSpecifierBeta: BNNSPointerSpecifier](bnnspointerspecifierbeta.md)
  A constant that specifies the beta pointer.
### Raw Values
- [init(UInt32)](bnnspointerspecifier/init(_:).md)
- [init(rawValue: UInt32)](bnnspointerspecifier/init(rawvalue:).md)
- [var rawValue: UInt32](bnnspointerspecifier/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnspointerspecifier)*