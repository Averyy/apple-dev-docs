...
```swift
func slartgp_(_ f: UnsafePointer<Float>, _ g: UnsafePointer<Float>, _ cs: UnsafeMutablePointer<Float>, _ sn: UnsafeMutablePointer<Float>, _ r: UnsafeMutablePointer<Float>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slartgp_(_:_:_:_:_:))*