...
```swift
func SparseMultiply(_ Subfactor: SparseOpaqueSubfactor_Float, _ XY: DenseMatrix_Float)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sparsemultiply(_:_:)-3r4mf)*