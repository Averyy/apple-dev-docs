...
- `workspace`: The scratch space of size          , where   is the number of right-hand-sides to find solutions for.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sparsesolve(_:_:_:_:)-8xma8)*