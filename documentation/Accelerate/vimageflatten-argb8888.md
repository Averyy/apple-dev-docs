...
```swift
func vImageFlatten_ARGB8888(_ argbSrc: UnsafePointer<vImage_Buffer>, _ argbDst: UnsafePointer<vImage_Buffer>, _ argbBackgroundColorPtr: UnsafePointer<UInt8>, _ isImagePremultiplied: Bool, _ flags: vImage_Flags) -> vImage_Error
```
...
- `isImagePremultiplied`: A Boolean value that specifes the whether source image has premultiplied alpha.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vimageflatten_argb8888(_:_:_:_:_:))*