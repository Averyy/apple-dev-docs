...
Note that BNNS typically calls the `free` function when it destroys the context, but it only requires the workspace during execution. As such, you may wish to make the allocated memory purgable or free it between calls to [`BNNSGraphContextExecute(_:_:_:_:_:_:)`](bnnsgraphcontextexecute(_:_:_:_:_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnsgraphcontextsetworkspaceallocationcallback(_:_:_:_:_:))*