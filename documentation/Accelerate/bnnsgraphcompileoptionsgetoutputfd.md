...
The file descriptor that the [`BNNSGraphCompileOptionsSetOutputFD(_:_:)`](bnnsgraphcompileoptionssetoutputfd(_:_:).md) function defines, if any.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnsgraphcompileoptionsgetoutputfd(_:))*