...
```swift
func slassq_(_ n: UnsafePointer<__LAPACK_int>, _ x: UnsafePointer<Float>?, _ incx: UnsafePointer<__LAPACK_int>, _ scale: UnsafeMutablePointer<Float>, _ sumsq: UnsafeMutablePointer<Float>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slassq_(_:_:_:_:_:))*