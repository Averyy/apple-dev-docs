# dlahqr_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func dlahqr_(_ wantt: UnsafePointer<__LAPACK_bool>, _ wantz: UnsafePointer<__LAPACK_bool>, _ n: UnsafePointer<__LAPACK_int>, _ ilo: UnsafePointer<__LAPACK_int>, _ ihi: UnsafePointer<__LAPACK_int>, _ h: UnsafeMutablePointer<Double>?, _ ldh: UnsafePointer<__LAPACK_int>, _ wr: UnsafeMutablePointer<Double>?, _ wi: UnsafeMutablePointer<Double>?, _ iloz: UnsafePointer<__LAPACK_int>, _ ihiz: UnsafePointer<__LAPACK_int>, _ z: UnsafeMutablePointer<Double>?, _ ldz: UnsafePointer<__LAPACK_int>, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlahqr_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*