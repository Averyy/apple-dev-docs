...
```swift
func dla_gbrpvgrw_(_ n: UnsafePointer<__LAPACK_int>, _ kl: UnsafePointer<__LAPACK_int>, _ ku: UnsafePointer<__LAPACK_int>, _ ncols: UnsafePointer<__LAPACK_int>, _ ab: UnsafePointer<Double>?, _ ldab: UnsafePointer<__LAPACK_int>, _ afb: UnsafePointer<Double>?, _ ldafb: UnsafePointer<__LAPACK_int>) -> Double
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dla_gbrpvgrw_(_:_:_:_:_:_:_:_:))*