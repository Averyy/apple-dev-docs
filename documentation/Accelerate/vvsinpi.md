...
The following code shows an example of using [`vvsinpi(_:_:_:)`](vvsinpi(_:_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vvsinpi(_:_:_:))*