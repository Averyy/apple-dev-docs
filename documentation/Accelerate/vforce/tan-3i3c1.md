...
```swift
static func tan<U>(_ vector: U) -> [Float] where U : AccelerateBuffer, U.Element == Float
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vforce/tan(_:)-3i3c1)*