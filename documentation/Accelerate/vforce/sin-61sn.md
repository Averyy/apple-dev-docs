...
```swift
static func sin<U>(_ vector: U) -> [Double] where U : AccelerateBuffer, U.Element == Double
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vforce/sin(_:)-61sn)*