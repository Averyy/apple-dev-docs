...
```swift
static func atan<U>(_ vector: U) -> [Float] where U : AccelerateBuffer, U.Element == Float
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vforce/atan(_:)-5ejvk)*