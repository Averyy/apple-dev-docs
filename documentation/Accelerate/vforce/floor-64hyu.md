...
```swift
static func floor<U>(_ vector: U) -> [Double] where U : AccelerateBuffer, U.Element == Double
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vforce/floor(_:)-64hyu)*