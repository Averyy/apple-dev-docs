...
```swift
static func acos<U>(_ vector: U) -> [Float] where U : AccelerateBuffer, U.Element == Float
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vforce/acos(_:)-3hl5t)*