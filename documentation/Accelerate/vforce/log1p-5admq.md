...
```swift
static func log1p<U>(_ vector: U) -> [Double] where U : AccelerateBuffer, U.Element == Double
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vforce/log1p(_:)-5admq)*