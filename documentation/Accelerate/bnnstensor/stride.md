...
The first [`rank`](bnnstensor/rank.md) elements specify the stride of each dimension.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnstensor/stride)*