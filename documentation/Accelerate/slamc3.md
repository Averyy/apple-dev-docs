...
```swift
func slamc3_(_ a: UnsafePointer<Float>, _ b: UnsafePointer<Float>) -> Float
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slamc3_(_:_:))*