...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnslayerparameterslosssigmoidcrossentropy/init(function:i_desc:o_desc:reduction:label_smooth:))*