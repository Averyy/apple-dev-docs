# clalsd_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func clalsd_(_ uplo: UnsafePointer<CChar>, _ smlsiz: UnsafePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ nrhs: UnsafePointer<__LAPACK_int>, _ d: UnsafeMutablePointer<Float>?, _ e: UnsafeMutablePointer<Float>?, _ b: OpaquePointer?, _ ldb: UnsafePointer<__LAPACK_int>, _ rcond: UnsafePointer<Float>, _ rank: UnsafeMutablePointer<__LAPACK_int>, _ work: OpaquePointer, _ rwork: UnsafeMutablePointer<Float>?, _ iwork: UnsafeMutablePointer<__LAPACK_int>?, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/clalsd_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*