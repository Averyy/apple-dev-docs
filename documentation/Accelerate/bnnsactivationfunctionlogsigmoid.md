...
```swift
var BNNSActivationFunctionLogSigmoid: BNNSActivationFunction { get }
```
...
![Graph that shows input values for the activation function on horizontal axis and its output values on vertical axis. ](https://docs-assets.developer.apple.com/published/b8541c139e57c4e93558389c56d466f6/media-3560496%402x.png)
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnnsactivationfunctionlogsigmoid)*