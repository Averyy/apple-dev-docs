...
![Visualization of a sine wave.](https://docs-assets.developer.apple.com/published/84dcec7eed7b6ac76bda872718d5f479/media-3239818%402x.png)
...
![Visualization of the generated vector.](https://docs-assets.developer.apple.com/published/a9e2897491ce2327cdaa24df8ffd54c2/media-3239895%402x.png)

## Parameters

- `__I0`: The first single-precision input vector.
- `__I1`: The second single-precision input vector.
...
- `__O0`: The first single-precision output vector.
- `__O1`: The second single-precision output vector.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vdsp_vrampmul2)*