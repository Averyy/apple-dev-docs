...
```swift
func zla_gerpvgrw_(_ n: UnsafePointer<__LAPACK_int>, _ ncols: UnsafePointer<__LAPACK_int>, _ a: OpaquePointer?, _ lda: UnsafePointer<__LAPACK_int>, _ af: OpaquePointer?, _ ldaf: UnsafePointer<__LAPACK_int>) -> Double
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/zla_gerpvgrw_(_:_:_:_:_:_:))*