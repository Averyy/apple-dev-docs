...
- [vDSP_zrvadd](vdsp_zrvadd.md)
  Adds a single-precision complex vector to a single-precision real vector.


---

*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vdsp_zrvaddd)*