# dlaqps_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func dlaqps_(_ m: UnsafePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ offset: UnsafePointer<__LAPACK_int>, _ nb: UnsafePointer<__LAPACK_int>, _ kb: UnsafeMutablePointer<__LAPACK_int>, _ a: UnsafeMutablePointer<Double>?, _ lda: UnsafePointer<__LAPACK_int>, _ jpvt: UnsafeMutablePointer<__LAPACK_int>?, _ tau: UnsafeMutablePointer<Double>?, _ vn1: UnsafeMutablePointer<Double>?, _ vn2: UnsafeMutablePointer<Double>?, _ auxv: UnsafeMutablePointer<Double>?, _ f: UnsafeMutablePointer<Double>?, _ ldf: UnsafePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlaqps_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*