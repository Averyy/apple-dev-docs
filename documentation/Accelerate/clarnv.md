...
```swift
func clarnv_(_ idist: UnsafePointer<__LAPACK_int>, _ iseed: UnsafeMutablePointer<__LAPACK_int>?, _ n: UnsafePointer<__LAPACK_int>, _ x: OpaquePointer?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/clarnv_(_:_:_:_:))*