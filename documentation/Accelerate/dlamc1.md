...
```swift
func dlamc1_(_ beta: UnsafeMutablePointer<__LAPACK_int>, _ t: UnsafeMutablePointer<__LAPACK_int>, _ rnd: UnsafeMutablePointer<__LAPACK_bool>, _ ieee1: UnsafeMutablePointer<__LAPACK_bool>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlamc1_(_:_:_:_:))*