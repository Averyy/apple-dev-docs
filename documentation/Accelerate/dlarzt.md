...
```swift
func dlarzt_(_ direct: UnsafePointer<CChar>, _ storev: UnsafePointer<CChar>, _ n: UnsafePointer<__LAPACK_int>, _ k: UnsafePointer<__LAPACK_int>, _ v: UnsafePointer<Double>?, _ ldv: UnsafePointer<__LAPACK_int>, _ tau: UnsafePointer<Double>?, _ t: UnsafeMutablePointer<Double>?, _ ldt: UnsafePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlarzt_(_:_:_:_:_:_:_:_:_:))*