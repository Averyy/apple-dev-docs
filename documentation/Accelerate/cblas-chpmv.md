# cblas_chpmv(_:_:_:_:_:_:_:_:_:_:)
...
```swift
func cblas_chpmv(_ ORDER: CBLAS_ORDER, _ UPLO: CBLAS_UPLO, _ N: __LAPACK_int, _ ALPHA: OpaquePointer, _ AP: OpaquePointer?, _ X: OpaquePointer?, _ INCX: __LAPACK_int, _ BETA: OpaquePointer, _ Y: OpaquePointer?, _ INCY: __LAPACK_int)
```
...
- `ALPHA`: Scaling factor that matrix   is multiplied by.
- `AP`: Matrix  .
- `X`: Vector  .
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/cblas_chpmv(_:_:_:_:_:_:_:_:_:_:))*