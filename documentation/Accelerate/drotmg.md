...
```swift
func drotmg_(_ D1: UnsafeMutablePointer<Double>, _ D2: UnsafeMutablePointer<Double>, _ X1: UnsafeMutablePointer<Double>, _ Y1: UnsafePointer<Double>, _ PARAM: UnsafeMutablePointer<Double>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/drotmg_(_:_:_:_:_:))*