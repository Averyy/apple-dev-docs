...
![A mathematical formula that describes a matrix equation. A four-by-four matrix is multiplied by the four-element vector, f, equals a four-element matrix. The vector f contains unknown values.](https://docs-assets.developer.apple.com/published/fca17823d6f2acf7f9fb11682abb3800/media-3855531%402x.png)

This function solves the equation and finds the values for the output vector, `__F`.

![A mathematical formula that describes a matrix equation. A four-by-four matrix is multiplied by the four-element vector, f, equals a four-element matrix. The vector f contains known values.](https://docs-assets.developer.apple.com/published/ced19e4f17693d7d3cea92b8377b470d/media-3855530%402x.png)
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vdsp_wiener)*