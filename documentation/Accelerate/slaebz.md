# slaebz_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func slaebz_(_ ijob: UnsafePointer<__LAPACK_int>, _ nitmax: UnsafePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ mmax: UnsafePointer<__LAPACK_int>, _ minp: UnsafePointer<__LAPACK_int>, _ nbmin: UnsafePointer<__LAPACK_int>, _ abstol: UnsafePointer<Float>, _ reltol: UnsafePointer<Float>, _ pivmin: UnsafePointer<Float>, _ d: UnsafePointer<Float>?, _ e: UnsafePointer<Float>?, _ e2: UnsafePointer<Float>?, _ nval: UnsafeMutablePointer<__LAPACK_int>?, _ ab: UnsafeMutablePointer<Float>?, _ c: UnsafeMutablePointer<Float>?, _ mout: UnsafeMutablePointer<__LAPACK_int>, _ nab: UnsafeMutablePointer<__LAPACK_int>?, _ work: UnsafeMutablePointer<Float>, _ iwork: UnsafeMutablePointer<__LAPACK_int>?, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slaebz_(_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:_:))*