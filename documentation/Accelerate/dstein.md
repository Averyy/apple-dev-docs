# dstein_(_:_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func dstein_(_ n: UnsafePointer<__LAPACK_int>, _ d: UnsafePointer<Double>?, _ e: UnsafePointer<Double>?, _ m: UnsafePointer<__LAPACK_int>, _ w: UnsafePointer<Double>?, _ iblock: UnsafePointer<__LAPACK_int>?, _ isplit: UnsafePointer<__LAPACK_int>?, _ z: UnsafeMutablePointer<Double>?, _ ldz: UnsafePointer<__LAPACK_int>, _ work: UnsafeMutablePointer<Double>, _ iwork: UnsafeMutablePointer<__LAPACK_int>?, _ ifail: UnsafeMutablePointer<__LAPACK_int>?, _ info: UnsafeMutablePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dstein_(_:_:_:_:_:_:_:_:_:_:_:_:_:))*