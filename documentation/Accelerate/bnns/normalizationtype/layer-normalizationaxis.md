# BNNS.NormalizationType.layer(normalizationAxis:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnns/normalizationtype/layer(normalizationaxis:))*