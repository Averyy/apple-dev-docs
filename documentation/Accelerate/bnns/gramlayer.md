...
- [convenience init?(input: BNNSNDArrayDescriptor, output: BNNSNDArrayDescriptor, alpha: Float, filterParameters: BNNSFilterParameters?)](bnns/gramlayer/init(input:output:alpha:filterparameters:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnns/gramlayer)*