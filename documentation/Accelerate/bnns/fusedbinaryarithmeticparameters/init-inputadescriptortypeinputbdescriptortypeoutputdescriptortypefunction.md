...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnns/fusedbinaryarithmeticparameters/init(inputadescriptortype:inputbdescriptortype:outputdescriptortype:function:))*