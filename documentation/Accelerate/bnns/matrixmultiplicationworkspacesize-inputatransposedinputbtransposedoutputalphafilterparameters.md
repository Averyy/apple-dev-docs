...
- `transposeB`: A Boolean value that indicates whether the function transposes the last two dimensions of matrix B_._
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnns/matrixmultiplicationworkspacesize(inputa:transposed:inputb:transposed:output:alpha:filterparameters:))*