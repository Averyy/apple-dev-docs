...
- `source`: The descriptor of the input.
- `destination`: The descriptor of the output.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnns/copy(_:to:filterparameters:))*