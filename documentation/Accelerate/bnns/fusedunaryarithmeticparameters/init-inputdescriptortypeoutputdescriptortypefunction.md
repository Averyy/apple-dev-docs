...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/bnns/fusedunaryarithmeticparameters/init(inputdescriptortype:outputdescriptortype:function:))*