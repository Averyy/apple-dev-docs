...
```swift
func cblas_sasum(_ N: __LAPACK_int, _ X: UnsafePointer<Float>?, _ INCX: __LAPACK_int) -> Float
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/cblas_sasum(_:_:_:))*