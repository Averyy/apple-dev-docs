...
```swift
func slatzm_(_ side: UnsafePointer<CChar>, _ m: UnsafePointer<__LAPACK_int>, _ n: UnsafePointer<__LAPACK_int>, _ v: UnsafePointer<Float>?, _ incv: UnsafePointer<__LAPACK_int>, _ tau: UnsafePointer<Float>, _ c1: UnsafeMutablePointer<Float>?, _ c2: UnsafeMutablePointer<Float>?, _ ldc: UnsafePointer<__LAPACK_int>, _ work: UnsafeMutablePointer<Float>?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slatzm_(_:_:_:_:_:_:_:_:_:_:))*