...
```swift
func slamc5_(_ beta: UnsafePointer<__LAPACK_int>, _ p: UnsafePointer<__LAPACK_int>, _ emin: UnsafePointer<__LAPACK_int>, _ ieee: UnsafePointer<__LAPACK_bool>, _ emax: UnsafeMutablePointer<__LAPACK_int>, _ rmax: UnsafeMutablePointer<Float>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slamc5_(_:_:_:_:_:_:))*