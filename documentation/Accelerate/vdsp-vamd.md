...
- `__IDD`: The distance between the elements in the output vector  .
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/vdsp_vamd)*