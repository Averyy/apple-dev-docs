...
```swift
func dlarnv_(_ idist: UnsafePointer<__LAPACK_int>, _ iseed: UnsafeMutablePointer<__LAPACK_int>?, _ n: UnsafePointer<__LAPACK_int>, _ x: UnsafeMutablePointer<Double>?)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlarnv_(_:_:_:_:))*