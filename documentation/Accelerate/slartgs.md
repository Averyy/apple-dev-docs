...
```swift
func slartgs_(_ x: UnsafePointer<Float>, _ y: UnsafePointer<Float>, _ sigma: UnsafePointer<Float>, _ cs: UnsafeMutablePointer<Float>, _ sn: UnsafeMutablePointer<Float>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/slartgs_(_:_:_:_:_:))*