# dlagtm_(_:_:_:_:_:_:_:_:_:_:_:_:)
...
```swift
func dlagtm_(_ trans: UnsafePointer<CChar>, _ n: UnsafePointer<__LAPACK_int>, _ nrhs: UnsafePointer<__LAPACK_int>, _ alpha: UnsafePointer<Double>, _ dl: UnsafePointer<Double>?, _ d: UnsafePointer<Double>?, _ du: UnsafePointer<Double>?, _ x: UnsafePointer<Double>?, _ ldx: UnsafePointer<__LAPACK_int>, _ beta: UnsafePointer<Double>, _ b: UnsafeMutablePointer<Double>?, _ ldb: UnsafePointer<__LAPACK_int>)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/dlagtm_(_:_:_:_:_:_:_:_:_:_:_:_:))*