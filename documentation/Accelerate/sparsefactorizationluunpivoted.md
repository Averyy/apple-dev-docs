# SparseFactorizationLUUnpivoted
...
```swift
var SparseFactorizationLUUnpivoted: SparseFactorization_t { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/accelerate/sparsefactorizationluunpivoted)*