...
![A screenshot of tab view on iOS.](/images/com.apple.visionOS/Destination-video-iOS@2x.png)

**macOS**:

![A screenshot of tab view on macOS](/images/com.apple.visionOS/Destination-video-macOS@2x.png)

**visionOS**:

![An image that shows tab view on visionOS.](/images/com.apple.visionOS/Destination-video-visionOS.png)
...
![A screenshot that shows the tab view in Destination Video for Mac.](/images/com.apple.visionOS/Destination-video-mac-windows@2x.png)
...
![A screenshot that shows the Studio environment in visionOS.](/images/com.apple.visionOS/Destination-video-immersive-space@2x.png)
...
![A screenshot that shows a video player in the Studio environment in visionOS.](/images/com.apple.visionOS/Destination-video-video-player@2x.png)
