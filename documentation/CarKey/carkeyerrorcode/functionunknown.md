# CarKeyErrorCode.FunctionUnknown
...
Verify that the integer value in your [`FunctionIdentifier`](functionidentifier.md) type matches one your vehicle supports.
...
*[View on Apple Developer](https://developer.apple.com/documentation/carkey/carkeyerrorcode/functionunknown)*