...
This function takes an index. If you have an identifier, use the [`ABMultiValueGetIndexForIdentifier(_:_:)`](abmultivaluegetindexforidentifier(_:_:).md) function to get the corresponding index.
...
*[View on Apple Developer](https://developer.apple.com/documentation/addressbook/abmultivalueinsertvalueandlabelatindex(_:_:_:_:_:))*