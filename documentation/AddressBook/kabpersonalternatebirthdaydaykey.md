...
Corresponds to [`day`](https://developer.apple.com/documentation/Foundation/NSDateComponents/day).
...
*[View on Apple Developer](https://developer.apple.com/documentation/addressbook/kabpersonalternatebirthdaydaykey)*