...
If the identifier is `nil`, this method raises an exception. Use the [`identifier(at:)`](abmultivalue-swift.class/identifier(at:).md) method to get the identifier given the index.
...
*[View on Apple Developer](https://developer.apple.com/documentation/addressbook/abmutablemultivalue-swift.class/setprimaryidentifier(_:))*