...
Corresponds to [`era`](https://developer.apple.com/documentation/Foundation/NSDateComponents/era).
...
*[View on Apple Developer](https://developer.apple.com/documentation/addressbook/kabpersonalternatebirthdayerakey)*