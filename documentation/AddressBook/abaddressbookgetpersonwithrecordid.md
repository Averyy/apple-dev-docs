...
- `recordID`: The record identifier to seek in  .
...
*[View on Apple Developer](https://developer.apple.com/documentation/addressbook/abaddressbookgetpersonwithrecordid(_:_:))*