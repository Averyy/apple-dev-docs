...
- `property`: The person property whose localized name is being returned.
...
*[View on Apple Developer](https://developer.apple.com/documentation/addressbook/abpersoncopylocalizedpropertyname(_:))*