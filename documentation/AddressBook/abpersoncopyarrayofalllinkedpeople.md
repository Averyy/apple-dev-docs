...
- `person`: The person record whose linked records are being returned.
...
*[View on Apple Developer](https://developer.apple.com/documentation/addressbook/abpersoncopyarrayofalllinkedpeople(_:))*