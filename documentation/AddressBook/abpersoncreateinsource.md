...
To add the newly created person record to the Address Book database, use [`ABAddressBookAddRecord(_:_:_:)`](abaddressbookaddrecord(_:_:_:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/addressbook/abpersoncreateinsource(_:))*