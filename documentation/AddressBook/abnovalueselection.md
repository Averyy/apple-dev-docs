...
```swift
var ABNoValueSelection: ABPeoplePickerSelectionBehavior { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/addressbook/abnovalueselection)*