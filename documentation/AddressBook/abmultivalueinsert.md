...
- `index`: The index to insert   at. If   is out of bounds, this function raises an exception.
...
*[View on Apple Developer](https://developer.apple.com/documentation/addressbook/abmultivalueinsert(_:_:_:_:_:))*