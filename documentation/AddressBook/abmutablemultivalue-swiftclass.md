...
### Adding a value
- [func add(Any!, withLabel: String!) -> String!](abmutablemultivalue-swift.class/add(_:withlabel:).md)
  Adds a value and its label to a multivalue list.
- [func insert(Any!, withLabel: String!, at: Int) -> String!](abmutablemultivalue-swift.class/insert(_:withlabel:at:).md)
  Inserts a value and its label at the given index in a multivalue list.
### Replacing values and labels
- [func replaceLabel(at: Int, withLabel: String!) -> Bool](abmutablemultivalue-swift.class/replacelabel(at:withlabel:).md)
  Replaces the label at the given index.
- [func replace(at: Int, withValue: Any!) -> Bool](abmutablemultivalue-swift.class/replace(at:withvalue:).md)
  Replaces the value at the given index.
### Removing values
- [func removeAndLabel(at: Int) -> Bool](abmutablemultivalue-swift.class/removeandlabel(at:).md)
  Removes the value and label at the given index.
### Setting the Primary identifier
- [func setPrimaryIdentifier(String!) -> Bool](abmutablemultivalue-swift.class/setprimaryidentifier(_:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/addressbook/abmutablemultivalue-swift.class)*