...
The user’s sort ordering preference; see [`Sort Order`](1619730-sort-order.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/addressbook/abpersongetsortordering())*