...
Each value in a multi-value list must be the same type, andhas an associated pre-defined or user-defined label, and uniqueidentifier. Use the [`ABMultiValueCopyLabelAtIndex(_:_:)`](abmultivaluecopylabelatindex(_:_:).md) functionto get a label, and the [`ABMultiValueCopyValueAtIndex(_:_:)`](abmultivaluecopyvalueatindex(_:_:).md)functionto get a value.
...
*[View on Apple Developer](https://developer.apple.com/documentation/addressbook/abmultivaluecopyidentifieratindex(_:_:))*