...
- `addressBook`: The address book whose record count is being returned.
...
*[View on Apple Developer](https://developer.apple.com/documentation/addressbook/abaddressbookgetgroupcount(_:))*