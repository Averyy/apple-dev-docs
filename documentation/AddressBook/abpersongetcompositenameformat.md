...
A constant indicating person-name display order; see [`Composite Name Format`](1619815-composite-name-format.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/addressbook/abpersongetcompositenameformat())*