...
- `source`: The source whose groups are being returned.
...
*[View on Apple Developer](https://developer.apple.com/documentation/addressbook/abaddressbookcopyarrayofallgroupsinsource(_:_:))*