...
[`kABRecordInvalidID`](kabrecordinvalidid.md) when the record hasn’t been saved to the database.

## Parameters

- `record`: The record whose ID is being returned.
...
*[View on Apple Developer](https://developer.apple.com/documentation/addressbook/abrecordgetrecordid(_:))*