...
Corresponds to [`month`](https://developer.apple.com/documentation/Foundation/NSDateComponents/month).
...
*[View on Apple Developer](https://developer.apple.com/documentation/addressbook/kabpersonalternatebirthdaymonthkey)*