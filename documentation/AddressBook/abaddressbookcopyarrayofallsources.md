...
- `addressBook`: The address book whose source records are being returned.
...
*[View on Apple Developer](https://developer.apple.com/documentation/addressbook/abaddressbookcopyarrayofallsources(_:))*