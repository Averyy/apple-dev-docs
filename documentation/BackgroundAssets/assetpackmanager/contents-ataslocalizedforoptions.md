...
```swift
nonisolated
func contents(at path: FilePath, asLocalizedFor language: Locale.Language, options: Data.ReadingOptions = .mappedIfSafe) throws -> Data
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/backgroundassets/assetpackmanager/contents(at:aslocalizedfor:options:))*