...
You can use this option only with the [`record`](avaudiosession/category-swift.struct/record.md) and  [`playAndRecord`](avaudiosession/category-swift.struct/playandrecord.md) categories.
