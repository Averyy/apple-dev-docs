...
- Automatic BPM detection using the [`MusicUnderstanding`](https://developer.apple.com/documentation/MusicUnderstanding) framework.
...
The clip loader analyzes audio content to detect BPM using the [`MusicUnderstanding`](https://developer.apple.com/documentation/MusicUnderstanding) framework. For clips shorter than 15 seconds, the `analyzeRhythm` helper repeats the audio to provide enough data for accurate tempo detection.
