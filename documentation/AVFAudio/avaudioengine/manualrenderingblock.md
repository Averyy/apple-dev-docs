...
```swift
var manualRenderingBlock: AVAudioEngineManualRenderingBlock { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/avfaudio/avaudioengine/manualrenderingblock)*