...
### Initializers
- [init(rawValue: UInt32)](iousbhostisochronoustransferoptions/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iousbhost/iousbhostisochronoustransferoptions)*