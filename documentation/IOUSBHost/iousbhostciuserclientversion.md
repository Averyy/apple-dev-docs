...
### Initializers
- [init(UInt32)](iousbhostciuserclientversion/init(_:).md)
- [init(rawValue: UInt32)](iousbhostciuserclientversion/init(rawvalue:).md)
### Constants
- [var IOUSBHostCIUserClientVersion100: IOUSBHostCIUserClientVersion](iousbhostciuserclientversion100.md)
### Instance Properties
- [var rawValue: UInt32](iousbhostciuserclientversion/rawvalue.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iousbhost/iousbhostciuserclientversion)*