# IOUSBHostCIEndpointStateToString(_:)
...
```swift
func IOUSBHostCIEndpointStateToString(_ endpointState: IOUSBHostCIEndpointState) -> UnsafePointer<CChar>!
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/iousbhost/iousbhostciendpointstatetostring(_:))*