# IOUSBHostCIExceptionTypeToString(_:)
...
```swift
func IOUSBHostCIExceptionTypeToString(_ exceptionType: IOUSBHostCIExceptionType) -> UnsafePointer<CChar>!
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/iousbhost/iousbhostciexceptiontypetostring(_:))*