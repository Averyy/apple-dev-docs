...
- [func IOUSBGetEndpointMult(UInt32, UnsafePointer<IOUSBEndpointDescriptor>!, UnsafePointer<IOUSBSuperSpeedEndpointCompanionDescriptor>!, UnsafePointer<IOUSBSuperSpeedPlusIsochronousEndpointCompanionDescriptor>!) -> UInt8](iousbgetendpointmult(_:_:_:_:).md)
...
- [func IOUSBHostCIMessageStatusToString(IOUSBHostCIMessageStatus) -> UnsafePointer<CChar>!](iousbhostcimessagestatustostring(_:).md)
- [func IOUSBHostCIMessageTypeToString(IOUSBHostCIMessageType) -> UnsafePointer<CChar>!](iousbhostcimessagetypetostring(_:).md)
- [func IOUSBHostCIPortStateToString(IOUSBHostCIPortState) -> UnsafePointer<CChar>!](iousbhostciportstatetostring(_:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iousbhost/iousbhost-functions)*