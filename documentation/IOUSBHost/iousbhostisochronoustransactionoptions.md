...
### Initializers
- [init(rawValue: UInt32)](iousbhostisochronoustransactionoptions/init(rawvalue:).md)
### Type Properties
- [static var wrap: IOUSBHostIsochronousTransactionOptions](iousbhostisochronoustransactionoptions/wrap.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iousbhost/iousbhostisochronoustransactionoptions)*