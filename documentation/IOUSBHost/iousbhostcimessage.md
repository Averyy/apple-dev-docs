...
### Initializers
- [init()](iousbhostcimessage/init.md)
- [init(control: UInt32, data0: UInt32, data1: UInt64)](iousbhostcimessage/init(control:data0:data1:).md)
### Instance Properties
- [var control: UInt32](iousbhostcimessage/control.md)
- [var data0: UInt32](iousbhostcimessage/data0.md)
- [var data1: UInt64](iousbhostcimessage/data1.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/iousbhost/iousbhostcimessage)*