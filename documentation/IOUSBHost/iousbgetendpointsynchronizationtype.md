# IOUSBGetEndpointSynchronizationType(_:)
...
```swift
func IOUSBGetEndpointSynchronizationType(_ descriptor: UnsafePointer<IOUSBEndpointDescriptor>!) -> UInt8
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/iousbhost/iousbgetendpointsynchronizationtype(_:))*