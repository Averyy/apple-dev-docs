...
This method uses [`IOUSBGetNextDescriptorWithType(_:_:_:)`](iousbgetnextdescriptorwithtype(_:_:_:).md) to find the next interface association descriptor.
...
*[View on Apple Developer](https://developer.apple.com/documentation/iousbhost/iousbgetnextinterfaceassociationdescriptor(_:_:))*