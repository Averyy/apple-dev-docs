...
```swift
var fadeType: FadeCommand.FadeType
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/immersivemediasupport/fadecommand/fadetype-swift.property)*