...
```swift
var colorFadeOpacity: Float { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/immersivemediasupport/presentationdescriptorreader/colorfadeopacity)*