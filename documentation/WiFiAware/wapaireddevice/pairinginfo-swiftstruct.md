...
- [init(from: any Decoder) throws](wapaireddevice/pairinginfo-swift.struct/init(from:).md)
  Creates a new instance by decoding from the given decoder.
### Operators
- [static func == (WAPairedDevice.PairingInfo, WAPairedDevice.PairingInfo) -> Bool](wapaireddevice/pairinginfo-swift.struct/==(_:_:).md)
  Returns a Boolean value indicating whether two values are equal.
### Instance Properties
- [var hashValue: Int](wapaireddevice/pairinginfo-swift.struct/hashvalue.md)
  The hash value.
### Instance Methods
- [func encode(to: any Encoder) throws](wapaireddevice/pairinginfo-swift.struct/encode(to:).md)
  Encodes this value into the given encoder.
- [func hash(into: inout Hasher)](wapaireddevice/pairinginfo-swift.struct/hash(into:).md)
  Hashes the essential components of this value by feeding them into the given hasher.
### Default Implementations
- [Equatable Implementations](wapaireddevice/pairinginfo-swift.struct/equatable-implementations.md)
