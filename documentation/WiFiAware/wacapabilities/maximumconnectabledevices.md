...
```swift
static var maximumConnectableDevices: Int { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/wifiaware/wacapabilities/maximumconnectabledevices)*