...
**Reduce the use of toolbar backgrounds and tinted controls.** Any custom backgrounds and appearances you use might overlay or interfere with background effects that the system provides. Instead, use the content layer to inform the color and appearance of the toolbar, and use a [ScrollEdgeEffectStyle](../SwiftUI/ScrollEdgeEffectStyle.md) when necessary to distinguish the toolbar area from the content area. This approach helps your app express its unique personality without distracting from content.
...
![An illustration of a capsule-shape Back button that includes the Back symbol on the leading side, grouped with Back in text on the trailing side.](https://docs-assets.developer.apple.com/published/c6b298c4398d9d4082e937498729a248/toolbars-navigation-action-back-incorrect~dark%402x.png)
![An X in a circle to indicate incorrect usage.](https://docs-assets.developer.apple.com/published/209f6f0fc8ad99d9bf59e12d82d06584/crossout%402x.png)
![An illustration of the standard circular Back button that includes the standard Back symbol.](https://docs-assets.developer.apple.com/published/31784c620f5e04e049f9a1b5741801b8/toolbars-navigation-action-back-correct~dark%402x.png)
...
![An illustration of an item group with text button labels for Filter, Delete, and New.](https://docs-assets.developer.apple.com/published/c4b789a47d1303ef117c66de909f115b/toolbars-prefer-symbols-incorrect~dark%402x.png)
![An X in a circle to indicate incorrect usage.](https://docs-assets.developer.apple.com/published/209f6f0fc8ad99d9bf59e12d82d06584/crossout%402x.png)
![An illustration of an item group with symbol button labels for Filter, Delete, and New.](https://docs-assets.developer.apple.com/published/36277979ff374ea9f1794399e6663a35/toolbars-prefer-symbols-correct~dark%402x.png)
![A checkmark in a circle to indicate correct usage.](https://docs-assets.developer.apple.com/published/88662da92338267bb64cd2275c84e484/checkmark%402x.png)
...
![An illustration of an item group with buttons for Filter and More. The buttons are labeled with symbols with circular borders.](https://docs-assets.developer.apple.com/published/886562ae53e5383022d98d0827b232c0/toolbars-icons-circle-outline-incorrect~dark%402x.png)
![An X in a circle to indicate incorrect usage.](https://docs-assets.developer.apple.com/published/209f6f0fc8ad99d9bf59e12d82d06584/crossout%402x.png)
![An illustration of an item group with buttons for Filter and More. The buttons are labeled with symbols without borders.](https://docs-assets.developer.apple.com/published/6f60da83c6109c8635b486431048c0ca/toolbars-icons-no-outline-correct~dark%402x.png)
![A checkmark in a circle to indicate correct usage.](https://docs-assets.developer.apple.com/published/88662da92338267bb64cd2275c84e484/checkmark%402x.png)
...
![A diagram of the top toolbar in the Freeform app on iPad. Callouts indicate the location of item groupings on the leading edge, center area, and trailing edge of the toolbar.](https://docs-assets.developer.apple.com/published/28029a8d24adb2ff422670edc5226fba/toolbars-ipad-anatomy~dark%402x.png)
...
![An illustration of a top toolbar on iPhone, with controls for back, forward, tool selection, and the More menu grouped in a single section on the trailing edge.](https://docs-assets.developer.apple.com/published/ab8a93558279b36b9d50c1ca6ec21d8b/toolbars-layout-grouping-incorrect~dark%402x.png)
![An X in a circle to indicate incorrect usage.](https://docs-assets.developer.apple.com/published/209f6f0fc8ad99d9bf59e12d82d06584/crossout%402x.png)
![An illustration of a top toolbar on iPhone, with controls for back and forward grouped on the leading edge, and controls for tool selection and the More menu grouped on the trailing edge.](https://docs-assets.developer.apple.com/published/2163c3c0848f2db90004f7c02ff38fff/toolbars-layout-grouping-correct~dark%402x.png)
![A checkmark in a circle to indicate correct usage.](https://docs-assets.developer.apple.com/published/88662da92338267bb64cd2275c84e484/checkmark%402x.png)
...
**Keep actions with text labels separate.** Placing an action with a text label next to an action with a symbol can create the illusion of a single action with a combined text and symbol, leading to confusion and misinterpretation. If your toolbar includes multiple text-labeled buttons, the text of those buttons may appear to run together, making the buttons indistinguishable. Add separation by inserting fixed space between the buttons. For developer guidance, see [UIBarButtonItem.SystemItem.fixedSpace](../UIKit/UIBarButtonItem/SystemItem/fixedSpace.md).
![An illustration of a top toolbar on iPhone, with an Edit control with a text label and a Share control with a symbol grouped together on the trailing edge.](https://docs-assets.developer.apple.com/published/3f98befb75c565006d08e19190ceb25a/toolbars-layout-text-action-grouping-incorrect~dark%402x.png)
![An X in a circle to indicate incorrect usage.](https://docs-assets.developer.apple.com/published/209f6f0fc8ad99d9bf59e12d82d06584/crossout%402x.png)
![An illustration of a top toolbar on iPhone, with an Edit control with a text label and a Share control with a symbol grouped into individual sections on the trailing edge.](https://docs-assets.developer.apple.com/published/3fded39f89057582ce46ea17a43c16ab/toolbars-layout-text-action-grouping-correct~dark%402x.png)
![A checkmark in a circle to indicate correct usage.](https://docs-assets.developer.apple.com/published/88662da92338267bb64cd2275c84e484/checkmark%402x.png)
...
![A diagram of a Finder window in macOS with callouts showing the location of the toolbar and the window frame.](https://docs-assets.developer.apple.com/published/6f7f46a870c184c4a6d11f6e0f958dcb/toolbars-mac-window-anatomy~dark%402x.png)
...
**Avoid creating a vertical toolbar.** In visionOS, [Tab bars](tab-bars.md) are vertical, so presenting a vertical toolbar could confuse people.
...
**Avoid using a pull-down menu in a toolbar.** A pull-down menu lets you offer additional actions related to a toolbar item, but can be difficult for people to discover and may clutter your interface. Because a toolbar is located at the bottom edge of a window in visionOS, a pull-down menu might obscure the standard window controls that appear below the bottom edge. For guidance, see [Pull-down buttons](pull-down-buttons.md).
...
For developer guidance, see [topBarLeading](../SwiftUI/ToolbarItemPlacement/topBarLeading.md), [topBarTrailing](../SwiftUI/ToolbarItemPlacement/topBarTrailing.md), or [bottomBar](../SwiftUI/ToolbarItemPlacement/bottomBar.md).
...
For developer guidance, see [primaryAction](../SwiftUI/ToolbarItemPlacement/primaryAction.md).
...
[Toolbars](../SwiftUI/Toolbars.md) — SwiftUI
[UIToolbar](../UIKit/UIToolbar.md) — UIKit
[NSToolbar](../AppKit/NSToolbar.md) — AppKit
