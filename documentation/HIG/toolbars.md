...
![A stylized representation of a toolbar, with a Back control on the leading edge, and Compose, Share, and the More menu on the trailing edge. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](/images/com.apple.HIG/components-toolbar-intro~dark@2x.png)
...
![An illustration of an item group with text button labels for Filter, Delete, and New.](/images/com.apple.HIG/toolbars-prefer-symbols-incorrect~dark@2x.png)
![An X in a circle to indicate incorrect usage.](/images/com.apple.HIG/crossout@2x.png)
![An illustration of an item group with symbol button labels for Filter, Delete, and New.](/images/com.apple.HIG/toolbars-prefer-symbols-correct~dark@2x.png)
![A checkmark in a circle to indicate correct usage.](/images/com.apple.HIG/checkmark@2x.png)
...
![An X in a circle to indicate incorrect usage.](/images/com.apple.HIG/crossout@2x.png)
![An illustration of a top toolbar on iPhone, with controls for back and forward grouped on the leading edge, and controls for tool selection and the More menu grouped on the trailing edge.](/images/com.apple.HIG/toolbars-layout-grouping-correct~dark@2x.png)
![A checkmark in a circle to indicate correct usage.](/images/com.apple.HIG/checkmark@2x.png)
...
![An illustration of a top toolbar on iPhone, with an Edit control with a text label and a Share control with a symbol grouped together on the trailing edge.](/images/com.apple.HIG/toolbars-layout-text-action-grouping-incorrect~dark@2x.png)
![An X in a circle to indicate incorrect usage.](/images/com.apple.HIG/crossout@2x.png)
![An illustration of a top toolbar on iPhone, with an Edit control with a text label and a Share control with a symbol grouped into individual sections on the trailing edge.](/images/com.apple.HIG/toolbars-layout-text-action-grouping-correct~dark@2x.png)
![A checkmark in a circle to indicate correct usage.](/images/com.apple.HIG/checkmark@2x.png)
