...
![A stylized representation of the Camera Control.](/images/com.apple.HIG/inputs-camera-control-intro~dark@2x.png)
...
![A screenshot showing callouts to the Camera Control and overlay on iPhone in landscape orientation.](/images/com.apple.HIG/camera-control-button-callout~dark@2x.png)
...
![A partial screenshot of the Camera Control overlay displaying its controls.](/images/com.apple.HIG/camera-control-picker~dark@2x.png)
...
![A partial screenshot of the Camera Control overlay displaying a slider control.](/images/com.apple.HIG/camera-control-slider-control~dark@2x.png)
![A partial screenshot of the Camera Control overlay displaying a picker control.](/images/com.apple.HIG/camera-control-picker-control~dark@2x.png)
...
![A partial screenshot of the Camera Control overlay displaying the system zoom factor control.](/images/com.apple.HIG/system-control-type-zoom-factor~dark@2x.png)
![A partial screenshot of the Camera Control overlay displaying the system exposure bias control.](/images/com.apple.HIG/system-control-type-exposure-bias~dark@2x.png)
...
![A partial screenshot of the Camera Control overlay displaying a camera flash control that uses the bolt.fill symbol.](/images/com.apple.HIG/camera-control-picker-sf-symbols-flash~dark@2x.png)
![A partial screenshot of the Camera Control overlay displaying a camera filters control that uses the camera.filters symbol.](/images/com.apple.HIG/camera-control-picker-sf-symbols-filters~dark@2x.png)
...
![A partial screenshot showing an example of the Camera Control overlay with a slider control displaying a value and context for the type of value.](/images/com.apple.HIG/system-control-with-label~dark@2x.png)
![A checkmark in a circle to indicate correct usage.](/images/com.apple.HIG/checkmark@2x.png)
![A partial screenshot showing an example of the Camera Control overlay with a slider control displaying a value without information about what the value represents.](/images/com.apple.HIG/system-control-no-label~dark@2x.png)
...
![Partial screenshots showing the Camera Control overlay with its control's label in the viewport in portrait and landscape orientations on iPhone.](/images/com.apple.HIG/camera-control-portrait-landscape-orientation~dark@2x.png)
...
![A partial screenshot showing an example of the Camera Control overlay with UI elements removed from the capture viewport.](/images/com.apple.HIG/camera-control-screen-ui-good-example~dark@2x.png)
![A checkmark in a circle to indicate correct usage.](/images/com.apple.HIG/checkmark@2x.png)
![A partial screenshot showing an example of the Camera Control overlay with UI elements duplicated in the capture viewport.](/images/com.apple.HIG/camera-control-screen-ui-bad-example~dark@2x.png)
![An X in a circle to indicate incorrect usage.](/images/com.apple.HIG/crossout@2x.png)
