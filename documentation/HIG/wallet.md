...
![A sketch of the Wallet icon. The image is overlaid with rectangular and circular grid lines and is tinted blue to subtly reflect the blue in the original six-color Apple logo.](/images/com.apple.HIG/technologies-Wallet-intro~dark@2x.png)
...
![A screenshot of the bottom portion of the Lock Screen on iPhone showing a banner from the Gym app that reads 'Get ready for today's workout! Open your membership pass to badge in.'](/images/com.apple.HIG/wallet-passes-pass-notification~dark@2x.png)
![A screenshot of the bottom portion of the Lock Screen on iPhone showing a Live Activity for a soccer event ticket, displaying the seat location at level 3, row 12, seat 5.](/images/com.apple.HIG/wallet-passes-pass-live-activity~dark@2x.png)
...
![A screenshot of a museum membership pass open in Wallet on iPhone, showing a full-art background with a dinosaur skull illustration, a QR code, and member details. Below the pass are two featured actions: View Membership Benefits and Go to Location.](/images/com.apple.HIG/wallet-passes-wallet-app~dark@2x.png)
...
![A screenshot of Pass Designer on Mac showing a preview of a museum poster generic pass with an illustration featuring a dinosaur skull, butterflies, and marine creatures, along with member details and a QR code.](/images/com.apple.HIG/wallet-pass-pass-designer-overview~dark@2x.png)
...
![A gym membership pass with a solid purple background and white label text that's clearly legible against the background.](/images/com.apple.HIG/wallet-passes-text-sufficient-contrast@2x.png)
![A checkmark in a circle to indicate correct usage.](/images/com.apple.HIG/checkmark@2x.png)
![A gym membership pass with a solid purple background and label text that's difficult to distinguish from the background.](/images/com.apple.HIG/wallet-passes-text-insufficient-contrast@2x.png)
![An X in a circle to indicate incorrect usage.](/images/com.apple.HIG/crossout@2x.png)
![A concert ticket pass with an image background and white label text that's clearly legible against the background.](/images/com.apple.HIG/wallet-passes-background-sufficient-contrast@2x.png)
![A checkmark in a circle to indicate correct usage.](/images/com.apple.HIG/checkmark@2x.png)
![A concert ticket pass with an image background and label text that's difficult to distinguish from the background.](/images/com.apple.HIG/wallet-passes-background-insufficient-contrast@2x.png)
![An X in a circle to indicate incorrect usage.](/images/com.apple.HIG/crossout@2x.png)
...
![A soccer event ticket with a blurred full-image background of a soccer player in motion, displaying event details, seat information, and a barcode at the bottom.](/images/com.apple.HIG/wallet-passes-types-event-ticket-background@2x.png)
![A soccer event ticket on a solid dark blue background, displaying event details, seat information, a thumbnail, and a barcode at the bottom.](/images/com.apple.HIG/wallet-passes-types-event-ticket@2x.png)
...
![The top portion of a food truck coupon pass with a callout identifying the logo position in the top-left corner of the pass.](/images/com.apple.HIG/wallet-passes-images-logo~dark@2x.png)
|  |  |
| --- | --- |
...
![A brown paper bag icon with a flat appearance and no inner drop shadow.](/images/com.apple.HIG/wallet-passes-images-logo-no-shadow@2x.png)
![A checkmark in a circle to indicate correct usage.](/images/com.apple.HIG/checkmark@2x.png)
![A brown paper bag icon with an inner drop shadow applied, creating a recessed effect inside the icon shape.](/images/com.apple.HIG/wallet-passes-images-logo-with-shadow-incorrect@2x.png)
![An X in a circle to indicate incorrect usage.](/images/com.apple.HIG/crossout@2x.png)
...
![The top portion of an airline boarding pass with callouts identifying a square primary logo in the top-left corner and the logo text beside it.](/images/com.apple.HIG/wallet-passes-images-primary-logo-square~dark@2x.png)
![The top portion of an airline boarding pass with a callout identifying a rectangular text-based primary logo in the top-left corner.](/images/com.apple.HIG/wallet-passes-images-primary-logo-wide~dark@2x.png)
|  |  |
| --- | --- |
...
![The bottom portion of a soccer event poster ticket with a callout identifying the secondary logo in the bottom-trailing corner.](/images/com.apple.HIG/wallet-passes-images-secondary-logo~dark@2x.png)
|  |  |
| --- | --- |
...
![A screenshot of the bottom portion of the Lock Screen on iPhone showing an airline boarding pass banner that reads 'Get ready for flight AP 1042 to Tokyo!', with the pass icon appearing in the leading edge of the banner.](/images/com.apple.HIG/wallet-passes-images-icon-notification~dark@2x.png)
![The bottom portion of an airline boarding pass open in Wallet on iPhone, with the pass icon visible in the bottom-leading corner of the pass, and two featured actions below: Go to Terminal I and Track Luggage.](/images/com.apple.HIG/wallet-passes-images-icon-wallet~dark@2x.png)
|  |  |
| --- | --- |
...
![The upper portion of a food truck coupon pass with callouts identifying the primary field and the strip image, outlined with dashed borders.](/images/com.apple.HIG/wallet-passes-images-strip-image~dark@2x.png)
|  |  |
| --- | --- |
...
![The top portion of a gym membership pass on a solid purple background with a callout identifying the thumbnail in the upper-trailing area of the pass.](/images/com.apple.HIG/wallet-passes-images-thumbnail~dark@2x.png)
|  |  |
| --- | --- |
...
![A soccer event ticket with a blurred full-image background of a soccer player in motion, displaying event details, seat information, and a barcode at the bottom.](/images/com.apple.HIG/wallet-passes-types-event-ticket-background@2x.png)
![A food truck coupon pass with a background illustration of a food truck in an outdoor setting, a barcode overlaid on the illustration, and coupon details at the top and bottom.](/images/com.apple.HIG/wallet-passes-images-background-unblurred@2x.png)
...
![A museum poster generic pass with a background illustration featuring a dinosaur skull, butterflies, and marine creatures, with a QR code and member details at the bottom.](/images/com.apple.HIG/wallet-passes-images-background-layout-qr-code@2x.png)
![A museum poster generic pass with a background illustration featuring a dinosaur skull, butterflies, and marine creatures. Blue overlays show the safe areas for pass content, including a header area at the top and QR code and footer areas below.](/images/com.apple.HIG/wallet-passes-images-background-layout-qr-code-safe-areas@2x.png)
![An art museum poster generic pass with a full-art background illustration of a waterfall scene, with a barcode and member details at the bottom.](/images/com.apple.HIG/wallet-passes-images-background-layout-barcode@2x.png)
![A background artwork image of a waterfall scene. Blue overlays show the safe areas for pass content, including a header area at the top and barcode and footer areas below.](/images/com.apple.HIG/wallet-passes-images-background-layout-barcode-safe-areas@2x.png)
...
![A screenshot of an order fulfillment screen for a food truck app on iPhone. The screen displays information about an order placed, and includes a status bar, shipping address, list of items ordered, and additional order details.](/images/com.apple.HIG/wallet-ot-status-order-placed~dark@2x.png)
![A screenshot of an order fulfillment screen for a food truck app on iPhone. The screen displays information about an order placed, and denotes that the order was delivered today. The screen includes the shipping address, a link to track the shipment, a list of items ordered, and additional order details.](/images/com.apple.HIG/wallet-ot-status-delivered~dark@2x.png)
...
![A screenshot of a dashboard that displays an order history screen for a food truck app on iPhone. The screen displays a search field, a list of active orders, and a list of orders placed this month.](/images/com.apple.HIG/wallet-ot-dashboard~dark@2x.png)
The [Wallet Orders](../walletorders.md) schema defines the properties you use to provide order data like product descriptions, order status, contact information, and shipping and pickup details, including estimated arrival dates, addresses, tracking numbers, and pickup instructions. Wallet displays the information you supply within consistent, system-defined interfaces. To help people get the information they need quickly and conveniently, supply as much information as you can, using the properties that match your order processes.
![A screenshot of an order fulfillment screen for a food truck app on iPhone. The screen displays information about an order placed, and includes a status bar, shipping address, list of items ordered, and additional order details. Callouts identify different fields on the screen, including the merchant logo and display name, the order status and description, the tracking link, and various line items.](/images/com.apple.HIG/wallet-ot-status-on-the-way-fields~dark@2x.png)
**Make it easy for people to add an order to Wallet.** For example, when a customer completes an Apple Pay transaction in your app or website, use [PKPaymentOrderDetails](../passkit/pkpaymentorderdetails.md) (app) or [ApplePayPaymentOrderDetails](../applepayontheweb/applepaypaymentorderdetails.md) (web) to automatically add the order to Wallet. In iOS 17 and later, you can use [AddOrderToWalletButton](../financekitui/addordertowalletbutton.md) to display the system-provided Track with Apple Wallet button in relevant areas of your app or website — such as in pages for order confirmation, status, or tracking — or in emails to customers. If a person already added an order to Wallet, trying to add it again opens Wallet and displays the order.
...
![An illustration of a donut, representing a product image. Horizontal and vertical lines extend along the bottom and right side of the image, and include labels that denote the illustration is 300 pixels wide by 300 pixels high.](/images/com.apple.HIG/wallet-ot-product-images~dark@2x.png)
...
**Make it easy for customers to contact the merchant.** Provide multiple contact methods, so people can choose the one that works best for them. At minimum, you need to provide a link to the merchant’s website or landing page, but you can also provide a Messages for Business link, a phone number, an email address, and a link to a support page. When people choose the Contact button in an order, the system displays a menu of the contact methods you supply. For developer guidance, see [Merchant](../walletorders/merchant.md).
![A screenshot of an order detail screen for a food truck app on iPhone. The screen displays a list of donuts ordered. Above the list is an overlay containing buttons to message or email the merchant, get online support, or call customer service.](/images/com.apple.HIG/wallet-ot-contacts~dark@2x.png)
...
| --- | --- |
| ![An illustration of a Verify Age with Apple Wallet button.](/images/com.apple.HIG/wallet-button-verify-age~dark@2x.png) | Your app can complete the current transaction after you verify a person’s age. An example transaction is making a car available to lease. |
| ![An illustration of a Verify Identity with Apple Wallet button.](/images/com.apple.HIG/wallet-button-verify-identity~dark@2x.png) | Your app can complete the current transaction after you verify a person’s identity. An example transaction is a car rental. |
| ![An illustration of a Continue with Apple Wallet button.](/images/com.apple.HIG/wallet-button-continue-with~dark@2x.png) | Verify with Wallet forms one part of a verification process that also requires people to supply additional information not provided by Verify with Wallet, such as a Social Security number or phone number. Examples include opening a financial account or performing a background check. |
| ![An illustration of a Verify with Apple Wallet button.](/images/com.apple.HIG/wallet-button-verify-with~dark@2x.png) | Your app can complete the current verification flow without additional steps, but the “Verify Age,” “Verify Identity,” and “Continue” button labels aren’t appropriate for your use case. An example is an app that helps people sign up for a government service. |

All button labels are also available in a multiline variant that the system automatically uses when horizontal space is constrained. For developer guidance, see [PKIdentityButton.Label](../passkit/pkidentitybutton/label.md).
...
![A diagram that shows the basic layout of a pass on Apple Watch. A top row contains a logo image and an essential field area. A second row contains a primary field area. A third row contains a secondary and auxiliary fields area.](/images/com.apple.HIG/watch-layout-diagram~dark@2x.png)
...
[FinanceKitUI](../financekitui.md)
[FinanceKit](../financekit.md)
...
---
*Source: [https://developer.apple.com/design/human-interface-guidelines/wallet](https://developer.apple.com/design/human-interface-guidelines/wallet)*
