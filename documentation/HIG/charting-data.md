...
![A screenshot of the Stocks app on iPhone. The app uses a line chart to depict the performance of a stock over the currently chosen one-month period.](https://docs-assets.developer.apple.com/published/ec40b27677264d12e0c474515ee7df02/charts-stocks%402x.png)
![A screenshot of the Activity screen in the Health app on iPhone. The app uses a set of three bar charts to depict information from the three Activity Rings over the currently chosen one-day period.](https://docs-assets.developer.apple.com/published/59abbb8326b6d4ab301a4218a5fb16b4/charts-activity~dark%402x.png)
...
---
*Source: [https://developer.apple.com/design/human-interface-guidelines/charting-data](https://developer.apple.com/design/human-interface-guidelines/charting-data)*
