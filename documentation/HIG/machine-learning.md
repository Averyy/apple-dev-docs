...
> **Updated 2023-10-24:** Added art to Corrections section.
...
For related guidance on how to use machine learning models to enable intelligent content creation experiences, see [Generative AI](generative-ai.md).

## Planning your design
Machine learning apps use *models* to perform tasks like recognizing images or finding relationships among numerical data. A great machine learning app depends on well-designed models as much as it depends on a well-designed UI and user experience. For insight into the process of designing models, see [Create ML](../CreateML.md).
...
- [Limitations](machine-learning.md#Limitations) help you set people’s expectations about the accuracy of your suggestions.
- [Corrections](machine-learning.md#Corrections) give people a way to be successful even when your results are wrong.
- [Attribution](machine-learning.md#Attribution) gives people insight into where suggestions come from, which can help them understand mistakes.
- [Confidence](machine-learning.md#Confidence) helps you gauge the quality of your results, which can impact how you present them.
...
![A screenshot of the Maps app on Mac, displaying the San Francisco Bay Area. The map shows three different routes between San Francisco and Apple Park.](https://docs-assets.developer.apple.com/published/819eff1b239b78857696dbf1b9ec4ba2/machine-learning-multiple-options~dark%402x.png)
