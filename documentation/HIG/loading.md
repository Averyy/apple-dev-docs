...
> **Updated 2025-06-09:** Revised guidance for storing downloads to reflect downloading large assets in the background.
...
**Improve installation and launch time by downloading large assets in the background.** Consider using the [Background Assets](../backgroundassets.md) framework to schedule asset downloads — like game level packs, 3D character models, and textures — to occur immediately after installation, during updates, or at other nondisruptive times.
