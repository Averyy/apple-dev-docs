...
![A stylized representation of a bar chart. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](/images/com.apple.HIG/components-charts-intro~dark@2x.png)
...
To learn about designing charts to enhance your experience, see [Charting data](charting-data.md); for developer guidance, see [Creating a chart using Swift Charts](../charts/creating-a-chart-using-swift-charts.md).

## Anatomy
A chart comprises several graphical elements that depict the values in a dataset and convey information about them.
![A bar chart with callouts that identify chart components, such as axes, grid lines, marks, ticks, axis value labels, and the overall plot area.](/images/com.apple.HIG/charts-anatomy~dark@2x.png)
A *mark* is a visual representation of a data value. You create a chart by supplying one or more series of data values, assigning each value to a mark. To specify the style of chart you want to display — such as bar chart, line chart, or scatter plot — you choose a mark type, such as bar, line, or point (for guidance, see [Marks](charts.md#Marks)). The general task of depicting individual data values in a chart is called *plotting*, and the area that contains the marks is called the *plot area*.
...
Clear, accurate descriptions can help make a chart more approachable and accessible; to learn about additional ways to improve the accessibility of your chart, see [Enhancing the accessibility of a chart](charts.md#Enhancing-the-accessibility-of-a-chart).

## Marks
**Choose a mark type based on the information you want to communicate about the data.** Some of the most familiar mark types are bar, line, and point; for developer guidance on these and other mark types, see [Swift Charts](../charts.md).
...
![A line chart that depicts the performance of a stock over a five-year period.](/images/com.apple.HIG/charts-line-marks~dark@2x.png)
...
When you use Swift Charts to create a chart, you get a default implementation of [Audio graphs](../accessibility/audio-graphs.md), in addition to a default accessibility element for each mark (or group of marks) that describes its value.
