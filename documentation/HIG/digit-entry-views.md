...
![A stylized representation of an Apple TV five-digit passcode entry screen. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](https://docs-assets.developer.apple.com/published/81b2ac682d084ddb189311f07fc09c2a/components-digit-entry-view-intro~dark%402x.png)
...
[TVDigitEntryViewController](../TVUIKit/TVDigitEntryViewController.md) — TVUIKit
