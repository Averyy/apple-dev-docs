...
- In visionOS, people use the standard [Standard gestures](gestures.md#Standard-gestures) gesture to open the edit menu as a horizontal bar, or they can open it in a context menu.
