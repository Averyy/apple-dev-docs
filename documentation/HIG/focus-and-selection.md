...
![An illustration of a collection view of photos showing a rounded-rectangle halo effect that outlines the focused photo.](/images/com.apple.HIG/focus-and-selection-customized-halo~dark@2x.png)
...
![An illustration of a list of menu items with the second item highlighted. The item's title and icon are tinted with a red accent color.](/images/com.apple.HIG/focus-and-selection-highlighted-appearance~dark@2x.png)
