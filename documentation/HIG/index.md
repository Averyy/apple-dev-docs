...
- [Getting started](getting-started.md) - Create an app or game that feels at home on every platform you support.
- [Foundations](foundations.md) - Understand how fundamental design elements help you create rich experiences.
- [Patterns](patterns.md) - Get design guidance for supporting common user actions, tasks, and experiences.
- [Components](components.md) - Learn how to use and customize system-defined components to give people a familiar and consistent experience.
- [Inputs](inputs.md) - Learn about the various methods people use to control your app or game and enter data.
- [Technologies](technologies.md) - Discover the Apple technologies, features, and services you can integrate into your app or game.
