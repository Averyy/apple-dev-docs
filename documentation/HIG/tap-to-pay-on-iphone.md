...
Before your app can enable Tap to Pay on iPhone and configure a merchant’s device, the merchant must accept the relevant terms and conditions. Use the ProximityReader API to help you get the current status and present an acceptance flow only when necessary. For developer guidance, see [Adding support for Tap to Pay on iPhone to your app](../proximityreader/adding-support-for-tap-to-pay-on-iphone-to-your-app.md).
...
![An illustration of an app screen that describes the feature and contains a button labeled 'Enable Tap to Pay on iPhone'.](/images/com.apple.HIG/tap-to-pay-introduction-screen~dark@2x.png)
![An illustration of an app screen that contains a button labeled 'Try a test transaction'.](/images/com.apple.HIG/tap-to-pay-confirmation-screen~dark@2x.png)
...
![An illustration of an app's Tutorials screen in Settings, with a link to open the merchant education tutorial experience.](/images/com.apple.HIG/tap-to-pay-merchant-settings-tutorials~dark@2x.png)
![An illustration of the Tap to Pay on iPhone merchant education tutorial sheet, which includes an image of the Tap to Pay behavior and instructions for how to accept a first payment.](/images/com.apple.HIG/tap-to-pay-merchant-education-contactless-cards~dark@2x.png)
...
![An illustration of an app screen that displays a determinate progress indicator followed by the text 'Preparing Tap to Pay on iPhone' above a purchase total.](/images/com.apple.HIG/tap-to-pay-processing-screen-determinate-progress~dark@2x.png)
![An illustration of an app screen that displays an indeterminate progress indicator followed by the text 'Preparing Tap to Pay on iPhone' above a purchase total.](/images/com.apple.HIG/tap-to-pay-processing-screen-indeterminate-progress~dark@2x.png)
...
![An illustration of a 'Tap to Pay' button containing an icon. The button correctly includes a wave symbol followed by the words 'Tap to Pay on iPhone'.](/images/com.apple.HIG/tap-to-pay-on-iphone-symbol-correct~dark@2x.png)
![A checkmark in a circle to indicate correct usage.](/images/com.apple.HIG/checkmark@2x.png)
![An illustration of a 'Tap to Pay' button containing an icon. The button incorrectly includes the Apple logo followed by the words 'Tap to Pay on iPhone'.](/images/com.apple.HIG/tap-to-pay-on-iphone-logo-incorrect~dark@2x.png)
...
![An illustration of an app's checkout screen showing an indeterminate progress indicator followed by the text 'Authorizing' above a purchase total.](/images/com.apple.HIG/tap-to-pay-authorizing-payment~dark@2x.png)
...
![An illustration of an app's checkout screen showing a green checkmark in a green circle above a purchase total. Below the total is the text 'Select receipt option' followed by a stack of three buttons.](/images/com.apple.HIG/tap-to-pay-confirmed-payment~dark@2x.png)
![An illustration of an app's checkout screen showing a red X in a red circle above a purchase total. Below the total is the text 'Select receipt option' followed by a stack of three buttons.](/images/com.apple.HIG/tap-to-pay-unconfirmed-payment~dark@2x.png)
...
![An illustration of a button labeled 'Loyalty Card'.](/images/com.apple.HIG/loyalty-card~dark@2x.png)
![A checkmark in a circle to indicate correct usage.](/images/com.apple.HIG/checkmark@2x.png)
![An illustration of a button labeled 'Tap to Pay on iPhone - Loyalty'.](/images/com.apple.HIG/tap-to-pay-on-iphone-loyalty~dark@2x.png)
![An X in a circle to indicate incorrect usage.](/images/com.apple.HIG/crossout@2x.png)
