...
![A stylized representation of a rating indicator denoting a ranking of three out of five stars. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](/images/com.apple.HIG/components-rating-indicators-intro~dark@2x.png)
...
[NSLevelIndicator.Style.rating](../appkit/nslevelindicator/style/rating.md) — AppKit
