...
> **Updated 2025-12-16:** Added guidance for spatial photos and spatial scenes in visionOS.
...
![Image of a circle that's in standard resolution at scale factor of @1x, and is 10 by 10 pixels.](https://docs-assets.developer.apple.com/published/45d3f9f0f6e790aef4b1601305041550/image-resolution-1x~dark%402x.png)
![Image of a circle that's in high resolution at a scale factor of @2x, and is 20 by 20 pixels.](https://docs-assets.developer.apple.com/published/bfe50a5393482c44bd38c3dbbf9f0820/image-resolution-2x~dark%402x.png)
![Image of a circle that's in high resolution at a scale factor of @3x, and is 30 by 30 pixels.](https://docs-assets.developer.apple.com/published/e9cd0f2ca6cddc1dc5c384cbb361ce0f/image-resolution-3x~dark%402x.png)
...
| iPadOS, watchOS | @2x |
| iOS | @2x and @3x |
| visionOS | @2x or higher (see [visionOS](images.md#visionOS)) |
...
[Video: tvos-app-icon-parallax-effect-animation.mp4](https://docs-assets.developer.apple.com/published/2b757391385337fb423a39a8fea4e88c/tvos-app-icon-parallax-effect-animation.mp4)
...
> **Important:** Your tvOS [tvOS](app-icons.md#tvOS) must use a layered image. For other focusable images in your app, including [Top Shelf](top-shelf.md) images, layered images are strongly encouraged, but optional.
...
**Use standard interface elements to display layered images.** If you use standard views and system-provided focus APIs — such as [FocusState](../SwiftUI/FocusState.md) — layered images automatically get the parallax treatment when people bring them into focus.
...
**Leave a safe zone around the foreground layers of your image.** When focused, content on some layers may be cropped as the layered image scales and moves. To ensure that essential content is always visible, keep it within a safe zone. For guidance, see [App icons](app-icons.md).
...
[Drawing sharp layer-based content in visionOS](../visionOS/drawing-sharp-layer-based-content.md) — visionOS
[Images](../SwiftUI/Images.md) — SwiftUI
