...
> **Updated 2026-06-08:** Updated terminology and refined best practices.
...
## Best practices
**If search is important, give it a primary position in your app or view.** For example, in the Notes app, a search field is in the bottom [Toolbars](toolbars.md) alongside other important actions. In apps that use [Tab bars](tab-bars.md), like Photos and Apple TV, search is a dedicated tab.
...
**Provide suggestions to make searching easier.** When you display a personʼs recent searches before they start typing or offer predictive search suggestions while they’re typing, you can help people search faster and type less. For developer guidance, see [searchSuggestions(_:)](../swiftui/view/searchsuggestions(_:).md).
