...
> **Updated 2024-09-09:** Added guidance for working with system overlays in visionOS and made organizational updates.
...
### iOS, iPadOS
In addition to the [Standard gestures](gestures.md#Standard-gestures) supported in all platforms, iOS and iPadOS support a few other gestures that people expect.
...
### macOS
People primarily interact with macOS using a [Keyboards](keyboards.md) and mouse. In addition, they can make [Standard gestures](gestures.md#Standard-gestures) on a Magic Trackpad, Magic Mouse, or a [Game controls](game-controls.md) that includes a touch surface.

### tvOS
People expect to use [Standard gestures](gestures.md#Standard-gestures) to navigate tvOS apps and games with a compatible remote, Siri Remote, or [Game controls](game-controls.md) that includes a touch surface. For guidance, see [Remotes](remotes.md).
