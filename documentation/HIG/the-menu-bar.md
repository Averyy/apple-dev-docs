...
> **Updated 2025-06-09:** Added guidance for the menu bar in iPadOS.
...
- Window
- Help
In addition, the macOS menu bar includes the Apple menu on the leading side and menu bar extras on the trailing side. See [macOS](the-menu-bar.md#macOS) for guidance.
...
> **Important:** The View menu doesn’t include items for navigating between or managing specific windows; the [Window menu](the-menu-bar.md#Window-menu) provides these commands.
...
| Menu item | Action |
| --- | --- |
| Show/Hide Tab Bar | Toggles the visibility of the [Tab bars](tab-bars.md) above the body area in a tab-based window |
...
| Show/Hide Toolbar | In a window that includes a [Toolbars](toolbars.md), toggles the toolbar’s visibility |
| Customize Toolbar | In a window that includes a toolbar, opens a view that lets people customize toolbar items |
| Show/Hide Sidebar | In a window that includes a [Sidebars](sidebars.md), toggles the sidebar’s visibility |
| Enter/Exit Full Screen | In an app that supports a [Going full screen](going-full-screen.md), opens the window at full-screen size in a new space |
...
> **Important:** The Window menu doesn’t help people customize the appearance of windows or close them. To customize a window, people use commands in the [View menu](the-menu-bar.md#View-menu); to close a window, people choose Close in the [File menu](the-menu-bar.md#File-menu).
...
| Zoom | Toggles between a predefined size appropriate to the window’s content and the window size people set. Pressing the Option key changes this item to Zoom All. | Avoid using Zoom to enter or exit full-screen mode. The [View menu](the-menu-bar.md#View-menu) supports these functions. |
...
| Enter/Exit Full Screen | In an app that supports a [Going full screen](going-full-screen.md), opens the window at full-screen size in a new space. | Include this item in the Window menu only if your app doesn’t have a View menu. In this scenario, continue to provide separate Minimize and Zoom menu items. |
...
### macOS
The menu bar in macOS includes the Apple menu, which is always the first item on the leading side of the menu bar. The Apple menu includes system-defined menu items that are always available, and you can’t modify or remove it. Space permitting, the system can also display menu bar extras in the trailing end of the menu bar. For guidance, see [Menu bar extras](the-menu-bar.md#Menu-bar-extras).
