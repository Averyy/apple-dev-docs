...
![A stylized representation of a brightness slider. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](/images/com.apple.HIG/components-slider-intro~dark@2x.png)
...
![An illustration of a horizontal linear slider without tick marks, followed by a text field and a stepper. The thumb is in the center of the slider and the text field displays 50%.](/images/com.apple.HIG/sliders-text-field~dark@2x.png)
...
![An illustration of a circular slider with the thumb at the 12 o'clock position.](/images/com.apple.HIG/sliders-circular~dark@2x.png)
...
[Slider](../swiftui/slider.md) — SwiftUI
[UISlider](../uikit/uislider.md) — UIKit
[NSSlider](../appkit/nsslider.md) — AppKit
