...
## Providing coaching
Before people can enjoy an AR experience in your app, they need to move their device in ways that lets ARKit evaluate the surroundings and detect surfaces. Consider using the built-in coaching view to show people what to do and provide feedback during the initialization process. You can also use the coaching view to help people reinitialize AR — a process known as *relocalization* — after an AR experience is interrupted by, for example, people switching briefly to a different app. For guidance on relocalization, see [Handling interruptions](augmented-reality.md#Handling-interruptions); for developer guidance, see [ARCoachingOverlayView](../arkit/arcoachingoverlayview.md).
![An illustration of an iPhone screen showing the corner of a room viewed through the camera. On the screen is a translucent overlay containing the surface-detection indicator. The indicator is a white square with rounded corners projected into the 3D space. A small iPhone is shown scanning back and forth along the base of the square. A circle of dots trailing the iPhone emphasizes the movement.](/images/com.apple.HIG/augmented-reality-coaching-overlay@2x.png)
...
![An illustration showing a cube and a hand with the index finger touching the cube. There's a curved line intersecting the finger and cube to indicate the movement of the finger to the right as it directly manipulates the object.](/images/com.apple.HIG/augmented-reality-user-interaction-direct~dark@2x.png)
![An illustration showing a cube. Below the cube are two buttons, each with a circular arrow pointing in the opposite direction, offering indirect ways to rotate the cube.](/images/com.apple.HIG/augmented-reality-user-interaction-indirect~dark@2x.png)
...
![An illustration of a cube. The base of the cube is indicated with a grid, and the active side of the cube is outlined in blue. Arrows follow a continuous circle around the cube to the right, hinting that the cube can be rotated within the 3D context.](/images/com.apple.HIG/augmented-reality-3d-hint~dark@2x.png)
![An illustration of a cube. The base of the cube is indicated with a grid, and underneath the cube is the word Rotate, hinting that the cube can be rotated within the 3D space.](/images/com.apple.HIG/augmented-reality-2d-hint~dark@2x.png)
...
![An illustration of an iPhone screen in landscape orientation showing the corner of a room viewed through the camera. In the room are two AR objects: a desk and a chair. Each object has a label attached to the object by a vertical line. The label in each object ends with a greater-than sign to indicate the label can be tapped for more information.](/images/com.apple.HIG/augmented-reality-labels@2x.png)
![An illustration of an iPhone screen in landscape orientation showing a full-screen view with the detailed information for a chair. On the left side of the screen is an image of the chair, in the middle is a vertical separator line, and on the right is the model number, price, and size of the chair.](/images/com.apple.HIG/augmented-reality-popover~dark@2x.png)

## Handling interruptions
ARKit can’t track device position and orientation during an interruption, such as when people briefly switch to another app or accept a phone call. After an interruption ends, previously placed virtual objects are likely to appear in the wrong real-world positions. When you support relocalization, ARKit attempts to restore those virtual objects to their original real-world positions using new information. For developer guidance, see [Managing Session Life Cycle and Tracking Quality](../arkit/managing-session-life-cycle-and-tracking-quality.md).
...
![An illustration of an iPhone screen showing the corner of a room viewed through the camera. On the screen is a translucent overlay containing the surface-detection indicator. The indicator is a white square with rounded corners projected into the 3D space. A small iPhone is shown scanning back and forth along the base of the square. A circle of dots trailing the iPhone emphasizes the movement.](/images/com.apple.HIG/augmented-reality-vertical-orientation@2x.png)
...
![An illustration showing a corner of a brightly lit office that contains a desk and chair.](/images/com.apple.HIG/augmented-reality-sufficient-lighting@2x.png)
![An illustration showing a corner of a dark office that contains a desk and chair.](/images/com.apple.HIG/augmented-reality-insufficient-lighting@2x.png)
...
![The AR glyph.](/images/com.apple.HIG/augmented-reality-glyph~dark@2x.png)
![A button containing the AR glyph and the text View in AR.](/images/com.apple.HIG/augmented-reality-glyph-button~dark@2x.png)
...
![An illustration that shows the AR glyph centered within a frame that represents the minimum clear space to leave around the glyph.](/images/com.apple.HIG/augmented-reality-glyph-minimum-clear-space~dark@2x.png)
...
![The AR badge with both the glyph and the text AR.](/images/com.apple.HIG/augmented-reality-badge-iconandtext~dark@2x.png)
![The glyph-only AR badge.](/images/com.apple.HIG/augmented-reality-badge-icon~dark@2x.png)
...
![An illustration of the AR badge with the AR glyph and text AR. A frame surrounds the badge to indicate leaving clear space around the badge.](/images/com.apple.HIG/augmented-reality-badge-iconandtext-clear~dark@2x.png)
![An illustration of the glyph-only AR badge. A frame surrounds the badge to indicate leaving clear space around the badge.](/images/com.apple.HIG/augmented-reality-badge-icon-clear~dark@2x.png)

## Platform considerations
*No additional considerations for iOS or iPadOS. Not supported in macOS, tvOS, or watchOS.*

### visionOS
With the wearer’s [visionOS](privacy.md#visionOS), you can use ARKit in your visionOS app to detect surfaces in a person’s surroundings, use a person’s hand and finger postions to inform your [Designing custom gestures in visionOS](gestures.md#Designing-custom-gestures-in-visionOS), support interactions that incorporate nearby physical objects into your [Immersive experiences](immersive-experiences.md), and more. For developer guidance, see [ARKit](../arkit.md).

[Video: visionos-augmented-reality-meteor.mp4](/videos/com.apple.HIG/visionos-augmented-reality-meteor.mp4)
...
---
*Source: [https://developer.apple.com/design/human-interface-guidelines/augmented-reality](https://developer.apple.com/design/human-interface-guidelines/augmented-reality)*
