...
![A sketch of the Apple logo, suggesting Sign in with Apple. The image is overlaid with rectangular and circular grid lines and is tinted blue to subtly reflect the blue in the original six-color Apple logo.](/images/com.apple.HIG/technologies-SIWA-intro~dark@2x.png)
...
![An illustration representing an order confirmation screen on iPhone. The screen includes buttons titled 'Create Account' and 'Sign up with Apple'.](/images/com.apple.HIG/create-account-after-purchase~dark@2x.png)
...
![An illustration of a button that includes the Apple logo and text that reads 'Sign in with Apple'.](/images/com.apple.HIG/apple-account-sign-in-with~dark@2x.png)
![An illustration of a button that includes the Apple logo and text that reads 'Sign up with Apple'.](/images/com.apple.HIG/apple-account-sign-up-with~dark@2x.png)
![An illustration of a button that includes the Apple logo and text that reads 'Continue with Apple'.](/images/com.apple.HIG/apple-account-continue-with~dark@2x.png)
...
![An illustration of a 'Sign in with Apple' button with 90-degree corners.](/images/com.apple.HIG/apple-account-minimum-corner-radii~dark@2x.png)
![An illustration of a 'Sign in with Apple' button with the default corner radius.](/images/com.apple.HIG/apple-account-default-corner-radii~dark@2x.png)
![An illustration of a 'Sign in with Apple' button with the maximum corner radius, which results in a capsule-like appearance.](/images/com.apple.HIG/apple-account-maximum-corner-radii~dark@2x.png)
...
![An illustration of a Sign in with Apple button, with callouts that indicate a button height of 44 points and a font size of 19 points.](/images/com.apple.HIG/left-aligned-correct-proportions-2~dark@2x.png)
![An illustration of a Sign in with Apple button, with callouts that indicate a button height of 56 points and a font size of 24 points.](/images/com.apple.HIG/left-aligned-correct-proportions-1~dark@2x.png)
...
![An illustration of a logo-only Sign in with Apple button. The button includes only the Apple logo, and the button has rounded corners.](/images/com.apple.HIG/siwa-logo-masked-rounded-rect~dark@2x.png)
![An illustration of a logo-only Sign in with Apple button. The button includes only the Apple logo, and the button has square corners.](/images/com.apple.HIG/siwa-logo-default~dark@2x.png)
![An illustration of a logo-only Sign in with Apple button. The button includes only the Apple logo, and the button is circular.](/images/com.apple.HIG/siwa-logo-masked-circle~dark@2x.png)
