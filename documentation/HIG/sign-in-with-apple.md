...
![An illustration representing an order confirmation screen on iPhone. The screen includes buttons titled 'Create Account' and 'Sign up with Apple'.](https://docs-assets.developer.apple.com/published/67f04b31384b7c34470f89e944aa458f/create-account-after-purchase~dark%402x.png)
...
## Displaying buttons
Apple provides several Sign in with Apple buttons you can use to let people set up an account and sign in. If necessary, you can create a custom button to offer Sign in with Apple; for guidelines, see [Creating a custom Sign in with Apple button](sign-in-with-apple.md#Creating-a-custom-Sign-in-with-Apple-button).
...
For developer guidance, see [ASAuthorizationAppleIDButton](../AuthenticationServices/ASAuthorizationAppleIDButton.md) (iOS, macOS, and tvOS), [WKInterfaceAuthorizationAppleIDButton](../WatchKit/WKInterfaceAuthorizationAppleIDButton.md) (watchOS), and [Displaying Sign in with Apple buttons on the web](../signinwithapple/displaying-sign-in-with-apple-buttons-on-the-web.md). You can also visit [Sign in with Apple button](https://appleid.apple.com/signinwithapple/button) to view and adjust live previews of web-based buttons and get the code.
...
![An illustration of a button that includes the Apple logo and text that reads 'Sign in with Apple'.](https://docs-assets.developer.apple.com/published/ff983a6979556232a1a192445cd2c8cf/apple-account-sign-in-with~dark%402x.png)
![An illustration of a button that includes the Apple logo and text that reads 'Sign up with Apple'.](https://docs-assets.developer.apple.com/published/2514cb498c22dbfadd560e49d7d58215/apple-account-sign-up-with~dark%402x.png)
![An illustration of a button that includes the Apple logo and text that reads 'Continue with Apple'.](https://docs-assets.developer.apple.com/published/46095697ef9bbc53b42f7cb200bfc136/apple-account-continue-with~dark%402x.png)
For watchOS, the system provides one title:  Sign in.
![An illustration of a button for watchOS, that includes the Apple logo and text that reads 'Sign in'.](https://docs-assets.developer.apple.com/published/73d80af02f29a937c2f5fc8018419328/apple-account-watch-44mm-no-background%402x.png)
...
![An illustration of a white button correctly positioned on a dark shaded background. The button includes the Apple logo and text that reads 'Sign in with Apple'.](https://docs-assets.developer.apple.com/published/0f4a3692961a427449133e6c8cd481d5/apple-account-white-yes%402x.png)
![A checkmark in a circle to indicate correct usage.](https://docs-assets.developer.apple.com/published/88662da92338267bb64cd2275c84e484/checkmark%402x.png)
![An illustration of a white button incorrectly positioned on a light shaded background. The button includes the Apple logo and text that reads 'Sign in with Apple'.](https://docs-assets.developer.apple.com/published/6b0e9bb693c3c1630caacb3df7ccdc96/apple-account-white-no%402x.png)
...
![An illustration of a white, outlined button correctly positioned on a light shaded background. The button includes the Apple logo and text that reads 'Sign in with Apple'.](https://docs-assets.developer.apple.com/published/44b0000f44f5356063b6db3a8c55e425/apple-account-outline-yes%402x.png)
![A checkmark in a circle to indicate correct usage.](https://docs-assets.developer.apple.com/published/88662da92338267bb64cd2275c84e484/checkmark%402x.png)
![An illustration of a white, outlined button incorrectly positioned on a dark shaded background. The button includes the Apple logo and text that reads 'Sign in with Apple'.](https://docs-assets.developer.apple.com/published/e7c9a63b2896498b32cc6d3cbb93eeda/apple-account-outline-no%402x.png)
![An X in a circle to indicate incorrect usage.](https://docs-assets.developer.apple.com/published/209f6f0fc8ad99d9bf59e12d82d06584/crossout%402x.png)
...
![An illustration of a black button correctly positioned on a light shaded background. The button includes the Apple logo and text that reads 'Sign in with Apple'.](https://docs-assets.developer.apple.com/published/1a92aa30e8e5c672f8d29c33a286bb07/apple-account-black-yes%402x.png)
![A checkmark in a circle to indicate correct usage.](https://docs-assets.developer.apple.com/published/88662da92338267bb64cd2275c84e484/checkmark%402x.png)
![An illustration of a black button incorrectly positioned on a dark shaded background. The button includes the Apple logo and text that reads 'Sign in with Apple'.](https://docs-assets.developer.apple.com/published/cdbb88914b83a16e21f9ff869a0ebfa9/apple-account-black-no%402x.png)
![An X in a circle to indicate incorrect usage.](https://docs-assets.developer.apple.com/published/209f6f0fc8ad99d9bf59e12d82d06584/crossout%402x.png)
...
![An illustration of a dark shaded button for watchOS on a black background, that includes the Apple logo and text that reads 'Sign in'.](https://docs-assets.developer.apple.com/published/882e15d46d9e971c7f4fcdbd616d100a/apple-account-watch-44mm%402x.png)

#### Button size and corner radius
**Adjust the corner radius to match the appearance of other buttons in your app.** By default, the Sign in with Apple button has rounded corners. In iOS, macOS, and the web, you can change the corner radius to produce a button with square corners or a capsule-shape button. For developer guidance, see [cornerRadius](../AuthenticationServices/ASAuthorizationAppleIDButton/cornerRadius.md) (iOS and macOS) and [Displaying Sign in with Apple buttons on the web](../signinwithapple/displaying-sign-in-with-apple-buttons-on-the-web.md).
![An illustration of a 'Sign in with Apple' button with 90-degree corners.](https://docs-assets.developer.apple.com/published/878de1eacc0000e27454577ff77be0bc/apple-account-minimum-corner-radii~dark%402x.png)
![An illustration of a 'Sign in with Apple' button with the default corner radius.](https://docs-assets.developer.apple.com/published/ff983a6979556232a1a192445cd2c8cf/apple-account-default-corner-radii~dark%402x.png)
![An illustration of a 'Sign in with Apple' button with the maximum corner radius, which results in a capsule-like appearance.](https://docs-assets.developer.apple.com/published/611f43df40ea2452e05b09a86a2c9366/apple-account-maximum-corner-radii~dark%402x.png)
...
![An illustration of a Sign in with Apple button, with callouts that indicate a button height of 44 points and a font size of 19 points.](https://docs-assets.developer.apple.com/published/3ec8e6aa6d8a6af13b4957585e5213f8/left-aligned-correct-proportions-2~dark%402x.png)
![An illustration of a Sign in with Apple button, with callouts that indicate a button height of 56 points and a font size of 24 points.](https://docs-assets.developer.apple.com/published/3f75d55f34beb6e56f077c114c577376/left-aligned-correct-proportions-1~dark%402x.png)
...
![An illustration of a logo-only Sign in with Apple button. The button includes only the Apple logo, and the button has rounded corners.](https://docs-assets.developer.apple.com/published/1c94f65701ca1c93dd22de5106653ae2/siwa-logo-masked-rounded-rect~dark%402x.png)
![An illustration of a logo-only Sign in with Apple button. The button includes only the Apple logo, and the button has square corners.](https://docs-assets.developer.apple.com/published/96b45d8eb6d836e511ab9fb97a14ab56/siwa-logo-default~dark%402x.png)
![An illustration of a logo-only Sign in with Apple button. The button includes only the Apple logo, and the button is circular.](https://docs-assets.developer.apple.com/published/fe4b994b035047e4d03359b600cac725/siwa-logo-masked-circle~dark%402x.png)
...
[Authentication Services](../AuthenticationServices.md)
[Displaying Sign in with Apple buttons on the web](../signinwithapple/displaying-sign-in-with-apple-buttons-on-the-web.md) — Sign in with Apple
...
---
*Source: [https://developer.apple.com/design/human-interface-guidelines/sign-in-with-apple](https://developer.apple.com/design/human-interface-guidelines/sign-in-with-apple)*
