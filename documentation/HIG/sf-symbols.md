...
![A sketch of the SF Symbols icon. The image is overlaid with rectangular and circular grid lines and is tinted yellow to subtly reflect the yellow in the original six-color Apple logo.](/images/com.apple.HIG/foundations-sf-symbols-intro~dark@2x.png)
...
![An image of the cloud sun rain fill symbol. The cloud is black and the raindrops and sun are gray to indicate that the cloud is in the primary layer.](/images/com.apple.HIG/sf-three-layers-primary~dark@2x.png)
...
![An image of the cloud sun rain fill symbol. The raindrops are black and the sun and cloud are gray to indicate that the raindrops are in the primary layer.](/images/com.apple.HIG/sf-three-layers-tertiary~dark@2x.png)
...
![An image of the cloud sun rain fill symbol that uses three different opacities of the system blue color in the symbol’s three different layers: the cloud is fully opaque, the sun is about 50% opaque, and the raindrops are about 25% opaque.](/images/com.apple.HIG/sf-three-layers-color~dark@2x.png)
...
![The sun symbol with a solid yellow fill.](/images/com.apple.HIG/sf-symbols-sun-solid-fill~dark@2x.png)
...
![A diagram showing the first of three images of the plus circle symbol followed by the capitalized word add. In each image, the word uses the same size, but the symbol uses a different size. The symbol size is small in this image. Two parallel horizontal lines appear across all three images. The top line shows the height of the capital letter A and the bottom line is the baseline under the word add. In this small symbol, the circle touches both lines.](/images/com.apple.HIG/sf-symbol-scale-small~dark@2x.png)
![The second of three images of the plus circle symbol followed by the capitalized word add. In this medium symbol, the circle extends slightly above and below the lines.](/images/com.apple.HIG/sf-symbol-scale-medium~dark@2x.png)
![The third of three images of the plus circle symbol followed by the capitalized word add. In this large symbol, the vertical line of the plus sign almost touches both lines.](/images/com.apple.HIG/sf-symbol-scale-large~dark@2x.png)
...
[Video: sf-animation-appear.mp4](/videos/com.apple.HIG/sf-animation-appear~dark.mp4)
**Disappear** — Causes a symbol to gradually recede out of view.

[Video: sf-animation-disappear.mp4](/videos/com.apple.HIG/sf-animation-disappear~dark.mp4)
...
[Video: sf-animation-bounce.mp4](/videos/com.apple.HIG/sf-animation-bounce~dark.mp4)
...
[Video: sf-animation-scale.mp4](/videos/com.apple.HIG/sf-animation-scale~dark.mp4)
...
[Video: sf-animation-pulse.mp4](/videos/com.apple.HIG/sf-animation-pulse~dark.mp4)
...
[Video: sf-animation-variable-color.mp4](/videos/com.apple.HIG/sf-animation-variable-color~dark.mp4)
...
[Video: sf-animation-replace.mp4](/videos/com.apple.HIG/sf-animation-replace~dark.mp4)
...
[Video: sf-animation-magic-replace.mp4](/videos/com.apple.HIG/sf-animation-magic-replace~dark.mp4)
...
[Video: sf-animation-wiggle.mp4](/videos/com.apple.HIG/sf-animation-wiggle~dark.mp4)
...
[Video: sf-animation-breathe.mp4](/videos/com.apple.HIG/sf-animation-breathe~dark.mp4)
...
[Video: sf-animation-rotate.mp4](/videos/com.apple.HIG/sf-animation-rotate~dark.mp4)
