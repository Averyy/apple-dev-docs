...
| --- | --- |
| ![An illustration of a Verify Age button.](https://docs-assets.developer.apple.com/published/074a189ca7369ae6929d6fde7c3b05c6/id-verifier-button-age~dark%402x.png) | An app that checks whether people are old enough to attend an event or access a venue, like a concert hall. |
| ![An illustration of a Verify Identity button.](https://docs-assets.developer.apple.com/published/dcbe798ce9ce34869b1564abb4f2931c/id-verifier-button-identity~dark%402x.png) | An app that verifies whether specific identity information matches expected values, such as name and birth date when picking up a rental car. |
...
[Identity verification](wallet.md#Identity-verification)

#### Developer documentation
[Adopting the Verifier API in your iPhone app](../ProximityReader/adopting-the-verifier-api-in-your-iphone-app.md) — ProximityReader
...
---
*Source: [https://developer.apple.com/design/human-interface-guidelines/id-verifier](https://developer.apple.com/design/human-interface-guidelines/id-verifier)*
