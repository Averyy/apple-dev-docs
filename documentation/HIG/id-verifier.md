...
| --- | --- |
| ![An illustration of a Verify Age button.](/images/com.apple.HIG/id-verifier-button-age~dark@2x.png) | An app that checks whether people are old enough to attend an event or access a venue, like a concert hall. |
| ![An illustration of a Verify Identity button.](/images/com.apple.HIG/id-verifier-button-identity~dark@2x.png) | An app that verifies whether specific identity information matches expected values, such as name and birth date when picking up a rental car. |
