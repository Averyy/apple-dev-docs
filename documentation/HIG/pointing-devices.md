...
> **Updated 2023-06-21:** Updated to include guidance for visionOS.

People can use a pointing device like a trackpad or mouse to navigate the interface and initiate actions.

![A sketch of an arrow-shaped pointer, suggesting use of a mouse or trackpad. The image is overlaid with rectangular and circular grid lines and is tinted purple to subtly reflect the purple in the original six-color Apple logo.](/images/com.apple.HIG/inputs-pointing-devices-intro~dark@2x.png)
...
[Video: text-entry-pointer.mp4](/videos/com.apple.HIG/text-entry-pointer.mp4)
...
[Video: highlight-content-effect.mp4](/videos/com.apple.HIG/highlight-content-effect.mp4)
...
[Video: lift-content-effect-home-screen.mp4](/videos/com.apple.HIG/lift-content-effect-home-screen.mp4)
...
[Video: hover-content-effect-calendar-popover.mp4](/videos/com.apple.HIG/hover-content-effect-calendar-popover.mp4)
...
Unlike pointer shapes and content effects, accessories are secondary items that can combine with any pointer to communicate additional information. For developer guidance, see [UIPointerAccessory](../uikit/uipointeraccessory.md).
...
[Video: magnetics-clock.mp4](/videos/com.apple.HIG/magnetics-clock.mp4)
...
- Use hover for large elements and customize the scale, tint, and shadow attributes as needed (for guidance, see [Customizing pointers](pointing-devices.md#Customizing-pointers)).
...
| --- | --- | --- | --- |
| ![A pointer that resembles a diagonal arrow pointing up and to the left.](/images/com.apple.HIG/pointers-arrow@2x.png) | Arrow | Standard pointer for selecting and interacting with content and interface elements. | [arrow](../appkit/nscursor/arrow.md) |
| ![A closed, gloved hand.](/images/com.apple.HIG/pointers-closed-hand~dark@2x.png) | Closed hand | Dragging to reposition the display of content within a view—for example, dragging a map around in Maps. | [closedHand](../appkit/nscursor/closedhand.md) |
| ![A pointer arrow with a small menu-like square to the right of the arrow.](/images/com.apple.HIG/pointers-contextual-menu@2x.png) | Contextual menu | A contextual menu is available for the content below the pointer. This pointer is generally shown only when the Control key is pressed. | [contextualMenu](../appkit/nscursor/contextualmenu.md) |
| ![A plus symbol.](/images/com.apple.HIG/pointers-crosshair@2x.png) | Crosshair | Precise rectangular selection is possible, such as when viewing an image in Preview. | [crosshair](../appkit/nscursor/crosshair.md) |
| ![A small pointer arrowhead with a circle underneath; the circle contains an Ex.](/images/com.apple.HIG/pointers-disappearing-item@2x.png) | Disappearing item | A dragged item will disappear when dropped. If the item references an original item, the original is unaffected. For example, when dragging a mailbox out of the favorites bar in Mail, the original mailbox isn’t removed. | [disappearingItem](../appkit/nscursor/disappearingitem.md) |
| ![A small pointer arrowhead with a circle underneath; the circle contains a plus symbol.](/images/com.apple.HIG/pointers-drag-copy@2x.png) | Drag copy | Duplicates a dragged—not moved—item when dropped into the destination. Appears when pressing the Option key during a drag operation. | [dragCopy](../appkit/nscursor/dragcopy.md) |
...
| ![Opposing veritcal braces, used to form an insertion marker.](/images/com.apple.HIG/pointers-horizontal-beam@2x.png) | Horizontal I beam | Selection and insertion of text is possible in a horizontal layout, such as a TextEdit or Pages document. | [iBeam](../appkit/nscursor/ibeam.md) |
| ![An open, gloved hand.](/images/com.apple.HIG/pointers-open-hand~dark@2x.png) | Open hand | Dragging to reposition content within a view is possible. | [openHand](../appkit/nscursor/openhand.md) |
| ![A small pointer arrowhead with a do not enter symbol underneath.](/images/com.apple.HIG/pointers-operation-not-allowed@2x.png) | Operation not allowed | A dragged item can’t be dropped in the current location. | [operationNotAllowed](../appkit/nscursor/operationnotallowed.md) |
| ![A gloved hand, with the index finger extended.](/images/com.apple.HIG/pointers-pointing-hand~dark@2x.png) | Pointing hand | The content beneath the pointer is a URL link to a webpage, document, or other item. | [pointingHand](../appkit/nscursor/pointinghand.md) |
| ![A horizontal bar with a downward-pointing arrow at its midpoint.](/images/com.apple.HIG/pointers-resize-down@2x.png) | Resize down | Resize or move a window, view, or element downward. | [resizeDown](../appkit/nscursor/resizedown.md) |
| ![A vertical bar with a left-pointing arrow at its midpoint.](/images/com.apple.HIG/pointers-resize-left@2x.png) | Resize left | Resize or move a window, view, or element to the left. | [resizeLeft](../appkit/nscursor/resizeleft.md) |
| ![A vertical bar with left- and right-pointing arrows extending from its midpoint.](/images/com.apple.HIG/pointers-resize-left-right@2x.png) | Resize left/right | Resize or move a window, view, or element to the left or right. | [resizeLeftRight](../appkit/nscursor/resizeleftright.md) |
| ![A vertical bar with a right-pointing arrow at its midpoint.](/images/com.apple.HIG/pointers-resize-right@2x.png) | Resize right | Resize or move a window, view, or element to the right. | [resizeRight](../appkit/nscursor/resizeright.md) |
| ![A horizontal bar with an up-pointing arrow at its midpoint.](/images/com.apple.HIG/pointers-resize-up@2x.png) | Resize up | Resize or move a window, view, or element upward. | [resizeUp](../appkit/nscursor/resizeup.md) |
| ![A horizontal bar with up- and down-pointing arrows extending from its midpoint.](/images/com.apple.HIG/pointers-resize-up-down@2x.png) | Resize up/down | Resize or move a window, view, or element upward or downward. | [resizeUpDown](../appkit/nscursor/resizeupdown.md) |
| ![Opposing horizontal braces, used to form an insertion marker.](/images/com.apple.HIG/pointers-vertical-beam@2x.png) | Vertical I beam | Selection and insertion of text is possible in a vertical layout. | [iBeamCursorForVerticalLayout](../appkit/nscursor/ibeamcursorforverticallayout.md) |
...
[Video: visionos-trackpad-pointer-input.mp4](/videos/com.apple.HIG/visionos-trackpad-pointer-input.mp4)
...
[Pointer interactions](../uikit/pointer-interactions.md) — UIKit
