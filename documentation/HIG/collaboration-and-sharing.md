...
![An illustration of a Notes document on iPhone. The document toolbar prominently features the Share button next to the More button.](/images/com.apple.HIG/collaboration-share-button~dark@2x.png)
...
![An illustration of a Notes document with the share sheet open on iPhone, with collaboration options set to indicate that only invited people can edit the selected document.](/images/com.apple.HIG/collaboration-sharing-permission-invited~dark@2x.png)
