...
![A sketch of the Accessibility icon. The image is overlaid with rectangular and circular grid lines and is tinted yellow to subtly reflect the yellow in the original six-color Apple logo.](/images/com.apple.HIG/foundations-accessibility-intro~dark@2x.png)
...
## Vision
![An illustration containing five symbols associated with the topic of vision, including symbols representing text size, magnification, VoiceOver, and spoken dialogue.](/images/com.apple.HIG/accessibility-vision-section-hero~dark@2x.png)
...
![An illustration of a rectangular view containing the word 'Hello,' formatted thin, at a large font size.](/images/com.apple.HIG/accessibility-font-weight-large-thin~dark@2x.png)
...
![An illustration of a button that has sufficient contrast between the button's title and background.](/images/com.apple.HIG/accessibilty-button-good-color-contrast~dark@2x.png)
...
![An illustration of a green circle to the left of a red circle.](/images/com.apple.HIG/accessibility-differentiate-with-shapes-incorrect~dark@2x.png)
![An X in a circle to indicate incorrect usage.](/images/com.apple.HIG/crossout@2x.png)
![An illustration of a green circle containing a checkmark to the left of a red octagon containing an X.](/images/com.apple.HIG/accessibility-differentiate-with-shapes-correct~dark@2x.png)
![A checkmark in a circle to indicate correct usage.](/images/com.apple.HIG/checkmark@2x.png)
...
## Mobility
![An illustration containing five symbols associated with the topic of mobility, including symbols representing the keyboard, movement, and touch.](/images/com.apple.HIG/accessibility-mobility-section-hero~dark@2x.png)
...
![An illustration showing three buttons: rewind, play, and fast forward. The buttons have insufficient padding between them.](/images/com.apple.HIG/accessibility-controls-spacing-incorrect~dark@2x.png)
![An X in a circle to indicate incorrect usage.](/images/com.apple.HIG/crossout@2x.png)
...
## Speech
![An illustration containing five symbols associated with the topic of speech, including symbols representing waveforms and speech.](/images/com.apple.HIG/accessibility-speech-section-hero~dark@2x.png)
