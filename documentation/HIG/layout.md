...
> **Updated 2025-09-09:** Added specifications for iPhone 17, iPhone Air, iPhone 17 Pro, iPhone 17 Pro Max, Apple Watch SE 3, Apple Watch Series 11, and Apple Watch Ultra 3.
...
**Place items to convey their relative importance.** People often start by viewing items in reading order — that is, from top to bottom and from the leading to trailing side — so it generally works well to place the most important items near the top and leading side of the window, display, or [Field of view](spatial-layout.md#Field-of-view). Be aware that reading order varies by language, and take [Right to left](right-to-left.md) languages into account as you design.
...
**Avoid displaying content within the camera housing at the top edge of the window.** For developer guidance, see [NSPrefersDisplaySafeAreaCompatibilityMode](../BundleResources/Information-Property-List/NSPrefersDisplaySafeAreaCompatibilityMode.md).
...
![An illustration of a TV with a safe zone border on all sides. In width, the top and bottom borders measure 60 points, and the side borders both measure 80 points.](https://docs-assets.developer.apple.com/published/085346e3d10a0ce1df781337fcf0abbe/visual-design-safe-zone~dark%402x.png)
...
![An illustration that uses vertical shaded rectangles to show padding between focusable items.](https://docs-assets.developer.apple.com/published/88718ab62fbb723782964f30e381dea8/visual-design-padding~dark%402x.png)
...
**If you need to display additional controls that don’t belong within a window, use an ornament.** An ornament lets you offer app controls that remain visually associated with a window without interfering with the system-provided controls. For example, a window’s toolbar and tab bar appear as ornaments. For guidance, see [Ornaments](ornaments.md).
...
![An illustration of the Workout app’s main list of workouts on Apple Watch. A callout indicates that the currently focused workout item spans the full width of the available screen area.](https://docs-assets.developer.apple.com/published/54c5664a772608961743bd095889e6f5/layout-full-width~dark%402x.png)
...
> **Note:** All scale factors in the table above are UIKit scale factors, which may differ from native scale factors. For developer guidance, see [scale](../UIKit/UIScreen/scale.md) and [nativeScale](../UIKit/UIScreen/nativeScale.md).

### iOS, iPadOS device size classes
A size class is a value that’s either regular or compact, where *regular* refers to a larger screen or a screen in landscape orientation and *compact* refers to a smaller screen or a screen in portrait orientation. For developer guidance, see [UserInterfaceSizeClass](../SwiftUI/UserInterfaceSizeClass.md).
