...
- `qop_req`: The quality of protection requested for the encryption. See Quality of Protection Constants in   for valid values.
...
*[View on Apple Developer](https://developer.apple.com/documentation/gss/gss_wrap(_:_:_:_:_:_:_:))*