...
```swift
#define GSS_KRB5_EXTRACT_AUTHZ_DATA_FROM_SEC_CONTEXT_X
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/gss/gss_krb5_extract_authz_data_from_sec_context_x)*