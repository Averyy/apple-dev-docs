...
### Instance Properties
- [var count: Int](gss_buffer_set_desc_struct/count.md)
  The number of buffer descriptors in the array.
- [var elements: UnsafeMutablePointer<gss_buffer_desc>!](gss_buffer_set_desc_struct/elements.md)
  A pointer to an array of buffer descriptors.
### Initialization
- [init()](gss_buffer_set_desc_struct/init.md)
  Initialize a new, empty buffer set.
- [init(count: Int, elements: UnsafeMutablePointer<gss_buffer_desc>!)](gss_buffer_set_desc_struct/init(count:elements:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/gss/gss_buffer_set_desc_struct)*