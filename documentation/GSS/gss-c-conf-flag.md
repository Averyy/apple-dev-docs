...
When set, you can use the [`gss_wrap(_:_:_:_:_:_:_:)`](gss_wrap(_:_:_:_:_:_:_:).md) and [`gss_unwrap(_:_:_:_:_:_:)`](gss_unwrap(_:_:_:_:_:_:).md) functions to encrypt and decrypt the data transferred. When the flag is not set, you can perform your own data level encryption, but the GSS-API does not provide this service.
...
*[View on Apple Developer](https://developer.apple.com/documentation/gss/gss_c_conf_flag)*