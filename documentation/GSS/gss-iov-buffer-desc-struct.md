...
### Instance Properties
- [var buffer: gss_buffer_desc](gss_iov_buffer_desc_struct/buffer.md)
  The buffer length and contents.
- [var type: OM_uint32](gss_iov_buffer_desc_struct/type.md)
  The buffer type.
### Initialization
- [init()](gss_iov_buffer_desc_struct/init.md)
  Initialize a new, empty IOV buffer structure.
- [init(type: OM_uint32, buffer: gss_buffer_desc)](gss_iov_buffer_desc_struct/init(type:buffer:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/gss/gss_iov_buffer_desc_struct)*