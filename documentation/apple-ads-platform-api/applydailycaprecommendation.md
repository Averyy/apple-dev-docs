...
`ApplyDailyCapRecommendation` is the request body for applying or dismissing a daily budget recommendation.
...
*[View on Apple Developer](https://developer.apple.com/documentation/apple-ads-platform-api/applydailycaprecommendation)*