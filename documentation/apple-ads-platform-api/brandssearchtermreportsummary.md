...
```swift
object BrandsSearchTermReportSummary
```

## Properties

- `grandTotal` (BrandsMetrics): See [`BrandsMetrics`](brandsmetrics.md) for details.
...
*[View on Apple Developer](https://developer.apple.com/documentation/apple-ads-platform-api/brandssearchtermreportsummary)*