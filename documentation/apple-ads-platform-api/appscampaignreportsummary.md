...
```swift
object AppsCampaignReportSummary
```

## Properties

- `grandTotal` (AppsCampaignMetrics): See [`AppsCampaignMetrics`](appscampaignmetrics.md) for details.
...
*[View on Apple Developer](https://developer.apple.com/documentation/apple-ads-platform-api/appscampaignreportsummary)*