...
`AppsCampaignMetrics` extends [`AppsMetrics`](appsmetrics.md) with no additional fields. It is the metrics object embedded in APPS campaign report rows.
...
*[View on Apple Developer](https://developer.apple.com/documentation/apple-ads-platform-api/appscampaignmetrics)*