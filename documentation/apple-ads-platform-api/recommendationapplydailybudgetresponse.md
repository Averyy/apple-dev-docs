...
`RecommendationApplyDailyBudgetResponse` is the top-level response body for `POST /recommendations/daily-budgets/apply`.
...
*[View on Apple Developer](https://developer.apple.com/documentation/apple-ads-platform-api/recommendationapplydailybudgetresponse)*