...
```swift
object BrandsCampaignResultContainer
```

## Properties

- `rows` ([BrandsCampaignReportRow]): The array of campaign report rows. See [`BrandsCampaignReportRow`](brandscampaignreportrow.md) for details.
- `summary` (BrandsCampaignReportSummary): See [`BrandsCampaignReportSummary`](brandscampaignreportsummary.md) for details.
...
*[View on Apple Developer](https://developer.apple.com/documentation/apple-ads-platform-api/brandscampaignresultcontainer)*