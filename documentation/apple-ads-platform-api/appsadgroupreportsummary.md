...
```swift
object AppsAdGroupReportSummary
```

## Properties

- `grandTotal` (AppsAdGroupMetrics): See [`AppsAdGroupMetrics`](appsadgroupmetrics.md) for details.
...
*[View on Apple Developer](https://developer.apple.com/documentation/apple-ads-platform-api/appsadgroupreportsummary)*