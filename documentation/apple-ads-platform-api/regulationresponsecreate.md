...
```swift
object RegulationResponseCreate
```

## Topics

### Type Aliases
- [type RegulationResponseCreate.RegulationType](regulationresponsecreate/regulationtype-data.typealias.md)
  The category of regulatory disclosure being answered.
- [type RegulationResponseCreate.ResponseValue](regulationresponsecreate/responsevalue-data.typealias.md)
  The advertiser’s answer to the regulatory disclosure question.

## Properties

- `regulationType` (RegulationResponseCreate.RegulationType): The category of regulatory disclosure being answered. See [`RegulationResponseCreate.RegulationType`](regulationresponsecreate/regulationtype-data.typealias.md). Not nullable.
- `responseValue` (RegulationResponseCreate.ResponseValue): The advertiser’s answer to the regulatory disclosure question. See [`RegulationResponseCreate.ResponseValue`](regulationresponsecreate/responsevalue-data.typealias.md). Not nullable.
...
*[View on Apple Developer](https://developer.apple.com/documentation/apple-ads-platform-api/regulationresponsecreate)*