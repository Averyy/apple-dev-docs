...
```swift
object BrandsKeywordReportSummary
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/apple-ads-platform-api/brandskeywordreportsummary)*