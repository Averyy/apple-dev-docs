...
```swift
object AppsCampaignResultContainer
```

## Properties

- `rows` ([AppsCampaignReportRow]): The array of campaign report rows. See [`AppsCampaignReportRow`](appscampaignreportrow.md) for details.
- `summary` (AppsCampaignReportSummary): See [`AppsCampaignReportSummary`](appscampaignreportsummary.md) for details.
...
*[View on Apple Developer](https://developer.apple.com/documentation/apple-ads-platform-api/appscampaignresultcontainer)*