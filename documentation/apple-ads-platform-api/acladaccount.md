...
- `id` (int64): The unique identifier for the ad account.
- `name` (string): The name of the ad account.
- `orgId` (int64): The organization ID the ad account belongs to.
...
*[View on Apple Developer](https://developer.apple.com/documentation/apple-ads-platform-api/acladaccount)*