...
```swift
object BrandsKeywordResultContainer
```

## Properties

- `rows` ([BrandsKeywordReportRow]): The array of keyword report rows. See [`BrandsKeywordReportRow`](brandskeywordreportrow.md) for details.
- `summary` (BrandsKeywordReportSummary): See [`BrandsKeywordReportSummary`](brandskeywordreportsummary.md) for details.
...
*[View on Apple Developer](https://developer.apple.com/documentation/apple-ads-platform-api/brandskeywordresultcontainer)*