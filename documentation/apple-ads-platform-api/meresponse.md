...
- `result` (Me): The authenticated user’s identity information. See [`Me`](me.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/apple-ads-platform-api/meresponse)*