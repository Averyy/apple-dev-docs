...
### Type Aliases
- [type BulkNegativeKeywordUpdate.Status](bulknegativekeywordupdate/status-data.typealias.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/apple-ads-platform-api/bulknegativekeywordupdate)*