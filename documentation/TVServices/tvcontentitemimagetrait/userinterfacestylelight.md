...
Specify this constant, or the [`userInterfaceStyleDark`](tvcontentitemimagetrait/userinterfacestyledark.md) constant, but not both.
...
*[View on Apple Developer](https://developer.apple.com/documentation/tvservices/tvcontentitemimagetrait/userinterfacestylelight)*