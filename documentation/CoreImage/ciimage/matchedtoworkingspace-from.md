...
- `colorSpace`: The color space to be converted from. This color space must conform to the [`CGColorSpaceModel.rgb`](https://developer.apple.com/documentation/coregraphics/cgcolorspacemodel/rgb) color space model.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/ciimage/matchedtoworkingspace(from:))*