# init(portaitEffectsMatte:options:)
...
```swift
init?(portaitEffectsMatte matte: AVPortraitEffectsMatte, options: [CIImageOption : Any]? = nil)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/ciimage/init(portaiteffectsmatte:options:))*