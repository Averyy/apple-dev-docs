# init(semanticSegmentationMatte:options:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/ciimage/init(semanticsegmentationmatte:options:))*