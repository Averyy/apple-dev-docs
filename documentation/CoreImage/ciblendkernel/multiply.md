...
![The result of using the multiply blend kernel (background image is top left, foreground image is bottom left)](/images/com.apple.coreimage/media-2926879@2x.png)
