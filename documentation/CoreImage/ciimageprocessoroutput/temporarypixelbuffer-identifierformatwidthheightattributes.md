# temporaryPixelBuffer(identifier:format:width:height:attributes:)
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/ciimageprocessoroutput/temporarypixelbuffer(identifier:format:width:height:attributes:))*