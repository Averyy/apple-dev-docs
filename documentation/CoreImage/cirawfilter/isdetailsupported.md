...
If this value is `true`, you can adjust the amount of detail enhancement to apply to the image by setting [`detailAmount`](cirawfilter/detailamount.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/cirawfilter/isdetailsupported)*