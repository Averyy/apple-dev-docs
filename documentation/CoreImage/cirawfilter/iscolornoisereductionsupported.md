...
If this value is `true`, you can adjust the amount of color noise reduction to apply to the image by setting [`colorNoiseReductionAmount`](cirawfilter/colornoisereductionamount.md).
