...
If this value is `true`, you can adjust the amount of moire artifact reduction to apply to the image by setting [`moireReductionAmount`](cirawfilter/moirereductionamount.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/cirawfilter/ismoirereductionsupported)*