...
If this value is `true`, you can adjust the amount of luminance noise reduction to apply to the image by setting [`luminanceNoiseReductionAmount`](cirawfilter/luminancenoisereductionamount.md).
