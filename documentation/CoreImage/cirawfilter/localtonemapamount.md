...
> **Note**:  The [`isLocalToneMapSupported`](cirawfilter/islocaltonemapsupported.md) property is [`false`](https://developer.apple.com/documentation/Swift/false) if the current image doesn’t support this adjustment.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/cirawfilter/localtonemapamount)*