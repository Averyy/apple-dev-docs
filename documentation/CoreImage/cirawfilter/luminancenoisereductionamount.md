...
> **Note**:  The [`isLuminanceNoiseReductionSupported`](cirawfilter/isluminancenoisereductionsupported.md) property is `false` if the current image doesn’t support this adjustment.
