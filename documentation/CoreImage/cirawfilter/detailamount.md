...
> **Note**:  A value of `false` for [`isDetailSupported`](cirawfilter/isdetailsupported.md) indicates that the current image doesn’t support this adjustment.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreimage/cirawfilter/detailamount)*