...
If the next billing period includes an offer specified by the [`offerIdentifier`](https://developer.apple.com/documentation/AppStoreServerNotifications/offerIdentifier), the [`renewalPrice`](renewalprice.md) value reflects the discount.
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreserverapi/renewalprice)*