...
For valid `lifetimeDollarsRefunded` values in a [`ConsumptionRequest`](consumptionrequest.md), see [`lifetimeDollarsRefunded`](lifetimedollarsrefunded.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreserverapi/invalidlifetimedollarsrefundederror)*