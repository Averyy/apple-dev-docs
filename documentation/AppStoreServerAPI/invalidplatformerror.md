...
For valid `platform` values in a [`ConsumptionRequest`](consumptionrequest.md), see [`platform`](platform.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreserverapi/invalidplatformerror)*