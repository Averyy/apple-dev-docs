...
For valid `userStatus` values in a [`ConsumptionRequest`](consumptionrequest.md), see [`userStatus`](userstatus.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreserverapi/invaliduserstatuserror)*