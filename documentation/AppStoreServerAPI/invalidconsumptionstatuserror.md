...
For more information about the `consumptionStatus` field in a [`ConsumptionRequest`](consumptionrequest.md), see [`consumptionStatus`](consumptionstatus.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/appstoreserverapi/invalidconsumptionstatuserror)*