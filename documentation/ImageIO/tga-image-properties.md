...
### Dictionary Key
- [let kCGImagePropertyTGADictionary: CFString](kcgimagepropertytgadictionary.md)
### Compression
- [let kCGImagePropertyTGACompression: CFString](kcgimagepropertytgacompression.md)
- [enum CGImagePropertyTGACompression](cgimagepropertytgacompression.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/imageio/tga-image-properties)*