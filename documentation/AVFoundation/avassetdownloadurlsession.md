...
> ❗ **Important**: The standard doc://com.apple.documentation/documentation/foundation/nsurlsession initializers and task-creation methods are unavailable on this class. Use [`init(configuration:assetDownloadDelegate:delegateQueue:)`](avassetdownloadurlsession/init(configuration:assetdownloaddelegate:delegatequeue:).md) to create a session and [`makeAssetDownloadTask(downloadConfiguration:)`](avassetdownloadurlsession/makeassetdownloadtask(downloadconfiguration:).md) to create download tasks.
