...
Apple discourages using this method in iOS 15, tvOS 15, macOS 12, and watchOS 8 or later. Load a track asynchronously using [`loadTrack(withTrackID:completionHandler:)`](avmovie/loadtrack(withtrackid:completionhandler:).md) instead.
...
*[View on Apple Developer](https://developer.apple.com/documentation/avfoundation/avmovie/track(withtrackid:))*