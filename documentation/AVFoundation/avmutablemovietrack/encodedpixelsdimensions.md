...
```swift
var encodedPixelsDimensions: CGSize { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/avfoundation/avmutablemovietrack/encodedpixelsdimensions)*