...
```swift
var sourceSampleDataTrackIDs: [CMPersistentTrackID] { get set }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/avfoundation/avvideocomposition/configuration/sourcesampledatatrackids)*