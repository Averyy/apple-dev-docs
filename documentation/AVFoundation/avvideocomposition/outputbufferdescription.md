...
```swift
func outputBufferDescription() -> [[CMTag]]?
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/avfoundation/avvideocomposition/outputbufferdescription())*