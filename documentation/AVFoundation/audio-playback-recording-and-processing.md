...
- [class AVAudioPlayer](../AVFAudio/AVAudioPlayer.md)
  An object that plays audio data from a file or buffer.
- [class AVAudioRecorder](../AVFAudio/AVAudioRecorder.md)
  An object that records audio data to a file.
- [class AVMIDIPlayer](../AVFAudio/AVMIDIPlayer.md)
  An object that plays MIDI data through a system sound module.
### Advanced audio processing
- [Audio Engine](../AVFAudio/audio-engine.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/avfoundation/audio-playback-recording-and-processing)*