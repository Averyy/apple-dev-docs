...
```swift
@nonobjc
func setActionQueue(_ actionQueue: DispatchQueue, action: @escaping (Int) -> ())
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/avfoundation/avcaptureindexpicker/setactionqueue(_:action:))*