...
```swift
@nonobjc
func setFontStyle(_ fontStyle: AVCaption.FontStyle, in range: NSRange)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/avfoundation/avmutablecaption/setfontstyle(_:in:))*