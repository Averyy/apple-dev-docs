...
### Initializers
- [init?(rawValue: Int)](avcapturedevice/lensstabilizationstatus/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/avfoundation/avcapturedevice/lensstabilizationstatus)*