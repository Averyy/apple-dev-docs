...
```swift
static let ratio4x3: AVCaptureDevice.AspectRatio
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/avfoundation/avcapturedevice/aspectratio/ratio4x3)*