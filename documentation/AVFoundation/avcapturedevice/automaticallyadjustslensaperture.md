...
```swift
var automaticallyAdjustsLensAperture: Bool { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/avfoundation/avcapturedevice/automaticallyadjustslensaperture)*