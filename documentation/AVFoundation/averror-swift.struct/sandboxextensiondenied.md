...
```swift
static var sandboxExtensionDenied: AVError.Code { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/avfoundation/averror-swift.struct/sandboxextensiondenied)*