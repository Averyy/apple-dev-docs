...
### Initializers
- [init(String)](avfiletype/init(_:).md)
...
- [struct AVFileTypeProfile](avfiletypeprofile.md)
  File type profiles for streaming formats.


---

*[View on Apple Developer](https://developer.apple.com/documentation/avfoundation/avfiletype)*