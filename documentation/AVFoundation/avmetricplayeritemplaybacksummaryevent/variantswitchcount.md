...
```swift
var variantSwitchCount: Int { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/avfoundation/avmetricplayeritemplaybacksummaryevent/variantswitchcount)*