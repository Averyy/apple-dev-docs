# quickTimeMetadataKeyCinematicVideoIntent
...
```swift
static let quickTimeMetadataKeyCinematicVideoIntent: AVMetadataKey
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/avfoundation/avmetadatakey/quicktimemetadatakeycinematicvideointent)*