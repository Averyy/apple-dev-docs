# quickTimeMetadataKeyCameraShutterSpeedAngle
...
```swift
static let quickTimeMetadataKeyCameraShutterSpeedAngle: AVMetadataKey
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/avfoundation/avmetadatakey/quicktimemetadatakeycamerashutterspeedangle)*