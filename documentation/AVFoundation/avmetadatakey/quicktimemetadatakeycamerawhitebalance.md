# quickTimeMetadataKeyCameraWhiteBalance
...
```swift
static let quickTimeMetadataKeyCameraWhiteBalance: AVMetadataKey
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/avfoundation/avmetadatakey/quicktimemetadatakeycamerawhitebalance)*