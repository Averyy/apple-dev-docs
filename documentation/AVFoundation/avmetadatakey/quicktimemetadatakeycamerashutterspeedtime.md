# quickTimeMetadataKeyCameraShutterSpeedTime
...
```swift
static let quickTimeMetadataKeyCameraShutterSpeedTime: AVMetadataKey
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/avfoundation/avmetadatakey/quicktimemetadatakeycamerashutterspeedtime)*