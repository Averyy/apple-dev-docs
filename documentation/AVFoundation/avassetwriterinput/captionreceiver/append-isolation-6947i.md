...
```swift
func append(_ captionGroup: AVCaptionGroup, isolation: isolated (any Actor)? = #isolation) async throws
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/avfoundation/avassetwriterinput/captionreceiver/append(_:isolation:)-6947i)*