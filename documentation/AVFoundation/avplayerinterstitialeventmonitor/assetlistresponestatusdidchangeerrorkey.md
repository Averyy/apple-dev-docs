# assetListResponeStatusDidChangeErrorKey
...
```swift
class let assetListResponeStatusDidChangeErrorKey: String
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/avfoundation/avplayerinterstitialeventmonitor/assetlistresponestatusdidchangeerrorkey)*