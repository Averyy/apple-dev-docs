...
```swift
static var mediaCharacteristics: AVAsyncProperty<Root, [AVMediaCharacteristic]> { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/avfoundation/avpartialasyncproperty/mediacharacteristics)*