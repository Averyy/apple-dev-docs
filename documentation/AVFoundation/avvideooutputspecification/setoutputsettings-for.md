...
```swift
func setOutputSettings(_ outputSettings: [String : any Sendable]?, for tagCollection: [CMTag])
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/avfoundation/avvideooutputspecification/setoutputsettings(_:for:))*