...
```swift
var preferredTagCollections: [[CMTag]] { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/avfoundation/avvideooutputspecification/preferredtagcollections-3gdo7)*