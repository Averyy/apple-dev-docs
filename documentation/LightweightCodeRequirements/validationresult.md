...
### Instance Properties
- [let failureReason: OSStatus](validationresult/failurereason.md)
- [let requirementMatched: Bool](validationresult/requirementmatched.md)
- [let signatureIsValid: Bool](validationresult/signatureisvalid.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/lightweightcoderequirements/validationresult)*