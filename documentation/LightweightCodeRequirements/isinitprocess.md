...
### Initializers
- [init()](isinitprocess/init.md)
  Matches if the process is the init process.
- [init(Bool)](isinitprocess/init(_:).md)
  Matches if the process is or is not the init process depending on the specified value.
- [init(from: any Decoder) throws](isinitprocess/init(from:).md)
  Create a new instance by decoding from the given decoder
### Instance Methods
- [func encode(to: any Encoder) throws](isinitprocess/encode(to:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/lightweightcoderequirements/isinitprocess)*