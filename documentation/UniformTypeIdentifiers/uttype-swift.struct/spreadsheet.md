...
```swift
static var spreadsheet: UTType { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/uniformtypeidentifiers/uttype-swift.struct/spreadsheet)*