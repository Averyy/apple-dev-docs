...
```swift
static var mpeg2Video: UTType { get }
```
...
This type conforms to [`UTTypeVideo`](uttypevideo.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/uniformtypeidentifiers/uttype-swift.struct/mpeg2video)*