...
```swift
static var makefile: UTType { get }
```
...
This type conforms to [`script`](uttype-swift.struct/script.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/uniformtypeidentifiers/uttype-swift.struct/makefile)*