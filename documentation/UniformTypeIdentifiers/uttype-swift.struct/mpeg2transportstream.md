...
```swift
static var mpeg2TransportStream: UTType { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/uniformtypeidentifiers/uttype-swift.struct/mpeg2transportstream)*