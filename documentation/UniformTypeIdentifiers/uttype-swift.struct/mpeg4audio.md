...
```swift
static var mpeg4Audio: UTType { get }
```
...
This type conforms to [`UTTypeMPEG`](uttypempeg.md) and [`UTTypeAudio`](uttypeaudio.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/uniformtypeidentifiers/uttype-swift.struct/mpeg4audio)*