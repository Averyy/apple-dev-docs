...
```swift
init(importedAs identifier: String, conformingTo parentType: UTType)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/uniformtypeidentifiers/uttypereference/init(importedas:conformingto:))*