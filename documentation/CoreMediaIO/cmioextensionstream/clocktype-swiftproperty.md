...
If you created the stream with a custom clock configuration, the value of this property is [`CMIOExtensionStream.ClockType.custom`](cmioextensionstream/clocktype-swift.enum/custom.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coremediaio/cmioextensionstream/clocktype-swift.property)*