...
```swift
var errSSLATSMinimumVersionViolation: OSStatus { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/security/errsslatsminimumversionviolation)*