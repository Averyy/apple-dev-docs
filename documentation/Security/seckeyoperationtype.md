...
### Initializers
- [init?(rawValue: CFIndex)](seckeyoperationtype/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/security/seckeyoperationtype)*