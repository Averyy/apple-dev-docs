...
- [var errSecCSDetachedCertificates: OSStatus](errseccsdetachedcertificates.md)
- [var errSecCSMultipleSelfSigning: OSStatus](errseccsmultipleselfsigning.md)
- [var errSecCSRemoteSignerFirstSlotFull: OSStatus](errseccsremotesignerfirstslotfull.md)
- [var errSecCSRemoteSignerSecondSlotFull: OSStatus](errseccsremotesignersecondslotfull.md)
