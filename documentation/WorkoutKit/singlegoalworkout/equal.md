...
```swift
static func == (a: SingleGoalWorkout, b: SingleGoalWorkout) -> Bool
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/workoutkit/singlegoalworkout/==(_:_:))*