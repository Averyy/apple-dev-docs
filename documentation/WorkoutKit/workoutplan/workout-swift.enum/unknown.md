...
```swift
static func == (a: WorkoutPlan.Workout, b: WorkoutPlan.Workout) -> Bool
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/workoutkit/workoutplan/workout-swift.enum/==(_:_:))*