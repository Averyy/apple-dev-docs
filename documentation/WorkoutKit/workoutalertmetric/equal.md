...
```swift
static func == (a: WorkoutAlertMetric, b: WorkoutAlertMetric) -> Bool
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/workoutkit/workoutalertmetric/==(_:_:))*