...
```swift
static func == (a: HeartRateZoneAlert, b: HeartRateZoneAlert) -> Bool
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/workoutkit/heartratezonealert/==(_:_:))*