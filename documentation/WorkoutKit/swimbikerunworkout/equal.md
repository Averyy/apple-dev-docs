...
```swift
static func == (a: SwimBikeRunWorkout, b: SwimBikeRunWorkout) -> Bool
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/workoutkit/swimbikerunworkout/==(_:_:))*