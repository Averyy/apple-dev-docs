...
```swift
static func == (a: SwimBikeRunWorkout.Activity, b: SwimBikeRunWorkout.Activity) -> Bool
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/workoutkit/swimbikerunworkout/activity/==(_:_:))*