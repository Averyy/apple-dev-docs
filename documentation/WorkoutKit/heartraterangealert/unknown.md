...
```swift
static func == (a: HeartRateRangeAlert, b: HeartRateRangeAlert) -> Bool
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/workoutkit/heartraterangealert/==(_:_:))*