...
```swift
static func == (a: CadenceRangeAlert, b: CadenceRangeAlert) -> Bool
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/workoutkit/cadencerangealert/==(_:_:))*