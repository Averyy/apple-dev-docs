...
```swift
static func == (a: PowerThresholdAlert, b: PowerThresholdAlert) -> Bool
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/workoutkit/powerthresholdalert/==(_:_:))*