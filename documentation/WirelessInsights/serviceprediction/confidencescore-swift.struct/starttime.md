...
```swift
let startTime: ServicePrediction.Confidence
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/wirelessinsights/serviceprediction/confidencescore-swift.struct/starttime)*