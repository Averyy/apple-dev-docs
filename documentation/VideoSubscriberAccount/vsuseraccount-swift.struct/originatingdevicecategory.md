...
- [VSUserAccount.OriginatingDeviceCategory.mobile](vsuseraccount-swift.struct/originatingdevicecategory/mobile.md)
  A constant that indicates the original registering device is mobile.
- [VSUserAccount.OriginatingDeviceCategory.other](vsuseraccount-swift.struct/originatingdevicecategory/other.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/videosubscriberaccount/vsuseraccount-swift.struct/originatingdevicecategory)*