...
### Initializers
- [init(transform: any TCTransform)](tcrectcollider/init(transform:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/touchcontrols/tcrectcollider)*