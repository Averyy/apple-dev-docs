...
```swift
#define kUSBHostPortPropertyBusCurrentAllocation
```
...
- [kUSBHostPortPropertyStatus](../iokit/kusbhostportpropertystatus.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/usbdriverkit/kusbhostportpropertybuscurrentallocation)*