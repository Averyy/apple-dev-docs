...
The value in this field is always [`kIOUSBDescriptorTypeDevice`](tiousbdescriptortype/kiousbdescriptortypedevice.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/usbdriverkit/iousbdevicedescriptor/bdescriptortype)*