...
This traffic class doesn’t specify particular quality-of-service requirements, so you can use it for general-purpose network traffic. Network slices that don’t have specific traffic class restrictions return this value for their [`trafficClass`](ctslicingmanager/slice/trafficclass.md) property.
...
*[View on Apple Developer](https://developer.apple.com/documentation/coretelephony/ctslicingmanager/trafficclass/any)*