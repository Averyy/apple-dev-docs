...
```swift
static var efiVariableInaccessible: VZError.Code { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/virtualization/vzerror/efivariableinaccessible)*