...
```swift
static var guestProvisioningInvalidPassword: VZError.Code { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/virtualization/vzerror/guestprovisioninginvalidpassword)*