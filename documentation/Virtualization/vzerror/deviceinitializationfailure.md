...
```swift
static var deviceInitializationFailure: VZError.Code { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/virtualization/vzerror/deviceinitializationfailure)*