...
```swift
static var installationFailed: VZError.Code { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/virtualization/vzerror/installationfailed)*