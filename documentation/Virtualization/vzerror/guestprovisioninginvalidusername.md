...
```swift
static var guestProvisioningInvalidUsername: VZError.Code { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/virtualization/vzerror/guestprovisioninginvalidusername)*