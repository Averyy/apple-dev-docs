...
This state is an intermediate state between the [`VZVirtualMachine.State.paused`](vzvirtualmachine/state-swift.enum/paused.md) and [`VZVirtualMachine.State.running`](vzvirtualmachine/state-swift.enum/running.md) states.
...
*[View on Apple Developer](https://developer.apple.com/documentation/virtualization/vzvirtualmachine/state-swift.enum/resuming)*