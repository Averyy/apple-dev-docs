...
This is the intermediate state between [`VZVirtualMachine.State.running`](vzvirtualmachine/state-swift.enum/running.md) and [`VZVirtualMachine.State.stopped`](vzvirtualmachine/state-swift.enum/stopped.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/virtualization/vzvirtualmachine/state-swift.enum/stopping)*