...
Call this method to start a VM that’s in the [`VZVirtualMachine.State.stopped`](vzvirtualmachine/state-swift.enum/stopped.md) or [`VZVirtualMachine.State.error`](vzvirtualmachine/state-swift.enum/error.md) state.
...
*[View on Apple Developer](https://developer.apple.com/documentation/virtualization/vzvirtualmachine/start())*