# kDNSServiceInterfaceIndexInfra
...
```swift
var kDNSServiceInterfaceIndexInfra: UInt32 { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/dnssd/kdnsserviceinterfaceindexinfra)*