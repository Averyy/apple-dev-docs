...
- [init(tag: UInt8, value: Data)](tksimpletlvrecord/init(tag:value:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/cryptotokenkit/tksimpletlvrecord)*