...
```swift
@MainActor
@preconcurrency func controlWidgetStatus<S>(_ status: S) -> some View where S : StringProtocol
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/financekitui/addordertowalletbutton/controlwidgetstatus(_:)-10znf)*