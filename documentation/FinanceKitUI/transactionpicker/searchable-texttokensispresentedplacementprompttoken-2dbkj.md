...
*[View on Apple Developer](https://developer.apple.com/documentation/financekitui/transactionpicker/searchable(text:tokens:ispresented:placement:prompt:token:)-2dbkj)*