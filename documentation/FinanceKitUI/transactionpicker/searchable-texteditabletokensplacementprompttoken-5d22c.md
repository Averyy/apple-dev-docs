...
*[View on Apple Developer](https://developer.apple.com/documentation/financekitui/transactionpicker/searchable(text:editabletokens:placement:prompt:token:)-5d22c)*