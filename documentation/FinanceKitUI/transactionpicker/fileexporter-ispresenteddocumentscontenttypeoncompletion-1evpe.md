...
*[View on Apple Developer](https://developer.apple.com/documentation/financekitui/transactionpicker/fileexporter(ispresented:documents:contenttype:oncompletion:)-1evpe)*