...
*[View on Apple Developer](https://developer.apple.com/documentation/financekitui/transactionpicker/filemover(ispresented:files:oncompletion:oncancellation:))*