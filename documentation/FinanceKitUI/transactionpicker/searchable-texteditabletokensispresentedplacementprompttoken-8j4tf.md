...
*[View on Apple Developer](https://developer.apple.com/documentation/financekitui/transactionpicker/searchable(text:editabletokens:ispresented:placement:prompt:token:)-8j4tf)*