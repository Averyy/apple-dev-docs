...
*[View on Apple Developer](https://developer.apple.com/documentation/financekitui/transactionpicker/fileimporter(ispresented:allowedcontenttypes:oncompletion:))*