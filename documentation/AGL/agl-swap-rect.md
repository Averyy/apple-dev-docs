...
Enable or set the swap rectangle. The associated parameter must contain four values: the  and  window coordinates of the swap rectangle, followed by its width and height. If enabled, the area of the window that is affected by the function [`aglSwapBuffers`](https://developer.apple.comhttps://developer.apple.com/library/archive/#id(F15030))   is restricted to a subrectangle of the entire window.
...
*[View on Apple Developer](https://developer.apple.com/documentation/agl/agl_swap_rect)*