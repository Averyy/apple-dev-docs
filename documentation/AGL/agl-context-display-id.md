...
The associated value is a list of the display IDs of all displays touched by the rendering context, up to a maximum of 32 displays. You can’t set this list of values because the system assigns display ID values. However, you can retrieve the value using the function [`aglGetInteger`](https://developer.apple.comhttps://developer.apple.com/library/archive/#id(F15035)).
...
*[View on Apple Developer](https://developer.apple.com/documentation/agl/agl_context_display_id)*