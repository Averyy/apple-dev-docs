...
### Constants
- [var ENRiskLevelMin: Int](enrisklevelmin.md)
  The value that is the minimum for risk level.
- [var ENRiskLevelMax: Int](enrisklevelmax.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/exposurenotification/risk-level)*