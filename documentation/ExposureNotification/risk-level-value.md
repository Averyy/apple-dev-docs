...
### Constants
- [var ENRiskLevelValueMin: Int](enrisklevelvaluemin.md)
  The value that is the minimum for risk level value.
- [var ENRiskLevelValueMax: Int](enrisklevelvaluemax.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/exposurenotification/risk-level-value)*