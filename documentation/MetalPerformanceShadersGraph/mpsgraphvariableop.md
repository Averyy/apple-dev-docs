...
### Instance Properties
- [var dataType: MPSDataType](mpsgraphvariableop/datatype.md)
  The data type of the variable.
- [var shape: [NSNumber]](mpsgraphvariableop/shape.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/metalperformanceshadersgraph/mpsgraphvariableop)*