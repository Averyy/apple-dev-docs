...
```swift
var kAudioChannelLayoutTag_Logic_Atmos_7_1_2: AudioChannelLayoutTag { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreaudiotypes/kaudiochannellayouttag_logic_atmos_7_1_2)*