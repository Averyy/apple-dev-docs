...
This flag is a synonym for [`kAudioFormatFlagIsNonInterleaved`](kaudioformatflagisnoninterleaved.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreaudiotypes/klinearpcmformatflagisnoninterleaved)*