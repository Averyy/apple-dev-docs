...
```swift
var kAudioChannelLayoutTag_CICP_7: AudioChannelLayoutTag { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreaudiotypes/kaudiochannellayouttag_cicp_7)*