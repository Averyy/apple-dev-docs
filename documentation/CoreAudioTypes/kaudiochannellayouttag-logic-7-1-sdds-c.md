...
```swift
var kAudioChannelLayoutTag_Logic_7_1_SDDS_C: AudioChannelLayoutTag { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreaudiotypes/kaudiochannellayouttag_logic_7_1_sdds_c)*