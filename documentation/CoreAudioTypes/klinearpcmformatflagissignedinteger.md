...
This flag is a synonym for [`kAudioFormatFlagIsSignedInteger`](kaudioformatflagissignedinteger.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreaudiotypes/klinearpcmformatflagissignedinteger)*