...
```swift
var kAudioChannelLayoutTag_WAVE_5_0_A: AudioChannelLayoutTag { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreaudiotypes/kaudiochannellayouttag_wave_5_0_a)*