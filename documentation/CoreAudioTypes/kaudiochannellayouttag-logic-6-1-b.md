...
```swift
var kAudioChannelLayoutTag_Logic_6_1_B: AudioChannelLayoutTag { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreaudiotypes/kaudiochannellayouttag_logic_6_1_b)*