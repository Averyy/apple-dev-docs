...
```swift
var kAudioChannelLayoutTag_Logic_5_1_B: AudioChannelLayoutTag { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreaudiotypes/kaudiochannellayouttag_logic_5_1_b)*