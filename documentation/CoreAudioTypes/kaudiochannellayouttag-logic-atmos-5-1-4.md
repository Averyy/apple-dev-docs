...
```swift
var kAudioChannelLayoutTag_Logic_Atmos_5_1_4: AudioChannelLayoutTag { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreaudiotypes/kaudiochannellayouttag_logic_atmos_5_1_4)*