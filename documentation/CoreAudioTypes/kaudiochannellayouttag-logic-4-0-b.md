...
```swift
var kAudioChannelLayoutTag_Logic_4_0_B: AudioChannelLayoutTag { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreaudiotypes/kaudiochannellayouttag_logic_4_0_b)*