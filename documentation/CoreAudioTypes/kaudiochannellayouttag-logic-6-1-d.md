...
```swift
var kAudioChannelLayoutTag_Logic_6_1_D: AudioChannelLayoutTag { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreaudiotypes/kaudiochannellayouttag_logic_6_1_d)*