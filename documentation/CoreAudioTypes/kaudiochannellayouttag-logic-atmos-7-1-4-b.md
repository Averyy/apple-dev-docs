...
```swift
var kAudioChannelLayoutTag_Logic_Atmos_7_1_4_B: AudioChannelLayoutTag { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreaudiotypes/kaudiochannellayouttag_logic_atmos_7_1_4_b)*