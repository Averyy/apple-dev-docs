...
Uses the [`IOAudioTimeStamp`](https://developer.apple.com/documentation/iokit/ioaudiotimestamp) flags. For more information, see [`mFlags`](audiotimestamp/mflags.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreaudiotypes/kaudioformattimecode)*