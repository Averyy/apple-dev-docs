...
```swift
var kAudioChannelLayoutTag_Atmos_5_1_2: AudioChannelLayoutTag { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreaudiotypes/kaudiochannellayouttag_atmos_5_1_2)*