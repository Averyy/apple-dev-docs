...
```swift
var kAudioChannelLayoutTag_MPEG_6_1_B: AudioChannelLayoutTag { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreaudiotypes/kaudiochannellayouttag_mpeg_6_1_b)*