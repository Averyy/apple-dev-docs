...
This flag is a synonym for [`kAudioFormatFlagsAreAllClear`](kaudioformatflagsareallclear.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreaudiotypes/klinearpcmformatflagsareallclear)*