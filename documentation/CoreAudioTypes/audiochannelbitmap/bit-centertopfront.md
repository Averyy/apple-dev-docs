...
```swift
static var bit_CenterTopFront: AudioChannelBitmap { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreaudiotypes/audiochannelbitmap/bit_centertopfront)*