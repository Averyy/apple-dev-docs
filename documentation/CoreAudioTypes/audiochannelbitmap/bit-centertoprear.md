...
```swift
static var bit_CenterTopRear: AudioChannelBitmap { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreaudiotypes/audiochannelbitmap/bit_centertoprear)*