...
```swift
static var bit_RightTopMiddle: AudioChannelBitmap { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreaudiotypes/audiochannelbitmap/bit_righttopmiddle)*