...
This flag is a synonym for [`kAudioFormatFlagIsPacked`](kaudioformatflagispacked.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/coreaudiotypes/klinearpcmformatflagispacked)*