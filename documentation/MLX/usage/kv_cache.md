...
source: MLX
framework: MLX
url: https://ml-explore.github.io/mlx/build/html/usage/kv_cache.html
---
...
- [.rst](../_sources/usage/kv_cache.rst)
- **
...
Avoid appending naively with `concatenate()`:
...
`concatenate()` creates a new array and copies the existing cache at every
