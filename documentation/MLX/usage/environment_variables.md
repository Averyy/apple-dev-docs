...
source: MLX
framework: MLX
url: https://ml-explore.github.io/mlx/build/html/usage/environment_variables.html
---
...
- [.rst](../_sources/usage/environment_variables.rst)
- **
...
[mlx.core.enable_compile()](../python/_autosummary/mlx.core.enable_compile.html#mlx.core.enable_compile) overrides it.
...
operations in full `float32` precision. See [Numerical Precision](precision.md).

## Distributed

The variables required to initialize a distributed process depend on the
backend. [Distributed Communication](distributed.md) describes their formats and how `mlx.launch`
sets them.
...
variables](https://docs.nvidia.com/deeplearning/nccl/user-guide/docs/env.md).
