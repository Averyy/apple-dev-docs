...
- [.rst](../_sources/usage/lazy_evaluation.rst)
- **
...
[eval()](../python/_autosummary/mlx.core.eval.html#mlx.core.eval) is performed.
...
computations. This is useful for function transformations like [grad()](../python/_autosummary/mlx.core.grad.html#mlx.core.grad) and
[vmap()](../python/_autosummary/mlx.core.vmap.html#mlx.core.vmap) and graph optimizations.
...
[mlx.nn.Module](../python/nn/module.html#mlx.nn.Module). You can instantiate this model with `model = Model()`.
...
[eval()](../python/_autosummary/mlx.core.eval.html#mlx.core.eval). If you update the model with `float16` weights, your maximum
...
A common question is when to use [eval()](../python/_autosummary/mlx.core.eval.html#mlx.core.eval). The trade-off is between
...
[eval()](../python/_autosummary/mlx.core.eval.html#mlx.core.eval) is at each iteration of this outer loop.
...
Calling [array.item()](../python/_autosummary/mlx.core.array.item.html#mlx.core.array.item) on a scalar array will also evaluate it. In the
...
Also, calling [eval()](../python/_autosummary/mlx.core.eval.html#mlx.core.eval) on an array or set of arrays multiple times is
