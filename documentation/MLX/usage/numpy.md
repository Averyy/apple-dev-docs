...
- The [Python Buffer Protocol](https://docs.python.org/3/c-api/buffer.md).
...
PyTorch Support for [memoryview](https://docs.python.org/3/library/stdtypes.html#memoryview) is experimental and can break for
