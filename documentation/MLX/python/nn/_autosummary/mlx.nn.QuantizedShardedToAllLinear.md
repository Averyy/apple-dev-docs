...
source: MLX
framework: MLX
url: https://ml-explore.github.io/mlx/build/html/python/nn/_autosummary/mlx.nn.QuantizedShardedToAllLinear.html
---
...
- [.rst](../../../_sources/python/nn/_autosummary/mlx.nn.QuantizedShardedToAllLinear.rst)
- **
...
**class QuantizedShardedToAllLinear(*input_dims: int*, *output_dims: int*, *bias: bool = True*, *group_size: int = 64*, *bits: int = 4*, *mode: str = 'affine'*, *group: Group | None = None*)**
...
It is the quantized equivalent of [mlx.nn.ShardedToAllLinear](mlx.nn.ShardedToAllLinear.html#mlx.nn.ShardedToAllLinear).
