...
**dequantize(*w: array*, */*, *scales: array*, *biases: array | None = None*, *group_size: int | None = None*, *bits: int | None = None*, *mode: str = 'affine'*, *global_scale: array | None = None*, *dtype: Dtype | None = None*, ***, *stream: StreamOrDevice = None*) → [array](mlx.core.array.html#mlx.core.array)**
