...
source: MLX
framework: MLX
url: https://ml-explore.github.io/mlx/build/html/python/_autosummary/mlx.core.var.html
---
...
- [.rst](../../_sources/python/_autosummary/mlx.core.var.rst)
- **
...
**var(*a: array*, */*, *axis: None | int | Sequence[int] = None*, *keepdims: bool = False*, *ddof: int = 0*, ***, *stream: None | Stream | Device = None*) → [array](mlx.core.array.html#mlx.core.array)**
