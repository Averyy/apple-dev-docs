...
**ifftshift(*a: array*, *axes: Sequence[int] | None = None*, *stream: Stream | Device | None = None*) → [array](mlx.core.array.html#mlx.core.array)**
...
**axes** ([list](https://docs.python.org/3/library/stdtypes.html#list)*(*[int](https://docs.python.org/3/library/functions.html#int)*)**, **optional*) – Axes over which to perform the inverse shift.
