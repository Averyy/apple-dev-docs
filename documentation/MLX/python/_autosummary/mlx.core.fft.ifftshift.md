...
**ifftshift(*a: array*, *axes: int | Sequence[int] | None = None*, *stream: Stream | ThreadLocalStream | Device | mlx.core.DeviceType | None = None*) → [array](mlx.core.array.html#mlx.core.array)**
