...
**conv2d(*input: array*, *weight: array*, */*, *stride: int | tuple[int, int] = 1*, *padding: int | tuple[int, int] = 0*, *dilation: int | tuple[int, int] = 1*, *groups: int = 1*, ***, *stream: StreamOrDevice = None*) → [array](mlx.core.array.html#mlx.core.array)**
