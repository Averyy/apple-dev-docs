...
**laplace(*shape: Sequence[int] = []*, *dtype: Dtype | None = float32*, *loc: float = 0.0*, *scale: float = 1.0*, *key: array | None = None*, *stream: None | Stream | Device = None*) → [array](mlx.core.array.html#mlx.core.array)**
