...
See [`deliveryDate`](accessorynotification/deliverydate.md) for the actual date value. Display this date with information that specifies the minute.
...
*[View on Apple Developer](https://developer.apple.com/documentation/accessorynotifications/accessorynotification/displaydate-swift.enum/deliverydate)*