...
A new geometry source whose [`semantic`](scngeometrysource/semantic-swift.property.md) property is [`normal`](scngeometrysource/semantic-swift.struct/normal.md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/scenekit/scngeometrysource/init(normals:))*