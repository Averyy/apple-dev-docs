...
### Initializers
- [init(rawValue: String)](scnscenesource/animationimportpolicy/init(rawvalue:).md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/scenekit/scnscenesource/animationimportpolicy)*