...
Deprecated in OS X v10.9. Use [`SCNWrapMode.repeat`](scnwrapmode/repeat.md) instead.
...
*[View on Apple Developer](https://developer.apple.com/documentation/scenekit/scnrepeat)*