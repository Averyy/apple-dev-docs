...
| `mat4` ![None](/images/com.apple.scenekit/spacer.png) `mat4x4` | `float4x4` | [`NSValue`](https://developer.apple.com/documentation/foundation/nsvalue) ([`CATransform3D`](https://developer.apple.com/documentation/quartzcore/catransform3d)) |
| `sampler2D` ![None](/images/com.apple.scenekit/spacer.png) `samplerCube` | `sampler` | [`SCNMaterialProperty`](scnmaterialproperty.md) |
...
| `u_boundingBox` | `mat32` | The bounding box of the geometry being rendered, in model space. ![None](/images/com.apple.scenekit/spacer.png) `u_boundingBox[0].xyz` is the minimum corner of the bounding box and `u_boundingBox[1].xyz` is the maximum corner. |
| `u_modelTransform` ![None](/images/com.apple.scenekit/spacer.png) `u_viewTransform` ![None](/images/com.apple.scenekit/spacer.png) `u_projectionTransform` ![None](/images/com.apple.scenekit/spacer.png) `u_normalTransform` ![None](/images/com.apple.scenekit/spacer.png) `u_modelViewTransform` ![None](/images/com.apple.scenekit/spacer.png) `u_modelViewProjectionTransform` | `mat4` | The transform matrices used for converting vertex positions and normals between model, world, view, and clip coordinate spaces. ![None](/images/com.apple.scenekit/spacer.png) For detailed definitions, see Rendering Transform Keys. |
| `u_inverseModelTransform` ![None](/images/com.apple.scenekit/spacer.png) `u_inverseViewTransform` ![None](/images/com.apple.scenekit/spacer.png) `u_inverseProjectionTransform` ![None](/images/com.apple.scenekit/spacer.png) `u_inverseModelViewTransform` ![None](/images/com.apple.scenekit/spacer.png) `u_inverseModelViewProjectionTransform` | `mat4` | The inverse matrices corresponding to each transform. |
| `u_diffuseTexture` ![None](/images/com.apple.scenekit/spacer.png) `u_ambientTexture` ![None](/images/com.apple.scenekit/spacer.png) `u_specularTexture` ![None](/images/com.apple.scenekit/spacer.png) `u_normalTexture` ![None](/images/com.apple.scenekit/spacer.png) `u_reflectiveTexture` ![None](/images/com.apple.scenekit/spacer.png) `u_emissionTexture` ![None](/images/com.apple.scenekit/spacer.png) `u_transparentTexture` ![None](/images/com.apple.scenekit/spacer.png) `u_multiplyTexture` | `sampler2D` or `samplerCube` | The texture contents of the corresponding material property. Declared only if the material property’s [`contents`](scnmaterialproperty/contents.md) object provides a texture image. ![None](/images/com.apple.scenekit/spacer.png) The GLSL type of the uniform variable depends on whether the contents are a 2D image or cube map. ![None](/images/com.apple.scenekit/spacer.png) For details on materials, see [`SCNMaterial`](scnmaterial.md). |
