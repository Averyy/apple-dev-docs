...
The particle system’s [`particleFriction`](scnparticlesystem/particlefriction.md) and [`particleFrictionVariation`](scnparticlesystem/particlefrictionvariation.md) properties determine the initial friction coefficient for each particle.
...
*[View on Apple Developer](https://developer.apple.com/documentation/scenekit/scnparticlesystem/particleproperty/friction)*