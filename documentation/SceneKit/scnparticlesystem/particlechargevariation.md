...
Setting a nonzero value for this property randomizes the effect of the [`particleCharge`](scnparticlesystem/particlecharge.md) property. SceneKit randomly adjusts the charge of each particle by up to half the [`particleChargeVariation`](scnparticlesystem/particlechargevariation.md) value. For example, if the [`particleCharge`](scnparticlesystem/particlecharge.md) value is `1.0` coulombs and the [`particleChargeVariation`](scnparticlesystem/particlechargevariation.md) value is `0.5` coulombs, each particle uses a random charge value between `0.75` and `1.25` coulombs for physics simulation.
...
*[View on Apple Developer](https://developer.apple.com/documentation/scenekit/scnparticlesystem/particlechargevariation)*