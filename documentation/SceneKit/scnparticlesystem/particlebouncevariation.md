...
Setting a nonzero value for this property randomizes the effect of the [`particleBounce`](scnparticlesystem/particlebounce.md) property. SceneKit randomly adjusts the restitution coefficient of each particle by up to half the [`particleBounceVariation`](scnparticlesystem/particlebouncevariation.md) value. For example, if the [`particleBounce`](scnparticlesystem/particlebounce.md) value is `1.0` and the [`particleBounceVariation`](scnparticlesystem/particlebouncevariation.md) value is `0.5`, each particle uses a random restitution coefficient between `0.75` and `1.25` for physics simulation.
...
*[View on Apple Developer](https://developer.apple.com/documentation/scenekit/scnparticlesystem/particlebouncevariation)*