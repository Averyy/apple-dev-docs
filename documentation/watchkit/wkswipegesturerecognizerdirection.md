...
### Constants
- [static var right: WKSwipeGestureRecognizerDirection](wkswipegesturerecognizerdirection/right.md)
...
### Initializers
- [init(rawValue: UInt)](wkswipegesturerecognizerdirection/init(rawvalue:).md)
