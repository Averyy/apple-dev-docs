...
- [WKInterfaceObjectVerticalAlignment.center](wkinterfaceobjectverticalalignment/center.md)
...
### Initializers
- [init?(rawValue: Int)](wkinterfaceobjectverticalalignment/init(rawvalue:).md)
