...
| [{'type': 'paragraph', 'inlineContent': [{'type': 'text', 'text': 'Rows'}]}] | [{'type': 'paragraph', 'inlineContent': [{'type': 'text', 'text': 'The number of row controllers supported by the table. Change the value to add or remove new row controller objects to the storyboard file.'}]}] |
| [{'type': 'paragraph', 'inlineContent': [{'type': 'text', 'text': 'Spacing'}]}] | [{'type': 'paragraph', 'inlineContent': [{'text': 'The amount of spacing (in points) between rows.', 'type': 'text'}]}] |
| [{'type': 'paragraph', 'inlineContent': [{'type': 'text', 'text': 'Background'}]}] | [{'type': 'paragraph', 'inlineContent': [{'text': 'The background image to display behind the table’s items. Don’t set an image if you want the background color or image of the underlying interface controller to be visible.', 'type': 'text'}]}] |
| [{'type': 'paragraph', 'inlineContent': [{'type': 'text', 'text': 'Color'}]}] | [{'type': 'paragraph', 'inlineContent': [{'text': 'The background color for the table. Set the color to clear if you want the background color or image of the underlying interface controller to be visible.', 'type': 'text'}]}] |
| [{'type': 'paragraph', 'inlineContent': [{'text': 'Item Pagination', 'type': 'text'}]}] | [{'type': 'paragraph', 'inlineContent': [{'type': 'text', 'text': 'A checkbox that enables Item Pagination. For more information on Item Pagination, see '}, {'identifier': 'doc://com.apple.watchkit/documentation/WatchKit/WKInterfaceTable#Support-Item-Pagination', 'isActive': True, 'type': 'reference'}, {'type': 'text', 'text': '.'}]}] |
...
| [{'type': 'paragraph', 'inlineContent': [{'type': 'text', 'text': 'Identifier'}]}] | [{'type': 'paragraph', 'inlineContent': [{'type': 'text', 'text': 'The name used to identify the row controller’s type to the '}, {'identifier': 'doc://com.apple.watchkit/documentation/WatchKit/WKInterfaceTable/setRowTypes(_:)', 'type': 'reference', 'isActive': True}, {'type': 'text', 'text': ' or '}, {'identifier': 'doc://com.apple.watchkit/documentation/WatchKit/WKInterfaceTable/setNumberOfRows(_:withRowType:)', 'type': 'reference', 'isActive': True}, {'type': 'text', 'text': ' method.'}]}] |
| [{'type': 'paragraph', 'inlineContent': [{'type': 'text', 'text': 'Selectable'}]}] | [{'type': 'paragraph', 'inlineContent': [{'type': 'text', 'text': 'A checkbox indicating whether the table responds to taps within the row. When disabled, tapping the row doesn’t highlight the row or report the action to the table.'}]}] |
