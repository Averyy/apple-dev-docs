...
```swift
@MainActor @preconcurrency static let willEnterForegroundNotification: NSNotification.Name
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/watchkit/wkapplication/willenterforegroundnotification)*