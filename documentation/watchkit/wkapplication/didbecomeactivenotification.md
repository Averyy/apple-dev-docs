...
```swift
@MainActor @preconcurrency static let didBecomeActiveNotification: NSNotification.Name
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/watchkit/wkapplication/didbecomeactivenotification)*