...
The duration of the audio file is obtained from the audio file itself.
...
*[View on Apple Developer](https://developer.apple.com/documentation/watchkit/wkaudiofileasset/duration)*