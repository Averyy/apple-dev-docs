...
```swift
@MainActor func addMenuItem(with itemIcon: WKMenuItemIcon, title: String, action: Selector)
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/watchkit/wkinterfacecontroller/addmenuitem(with:title:action:)-6pb4t)*