...
```swift
@MainActor func endGlanceUpdates()
```

## Overview

When all outstanding calls to the [`beginGlanceUpdates()`](https://developer.apple.com/documentation/watchkit/wkinterfacecontroller/beginglanceupdates()) method are balanced with calls to this method, WatchKit displays your updated glance interface.
