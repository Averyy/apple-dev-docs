...
- `videoGravity`: The resizing option for the movie. For a list of possible values, see the   type. Defaults to  .
...
*[View on Apple Developer](https://developer.apple.com/documentation/watchkit/wkinterfaceinlinemovie/setvideogravity(_:))*