...
```swift
static let progressiveShortDictation: DictationTranscriber.Preset
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/speech/dictationtranscriber/preset/progressiveshortdictation)*