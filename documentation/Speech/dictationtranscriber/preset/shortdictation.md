...
```swift
static let shortDictation: DictationTranscriber.Preset
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/speech/dictationtranscriber/preset/shortdictation)*