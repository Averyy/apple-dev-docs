...
```swift
static let timeIndexedLongDictation: DictationTranscriber.Preset
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/speech/dictationtranscriber/preset/timeindexedlongdictation)*