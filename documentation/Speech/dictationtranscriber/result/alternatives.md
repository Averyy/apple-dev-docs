...
To receive alternatives, set the [`DictationTranscriber.ReportingOption.alternativeTranscriptions`](dictationtranscriber/reportingoption/alternativetranscriptions.md) option.
