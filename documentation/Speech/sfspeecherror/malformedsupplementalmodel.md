...
```swift
static var malformedSupplementalModel: SFSpeechError.Code { get }
```
...
*[View on Apple Developer](https://developer.apple.com/documentation/speech/sfspeecherror/malformedsupplementalmodel)*