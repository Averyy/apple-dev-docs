...
![A screenshot showing a control-drag operation from a button in the storyboard to the WKInterfaceController subclass.](/images/com.apple.watchkit/media-3172422@2x.png)
...
![A screenshot showing the popup to create a new outlet; the outlet is named firstButton.](/images/com.apple.watchkit/media-3144653@2x.png)
...
![A screenshot of the Attribute inspector for Labels.](/images/com.apple.watchkit/media-3148615@2x.png)
...
![A screenshot showing the Xcode prompt when adding an action method.](/images/com.apple.watchkit/media-3148596@2x.png)
