...
- [var group: CNGroup](cnchangehistoryaddsubgrouptogroupevent/group.md)
  The group where the user added a subgroup.
- [var subgroup: CNGroup](cnchangehistoryaddsubgrouptogroupevent/subgroup.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/contacts/cnchangehistoryaddsubgrouptogroupevent)*