...
- [var group: CNGroup](cnchangehistoryaddmembertogroupevent/group.md)
  The group where the user added a contact.
- [var member: CNContact](cnchangehistoryaddmembertogroupevent/member.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/contacts/cnchangehistoryaddmembertogroupevent)*