...
- [var group: CNGroup](cnchangehistoryremovesubgroupfromgroupevent/group.md)
  The group where the user removed a subgroup.
- [var subgroup: CNGroup](cnchangehistoryremovesubgroupfromgroupevent/subgroup.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/contacts/cnchangehistoryremovesubgroupfromgroupevent)*