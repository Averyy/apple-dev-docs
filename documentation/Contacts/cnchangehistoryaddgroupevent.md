...
- [var group: CNGroup](cnchangehistoryaddgroupevent/group.md)
  The group the user added.
- [var containerIdentifier: String](cnchangehistoryaddgroupevent/containeridentifier.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/contacts/cnchangehistoryaddgroupevent)*