...
- [var rawRepresentation: Data](p384/signing/publickey/rawrepresentation.md)
  A full representation of the public key.
- [var compactRepresentation: Data?](p384/signing/publickey/compactrepresentation.md)
  A compact representation of the public key.
- [var compressedRepresentation: Data](p384/signing/publickey/compressedrepresentation.md)
  A compressed representation of the public key.
- [var derRepresentation: Data](p384/signing/publickey/derrepresentation.md)
  A Distinguished Encoding Rules (DER) encoded representation of the public key.
- [var pemRepresentation: String](p384/signing/publickey/pemrepresentation.md)
  A Privacy-Enhanced Mail (PEM) representation of the public key.
- [var x963Representation: Data](p384/signing/publickey/x963representation.md)
...
- [func isValidSignature<D>(P384.Signing.ECDSASignature, for: D) -> Bool](p384/signing/publickey/isvalidsignature(_:for:)-1hrtv.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/cryptokit/p384/signing/publickey)*