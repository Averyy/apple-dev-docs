...
Keys that use a compact point encoding enable shorter public keys, but aren’t compliant with FIPS certification. If your app requires FIPS certification, create a key with [`init(rawRepresentation:)`](p384/keyagreement/privatekey/init(rawrepresentation:).md).
...
*[View on Apple Developer](https://developer.apple.com/documentation/cryptokit/p384/keyagreement/privatekey/init(compactrepresentable:))*