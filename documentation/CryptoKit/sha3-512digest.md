...
### Instance Properties
- [var description: String](sha3_512digest/description.md)
  A human-readable description of the digest.
### Instance Methods
- [func hash(into: inout Hasher)](sha3_512digest/hash(into:).md)
  Hashes the essential components of the digest by feeding them into the given hash function.
### Type Properties
- [static var byteCount: Int](sha3_512digest/bytecount.md)
...
*[View on Apple Developer](https://developer.apple.com/documentation/cryptokit/sha3_512digest)*